...
.method public final a(Landroid/util/Size;ILandroid/graphics/Rect;)Landroid/graphics/Matrix;
    ...
    iget-object v2, p0, Lmyb;->d:Landroid/graphics/Matrix;

    invoke-direct {v1, v2}, Landroid/graphics/Matrix;-><init>(Landroid/graphics/Matrix;)V

    invoke-virtual {p0, p1, p2}, Lmyb;->c(Landroid/util/Size;I)Landroid/graphics/Matrix;
...
.method public final b()Landroid/util/Size;
    ...
    iget-object v1, p0, Lmyb;->b:Landroid/graphics/Rect;

    invoke-virtual {v1}, Landroid/graphics/Rect;->height()I

    move-result v1

    iget-object v2, p0, Lmyb;->b:Landroid/graphics/Rect;
...
.method public final c(Landroid/util/Size;I)Landroid/graphics/Matrix;
    ...
    invoke-virtual {p0}, Lmyb;->b()Landroid/util/Size;

    move-result-object v0

    const/4 v1, 0x1

    invoke-static {p1, v1, v0}, Lz2g;->c(Landroid/util/Size;ZLandroid/util/Size;)Z
    ...
    invoke-static {v6, v5}, Lafi;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lmyb;->b:Landroid/graphics/Rect;
    ...
    invoke-static {p1, p2, v0, v1}, Lz2g;->a(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;

    move-result-object p1

    iget-boolean p2, p0, Lmyb;->f:Z

    if-eqz p2, :cond_8

    iget-boolean p2, p0, Lmyb;->g:Z

    if-eqz p2, :cond_8

    iget p2, p0, Lmyb;->c:I

    invoke-static {p2}, Lz2g;->b(I)Z
    ...
    iget-object p2, p0, Lmyb;->b:Landroid/graphics/Rect;
...
.method public final d()Landroid/graphics/Matrix;
    ...
    iget-object v1, p0, Lmyb;->a:Landroid/util/Size;
    ...
    iget-object v2, p0, Lmyb;->a:Landroid/util/Size;
    ...
    invoke-static {v0, v0, v1, v2}, Lz2g;->a(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
...
.method public final e(Landroid/util/Size;I)Landroid/graphics/RectF;
    ...
    iget-object v0, p0, Lmyb;->a:Landroid/util/Size;
...
.method public final f()Z
    ...
    :goto_1
    iget-object v3, p0, Lmyb;->b:Landroid/graphics/Rect;

    if-eqz v3, :cond_2

    iget-object v3, p0, Lmyb;->a:Landroid/util/Size;
