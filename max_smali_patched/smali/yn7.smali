...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lpf5;Lmb0;)V
    .locals 0
    ...
    iput-object p2, p0, Lyn7;->b:Lpf5;

    iput-object p3, p0, Lyn7;->c:Lmb0;
...
# virtual methods
.method public final a(Lec0;IZ)V
    .locals 16
    ...
    iget-object v5, v1, Lyn7;->a:Landroid/content/Context;
    ...
    iget-object v8, v0, Lec0;->a:Ljava/lang/String;
    ...
    iget-object v7, v0, Lec0;->c:Lzyb;

    invoke-static {v7}, Lczb;->a(Lzyb;)I
    ...
    invoke-static {v9, v2, v0}, Ldfi;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    return-void

    :cond_2
    iget-object v11, v1, Lyn7;->b:Lpf5;

    check-cast v11, Ldld;

    invoke-virtual {v11}, Ldld;->l()Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v3, v1, Lyn7;->c:Lmb0;

    invoke-virtual {v3, v7, v14, v15, v2}, Lmb0;->a(Lzyb;JI)J

    move-result-wide v0

    invoke-virtual {v11, v0, v1}, Landroid/app/job/JobInfo$Builder;->setMinimumLatency(J)Landroid/app/job/JobInfo$Builder;

    iget-object v0, v3, Lmb0;->b:Ljava/util/HashMap;
    ...
    iget-object v0, v0, Lnb0;->c:Ljava/util/Set;
