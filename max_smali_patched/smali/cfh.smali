...
.method public a0(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    .locals 0
...
.method public abstract b0(Landroid/os/Parcel;I)Z
.end method
...
.method public final onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lcfh;->c0(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    :cond_3
    invoke-virtual {p0, p2, p1}, Lcfh;->b0(Landroid/os/Parcel;I)Z
    ...
    :cond_5
    invoke-virtual {p0, p1, p2, p3}, Lcfh;->a0(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    iget-object p1, p3, Likh;->f:Lmkh;

    iget-object p1, p1, Lmkh;->a:Lkmh;

    if-eqz p1, :cond_9

    iget-object p2, p3, Likh;->e:Ltbf;

    iget-object p4, p1, Lkmh;->f:Ljava/lang/Object;

    monitor-enter p4

    :try_start_0
    iget-object v0, p1, Lkmh;->e:Ljava/util/HashSet;
    ...
    invoke-direct {p2, v3, p1}, Lklh;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p1}, Lkmh;->a()Landroid/os/Handler;
    ...
    :cond_9
    :goto_6
    iget-object p1, p3, Likh;->d:Lt5f;

    const-string p2, "onGetLaunchReviewFlowInfo"

    new-array p4, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p4}, Lt5f;->f(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    new-instance p4, Lpgh;

    invoke-direct {p4, p1, p2}, Lpgh;-><init>(Landroid/app/PendingIntent;Z)V

    iget-object p1, p3, Likh;->e:Ltbf;

    invoke-virtual {p1, p4}, Ltbf;->d(Ljava/lang/Object;)V
    ...
    iget-object p1, p3, Lylh;->f:Ldmh;

    iget-object p1, p1, Ldmh;->a:Lanh;

    iget-object p2, p3, Lylh;->e:Ltbf;

    invoke-virtual {p1, p2}, Lanh;->c(Ltbf;)V

    iget-object p1, p3, Lylh;->d:Ln8f;

    const-string p2, "onCompleteUpdate"

    new-array p3, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p3}, Ln8f;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {p1, v6}, Lfl7;->e(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p1, p4, v2}, Ln8f;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p2, p3}, Ltbf;->c(Ljava/lang/Exception;)Z

    goto/16 :goto_8

    :cond_13
    iget-object p1, p3, Lylh;->g:Ldmh;
    ...
    iget-object p1, p1, Ldmh;->d:Limh;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v3, Ljava/io/File;

    iget-object p1, p1, Limh;->a:Landroid/content/Context;
    ...
    invoke-static {v3}, Limh;->a(Ljava/io/File;)J
    ...
    invoke-direct {p1, v6}, Lbq;-><init>(I)V

    invoke-virtual {p2, p1}, Ltbf;->d(Ljava/lang/Object;)V
    ...
    :cond_1d
    invoke-virtual {p0, p1, p2, p3}, Lcfh;->Z(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
