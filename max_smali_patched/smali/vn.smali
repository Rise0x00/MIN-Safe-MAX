...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Lvn;->c:Lsp;

    invoke-virtual {p1, p2, v6}, Lsp;->f(Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Lvn;->b:Le9;

    invoke-virtual {p1, p2, v6}, Le9;->H(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p1, p2, v0, v6}, Lu2c;->x(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lu2c;
    ...
    sget-object v3, Lsvc;->CheckedTextView:[I

    iget-object v1, p1, Lu2c;->c:Ljava/lang/Object;
    ...
    :try_start_0
    sget p2, Lsvc;->CheckedTextView_checkMarkCompat:I
    ...
    invoke-static {v3, p2}, Lafi;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-virtual {p0, p2}, Lvn;->setCheckMarkDrawable(Landroid/graphics/drawable/Drawable;)V
    :try_end_1
    ...
    :cond_0
    :try_start_2
    sget p2, Lsvc;->CheckedTextView_android_checkMark:I
    ...
    invoke-static {v2, p2}, Lafi;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    :goto_0
    sget p2, Lsvc;->CheckedTextView_checkMarkTint:I
    ...
    :cond_2
    sget p2, Lsvc;->CheckedTextView_checkMarkTintMode:I
    ...
    invoke-static {p2, v0}, Li15;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-direct {p0}, Lvn;->getEmojiTextViewHelper()Lto;

    move-result-object p1

    invoke-virtual {p1, v4, v6}, Lto;->c(Landroid/util/AttributeSet;I)V
...
.method public setCheckMarkDrawable(I)V
    ...
    invoke-virtual {p0, p1}, Lvn;->setCheckMarkDrawable(Landroid/graphics/drawable/Drawable;)V
