...
.method public final a(Lcic;Lfic;Lgj;)V
    ...
    :try_start_0
    iget-wide v0, p0, Lgb4;->b:J

    iget-wide v2, p2, Liz5;->e:J

    cmp-long p1, v0, v2

    if-lez p1, :cond_1

    iget-wide v4, p2, Liz5;->f:J
    ...
    :goto_0
    iput-wide v0, p2, Liz5;->e:J

    if-eqz p1, :cond_1

    iget-object p1, p2, Liz5;->j:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p3, Lps3;

    const/4 v0, 0x1

    invoke-direct {p3, v0, p2}, Lps3;-><init>(ILjava/lang/Object;)V
