...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "timeUnit",
        "setBackoffCriteria",
        "(Lfl0;JLjava/util/concurrent/TimeUnit;)Landroidx/work/WorkRequest$Builder;",
        "Ljava/time/Duration;",
        "duration",
        "(Lfl0;Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;",
        "Loz3;",
        "constraints",
        "setConstraints",
        "(Loz3;)Landroidx/work/WorkRequest$Builder;",
        "Ljj4;",
        "inputData",
        "setInputData",
        "(Ljj4;)Landroidx/work/WorkRequest$Builder;",
        "",
        "tag",
        "addTag",
        ...
        "policy",
        "setExpedited",
        "(Lrwb;)Landroidx/work/WorkRequest$Builder;",
        "build",
        "()Landroidx/work/WorkRequest;",
        ...
        "state",
        "setInitialState",
        "(Lkvi;)Landroidx/work/WorkRequest$Builder;",
        "",
        "runAttemptCount",
...
.method public constructor <init>(Ljava/lang/Class;)V
    ...
    invoke-direct/range {v3 .. v31}, Lfwi;-><init>(Ljava/lang/String;Lkvi;Ljava/lang/String;Ljava/lang/String;Ljj4;Ljj4;JJJLoz3;ILfl0;JJJJZLrwb;III)V

    iput-object v3, v0, Landroidx/work/WorkRequest$Builder;->workSpec:Lfwi;
    ...
    invoke-static {v1, v2}, Lav;->U0([Ljava/lang/Object;Ljava/util/HashSet;)V
...
.method public final build()Landroidx/work/WorkRequest;
    ...
    iget-object v1, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lfwi;

    iget-object v1, v1, Lfwi;->j:Loz3;

    iget-object v2, v1, Loz3;->h:Ljava/util/Set;
    ...
    iget-boolean v2, v1, Loz3;->d:Z

    if-nez v2, :cond_1

    iget-boolean v2, v1, Loz3;->b:Z

    if-nez v2, :cond_1

    iget-boolean v1, v1, Loz3;->c:Z
    ...
    :goto_1
    iget-object v2, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lfwi;

    iget-boolean v3, v2, Lfwi;->q:Z

    if-eqz v3, :cond_4

    if-nez v1, :cond_3

    iget-wide v1, v2, Lfwi;->g:J
...
.method public final getWorkSpec$work_runtime_release()Lfwi;
    .locals 1

    iget-object v0, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lfwi;
...
.method public final keepResultsForAtLeast(Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;
    ...
    invoke-static {p1}, Lbd5;->a(Ljava/time/Duration;)J

    move-result-wide v1

    iput-wide v1, v0, Lfwi;->o:J
...
.method public final setBackoffCriteria(Lfl0;JLjava/util/concurrent/TimeUnit;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1, p2}, Lfwi;->e(J)V
...
.method public final setBackoffCriteria(Lfl0;Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 7
    invoke-static {p2}, Lbd5;->a(Ljava/time/Duration;)J
...
.method public final setConstraints(Loz3;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public setExpedited(Lrwb;)Landroidx/work/WorkRequest$Builder;
    .locals 2
    ...
    iput-boolean v1, v0, Lfwi;->q:Z

    iput-object p1, v0, Lfwi;->r:Lrwb;
...
.method public final setId(Ljava/util/UUID;)Landroidx/work/WorkRequest$Builder;
    ...
    iget-object v3, v0, Landroidx/work/WorkRequest$Builder;->workSpec:Lfwi;

    iget-object v4, v3, Lfwi;->c:Ljava/lang/String;

    iget-object v5, v3, Lfwi;->b:Lkvi;

    move-object v6, v5

    iget-object v5, v3, Lfwi;->d:Ljava/lang/String;

    move-object v7, v6

    new-instance v6, Ljj4;

    iget-object v8, v3, Lfwi;->e:Ljj4;

    invoke-direct {v6, v8}, Ljj4;-><init>(Ljj4;)V

    move-object v8, v7

    new-instance v7, Ljj4;

    iget-object v9, v3, Lfwi;->f:Ljj4;

    invoke-direct {v7, v9}, Ljj4;-><init>(Ljj4;)V

    move-object v10, v8

    iget-wide v8, v3, Lfwi;->g:J

    move-object v12, v10

    iget-wide v10, v3, Lfwi;->h:J

    move-object v14, v12

    iget-wide v12, v3, Lfwi;->i:J

    new-instance v15, Loz3;

    move-object/from16 v26, v1

    iget-object v1, v3, Lfwi;->j:Loz3;
    ...
    iget-wide v4, v1, Loz3;->f:J

    move-object/from16 v25, v2

    iget-wide v1, v1, Loz3;->g:J

    move-wide/from16 v23, v1

    move-wide/from16 v21, v4

    invoke-direct/range {v15 .. v25}, Loz3;-><init>(IZZZZJJLjava/util/Set;)V

    iget v1, v3, Lfwi;->k:I

    iget-object v2, v3, Lfwi;->l:Lfl0;

    iget-wide v4, v3, Lfwi;->m:J

    move/from16 v16, v1

    move-object/from16 v17, v2

    iget-wide v1, v3, Lfwi;->n:J

    move-wide/from16 v19, v1

    iget-wide v1, v3, Lfwi;->o:J

    move-wide/from16 v21, v1

    iget-wide v1, v3, Lfwi;->p:J

    move-wide/from16 v23, v1

    iget-boolean v1, v3, Lfwi;->q:Z

    iget-object v2, v3, Lfwi;->r:Lrwb;
    ...
    invoke-direct/range {v1 .. v29}, Lfwi;-><init>(Ljava/lang/String;Lkvi;Ljava/lang/String;Ljava/lang/String;Ljj4;Ljj4;JJJLoz3;ILfl0;JJJJZLrwb;III)V

    iput-object v1, v0, Landroidx/work/WorkRequest$Builder;->workSpec:Lfwi;
...
.method public setInitialDelay(JLjava/util/concurrent/TimeUnit;)Landroidx/work/WorkRequest$Builder;
    ...
    iget-object p3, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lfwi;

    iget-wide v0, p3, Lfwi;->g:J
...
.method public setInitialDelay(Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;
    ...
    iget-object p1, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lfwi;

    iget-wide v2, p1, Lfwi;->g:J
...
.method public final setInitialState(Lkvi;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final setInputData(Ljj4;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final setWorkSpec$work_runtime_release(Lfwi;)V
    .locals 0

    iput-object p1, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lfwi;
