...
# static fields
.field public static final e1:Lb62;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/widget/SwitchCompat;->e1:Lb62;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p0, v0}, Lftf;->a(Landroid/view/View;Landroid/content/Context;)V
    ...
    invoke-static {p1, p2, v0, v5}, Lu2c;->x(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lu2c;

    move-result-object v11

    iget-object v0, v11, Lu2c;->c:Ljava/lang/Object;

    move-object v4, v0

    check-cast v4, Landroid/content/res/TypedArray;

    sget-object v2, Lsvc;->SwitchCompat:[I
    ...
    sget p1, Lsvc;->SwitchCompat_android_thumb:I

    invoke-virtual {v11, p1}, Lu2c;->q(I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    sget p1, Lsvc;->SwitchCompat_track:I
    ...
    :cond_1
    sget p1, Lsvc;->SwitchCompat_android_textOn:I
    ...
    sget p1, Lsvc;->SwitchCompat_android_textOff:I
    ...
    sget p1, Lsvc;->SwitchCompat_showText:I
    ...
    sget p1, Lsvc;->SwitchCompat_thumbTextPadding:I
    ...
    sget p1, Lsvc;->SwitchCompat_switchMinWidth:I
    ...
    sget p1, Lsvc;->SwitchCompat_switchPadding:I
    ...
    sget p1, Lsvc;->SwitchCompat_splitTrack:I
    ...
    sget p1, Lsvc;->SwitchCompat_thumbTint:I

    invoke-virtual {v11, p1}, Lu2c;->p(I)Landroid/content/res/ColorStateList;
    ...
    :cond_2
    sget p1, Lsvc;->SwitchCompat_thumbTintMode:I
    ...
    invoke-static {p1, v7}, Li15;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_5
    sget p1, Lsvc;->SwitchCompat_trackTint:I
    ...
    :cond_6
    sget p1, Lsvc;->SwitchCompat_trackTintMode:I
    ...
    :cond_9
    sget p1, Lsvc;->SwitchCompat_switchTextAppearance:I
    ...
    invoke-static {v1, v4}, Le8;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :goto_1
    sget v2, Lsvc;->TextAppearance_android_textSize:I
    ...
    :cond_c
    sget v2, Lsvc;->TextAppearance_android_typeface:I

    invoke-virtual {p1, v2, p2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v2

    sget v4, Lsvc;->TextAppearance_android_textStyle:I
    ...
    :goto_6
    sget p2, Lsvc;->TextAppearance_textAllCaps:I
    ...
    iput-object v2, p2, Lbd;->a:Ljava/util/Locale;

    iput-object p2, v0, Landroidx/appcompat/widget/SwitchCompat;->Z0:Lbd;

    goto :goto_7

    :cond_15
    iput-object v7, v0, Landroidx/appcompat/widget/SwitchCompat;->Z0:Lbd;
    ...
    invoke-virtual {p1, v3, v5}, Lsp;->f(Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0}, Landroidx/appcompat/widget/SwitchCompat;->getEmojiTextViewHelper()Lto;

    move-result-object p1

    invoke-virtual {p1, v3, v5}, Lto;->c(Landroid/util/AttributeSet;I)V
...
.method private getEmojiTextViewHelper()Lto;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->b1:Lto;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->b1:Lto;
...
.method private getThumbScrollRange()I
    ...
    invoke-static {v0}, Li15;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v0, Li15;->c:Landroid/graphics/Rect;
...
.method private setTextOffInternal(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, v0, Lto;->b:Lcua;

    iget-object v0, v0, Lcua;->b:Ljava/lang/Object;

    check-cast v0, Lmzi;

    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->Z0:Lbd;

    invoke-virtual {v0, v1}, Lmzi;->g(Landroid/text/method/TransformationMethod;)Landroid/text/method/TransformationMethod;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v5}, Li15;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v5, Li15;->c:Landroid/graphics/Rect;
    ...
    invoke-static {v2, v0, v1, v4, v3}, Ly05;->f(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public final e()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->c1:Lo95;
    ...
    invoke-direct {v1, p0}, Lo95;-><init>(Landroidx/appcompat/widget/SwitchCompat;)V

    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->c1:Lo95;

    invoke-virtual {v0, v1}, La85;->h(Ly75;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Li15;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public final onLayout(ZIIII)V
    ...
    invoke-static {p2}, Li15;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public setChecked(Z)V
    ...
    sget v1, Ljoc;->tag_state_description:I

    const/4 v5, 0x2

    invoke-direct/range {v0 .. v5}, Ldyg;-><init>(ILjava/lang/Class;III)V

    invoke-virtual {v0, p0, v6}, Lrf8;->f(Landroid/view/View;Ljava/lang/Object;)V
    ...
    sget v1, Lmuc;->abc_capital_off:I
    ...
    sget-object v1, Landroidx/appcompat/widget/SwitchCompat;->e1:Lb62;
...
.method public setTextOff(Ljava/lang/CharSequence;)V
    ...
    sget v0, Lmuc;->abc_capital_off:I
