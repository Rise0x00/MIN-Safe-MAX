...
.method public final run()V
    ...
    iget-object v0, p0, Llu0;->d:Ljava/lang/Object;
    ...
    invoke-interface {v0, v1, v2}, Lvog;->l(II)V
    ...
    invoke-virtual {v0, v1, v2}, Lyf6;->a(II)V
    ...
    iget-boolean v3, v0, Lyf6;->s0:Z

    if-eqz v3, :cond_4

    iget-boolean v3, v0, Lyf6;->t0:Z

    if-eqz v3, :cond_4

    iget-object v3, v0, Lyf6;->X:Lorg/webrtc/ScreenCapturerAndroid;
    ...
    invoke-interface {v0, v1, v3, v2}, Lcwc;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_5
    iget-object v5, v0, Lnu0;->i:Lvx5;

    iget v6, v0, Lnu0;->e:I

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v4, v6}, Liwi;->h(II)Laj7;
    ...
    invoke-virtual {v6}, Lyi7;->iterator()Ljava/util/Iterator;
    ...
    invoke-virtual {v8}, Lzi7;->nextInt()I

    move-result v8

    add-int/2addr v8, v3

    invoke-virtual {v5, v8}, Lvx5;->i(I)I
    ...
    iget-object v8, v0, Lnu0;->l:Ljava/util/Set;
    ...
    iget-object v7, v0, Lnu0;->f:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v7}, Ljava/util/concurrent/ConcurrentHashMap;->keySet()Ljava/util/Set;

    move-result-object v7

    invoke-static {v7, v5}, Lh9e;->d(Ljava/util/Set;Ljava/util/Set;)Ljava/util/Set;
    ...
    iget-object v10, v0, Lnu0;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v12, v10, Lmu0;->a:Lci4;

    invoke-virtual {v12}, Lq93;->w()Lq93;
    ...
    iget-object v12, v0, Lnu0;->a:Lpsb;

    invoke-virtual {v12}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v13, Landroid/graphics/Bitmap$Config;->ARGB_8888:Landroid/graphics/Bitmap$Config;

    invoke-virtual {v12, v1, v2, v13}, Lpsb;->c(IILandroid/graphics/Bitmap$Config;)Lq93;
    ...
    invoke-direct {v10, v13}, Lmu0;-><init>(Lci4;)V

    invoke-virtual {v12}, Lq93;->l()Lq93;

    move-result-object v12

    :goto_8
    iput-boolean v9, v10, Lmu0;->b:Z

    :try_start_1
    invoke-virtual {v0, v8, v12}, Lnu0;->f(ILq93;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    invoke-interface {v12}, Ljava/io/Closeable;->close()V

    iget-object v9, v0, Lnu0;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {v12, v0}, Ltti;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v2, v4, v1}, Liwi;->c(III)I
