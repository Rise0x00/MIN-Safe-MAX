...
.method public final onInitializeAccessibilityNodeInfo(Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-direct {v0, p2}, Li5;-><init>(Landroid/view/accessibility/AccessibilityNodeInfo;)V

    sget-object v1, Ltyg;->a:Ljava/util/WeakHashMap;

    sget v1, Ljoc;->tag_screen_reader_focusable:I
    ...
    invoke-static {p1}, Lmyg;->d(Landroid/view/View;)Z
    ...
    invoke-static {p2, v1}, Lx4;->v(Landroid/view/accessibility/AccessibilityNodeInfo;Z)V
    ...
    :cond_4
    :goto_2
    sget v1, Ljoc;->tag_accessibility_heading:I

    sget v9, Landroid/os/Build$VERSION;->SDK_INT:I

    if-lt v9, v4, :cond_5

    invoke-static {p1}, Lmyg;->c(Landroid/view/View;)Z
    ...
    invoke-static {p2, v6}, Lx4;->D(Landroid/view/accessibility/AccessibilityNodeInfo;Z)V
    ...
    :cond_a
    :goto_6
    invoke-static {p1}, Ltyg;->e(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    if-lt v7, v4, :cond_b

    invoke-static {p2, v1}, Lx4;->u(Landroid/view/accessibility/AccessibilityNodeInfo;Ljava/lang/CharSequence;)V
    ...
    invoke-static {p1}, Loyg;->b(Landroid/view/View;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, p1, v0}, Lv4;->d(Landroid/view/View;Li5;)V

    invoke-virtual {p2}, Landroid/view/accessibility/AccessibilityNodeInfo;->getText()Ljava/lang/CharSequence;

    sget p2, Ljoc;->tag_accessibility_actions:I
    ...
    invoke-virtual {v0, p2}, Li5;->b(Lc5;)V
...
.method public final performAccessibilityAction(Landroid/view/View;ILandroid/os/Bundle;)Z
    ...
    invoke-virtual {v0, p1, p2, p3}, Lv4;->g(Landroid/view/View;ILandroid/os/Bundle;)Z
