...
# direct methods
.method public static a(Ljava/util/List;)Lyq9;
    .locals 8
    ...
    invoke-static {v7, v3}, Lpyh;->j(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v4, v3}, Lhdb;-><init>([B)V

    invoke-static {v4}, Lppb;->b(Lhdb;)Lppb;
    ...
    invoke-static {v7, v4, v3}, Lpyh;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v3, v6, v4}, Ls2h;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static b(Lhdb;ZZ)Loje;
    .locals 5
    ...
    invoke-static {p1, p0, v0}, Lkei;->f(ILhdb;Z)Z

    :cond_0
    invoke-virtual {p0}, Lhdb;->o()J
    ...
    invoke-virtual {p0, p1, v1}, Lhdb;->v(ILjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v3, v4}, Lhdb;->v(ILjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Loje;-><init>(Ljava/lang/Object;)V
...
.method public static final c(Landroid/view/View;Landroid/text/Layout;Lone/me/rlottie/ImageReceiver;)V
    ...
    invoke-virtual {v0}, Luk;->d()Landroid/graphics/drawable/Drawable;

    move-result-object v3

    iget-object v4, v0, Luk;->x0:Lone/me/rlottie/RLottieDrawable;
...
.method public static f(ILhdb;Z)Z
    .locals 3
