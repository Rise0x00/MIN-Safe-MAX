...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3}, Lxkd;-><init>(Ljava/lang/String;)V

    invoke-direct {v0, v1}, Ls8a;-><init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    invoke-direct {v3, v4, v0, v1}, Lxkd;-><init>(Ljava/lang/String;IZ)V

    sput-object v3, Lyi3;->e:Lxkd;
    ...
    invoke-virtual {v3}, Ls8a;->dispose()V
...
.method public final c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lzv4;
    ...
    iget-object v0, v0, Ls8a;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lzv4;
    ...
    iget-object v1, v0, Ls8a;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    new-instance p4, Lsi7;

    invoke-direct {p4, p1, v1}, Lsi7;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    :goto_0
    invoke-virtual {p4, p1}, Lsi7;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
