...
.method public constructor <init>(Lru7;Lru7;Lru7;)V
    ...
    iput-object p3, p0, Lreb;->a:Lru7;

    iput-object p1, p0, Lreb;->b:Lru7;

    iput-object p2, p0, Lreb;->c:Lru7;
    ...
    iput-object p1, p0, Lreb;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;

    invoke-static {}, Ljava/util/concurrent/ConcurrentHashMap;->newKeySet()Ljava/util/concurrent/ConcurrentHashMap$KeySetView;

    move-result-object p1

    iput-object p1, p0, Lreb;->o:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
...
.method public final clear()V
    ...
    iget-object v0, p0, Lreb;->o:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
    ...
    invoke-virtual {v2}, Lns1;->c()V

    const/4 v3, 0x0

    iput-object v3, v2, Lns1;->s0:Lfig;

    const/4 v3, 0x0

    iput-boolean v3, v2, Lns1;->t0:Z

    goto :goto_0

    :cond_0
    iget-object v1, p0, Lreb;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
    ...
    invoke-virtual {p0}, Lreb;->c()Lru/ok/android/externcalls/sdk/Conversation;
...
.method public final onCameraChanged()V
    ...
    invoke-virtual {v2}, Ln31;->b()Z

    move-result v2

    check-cast v1, Lns1;

    iget-object v3, v1, Lns1;->u0:Lywg;

    if-eqz v3, :cond_0

    iget-boolean v3, v3, Lywg;->c:Z

    const/4 v4, 0x1

    if-ne v3, v4, :cond_0

    iget-object v1, v1, Lns1;->c:Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;
...
.method public final rebindParticipantViews()V
    ...
    iget-object v5, p0, Lreb;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final removeOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-interface {v0}, Lzh1;->s()Lywg;

    move-result-object v0

    iget-object v0, v0, Lywg;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    invoke-virtual {p0, v0, p1}, Lreb;->d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final bridge synthetic removeParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-virtual {p0, p1, p2}, Lreb;->d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final setOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    invoke-interface {p2}, Lzh1;->s()Lywg;

    move-result-object p2

    iget-object p2, p2, Lywg;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;
...
.method public final setParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    iget-object p3, p0, Lreb;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
    ...
    invoke-interface {p2}, Lru/ok/android/externcalls/sdk/video/VideoRenderManager;->getCallRenderer()Lzf1;
    ...
    invoke-static/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/ui/RendererView;->init$default(Lru/ok/android/externcalls/sdk/ui/RendererView;Lzf1;Lorg/webrtc/RendererCommon$RendererEvents;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;ILjava/lang/Object;)Z
