...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmjf;->o:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lkoh;)V
    ...
    invoke-direct {v1, p1}, Lljf;-><init>(Landroid/content/Context;)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lmjf;->a:Landroid/content/Context;

    iput-object p2, p0, Lmjf;->c:Lkoh;

    iput-object v0, p0, Lmjf;->b:Landroid/app/job/JobScheduler;

    iput-object v1, p0, Lmjf;->d:Lljf;
...
.method public static a(Landroid/app/job/JobScheduler;I)V
    ...
    sget-object v1, Lmjf;->o:Ljava/lang/String;

    invoke-virtual {v0, v1, p1, p0}, Luyh;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    sget-object v2, Lmjf;->o:Ljava/lang/String;

    const-string v3, "getAllPendingJobs() is not reliable on this device."

    invoke-virtual {v1, v2, v3, p1}, Luyh;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static f(Landroid/app/job/JobInfo;)Lcoh;
    .locals 3
    ...
    invoke-direct {v2, p0, v1}, Lcoh;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final c(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lmjf;->a:Landroid/content/Context;

    iget-object v1, p0, Lmjf;->b:Landroid/app/job/JobScheduler;

    invoke-static {v0, v1}, Lmjf;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Lmjf;->f(Landroid/app/job/JobInfo;)Lcoh;
    ...
    invoke-static {v1, v2}, Lmjf;->a(Landroid/app/job/JobScheduler;I)V

    goto :goto_2

    :cond_3
    iget-object v0, p0, Lmjf;->c:Lkoh;

    iget-object v0, v0, Lkoh;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v0}, Landroidx/work/impl/WorkDatabase;->u()Lkjf;
...
.method public final varargs e([Lzoh;)V
    .locals 11
    ...
    invoke-direct {v2, v3, v1}, Lvhd;-><init>(ILjava/lang/Object;)V
    ...
    iget-object v7, v5, Lzoh;->a:Ljava/lang/String;

    invoke-virtual {v6, v7}, Lbph;->p(Ljava/lang/String;)Lzoh;
    ...
    sget-object v9, Lmjf;->o:Ljava/lang/String;
    ...
    invoke-virtual {v5, v9, v6}, Luyh;->m(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-static {v5}, Lofi;->d(Lzoh;)Lcoh;

    move-result-object v6

    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->u()Lkjf;

    move-result-object v7

    invoke-virtual {v7, v6}, Lkjf;->h(Lcoh;)Ljjf;
    ...
    iget-object v9, v2, Lvhd;->b:Ljava/lang/Object;

    check-cast v9, Landroidx/work/impl/WorkDatabase;

    new-instance v10, Lg87;

    invoke-direct {v10, v2, v8}, Lg87;-><init>(Lvhd;I)V

    invoke-virtual {v9, v10}, Lpgd;->o(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    new-instance v7, Ljjf;

    iget-object v9, v6, Lcoh;->a:Ljava/lang/String;

    iget v6, v6, Lcoh;->b:I

    invoke-direct {v7, v9, v6, v8}, Ljjf;-><init>(Ljava/lang/String;II)V

    iget-object v6, v0, Lkoh;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v6}, Landroidx/work/impl/WorkDatabase;->u()Lkjf;

    move-result-object v6

    invoke-virtual {v6, v7}, Lkjf;->i(Ljjf;)V

    :cond_3
    invoke-virtual {p0, v5, v8}, Lmjf;->g(Lzoh;I)V
...
.method public final g(Lzoh;I)V
    .locals 18
    ...
    iget-object v3, v1, Lmjf;->b:Landroid/app/job/JobScheduler;

    iget-object v4, v1, Lmjf;->d:Lljf;

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v5, v2, Lzoh;->j:Ldr3;

    new-instance v6, Landroid/os/PersistableBundle;

    invoke-direct {v6}, Landroid/os/PersistableBundle;-><init>()V

    iget-object v7, v2, Lzoh;->a:Ljava/lang/String;
    ...
    invoke-static {v4, v6}, Lpqd;->l(Landroid/app/job/JobInfo$Builder;Landroid/net/NetworkRequest;)V
    ...
    sget-object v14, Lljf;->b:Ljava/lang/String;

    invoke-static {v6}, Lpa9;->p(I)Ljava/lang/String;
    ...
    invoke-virtual {v11, v14, v6}, Luyh;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v6, v2, Lzoh;->l:Ldg0;

    sget-object v8, Ldg0;->b:Ldg0;
    ...
    :cond_7
    iget-boolean v10, v2, Lzoh;->q:Z

    if-nez v10, :cond_8

    invoke-static {v4}, Lpqd;->k(Landroid/app/job/JobInfo$Builder;)V
    ...
    iget-boolean v11, v10, Lcr3;->b:Z

    new-instance v6, Landroid/app/job/JobInfo$TriggerContentUri;

    iget-object v10, v10, Lcr3;->a:Landroid/net/Uri;
    ...
    invoke-static {v4}, Lgu8;->o(Landroid/app/job/JobInfo$Builder;)V
    ...
    invoke-virtual {v5, v9, v8}, Luyh;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v9, v5}, Luyh;->m(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean v4, v2, Lzoh;->q:Z

    if-eqz v4, :cond_e

    iget-object v4, v2, Lzoh;->r:Ljab;

    sget-object v5, Ljab;->a:Ljab;
    :try_end_0
    ...
    invoke-virtual {v5, v9, v4}, Luyh;->a(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual/range {p0 .. p2}, Lmjf;->g(Lzoh;I)V
    :try_end_1
    ...
    invoke-virtual {v3, v9, v2, v0}, Luyh;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :goto_8
    iget-object v2, v1, Lmjf;->a:Landroid/content/Context;

    invoke-static {v2, v3}, Lmjf;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    iget-object v4, v1, Lmjf;->c:Lkoh;

    iget-object v5, v4, Lkoh;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v5}, Landroidx/work/impl/WorkDatabase;->x()Lbph;

    move-result-object v5

    invoke-virtual {v5}, Lbph;->m()Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v9, v2}, Luyh;->c(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v3, Ljava/lang/IllegalStateException;

    invoke-direct {v3, v2, v0}, Ljava/lang/IllegalStateException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object v0, v4, Lkoh;->b:Lul3;
