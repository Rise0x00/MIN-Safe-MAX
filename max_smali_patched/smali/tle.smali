...
.method public final l(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v1, p0, Ltle;->Y:Lule;

    invoke-direct {v0, v1, p2}, Ltle;-><init>(Lule;Lkotlin/coroutines/Continuation;)V

    iput-object p1, v0, Ltle;->X:Ljava/lang/Object;
...
.method public final n(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v4, p0, Ltle;->Y:Lule;

    if-eqz v0, :cond_1

    if-ne v0, v3, :cond_0

    iget-object v0, p0, Ltle;->X:Ljava/lang/Object;
    ...
    iget-object p1, p0, Ltle;->X:Ljava/lang/Object;

    move-object v0, p1

    check-cast v0, Lg54;

    iget-object p1, v4, Lule;->b:Lru7;
    ...
    :cond_2
    iput-object v0, p0, Ltle;->X:Ljava/lang/Object;

    iput v3, p0, Ltle;->o:I

    new-instance p1, Lrle;

    invoke-direct {p1, v4, v2}, Lrle;-><init>(Lule;Lkotlin/coroutines/Continuation;)V
    ...
    iget-object v0, v4, Lule;->a:Landroid/content/Context;
    ...
    iget-object v6, v4, Lole;->a:Landroid/content/Context;

    iget-object v7, v4, Lole;->b:Ljava/lang/String;

    invoke-direct {v5, v6, v7}, Landroid/content/pm/ShortcutInfo$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iget-object v6, v4, Lole;->d:Ljava/lang/String;
    ...
    iget-object v6, v4, Lole;->c:[Landroid/content/Intent;
    ...
    iget-object v6, v4, Lole;->f:Landroidx/core/graphics/drawable/IconCompat;

    if-eqz v6, :cond_6

    iget-object v7, v4, Lole;->a:Landroid/content/Context;

    invoke-static {v6, v7}, Lf77;->g(Landroidx/core/graphics/drawable/IconCompat;Landroid/content/Context;)Landroid/graphics/drawable/Icon;
    ...
    :cond_6
    iget-object v6, v4, Lole;->e:Ljava/lang/String;
    ...
    iget-object v6, v4, Lole;->j:Landroid/os/PersistableBundle;
    ...
    iget-object v7, v4, Lole;->h:Lm88;

    if-eqz v7, :cond_b

    iget-object v7, v7, Lm88;->b:Landroid/content/LocusId;

    invoke-static {v5, v7}, Ldad;->n(Landroid/content/pm/ShortcutInfo$Builder;Landroid/content/LocusId;)V

    :cond_b
    iget-boolean v4, v4, Lole;->i:Z

    invoke-static {v5, v4}, Ldad;->o(Landroid/content/pm/ShortcutInfo$Builder;Z)V

    goto :goto_4

    :cond_c
    iget-object v7, v4, Lole;->j:Landroid/os/PersistableBundle;
    ...
    iput-object v7, v4, Lole;->j:Landroid/os/PersistableBundle;
    ...
    iget-object v8, v4, Lole;->j:Landroid/os/PersistableBundle;

    const-string v9, "extraLocusId"

    iget-object v7, v7, Lm88;->a:Ljava/lang/String;
    ...
    iget-boolean v9, v4, Lole;->i:Z

    invoke-virtual {v7, v8, v9}, Landroid/os/BaseBundle;->putBoolean(Ljava/lang/String;Z)V

    iget-object v4, v4, Lole;->j:Landroid/os/PersistableBundle;
    ...
    invoke-static {v5}, La55;->d(Landroid/content/pm/ShortcutInfo$Builder;)V
