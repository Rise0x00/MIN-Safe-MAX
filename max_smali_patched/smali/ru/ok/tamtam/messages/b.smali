...
# direct methods
.method public constructor <init>(Lov8;Lia8;Lia8;Lia8;Lia8;Lia8;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/tamtam/messages/b;->a:Lov8;

    iput-object p2, p0, Lru/ok/tamtam/messages/b;->b:Lia8;

    iput-object p3, p0, Lru/ok/tamtam/messages/b;->c:Lia8;

    iput-object p4, p0, Lru/ok/tamtam/messages/b;->d:Lia8;

    iput-object p5, p0, Lru/ok/tamtam/messages/b;->e:Lia8;

    iput-object p6, p0, Lru/ok/tamtam/messages/b;->f:Lia8;
...
.method public static a(Lej2;Lcs9;)V
    .locals 9
    ...
    iget-wide v3, p1, Lfo0;->a:J

    instance-of v5, p1, Lxk3;

    iget-wide v6, p0, Lej2;->a:J
    ...
    iget-object p1, p0, Lcl3;->I0:Lxl3;

    :cond_3
    move-object v8, p1

    invoke-direct/range {v2 .. v8}, Lru/ok/tamtam/messages/ChatException$ChatMessageTypeMismatch;-><init>(JZJLxl3;)V

    const-string p0, "PreProcessDataCache"

    const-string p1, "Wrong chat/message type"

    invoke-static {p0, p1, v2}, Lnm4;->A(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static c(Ljava/util/concurrent/ConcurrentHashMap;)V
    ...
    iput-object v2, v1, Lru/ok/tamtam/messages/c;->m:Ldl4;

    iput-object v2, v1, Lru/ok/tamtam/messages/c;->n:Lsqc;
...
.method public final d(JJLgy4;)V
    .locals 7
    ...
    invoke-direct/range {v1 .. v6}, Lqqc;-><init>(JJLgy4;)V
    ...
    invoke-virtual {p1, p2, p5, p3, p4}, Lnfb;->c(Lgp8;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final e(Lej2;Lcs9;)V
    .locals 12

    iget-wide v0, p2, Lfo0;->a:J
    ...
    invoke-virtual {p0, p1, p2}, Lru/ok/tamtam/messages/b;->f(Lej2;Lcs9;)Lru/ok/tamtam/messages/c;
    ...
    iget-object v2, p0, Lru/ok/tamtam/messages/b;->d:Lia8;
    ...
    invoke-virtual {v2, v4}, Lese;->x(Z)V

    new-instance v5, Lru/ok/tamtam/messages/ChatException$WrongMessage;

    iget-wide v6, p2, Lfo0;->a:J

    iget-wide v8, p2, Lcs9;->Z:J

    iget-wide v10, p1, Lej2;->a:J
    ...
    invoke-static {v3, v2, v5}, Lnm4;->A(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_1
    invoke-static {p1, p2}, Lru/ok/tamtam/messages/b;->a(Lej2;Lcs9;)V

    const/4 v2, 0x0

    invoke-virtual {p0, v2, p2}, Lru/ok/tamtam/messages/b;->f(Lej2;Lcs9;)Lru/ok/tamtam/messages/c;

    move-result-object v2

    instance-of p2, p2, Lxk3;
    ...
    invoke-virtual {v2, p1}, Lru/ok/tamtam/messages/c;->k(Lej2;)V

    return-void
.end method

.method public final f(Lej2;Lcs9;)Lru/ok/tamtam/messages/c;
    .locals 7

    new-instance v0, Lru/ok/tamtam/messages/c;

    iget-object v1, p0, Lru/ok/tamtam/messages/b;->b:Lia8;
    ...
    iget-object v2, p0, Lru/ok/tamtam/messages/b;->c:Lia8;
    ...
    iget-object v3, p0, Lru/ok/tamtam/messages/b;->d:Lia8;
    ...
    iget-object v4, p0, Lru/ok/tamtam/messages/b;->e:Lia8;
    ...
    iget-object v4, p0, Lru/ok/tamtam/messages/b;->f:Lia8;
    ...
    invoke-direct/range {v0 .. v6}, Lru/ok/tamtam/messages/c;-><init>(Lkgb;Lh14;Lcsc;Lcs9;Lej2;Lvl;)V

    return-object v0
.end method

.method public final g(Lej2;Lcs9;)Lru/ok/tamtam/messages/c;
    .locals 12
    ...
    iget-object v4, p0, Lru/ok/tamtam/messages/b;->d:Lia8;
    ...
    invoke-virtual {v4, v2}, Lese;->x(Z)V
    ...
    iput-boolean v2, v3, Lj3e;->a:Z

    instance-of v2, p2, Lxk3;
    ...
    invoke-direct {v1, v3, p0, p2, p1}, Lpqc;-><init>(Lj3e;Lru/ok/tamtam/messages/b;Lcs9;Lej2;)V

    new-instance p2, Lzk;

    const/16 v4, 0x10

    invoke-direct {p2, v4, v1}, Lzk;-><init>(ILjava/lang/Object;)V
    ...
    iget-boolean v0, v3, Lj3e;->a:Z

    if-eqz v0, :cond_3

    invoke-virtual {p2, p1}, Lru/ok/tamtam/messages/c;->k(Lej2;)V
