...
.method public constructor <init>(Li78;)V
    ...
    iput-object v0, p0, Ll32;->a:Ljava/util/LinkedHashMap;
    ...
    iput-object v0, p0, Ll32;->b:Ljava/util/TreeMap;

    sget-object v0, Ljb0;->d:Ljb0;

    new-instance v0, Ljava/util/ArrayList;

    sget-object v1, Ljb0;->l:Ljava/util/List;
    ...
    invoke-virtual {p1, v5}, Li78;->m(I)Lhc5;
    ...
    invoke-interface {v5}, Lhc5;->d()Ljava/util/List;
    ...
    :cond_1
    invoke-interface {v5}, Lhc5;->a()I

    move-result v8

    invoke-interface {v5}, Lhc5;->b()I

    move-result v9

    invoke-interface {v5}, Lhc5;->c()Ljava/util/List;
    ...
    invoke-static {v10, v7}, Loui;->a(Ljava/lang/String;Z)V
    ...
    invoke-direct/range {v7 .. v13}, Lkc0;-><init>(IILjava/util/List;Ljava/util/List;Laa0;Lca0;)V
    ...
    invoke-static {v4, v1}, Lafi;->g(Ljava/lang/String;Ljava/lang/String;)V

    goto/16 :goto_0

    :cond_3
    iget-object v4, v3, Lkc0;->f:Lca0;
    ...
    :cond_4
    iget-object p1, p0, Ll32;->a:Ljava/util/LinkedHashMap;
    ...
    invoke-static {v4, p1}, Lafi;->c(Ljava/lang/String;Ljava/lang/String;)V

    iput-object v3, p0, Ll32;->d:Lkc0;

    iput-object v3, p0, Ll32;->c:Lkc0;
    ...
    iget-object v0, p0, Ll32;->a:Ljava/util/LinkedHashMap;
...
# virtual methods
.method public final a(Ljb0;)Lkc0;
    .locals 3
