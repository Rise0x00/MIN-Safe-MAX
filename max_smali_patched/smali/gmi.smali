...
# static fields
.field public static a:Ln4a;


# direct methods
.method public static a(Landroid/hardware/camera2/CaptureRequest$Builder;Lu9b;)V
    .locals 4
    ...
    invoke-interface {p1}, Lg0d;->i()Ljava/util/Set;
    ...
    iget-object v2, v1, Lv90;->c:Ljava/lang/Object;
    ...
    invoke-static {v2, v1}, Lafi;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static b(Landroid/hardware/camera2/CaptureRequest$Builder;ILtr0;)V
    .locals 1
...
.method public static c(Lq32;Landroid/hardware/camera2/CameraDevice;Ljava/util/HashMap;ZLtr0;)Landroid/hardware/camera2/CaptureRequest;
    .locals 9
    ...
    :cond_0
    iget-object v0, p0, Lq32;->a:Ljava/util/ArrayList;

    iget-object v1, p0, Lq32;->b:Lu9b;

    iget v2, p0, Lq32;->c:I

    iget-object v3, v1, Lu9b;->a:Ljava/util/TreeMap;
    ...
    invoke-interface {p2}, Lfz1;->n()Landroid/hardware/camera2/CaptureResult;
    ...
    invoke-static {v6, p3}, Lafi;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6, p2}, Lafi;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_3
    invoke-static {p1, v2, p4}, Lgmi;->b(Landroid/hardware/camera2/CaptureRequest$Builder;ILtr0;)V

    sget-object p2, Lq32;->k:Lv90;

    sget-object p3, Lsb0;->f:Landroid/util/Range;

    :try_start_0
    invoke-virtual {v1, p2}, Lu9b;->l(Lv90;)Ljava/lang/Object;
    ...
    sget-object p2, Lsb0;->f:Landroid/util/Range;
    ...
    sget-object p4, Lq32;->k:Lv90;

    :try_start_1
    invoke-virtual {v1, p4}, Lu9b;->l(Lv90;)Ljava/lang/Object;
    ...
    :cond_7
    invoke-virtual {p0}, Lq32;->b()I

    move-result p2

    if-eq p2, v5, :cond_a

    invoke-virtual {p0}, Lq32;->c()I
    ...
    :cond_d
    invoke-static {p1, v1}, Lgmi;->a(Landroid/hardware/camera2/CaptureRequest$Builder;Lu9b;)V
...
.method public static d(Lq32;Landroid/hardware/camera2/CameraDevice;Ltr0;)Landroid/hardware/camera2/CaptureRequest;
    .locals 3
    ...
    invoke-static {p1, v1, p2}, Lgmi;->b(Landroid/hardware/camera2/CaptureRequest$Builder;ILtr0;)V

    iget-object p0, p0, Lq32;->b:Lu9b;

    invoke-static {p1, p0}, Lgmi;->a(Landroid/hardware/camera2/CaptureRequest$Builder;Lu9b;)V
