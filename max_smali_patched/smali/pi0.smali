...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lpi0;->c:Ljava/util/HashSet;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lpi0;->a:Ljava/util/HashMap;
...
.method public final getExtra(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1, v0}, Lpi0;->getExtra(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final getExtra(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 2
    iget-object v0, p0, Lpi0;->a:Ljava/util/HashMap;
...
.method public final getImageInfo()La57;
    ...
    iget-object v0, p0, Lpi0;->b:Lcom/facebook/imagepipeline/image/ImageInfoImpl;

    if-nez v0, :cond_0

    new-instance v1, Lcom/facebook/imagepipeline/image/ImageInfoImpl;

    invoke-interface {p0}, Lq73;->getWidth()I

    move-result v2

    invoke-interface {p0}, Lq73;->getHeight()I

    move-result v3

    invoke-interface {p0}, Lq73;->getSizeInBytes()I

    move-result v4

    invoke-virtual {p0}, Lpi0;->getQualityInfo()Lh8c;

    move-result-object v5

    iget-object v6, p0, Lpi0;->a:Ljava/util/HashMap;

    invoke-direct/range {v1 .. v6}, Lcom/facebook/imagepipeline/image/ImageInfoImpl;-><init>(IIILh8c;Ljava/util/Map;)V

    iput-object v1, p0, Lpi0;->b:Lcom/facebook/imagepipeline/image/ImageInfoImpl;
...
.method public final putExtra(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    sget-object v0, Lpi0;->c:Ljava/util/HashSet;
...
.method public final putExtras(Ljava/util/Map;)V
    ...
    :cond_1
    iget-object v3, p0, Lpi0;->a:Ljava/util/HashMap;
