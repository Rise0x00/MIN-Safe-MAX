...
# direct methods
.method public constructor <init>(ZLwq6;Ljava/util/concurrent/ExecutorService;Ler6;IZZZ)V
    .locals 0
    ...
    iput-object p2, p0, Lap4;->b:Lwq6;

    iput-object p3, p0, Lap4;->c:Ljava/util/concurrent/ExecutorService;

    iput-object p4, p0, Lap4;->d:Ler6;

    iput p5, p0, Lap4;->e:I

    iput-boolean p6, p0, Lap4;->f:Z

    iput-boolean p7, p0, Lap4;->g:Z

    iput-boolean p8, p0, Lap4;->h:Z
...
# virtual methods
.method public final bridge synthetic a(Landroid/content/Context;Lfy0;Llb3;ZLi22;)Lhog;
    .locals 7

    sget-object v5, Lmu4;->a:Lmu4;
    ...
    invoke-virtual/range {v0 .. v6}, Lap4;->c(Landroid/content/Context;Lfy0;Llb3;ZLjava/util/concurrent/Executor;Lgog;)Lcp4;
...
.method public final b()Landroidx/media3/effect/DefaultVideoFrameProcessor$Factory$Builder;
    ...
    iget-object v1, p0, Lap4;->c:Ljava/util/concurrent/ExecutorService;
    ...
    iget-object v1, p0, Lap4;->b:Lwq6;

    iput-object v1, v0, Landroidx/media3/effect/DefaultVideoFrameProcessor$Factory$Builder;->b:Lwq6;

    iget-object v1, p0, Lap4;->d:Ler6;
...
.method public final c(Landroid/content/Context;Lfy0;Llb3;ZLjava/util/concurrent/Executor;Lgog;)Lcp4;
    .locals 12

    iget-object v0, p0, Lap4;->c:Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct {v5, v8, v3}, Lvo4;-><init>(Lgog;I)V

    invoke-direct {v6, v11, v4, v5}, Lww1;-><init>(Ljava/util/concurrent/ExecutorService;ZLcog;)V

    iget-object v4, p0, Lap4;->b:Lwq6;
    ...
    invoke-direct {v4, v0}, Lqoh;-><init>(I)V
    ...
    invoke-direct/range {v0 .. v10}, Lzo4;-><init>(Lap4;Landroid/content/Context;Lfy0;Llb3;ZLww1;Ljava/util/concurrent/Executor;Lgog;Lwq6;Z)V
