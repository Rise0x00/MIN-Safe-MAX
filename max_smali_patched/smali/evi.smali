...
.method public static a([B)Lzs3;
    ...
    invoke-direct {v3, v1}, Lus3;-><init>(Ljava/lang/String;)V

    :goto_0
    iput-object v3, v0, Lrs3;->u:Lus3;
    ...
    invoke-direct {v5, v4, v3, v1}, Lws3;-><init>(Lz10;Ljava/lang/String;Ljava/util/ArrayList;)V

    iput-object v5, v0, Lrs3;->w:Lws3;
    ...
    :cond_4
    sget-object v13, Lss3;->c:Lss3;

    goto :goto_4

    :cond_5
    sget-object v13, Lss3;->b:Lss3;

    goto :goto_4

    :cond_6
    sget-object v13, Lss3;->a:Lss3;

    :cond_7
    :goto_4
    new-instance v10, Lts3;

    invoke-direct {v10, v11, v13, v12}, Lts3;-><init>(Ljava/lang/String;Lss3;Ljava/lang/String;)V
    ...
    :cond_10
    sget-object v8, Lvs3;->X:Lvs3;

    goto :goto_9

    :cond_11
    sget-object v8, Lvs3;->o:Lvs3;

    goto :goto_9

    :cond_12
    sget-object v8, Lvs3;->d:Lvs3;

    goto :goto_9

    :cond_13
    sget-object v8, Lvs3;->c:Lvs3;

    goto :goto_9

    :cond_14
    sget-object v8, Lvs3;->b:Lvs3;

    goto :goto_9

    :cond_15
    sget-object v8, Lvs3;->a:Lvs3;
...
.method public static b(Lzs3;)[B
    ...
    iget-wide v2, v0, Lzs3;->a:J

    iget-object v4, v0, Lzs3;->u:Lus3;

    iget-object v5, v0, Lzs3;->i:Lxs3;

    iget-object v6, v0, Lzs3;->w:Lws3;

    iget-object v7, v0, Lzs3;->n:Ljava/util/List;

    iget-object v8, v0, Lzs3;->f:Ljava/util/List;
    ...
    iget-object v2, v0, Lzs3;->d:Ljava/lang/String;
    ...
    iget-object v2, v0, Lzs3;->o:Ljava/lang/String;
    ...
    iget-object v2, v0, Lzs3;->p:Ljava/lang/String;
    ...
    iget-object v2, v0, Lzs3;->q:Ljava/lang/String;
    ...
    iget-object v11, v14, Lts3;->a:Ljava/lang/String;
    ...
    iget-object v11, v14, Lts3;->b:Ljava/lang/String;
    ...
    iget-object v11, v14, Lts3;->c:Lss3;
    ...
    iget-object v4, v4, Lus3;->a:Ljava/lang/String;
    ...
    iget-object v2, v6, Lws3;->b:Ljava/lang/String;
    ...
    iget-object v2, v6, Lws3;->a:Lz10;

    const/4 v3, 0x0

    if-eqz v2, :cond_1e

    invoke-static {v2}, Lru/ok/tamtam/nano/b;->d(Lz10;)Lru/ok/tamtam/nano/Protos$Attaches$Attach;
    ...
    :goto_9
    iget-object v2, v6, Lws3;->c:Ljava/util/List;

    if-eqz v2, :cond_1f

    invoke-static {v2}, Lrb9;->c(Ljava/util/List;)Lru/ok/tamtam/nano/Protos$MessageElements;
