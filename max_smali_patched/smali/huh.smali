...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lhuh;->V(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    :cond_3
    invoke-virtual {p0, p1, p2, p3}, Lhuh;->T(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    :cond_5
    invoke-virtual {p0, p2, p1}, Lhuh;->U(Landroid/os/Parcel;I)Z
    ...
    iget-object p1, p3, Lidi;->f:Ltfi;

    iget-object p1, p1, Ltfi;->a:Lgyi;

    if-eqz p1, :cond_b

    iget-object p2, p3, Lidi;->e:Lsof;

    iget-object p4, p1, Lgyi;->f:Ljava/lang/Object;

    monitor-enter p4

    :try_start_0
    iget-object v0, p1, Lgyi;->e:Ljava/util/HashSet;
    ...
    invoke-direct {p2, v3, p1}, Lari;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p1}, Lgyi;->a()Landroid/os/Handler;
    ...
    :cond_b
    :goto_7
    iget-object p1, p3, Lidi;->d:Lsw4;

    const-string p2, "onGetLaunchReviewFlowInfo"

    new-array p4, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p4}, Lsw4;->d(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    new-instance p4, Lxvh;

    invoke-direct {p4, p1, p2}, Lxvh;-><init>(Landroid/app/PendingIntent;Z)V

    iget-object p1, p3, Lidi;->e:Lsof;

    invoke-virtual {p1, p4}, Lsof;->d(Ljava/lang/Object;)V
    ...
    iget-object p1, p3, Lvui;->f:Lxvi;

    iget-object p1, p1, Lxvi;->a:Lv1j;

    iget-object p2, p3, Lvui;->e:Lsof;

    invoke-virtual {p1, p2}, Lv1j;->c(Lsof;)V

    iget-object p1, p3, Lvui;->d:Lobe;

    const-string p2, "onCompleteUpdate"

    new-array p3, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p3}, Lobe;->b(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, p4, v2}, Lobe;->b(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p2, p3}, Lsof;->c(Ljava/lang/Exception;)Z

    goto/16 :goto_9

    :cond_15
    iget-object p1, p3, Lvui;->g:Lxvi;
    ...
    iget-object p1, p1, Lxvi;->d:Leyi;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v3, Ljava/io/File;

    iget-object p1, p1, Leyi;->a:Landroid/content/Context;
    ...
    invoke-static {v3}, Leyi;->a(Ljava/io/File;)J
    ...
    invoke-direct {p1, v6}, Lzq;-><init>(I)V

    invoke-virtual {p2, p1}, Lsof;->d(Ljava/lang/Object;)V
    ...
    :cond_1d
    invoke-virtual {p0, p1, p2, p3}, Lhuh;->S(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
