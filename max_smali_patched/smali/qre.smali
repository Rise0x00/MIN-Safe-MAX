...
.method public constructor <init>(Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    iput-object p1, p0, Lqre;->a:Ljava/util/concurrent/ScheduledExecutorService;

    new-instance p1, Lai3;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lqre;->b:Lai3;
...
.method public final c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lzv4;
    ...
    iget-object v2, p0, Lqre;->b:Lai3;

    invoke-direct {v1, p1, v2}, Lkod;-><init>(Ljava/lang/Runnable;Law4;)V

    iget-object p1, p0, Lqre;->b:Lai3;
    ...
    :try_start_0
    iget-object p1, p0, Lqre;->a:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    :goto_0
    invoke-virtual {v1, p1}, Lkod;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    ...
    :goto_1
    invoke-virtual {p0}, Lqre;->dispose()V
