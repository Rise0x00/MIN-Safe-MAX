...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget v3, Lgkc;->collapsingToolbarLayoutStyle:I

    const/4 v1, 0x0

    sget v4, Lya3;->S0:I

    invoke-static {p1, v1, v3, v4}, Ljj8;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    invoke-direct {v2, v0}, Lj75;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, Lya3;->y0:Lj75;

    sget-object v2, Ldvc;->CollapsingToolbarLayout:[I

    new-array v5, v7, [I

    invoke-static {v0, v1, v3, v4}, Lzsf;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    sget v2, Ldvc;->CollapsingToolbarLayout_expandedTitleGravity:I
    ...
    :cond_0
    sget v2, Ldvc;->CollapsingToolbarLayout_collapsedTitleGravity:I
    ...
    sget v2, Ldvc;->CollapsingToolbarLayout_expandedTitleMargin:I
    ...
    sget v2, Ldvc;->CollapsingToolbarLayout_expandedTitleMarginStart:I
    ...
    :cond_1
    sget v2, Ldvc;->CollapsingToolbarLayout_expandedTitleMarginEnd:I
    ...
    :cond_2
    sget v2, Ldvc;->CollapsingToolbarLayout_expandedTitleMarginTop:I
    ...
    :cond_3
    sget v2, Ldvc;->CollapsingToolbarLayout_expandedTitleMarginBottom:I
    ...
    :cond_4
    sget v2, Ldvc;->CollapsingToolbarLayout_titleEnabled:I
    ...
    sget v2, Ldvc;->CollapsingToolbarLayout_title:I
    ...
    sget v2, Lquc;->TextAppearance_Design_CollapsingToolbar_Expanded:I

    invoke-virtual {v8, v2}, Lua3;->n(I)V

    sget v2, Lwuc;->TextAppearance_AppCompat_Widget_ActionBar_Title:I

    invoke-virtual {v8, v2}, Lua3;->k(I)V

    sget v2, Ldvc;->CollapsingToolbarLayout_expandedTitleTextAppearance:I
    ...
    :cond_5
    sget v2, Ldvc;->CollapsingToolbarLayout_collapsedTitleTextAppearance:I
    ...
    :cond_6
    sget v2, Ldvc;->CollapsingToolbarLayout_titleTextEllipsize:I
    ...
    :cond_a
    sget v2, Ldvc;->CollapsingToolbarLayout_expandedTitleTextColor:I
    ...
    invoke-static {v0, v1, v2}, Lzgi;->f(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    :cond_b
    sget v2, Ldvc;->CollapsingToolbarLayout_collapsedTitleTextColor:I
    ...
    :cond_c
    sget v2, Ldvc;->CollapsingToolbarLayout_scrimVisibleHeightTrigger:I
    ...
    sget v2, Ldvc;->CollapsingToolbarLayout_maxLines:I
    ...
    :cond_e
    sget p1, Ldvc;->CollapsingToolbarLayout_titlePositionInterpolator:I
    ...
    :cond_f
    sget p1, Ldvc;->CollapsingToolbarLayout_scrimAnimationDuration:I
    ...
    sget p1, Lgkc;->motionEasingStandardInterpolator:I

    sget-object v2, Lvg;->c:Lon5;

    invoke-static {v0, p1, v2}, Luli;->d(Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Landroid/animation/TimeInterpolator;
    ...
    sget p1, Ldvc;->CollapsingToolbarLayout_contentScrim:I
    ...
    sget p1, Ldvc;->CollapsingToolbarLayout_statusBarScrim:I
    ...
    sget p1, Ldvc;->CollapsingToolbarLayout_titleCollapseMode:I
    ...
    sget p1, Ldvc;->CollapsingToolbarLayout_toolbarId:I
    ...
    sget p1, Ldvc;->CollapsingToolbarLayout_forceApplySystemWindowInsetTop:I
    ...
    sget p1, Ldvc;->CollapsingToolbarLayout_extraMultilineHeightEnabled:I
    ...
    invoke-static {p0, p1}, Lhyg;->u(Landroid/view/View;Lima;)V

    return-void
.end method

.method public static b(Landroid/view/View;)Lxzg;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lxzg;-><init>(Landroid/view/View;)V

    sget v1, Lxmc;->view_offset_helper:I
...
.method private getDefaultContentScrimColorForTitleCollapseFadeMode()I
    ...
    sget v1, Lgkc;->colorSurfaceContainer:I
    ...
    sget v1, Lglc;->design_appbar_elevation:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimension(I)F

    move-result v0

    iget-object v1, p0, Lya3;->y0:Lj75;

    iget v2, v1, Lj75;->d:I

    invoke-virtual {v1, v2, v0}, Lj75;->a(IF)I
...
.method public final a()V
    ...
    iput-object v0, p0, Lya3;->d:Landroid/view/View;
    ...
    :cond_2
    iput-object v1, p0, Lya3;->d:Landroid/view/View;
...
.method public final c()V
    ...
    iget-object v0, p0, Lya3;->o:Landroid/view/View;
    ...
    iget-object v1, p0, Lya3;->o:Landroid/view/View;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lya3;->N0:Lonh;
...
.method public final drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-object v3, p0, Lya3;->d:Landroid/view/View;
...
.method public final e(ZIIII)V
    ...
    :goto_2
    invoke-static {v3}, Lya3;->b(Landroid/view/View;)Lxzg;
    ...
    sget-object v4, Llr4;->a:Ljava/lang/ThreadLocal;
    ...
    invoke-static {p0, v3, v7}, Llr4;->b(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method public final generateLayoutParams(Landroid/util/AttributeSet;)Landroid/widget/FrameLayout$LayoutParams;
    ...
    .line 6
    sget-object v4, Ldvc;->CollapsingToolbarLayout_Layout:[I
    ...
    .line 7
    sget v1, Ldvc;->CollapsingToolbarLayout_Layout_layout_collapseMode:I
    ...
    .line 9
    sget v1, Ldvc;->CollapsingToolbarLayout_Layout_layout_collapseParallaxMultiplier:I
...
.method public final onAttachedToWindow()V
    ...
    invoke-virtual {v0, v1}, Lpn;->setLiftOnScroll(Z)V
    ...
    invoke-virtual {v0, v1}, Lpn;->a(Lmn;)V
...
.method public final onDetachedFromWindow()V
    ...
    instance-of v2, v0, Lpn;

    if-eqz v2, :cond_0

    check-cast v0, Lpn;

    iget-object v0, v0, Lpn;->u0:Ljava/util/ArrayList;
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p1, v0, Lya3;->N0:Lonh;
    ...
    invoke-static {v2}, Lya3;->b(Landroid/view/View;)Lxzg;

    move-result-object v2

    iget-object v3, v2, Lxzg;->a:Landroid/view/View;
    ...
    invoke-static {p2}, Lya3;->b(Landroid/view/View;)Lxzg;

    move-result-object p2

    invoke-virtual {p2}, Lxzg;->a()V
...
.method public final onMeasure(II)V
    ...
    iget-object p2, v3, Lya3;->d:Landroid/view/View;
...
.method public setTitleCollapseMode(I)V
    ...
    invoke-virtual {v2, v0}, Lpn;->setLiftOnScroll(Z)V
