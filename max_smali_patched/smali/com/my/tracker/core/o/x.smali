...
.method private a(Ljava/lang/String;Lcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;)Lcom/my/tracker/core/net/HttpResult;
    ...
    invoke-virtual {v1, p1}, Ltx4;->h(Ljava/lang/String;)V

    .line 32
    const-string p1, "GET"

    invoke-virtual {v1, p1, v3}, Ltx4;->e(Ljava/lang/String;Lnm4;)V
    ...
    .line 34
    invoke-interface {p2}, Lcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;->getOkHttpClient()Lb4b;
    ...
    :goto_2
    :try_start_2
    invoke-virtual {p1}, Lt9e;->close()V
    :try_end_2
...
.method private a(Ljava/lang/String;[BZLcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;)Lcom/my/tracker/core/net/HttpResult;
    ...
    .line 100
    sget-object v4, Llk9;->c:Ljava/util/regex/Pattern;
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_0

    .line 101
    :try_start_6
    invoke-static {p2}, Lhp7;->w(Ljava/lang/String;)Llk9;
    ...
    .line 103
    iget-object v6, v4, Ltx4;->c:Ljava/lang/Object;

    check-cast v6, Leyf;

    invoke-virtual {v6, p1, v5}, Leyf;->y(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 105
    invoke-static {v5, p2, p1}, Lcq4;->j(ILlk9;[B)Le8e;
    ...
    invoke-virtual {v4, p2, p1}, Ltx4;->e(Ljava/lang/String;Lnm4;)V
    ...
    .line 110
    invoke-interface {p4}, Lcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;->getOkHttpClient()Lb4b;
    ...
    .line 128
    invoke-virtual {v3}, Lt9e;->close()V
