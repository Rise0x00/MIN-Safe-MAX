...
.field public k1:Lxy0;

.field public l1:Llu9;

.field public m1:I

.field public n1:Lqoh;
...
.method public final M(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->k1:Lxy0;
    ...
    iput-object p1, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->l1:Llu9;
...
.method public final O(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-direct {v0, p3, v1}, Lqoh;-><init>(Landroid/content/Context;I)V

    iput-object v0, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->n1:Lqoh;

    invoke-virtual {p1, p3}, Landroid/view/LayoutInflater;->cloneInContext(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object p1

    iget-object v0, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->k1:Lxy0;

    iget-object v0, v0, Lxy0;->a:Llu9;
    ...
    sget v2, Lnqc;->mtrl_calendar_vertical:I
    ...
    :cond_0
    sget v2, Lnqc;->mtrl_calendar_horizontal:I
    ...
    sget v2, Lglc;->mtrl_calendar_navigation_height:I

    invoke-virtual {p2, v2}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v2

    sget v6, Lglc;->mtrl_calendar_navigation_top_padding:I
    ...
    sget v2, Lglc;->mtrl_calendar_navigation_bottom_padding:I
    ...
    sget v6, Lglc;->mtrl_calendar_days_of_week_height:I
    ...
    sget v8, Lglc;->mtrl_calendar_day_height:I
    ...
    sget v9, Lglc;->mtrl_calendar_month_vertical_padding:I
    ...
    sget v7, Lglc;->mtrl_calendar_bottom_padding:I
    ...
    sget p2, Lxmc;->mtrl_calendar_days_of_week:I
    ...
    invoke-direct {v2, v6}, Lri8;-><init>(I)V

    invoke-static {p2, v2}, Ltyg;->n(Landroid/view/View;Lv4;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->k1:Lxy0;
    ...
    invoke-direct {v6, v2}, Ljd4;-><init>(I)V

    goto :goto_1

    :cond_1
    invoke-direct {v6}, Ljd4;-><init>()V
    ...
    sget p2, Lxmc;->mtrl_calendar_months:I
    ...
    invoke-direct {p2, p0, v5, v5}, Lsi8;-><init>(Lcom/google/android/material/datepicker/MaterialCalendar;II)V
    ...
    invoke-direct {v2, v5, p0}, Lk5;-><init>(ILjava/lang/Object;)V

    invoke-direct {p2, p3, v0, v2}, Lcom/google/android/material/datepicker/c;-><init>(Landroid/view/ContextThemeWrapper;Lxy0;Lk5;)V

    iget-object v0, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->p1:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v0, p2}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Lp6d;)V

    invoke-virtual {p3}, Landroid/view/ContextThemeWrapper;->getResources()Landroid/content/res/Resources;

    move-result-object v0

    sget v2, Ldqc;->mtrl_calendar_year_selector_span:I

    invoke-virtual {v0, v2}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v0

    sget v2, Lxmc;->mtrl_calendar_year_selector_frame:I
    ...
    invoke-direct {v2, p0}, Lpqh;-><init>(Lcom/google/android/material/datepicker/MaterialCalendar;)V
    ...
    invoke-direct {v2, p0}, Lx61;-><init>(Lcom/google/android/material/datepicker/MaterialCalendar;)V
    ...
    invoke-direct {v2, v3, p0}, Ljs0;-><init>(ILjava/lang/Object;)V

    invoke-static {v0, v2}, Ltyg;->n(Landroid/view/View;Lv4;)V

    sget v2, Lxmc;->month_navigation_previous:I
    ...
    sget v2, Lxmc;->month_navigation_next:I
    ...
    sget v2, Lxmc;->mtrl_calendar_day_selector_frame:I
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->l1:Llu9;

    invoke-virtual {v2}, Llu9;->d()Ljava/lang/String;
    ...
    invoke-direct {v3, p0, p2, v0}, Lti8;-><init>(Lcom/google/android/material/datepicker/MaterialCalendar;Lcom/google/android/material/datepicker/c;Lcom/google/android/material/button/MaterialButton;)V

    invoke-virtual {v2, v3}, Landroidx/recyclerview/widget/RecyclerView;->m(Lb7d;)V

    new-instance v2, Lw6;

    const/4 v3, 0x5

    invoke-direct {v2, v3, p0}, Lw6;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v2, p0, p2, v3}, Lqi8;-><init>(Lcom/google/android/material/datepicker/MaterialCalendar;Lcom/google/android/material/datepicker/c;I)V
    ...
    invoke-direct {p3, v0}, Lmc4;-><init>(I)V

    iget-object v0, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->p1:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {p3, v0}, Lmc4;->a(Landroidx/recyclerview/widget/RecyclerView;)V

    :cond_4
    iget-object p3, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->p1:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v0, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->l1:Llu9;

    iget-object p2, p2, Lcom/google/android/material/datepicker/c;->d:Lxy0;

    iget-object p2, p2, Lxy0;->a:Llu9;

    invoke-virtual {p2, v0}, Llu9;->e(Llu9;)I
    ...
    new-instance p3, Lri8;

    const/4 v0, 0x1

    invoke-direct {p3, v0}, Lri8;-><init>(I)V

    invoke-static {p2, p3}, Ltyg;->n(Landroid/view/View;Lv4;)V
...
.method public final b0(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->l1:Llu9;
...
.method public final s0(Llu9;)V
    ...
    iget-object v1, v0, Lcom/google/android/material/datepicker/c;->d:Lxy0;

    iget-object v1, v1, Lxy0;->a:Llu9;

    invoke-virtual {v1, p1}, Llu9;->e(Llu9;)I

    move-result v1

    iget-object v2, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->l1:Llu9;

    iget-object v0, v0, Lcom/google/android/material/datepicker/c;->d:Lxy0;

    iget-object v0, v0, Lxy0;->a:Llu9;

    invoke-virtual {v0, v2}, Llu9;->e(Llu9;)I
    ...
    invoke-direct {v0, p0, v1, v2}, Lwk0;-><init>(Ljava/lang/Object;II)V
...
.method public final t0(I)V
    ...
    iget-object v3, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->l1:Llu9;

    iget v3, v3, Llu9;->c:I

    iget-object v0, v0, Lpqh;->d:Lcom/google/android/material/datepicker/MaterialCalendar;

    iget-object v0, v0, Lcom/google/android/material/datepicker/MaterialCalendar;->k1:Lxy0;
    ...
    iget-object p1, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->l1:Llu9;

    invoke-virtual {p0, p1}, Lcom/google/android/material/datepicker/MaterialCalendar;->s0(Llu9;)V
