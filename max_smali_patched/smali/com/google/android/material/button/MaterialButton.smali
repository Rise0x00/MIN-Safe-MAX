...
.field public final d:Lni8;

.field public final o:Ljava/util/LinkedHashSet;

.field public s0:Lli8;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v2, Ldvc;->MaterialButton:[I
    ...
    sget v2, Ldvc;->MaterialButton_iconPadding:I
    ...
    sget v2, Ldvc;->MaterialButton_iconTintMode:I
    ...
    invoke-static {v2, v6}, Lbei;->m(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    sget v7, Ldvc;->MaterialButton_iconTint:I

    invoke-static {v2, p2, v7}, Lzgi;->f(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    sget v7, Ldvc;->MaterialButton_icon:I

    invoke-static {v2, p2, v7}, Lzgi;->h(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    iput-object v2, p0, Lcom/google/android/material/button/MaterialButton;->v0:Landroid/graphics/drawable/Drawable;

    sget v2, Ldvc;->MaterialButton_iconGravity:I
    ...
    sget v2, Ldvc;->MaterialButton_iconSize:I
    ...
    invoke-static {v0, v1, v3, v4}, Lphe;->b(Landroid/content/Context;Landroid/util/AttributeSet;II)Lbph;
    ...
    invoke-direct {v1, p0, v0}, Lni8;-><init>(Lcom/google/android/material/button/MaterialButton;Lphe;)V

    iput-object v1, p0, Lcom/google/android/material/button/MaterialButton;->d:Lni8;
    ...
    iput-object v3, v2, Lbph;->e:Ljava/lang/Object;

    new-instance v3, Lh0;

    invoke-direct {v3, v0}, Lh0;-><init>(F)V

    iput-object v3, v2, Lbph;->f:Ljava/lang/Object;

    new-instance v3, Lh0;

    invoke-direct {v3, v0}, Lh0;-><init>(F)V

    iput-object v3, v2, Lbph;->g:Ljava/lang/Object;

    new-instance v3, Lh0;

    invoke-direct {v3, v0}, Lh0;-><init>(F)V

    iput-object v3, v2, Lbph;->h:Ljava/lang/Object;

    invoke-virtual {v2}, Lbph;->g()Lphe;

    move-result-object v0

    invoke-virtual {v1, v0}, Lni8;->c(Lphe;)V

    iput-boolean v7, v1, Lni8;->p:Z
    ...
    invoke-static {v0, v6}, Lbei;->m(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v0

    iput-object v0, v1, Lni8;->i:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    sget v2, Ldvc;->MaterialButton_backgroundTint:I
    ...
    iput-object v0, v1, Lni8;->j:Landroid/content/res/ColorStateList;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    sget v2, Ldvc;->MaterialButton_strokeColor:I

    invoke-static {v0, p2, v2}, Lzgi;->f(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    iput-object v0, v1, Lni8;->k:Landroid/content/res/ColorStateList;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    sget v2, Ldvc;->MaterialButton_rippleColor:I

    invoke-static {v0, p2, v2}, Lzgi;->f(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    iput-object v0, v1, Lni8;->l:Landroid/content/res/ColorStateList;
    ...
    sget v5, Ldvc;->MaterialButton_android_background:I
    ...
    iput-boolean v7, v1, Lni8;->o:Z

    iget-object v5, v1, Lni8;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v5, v1, Lni8;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public final b()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->d:Lni8;

    if-eqz v0, :cond_0

    iget-boolean v0, v0, Lni8;->o:Z
...
.method public final d(Z)V
    ...
    invoke-static {v0, v2}, Ly05;->h(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v2, v0}, Ly05;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method public getRippleColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lni8;->l:Landroid/content/res/ColorStateList;
...
.method public getStrokeColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lni8;->k:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lni8;->j:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, v0, Lni8;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public final onAttachedToWindow()V
    ...
    invoke-virtual {v0, v1}, Lni8;->b(Z)Lbj8;
...
.method public setBackgroundColor(I)V
    ...
    invoke-virtual {v0, p1}, Lbj8;->setTint(I)V
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v1, p0, Lcom/google/android/material/button/MaterialButton;->d:Lni8;

    iput-boolean v0, v1, Lni8;->o:Z

    iget-object v0, v1, Lni8;->a:Lcom/google/android/material/button/MaterialButton;

    iget-object v2, v1, Lni8;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, v1, Lni8;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public setCornerRadius(I)V
    ...
    iput-boolean v1, v0, Lni8;->p:Z

    iget-object v1, v0, Lni8;->b:Lphe;

    int-to-float p1, p1

    invoke-virtual {v1}, Lphe;->e()Lbph;
    ...
    iput-object v2, v1, Lbph;->e:Ljava/lang/Object;

    new-instance v2, Lh0;

    invoke-direct {v2, p1}, Lh0;-><init>(F)V

    iput-object v2, v1, Lbph;->f:Ljava/lang/Object;

    new-instance v2, Lh0;

    invoke-direct {v2, p1}, Lh0;-><init>(F)V

    iput-object v2, v1, Lbph;->g:Ljava/lang/Object;

    new-instance v2, Lh0;

    invoke-direct {v2, p1}, Lh0;-><init>(F)V

    iput-object v2, v1, Lbph;->h:Ljava/lang/Object;

    invoke-virtual {v1}, Lbph;->g()Lphe;

    move-result-object p1

    invoke-virtual {v0, p1}, Lni8;->c(Lphe;)V
...
.method public setInsetBottom(I)V
    ...
    invoke-virtual {v0, v1, p1}, Lni8;->d(II)V
...
.method public setInsetTop(I)V
    ...
    invoke-virtual {v0, p1, v1}, Lni8;->d(II)V
...
.method public setOnPressedChangeListenerInternal(Lli8;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/material/button/MaterialButton;->s0:Lli8;
...
.method public setPressed(Z)V
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->s0:Lli8;
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lni8;->a:Lcom/google/android/material/button/MaterialButton;

    iget-object v2, v0, Lni8;->l:Landroid/content/res/ColorStateList;

    if-eq v2, p1, :cond_0

    iput-object p1, v0, Lni8;->l:Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1}, Lqfd;->b(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method public setStrokeColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lni8;->k:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lni8;->k:Landroid/content/res/ColorStateList;
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lni8;->j:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lni8;->j:Landroid/content/res/ColorStateList;

    const/4 p1, 0x0

    invoke-virtual {v0, p1}, Lni8;->b(Z)Lbj8;
...
.method public setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object v1, v0, Lni8;->i:Landroid/graphics/PorterDuff$Mode;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lni8;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {p1, v0}, Ly05;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
