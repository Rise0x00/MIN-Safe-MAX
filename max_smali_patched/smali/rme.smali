...
# direct methods
.method public constructor <init>(Loc4;I)V
    .locals 3
    ...
    invoke-direct {p0, p1, v2, v0, p2}, Lasc;-><init>(Loc4;Ljava/lang/String;II)V

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1, v1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>(I)V

    iput-object p1, p0, Lrme;->Z:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1, v1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>(I)V

    iput-object p1, p0, Lrme;->z0:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public p(Ljava/lang/Long;)V
    ...
    iget-object v2, p0, Lasc;->Y:Ljava/lang/String;
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, Lrme;->Z:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {v5, v6, v3}, Lqsc;-><init>(ILjava/lang/Object;)V
    ...
    iget-object v3, p0, Lrme;->Z:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p1, v5, v6}, Lgj2;->b(Ljava/lang/Long;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_5
    :goto_1
    iget-object v2, p0, Lrme;->z0:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v3, p0, Lrme;->z0:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p1, v3, v5}, Lgj2;->b(Ljava/lang/Long;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final q(Ljava/lang/Long;Ljava/lang/String;Ljava/lang/Object;)Lqme;
    .locals 7

    sget-object v0, Lgp8;->X:Lgp8;

    invoke-virtual {p0}, Lrme;->o()Z
    ...
    invoke-static {p3, v1}, Lsb6;->j(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {p0, p3}, Lrme;->n(Ljava/lang/Object;)Z
    ...
    iget-object v4, p0, Lrme;->Z:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_6
    :goto_1
    iget-object v0, p0, Lrme;->z0:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v1, Lpl2;

    const/16 v2, 0x9

    invoke-direct {v1, p3, v2, p2}, Lpl2;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object v0, p0, Lrme;->Z:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct/range {v1 .. v6}, Lpme;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p1, Lqsc;

    const/4 p2, 0x5

    invoke-direct {p1, p2, v1}, Lqsc;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {p1, p0, v5, v2, v4}, Lqme;-><init>(Lrme;Ljava/lang/Long;Ljava/lang/Object;Ljava/lang/String;)V
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lrme;->Z:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Lrme;->z0:Ljava/util/concurrent/ConcurrentHashMap;
