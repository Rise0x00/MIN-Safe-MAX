...
.method public constructor <init>(Ldqb;)V
    ...
    iput-object v0, p0, Ldec;->a:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Ldec;->b:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Ldec;->c:Landroid/graphics/Rect;

    invoke-virtual {p0, p1}, Ldec;->onThemeChanged(Ldqb;)V
...
.method public final g(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Lx2e;)V
    ...
    iget-object p3, p4, Lx2e;->b:Landroid/util/SparseArray;
    ...
    iput-object p3, p4, Lx2e;->b:Landroid/util/SparseArray;
...
.method public final h(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Lx2e;)V
    ...
    iget-object v0, p0, Ldec;->b:Landroid/graphics/RectF;
    ...
    invoke-virtual {p2, v4}, Landroidx/recyclerview/widget/RecyclerView;->U(Landroid/view/View;)Lb3e;

    move-result-object v6

    instance-of v6, v6, Ld43;

    if-eqz v6, :cond_5

    iget-object v6, p3, Lx2e;->b:Landroid/util/SparseArray;
    ...
    iget-object v6, p0, Ldec;->c:Landroid/graphics/Rect;
    ...
    :cond_4
    iget-object v4, p0, Ldec;->a:Landroid/graphics/Paint;
...
.method public final onThemeChanged(Ldqb;)V
    ...
    iget-object v0, p0, Ldec;->a:Landroid/graphics/Paint;
