...
# direct methods
.method public constructor <init>(Lb2g;Leu;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lei5;->b:Lb2g;

    iput-object p2, p0, Lei5;->a:Leu;
...
.method public final L0(Landroidx/media3/common/PlaybackException;)V
    ...
    invoke-interface {v1, p1}, Leu;->c(Landroidx/media3/transformer/ExportException;)V
...
.method public final f0(Lf2g;)V
    ...
    iget-object v0, p0, Lei5;->a:Leu;

    const/4 v1, 0x1

    :try_start_0
    invoke-virtual {p1, v1}, Lf2g;->a(I)Z

    move-result v2

    const/4 v3, 0x2

    invoke-virtual {p1, v3}, Lf2g;->a(I)Z
    ...
    invoke-static {v4, v6, v5}, Lox1;->p(ILjava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    :cond_3
    iget-object p1, p0, Lei5;->b:Lb2g;

    if-lez v2, :cond_4

    :try_start_1
    invoke-interface {v0, v2}, Leu;->a(I)V

    iget-object p1, p1, Lb2g;->c:Ljava/lang/Object;

    check-cast p1, Lzi5;

    invoke-virtual {p1}, Ladi;->play()V
    ...
    iget-object v3, p1, Lb2g;->d:Ljava/lang/Object;
    ...
    invoke-static {v3, p1}, Le0i;->c(Landroid/content/Context;Lqs8;)Ljava/lang/String;
...
.method public final n0(Lmvf;I)V
    ...
    iget-object p2, p0, Lei5;->a:Leu;

    iget-object v0, p0, Lei5;->b:Lb2g;
    ...
    invoke-interface {p2, v1, v2}, Leu;->d(J)V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
