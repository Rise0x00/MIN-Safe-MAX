...
.method public constructor <init>(Landroid/graphics/drawable/BitmapDrawable;II)V
    ...
    iput-object p1, p0, Leab;->o:Landroid/graphics/Matrix;
    ...
    iput-object p1, p0, Leab;->Z:Landroid/graphics/Matrix;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Leab;->s0:Landroid/graphics/RectF;
...
.method public final d(Landroid/graphics/Matrix;)V
    ...
    iget-object v0, p0, Leab;->o:Landroid/graphics/Matrix;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Leab;->o:Landroid/graphics/Matrix;
...
.method public final getIntrinsicHeight()I
    ...
    :cond_0
    invoke-super {p0}, Lod6;->getIntrinsicHeight()I
    ...
    :cond_1
    :goto_0
    invoke-super {p0}, Lod6;->getIntrinsicWidth()I
...
.method public final onBoundsChange(Landroid/graphics/Rect;)V
    ...
    iget-object v6, p0, Leab;->o:Landroid/graphics/Matrix;
    ...
    :goto_1
    iget-object v1, p0, Leab;->Z:Landroid/graphics/Matrix;

    invoke-virtual {v1}, Landroid/graphics/Matrix;->reset()V

    invoke-virtual {v6, v1}, Landroid/graphics/Matrix;->invert(Landroid/graphics/Matrix;)Z

    iget-object v2, p0, Leab;->s0:Landroid/graphics/RectF;
