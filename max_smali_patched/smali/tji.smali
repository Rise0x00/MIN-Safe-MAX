...
# static fields
.field public static a:Lbli;


# direct methods
.method public static a()Lwo0;
    .locals 4

    :try_start_0
    new-instance v0, Lwo0;

    sget-object v1, Ltji;->a:Lbli;
    ...
    invoke-direct {v0, v2}, Lwo0;-><init>(Lb77;)V
    :try_end_0
...
.method public static b(Landroid/graphics/Bitmap;)Lwo0;
    .locals 3
    ...
    invoke-direct {v0, v1}, Lwo0;-><init>(Lb77;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static d(Landroid/media/MediaRoute2Info;)Lsx8;
    .locals 10
    ...
    invoke-static {p0}, Lb5;->t(Landroid/media/MediaRoute2Info;)Ljava/lang/String;

    move-result-object v2

    invoke-static {p0}, Lww8;->h(Landroid/media/MediaRoute2Info;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, v2, v3}, Lu2c;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, v1, Lu2c;->b:Ljava/lang/Object;

    check-cast v2, Landroid/os/Bundle;

    invoke-static {p0}, Lww8;->a(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lww8;->v(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lww8;->D(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lb5;->l(Landroid/media/MediaRoute2Info;)Landroid/os/Bundle;
    ...
    invoke-static {p0}, Lww8;->x(Landroid/media/MediaRoute2Info;)Ljava/lang/CharSequence;
    ...
    :cond_2
    invoke-static {p0}, Lww8;->f(Landroid/media/MediaRoute2Info;)Landroid/net/Uri;
    ...
    invoke-virtual {v1, p0}, Lu2c;->h(Ljava/util/List;)V

    :cond_6
    invoke-virtual {v1}, Lu2c;->k()Lsx8;
...
.method public static varargs e(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v3, v0, v4}, Lnx1;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
