...
.method public constructor <init>(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {p0, p1}, Lod6;-><init>(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object v0, p0, Lrid;->X:Landroid/graphics/RectF;

    const/16 v0, 0x8

    new-array v1, v0, [F

    iput-object v1, p0, Lrid;->Y:[F

    new-array v0, v0, [F

    iput-object v0, p0, Lrid;->Z:[F

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, p1}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v0, p0, Lrid;->s0:Landroid/graphics/Paint;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lrid;->t0:Z

    const/4 v0, 0x0

    iput v0, p0, Lrid;->u0:F

    iput p1, p0, Lrid;->v0:I

    iput p1, p0, Lrid;->w0:I

    iput v0, p0, Lrid;->x0:F

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lrid;->y0:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lrid;->z0:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lrid;->A0:Landroid/graphics/RectF;
...
.method public final a(IF)V
    ...
    iput p2, p0, Lrid;->u0:F

    invoke-virtual {p0}, Lrid;->p()V
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lrid;->X:Landroid/graphics/RectF;
    ...
    iget-object v2, p0, Lrid;->y0:Landroid/graphics/Path;

    iget-object v8, p0, Lrid;->s0:Landroid/graphics/Paint;
    ...
    invoke-super {p0, p1}, Lod6;->draw(Landroid/graphics/Canvas;)V
    ...
    iget-object p1, p0, Lrid;->z0:Landroid/graphics/Path;
...
.method public final m([F)V
    ...
    invoke-static {v4, v1}, Ljui;->d(Ljava/lang/String;Z)V
...
.method public final onBoundsChange(Landroid/graphics/Rect;)V
    ...
    invoke-super {p0, p1}, Lod6;->onBoundsChange(Landroid/graphics/Rect;)V
...
.method public final p()V
    ...
    iget-object v0, p0, Lrid;->y0:Landroid/graphics/Path;

    invoke-virtual {v0}, Landroid/graphics/Path;->reset()V

    iget-object v1, p0, Lrid;->z0:Landroid/graphics/Path;
    ...
    :cond_0
    iget-boolean v2, p0, Lrid;->t0:Z

    iget-object v4, p0, Lrid;->Y:[F
    ...
    :goto_0
    iget v0, p0, Lrid;->x0:F

    neg-float v0, v0

    invoke-virtual {v3, v0, v0}, Landroid/graphics/RectF;->inset(FF)V

    iget v0, p0, Lrid;->u0:F

    div-float/2addr v0, v5

    invoke-virtual {v3, v0, v0}, Landroid/graphics/RectF;->inset(FF)V

    iget-boolean v0, p0, Lrid;->t0:Z
    ...
    iget v7, p0, Lrid;->x0:F

    add-float/2addr v6, v7

    iget v7, p0, Lrid;->u0:F
