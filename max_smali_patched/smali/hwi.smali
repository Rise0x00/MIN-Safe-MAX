...
# direct methods
.method public static a(Landroid/net/Uri;Landroid/content/Context;Lak0;)Ljava/util/ArrayList;
    .locals 31
    ...
    invoke-virtual {v8, v7}, Lak0;->c(Ljava/lang/String;)Lq04;

    move-result-object v7

    if-eqz v7, :cond_4

    iget-wide v7, v7, Lq04;->b:J
    ...
    iget-object v11, v10, Lzr9;->a:Ljava/lang/String;
    ...
    invoke-direct/range {v12 .. v18}, Luo0;-><init>(IIIJLzr9;)V
    :try_end_1
    ...
    invoke-static {v2, v4, v0, v6}, Lcuh;->p(Ljava/lang/String;Ljava/lang/Exception;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_6
    ...
    :cond_a
    iget v0, v12, Luo0;->b:I

    iget v5, v12, Luo0;->c:I
    ...
    iget v11, v10, Lkhc;->c:I

    if-ne v11, v5, :cond_c

    iget v11, v10, Lkhc;->d:I
    ...
    iget v10, v9, Lkhc;->c:I

    if-gt v10, v5, :cond_1b

    iget v10, v9, Lkhc;->d:I
    ...
    :cond_1d
    iget v0, v10, Lkhc;->o:I

    goto :goto_18

    :goto_19
    iget-wide v5, v12, Luo0;->e:J

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iget v3, v12, Luo0;->b:I

    int-to-float v7, v3

    iget v8, v12, Luo0;->c:I
    ...
    iput v8, v12, Luo0;->b:I

    iput v3, v12, Luo0;->c:I
    ...
    iget v3, v14, Lkhc;->b:I

    move/from16 v17, v4

    iget v4, v10, Lkhc;->b:I
    ...
    sget-object v3, Lkhc;->s0:Lkhc;

    if-eq v14, v3, :cond_25

    sget-object v3, Lkhc;->t0:Lkhc;
    ...
    iget v4, v12, Luo0;->b:I

    goto :goto_22

    :cond_27
    iget v4, v12, Luo0;->c:I
    ...
    :cond_28
    iget v3, v12, Luo0;->d:I

    if-lez v3, :cond_2a

    iget v4, v14, Lkhc;->o:I
    ...
    invoke-direct/range {v17 .. v24}, Lmhc;-><init>(Lkhc;IIIJZ)V
    ...
    invoke-direct/range {v22 .. v29}, Lmhc;-><init>(Lkhc;IIIJZ)V
    ...
    invoke-virtual {v5, v1, v2, v6, v8}, Lnxa;->c(La98;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v3, v1, v2, v4, v8}, Lnxa;->c(La98;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static final b(Ly44;Ljava/lang/Throwable;)V
    .locals 3
    ...
    invoke-interface {v0, p0, p1}, Lb54;->i(Ly44;Ljava/lang/Throwable;)V
    :try_end_0
    ...
    :cond_0
    invoke-static {p0, p1}, Lkotlinx/coroutines/internal/CoroutineExceptionHandlerImpl_commonKt;->handleUncaughtCoroutineException(Ly44;Ljava/lang/Throwable;)V
