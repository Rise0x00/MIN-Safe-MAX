...
.method public constructor <init>(Lhng;)V
    ...
    iput-object v0, p0, Ljng;->d:Ljava/util/HashSet;

    iput-object p1, p0, Ljng;->a:Lhng;

    invoke-interface {p1}, Lhng;->H()I
    ...
    iput-object v1, p0, Ljng;->b:Landroid/util/Range;

    invoke-interface {p1}, Lhng;->U()I
    ...
    iput-object p1, p0, Ljng;->c:Landroid/util/Range;
...
.method public static a(Lhng;Landroid/util/Size;)Lhng;
    .locals 4
    ...
    invoke-interface {p0, v0, v1}, Lhng;->D(II)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-interface {p0}, Lhng;->V()Landroid/util/Range;

    move-result-object v0

    invoke-interface {p0}, Lhng;->Y()Landroid/util/Range;
    ...
    invoke-direct {v0, p0}, Ljng;-><init>(Lhng;)V
    ...
    iget-object v0, v0, Ljng;->d:Ljava/util/HashSet;
...
.method public final Q(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Ljng;->c:Landroid/util/Range;

    invoke-virtual {v1, v0}, Landroid/util/Range;->contains(Ljava/lang/Comparable;)Z

    move-result v0

    iget-object v2, p0, Ljng;->a:Lhng;
    ...
    iget-object p1, p0, Ljng;->b:Landroid/util/Range;
...
.method public final T(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Ljng;->b:Landroid/util/Range;
    ...
    iget-object p1, p0, Ljng;->c:Landroid/util/Range;
...
.method public final V()Landroid/util/Range;
    ...
    iget-object v0, p0, Ljng;->b:Landroid/util/Range;
...
.method public final W(II)Z
    ...
    invoke-interface {v0, p1, p2}, Lhng;->W(II)Z
    ...
    :cond_0
    iget-object v1, p0, Ljng;->d:Ljava/util/HashSet;
...
.method public final Y()Landroid/util/Range;
    ...
    iget-object v0, p0, Ljng;->c:Landroid/util/Range;
