...
.method public constructor <init>(Lfmh;Landroid/os/IBinder;)V
    ...
    iput-object p1, p0, Lvjh;->o:Ljava/lang/Object;
...
.method public constructor <init>(Lmkh;Ltbf;Ltbf;)V
    .locals 1
    ...
    .line 1
    iput-object p3, p0, Lvjh;->c:Ljava/lang/Object;
...
.method public final a()V
    ...
    iget-object v4, p0, Lvjh;->c:Ljava/lang/Object;
    ...
    invoke-direct {v2, v4}, Lsih;-><init>(Landroid/os/IBinder;)V

    :goto_0
    iput-object v2, v0, Lkmh;->m:Lwjh;

    iget-object v2, v0, Lkmh;->b:Lt5f;

    const-string v4, "linkToDeath"

    new-array v5, v3, [Ljava/lang/Object;

    invoke-virtual {v2, v4, v5}, Lt5f;->f(Ljava/lang/String;[Ljava/lang/Object;)V

    :try_start_0
    iget-object v4, v0, Lkmh;->m:Lwjh;

    invoke-interface {v4}, Landroid/os/IInterface;->asBinder()Landroid/os/IBinder;

    move-result-object v4

    iget-object v5, v0, Lkmh;->j:Lukh;
    ...
    iget-object v1, v2, Lt5f;->a:Ljava/lang/Object;

    check-cast v1, Ljava/lang/String;

    invoke-static {v1, v6, v5}, Lt5f;->h(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    :cond_3
    iget-object v0, v0, Lkmh;->d:Ljava/util/ArrayList;
    ...
    iget-object v4, v0, Lmkh;->a:Lkmh;

    iget-object v4, v4, Lkmh;->m:Lwjh;

    iget-object v0, v0, Lmkh;->b:Ljava/lang/String;

    new-instance v5, Landroid/os/Bundle;

    invoke-direct {v5}, Landroid/os/Bundle;-><init>()V

    sget-object v6, Lskh;->a:Ljava/util/HashMap;
    ...
    :try_start_2
    sget-object v7, Lskh;->a:Ljava/util/HashMap;
    ...
    iget-object v7, p0, Lvjh;->o:Ljava/lang/Object;

    check-cast v7, Lmkh;

    iget-object v8, p0, Lvjh;->c:Ljava/lang/Object;

    check-cast v8, Ltbf;

    iget-object v9, v7, Lmkh;->b:Ljava/lang/String;

    invoke-direct {v6, v7, v8}, Likh;-><init>(Lmkh;Ltbf;)V
    ...
    :try_start_4
    iget-object v3, v4, Lsih;->c:Landroid/os/IBinder;
    ...
    :goto_4
    iget-object v2, p0, Lvjh;->o:Ljava/lang/Object;

    check-cast v2, Lmkh;

    sget-object v3, Lmkh;->c:Lt5f;

    iget-object v2, v2, Lmkh;->b:Ljava/lang/String;
    ...
    iget-object v1, v3, Lt5f;->a:Ljava/lang/Object;

    check-cast v1, Ljava/lang/String;

    invoke-static {v1, v4, v2}, Lt5f;->h(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
