...
.field public final Z:Lihd;

.field public final o:I

.field public final s0:Lihd;
...
# direct methods
.method public constructor <init>(Ljava/lang/String;IILihd;)V
    .locals 1
    ...
    iput-object p1, p0, Luk4;->Y:Ljava/lang/String;

    iput p2, p0, Luk4;->o:I

    iput p3, p0, Luk4;->X:I

    iput-object p4, p0, Luk4;->Z:Lihd;

    new-instance p1, Lihd;

    const/16 p2, 0x14

    invoke-direct {p1, p2}, Lihd;-><init>(I)V

    iput-object p1, p0, Luk4;->s0:Lihd;
...
.method public final H(Lec4;)J
    ...
    iput-object v0, v1, Luk4;->t0:Lec4;

    const-wide/16 v12, 0x0

    iput-wide v12, v1, Luk4;->z0:J

    iput-wide v12, v1, Luk4;->y0:J

    invoke-virtual/range {p0 .. p1}, Llj0;->c(Lec4;)V
    ...
    iget-object v3, v0, Lec4;->a:Landroid/net/Uri;
    ...
    iget-object v4, v0, Lec4;->d:[B

    iget-wide v5, v0, Lec4;->f:J

    iget-wide v7, v0, Lec4;->g:J
    ...
    :goto_0
    iget-object v11, v0, Lec4;->e:Ljava/util/Map;

    const/4 v10, 0x1

    invoke-virtual/range {v1 .. v11}, Luk4;->g(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;

    move-result-object v2

    iget-wide v3, v0, Lec4;->f:J

    iget-wide v5, v0, Lec4;->g:J

    iput-object v2, v1, Luk4;->u0:Ljava/net/HttpURLConnection;

    invoke-virtual {v2}, Ljava/net/HttpURLConnection;->getResponseCode()I

    move-result v7

    iput v7, v1, Luk4;->x0:I
    ...
    sget-object v8, Ld67;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v10, v9}, Lpyh;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v9, Ld67;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v10, v5}, Lpyh;->j(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v10, v5}, Lpyh;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v2, v1, Luk4;->v0:Ljava/io/InputStream;

    if-eqz v7, :cond_a

    new-instance v2, Ljava/util/zip/GZIPInputStream;

    iget-object v6, v1, Luk4;->v0:Ljava/io/InputStream;
    ...
    :goto_6
    iput-boolean v9, v1, Luk4;->w0:Z

    invoke-virtual/range {p0 .. p1}, Llj0;->d(Lec4;)V

    :try_start_5
    invoke-virtual {v1, v3, v4}, Luk4;->h(J)V
    :try_end_5
    .catch Ljava/io/IOException; {:try_start_5 .. :try_end_5} :catch_4

    iget-wide v2, v1, Luk4;->y0:J
    ...
    :cond_c
    sget-object v8, Ld67;->b:Ljava/util/regex/Pattern;
...
.method public final close()V
    ...
    :try_start_0
    iget-object v2, p0, Luk4;->v0:Ljava/io/InputStream;
    :try_end_0
    ...
    :cond_0
    :goto_0
    iput-object v1, p0, Luk4;->v0:Ljava/io/InputStream;

    invoke-virtual {p0}, Luk4;->f()V

    iget-boolean v2, p0, Luk4;->w0:Z

    if-eqz v2, :cond_1

    iput-boolean v0, p0, Luk4;->w0:Z

    invoke-virtual {p0}, Llj0;->b()V

    :cond_1
    iput-object v1, p0, Luk4;->u0:Ljava/net/HttpURLConnection;

    iput-object v1, p0, Luk4;->t0:Lec4;
...
.method public final f()V
    ...
    iget-object v0, p0, Luk4;->u0:Ljava/net/HttpURLConnection;
...
.method public final g(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    iget-object v1, p0, Luk4;->Z:Lihd;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lihd;->r()Ljava/util/Map;
    ...
    :cond_0
    iget-object v1, p0, Luk4;->s0:Lihd;
    ...
    :cond_1
    sget-object p10, Ld67;->a:Ljava/util/regex/Pattern;
    ...
    :cond_4
    iget-object p4, p0, Luk4;->Y:Ljava/lang/String;
    ...
    invoke-static {p2}, Lec4;->b(I)Ljava/lang/String;
...
.method public final getUri()Landroid/net/Uri;
    ...
    :cond_0
    iget-object v0, p0, Luk4;->t0:Lec4;
...
.method public final h(J)V
    ...
    iget-object v5, p0, Luk4;->v0:Ljava/io/InputStream;
    ...
    invoke-virtual {p0, v4}, Llj0;->a(I)V
...
.method public final read([BII)I
    ...
    :cond_2
    iget-object v0, p0, Luk4;->v0:Ljava/io/InputStream;
    ...
    :cond_3
    iget-wide p2, p0, Luk4;->z0:J

    int-to-long v0, p1

    add-long/2addr p2, v0

    iput-wide p2, p0, Luk4;->z0:J
