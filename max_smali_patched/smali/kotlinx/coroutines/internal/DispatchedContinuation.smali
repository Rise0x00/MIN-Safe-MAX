...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "continuation",
        "<init>",
        "(Lhc4;Lkotlin/coroutines/Continuation;)V",
...
.field public final dispatcher:Lhc4;
...
.method public constructor <init>(Lhc4;Lkotlin/coroutines/Continuation;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, v0}, Lh45;-><init>(I)V

    iput-object p1, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lhc4;
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getContext()Lfc4;

    move-result-object p1

    invoke-static {p1}, Lkotlinx/coroutines/internal/ThreadContextKt;->threadContextElements(Lfc4;)Ljava/lang/Object;
...
.method private final getReusableCancellableContinuation()Lpb2;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final claimReusableCancellableContinuation$kotlinx_coroutines_core()Lpb2;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final dispatchYield$kotlinx_coroutines_core(Lfc4;Ljava/lang/Object;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput p2, p0, Lh45;->resumeMode:I

    iget-object p2, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lhc4;

    invoke-virtual {p2, p1, p0}, Lhc4;->dispatchYield(Lfc4;Ljava/lang/Runnable;)V

    return-void
.end method

.method public getCallerFrame()Lqc4;
    .locals 2
...
.method public final release$kotlinx_coroutines_core()V
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getReusableCancellableContinuation()Lpb2;
...
.method public final resumeCancellableWith$kotlinx_coroutines_core(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lhc4;

    invoke-virtual {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getContext()Lfc4;

    move-result-object v2

    invoke-static {v1, v2}, Lkotlinx/coroutines/internal/DispatchedContinuationKt;->safeIsDispatchNeeded(Lhc4;Lfc4;)Z
    ...
    iput v2, p0, Lh45;->resumeMode:I

    iget-object p1, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lhc4;

    invoke-virtual {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getContext()Lfc4;

    move-result-object v0

    invoke-static {p1, v0, p0}, Lkotlinx/coroutines/internal/DispatchedContinuationKt;->safeDispatch(Lhc4;Lfc4;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v1, p0}, Ljp5;->g0(Lh45;)V

    return-void

    :cond_1
    invoke-virtual {v1, v2}, Ljp5;->u0(Z)V
    ...
    invoke-interface {v3, v4}, Lfc4;->get(Lec4;)Ldc4;
    ...
    invoke-interface {v3}, Lz08;->getCancellationException()Ljava/util/concurrent/CancellationException;

    move-result-object p1

    invoke-virtual {p0, v0, p1}, Lh45;->cancelCompletedResult$kotlinx_coroutines_core(Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    invoke-static {v4, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lfc4;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v0, v4, v3}, Lhk0;->v0(Lkotlin/coroutines/Continuation;Lfc4;Ljava/lang/Object;)Lseh;
    ...
    :cond_4
    invoke-static {v4, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lfc4;Ljava/lang/Object;)V

    :cond_5
    :goto_1
    invoke-virtual {v1}, Ljp5;->F0()Z
    ...
    :goto_2
    invoke-virtual {v1, v2}, Ljp5;->J(Z)V
    ...
    :goto_3
    :try_start_4
    invoke-virtual {p0, p1}, Lh45;->handleFatalException$kotlinx_coroutines_core(Ljava/lang/Throwable;)V
    :try_end_4
...
.method public final resumeCancelled$kotlinx_coroutines_core(Ljava/lang/Object;)Z
    ...
    invoke-interface {v0}, Lz08;->getCancellationException()Ljava/util/concurrent/CancellationException;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Lh45;->cancelCompletedResult$kotlinx_coroutines_core(Ljava/lang/Object;Ljava/lang/Throwable;)V

    new-instance p1, Lmae;

    invoke-direct {p1, v0}, Lmae;-><init>(Ljava/lang/Throwable;)V
...
.method public final resumeUndispatchedWith$kotlinx_coroutines_core(Ljava/lang/Object;)V
    ...
    invoke-static {v2, v1}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lfc4;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v0, v2, v1}, Lhk0;->v0(Lkotlin/coroutines/Continuation;Lfc4;Ljava/lang/Object;)Lseh;
    ...
    :cond_1
    invoke-static {v2, v1}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lfc4;Ljava/lang/Object;)V
...
.method public resumeWith(Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, v0}, Ljp5;->u0(Z)V
    ...
    invoke-static {v2, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lfc4;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_2
    invoke-static {v2, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lfc4;Ljava/lang/Object;)V
    ...
    :goto_0
    invoke-virtual {v1, v0}, Ljp5;->J(Z)V
...
.method public final tryReleaseClaimedContinuation$kotlinx_coroutines_core(Lnb2;)Ljava/lang/Throwable;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
