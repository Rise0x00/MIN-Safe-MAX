...
.method public synthetic constructor <init>(Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;Landroid/content/Intent;Landroid/content/Context;ZLandroid/content/BroadcastReceiver$PendingResult;)V
    ...
    iput-object p2, p0, Lyyf;->c:Ljava/lang/Object;

    iput-object p3, p0, Lyyf;->o:Ljava/lang/Object;

    iput-boolean p4, p0, Lyyf;->b:Z

    iput-object p5, p0, Lyyf;->X:Ljava/lang/Object;

    return-void
.end method

.method public constructor <init>(Lzyf;ZLjava/io/File;Ldp5;)V
    .locals 1
    ...
    iput-object p1, p0, Lyyf;->X:Ljava/lang/Object;

    iput-boolean p2, p0, Lyyf;->b:Z

    iput-object p3, p0, Lyyf;->c:Ljava/lang/Object;

    iput-object p4, p0, Lyyf;->o:Ljava/lang/Object;
...
.method public final run()V
    ...
    iget-object v0, v1, Lyyf;->c:Ljava/lang/Object;

    check-cast v0, Landroid/content/Intent;

    iget-object v2, v1, Lyyf;->o:Ljava/lang/Object;

    check-cast v2, Landroid/content/Context;

    iget-boolean v3, v1, Lyyf;->b:Z

    iget-object v4, v1, Lyyf;->X:Ljava/lang/Object;
    ...
    invoke-direct {v5, v0}, Lw73;-><init>(Landroid/content/Intent;)V
    ...
    invoke-direct {v7, v11, v12}, Llx9;-><init>(Ljava/lang/String;I)V
    ...
    :try_start_2
    new-instance v9, Ldo3;

    invoke-direct {v9, v2, v5, v8}, Ldo3;-><init>(Landroid/content/Context;Lw73;Ljava/util/concurrent/CountDownLatch;)V
    ...
    invoke-direct {v5, v2}, Lrob;-><init>(Landroid/content/Context;)V

    invoke-virtual {v5, v0}, Lrob;->v(Landroid/content/Intent;)Lvmh;

    move-result-object v0

    invoke-static {v0}, Lud6;->e(Lcom/google/android/gms/tasks/Task;)Ljava/lang/Object;
    ...
    :pswitch_0
    iget-object v0, v1, Lyyf;->o:Ljava/lang/Object;
    ...
    iget-boolean v0, v1, Lyyf;->b:Z

    iget-object v4, v1, Lyyf;->X:Ljava/lang/Object;

    check-cast v4, Lzyf;

    iget-object v4, v4, Lkr4;->a:Ljava/io/File;
    ...
    invoke-static {v6, v7}, Lv4b;->Q(Ljava/lang/String;Ljava/lang/String;)V

    if-eqz v0, :cond_9

    :try_start_9
    invoke-static {v4}, Lu5f;->c(Ljava/io/File;)V
    ...
    :cond_9
    :goto_8
    iget-object v7, v1, Lyyf;->c:Ljava/lang/Object;

    check-cast v7, Ljava/io/File;

    const/4 v8, 0x1

    invoke-static {v7, v8, v0}, Lzyf;->i(Ljava/io/File;BZ)V
    :try_end_9
    ...
    invoke-static {v6, v0}, Lv4b;->Q(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6, v3}, Lv4b;->Q(Ljava/lang/String;Ljava/lang/String;)V
