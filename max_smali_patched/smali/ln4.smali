...
.method public constructor <init>(Ly45;)V
    ...
    iput-object v0, p0, Lln4;->o:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/16 v0, 0x10

    new-array v2, v0, [F

    iput-object v2, p0, Lln4;->X:[F

    new-array v0, v0, [F

    iput-object v0, p0, Lln4;->Y:[F

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, Lln4;->Z:Ljava/util/LinkedHashMap;

    iput v1, p0, Lln4;->s0:I

    iput-boolean v1, p0, Lln4;->t0:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lln4;->u0:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, Lln4;->d:Landroid/os/Handler;

    new-instance v0, Lfw6;

    invoke-direct {v0, v1}, Lfw6;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Lln4;->c:Lfw6;

    new-instance v0, Lbx4;

    invoke-direct {v0}, Lbx4;-><init>()V

    iput-object v0, p0, Lln4;->a:Lbx4;

    :try_start_0
    new-instance v0, Lk00;

    invoke-direct {v0, p0, p1}, Lk00;-><init>(Lln4;Ly45;)V
    ...
    :try_start_1
    invoke-virtual {p1}, Ltt1;->get()Ljava/lang/Object;
    :try_end_1
    ...
    invoke-virtual {p0}, Lln4;->release()V
...
.method public final a(Lcgf;)V
    ...
    iget-object v0, p0, Lln4;->o:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v0, p0, v1, p1}, Lhn4;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance v1, Lin4;

    const/4 v2, 0x0

    invoke-direct {v1, p1, v2}, Lin4;-><init>(Lcgf;I)V

    invoke-virtual {p0, v0, v1}, Lln4;->e(Ljava/lang/Runnable;Ljava/lang/Runnable;)V

    return-void
.end method

.method public final b(II)Lv28;
    .locals 1

    new-instance v0, Llg4;

    invoke-direct {v0, p0, p1, p2}, Llg4;-><init>(Ljava/lang/Object;II)V
...
.method public final c(Lvff;)V
    ...
    invoke-direct {v1, v2, p1}, Lcj4;-><init>(ILjava/lang/Object;)V
...
.method public final d()V
    ...
    iget-boolean v0, p0, Lln4;->t0:Z

    if-eqz v0, :cond_2

    iget v0, p0, Lln4;->s0:I

    if-nez v0, :cond_2

    iget-object v0, p0, Lln4;->Z:Ljava/util/LinkedHashMap;
    ...
    invoke-virtual {v2}, Lvff;->close()V

    goto :goto_0

    :cond_0
    iget-object v1, p0, Lln4;->u0:Ljava/util/ArrayList;
    ...
    invoke-virtual {v2, v3}, Lqt1;->d(Ljava/lang/Throwable;)Z
    ...
    iget-object v0, p0, Lln4;->a:Lbx4;

    invoke-virtual {v0}, Lbx4;->q()V

    iget-object v0, p0, Lln4;->b:Landroid/os/HandlerThread;
...
.method public final e(Ljava/lang/Runnable;Ljava/lang/Runnable;)V
    ...
    :try_start_0
    iget-object v0, p0, Lln4;->c:Lfw6;

    new-instance v1, Lhj;

    const/16 v2, 0x16

    invoke-direct {v1, p0, p2, p1, v2}, Lhj;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final f(Ljava/lang/Exception;)V
    ...
    iget-object v0, p0, Lln4;->u0:Ljava/util/ArrayList;
...
.method public final g(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v2}, Lbii;->b([FF)V

    invoke-static {v1}, Lbii;->c([F)V
    ...
    invoke-static {v6}, Lsk6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v15}, Lsk6;->b(Ljava/lang/String;)V
    ...
    invoke-static/range {v16 .. v16}, Lsk6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v7}, Lsk6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v8}, Lsk6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v9}, Lsk6;->b(Ljava/lang/String;)V
    ...
    iput-object v6, v3, Lbx4;->k:Ljava/lang/Object;
    ...
    iget-object v6, v3, Lbx4;->m:Ljava/lang/Object;

    check-cast v6, Lqk6;

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    instance-of v10, v6, Lrk6;
    ...
    invoke-static {v1}, Lsk6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lsk6;->b(Ljava/lang/String;)V
...
.method public final h(Lz4g;)V
    ...
    invoke-virtual {p0, p1}, Lln4;->f(Ljava/lang/Exception;)V
    ...
    :cond_3
    :goto_1
    iget-object v4, p1, Lz4g;->b:Ljava/lang/Object;

    check-cast v4, Landroid/util/Size;

    iget-object v5, p1, Lz4g;->c:Ljava/lang/Object;

    check-cast v5, [F

    invoke-virtual {p0, v4, v5, v9}, Lln4;->g(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    :cond_5
    iget-object v9, p1, Lz4g;->a:Ljava/lang/Object;
    ...
    iget-object v8, v8, Lx90;->c:Lqt1;

    invoke-virtual {v8, v3}, Lqt1;->b(Ljava/lang/Object;)Z
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v0, p0, Lln4;->X:[F

    invoke-virtual {p1, v0}, Landroid/graphics/SurfaceTexture;->getTransformMatrix([F)V

    iget-object v1, p0, Lln4;->Z:Ljava/util/LinkedHashMap;
    ...
    iget-object v5, p0, Lln4;->Y:[F

    invoke-virtual {v3, v5, v0}, Lvff;->w([F[F)V
    ...
    :try_start_0
    iget-object v3, p0, Lln4;->a:Lbx4;

    invoke-virtual {p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v6

    invoke-virtual {v3, v6, v7, v5, v4}, Lbx4;->t(J[FLandroid/view/Surface;)V
    :try_end_0
    ...
    invoke-static {v6, v7}, Loui;->f(Ljava/lang/String;Z)V
    ...
    invoke-static {v2, v8}, Loui;->f(Ljava/lang/String;Z)V

    new-instance v2, Lz4g;

    iget-object v3, v3, Lvff;->d:Landroid/util/Size;
    ...
    invoke-direct {v2, v4, v3, v5}, Lz4g;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    goto :goto_0

    :cond_4
    :try_start_1
    invoke-virtual {p0, v2}, Lln4;->h(Lz4g;)V
    :try_end_1
...
.method public final release()V
    ...
    invoke-direct {v0, v1, p0}, Lcj4;-><init>(ILjava/lang/Object;)V
