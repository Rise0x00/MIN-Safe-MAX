...
.method public final b(Landroid/graphics/Canvas;Landroid/graphics/Paint;II)V
    ...
    invoke-static {p3, p4}, Lwgi;->a(II)I

    move-result p3

    iget-object p4, p0, Lv15;->a:Lrk0;
    ...
    invoke-virtual/range {v1 .. v7}, Lvx7;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;FF)V

    :cond_0
    return-void
.end method

.method public final c(Landroid/graphics/Canvas;Landroid/graphics/Paint;Lu15;I)V
    .locals 9

    iget v0, p3, Lu15;->c:I

    invoke-static {v0, p4}, Lwgi;->a(II)I
    ...
    invoke-virtual/range {v1 .. v8}, Lvx7;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
...
.method public final d(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
    ...
    invoke-static {p5, p6}, Lwgi;->a(II)I
    ...
    invoke-virtual/range {v0 .. v7}, Lvx7;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
...
.method public final g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
    ...
    invoke-static {p3, v0, v1}, Lrhi;->a(FFF)F

    move-result p3

    move/from16 v2, p4

    invoke-static {v2, v0, v1}, Lrhi;->a(FFF)F
    ...
    invoke-static {v3, v1, p3}, Lohi;->b(FFF)F
    ...
    invoke-static {v3, v1, v2}, Lohi;->b(FFF)F
    ...
    invoke-static {p3, v0, v4}, Lrhi;->a(FFF)F
    ...
    invoke-static {v2, v6, v1}, Lrhi;->a(FFF)F
    ...
    invoke-virtual/range {v5 .. v11}, Lvx7;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;FF)V
