...
.method public synthetic constructor <init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Z)V
    ...
    iput-object p2, p0, Lku8;->c:Ljava/lang/Object;

    iput-object p3, p0, Lku8;->d:Ljava/lang/Object;

    iput-object p4, p0, Lku8;->o:Ljava/lang/Object;

    iput-object p5, p0, Lku8;->X:Ljava/lang/Object;

    iput-boolean p6, p0, Lku8;->b:Z
...
.method public synthetic constructor <init>(Lxmf;Lzm;ZLi78;Lonf;)V
    .locals 1
    ...
    iput-object p1, p0, Lku8;->c:Ljava/lang/Object;

    iput-object p2, p0, Lku8;->d:Ljava/lang/Object;

    iput-boolean p3, p0, Lku8;->b:Z
...
.method public final run()V
    ...
    iget-object v0, v1, Lku8;->c:Ljava/lang/Object;

    move-object v2, v0

    check-cast v2, Lxmf;

    iget-object v0, v1, Lku8;->d:Ljava/lang/Object;

    move-object v3, v0

    check-cast v3, Lzm;

    iget-object v0, v1, Lku8;->o:Ljava/lang/Object;

    move-object v9, v0

    check-cast v9, Li78;

    iget-object v0, v1, Lku8;->X:Ljava/lang/Object;
    ...
    iget-object v0, v2, Lxmf;->v0:Lru7;
    ...
    :try_start_0
    iget-object v5, v2, Lxmf;->y0:Lru7;
    ...
    iput-object v5, v3, Lzm;->c:Lan;

    invoke-virtual {v3}, Lzm;->r()Lkh;
    ...
    invoke-virtual {v2, v4}, Lxmf;->d(Lkh;)J

    move-result-wide v7
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    iget-boolean v4, v1, Lku8;->b:Z
    ...
    iget-object v4, v0, Lanf;->X:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_0
    invoke-virtual {v0, v5, v9}, Lanf;->d(Lkh;Lllf;)Z
    ...
    invoke-virtual/range {v4 .. v9}, Lw6e;->i(Lkh;ZJLllf;)V
    ...
    invoke-direct {v4, v11, v0, v12}, Lxlf;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v2, v3, v4}, Lxmf;->f(Lzm;Lxlf;)V

    invoke-interface {v10}, Lonf;->b()Lnnf;
    ...
    invoke-direct {v6, v10, v4, v7}, Lsmf;-><init>(Lonf;Lxlf;I)V

    invoke-virtual {v5, v6}, Lnnf;->a(Ljava/lang/Runnable;)V
    ...
    invoke-static {v4, v12, v0, v5}, Lcuh;->p(Ljava/lang/String;Ljava/lang/Exception;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_1
    ...
    invoke-direct {v4, v11, v5, v12}, Lxlf;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v5, v10, v4, v6}, Lsmf;-><init>(Lonf;Lxlf;I)V

    invoke-virtual {v3, v5}, Lnnf;->a(Ljava/lang/Runnable;)V

    iget-object v2, v2, Lxmf;->Z:Lvf5;
    ...
    iget-object v2, v1, Lku8;->d:Ljava/lang/Object;

    check-cast v2, Lp67;

    iget-object v3, v1, Lku8;->o:Ljava/lang/Object;

    move-object v5, v3

    check-cast v5, Lm09;

    iget-object v3, v1, Lku8;->X:Ljava/lang/Object;

    check-cast v3, Lfp3;

    iget-boolean v8, v1, Lku8;->b:Z

    iget-object v4, v0, Lu09;->e:Ljava/util/Set;
    ...
    :goto_2
    invoke-static {v2}, Lvyi;->b(Lp67;)V
    ...
    invoke-direct {v9, v2, v7}, Lg19;-><init>(Lp67;I)V

    iget-object v10, v3, Lfp3;->e:Landroid/os/Bundle;

    invoke-direct/range {v4 .. v10}, Lgz8;-><init>(Lm09;IIZLfz8;Landroid/os/Bundle;)V

    invoke-virtual {v0, v4}, Lone/me/android/media/service/OneMeMediaSessionService;->g(Lgz8;)Liz8;
    ...
    :cond_7
    invoke-virtual {v0, v3}, Lone/me/android/media/service/OneMeMediaSessionService;->a(Liz8;)V

    iget-object v0, v3, Liz8;->a:Lzz8;

    iget-object v0, v0, Lzz8;->g:Lk19;

    invoke-virtual {v0, v2, v4}, Lk19;->i(Lp67;Lgz8;)V
    :try_end_3
    ...
    invoke-static {v3, v4, v0}, Lpyh;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_4
    ...
    iget-object v4, v1, Lku8;->X:Ljava/lang/Object;

    check-cast v4, Ldy1;

    iget-object v5, v2, Lnu8;->Z:Lju8;

    iget-object v6, v2, Lnu8;->b:Lgj;

    check-cast v5, Lnl4;

    iget-object v7, v5, Lnl4;->a:Landroid/content/Context;

    sget v8, Landroid/os/Build$VERSION;->SDK_INT:I

    iget-object v9, v5, Lnl4;->c:Landroid/app/NotificationManager;
    ...
    invoke-static {v9, v8}, Lvti;->a(ILjava/lang/String;)V
    ...
    iget-object v13, v15, Lgc3;->a:Lx6e;

    if-eqz v13, :cond_b

    iget v13, v13, Lx6e;->a:I
    ...
    :cond_c
    invoke-virtual {v3}, Liz8;->a()Lrtb;

    move-result-object v0

    iget-object v9, v3, Liz8;->a:Lzz8;

    new-instance v11, Lvca;

    invoke-direct {v11, v7, v10}, Lvca;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    new-instance v10, Lo29;

    invoke-direct {v10, v3}, Lo29;-><init>(Liz8;)V
    ...
    iget-object v13, v12, Lzi5;->Y0:Lltb;

    invoke-static {v14, v8}, Lec7;->i(I[Ljava/lang/Object;)Lz8d;

    move-result-object v8

    iget-boolean v14, v9, Lzz8;->p:Z

    invoke-static {v0, v14}, Llig;->h0(Lrtb;Z)Z

    move-result v14

    const/4 v15, 0x1

    invoke-static {v8, v15, v15}, Lgc3;->e(Ljava/util/List;ZZ)Lz8d;
    ...
    invoke-virtual {v14, v0}, Lgc3;->b(Lzb7;)Lgc3;
    ...
    iget-object v14, v13, Lltb;->a:Lky5;

    invoke-virtual {v14, v0}, Lky5;->a([I)Z
    ...
    sget v14, Lbtc;->media3_controls_seek_to_previous_description:I
    ...
    :goto_9
    invoke-virtual {v13, v14}, Lltb;->a(I)Z
    ...
    sget v1, Lbtc;->media3_controls_pause_description:I
    ...
    sget v14, Lbtc;->media3_controls_play_description:I
    ...
    invoke-virtual {v0, v14}, Lgc3;->b(Lzb7;)Lgc3;
    ...
    iget-object v13, v13, Lltb;->a:Lky5;

    invoke-virtual {v13, v14}, Lky5;->a([I)Z
    ...
    sget v14, Lbtc;->media3_controls_seek_to_next_description:I
    ...
    invoke-virtual {v13, v14}, Lgc3;->b(Lzb7;)Lgc3;
    ...
    iget-object v2, v1, Lgc3;->h:Lzb7;

    if-eqz v8, :cond_15

    iget-object v0, v6, Lgj;->c:Ljava/lang/Object;
    ...
    iget-object v5, v8, Lx6e;->b:Ljava/lang/String;

    iget-object v8, v8, Lx6e;->c:Landroid/os/Bundle;
    ...
    iget-object v10, v9, Lzz8;->b:Landroid/net/Uri;
    ...
    invoke-direct {v4, v15, v14, v0}, Lhca;-><init>(Landroidx/core/graphics/drawable/IconCompat;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)V

    iget-object v0, v11, Lvca;->b:Ljava/util/ArrayList;
    ...
    :goto_11
    invoke-virtual {v6, v3, v10}, Lgj;->h(Liz8;I)Landroid/content/Intent;
    ...
    :goto_12
    invoke-direct {v5, v4, v14, v0}, Lhca;-><init>(Landroidx/core/graphics/drawable/IconCompat;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    invoke-virtual {v2, v0}, Ladi;->S(I)Z

    move-result v0

    if-eqz v0, :cond_2d

    invoke-virtual/range {v30 .. v30}, Lzi5;->G1()V

    move-object/from16 v4, v30

    iget-object v0, v4, Lzi5;->Z0:Ldu8;

    iget-object v5, v0, Ldu8;->a:Ljava/lang/CharSequence;

    invoke-static {v5}, Lvca;->b(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v5

    iput-object v5, v11, Lvca;->e:Ljava/lang/CharSequence;

    iget-object v5, v0, Ldu8;->b:Ljava/lang/CharSequence;

    invoke-virtual {v11, v5}, Lvca;->c(Ljava/lang/CharSequence;)V

    move-object/from16 v5, v32

    iget-object v7, v5, Lzz8;->m:Lmxb;

    invoke-virtual {v7}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v8, v0, Ldu8;->k:[B

    if-eqz v8, :cond_29

    invoke-virtual {v7, v8}, Lmxb;->d([B)Lv28;
    ...
    :cond_29
    iget-object v0, v0, Ldu8;->m:Landroid/net/Uri;

    if-eqz v0, :cond_2a

    invoke-virtual {v7, v0}, Lmxb;->b(Landroid/net/Uri;)Lv28;
    ...
    invoke-virtual {v11, v0}, Lvca;->f(Landroid/graphics/Bitmap;)V
    :try_end_5
    ...
    iput-object v8, v7, Lnl4;->d:Lae;

    iget-object v9, v5, Lzz8;->l:Landroid/os/Handler;
    ...
    invoke-direct {v10, v12, v9}, Lbu1;-><init>(ILjava/lang/Object;)V

    new-instance v9, Lkk6;

    const/4 v12, 0x0

    invoke-direct {v9, v0, v12, v8}, Lkk6;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-interface {v0, v9, v10}, Lv28;->e(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
    ...
    invoke-virtual {v4}, Lzi5;->f()Z

    move-result v0

    if-nez v0, :cond_2f

    invoke-virtual {v2}, Ladi;->w0()Z

    move-result v0

    if-nez v0, :cond_2f

    invoke-virtual {v4}, Lzi5;->e1()Lzsb;
    ...
    :goto_1f
    iget-object v0, v11, Lvca;->F:Landroid/app/Notification;

    iput-wide v12, v0, Landroid/app/Notification;->when:J

    iput-boolean v14, v11, Lvca;->l:Z

    iput-boolean v14, v11, Lvca;->m:Z
    ...
    iput v14, v11, Lvca;->D:I

    :cond_32
    iget-object v0, v5, Lzz8;->u:Landroid/app/PendingIntent;

    iput-object v0, v11, Lvca;->g:Landroid/app/PendingIntent;

    const/16 v2, 0x56

    invoke-virtual {v6, v3, v2}, Lgj;->h(Liz8;I)Landroid/content/Intent;
    ...
    iget-object v4, v6, Lgj;->c:Ljava/lang/Object;
    ...
    iget-object v2, v11, Lvca;->F:Landroid/app/Notification;

    iput-object v0, v2, Landroid/app/Notification;->deleteIntent:Landroid/app/PendingIntent;

    const/16 v2, 0x8

    invoke-virtual {v11, v2, v14}, Lvca;->e(IZ)V
    ...
    invoke-virtual {v11, v1}, Lvca;->h(Ljda;)V

    iput v14, v11, Lvca;->y:I

    const/4 v14, 0x0

    const/4 v15, 0x2

    invoke-virtual {v11, v15, v14}, Lvca;->e(IZ)V

    const-string v0, "media3_group_key"

    iput-object v0, v11, Lvca;->r:Ljava/lang/String;

    invoke-virtual {v11}, Lvca;->a()Landroid/app/Notification;

    move-result-object v0

    new-instance v1, Lvhd;

    invoke-direct {v1, v0}, Lvhd;-><init>(Landroid/app/Notification;)V

    move-object/from16 v2, v27

    iget-object v0, v2, Lnu8;->o:Lbu1;

    new-instance v4, Lpi5;

    move-object/from16 v5, p0

    iget-boolean v6, v5, Lku8;->b:Z

    invoke-direct {v4, v2, v3, v1, v6}, Lpi5;-><init>(Lnu8;Liz8;Lvhd;Z)V

    invoke-virtual {v0, v4}, Lbu1;->execute(Ljava/lang/Runnable;)V
