...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ltt;->a:Landroid/util/Rational;

    new-instance v0, Landroid/util/Rational;

    invoke-direct {v0, v2, v1}, Landroid/util/Rational;-><init>(II)V

    sput-object v0, Ltt;->b:Landroid/util/Rational;
    ...
    sput-object v0, Ltt;->c:Landroid/util/Rational;

    new-instance v0, Landroid/util/Rational;

    invoke-direct {v0, v2, v1}, Landroid/util/Rational;-><init>(II)V

    sput-object v0, Ltt;->d:Landroid/util/Rational;
...
.method public static a(Landroid/util/Size;Landroid/util/Rational;Landroid/util/Size;)Z
    ...
    :cond_1
    sget-object v1, Llse;->a:Landroid/util/Size;
    ...
    invoke-static {v3, p2, p1}, Ltt;->b(IILandroid/util/Rational;)Z
    ...
    invoke-static {p1, p0, v1}, Ltt;->b(IILandroid/util/Rational;)Z
    ...
    invoke-static {p0, p2, p1}, Ltt;->b(IILandroid/util/Rational;)Z
    ...
    invoke-static {p2, p0, v1}, Ltt;->b(IILandroid/util/Rational;)Z
