...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lrre;->e:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-direct {v2, v3, v0, v1}, Lxkd;-><init>(Ljava/lang/String;IZ)V

    sput-object v2, Lrre;->d:Lxkd;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lrre;->c:Ljava/util/concurrent/atomic/AtomicReference;

    sget-boolean v1, Lnpd;->a:Z

    new-instance v1, Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    const/4 v2, 0x1

    sget-object v3, Lrre;->d:Lxkd;

    invoke-direct {v1, v2, v3}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    sget-boolean v2, Lnpd;->a:Z
...
.method public final a()Lepd;
    ...
    iget-object v1, p0, Lrre;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v0, v1}, Lqre;-><init>(Ljava/util/concurrent/ScheduledExecutorService;)V
...
.method public final d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lzv4;
    ...
    sget-object v7, Lia5;->a:Lia5;

    iget-object v6, p0, Lrre;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v6, p1, v1}, Lsi7;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    :goto_0
    invoke-virtual {v6, v0}, Lsi7;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
