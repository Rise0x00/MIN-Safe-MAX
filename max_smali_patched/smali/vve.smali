...
.method public constructor <init>(Lyvi;)V
    ...
    iput-object p1, p0, Lvve;->a:Lyvi;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lvve;->b:Landroid/graphics/Rect;

    new-instance v0, Landroid/text/TextPaint;

    invoke-direct {v0}, Landroid/text/TextPaint;-><init>()V

    invoke-virtual {p1, v0}, Lyvi;->c(Landroid/text/TextPaint;)V

    iput-object v0, p0, Lvve;->c:Landroid/text/TextPaint;
...
.method public final g(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Lx2e;)V
    ...
    iget-object p4, v0, Lone/me/chats/list/ChatsListWidget;->M0:Lmx5;

    invoke-virtual {p4}, Lci8;->m()I
    ...
    iget-object v1, p0, Lvve;->c:Landroid/text/TextPaint;
...
.method public final i(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    :cond_1
    iget-object v4, p0, Lvve;->a:Lyvi;

    iget-object v5, v4, Lyvi;->a:Ljava/lang/Object;

    check-cast v5, Lone/me/chats/list/ChatsListWidget;

    iget-object v6, v5, Lone/me/chats/list/ChatsListWidget;->K0:Lf53;
    ...
    iget-object v5, v5, Lone/me/chats/list/ChatsListWidget;->M0:Lmx5;
    ...
    iget-object v4, v4, Lyvi;->b:Ljava/lang/Object;

    check-cast v4, Ljava/lang/String;

    iget-object v5, p0, Lvve;->d:Leyf;

    iget-object v6, p0, Lvve;->b:Landroid/graphics/Rect;

    invoke-virtual {v5, v6, v1, v3}, Leyf;->o(Landroid/graphics/Rect;Landroid/view/View;I)V
    ...
    iget-object v5, p0, Lvve;->c:Landroid/text/TextPaint;
...
.method public final onThemeChanged(Ldqb;)V
    ...
    iget-object p1, p0, Lvve;->c:Landroid/text/TextPaint;

    iget-object v0, p0, Lvve;->a:Lyvi;

    invoke-virtual {v0, p1}, Lyvi;->c(Landroid/text/TextPaint;)V
