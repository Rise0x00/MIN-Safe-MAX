...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lctb;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method public constructor <init>(IJJFJILjava/lang/CharSequence;JLjava/util/ArrayList;JLandroid/os/Bundle;)V
    ...
    .line 4
    iput-wide p4, p0, Lctb;->c:J

    .line 5
    iput p6, p0, Lctb;->d:F

    .line 6
    iput-wide p7, p0, Lctb;->o:J

    .line 7
    iput p9, p0, Lctb;->X:I

    .line 8
    iput-object p10, p0, Lctb;->Y:Ljava/lang/CharSequence;

    .line 9
    iput-wide p11, p0, Lctb;->Z:J
    ...
    :goto_0
    iput-object p1, p0, Lctb;->s0:Ljava/util/AbstractCollection;

    move-wide p1, p14

    .line 13
    iput-wide p1, p0, Lctb;->t0:J

    move-object/from16 p1, p16

    .line 14
    iput-object p1, p0, Lctb;->u0:Landroid/os/Bundle;
...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v0, p0, Lctb;->Y:Ljava/lang/CharSequence;

    .line 23
    sget-object v0, Lbtb;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .line 26
    :cond_0
    iput-object v0, p0, Lctb;->s0:Ljava/util/AbstractCollection;
    ...
    iput-object v0, p0, Lctb;->u0:Landroid/os/Bundle;
...
.method public static a(Landroid/media/session/PlaybackState;)Lctb;
    .locals 26
    ...
    invoke-static {v4}, Ltz8;->o(Landroid/os/Bundle;)V
    ...
    invoke-direct {v5, v6, v7, v8, v4}, Lbtb;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;ILandroid/os/Bundle;)V

    iput-object v3, v5, Lbtb;->o:Landroid/media/session/PlaybackState$CustomAction;
    ...
    invoke-static/range {v25 .. v25}, Ltz8;->o(Landroid/os/Bundle;)V
    ...
    invoke-direct/range {v9 .. v25}, Lctb;-><init>(IJJFJILjava/lang/CharSequence;JLjava/util/ArrayList;JLandroid/os/Bundle;)V

    iput-object v0, v9, Lctb;->v0:Landroid/media/session/PlaybackState;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lctb;->Y:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Lctb;->s0:Ljava/util/AbstractCollection;
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-wide v0, p0, Lctb;->o:J

    invoke-virtual {p1, v0, v1}, Landroid/os/Parcel;->writeLong(J)V

    iget-object v0, p0, Lctb;->Y:Ljava/lang/CharSequence;

    invoke-static {v0, p1, p2}, Landroid/text/TextUtils;->writeToParcel(Ljava/lang/CharSequence;Landroid/os/Parcel;I)V

    iget-object p2, p0, Lctb;->s0:Ljava/util/AbstractCollection;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeTypedList(Ljava/util/List;)V

    iget-wide v0, p0, Lctb;->t0:J

    invoke-virtual {p1, v0, v1}, Landroid/os/Parcel;->writeLong(J)V

    iget-object p2, p0, Lctb;->u0:Landroid/os/Bundle;
