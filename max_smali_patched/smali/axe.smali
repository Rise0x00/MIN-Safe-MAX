...
.method static constructor <clinit>()V
    ...
    sput-object v0, Laxe;->r:Ljava/util/regex/Pattern;
...
.method public constructor <init>(Ljava/util/List;)V
    ...
    invoke-static {v0}, Ljig;->m([B)Ljava/lang/String;
    ...
    invoke-static {v0}, Laf;->b(Ljava/lang/String;)Laf;

    move-result-object v0

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object v0, p0, Laxe;->n:Laf;
    ...
    invoke-virtual {p0, v0}, Laxe;->i(Lbjg;)V

    return-void

    :cond_0
    iput-boolean v0, p0, Laxe;->m:Z

    const/4 p1, 0x0

    iput-object p1, p0, Laxe;->n:Laf;
...
.method public static j(Ljava/lang/String;)J
    ...
    sget-object v0, Laxe;->r:Ljava/util/regex/Pattern;
...
.method public final e(IZ[B)Licf;
    ...
    invoke-direct {v3, v4, v5}, Lbjg;-><init>(I[B)V

    iget-boolean v4, v0, Laxe;->m:Z

    if-nez v4, :cond_0

    invoke-virtual {v0, v3}, Laxe;->i(Lbjg;)V

    :cond_0
    if-eqz v4, :cond_1

    iget-object v4, v0, Laxe;->n:Laf;
    ...
    :goto_0
    invoke-virtual {v3}, Lbjg;->g()Ljava/lang/String;
    ...
    invoke-static {v6}, Laf;->b(Ljava/lang/String;)Laf;
    ...
    invoke-static {v9}, Laxe;->j(Ljava/lang/String;)J
    ...
    invoke-static {v13}, Laxe;->j(Ljava/lang/String;)J
    ...
    :cond_b
    iget-object v6, v0, Laxe;->o:Ljava/util/LinkedHashMap;
    ...
    sget-object v14, Lexe;->a:Ljava/util/regex/Pattern;
    ...
    :try_start_0
    invoke-static {v3}, Lexe;->a(Ljava/lang/String;)Landroid/graphics/PointF;
    ...
    :cond_d
    :try_start_1
    sget-object v13, Lexe;->d:Ljava/util/regex/Pattern;
    ...
    invoke-static {v3}, Lgxe;->a(Ljava/lang/String;)I
    ...
    sget-object v3, Lexe;->a:Ljava/util/regex/Pattern;
    ...
    iget-boolean v3, v6, Lgxe;->f:Z

    iget-object v0, v6, Lgxe;->c:Ljava/lang/Integer;
    ...
    :pswitch_0
    invoke-static {v4, v6, v0, v8}, Lnx1;->s(Ljava/lang/String;IILjava/lang/String;)V
    ...
    invoke-direct/range {v17 .. v34}, Lq84;-><init>(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;Landroid/text/Layout$Alignment;Landroid/graphics/Bitmap;FIIFIIFFFZIIF)V

    move-object/from16 v0, v17

    invoke-static {v9, v10, v2, v1}, Laxe;->h(JLjava/util/ArrayList;Ljava/util/ArrayList;)I

    move-result v3

    invoke-static {v11, v12, v2, v1}, Laxe;->h(JLjava/util/ArrayList;Ljava/util/ArrayList;)I
    ...
    invoke-direct {v0, v1, v2, v4, v3}, Ljfc;-><init>(Ljava/lang/Object;Ljava/lang/Object;ZI)V
...
.method public final i(Lbjg;)V
    ...
    :cond_0
    :goto_0
    invoke-virtual {v2}, Lbjg;->g()Ljava/lang/String;
    ...
    invoke-static {v14}, Ldgi;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct/range {v14 .. v23}, Lcxe;-><init>(IIIIIIIII)V
    ...
    invoke-static {v5, v14, v12, v0, v13}, Lox1;->k(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :cond_14
    :try_start_1
    new-instance v18, Lgxe;

    iget v0, v10, Lcxe;->a:I
    ...
    invoke-static {v0}, Lgxe;->a(Ljava/lang/String;)I
    ...
    invoke-static {v0}, Lgxe;->c(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    invoke-static {v4, v5, v0}, Lnei;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    invoke-static {v0}, Lgxe;->b(Ljava/lang/String;)Z
    ...
    :goto_10
    invoke-direct/range {v18 .. v26}, Lgxe;-><init>(Ljava/lang/String;ILjava/lang/Integer;FZZZZ)V
    :try_end_3
    ...
    iget-object v4, v0, Lgxe;->a:Ljava/lang/String;
    ...
    :cond_1d
    iput-object v3, v1, Laxe;->o:Ljava/util/LinkedHashMap;
