...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    :cond_0
    iput-object p1, p0, Lig5;->b:Ljava/lang/CharSequence;
    ...
    invoke-direct {v0, v1, p0, p1}, Lck;-><init>(ILandroid/view/View;Ljava/lang/Object;)V

    iput-object v0, p0, Lig5;->c:Lck;
    ...
    invoke-virtual {p0}, Lig5;->getTypography()Lpef;
    ...
    iput-object p1, p0, Lig5;->o:Landroid/text/TextPaint;

    const p1, 0x7fffffff

    iput p1, p0, Lig5;->x0:I

    invoke-virtual {v0, p0}, Lsed;->l(Landroid/view/View;)Luxa;

    move-result-object p1

    invoke-virtual {p0, p1}, Lig5;->onThemeChanged(Luxa;)V
...
.method public final a(ILjava/lang/CharSequence;)Landroid/text/Layout;
    ...
    invoke-static {p2}, Li2a;->m(Ljava/lang/CharSequence;)Leje;
    ...
    iget-object v1, p0, Lig5;->a:Lyo7;

    iget-object v3, p0, Lig5;->o:Landroid/text/TextPaint;
...
.method public final b(I)V
    ...
    iget-object v0, p0, Lig5;->w0:Landroid/text/SpannableString;
    ...
    :cond_0
    invoke-virtual {p0, p1, v0}, Lig5;->a(ILjava/lang/CharSequence;)Landroid/text/Layout;

    move-result-object v1

    iput-object v1, p0, Lig5;->A0:Landroid/text/Layout;

    invoke-virtual {v1}, Landroid/text/Layout;->getLineCount()I

    move-result v1

    iget v2, p0, Lig5;->x0:I

    if-gt v1, v2, :cond_1

    iget-object p1, p0, Lig5;->A0:Landroid/text/Layout;
    ...
    iget-object v3, p0, Lig5;->b:Ljava/lang/CharSequence;
    ...
    iget-object v4, p0, Lig5;->o:Landroid/text/TextPaint;
    ...
    :cond_6
    invoke-static {v7, v0}, Lyxe;->I0(ILjava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, v4, p0}, Lmc7;-><init>(ILjava/lang/Object;)V

    new-instance v4, Landroid/text/SpannableStringBuilder;

    invoke-static {v0}, Lpih;->W(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    :goto_5
    iput-object p1, p0, Lig5;->z0:Landroid/text/Layout;

    iget-boolean v0, p0, Lig5;->D0:Z
    ...
    :cond_8
    iput-object p1, p0, Lig5;->y0:Landroid/text/Layout;
...
.method public final c()V
    ...
    invoke-virtual {p0, v0}, Lig5;->b(I)V

    const/4 v0, 0x1

    iput-boolean v0, p0, Lig5;->B0:Z
    ...
    :cond_0
    iget-object v0, p0, Lig5;->F0:Lcq0;
    ...
    iput-object v0, p0, Lig5;->F0:Lcq0;

    invoke-virtual {p0}, Landroid/view/View;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v0

    iget-object v1, p0, Lig5;->F0:Lcq0;
...
.method public final getTextLayout()Landroid/text/Layout;
    ...
    iget-object v0, p0, Lig5;->y0:Landroid/text/Layout;

    return-object v0
.end method

.method public final getTypography()Lpef;
    .locals 2

    sget-object v0, Lig5;->G0:[Ltm7;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    iget-object v0, p0, Lig5;->c:Lck;
...
.method public final onMeasure(II)V
    ...
    iget-object p2, p0, Lig5;->E0:Ljava/lang/Integer;
    ...
    :cond_0
    iget-object p2, p0, Lig5;->y0:Landroid/text/Layout;
...
.method public final onThemeChanged(Luxa;)V
    ...
    iget-object v0, p0, Lig5;->o:Landroid/text/TextPaint;

    invoke-virtual {v0, p1}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p1, p0, Lig5;->w0:Landroid/text/SpannableString;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    iget-object v1, p0, Lig5;->y0:Landroid/text/Layout;
    ...
    invoke-static {v2, v5, v1}, Lnd5;->c(FFI)I
...
.method public final setText(Landroid/text/SpannableString;)V
    ...
    .line 1
    iput-object p1, p0, Lig5;->w0:Landroid/text/SpannableString;
...
.method public final setText(Ljava/lang/CharSequence;)V
    ...
    invoke-static {p1, v0, v1}, Lt7a;->c(Ljava/lang/CharSequence;II)Landroid/text/Spannable;
    ...
    .line 6
    iput-boolean p1, p0, Lig5;->D0:Z

    .line 7
    iput-boolean p1, p0, Lig5;->B0:Z
