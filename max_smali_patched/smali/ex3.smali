...
.field public volatile k:Lyx3;

.field public volatile l:J

.field public final m:Ljava/util/concurrent/CopyOnWriteArraySet;

.field public final n:Lcx3;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/ExecutorService;Lc4;Lakg;Lia8;)V
    .locals 0
    ...
    iput-object p2, p0, Lex3;->b:Ljava/util/concurrent/ExecutorService;

    iput-object p3, p0, Lex3;->c:Lc4;

    iput-object p5, p0, Lex3;->d:Lia8;

    iput-object p4, p0, Lex3;->e:Lakg;
    ...
    iput-object p1, p0, Lex3;->f:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p3, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {p3, p2}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object p3, p0, Lex3;->g:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p3, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {p3, p2}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object p3, p0, Lex3;->h:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p3, Lax3;

    const/4 p4, 0x0

    invoke-direct {p3, p0, p4}, Lax3;-><init>(Lex3;I)V

    new-instance p4, Lakg;

    invoke-direct {p4, p3}, Lakg;-><init>(Lxs6;)V

    iput-object p4, p0, Lex3;->i:Lakg;
    ...
    iput-object p4, p0, Lex3;->j:Lakg;

    sget-object p3, Lyx3;->b:Lyx3;

    iput-object p3, p0, Lex3;->k:Lyx3;

    new-instance p3, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {p3}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object p3, p0, Lex3;->m:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance p3, Lcx3;

    const/4 p4, 0x0

    invoke-direct {p3, p4, p0}, Lcx3;-><init>(ILjava/lang/Object;)V

    iput-object p3, p0, Lex3;->n:Lcx3;

    new-instance p3, Ljava/util/concurrent/atomic/AtomicReference;

    sget-object p4, Lbx3;->f:Lbx3;

    invoke-direct {p3, p4}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object p3, p0, Lex3;->o:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object p3, p0, Lex3;->p:Ljava/lang/String;

    invoke-virtual {p0, p2}, Lex3;->o(Z)Z

    move-result p2

    invoke-virtual {p1, p2}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    invoke-virtual {p0}, Lex3;->n()V

    return-void
.end method

.method public static j(Lex3;)Landroid/net/NetworkCapabilities;
    .locals 4

    invoke-virtual {p0}, Lex3;->i()Landroid/net/Network;
    ...
    :try_start_0
    invoke-virtual {p0}, Lex3;->l()Landroid/net/ConnectivityManager;
    ...
    iget-object p0, p0, Lex3;->p:Ljava/lang/String;
    ...
    invoke-virtual {v0, v2, p0, v3, v1}, Lnfb;->c(Lgp8;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_0
...
.method public static k(Landroid/net/NetworkCapabilities;Landroid/net/NetworkInfo;)Lyx3;
    .locals 3
    ...
    sget-object p0, Lyx3;->o:Lyx3;

    return-object p0

    :cond_5
    sget-object p0, Lyx3;->X:Lyx3;

    return-object p0

    :cond_6
    :goto_0
    sget-object p0, Lyx3;->b:Lyx3;

    return-object p0

    :cond_7
    :goto_1
    sget-object p0, Lyx3;->c:Lyx3;
...
.method public final b()Lyx3;
    ...
    invoke-virtual {p0, v2}, Lex3;->m(Landroid/net/Network;)Landroid/net/NetworkInfo;

    move-result-object v1

    invoke-static {v0, v1}, Lex3;->k(Landroid/net/NetworkCapabilities;Landroid/net/NetworkInfo;)Lyx3;
    ...
    invoke-virtual {v3, v2, v0}, Ljd4;->a(Ljava/lang/String;Ljava/lang/Throwable;)V

    :goto_0
    iput-object v1, p0, Lex3;->k:Lyx3;
...
.method public final d(Lww3;)V
    ...
    iget-object v0, p0, Lex3;->m:Ljava/util/concurrent/CopyOnWriteArraySet;
...
.method public final e()Z
    ...
    iget-object v0, p0, Lex3;->o:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v1, p0, Lex3;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-boolean v0, v0, Lbx3;->e:Z

    return v0

    :cond_0
    invoke-static {p0}, Lex3;->j(Lex3;)Landroid/net/NetworkCapabilities;
...
.method public final g()Z
    ...
    iget-object v0, p0, Lex3;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v1, p0, Lex3;->p:Ljava/lang/String;
    ...
    invoke-virtual {v1, v0}, Lfb8;->a(Ljava/lang/Throwable;)V
...
.method public final invalidate()V
    ...
    iget-object v0, p0, Lex3;->p:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lex3;->o(Z)Z
    ...
    invoke-virtual {p0, v2}, Lex3;->p(Lgzb;)Lbx3;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {p0, v0}, Lex3;->q(Lbx3;)V
...
.method public final m(Landroid/net/Network;)Landroid/net/NetworkInfo;
    ...
    iget-object v3, p0, Lex3;->p:Ljava/lang/String;
...
.method public final n()V
    ...
    iget-object v0, p0, Lex3;->g:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v3, v5, v0, v6, v4}, Lnfb;->c(Lgp8;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :try_start_0
    iget-object v3, p0, Lex3;->a:Landroid/content/Context;

    new-instance v5, Lcs0;

    const/4 v6, 0x2

    invoke-direct {v5, v6, p0}, Lcs0;-><init>(ILjava/lang/Object;)V
    ...
    invoke-static {v3, v5, v6, v4, v7}, Lg84;->v0(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;I)Landroid/content/Intent;
    ...
    :goto_2
    iget-object v4, p0, Lex3;->p:Ljava/lang/String;
    ...
    iget-object v4, p0, Lex3;->h:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v2, v4}, Lfb8;->a(Ljava/lang/Throwable;)V
...
.method public final o(Z)Z
    ...
    invoke-virtual {v0, p1}, Lfb8;->a(Ljava/lang/Throwable;)V
    ...
    iget-object p1, p0, Lex3;->p:Ljava/lang/String;
    ...
    :goto_3
    iget-object v0, p0, Lex3;->c:Lc4;

    const-string v1, "ConnectionInfo"

    const-string v3, "Unable to register default network callback"

    invoke-static {v1, v3, p1}, Lnm4;->m0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0, v2, p1}, Ljd4;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final p(Lgzb;)Lbx3;
    .locals 14
    ...
    :cond_d
    invoke-virtual {p0, v3}, Lex3;->m(Landroid/net/Network;)Landroid/net/NetworkInfo;
    ...
    invoke-direct/range {v8 .. v13}, Lbx3;-><init>(ZZZZZ)V
    ...
    invoke-static {v5, v6, v7, v10, v2}, Lsb6;->t(JLjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final q(Lbx3;)V
    .locals 7

    sget-object v0, Lgp8;->c:Lgp8;

    iget-object v1, p0, Lex3;->o:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_2
    iget-object v2, p0, Lex3;->o:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {v2, p1}, Ljava/util/concurrent/atomic/AtomicReference;->set(Ljava/lang/Object;)V

    iget-boolean v1, v1, Lbx3;->e:Z

    iget-boolean v2, p1, Lbx3;->e:Z
    ...
    iget-boolean v4, p1, Lbx3;->e:Z

    const-string v5, "updateInet, vpn changed to "

    const-string v6, ", reset dns ..."

    invoke-static {v5, v6, v4}, Lrtc;->s(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    :cond_9
    :goto_2
    iget-object p1, p0, Lex3;->b:Ljava/util/concurrent/ExecutorService;
