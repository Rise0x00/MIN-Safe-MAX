...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lukg;->o:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lpvi;)V
    .locals 2
    ...
    invoke-direct {v1, p1}, Ltkg;-><init>(Landroid/content/Context;)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lukg;->a:Landroid/content/Context;

    iput-object p2, p0, Lukg;->c:Lpvi;

    iput-object v0, p0, Lukg;->b:Landroid/app/job/JobScheduler;

    iput-object v1, p0, Lukg;->d:Ltkg;
...
.method public static a(Landroid/app/job/JobScheduler;I)V
    ...
    sget-object v1, Lukg;->o:Ljava/lang/String;

    invoke-virtual {v0, v1, p1, p0}, Lvfa;->x(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    sget-object v2, Lukg;->o:Ljava/lang/String;

    const-string v3, "getAllPendingJobs() is not reliable on this device."

    invoke-virtual {v1, v2, v3, p1}, Lvfa;->x(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static f(Landroid/app/job/JobInfo;)Ljvi;
    .locals 3
    ...
    invoke-direct {v2, p0, v1}, Ljvi;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final c(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lukg;->a:Landroid/content/Context;

    iget-object v1, p0, Lukg;->b:Landroid/app/job/JobScheduler;

    invoke-static {v0, v1}, Lukg;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Lukg;->f(Landroid/app/job/JobInfo;)Ljvi;
    ...
    invoke-static {v1, v2}, Lukg;->a(Landroid/app/job/JobScheduler;I)V

    goto :goto_2

    :cond_3
    iget-object v0, p0, Lukg;->c:Lpvi;

    iget-object v0, v0, Lpvi;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v0}, Landroidx/work/impl/WorkDatabase;->y()Lskg;

    move-result-object v0

    iget-object v1, v0, Lskg;->a:Ljava/lang/Object;
    ...
    invoke-virtual {v0, v2}, Lijf;->c(Lpr6;)V
...
.method public final varargs e([Lfwi;)V
    ...
    invoke-direct {v2, v1}, Lmi7;-><init>(Landroidx/work/impl/WorkDatabase;)V
    ...
    iget-object v7, v5, Lfwi;->a:Ljava/lang/String;

    invoke-virtual {v6, v7}, Lhwi;->o(Ljava/lang/String;)Lfwi;
    ...
    sget-object v9, Lukg;->o:Ljava/lang/String;
    ...
    invoke-virtual {v5, v9, v6}, Lvfa;->a0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-static {v5}, Ls5b;->r(Lfwi;)Ljvi;

    move-result-object v6

    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->y()Lskg;

    move-result-object v7

    invoke-virtual {v7, v6}, Lskg;->r(Ljvi;)Lqkg;
    ...
    iget-object v9, v2, Lmi7;->a:Landroidx/work/impl/WorkDatabase;

    new-instance v10, Lli7;

    invoke-direct {v10, v2, v8}, Lli7;-><init>(Lmi7;I)V
    ...
    invoke-direct {v8, v11, v10}, Lx9b;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v9, v8}, Lide;->t(Lxs6;)Ljava/lang/Object;
    ...
    iget-object v9, v6, Ljvi;->a:Ljava/lang/String;

    iget v6, v6, Ljvi;->b:I

    invoke-direct {v7, v9, v6, v8}, Lqkg;-><init>(Ljava/lang/String;II)V

    iget-object v6, v0, Lpvi;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v6}, Landroidx/work/impl/WorkDatabase;->y()Lskg;

    move-result-object v6

    invoke-virtual {v6, v7}, Lskg;->t(Lqkg;)V

    :cond_3
    invoke-virtual {p0, v5, v8}, Lukg;->g(Lfwi;I)V
...
.method public final g(Lfwi;I)V
    .locals 18
    ...
    iget-object v3, v1, Lukg;->b:Landroid/app/job/JobScheduler;

    iget-object v4, v1, Lukg;->d:Ltkg;

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v5, v2, Lfwi;->j:Loz3;

    new-instance v6, Landroid/os/PersistableBundle;

    invoke-direct {v6}, Landroid/os/PersistableBundle;-><init>()V

    iget-object v7, v2, Lfwi;->a:Ljava/lang/String;
    ...
    invoke-static {v4, v6}, Ld5;->j(Landroid/app/job/JobInfo$Builder;Landroid/net/NetworkRequest;)V
    ...
    sget-object v14, Ltkg;->b:Ljava/lang/String;

    invoke-static {v6}, Lsb6;->A(I)Ljava/lang/String;
    ...
    invoke-virtual {v11, v14, v6}, Lvfa;->s(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v6, v2, Lfwi;->l:Lfl0;

    sget-object v8, Lfl0;->b:Lfl0;
    ...
    :cond_7
    iget-boolean v10, v2, Lfwi;->q:Z

    if-nez v10, :cond_8

    invoke-static {v4}, Ld5;->i(Landroid/app/job/JobInfo$Builder;)V
    ...
    invoke-virtual {v10}, Lnz3;->b()Z

    move-result v11

    new-instance v6, Landroid/app/job/JobInfo$TriggerContentUri;

    invoke-virtual {v10}, Lnz3;->a()Landroid/net/Uri;
    ...
    invoke-static {v4}, Lzy0;->v(Landroid/app/job/JobInfo$Builder;)V
    ...
    invoke-virtual {v5, v9, v8}, Lvfa;->s(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v9, v5}, Lvfa;->a0(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean v4, v2, Lfwi;->q:Z

    if-eqz v4, :cond_e

    iget-object v4, v2, Lfwi;->r:Lrwb;

    sget-object v5, Lrwb;->a:Lrwb;
    :try_end_0
    ...
    invoke-virtual {v5, v9, v4}, Lvfa;->s(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual/range {p0 .. p2}, Lukg;->g(Lfwi;I)V
    :try_end_1
    ...
    invoke-virtual {v3, v9, v2, v0}, Lvfa;->x(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :goto_8
    iget-object v2, v1, Lukg;->a:Landroid/content/Context;

    invoke-static {v2, v3}, Lukg;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    iget-object v4, v1, Lukg;->c:Lpvi;

    iget-object v5, v4, Lpvi;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v5}, Landroidx/work/impl/WorkDatabase;->B()Lhwi;

    move-result-object v5

    invoke-virtual {v5}, Lhwi;->k()Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v9, v2}, Lvfa;->w(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v3, Ljava/lang/IllegalStateException;

    invoke-direct {v3, v2, v0}, Ljava/lang/IllegalStateException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object v0, v4, Lpvi;->b:Lft3;
