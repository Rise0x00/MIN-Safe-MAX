...
.method public synthetic constructor <init>(ILjava/lang/Object;)V
    ...
    iput-object p2, p0, Lz14;->e:Ljava/lang/Object;

    const/4 p1, 0x0

    invoke-direct {p0, p1}, Lkma;-><init>(Z)V
...
.method public synthetic constructor <init>(Lone/me/sdk/arch/Widget;I)V
    ...
    iput-object p1, p0, Lz14;->e:Ljava/lang/Object;
...
.method public constructor <init>(Lone/me/startconversation/StartConversationScreen;Z)V
    ...
    .line 3
    invoke-direct {p0, p2}, Lkma;-><init>(Z)V

    return-void
.end method

.method public constructor <init>(ZLqi6;)V
    .locals 1
...
.method public a()V
    ...
    :pswitch_0
    iget-object v0, p0, Lz14;->e:Ljava/lang/Object;
    ...
    :cond_0
    iget-object v1, v0, Landroidx/fragment/app/c;->h:Lwe0;

    if-eqz v1, :cond_2

    const/4 v2, 0x0

    iput-boolean v2, v1, Lwe0;->r:Z
    ...
    iget-object v4, v1, Lwe0;->p:Ljava/util/ArrayList;
    ...
    iput-object v4, v1, Lwe0;->p:Ljava/util/ArrayList;

    :cond_1
    iget-object v1, v1, Lwe0;->p:Ljava/util/ArrayList;

    invoke-virtual {v1, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v1, v0, Landroidx/fragment/app/c;->h:Lwe0;

    invoke-virtual {v1, v2}, Lwe0;->d(Z)I
    ...
    iput-object v1, v0, Landroidx/fragment/app/c;->h:Lwe0;
...
.method public final b()V
    ...
    iget-object v3, p0, Lz14;->e:Ljava/lang/Object;

    packed-switch v0, :pswitch_data_0

    check-cast v3, Lone/me/startconversation/StartConversationScreen;

    iget-object v0, v3, Lone/me/startconversation/StartConversationScreen;->u0:Ld0d;
    ...
    invoke-interface {v0, v3, v1}, Ld0d;->E(Ljava/lang/Object;Les7;)Ljava/lang/Object;
    ...
    invoke-virtual {v3}, Lone/me/qrscanner/QrScannerWidget;->z0()Lahc;
    ...
    invoke-interface {v3, p0}, Lqi6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v9, v3, Landroidx/fragment/app/c;->h:Lwe0;
    ...
    :cond_6
    iget-object v6, v3, Landroidx/fragment/app/c;->h:Lwe0;

    iget-object v6, v6, Lwe0;->a:Ljava/util/ArrayList;
    ...
    iget-object v7, v7, Lmf6;->b:Landroidx/fragment/app/a;
    ...
    iget-object v6, v2, Len4;->c:Ljava/util/ArrayList;
    ...
    :cond_9
    invoke-virtual {v2, v6}, Len4;->i(Ljava/util/List;)V

    invoke-virtual {v2, v6}, Len4;->c(Ljava/util/List;)V

    goto :goto_3

    :cond_a
    iget-object v1, v3, Landroidx/fragment/app/c;->h:Lwe0;
    ...
    :cond_c
    iput-object v8, v3, Landroidx/fragment/app/c;->h:Lwe0;
    ...
    :cond_10
    iget-object v0, v3, Landroidx/fragment/app/c;->g:Lsma;
    ...
    sget-object v0, Lone/me/calls/ui/ui/incoming/CallIncomingScreen;->s0:Li0e;

    invoke-virtual {v3}, Lone/me/calls/ui/ui/incoming/CallIncomingScreen;->z0()Lla1;

    move-result-object v0

    iget-object v0, v0, Lla1;->s0:La1f;
    ...
    invoke-direct {v3, v2}, Lha1;-><init>(Z)V
    ...
    sget-object v0, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->Z:[Les7;

    invoke-virtual {v3}, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->x0()Les;

    move-result-object v0

    iget-object v0, v0, Les;->F0:Laf5;
    ...
    iget-object v0, v3, Lc24;->router:Lyid;

    invoke-virtual {v0}, Lyid;->i()Lyid;

    move-result-object v0

    invoke-virtual {v0}, Lyid;->m()Z

    move-result v0

    if-nez v0, :cond_14

    invoke-virtual {p0, v2}, Lkma;->f(Z)V

    invoke-virtual {v3}, Lc24;->getOnBackPressedDispatcher()Lsma;

    move-result-object v0

    invoke-virtual {v0}, Lsma;->d()V

    iget-boolean v0, v3, Lc24;->isBeingDestroyed:Z

    if-nez v0, :cond_14

    invoke-virtual {p0, v1}, Lkma;->f(Z)V
...
.method public c(Lve0;)V
    ...
    :cond_0
    iget-object v2, v0, Landroidx/fragment/app/c;->h:Lwe0;

    if-eqz v2, :cond_6

    new-instance v2, Ljava/util/ArrayList;

    iget-object v4, v0, Landroidx/fragment/app/c;->h:Lwe0;
    ...
    :cond_2
    iget-object v5, v5, Len4;->c:Ljava/util/ArrayList;
    ...
    iget-object v7, v7, Lcwe;->k:Ljava/util/ArrayList;

    invoke-static {v6, v7}, Lgb3;->p(Ljava/util/Collection;Ljava/lang/Iterable;)V

    goto :goto_0

    :cond_3
    invoke-static {v6}, Lab3;->b0(Ljava/lang/Iterable;)Ljava/util/Set;

    move-result-object v5

    invoke-static {v5}, Lab3;->X(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-virtual {v8, p1}, Lbwe;->c(Lve0;)V
...
.method public d()V
    ...
    invoke-direct {v1, v0}, Lef6;-><init>(Landroidx/fragment/app/c;)V

    const/4 v2, 0x0

    invoke-virtual {v0, v1, v2}, Landroidx/fragment/app/c;->x(Lcf6;Z)V
