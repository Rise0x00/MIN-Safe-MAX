...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcxf;->A0:Ljava/lang/Object;
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lcxf;->a:Ljava/util/concurrent/atomic/AtomicLong;

    new-instance v1, Ljava/util/concurrent/atomic/AtomicLong;

    invoke-direct {v1}, Ljava/util/concurrent/atomic/AtomicLong;-><init>()V

    iput-object v1, p0, Lcxf;->Z:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iput-object v2, p0, Lcxf;->o:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    iput-object v2, p0, Lcxf;->Y:Ljava/util/concurrent/atomic/AtomicReferenceArray;
...
.method public final clear()V
    ...
    :cond_0
    :goto_0
    invoke-virtual {p0}, Lcxf;->poll()Ljava/lang/Object;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lcxf;->isEmpty()Z
...
.method public final isEmpty()Z
    ...
    iget-object v0, p0, Lcxf;->a:Ljava/util/concurrent/atomic/AtomicLong;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicLong;->get()J

    move-result-wide v0

    iget-object v2, p0, Lcxf;->Z:Ljava/util/concurrent/atomic/AtomicLong;
...
.method public final offer(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Lcxf;->o:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget-object v1, p0, Lcxf;->a:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iput-object v13, p0, Lcxf;->o:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    add-long/2addr v2, v5

    sub-long/2addr v2, v7

    iput-wide v2, p0, Lcxf;->c:J
    ...
    sget-object p1, Lcxf;->A0:Ljava/lang/Object;
...
.method public final poll()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcxf;->Y:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget-object v1, p0, Lcxf;->Z:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    sget-object v7, Lcxf;->A0:Ljava/lang/Object;
    ...
    iput-object v6, p0, Lcxf;->Y:Ljava/util/concurrent/atomic/AtomicReferenceArray;
