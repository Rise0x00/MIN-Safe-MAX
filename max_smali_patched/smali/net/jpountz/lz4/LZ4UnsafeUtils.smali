...
.method public static commonBytes([BIII)I
    ...
    invoke-static {p2, p0}, Lhgh;->f(I[B)J

    move-result-wide v1

    invoke-static {p1, p0}, Lhgh;->f(I[B)J
    ...
    :cond_0
    sget-object p3, Lqnh;->a:Ljava/nio/ByteOrder;
    ...
    invoke-static {p1, p0}, Lhgh;->a(I[B)B

    move-result p1

    add-int/lit8 v2, p2, 0x1

    invoke-static {p2, p0}, Lhgh;->a(I[B)B
...
.method public static readIntEquals([BII)Z
    ...
    invoke-static {p1, p0}, Lhgh;->c(I[B)I

    move-result p1

    invoke-static {p2, p0}, Lhgh;->c(I[B)I
...
.method public static readShortLittleEndian([BI)I
    ...
    invoke-static {p1, p0}, Lhgh;->i(I[B)S

    move-result p0

    sget-object p1, Lqnh;->a:Ljava/nio/ByteOrder;
...
.method public static safeArraycopy([BI[BII)V
    ...
    invoke-static {v3, p0}, Lhgh;->a(I[B)B

    move-result v3

    invoke-static {p2, v2, v3}, Lhgh;->l([BIB)V
...
.method public static safeIncrementalCopy([BIII)V
    ...
    invoke-static {v2, p0}, Lhgh;->a(I[B)B

    move-result v2

    invoke-static {p0, v1, v2}, Lhgh;->l([BIB)V
...
.method public static wildArraycopy([BI[BII)V
    ...
    invoke-static {v2, p0}, Lhgh;->f(I[B)J

    move-result-wide v2

    invoke-static {p2, v1, v2, v3}, Lhgh;->o([BIJ)V
...
.method public static wildIncrementalCopy([BIII)V
    ...
    invoke-static {v5, p0}, Lhgh;->a(I[B)B

    move-result v5

    invoke-static {p0, v4, v5}, Lhgh;->l([BIB)V
    ...
    :goto_1
    invoke-static {v3, p0}, Lhgh;->c(I[B)I

    move-result p1

    invoke-static {v2, p0, p1}, Lhgh;->n(I[BI)V
    ...
    invoke-static {p0, p2, v2, v3}, Lhgh;->o([BIJ)V
...
.method public static writeLen(I[BI)I
    ...
    invoke-static {p1, p2, v0}, Lhgh;->l([BIB)V
    ...
    invoke-static {p1, p2, p0}, Lhgh;->l([BIB)V
...
.method public static writeShortLittleEndian([BII)V
    ...
    sget-object v0, Lqnh;->a:Ljava/nio/ByteOrder;
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lhgh;->p([BIS)V
