...
.method public static final a(Lone/me/android/root/RootController;Landroid/content/Intent;)V
    ...
    invoke-virtual {p0}, Lone/me/android/root/RootController;->F0()Lyid;

    move-result-object p0

    invoke-virtual {p0}, Lyid;->n()Z

    move-result p0

    if-nez p0, :cond_2

    sget-object p0, Lusa;->a:Lusa;
    ...
    invoke-virtual {p0, v0}, Lt5;->c(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    sget-object p0, Lnhd;->U:Lmhd;

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object p0, Lmhd;->b:Ljava/util/Set;

    invoke-virtual {p1}, Landroid/content/Intent;->getAction()Ljava/lang/String;

    move-result-object p1

    invoke-static {p0, p1}, Lab3;->u(Ljava/lang/Iterable;Ljava/lang/Object;)Z
    ...
    sget-object p1, Lce8;->e:Lrf4;

    iget-object p1, p1, Lrf4;->a:Landroid/net/Uri;

    invoke-static {p1}, Lag4;->a(Landroid/net/Uri;)Ljava/lang/String;

    move-result-object p1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0}, Ltf4;->b(Ljava/lang/String;Landroid/os/Bundle;)Z

    :cond_2
    return-void
.end method

.method public static final b(JLl83;)I
    .locals 2
...
.method public static final c(Lj6;)Lone/me/android/root/RootController;
    .locals 3

    check-cast p0, Lnhd;

    invoke-interface {p0}, Lnhd;->k()Lyid;
    ...
    invoke-virtual {v2, v1}, Lbjd;->d(Ljava/lang/String;)V

    invoke-virtual {p0, v2}, Lyid;->S(Lbjd;)V

    return-object v0
.end method

.method public static final d(Lj6;Landroid/content/Intent;)V
    .locals 16
    ...
    invoke-virtual {v2}, Lwpa;->a()Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-virtual {v2}, Lwpa;->b()V
    ...
    sget-object v6, Lnhd;->U:Lmhd;

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v6, Lmhd;->b:Ljava/util/Set;

    invoke-static {v6, v2}, Lab3;->u(Ljava/lang/Iterable;Ljava/lang/Object;)Z
    ...
    invoke-static {v2}, Lebf;->l(Ljava/lang/String;)Ljava/lang/Long;
    ...
    invoke-virtual {v1, v0, v2}, Ltf4;->b(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    invoke-static {v0, v7, v6}, Lh9i;->b(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    sget-object v4, Lxv1;->a:Ljava/lang/Object;
    ...
    invoke-static {v9, v8, v3}, Lxaf;->v(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z
    ...
    :cond_8
    invoke-static {v2}, Lipd;->a(Ljava/lang/String;)Lfc1;

    move-result-object v2

    instance-of v8, v2, Lbc1;

    if-nez v8, :cond_12

    instance-of v8, v2, Lwb1;
    ...
    :cond_9
    instance-of v8, v2, Lcc1;

    const-string v9, ""

    if-eqz v8, :cond_c

    invoke-static {v1}, Lxv1;->b(Lyid;)Z
    ...
    sget-object v10, Lyd8;->c:Lyd8;

    invoke-virtual/range {v10 .. v15}, Lyd8;->U0(JLjava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-virtual {v2, v9, v3}, Lsf4;->c(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-virtual {v2}, Lsf4;->a()Landroid/net/Uri;

    move-result-object v2

    invoke-virtual {v1, v2, v5}, Ltf4;->c(Landroid/net/Uri;Landroid/os/Bundle;)Z

    goto :goto_1

    :cond_e
    instance-of v1, v2, Ldc1;
    ...
    invoke-static {v8}, Lft;->B([Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-virtual {v3}, Ladi;->p0()Ltf4;
    ...
    invoke-virtual {v3, v1, v5}, Ltf4;->c(Landroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    invoke-virtual {v3, v2, v4}, Lyd8;->T0(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-static {v1, v6}, Lsfd;->h(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v3, v4, v2, v1, v5}, Lnxa;->c(La98;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v0, v1, v2}, Lh9i;->b(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-static {v2, v6, v1}, Lcuh;->q(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v1}, Laha;->e()Lbha;

    move-result-object v1

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v2, Lbha;->d:Ljava/lang/String;
    ...
    invoke-static {v2, v3, v6}, Lcuh;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v8, v7, v0}, Lvcb;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    const-string v0, "eKey"

    new-instance v7, Lvcb;

    invoke-direct {v7, v0, v3}, Lvcb;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    filled-new-array {v8, v7, v3}, [Lvcb;
...
.method public static final e(Lj6;Lb4b;)V
    .locals 13

    iget-object v0, p1, Lb4b;->o:Lk3b;
    ...
    invoke-static {p0, v3}, Lcuh;->f(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static final f(Lj6;Landroid/content/Intent;)V
    .locals 3
    ...
    invoke-static {p1, v0, v1}, Lh9i;->b(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
