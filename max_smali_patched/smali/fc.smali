...
.method public constructor <init>(Landroid/os/Looper;Ljava/lang/ref/WeakReference;)V
    ...
    .line 3
    iput-object p2, p0, Lfc;->b:Ljava/lang/ref/WeakReference;
...
.method public constructor <init>(Ldyc;)V
    ...
    iput-object v0, p0, Lfc;->b:Ljava/lang/ref/WeakReference;
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    iget-object v2, v0, Lfc;->b:Ljava/lang/ref/WeakReference;
    ...
    iget-object v3, v1, Lg0d;->a:Lqza;

    iget-object v1, v1, Lg0d;->b:Landroid/util/Size;

    invoke-virtual {v2, v3, v1}, Lm0d;->g(Lqza;Landroid/util/Size;)V
    ...
    invoke-virtual {v2, v1}, Lm0d;->e(Ljava/lang/Object;)V
    ...
    iget-object v3, v1, Lf0d;->a:Lqza;

    iget-object v1, v1, Lf0d;->b:Landroid/view/Surface;

    invoke-virtual {v2, v3, v1}, Lm0d;->f(Lqza;Landroid/view/Surface;)V
    ...
    invoke-virtual {v2, v1}, Lm0d;->b(Ljava/lang/Object;)V
    ...
    iget-object v3, v1, Ld0d;->a:Lqza;

    iget-object v4, v1, Ld0d;->b:Lgx0;

    iget-object v1, v1, Ld0d;->c:Landroid/os/Handler;

    invoke-virtual {v2, v3, v4, v1}, Lm0d;->a(Lqza;Lgx0;Landroid/os/Handler;)V
    ...
    iget-object v3, v2, Ldyc;->h:Landroid/util/SparseArray;

    iget-object v4, v2, Ldyc;->i:Liyc;

    iget-object v5, v4, Liyc;->z0:Ljava/util/ArrayList;
    ...
    :pswitch_1
    iget-object v3, v4, Liyc;->C0:Ldyc;
    ...
    :cond_8
    iget-object v2, v4, Liyc;->E0:Ljsc;

    if-eqz v2, :cond_9

    instance-of v3, v12, Lrr8;
    ...
    iget-object v2, v2, Ljsc;->b:Ljava/lang/Object;

    check-cast v2, Le04;

    iget-object v2, v2, Le04;->c:Ljava/lang/Object;

    check-cast v2, Ljyc;

    check-cast v2, Lyr8;

    iget-object v6, v2, Lyr8;->s:Lrr8;

    if-ne v6, v3, :cond_9

    invoke-virtual {v2}, Lyr8;->c()Lbs8;

    move-result-object v3

    const/4 v6, 0x2

    invoke-virtual {v2, v3, v6}, Lyr8;->g(Lbs8;I)V

    :cond_9
    invoke-virtual {v5, v12}, Ljava/util/ArrayList;->remove(Ljava/lang/Object;)Z

    invoke-interface {v12}, Leyc;->c()V

    invoke-virtual {v4}, Liyc;->o()V
    ...
    invoke-direct {v3, v1}, Lyq8;-><init>(Landroid/os/Bundle;)V
    ...
    invoke-direct {v10, v9}, Lyq8;-><init>(Landroid/os/Bundle;)V
    ...
    new-instance v15, Lpr8;

    invoke-direct/range {v15 .. v20}, Lpr8;-><init>(Lyq8;IZZZ)V
    ...
    :cond_e
    iget-object v1, v4, Liyc;->C0:Ldyc;
    ...
    :cond_11
    instance-of v1, v12, Lgyc;

    if-eqz v1, :cond_1d

    check-cast v12, Lgyc;

    invoke-virtual {v12, v3, v6}, Lqr8;->l(Lyq8;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v2, v9}, Lfyc;->b(Landroid/os/Bundle;)V
    ...
    invoke-static {v2, v9}, Lfyc;->a(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-static {v9}, Ltr8;->b(Landroid/os/Bundle;)Ltr8;

    move-result-object v1

    invoke-virtual {v4, v2, v1}, Liyc;->l(Ldyc;Ltr8;)V
    ...
    invoke-static {v12, v9}, Lfyc;->a(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-interface {v2, v3}, Leyc;->b(Ldyc;)V
    ...
    :cond_19
    iget-object v1, v4, Lsr8;->X:Lar8;

    if-eqz v1, :cond_1d

    iget-object v5, v4, Liyc;->C0:Ldyc;
    ...
    iget-object v9, v1, Lar8;->a:Landroid/os/Bundle;
    ...
    invoke-static {v12, v12}, Lfyc;->a(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    iget-object v3, v0, Lfc;->b:Ljava/lang/ref/WeakReference;
