...
.field public static final Y:Lz8d;

.field public static final Z:Lz8d;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lyg6;->X:Ljava/lang/String;
    ...
    invoke-virtual {v0, v2}, Lub7;->b([Ljava/lang/Object;)V
...
.method public constructor <init>(Landroid/media/MediaMuxer;)V
    ...
    iput-object p1, p0, Lyg6;->a:Landroid/media/MediaMuxer;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, Lyg6;->b:Landroid/util/SparseArray;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, Lyg6;->c:Landroid/util/SparseArray;
...
.method public final A(Lwq9;)V
    ...
    iget-object v1, p0, Lyg6;->a:Landroid/media/MediaMuxer;
...
.method public final J(ILjava/nio/ByteBuffer;Lpu0;)V
    ...
    iget-boolean v5, v1, Lyg6;->d:Z

    iget-object v6, v1, Lyg6;->a:Landroid/media/MediaMuxer;

    const/4 v7, 0x1

    iget-object v8, v1, Lyg6;->c:Landroid/util/SparseArray;
    ...
    iget-object v3, v1, Lyg6;->b:Landroid/util/SparseArray;

    invoke-static {v3, v0}, Llig;->k(Landroid/util/SparseArray;I)Z
    ...
    invoke-static {v8, v9, v5, v12}, Lnx1;->l(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v3, v4, v6, v7}, Lnx1;->l(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final c0(Lub6;)I
    ...
    iget-object v5, p0, Lyg6;->a:Landroid/media/MediaMuxer;
    ...
    iget-object v6, p1, Lub6;->D:Llb3;

    invoke-static {v4, v6}, Lfji;->e(Landroid/media/MediaFormat;Llb3;)V
    ...
    :cond_10
    :goto_2
    iget-object v0, p1, Lub6;->q:Ljava/util/List;

    invoke-static {v4, v0}, Lfji;->g(Landroid/media/MediaFormat;Ljava/util/List;)V
...
.method public final close()V
    ...
    :cond_0
    iget-boolean v0, p0, Lyg6;->d:Z

    const/4 v1, 0x1

    iget-object v2, p0, Lyg6;->a:Landroid/media/MediaMuxer;
    ...
    iput-boolean v0, p0, Lyg6;->d:Z

    :try_start_1
    invoke-static {v2}, Lyg6;->c(Landroid/media/MediaMuxer;)V
    :try_end_1
    .catch Ljava/lang/RuntimeException; {:try_start_1 .. :try_end_1} :catch_1
