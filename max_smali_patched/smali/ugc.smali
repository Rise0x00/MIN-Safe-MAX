...
.field public C0:Landroid/media/session/PlaybackState;
...
.field public final z0:Ljava/util/AbstractCollection;
...
.method public constructor <init>(IJJFJILjava/lang/CharSequence;JLjava/util/ArrayList;JLandroid/os/Bundle;)V
    ...
    .line 3
    iput-wide p2, p0, Lugc;->b:J

    .line 4
    iput-wide p4, p0, Lugc;->c:J

    .line 5
    iput p6, p0, Lugc;->d:F

    .line 6
    iput-wide p7, p0, Lugc;->o:J

    .line 7
    iput p9, p0, Lugc;->X:I

    .line 8
    iput-object p10, p0, Lugc;->Y:Ljava/lang/CharSequence;

    .line 9
    iput-wide p11, p0, Lugc;->Z:J
    ...
    :goto_0
    iput-object p1, p0, Lugc;->z0:Ljava/util/AbstractCollection;

    move-wide p1, p14

    .line 13
    iput-wide p1, p0, Lugc;->A0:J

    move-object/from16 p1, p16

    .line 14
    iput-object p1, p0, Lugc;->B0:Landroid/os/Bundle;
...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v0, p0, Lugc;->Y:Ljava/lang/CharSequence;

    .line 23
    sget-object v0, Ltgc;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .line 26
    :cond_0
    iput-object v0, p0, Lugc;->z0:Ljava/util/AbstractCollection;
    ...
    iput-object v0, p0, Lugc;->B0:Landroid/os/Bundle;
...
.method public static a(Landroid/media/session/PlaybackState;)Lugc;
    .locals 21
    ...
    :cond_0
    invoke-static {v3}, Ltgc;->a(Landroid/media/session/PlaybackState$CustomAction;)Ltgc;
    ...
    invoke-static/range {v20 .. v20}, Lkg9;->n(Landroid/os/Bundle;)V
    ...
    invoke-direct/range {v4 .. v20}, Lugc;-><init>(IJJFJILjava/lang/CharSequence;JLjava/util/ArrayList;JLandroid/os/Bundle;)V

    iput-object v0, v4, Lugc;->C0:Landroid/media/session/PlaybackState;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lugc;->Y:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Lugc;->z0:Ljava/util/AbstractCollection;
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-wide v0, p0, Lugc;->o:J

    invoke-virtual {p1, v0, v1}, Landroid/os/Parcel;->writeLong(J)V

    iget-object v0, p0, Lugc;->Y:Ljava/lang/CharSequence;

    invoke-static {v0, p1, p2}, Landroid/text/TextUtils;->writeToParcel(Ljava/lang/CharSequence;Landroid/os/Parcel;I)V

    iget-object p2, p0, Lugc;->z0:Ljava/util/AbstractCollection;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeTypedList(Ljava/util/List;)V

    iget-wide v0, p0, Lugc;->A0:J

    invoke-virtual {p1, v0, v1}, Landroid/os/Parcel;->writeLong(J)V

    iget-object p2, p0, Lugc;->B0:Landroid/os/Bundle;
