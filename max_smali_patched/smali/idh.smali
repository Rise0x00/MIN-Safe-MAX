...
.method public static f0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    invoke-static {v0, v1}, Lidh;->h0(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, Lidh;->h0(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method public static g0([Lol6;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
    ...
    :try_start_0
    invoke-virtual {v4}, Lol6;->b()Landroid/net/Uri;
...
.method public final E(Landroid/content/Context;Lll6;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v3}, Lml6;->c()Ljava/lang/String;
    ...
    invoke-static {p2, p4}, Lidh;->f0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final F(Landroid/content/Context;[Lol6;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    invoke-static {p2, p1}, Lidh;->g0([Lol6;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {p1, p3}, Lidh;->f0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final G(Landroid/content/Context;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    invoke-static {v0, p1}, Lidh;->g0([Lol6;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {v4, p1}, Lidh;->g0([Lol6;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-static {v0, p3}, Lidh;->f0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final K([Lol6;I)Lol6;
    .locals 0
