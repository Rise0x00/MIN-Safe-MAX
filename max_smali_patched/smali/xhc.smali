...
.method public final run()V
    ...
    iget-object v3, v0, Lcic;->L0:Lq2e;

    invoke-virtual {v3, v1, v2}, Lq2e;->b(Livb;Ljava/lang/String;)V

    iget-object v0, v0, Lcic;->o:Lhp3;

    iget-object v1, v0, Lhp3;->j:Ljava/lang/Object;
    ...
    iget-object v1, v0, Lhp3;->h:[Ljava/lang/Object;
    ...
    iget-object v0, v0, Lhp3;->i:Ljava/lang/Object;
    ...
    iget-object v3, v1, Lcic;->o:Lhp3;

    iget-object v4, v1, Lcic;->a:Lr8e;

    iget-object v5, v1, Lcic;->Q0:Lto3;

    move-object v6, v5

    iget v5, v6, Lto3;->a:I

    iget-object v6, v6, Lto3;->h:[B
    ...
    invoke-direct {v10, v1, v11, v12}, Ldic;-><init>(Lcic;Lkh;I)V

    invoke-direct {v9, v10}, Lkh;-><init>(Lkh;)V

    invoke-direct {v8, v9}, Ldic;-><init>(Ltg6;)V

    const/4 v9, 0x0

    invoke-direct {v7, v1, v8, v9}, Ldic;-><init>(Lcic;Lkh;I)V
    ...
    invoke-direct/range {v2 .. v9}, Lm83;-><init>(Lhp3;Lr8e;I[BLdic;Lyhc;Lq98;)V

    iput-object v2, v1, Lcic;->N0:Lm83;

    new-instance v2, Lk5;

    iget-object v3, v1, Lcic;->N0:Lm83;

    const/16 v4, 0xc

    invoke-direct {v2, v4, v3}, Lk5;-><init>(ILjava/lang/Object;)V
    ...
    iget-object v6, v1, Lcic;->M0:Lcdc;

    invoke-virtual {v6}, Lcdc;->b()Lpxc;

    move-result-object v6

    if-eqz v6, :cond_0

    iget-object v7, v1, Lcic;->T0:Lz73;

    invoke-virtual {v7}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v7, v6, Lpxc;->a:Ljava/time/Instant;
    ...
    iget-object v9, v6, Lpxc;->b:Ljava/nio/ByteBuffer;
    ...
    iget-object v10, v6, Lpxc;->b:Ljava/nio/ByteBuffer;
    ...
    iget-object v8, v6, Lpxc;->a:Ljava/time/Instant;

    const/16 v9, 0xc

    invoke-direct {v7, v8, v4, v9}, Lgj;-><init>(Ljava/lang/Object;II)V

    iget-object v6, v6, Lpxc;->b:Ljava/nio/ByteBuffer;

    invoke-virtual {v2, v6, v7}, Lk5;->s(Ljava/nio/ByteBuffer;Lgj;)V

    iget-object v6, v1, Lcic;->L0:Lq2e;

    invoke-virtual {v6}, Lq2e;->k()V

    invoke-virtual {v1}, Lcic;->j()V

    iget-object v6, v1, Lcic;->L0:Lq2e;

    iget-object v7, v1, Lcic;->M0:Lcdc;

    iget-object v7, v7, Lcdc;->g:Ljava/lang/Object;
    ...
    iget-object v0, v1, Lcic;->L0:Lq2e;
