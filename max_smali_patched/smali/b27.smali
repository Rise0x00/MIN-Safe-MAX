...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lb27;->c:Ljava/lang/Object;
...
.method public final d(Lcom/google/android/gms/common/api/GoogleApiActivity;ILcom/google/android/gms/common/api/GoogleApiActivity;)V
    ...
    invoke-super {p0, p2, p1, v0}, Lc27;->b(ILandroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    invoke-static {v0, p1}, Lo3j;->a(Landroid/content/Intent;Lcom/google/android/gms/common/api/GoogleApiActivity;)Lo3j;
    ...
    :cond_2
    invoke-static {p1, p2}, Ld3j;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Ld3j;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p1, p2}, Ld3j;->f(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {v1, p3}, Lpn5;->a(Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;)Lpn5;
...
.method public final e(Landroid/content/Context;ILandroid/app/PendingIntent;)V
    ...
    invoke-direct {p2, p0, p1}, Lq3j;-><init>(Lb27;Landroid/content/Context;)V
    ...
    :cond_2
    invoke-static {p1, p2}, Ld3j;->e(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v0

    invoke-static {p1, p2}, Ld3j;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-direct {v5, p1, v6}, Lrva;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-boolean v1, v5, Lrva;->u:Z

    const/16 v6, 0x10

    invoke-virtual {v5, v6, v1}, Lrva;->f(IZ)V

    invoke-static {v0}, Lrva;->c(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, v5, Lrva;->e:Ljava/lang/CharSequence;
    ...
    iput-object v6, v0, Lpva;->e:Ljava/lang/CharSequence;

    invoke-virtual {v5, v0}, Lrva;->i(Lgwa;)V

    invoke-virtual {p1}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v0

    sget-object v6, Lf90;->e:Ljava/lang/Boolean;
    ...
    iget-object v2, v5, Lrva;->F:Landroid/app/Notification;

    iput v0, v2, Landroid/app/Notification;->icon:I

    iput v6, v5, Lrva;->k:I

    invoke-static {p1}, Lf90;->e0(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_4

    sget v0, Lkhd;->common_full_open_on_phone:I

    sget v2, Laqd;->common_open_on_phone:I

    invoke-virtual {v3, v2}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v2

    iget-object v3, v5, Lrva;->b:Ljava/util/ArrayList;

    new-instance v7, Ljva;

    invoke-direct {v7, v0, v2, p3}, Ljva;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    :cond_4
    iput-object p3, v5, Lrva;->g:Landroid/app/PendingIntent;
    ...
    iget-object v7, v5, Lrva;->F:Landroid/app/Notification;

    iput v0, v7, Landroid/app/Notification;->icon:I

    sget v0, Laqd;->common_google_play_services_notification_ticker:I

    invoke-virtual {v3, v0}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v0

    iget-object v3, v5, Lrva;->F:Landroid/app/Notification;
    ...
    iget-object v0, v5, Lrva;->F:Landroid/app/Notification;

    iput-wide v7, v0, Landroid/app/Notification;->when:J

    iput-object p3, v5, Lrva;->g:Landroid/app/PendingIntent;

    invoke-virtual {v5, v2}, Lrva;->d(Ljava/lang/CharSequence;)V

    :goto_0
    sget-object p3, Lb27;->c:Ljava/lang/Object;
    ...
    sget v2, Laqd;->common_google_play_services_notification_channel_name:I
    ...
    :cond_7
    :goto_1
    iput-object p3, v5, Lrva;->z:Ljava/lang/String;

    invoke-virtual {v5}, Lrva;->a()Landroid/app/Notification;
    ...
    :cond_8
    sget-object p2, Lr27;->a:Ljava/util/concurrent/atomic/AtomicBoolean;
