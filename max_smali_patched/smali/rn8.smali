...
.method public final onConnected()V
    ...
    iget-object v5, v1, Lsn8;->d:Lqn8;

    iget-object v6, v1, Lsn8;->b:Landroid/media/browse/MediaBrowser;
    ...
    iget-object v10, v1, Lsn8;->c:Landroid/os/Bundle;

    invoke-direct {v9, v8, v10}, Ltz8;-><init>(Landroid/os/IBinder;Landroid/os/Bundle;)V

    iput-object v9, v1, Lsn8;->f:Ltz8;

    new-instance v8, Landroid/os/Messenger;

    invoke-direct {v8, v5}, Landroid/os/Messenger;-><init>(Landroid/os/Handler;)V

    iput-object v8, v1, Lsn8;->g:Landroid/os/Messenger;
    ...
    iput-object v10, v5, Lqn8;->c:Ljava/lang/Object;

    :try_start_1
    iget-object v5, v1, Lsn8;->a:Landroid/content/Context;
    ...
    iget-object v11, v9, Ltz8;->c:Ljava/lang/Object;
    ...
    iput-object v4, v5, Ls67;->c:Landroid/os/IBinder;
    ...
    invoke-direct {v6, v4, v5}, Lsz8;-><init>(Landroid/media/session/MediaSession$Token;Lu67;)V

    iput-object v6, v1, Lsn8;->h:Lsz8;
    ...
    iget-object v1, v0, Lzq8;->j:Lun8;

    if-eqz v1, :cond_6

    iget-object v1, v1, Lun8;->a:Lsn8;

    iget-object v4, v1, Lsn8;->h:Lsz8;

    if-nez v4, :cond_5

    iget-object v4, v1, Lsn8;->b:Landroid/media/browse/MediaBrowser;
    ...
    invoke-direct {v5, v4, v3}, Lsz8;-><init>(Landroid/media/session/MediaSession$Token;Lu67;)V

    iput-object v5, v1, Lsn8;->h:Lsz8;

    :cond_5
    iget-object v1, v1, Lsn8;->h:Lsz8;

    iget-object v3, v0, Lzq8;->b:Lxp8;

    new-instance v4, Lhn5;

    const/16 v5, 0x1a

    invoke-direct {v4, v0, v5, v1}, Lhn5;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v3, v4}, Lxp8;->z(Ljava/lang/Runnable;)V

    iget-object v1, v3, Lxp8;->o:Landroid/os/Handler;

    new-instance v3, Lwq8;

    invoke-direct {v3, v0, v2}, Lwq8;-><init>(Lzq8;I)V
...
.method public final onConnectionSuspended()V
    ...
    iput-object v2, v1, Lsn8;->f:Ltz8;

    iput-object v2, v1, Lsn8;->g:Landroid/os/Messenger;

    iput-object v2, v1, Lsn8;->h:Lsz8;

    iget-object v1, v1, Lsn8;->d:Lqn8;
    ...
    iput-object v3, v1, Lqn8;->c:Ljava/lang/Object;
