...
.field public D0:Lmsg;

.field public E0:Lktg;

.field public F0:Lge5;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Leqa;->P0:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Leqa;->Q0:Landroid/text/TextPaint;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget-object v0, Leqa;->P0:Ljava/util/regex/Pattern;

    iput-object v0, p0, Leqa;->a:Ljava/util/regex/Pattern;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Leqa;->b:Landroid/graphics/Rect;

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, Leqa;->A0:F

    sget-object v0, Lge5;->b:Lge5;

    iput-object v0, p0, Leqa;->F0:Lge5;

    const/4 v0, -0x1

    iput v0, p0, Leqa;->G0:I

    const/high16 v0, -0x1000000

    iput v0, p0, Leqa;->I0:I

    sget-object v0, Leqa;->Q0:Landroid/text/TextPaint;

    invoke-virtual {v0}, Landroid/graphics/Paint;->getTypeface()Landroid/graphics/Typeface;

    move-result-object v1

    iput-object v1, p0, Leqa;->J0:Landroid/graphics/Typeface;

    invoke-virtual {v0}, Landroid/graphics/Paint;->getLetterSpacing()F

    move-result v1

    iput v1, p0, Leqa;->K0:F

    invoke-virtual {v0}, Landroid/graphics/Paint;->getTextSize()F

    move-result v1

    iput v1, p0, Leqa;->L0:F

    invoke-virtual {v0}, Landroid/graphics/Paint;->isElegantTextHeight()Z

    move-result v0

    iput-boolean v0, p0, Leqa;->M0:Z

    const/4 v0, 0x2

    iput v0, p0, Leqa;->N0:I

    new-instance v0, Ldqa;

    invoke-direct {v0, p0, p1}, Ldqa;-><init>(Leqa;Landroid/content/Context;)V

    iput-object v0, p0, Leqa;->O0:Ldqa;
...
.method private final getFullyVisibleLinesCount()I
    ...
    invoke-virtual {p0, v0, v1}, Leqa;->k(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;
...
.method private final getLinesCount()I
    ...
    invoke-direct {p0}, Leqa;->getFullyVisibleLinesCount()I
...
.method public static final h(Leqa;Landroid/text/TextPaint;)V
    .locals 1

    iget-object v0, p0, Leqa;->J0:Landroid/graphics/Typeface;

    invoke-virtual {p1, v0}, Landroid/graphics/Paint;->setTypeface(Landroid/graphics/Typeface;)Landroid/graphics/Typeface;

    iget v0, p0, Leqa;->K0:F

    invoke-virtual {p1, v0}, Landroid/graphics/Paint;->setLetterSpacing(F)V

    iget v0, p0, Leqa;->L0:F

    invoke-virtual {p1, v0}, Landroid/graphics/Paint;->setTextSize(F)V

    iget p0, p0, Leqa;->I0:I
...
.method private final setContent(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Leqa;->d:Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Leqa;->l()V

    iput-object p1, p0, Leqa;->d:Ljava/lang/CharSequence;

    const/4 p1, 0x0

    iput-object p1, p0, Leqa;->D0:Lmsg;

    const/4 p1, 0x1

    iput-boolean p1, p0, Leqa;->z0:Z
...
.method private final setLayoutInternal(Landroid/text/Layout;)V
    ...
    :goto_0
    iput-object v0, p0, Leqa;->c:Landroid/text/StaticLayout;
    ...
    :goto_1
    iput-object v0, p0, Leqa;->d:Ljava/lang/CharSequence;
    ...
    :cond_2
    iput-object v1, p0, Leqa;->o:Ljava/lang/CharSequence;
...
.method private final setStaticLayoutsTextColor(I)V
    ...
    iget-object v0, p0, Leqa;->c:Landroid/text/StaticLayout;
    ...
    :cond_0
    iget-object v0, p0, Leqa;->D0:Lmsg;

    if-eqz v0, :cond_1

    iget-object v1, v0, Lmsg;->a:Lvsg;
    ...
    iget-object v0, v0, Lmsg;->b:Lvsg;

    invoke-virtual {v0}, Lvsg;->a()Landroid/text/Layout;
...
.method public final a(Lge5;)V
    ...
    iget-object v0, p0, Leqa;->E0:Lktg;
    ...
    :cond_0
    iget-object v1, p0, Leqa;->F0:Lge5;
    ...
    :cond_1
    iput-object p1, p0, Leqa;->F0:Lge5;

    invoke-virtual {p0, v0, p1}, Leqa;->i(Lktg;Lge5;)V
...
.method public final d(Lktg;Lge5;)V
    .locals 0

    iput-object p1, p0, Leqa;->E0:Lktg;

    iput-object p2, p0, Leqa;->F0:Lge5;

    invoke-virtual {p0, p1, p2}, Leqa;->i(Lktg;Lge5;)V
...
.method public final e()Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Leqa;->b:Landroid/graphics/Rect;
...
.method public final g(Ljava/lang/String;)F
    ...
    :try_start_0
    invoke-static {p0, v0}, Leqa;->h(Leqa;Landroid/text/TextPaint;)V
...
.method public getLineHeight()I
    ...
    iget v0, p0, Leqa;->B0:F

    int-to-float v1, v1

    iget v2, p0, Leqa;->A0:F
...
.method public final i(Lktg;Lge5;)V
    .locals 16
    ...
    iget-object v3, v0, Lktg;->e:Ljava/lang/String;
    ...
    invoke-static {v5}, Lsb6;->a(I)I

    move-result v5

    invoke-static {v2, v3, v5}, Lfdh;->a(Landroid/content/Context;Landroid/graphics/Typeface;I)Landroid/graphics/Typeface;

    move-result-object v2

    iput-object v2, v1, Leqa;->J0:Landroid/graphics/Typeface;
    ...
    invoke-virtual/range {p1 .. p2}, Lktg;->h(Lge5;)J

    move-result-wide v5

    invoke-static {v5, v6, v2}, Lo25;->d(JLandroid/util/DisplayMetrics;)F

    move-result v3

    iput v3, v1, Leqa;->K0:F

    invoke-virtual/range {p1 .. p2}, Lktg;->j(Lge5;)J
    ...
    iput v3, v1, Leqa;->L0:F

    invoke-virtual/range {p1 .. p2}, Lktg;->i(Lge5;)J
    ...
    sget-object v2, Leqa;->Q0:Landroid/text/TextPaint;
    ...
    :try_start_0
    invoke-static {v1, v2}, Leqa;->h(Leqa;Landroid/text/TextPaint;)V
    ...
    iput v0, v1, Leqa;->B0:F

    const/4 v0, 0x0

    iput-boolean v0, v1, Leqa;->M0:Z

    const/4 v0, 0x1

    iput-boolean v0, v1, Leqa;->z0:Z
...
.method public final j()V
    ...
    invoke-interface {v1, p0}, Lg5i;->attach(Landroid/view/View;)V
...
.method public final k(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;
    ...
    sget-object v4, Leqa;->Q0:Landroid/text/TextPaint;
    ...
    :try_start_0
    invoke-static {v1, v4}, Leqa;->h(Leqa;Landroid/text/TextPaint;)V
    :try_end_0
...
.method public final l()V
    ...
    invoke-interface {v1, p0}, Lg5i;->detach(Landroid/view/View;)V
...
.method public final onAttachedToWindow()V
    ...
    iget-object v2, v1, Lvsg;->c:Ljava/util/concurrent/CopyOnWriteArraySet;

    iget-object v3, p0, Leqa;->O0:Ldqa;
    ...
    iget-object v0, v0, Lvsg;->c:Ljava/util/concurrent/CopyOnWriteArraySet;
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v1, p0, Leqa;->O0:Ldqa;

    if-eqz v0, :cond_0

    iget-object v0, v0, Lmsg;->a:Lvsg;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v0, v1, Leqa;->z0:Z

    const/4 v3, 0x1

    if-nez v0, :cond_2

    iget-object v0, v1, Leqa;->D0:Lmsg;
    ...
    :goto_0
    iget-object v0, v0, Lvsg;->b:Lge5;

    iget-object v4, v1, Leqa;->F0:Lge5;
    ...
    iput-boolean v0, v1, Leqa;->H0:Z

    iget-object v4, v1, Leqa;->d:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, v5, v4}, Leqa;->k(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;

    move-result-object v6

    invoke-direct {v1}, Leqa;->getLinesCount()I
    ...
    invoke-virtual {v1, v5, v9}, Leqa;->k(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;
    ...
    iget-object v7, v1, Leqa;->a:Ljava/util/regex/Pattern;
    ...
    :cond_a
    :goto_5
    iput-object v3, v1, Leqa;->o:Ljava/lang/CharSequence;

    goto :goto_6

    :cond_b
    iput-object v4, v1, Leqa;->o:Ljava/lang/CharSequence;

    :goto_6
    iget-object v3, v1, Leqa;->o:Ljava/lang/CharSequence;
    ...
    :goto_7
    invoke-virtual {v1, v5, v8}, Leqa;->k(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;

    move-result-object v3

    iput-object v3, v1, Leqa;->c:Landroid/text/StaticLayout;

    iput-boolean v0, v1, Leqa;->z0:Z

    :cond_d
    :goto_8
    iget-object v0, v1, Leqa;->c:Landroid/text/StaticLayout;

    if-eqz v0, :cond_e

    sget-object v3, Leqa;->Q0:Landroid/text/TextPaint;
    ...
    :try_start_0
    invoke-static {v1, v3}, Leqa;->h(Leqa;Landroid/text/TextPaint;)V
...
.method public final onMeasure(II)V
    ...
    :goto_2
    iput p2, p0, Leqa;->G0:I

    iput-boolean v0, p0, Leqa;->H0:Z

    iget-object v3, p0, Leqa;->D0:Lmsg;

    if-eqz v3, :cond_3

    iget-boolean v3, p0, Leqa;->z0:Z

    if-nez v3, :cond_3

    iget-object v3, p0, Leqa;->c:Landroid/text/StaticLayout;
    ...
    :cond_6
    invoke-virtual {p0, p2, v0}, Leqa;->k(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;
    ...
    invoke-virtual {p0}, Leqa;->getMaxLinesValue()I
...
.method public final onSizeChanged(IIII)V
    ...
    iget-object p2, p0, Leqa;->D0:Lmsg;
    ...
    :cond_0
    iget-object p1, p2, Lmsg;->b:Lvsg;

    goto :goto_0

    :goto_1
    iget-object p2, p0, Leqa;->c:Landroid/text/StaticLayout;

    if-eq p2, p1, :cond_1

    invoke-direct {p0, p1}, Leqa;->setLayoutInternal(Landroid/text/Layout;)V
...
.method public final onWindowVisibilityChanged(I)V
    ...
    invoke-super {p0, p1}, Ld3b;->onWindowVisibilityChanged(I)V
...
.method public setLayout(Lmsg;)V
    .locals 4
    ...
    iget-object v2, v0, Lmsg;->a:Lvsg;

    iget-object v3, v2, Lvsg;->c:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iput-object v0, p0, Leqa;->o:Ljava/lang/CharSequence;
    ...
    :goto_1
    iput-object p1, p0, Leqa;->c:Landroid/text/StaticLayout;
...
.method public setTextColor(I)V
    ...
    iput p1, p0, Leqa;->I0:I

    invoke-direct {p0, p1}, Leqa;->setStaticLayoutsTextColor(I)V
...
.method public setTextValue(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0, p1}, Leqa;->setContent(Ljava/lang/CharSequence;)V
