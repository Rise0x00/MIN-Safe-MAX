...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    iget-object v3, v1, Llad;->a:Lr7b;

    iget-object v1, v1, Llad;->b:Landroid/util/Size;

    invoke-virtual {v2, v3, v1}, Lrad;->g(Lr7b;Landroid/util/Size;)V
    ...
    invoke-virtual {v2, v1}, Lrad;->e(Ljava/lang/Object;)V
    ...
    iget-object v3, v1, Lkad;->a:Lr7b;

    iget-object v1, v1, Lkad;->b:Landroid/view/Surface;

    invoke-virtual {v2, v3, v1}, Lrad;->f(Lr7b;Landroid/view/Surface;)V
    ...
    invoke-virtual {v2, v1}, Lrad;->b(Ljava/lang/Object;)V
    ...
    iget-object v3, v1, Liad;->a:Lr7b;

    iget-object v4, v1, Liad;->b:Lgr4;

    iget-object v1, v1, Liad;->c:Landroid/os/Handler;

    invoke-virtual {v2, v3, v4, v1}, Lrad;->a(Lr7b;Lgr4;Landroid/os/Handler;)V
    ...
    iget-object v3, v2, Lb8d;->h:Landroid/util/SparseArray;

    iget-object v4, v2, Lb8d;->i:Lg8d;

    iget-object v5, v4, Lg8d;->u0:Ljava/util/ArrayList;
    ...
    :pswitch_1
    iget-object v3, v4, Lg8d;->x0:Lb8d;
    ...
    :cond_8
    iget-object v2, v4, Lg8d;->z0:Lc2d;

    if-eqz v2, :cond_9

    instance-of v3, v12, Lly8;
    ...
    iget-object v2, v2, Lc2d;->b:Ljava/lang/Object;

    check-cast v2, Lf24;

    iget-object v2, v2, Lf24;->c:Ljava/lang/Object;

    check-cast v2, Lh8d;

    check-cast v2, Lsy8;

    iget-object v6, v2, Lsy8;->s:Lly8;

    if-ne v6, v3, :cond_9

    invoke-virtual {v2}, Lsy8;->c()Lvy8;

    move-result-object v3

    const/4 v6, 0x2

    invoke-virtual {v2, v3, v6}, Lsy8;->g(Lvy8;I)V

    :cond_9
    invoke-virtual {v5, v12}, Ljava/util/ArrayList;->remove(Ljava/lang/Object;)Z

    invoke-interface {v12}, Lc8d;->c()V

    invoke-virtual {v4}, Lg8d;->o()V
    ...
    invoke-direct {v3, v1}, Lsx8;-><init>(Landroid/os/Bundle;)V
    ...
    new-instance v10, Lsx8;

    invoke-direct {v10, v9}, Lsx8;-><init>(Landroid/os/Bundle;)V
    ...
    invoke-direct/range {v15 .. v20}, Ljy8;-><init>(Lsx8;IZZZ)V
    ...
    :cond_e
    iget-object v1, v4, Lg8d;->x0:Lb8d;
    ...
    :cond_11
    instance-of v1, v12, Le8d;

    if-eqz v1, :cond_1d

    check-cast v12, Le8d;

    invoke-virtual {v12, v3, v6}, Lky8;->l(Lsx8;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v2, v9}, Ld8d;->b(Landroid/os/Bundle;)V
    ...
    invoke-static {v2, v9}, Ld8d;->a(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-static {v9}, Lny8;->b(Landroid/os/Bundle;)Lny8;

    move-result-object v1

    invoke-virtual {v4, v2, v1}, Lg8d;->l(Lb8d;Lny8;)V
    ...
    invoke-static {v12, v9}, Ld8d;->a(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-interface {v2, v3}, Lc8d;->b(Lb8d;)V
    ...
    :cond_19
    iget-object v1, v4, Lmy8;->o:Lux8;

    if-eqz v1, :cond_1d

    iget-object v5, v4, Lg8d;->x0:Lb8d;
    ...
    iget-object v9, v1, Lux8;->a:Landroid/os/Bundle;
    ...
    invoke-static {v12, v12}, Ld8d;->a(Ljava/lang/String;Landroid/os/Bundle;)V
