...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    sget-boolean p1, Lvne;->a:Z

    invoke-virtual {v0, p1}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;->setRemoveOnCancelPolicy(Z)V

    iput-object v0, p0, Lrqa;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final b(Ljava/lang/Runnable;)Ls45;
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Lrqa;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ls45;
...
.method public final dispose()V
    ...
    iput-boolean v0, p0, Lrqa;->b:Z

    iget-object v0, p0, Lrqa;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final e(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;Lt45;)Lsme;
    .locals 3

    new-instance v0, Lsme;

    invoke-direct {v0, p1, p5}, Lsme;-><init>(Ljava/lang/Runnable;Lt45;)V

    if-eqz p5, :cond_0

    invoke-interface {p5, v0}, Lt45;->a(Ls45;)Z
    ...
    iget-object v1, p0, Lrqa;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    :goto_0
    invoke-virtual {v0, p1}, Lsme;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    ...
    invoke-interface {p5, v0}, Lt45;->b(Ls45;)Z
