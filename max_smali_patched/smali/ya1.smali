...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v1, p0}, Ltk;-><init>(Lya1;)V

    iput-object v1, p0, Lya1;->H0:Ltk;

    new-instance v1, Leb1;

    invoke-direct {v1, p1}, Leb1;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v4, v5, v5}, Lmq3;-><init>(II)V
    ...
    invoke-direct {p0}, Lya1;->getTitleColor()I

    move-result v6

    invoke-virtual {v1, v6}, Landroid/widget/TextView;->setTextColor(I)V

    iput-object v1, p0, Lya1;->G0:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-direct {p1, v5, v0}, Lmq3;-><init>(II)V

    invoke-virtual {v6, p1}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    invoke-static {v4, v6}, Lorf;->d(Lorf;Landroid/widget/TextView;)V
    ...
    iput-object v6, p0, Lya1;->F0:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-virtual {p1, v0, v4, v3, v4}, Lwq3;->d(IIII)V
    ...
    invoke-virtual {p1, v0, v8, v7, v5}, Lwq3;->d(IIII)V
    ...
    invoke-virtual {p1, v0, v4, v1, v4}, Lwq3;->d(IIII)V

    invoke-virtual {v6}, Landroid/view/View;->getId()I

    move-result v1

    invoke-virtual {p1, v0, v5, v1, v8}, Lwq3;->d(IIII)V

    invoke-virtual {p1, v0, v8, v3, v8}, Lwq3;->d(IIII)V
...
.method public final a(Z)V
    ...
    invoke-virtual {p0}, Lya1;->getBackground()Leb1;

    move-result-object p1

    if-eqz p1, :cond_0

    iget-object v0, p1, Leb1;->Y:Ltk;
    ...
    sget-object v2, Ldb1;->b:Ldb1;

    invoke-virtual {v0, p1, v1, v2}, Ladi;->O(Ljava/lang/Object;Les7;Ljava/lang/Object;)V
    ...
    invoke-virtual {p1}, Leb1;->start()V

    :cond_1
    iget-object p1, p0, Lya1;->G0:Landroidx/appcompat/widget/AppCompatTextView;

    const/4 v0, 0x0

    invoke-virtual {p1, v0}, Landroid/view/View;->setTranslationY(F)V

    iget-object v1, p0, Lya1;->F0:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-virtual {v0, v2}, Leb1;->setAlpha(I)V
...
.method public final g(Le28;ZJ)V
    ...
    invoke-direct {p3, p4, p0}, Lt00;-><init>(ILjava/lang/Object;)V
...
.method public getBackground()Leb1;
    .locals 2
...
.method public final getIndicatorState()Lxa1;
    .locals 2

    sget-object v0, Lya1;->I0:[Les7;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    iget-object v0, p0, Lya1;->H0:Ltk;
...
.method public final onAttachedToWindow()V
    ...
    invoke-virtual {v0}, Leb1;->start()V
...
.method public final onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Leb1;->stop()V

    :cond_0
    return-void
.end method

.method public final setIndicatorState(Lxa1;)V
    .locals 2
...
.method public final setTime(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Lya1;->G0:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public final setTitle(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Lya1;->F0:Landroidx/appcompat/widget/AppCompatTextView;
