...
# direct methods
.method public constructor <init>(Lia8;Lia8;Ldng;Ltee;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p3, p0, Leqh;->a:Ldng;

    iput-object p4, p0, Leqh;->b:Ltee;

    iput-object p1, p0, Leqh;->c:Lia8;

    iput-object p2, p0, Leqh;->d:Lia8;
    ...
    iput-object p1, p0, Leqh;->e:Ljava/lang/String;

    const-wide/16 p1, -0x1

    iput-wide p1, p0, Leqh;->g:J

    iput-wide p1, p0, Leqh;->i:J
    ...
    iput-object p1, p0, Leqh;->j:Ljava/util/EnumSet;

    new-instance p1, Ljava/util/LinkedHashMap;

    invoke-direct {p1}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object p1, p0, Leqh;->k:Ljava/util/LinkedHashMap;
...
.method public final a(Lorh;)V
    ...
    iget-object v1, p0, Leqh;->e:Ljava/lang/String;
    ...
    iget-object v6, p0, Leqh;->h:Lorh;

    if-eqz v6, :cond_1

    invoke-interface {v6}, Lorh;->k()J
    ...
    invoke-virtual {v2, v0, v1, v6, v5}, Lnfb;->c(Lgp8;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_2
    :goto_1
    iput-object p1, p0, Leqh;->h:Lorh;

    iget-object p1, p0, Leqh;->j:Ljava/util/EnumSet;

    invoke-virtual {p1}, Ljava/util/AbstractCollection;->clear()V

    invoke-virtual {p0}, Leqh;->o()V

    const/4 p1, 0x0

    iput-boolean p1, p0, Leqh;->f:Z

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v1

    iput-wide v1, p0, Leqh;->i:J
    ...
    iget-object v6, p0, Leqh;->k:Ljava/util/LinkedHashMap;
    ...
    iget-object p1, p0, Leqh;->e:Ljava/lang/String;
    ...
    iget-object v2, p0, Leqh;->h:Lorh;

    if-eqz v2, :cond_4

    invoke-interface {v2}, Lorh;->k()J
    ...
    invoke-static {v2, v4, v3}, Lgj2;->b(Ljava/lang/Long;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_5
    iget-object v7, p0, Leqh;->k:Ljava/util/LinkedHashMap;

    invoke-interface {v6}, Lorh;->getType()I

    move-result v8

    invoke-static {v8}, Lndh;->b(I)I
    ...
    invoke-static {}, Lcqj;->a()Ljava/lang/String;
    ...
    iget-object v9, p0, Leqh;->k:Ljava/util/LinkedHashMap;
    ...
    :cond_8
    invoke-interface {v6}, Lorh;->a()Landroid/net/Uri;
    ...
    iget-object v8, p0, Leqh;->k:Ljava/util/LinkedHashMap;
    ...
    :cond_a
    invoke-interface {v6}, Lorh;->getContentType()Ljava/lang/String;

    move-result-object v6

    invoke-static {v1}, Lndh;->a(I)Ljava/lang/String;
    ...
    invoke-static {p1}, Lndh;->a(I)Ljava/lang/String;
    ...
    iget-object v1, p0, Leqh;->k:Ljava/util/LinkedHashMap;
    ...
    :cond_e
    iget-object p1, p0, Leqh;->l:Le0i;

    if-eqz p1, :cond_f

    iget-object v1, p0, Leqh;->k:Ljava/util/LinkedHashMap;

    invoke-virtual {p1}, Le0i;->a()I
    ...
    invoke-virtual {v1, v0, p1, v2, v5}, Lnfb;->c(Lgp8;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final b()V
    ...
    iget-object v0, p0, Leqh;->e:Ljava/lang/String;
    ...
    iget-object v3, p0, Leqh;->h:Lorh;

    const/4 v4, 0x0

    if-eqz v3, :cond_1

    invoke-interface {v3}, Lorh;->k()J
    ...
    invoke-static {v3, v5, v6}, Lgj2;->b(Ljava/lang/Long;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-wide v0, p0, Leqh;->g:J

    const/4 v0, 0x0

    iput-boolean v0, p0, Leqh;->f:Z
...
.method public final c()V
    ...
    invoke-direct {v1, p0, v3, v2}, Lg3g;-><init>(Ljava/lang/Object;Lkotlin/coroutines/Continuation;I)V

    const/4 v2, 0x2

    iget-object v4, p0, Leqh;->b:Ltee;
...
.method public final f()V
    ...
    iget-object v5, p0, Leqh;->h:Lorh;

    if-eqz v5, :cond_1

    invoke-interface {v5}, Lorh;->k()J
    ...
    invoke-static {v5, v2, v6}, Lgj2;->b(Ljava/lang/Long;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v4, v0, v2, v3}, Lnfb;->c(Lgp8;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :cond_5
    iget-object v0, p0, Leqh;->j:Ljava/util/EnumSet;
    ...
    invoke-virtual {v0, v1}, Lwv8;->putAll(Ljava/util/Map;)V

    iget-object v1, p0, Leqh;->d:Lia8;
    ...
    invoke-virtual {p0, v1, v0}, Leqh;->q(Ljava/lang/String;Lwv8;)V
...
.method public final h()V
    ...
    :goto_0
    iget-boolean v5, p0, Leqh;->f:Z

    iget-wide v6, p0, Leqh;->g:J
...
.method public final i(Ljava/lang/Throwable;)V
    ...
    iget-object v5, p0, Leqh;->e:Ljava/lang/String;
    ...
    iget-object v7, p0, Leqh;->h:Lorh;

    if-eqz v7, :cond_1

    invoke-interface {v7}, Lorh;->k()J
    ...
    invoke-virtual {p1}, Lone/video/player/error/OneVideoPlaybackException;->a()Lmsb;
    ...
    invoke-virtual {p0, v0, p1}, Leqh;->q(Ljava/lang/String;Lwv8;)V
...
.method public final j()V
    ...
    iget-object v2, p0, Leqh;->k:Ljava/util/LinkedHashMap;

    invoke-virtual {v1, v2}, Lwv8;->putAll(Ljava/util/Map;)V

    iget-object v2, p0, Leqh;->d:Lia8;
...
.method public final m(Z)V
    ...
    invoke-static {v5, p1}, Lsb6;->o(Ljava/lang/String;Z)Ljava/lang/String;
...
.method public final q(Ljava/lang/String;Lwv8;)V
    .locals 3

    iget-object v0, p0, Leqh;->c:Lia8;
    ...
    invoke-static {v0, v1, p1, p2, v2}, Lzo8;->h(Lzo8;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;I)V
