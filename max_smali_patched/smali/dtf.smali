...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1, p0, v1}, Lctf;-><init>(Ljava/lang/Object;Ldtf;I)V

    iput-object v0, p0, Ldtf;->a:Lctf;
    ...
    invoke-direct {p0}, Ldtf;->getTheme()Lw5b;
    ...
    iput-object p1, p0, Ldtf;->b:Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-interface {v2}, Lw5b;->i()Libf;

    move-result-object v2

    iget-object v2, v2, Libf;->b:Lnbf;

    iget v2, v2, Lnbf;->b:I

    invoke-virtual {v0, v2}, Landroid/graphics/Paint;->setColor(I)V

    iput-object v0, p0, Ldtf;->d:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v1}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v0, p0, Ldtf;->o:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Ldtf;->s0:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Ldtf;->t0:Landroid/graphics/RectF;
...
.method public static final synthetic a(Ldtf;)Lw5b;
    .locals 0
...
.method private final getTheme()Lw5b;
    .locals 3
    ...
    invoke-virtual {p0}, Ldtf;->getThemeName()Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Ly5b;->a(Ljava/lang/String;)Lewa;
    ...
    invoke-virtual {v1, v2}, Lewa;->a(Z)Lw5b;
...
.method public final b()V
    ...
    invoke-virtual {v0}, Ldtf;->getIncomingColors()[I
    ...
    iput-object v3, v0, Ldtf;->u0:Landroid/graphics/LinearGradient;
    ...
    invoke-virtual {v0}, Ldtf;->getOutgoingColors()[I
    ...
    iput-object v12, v0, Ldtf;->v0:Landroid/graphics/LinearGradient;
...
.method public final getPatternDrawable()Landroid/graphics/drawable/Drawable;
    ...
    sget-object v0, Ldtf;->w0:[Les7;

    const/4 v1, 0x1

    aget-object v0, v0, v1

    iget-object v0, p0, Ldtf;->c:Lctf;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v10, p0, Ldtf;->d:Landroid/graphics/Paint;
    ...
    iget-object v5, p0, Ldtf;->s0:Landroid/graphics/RectF;

    invoke-virtual {v5, p1, v1, v6, v8}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Ldtf;->u0:Landroid/graphics/LinearGradient;

    iget-object v1, p0, Ldtf;->o:Landroid/graphics/Paint;
    ...
    iget-object v4, p0, Ldtf;->t0:Landroid/graphics/RectF;

    invoke-virtual {v4, p1, v8, v5, v2}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Ldtf;->v0:Landroid/graphics/LinearGradient;
...
.method public final onThemeChanged(Lw5b;)V
    ...
    :goto_0
    iget-object v0, p0, Ldtf;->d:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Ldtf;->b:Landroid/graphics/drawable/GradientDrawable;
...
.method public setSelected(Z)V
    ...
    invoke-interface {v1}, Lw5b;->i()Libf;
