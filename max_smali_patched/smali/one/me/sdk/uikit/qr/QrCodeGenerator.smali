...
.method static constructor <clinit>()V
    ...
    sget-object v0, Libd;->a:Lkg3;

    sput-object v0, Lone/me/sdk/uikit/qr/QrCodeGenerator;->b:Lkg3;
    ...
    sget-object v2, Lone/me/sdk/uikit/qr/QrCodeGenerator;->b:Lkg3;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const-string v2, "Failed to load native library qrcode (UnsatisfiedLinkError)"

    invoke-static {v3, v2, v1}, Lnm4;->A(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static b(Ljbd;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Lfa8;Landroid/content/Context;Ldqb;)Lhbd;
    .locals 19

    invoke-virtual/range {p0 .. p0}, Ljbd;->d()I

    move-result v0

    add-int/lit8 v0, v0, 0x2

    invoke-virtual/range {p0 .. p0}, Ljbd;->c()I
    ...
    invoke-virtual/range {p0 .. p0}, Ljbd;->f()I
    ...
    invoke-static/range {v7 .. v12}, Lktg;->c(Lktg;Landroid/content/Context;Landroid/text/TextPaint;Landroid/util/DisplayMetrics;Lge5;I)V

    invoke-interface/range {p5 .. p5}, Ldqb;->getText()Lzpb;
    ...
    invoke-static/range {v3 .. v12}, Lfa8;->a(Lfa8;Ljava/lang/CharSequence;Landroid/text/TextPaint;IIZLandroid/text/TextUtils$TruncateAt;FZI)Landroid/text/Layout;
    ...
    invoke-static/range {v13 .. v18}, Lktg;->c(Lktg;Landroid/content/Context;Landroid/text/TextPaint;Landroid/util/DisplayMetrics;Lge5;I)V
    ...
    invoke-virtual/range {p0 .. p0}, Ljbd;->h()I
    ...
    invoke-direct/range {p0 .. p5}, Lhbd;-><init>(Landroid/text/Layout;Landroid/text/Layout;III)V
...
.method public static c(Lone/me/sdk/uikit/qr/QrCodeGenerator;Ljava/lang/String;ILdqb;)Lgzb;
    .locals 10
    ...
    invoke-interface {p3}, Ldqb;->j()Lps0;
    ...
    invoke-direct {p0, p1, p3}, Lgzb;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {v3, p1}, Lrtc;->q(ILjava/lang/String;)Ljava/lang/String;
...
.method public static e(Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Landroid/graphics/Canvas;[IIIIILdqb;)V
    .locals 16
    ...
    invoke-interface/range {p8 .. p8}, Ldqb;->j()Lps0;
    ...
    invoke-static {v7, v0}, Ltla;->P(ILandroid/graphics/drawable/Drawable;)V
    ...
    iget-object v4, v4, Lps0;->c:Ljava/lang/Object;

    check-cast v4, Lsr3;

    iget-object v4, v4, Lsr3;->i:Ljava/lang/Object;
    ...
    invoke-static {v14, v13}, Lav;->N0(I[I)Ljava/lang/Integer;
    ...
    :goto_0
    invoke-static {v3, v13}, Lav;->N0(I[I)Ljava/lang/Integer;
    ...
    invoke-static {v9, v13}, Lav;->N0(I[I)Ljava/lang/Integer;
    ...
    :goto_2
    invoke-static {v12, v13}, Lav;->N0(I[I)Ljava/lang/Integer;
...
# virtual methods
.method public final g(Landroid/content/Context;ILy66;Ldng;Lfa8;Lnbd;Ljava/lang/String;Landroid/graphics/drawable/Drawable;Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Lz84;)Ljava/lang/Object;
    .locals 45
    ...
    invoke-direct {v3, v1, v2}, Lkbd;-><init>(Lone/me/sdk/uikit/qr/QrCodeGenerator;Lz84;)V

    goto :goto_0

    :goto_1
    iget-object v2, v14, Lkbd;->A0:Ljava/lang/Object;

    iget v3, v14, Lkbd;->C0:I
    ...
    iget-object v0, v14, Lkbd;->z0:Landroid/graphics/Bitmap;

    iget-object v3, v14, Lkbd;->Z:Landroid/graphics/Bitmap;

    iget-object v4, v14, Lkbd;->Y:Ljava/lang/String;

    iget-object v5, v14, Lkbd;->X:Lnbd;

    iget-object v6, v14, Lkbd;->o:Ly66;

    iget-object v7, v14, Lkbd;->d:Landroid/content/Context;
    ...
    :cond_3
    invoke-virtual {v10, v6}, Lz66;->i(Landroid/content/Context;)Lgqb;

    move-result-object v2

    iget-object v7, v2, Lgqb;->a:Ldqb;

    new-instance v18, Ljbd;
    ...
    invoke-direct/range {v18 .. v27}, Ljbd;-><init>(IIIIIIIII)V
    ...
    invoke-static/range {v2 .. v7}, Lone/me/sdk/uikit/qr/QrCodeGenerator;->b(Ljbd;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Lfa8;Landroid/content/Context;Ldqb;)Lhbd;

    move-result-object v9

    invoke-virtual {v2, v9}, Ljbd;->a(Lhbd;)I

    move-result v3

    invoke-virtual {v2}, Ljbd;->i()I
    ...
    :goto_2
    invoke-virtual {v2, v3}, Ljbd;->j(F)Ljbd;
    ...
    :try_start_1
    invoke-virtual {v2}, Ljbd;->d()I

    move-result v6

    invoke-static {v1, v15, v6, v7}, Lone/me/sdk/uikit/qr/QrCodeGenerator;->c(Lone/me/sdk/uikit/qr/QrCodeGenerator;Ljava/lang/String;ILdqb;)Lgzb;

    move-result-object v6

    iget-object v4, v6, Lgzb;->a:Ljava/lang/Object;

    move-object/from16 v31, v4

    check-cast v31, Landroid/graphics/Bitmap;

    iget-object v4, v6, Lgzb;->b:Ljava/lang/Object;
    ...
    invoke-static {v3, v1}, Lhbd;->a(Lhbd;I)Lhbd;

    move-result-object v1

    invoke-virtual {v2, v1}, Ljbd;->a(Lhbd;)I
    ...
    invoke-virtual/range {v18 .. v18}, Ljbd;->i()I
    ...
    invoke-interface {v7}, Ldqb;->n()Laqb;

    move-result-object v8

    iget-object v8, v8, Laqb;->e:Lep0;
    ...
    invoke-virtual/range {v18 .. v18}, Ljbd;->c()I
    ...
    :try_start_3
    invoke-static/range {v2 .. v10}, Lone/me/sdk/uikit/qr/QrCodeGenerator;->e(Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Landroid/graphics/Canvas;[IIIIILdqb;)V

    move/from16 v34, v8

    invoke-virtual/range {v19 .. v19}, Lhbd;->d()Landroid/text/Layout;

    move-result-object v29

    invoke-virtual/range {v19 .. v19}, Lhbd;->c()Landroid/text/Layout;

    move-result-object v30

    invoke-virtual/range {v18 .. v18}, Ljbd;->e()I

    move-result v32

    invoke-virtual/range {v19 .. v19}, Lhbd;->b()I

    move-result v33

    invoke-virtual/range {v19 .. v19}, Lhbd;->e()I
    ...
    :try_start_5
    invoke-virtual/range {v18 .. v18}, Ljbd;->b()I
    ...
    invoke-virtual/range {v18 .. v18}, Ljbd;->g()I
    ...
    invoke-virtual/range {p3 .. p3}, Ly66;->k()Ljava/io/File;
    ...
    invoke-static {v2, v1}, Ly66;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;

    move-result-object v3

    invoke-virtual {v0, v6}, Lz66;->d(Landroid/content/Context;)Lzc3;
    ...
    invoke-static {v2}, Lvej;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_8
    invoke-direct/range {v2 .. v8}, Lqo7;-><init>(Ljava/io/File;Ljava/io/File;Ly66;Landroid/content/Context;Landroid/graphics/Bitmap;Lkotlin/coroutines/Continuation;)V
    :try_end_8
    .catch Ljava/util/concurrent/CancellationException; {:try_start_8 .. :try_end_8} :catch_2
    .catchall {:try_start_8 .. :try_end_8} :catchall_4

    :try_start_9
    iput-object v6, v15, Lkbd;->d:Landroid/content/Context;
    :try_end_9
    ...
    :try_start_a
    iput-object v5, v15, Lkbd;->o:Ly66;
    :try_end_a
    ...
    :try_start_b
    iput-object v3, v15, Lkbd;->X:Lnbd;
    :try_end_b
    ...
    :try_start_c
    iput-object v4, v15, Lkbd;->Y:Ljava/lang/String;
    :try_end_c
    ...
    :try_start_d
    iput-object v8, v15, Lkbd;->Z:Landroid/graphics/Bitmap;

    iput-object v7, v15, Lkbd;->z0:Landroid/graphics/Bitmap;

    const/4 v10, 0x1

    iput v10, v15, Lkbd;->C0:I

    invoke-static {v9, v2, v15}, Ly6j;->g0(Lfc4;Lnt6;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v9, v2, v7, v0}, Lfbd;-><init>(Landroid/net/Uri;Landroid/graphics/Bitmap;Ldqb;)V

    new-instance v0, Lgzb;

    invoke-direct {v0, v3, v9}, Lgzb;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    sput-object v0, Lone/me/sdk/uikit/qr/QrCodeGenerator;->f:Lgzb;
    :try_end_e
    ...
    invoke-static {v2, v6, v0}, Lnm4;->A(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v4, v3, v0}, Lnm4;->A(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-virtual {v5}, Ly66;->k()Ljava/io/File;
