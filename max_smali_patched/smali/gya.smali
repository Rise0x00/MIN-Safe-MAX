...
.field public final j:Lw85;

.field public final k:Llpa;

.field public final l:Lzwa;

.field public final m:Lvf5;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lqxb;Lw85;Lzwa;Llpa;Lvf5;Lru7;Lhsf;Lfya;Lru7;)V
    .locals 0
    ...
    iput-object p1, p0, Lgya;->c:Le78;

    iput-object p5, p0, Lgya;->b:Llpa;

    iput-object p7, p0, Lgya;->d:Lru7;

    iput-object p8, p0, Lgya;->e:Lhsf;
    ...
    iput-object p2, p0, Lgya;->i:Lqxb;

    iput-object p3, p0, Lgya;->j:Lw85;

    iput-object p4, p0, Lgya;->l:Lzwa;

    iput-object p5, p0, Lgya;->k:Llpa;

    iput-object p6, p0, Lgya;->m:Lvf5;

    iput-object p9, p0, Lgya;->n:Lfya;

    iput-object p10, p0, Lgya;->o:Lru7;
...
.method public final b(Ljava/lang/CharSequence;ZZZZLjava/util/List;Z)Ljava/lang/CharSequence;
    ...
    :cond_2
    sget-object v6, Ljsf;->a:Ljava/util/regex/Pattern;
    ...
    :goto_1
    iget-object v0, v1, Lgya;->k:Llpa;

    invoke-virtual {v0, v3}, Llpa;->a(Z)I

    move-result v7

    if-eqz p4, :cond_4

    sget-object v0, La18;->c:La18;

    invoke-static {v6, v0, v2, v7}, Ljsf;->a(Landroid/text/Spannable;La18;ZI)V
    ...
    :goto_2
    iget-object v0, v1, Lgya;->l:Lzwa;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v10, v0, Lzwa;->a:Lru7;

    const/4 v11, 0x0

    :try_start_0
    invoke-static {v6, v9}, Ljyh;->a(Landroid/text/Spannable;I)Z
    ...
    :try_start_1
    invoke-static {v6}, Lngi;->g(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v0

    check-cast v0, Landroid/text/Spannable;

    invoke-static {v0, v9}, Ljyh;->a(Landroid/text/Spannable;I)Z
    ...
    invoke-virtual {v9, v5, v0}, Lk64;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :try_start_2
    invoke-static {v6, v9, v12}, Ljyh;->b(Landroid/text/Spannable;Ljava/util/regex/Pattern;Ljava/lang/String;)Z
    ...
    invoke-static {v0, v9, v12}, Ljyh;->b(Landroid/text/Spannable;Ljava/util/regex/Pattern;Ljava/lang/String;)Z
    ...
    invoke-virtual {v4, v5, v0}, Lk64;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v11, v1, Lgya;->m:Lvf5;

    invoke-interface {v11, v0}, Lvf5;->a(Ljava/lang/Throwable;)V
    ...
    :goto_13
    invoke-virtual {v1, v6, v5, v8, v3}, Lgya;->c(Ljava/lang/CharSequence;Lqb9;ZZ)Ljava/lang/CharSequence;
...
.method public final c(Ljava/lang/CharSequence;Lqb9;ZZ)Ljava/lang/CharSequence;
    .locals 4

    sget-object v0, Lqb9;->g:Ljava/util/EnumSet;

    iget-object v1, p2, Lqb9;->c:Lpb9;
    ...
    :goto_0
    new-instance p3, Ltb9;

    iget-object v1, p0, Lgya;->b:Llpa;

    invoke-virtual {v1, p4}, Llpa;->a(Z)I

    move-result p4

    invoke-direct {p3, p2, p4}, Ltb9;-><init>(Lqb9;I)V
    ...
    invoke-static {p3, p4, v0, p2}, Lcuh;->p(Ljava/lang/String;Ljava/lang/Exception;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public final d(Landroid/text/SpannableStringBuilder;ZZI)V
    ...
    invoke-direct {v0, p3, v1}, Lzj3;-><init>(ZI)V
    ...
    invoke-direct {p2, p3, v1, v2, v0}, Lhkg;-><init>(Landroid/content/Context;IZLfkg;)V
...
.method public final f()I
    ...
    invoke-virtual {v1, v3, v2}, Luu7;->getFloat(Ljava/lang/String;F)F
...
.method public final h(Ljava/lang/CharSequence;)Laxb;
    .locals 2
    ...
    invoke-static {p1, p0}, Lisf;->c(Ljava/lang/String;Lgya;)[Ljava/lang/String;
...
.method public final i(Ljava/lang/String;Ljava/util/ArrayList;)Laxb;
    .locals 1
    ...
    invoke-virtual {p0, p1}, Lgya;->h(Ljava/lang/CharSequence;)Laxb;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lgya;->j(Ljava/lang/CharSequence;Ljava/util/List;I)Ljava/lang/CharSequence;
    ...
    invoke-direct {v0, p2, p1}, Laxb;-><init>(Ljava/lang/CharSequence;[Ljava/lang/String;)V
...
.method public final j(Ljava/lang/CharSequence;Ljava/util/List;I)Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Lgya;->j:Lw85;

    if-nez v0, :cond_1

    invoke-interface {v1, p3, p1}, Lw85;->b(ILjava/lang/CharSequence;)Ljava/lang/CharSequence;
...
.method public final l(Ljava/lang/CharSequence;Ljava/util/List;)Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v0 .. v5}, Lgya;->k(Ljava/lang/CharSequence;Ljava/util/List;ZIZ)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0, p2, v1, v2, v3}, Lgya;->c(Ljava/lang/CharSequence;Lqb9;ZZ)Ljava/lang/CharSequence;
