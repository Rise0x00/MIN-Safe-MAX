...
.field private mSession2Token:Lpkg;
...
.method public constructor <init>(Ljava/lang/Object;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0, v0}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lpkg;)V
...
.method public constructor <init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;)V
    ...
    .line 2
    invoke-direct {p0, p1, p2, v0}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lpkg;)V

    return-void
.end method

.method public constructor <init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lpkg;)V
    .locals 1
    ...
    .line 7
    iput-object p3, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->mSession2Token:Lpkg;
...
.method public static fromBundle(Landroid/os/Bundle;)Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    invoke-static {p0}, Ledb;->b(Landroid/os/Bundle;)Lpkg;
    ...
    invoke-direct {v2, p0, v0, v1}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lpkg;)V
...
.method public getSession2Token()Lpkg;
    .locals 2
    ...
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->mSession2Token:Lpkg;
...
.method public setSession2Token(Lpkg;)V
    .locals 1
    ...
    :try_start_0
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->mSession2Token:Lpkg;
...
.method public toBundle()Landroid/os/Bundle;
    ...
    :cond_0
    :goto_0
    iget-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->mSession2Token:Lpkg;

    if-eqz v2, :cond_1

    invoke-static {v0, v2}, Ledb;->c(Landroid/os/Bundle;Lpkg;)V
