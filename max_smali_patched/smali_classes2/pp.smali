...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v6, Lofd;->checkedTextViewStyle:I
    ...
    iput-object p1, p0, Lpp;->c:Llr;

    invoke-virtual {p1, p2, v6}, Llr;->f(Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Lpp;->b:Lqa;

    invoke-virtual {p1, p2, v6}, Lqa;->t(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p1, p2, v0, v6}, Lps0;->p(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lps0;
    ...
    sget-object v3, Lgrd;->CheckedTextView:[I
    ...
    :try_start_0
    sget p2, Lgrd;->CheckedTextView_checkMarkCompat:I
    ...
    invoke-static {v3, p2}, Lmtd;->w(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-virtual {p0, p2}, Lpp;->setCheckMarkDrawable(Landroid/graphics/drawable/Drawable;)V
    :try_end_1
    ...
    :cond_0
    :try_start_2
    sget p2, Lgrd;->CheckedTextView_android_checkMark:I
    ...
    invoke-static {v2, p2}, Lmtd;->w(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    :goto_0
    sget p2, Lgrd;->CheckedTextView_checkMarkTint:I
    ...
    :cond_2
    sget p2, Lgrd;->CheckedTextView_checkMarkTintMode:I
    ...
    invoke-static {p2, v0}, Lfa5;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-direct {p0}, Lpp;->getEmojiTextViewHelper()Llq;

    move-result-object p1

    invoke-virtual {p1, v4, v6}, Llq;->c(Landroid/util/AttributeSet;I)V
...
.method public setCheckMarkDrawable(I)V
    ...
    invoke-virtual {p0, p1}, Lpp;->setCheckMarkDrawable(Landroid/graphics/drawable/Drawable;)V
