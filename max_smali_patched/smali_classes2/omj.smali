...
# direct methods
.method public static a(Lmc2;Landroid/hardware/camera2/CaptureRequest$Builder;)V
    .locals 1

    invoke-virtual {p0}, Lmc2;->a()Landroid/util/Range;
...
.method public static b(Landroid/hardware/camera2/CaptureRequest$Builder;Lcvb;)V
    .locals 4
    ...
    invoke-interface {p1}, Lyvd;->c()Ljava/util/Set;
    ...
    iget-object v2, v1, Lkf0;->c:Ljava/lang/Object;
    ...
    invoke-static {v2, v1}, Lw8g;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static c(Landroid/hardware/camera2/CaptureRequest$Builder;ILfe0;)V
    .locals 1
...
.method public static d(Lmc2;Landroid/hardware/camera2/CameraDevice;Ljava/util/HashMap;ZLfe0;)Landroid/hardware/camera2/CaptureRequest;
    .locals 10
    ...
    :cond_0
    iget-object v1, p0, Lmc2;->a:Ljava/util/ArrayList;

    iget v2, p0, Lmc2;->c:I

    iget-object v3, p0, Lmc2;->b:Lcvb;

    iget-object v4, v3, Lcvb;->a:Ljava/util/TreeMap;
    ...
    invoke-interface {p2}, Li72;->r()Landroid/hardware/camera2/CaptureResult;
    ...
    invoke-static {v8, p3}, Lw8g;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v8, p2}, Lw8g;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_3
    invoke-static {p1, v2, p4}, Lomj;->c(Landroid/hardware/camera2/CaptureRequest$Builder;ILfe0;)V

    invoke-static {p0, p1}, Lomj;->a(Lmc2;Landroid/hardware/camera2/CaptureRequest$Builder;)V

    invoke-virtual {p0}, Lmc2;->c()I

    move-result p2

    if-eq p2, v6, :cond_9

    invoke-virtual {p0}, Lmc2;->d()I
    ...
    invoke-virtual {v3, p2}, Lcvb;->d(Lkf0;)Ljava/lang/Object;
    ...
    :cond_d
    invoke-static {p1, v3}, Lomj;->b(Landroid/hardware/camera2/CaptureRequest$Builder;Lcvb;)V
...
.method public static e(Lmc2;Landroid/hardware/camera2/CameraDevice;Lfe0;)Landroid/hardware/camera2/CaptureRequest;
    .locals 3
    ...
    invoke-static {p1, v1, p2}, Lomj;->c(Landroid/hardware/camera2/CaptureRequest$Builder;ILfe0;)V

    invoke-static {p0, p1}, Lomj;->a(Lmc2;Landroid/hardware/camera2/CaptureRequest$Builder;)V

    iget-object p0, p0, Lmc2;->b:Lcvb;

    invoke-static {p1, p0}, Lomj;->b(Landroid/hardware/camera2/CaptureRequest$Builder;Lcvb;)V
