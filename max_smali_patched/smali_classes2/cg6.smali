...
.field public volatile Y:Lqg6;

.field public volatile Z:Lqg6;
...
.field public final o:Lcid;

.field public volatile s0:J

.field public final t0:Lbvf;

.field public final u0:Lbvf;
...
# direct methods
.method public constructor <init>(Lcwc;Lcid;)V
    .locals 4
    ...
    iput-object v0, p0, Lcg6;->v0:Ljava/util/concurrent/atomic/AtomicInteger;

    iput-object p1, p0, Lcg6;->d:Lcwc;

    iput-object p2, p0, Lcg6;->o:Lcid;

    new-instance p1, Lu14;

    const-string p2, "SSFrameEncoder"

    invoke-direct {p1, p2}, Lu14;-><init>(Ljava/lang/String;)V

    iput-object p1, p0, Lcg6;->c:Lu14;

    new-instance p1, Lbvf;

    invoke-direct {p1}, Lbvf;-><init>()V

    iput-object p1, p0, Lcg6;->t0:Lbvf;

    new-instance p1, Lbvf;

    invoke-direct {p1}, Lbvf;-><init>()V

    iput-object p1, p0, Lcg6;->u0:Lbvf;
...
.method public final a()V
    ...
    iput-boolean v0, p0, Lcg6;->w0:Z

    iget-object v0, p0, Lcg6;->X:Lorg/webrtc/VpxEncoderWrapper;
    ...
    iput-object v0, p0, Lcg6;->X:Lorg/webrtc/VpxEncoderWrapper;
...
.method public final onEncodedImage(Lorg/webrtc/EncodedImage;)V
    ...
    iget-object v0, p0, Lcg6;->t0:Lbvf;
    ...
    iput-wide v2, p0, Lcg6;->s0:J

    :cond_0
    iget-object v0, p0, Lcg6;->Y:Lqg6;

    if-eqz v0, :cond_3

    iget-object v0, p0, Lcg6;->Y:Lqg6;

    iget-boolean v2, v0, Lqg6;->a:Z
    ...
    iput-boolean v1, v0, Lqg6;->h:Z

    :cond_2
    iget-object v1, v0, Lqg6;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    iget-object v1, v0, Lqg6;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p1, v0, Lqg6;->g:Lwrh;

    invoke-static {p1}, Lqg6;->b(Lwrh;)V
...
.method public final onFrame(Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v2, p0, Lcg6;->Z:Lqg6;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtimeNanos()J

    move-result-wide v3

    iget-wide v5, p0, Lcg6;->x0:J
    ...
    iget-object v5, v2, Lqg6;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iget-object v5, v2, Lqg6;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_1
    iget-object v5, p0, Lcg6;->v0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v7, v0, v1}, Lcwc;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-wide v3, p0, Lcg6;->x0:J

    iget-object p1, p0, Lcg6;->v0:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p1}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iget-object p1, p0, Lcg6;->c:Lu14;

    new-instance v0, Ld75;

    const/16 v3, 0xd

    invoke-direct {v0, p0, v2, v1, v3}, Ld75;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final onFrameDropped(I)V
    ...
    iget-object p1, p0, Lcg6;->u0:Lbvf;

    invoke-virtual {p1}, Lbvf;->a()V
