...
.method public constructor <init>(Lie5;)V
    ...
    iput-object v0, p0, Lqv4;->o:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/16 v0, 0x10

    new-array v2, v0, [F

    iput-object v2, p0, Lqv4;->X:[F

    new-array v0, v0, [F

    iput-object v0, p0, Lqv4;->Y:[F

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, Lqv4;->Z:Ljava/util/LinkedHashMap;

    iput v1, p0, Lqv4;->z0:I

    iput-boolean v1, p0, Lqv4;->A0:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lqv4;->B0:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lqv4;->b:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Lqv4;->d:Landroid/os/Handler;

    new-instance v0, Lh57;

    invoke-direct {v0, v1}, Lh57;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Lqv4;->c:Lh57;

    new-instance v0, Ly55;

    invoke-direct {v0}, Ly55;-><init>()V

    iput-object v0, p0, Lqv4;->a:Ly55;

    :try_start_0
    new-instance v0, Lnv4;

    invoke-direct {v0, p0, p1}, Lnv4;-><init>(Lqv4;Lie5;)V
    ...
    :try_start_1
    invoke-virtual {p1}, Lr12;->get()Ljava/lang/Object;
    :try_end_1
    ...
    invoke-virtual {p0}, Lqv4;->release()V
...
.method public final a()V
    ...
    iget-boolean v0, p0, Lqv4;->A0:Z

    if-eqz v0, :cond_2

    iget v0, p0, Lqv4;->z0:I

    if-nez v0, :cond_2

    iget-object v0, p0, Lqv4;->Z:Ljava/util/LinkedHashMap;
    ...
    invoke-virtual {v2}, Lygg;->close()V

    goto :goto_0

    :cond_0
    iget-object v1, p0, Lqv4;->B0:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Lqv4;->a:Ly55;

    invoke-virtual {v0}, Ly55;->r()V

    iget-object v0, p0, Lqv4;->b:Landroid/os/HandlerThread;
...
.method public final c(Ljava/lang/Exception;)V
    ...
    iget-object v0, p0, Lqv4;->B0:Ljava/util/ArrayList;
...
.method public final d(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v2}, Ln6j;->a([FF)V

    invoke-static {v1}, Ln6j;->b([F)V

    move-object/from16 v2, p1

    invoke-static {v2, v0}, Lj6h;->h(Landroid/util/Size;I)Landroid/util/Size;

    move-result-object v0

    move-object/from16 v2, p0

    iget-object v3, v2, Lqv4;->a:Ly55;
    ...
    invoke-static {v6, v5}, Lvfa;->h(Ljava/lang/String;Z)V
    ...
    invoke-static {v6}, Lxu6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v15}, Lxu6;->b(Ljava/lang/String;)V
    ...
    invoke-static/range {v16 .. v16}, Lxu6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v7}, Lxu6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v8}, Lxu6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v9}, Lxu6;->b(Ljava/lang/String;)V
    ...
    iput-object v6, v3, Ly55;->k:Ljava/lang/Object;
    ...
    iget-object v6, v3, Ly55;->m:Ljava/lang/Object;

    check-cast v6, Lvu6;

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    instance-of v10, v6, Lwu6;
    ...
    invoke-static {v1}, Lxu6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lxu6;->b(Ljava/lang/String;)V
...
.method public final e(Lfhg;)V
    ...
    iget-object v0, p0, Lqv4;->o:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v1, p1, v2}, Lpv4;-><init>(Lfhg;I)V

    invoke-virtual {p0, v0, v1}, Lqv4;->b(Ljava/lang/Runnable;Ljava/lang/Runnable;)V

    return-void
.end method

.method public final f(II)Lyi8;
    .locals 1

    new-instance v0, Lt42;

    invoke-direct {v0, p0, p1, p2}, Lt42;-><init>(Ljava/lang/Object;II)V
...
.method public final g(Lygg;)V
    ...
    invoke-direct {v1, v2, p1}, Lov4;-><init>(ILjava/lang/Object;)V
...
.method public final h(Lp8h;)V
    ...
    invoke-virtual {p0, p1}, Lqv4;->c(Ljava/lang/Exception;)V
    ...
    :cond_3
    :goto_1
    iget-object v4, p1, Lp8h;->b:Ljava/lang/Object;

    check-cast v4, Landroid/util/Size;

    iget-object v5, p1, Lp8h;->c:Ljava/lang/Object;

    check-cast v5, [F

    invoke-virtual {p0, v4, v5, v9}, Lqv4;->d(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    :cond_5
    iget-object v9, p1, Lp8h;->a:Ljava/lang/Object;
    ...
    iget-object v8, v8, Lmf0;->c:Lo12;

    invoke-virtual {v8, v3}, Lo12;->b(Ljava/lang/Object;)Z
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v0, p0, Lqv4;->X:[F

    invoke-virtual {p1, v0}, Landroid/graphics/SurfaceTexture;->getTransformMatrix([F)V

    iget-object v1, p0, Lqv4;->Z:Ljava/util/LinkedHashMap;
    ...
    iget-object v5, p0, Lqv4;->Y:[F

    const/4 v6, 0x1

    invoke-virtual {v3, v5, v0, v6}, Lygg;->J([F[FZ)V
    ...
    :try_start_0
    iget-object v3, p0, Lqv4;->a:Ly55;

    invoke-virtual {p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v6

    invoke-virtual {v3, v6, v7, v5, v4}, Ly55;->u(J[FLandroid/view/Surface;)V
    :try_end_0
    ...
    invoke-static {v7, v8}, Lvfa;->m(Ljava/lang/String;Z)V
    ...
    invoke-static {v2, v6}, Lvfa;->m(Ljava/lang/String;Z)V

    new-instance v2, Lp8h;

    iget-object v3, v3, Lygg;->d:Landroid/util/Size;
    ...
    invoke-direct {v2, v4, v3, v5}, Lp8h;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    goto :goto_0

    :cond_4
    :try_start_1
    invoke-virtual {p0, v2}, Lqv4;->h(Lp8h;)V
    :try_end_1
