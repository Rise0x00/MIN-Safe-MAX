...
.method public final b(Landroid/graphics/Canvas;Landroid/graphics/Paint;II)V
    ...
    invoke-static {p3, p4}, Lg84;->P(II)I

    move-result p3

    iget-object p4, p0, Lua5;->a:Lmp0;
    ...
    invoke-virtual/range {v1 .. v7}, Ljd8;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;FF)V

    :cond_0
    return-void
.end method

.method public final c(Landroid/graphics/Canvas;Landroid/graphics/Paint;Lta5;I)V
    .locals 9

    iget v0, p3, Lta5;->c:I

    invoke-static {v0, p4}, Lg84;->P(II)I
    ...
    invoke-virtual/range {v1 .. v8}, Ljd8;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
...
.method public final d(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
    ...
    invoke-static {p5, p6}, Lg84;->P(II)I
    ...
    invoke-virtual/range {v0 .. v7}, Ljd8;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
...
.method public final g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
    ...
    invoke-static {p3, v0, v1}, Lsr6;->q(FFF)F

    move-result p3

    move/from16 v2, p4

    invoke-static {v2, v0, v1}, Lsr6;->q(FFF)F
    ...
    invoke-static {v3, v1, p3}, Lnm4;->T(FFF)F
    ...
    invoke-static {v3, v1, v2}, Lnm4;->T(FFF)F
    ...
    invoke-static {p3, v0, v4}, Lsr6;->q(FFF)F
    ...
    invoke-static {v2, v6, v1}, Lsr6;->q(FFF)F
    ...
    invoke-virtual/range {v5 .. v11}, Ljd8;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;FF)V
