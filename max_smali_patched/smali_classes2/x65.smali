...
.method private getCorrectionMatrix()Landroid/graphics/Matrix;
    ...
    iget-object v0, p0, Lx65;->d:Landroid/graphics/Matrix;

    iget-object v1, p0, Lx65;->u0:[F
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lx65;->w0:Landroid/graphics/Rect;
    ...
    :cond_0
    iget-object v0, p0, Lx65;->a:Ljava/util/ArrayList;
    ...
    invoke-interface {v1, p1}, Lq65;->draw(Landroid/graphics/Canvas;)V
...
.method public getResultBounds()Landroid/graphics/Rect;
    ...
    :goto_0
    iget-boolean v1, p0, Lx65;->x0:Z

    if-eqz v1, :cond_2

    iget-object v1, p0, Lx65;->y0:Lv65;
...
.method public final onScale(Landroid/view/ScaleGestureDetector;)Z
    ...
    iget-object v2, p0, Lx65;->d:Landroid/graphics/Matrix;

    invoke-virtual {v2, v0, v0, v1, p1}, Landroid/graphics/Matrix;->postScale(FFFF)Z

    iget-object v0, p0, Lx65;->s0:Ljava/lang/Float;

    if-eqz v0, :cond_0

    iget-object v3, p0, Lx65;->t0:Ljava/lang/Float;
    ...
    :cond_0
    iget-object v0, p0, Lx65;->o:Landroid/graphics/Matrix;
    ...
    iput-object v0, p0, Lx65;->s0:Ljava/lang/Float;

    invoke-static {p1}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;

    move-result-object p1

    iput-object p1, p0, Lx65;->t0:Ljava/lang/Float;
...
.method public final onScaleBegin(Landroid/view/ScaleGestureDetector;)Z
    ...
    iget-object p1, p0, Lx65;->c:Lw65;

    if-eqz p1, :cond_1

    check-cast p1, Lt65;

    iget-object v0, p1, Lt65;->c:Ltz8;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Ltz8;->j()Ly9;

    move-result-object v0

    iget-object v1, p1, Lt65;->a:Lx65;

    invoke-virtual {v0, v1}, Ly9;->a(Ls65;)V

    :cond_0
    const/4 v0, 0x0

    iput-object v0, p1, Lt65;->c:Ltz8;
...
.method public final onScaleEnd(Landroid/view/ScaleGestureDetector;)V
    ...
    iget-object v3, p0, Lx65;->u0:[F

    const/4 p1, 0x0

    iput-object p1, p0, Lx65;->s0:Ljava/lang/Float;

    iput-object p1, p0, Lx65;->t0:Ljava/lang/Float;

    invoke-direct {p0}, Lx65;->getCorrectionMatrix()Landroid/graphics/Matrix;
    ...
    invoke-direct {v0, p0, v4, v3, v2}, Lph;-><init>(Ljava/lang/Object;Ljava/lang/Object;ZI)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, Lx65;->x0:Z

    const/4 v1, 0x1

    if-eqz v0, :cond_3

    iget-object v0, p0, Lx65;->y0:Lv65;
    ...
    :cond_1
    iget-object v0, p0, Lx65;->c:Lw65;

    if-eqz v0, :cond_2

    check-cast v0, Lt65;

    invoke-virtual {v0, p1}, Lt65;->c(Landroid/view/MotionEvent;)V
    ...
    :cond_3
    :goto_0
    iget-object v0, p0, Lx65;->b:Landroid/view/ScaleGestureDetector;
...
.method public setBoundingListener(Lv65;)V
    .locals 0

    iput-object p1, p0, Lx65;->y0:Lv65;
...
.method public setBounds(Landroid/graphics/Rect;)V
    ...
    iput-object p1, p0, Lx65;->w0:Landroid/graphics/Rect;
...
.method public setDrawStickerEnabled(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, Lx65;->x0:Z

    iget-object v0, p0, Lx65;->y0:Lv65;

    if-eqz v0, :cond_1

    invoke-interface {v0, p1}, Lv65;->setDrawStickerEnabled(Z)V
...
.method public setListener(Lw65;)V
    .locals 0

    iput-object p1, p0, Lx65;->c:Lw65;
