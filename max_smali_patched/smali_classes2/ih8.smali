...
# direct methods
.method public constructor <init>(Landroid/widget/EditText;ZLk5;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lih8;->a:Landroid/widget/EditText;

    iput-boolean p2, p0, Lih8;->b:Z

    iput-object p3, p0, Lih8;->c:Lk5;

    new-instance p1, Lj0a;

    invoke-direct {p1}, Lj0a;-><init>()V

    iput-object p1, p0, Lih8;->d:Lj0a;
...
.method public final a(ILandroid/text/Editable;II)V
    ...
    invoke-direct {p1, v1}, Lar0;-><init>(I)V

    invoke-static {p2, p3, p4, v1, p1}, Lngi;->d(Landroid/text/Editable;IIZLjh8;)V

    return-void

    :cond_0
    sget v0, Lvpc;->markdown_italic:I
    ...
    invoke-direct {p1, v2}, Lar0;-><init>(I)V
    ...
    :cond_1
    sget v0, Lvpc;->markdown_underline:I

    if-ne p1, v0, :cond_2

    new-instance p1, Lnaf;

    invoke-direct {p1, v2}, Lnaf;-><init>(I)V

    invoke-static {p2, p3, p4, v2, p1}, Lngi;->d(Landroid/text/Editable;IIZLjh8;)V

    return-void

    :cond_2
    sget v0, Lvpc;->markdown_mono:I

    if-ne p1, v0, :cond_3

    new-instance p1, Lhu9;

    invoke-direct {p1}, Lhu9;-><init>()V
    ...
    :cond_3
    sget v0, Lvpc;->markdown_strikethrough:I

    if-ne p1, v0, :cond_4

    new-instance p1, Lnaf;

    invoke-direct {p1, v1}, Lnaf;-><init>(I)V
    ...
    :cond_4
    sget v0, Lvpc;->markdown_heading:I
    ...
    :cond_5
    sget v0, Lvpc;->markdown_quote:I

    sget-object v3, Lybg;->a:Lybg;

    iget-object v4, p0, Lih8;->a:Landroid/widget/EditText;
    ...
    sget v0, Lypc;->text_change_is_programmatic_tag:I
    ...
    invoke-static {p2, v0, p1, p3, p4}, Lpgi;->j(Landroid/text/Spannable;Ljh8;III)V
    ...
    :try_start_2
    invoke-static {p2, v1, v3, v5}, Lngi;->e(Landroid/text/Spannable;Lh44;II)V
    ...
    :cond_f
    :goto_5
    sget p1, Lypc;->text_change_is_programmatic_tag:I

    invoke-virtual {v4, p1, v9}, Landroid/view/View;->setTag(ILjava/lang/Object;)V

    invoke-static {p2}, Lnki;->c(Landroid/text/Editable;)V

    return-void

    :goto_6
    sget p2, Lypc;->text_change_is_programmatic_tag:I
    ...
    :cond_10
    sget v0, Lvpc;->markdown_regular:I
    ...
    :try_start_5
    invoke-static {p2, v1, v6, v7}, Lngi;->e(Landroid/text/Spannable;Lh44;II)V
    ...
    :goto_a
    invoke-static {p2, p3, p4}, Lngi;->c(Landroid/text/Spannable;II)V
...
.method public final b()Lojc;
    ...
    iget-object v1, v0, Lih8;->a:Landroid/widget/EditText;
    ...
    invoke-static {v3, v6}, Ljvi;->c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct/range {v2 .. v14}, Lojc;-><init>(Landroid/content/Context;Lot0;Lorf;Landroid/graphics/drawable/Drawable;IIIIIIIF)V
...
.method public final c()Z
    ...
    iget-object v0, p0, Lih8;->a:Landroid/widget/EditText;
...
.method public final d(Landroid/text/Editable;II)V
    ...
    iget-object p1, v3, Lt08;->c:Ljava/lang/String;

    iget-object v0, v2, Lk5;->b:Ljava/lang/Object;

    check-cast v0, Lone/me/sdk/messagewrite/MessageWriteWidget;

    sget-object v1, Lone/me/sdk/messagewrite/MessageWriteWidget;->K0:[Les7;

    iget-object v0, v0, Lone/me/sdk/messagewrite/MessageWriteWidget;->c:Lru7;
    ...
    invoke-direct {v1, p2, p3, p1}, Lca;-><init>(IILjava/lang/String;)V
    ...
    :cond_2
    iget-object p1, v2, Lk5;->b:Ljava/lang/Object;
    ...
    iget-object p1, p1, Lone/me/sdk/messagewrite/MessageWriteWidget;->c:Lru7;
    ...
    iget-object p1, p1, Lkh8;->c:Laf5;

    new-instance v0, Lca;

    invoke-direct {v0, p2, p3, v1}, Lca;-><init>(IILjava/lang/String;)V
...
.method public final onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {p0, p2, v0, v1, v2}, Lih8;->a(ILandroid/text/Editable;II)V
    ...
    :cond_1
    sget v5, Lvpc;->markdown_italic:I
    ...
    :cond_4
    sget v5, Lvpc;->markdown_strikethrough:I
    ...
    :cond_5
    sget v5, Lvpc;->markdown_link:I

    if-ne v4, v5, :cond_6

    invoke-virtual {p0, v0, v1, v2}, Lih8;->d(Landroid/text/Editable;II)V

    return v6

    :cond_6
    sget v5, Lvpc;->markdown_heading:I
    ...
    :cond_8
    sget v5, Lvpc;->markdown_regular:I
...
.method public final onCreateActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    iget-object p1, p0, Lih8;->d:Lj0a;

    invoke-virtual {p1}, Lj0a;->c()V

    const v0, 0x1020020

    invoke-virtual {p1, v0}, Lj0a;->a(I)V

    const v0, 0x1020021

    invoke-virtual {p1, v0}, Lj0a;->a(I)V

    invoke-virtual {p0}, Lih8;->c()Z
    ...
    invoke-virtual {p1, v3}, Lj0a;->a(I)V
...
.method public final onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    :cond_4
    sget-object v1, Leh8;->X:Leh8;

    iget v2, v1, Leh8;->a:I

    iget-object v3, p0, Lih8;->a:Landroid/widget/EditText;
    ...
    invoke-virtual {p1, v2}, Lj0a;->a(I)V
    ...
    invoke-static {p1, v1}, Li3e;->d(Ly2e;Lqi6;)Law5;
