...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    :cond_0
    iput-object p1, p0, Lak5;->b:Ljava/lang/CharSequence;

    sget-object p1, Lcbg;->M:Lorf;

    new-instance v0, Ltk;

    const/4 v1, 0x7

    invoke-direct {v0, p1, v1, p0}, Ltk;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    iput-object v0, p0, Lak5;->c:Ltk;
    ...
    invoke-virtual {p0}, Lak5;->getTypography()Lorf;
    ...
    iput-object p1, p0, Lak5;->d:Landroid/text/TextPaint;

    const p1, 0x7fffffff

    iput p1, p0, Lak5;->s0:I

    invoke-virtual {v0, p0}, Lvh4;->i(Landroid/view/View;)Lw5b;

    move-result-object p1

    invoke-virtual {p0, p1}, Lak5;->onThemeChanged(Lw5b;)V
...
.method public final a(ILjava/lang/CharSequence;)Landroid/text/Layout;
    ...
    invoke-static {p2}, Lf9a;->b(Ljava/lang/CharSequence;)Luve;
    ...
    iget-object v1, p0, Lak5;->a:Lou7;

    iget-object v3, p0, Lak5;->d:Landroid/text/TextPaint;
...
.method public final b(I)V
    ...
    iget-object v0, p0, Lak5;->o:Landroid/text/SpannableString;
    ...
    :cond_0
    invoke-virtual {p0, p1, v0}, Lak5;->a(ILjava/lang/CharSequence;)Landroid/text/Layout;

    move-result-object v1

    iput-object v1, p0, Lak5;->v0:Landroid/text/Layout;

    invoke-virtual {v1}, Landroid/text/Layout;->getLineCount()I

    move-result v1

    iget v2, p0, Lak5;->s0:I

    if-gt v1, v2, :cond_1

    iget-object p1, p0, Lak5;->v0:Landroid/text/Layout;
    ...
    iget-object v3, p0, Lak5;->b:Ljava/lang/CharSequence;
    ...
    iget-object v4, p0, Lak5;->d:Landroid/text/TextPaint;
    ...
    :cond_6
    invoke-static {v7, v0}, Lxaf;->c0(ILjava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, v4, p0}, Lrh7;-><init>(ILjava/lang/Object;)V

    new-instance v4, Landroid/text/SpannableStringBuilder;

    invoke-static {v0}, Lngi;->g(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    :goto_5
    iput-object p1, p0, Lak5;->u0:Landroid/text/Layout;

    iget-boolean v0, p0, Lak5;->y0:Z
    ...
    :cond_8
    iput-object p1, p0, Lak5;->t0:Landroid/text/Layout;
...
.method public final c()V
    ...
    invoke-virtual {p0, v0}, Lak5;->b(I)V

    const/4 v0, 0x1

    iput-boolean v0, p0, Lak5;->w0:Z
    ...
    :cond_0
    iget-object v0, p0, Lak5;->A0:Lwq0;
    ...
    iput-object v0, p0, Lak5;->A0:Lwq0;

    invoke-virtual {p0}, Landroid/view/View;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v0

    iget-object v1, p0, Lak5;->A0:Lwq0;
...
.method public final getTextLayout()Landroid/text/Layout;
    ...
    iget-object v0, p0, Lak5;->t0:Landroid/text/Layout;

    return-object v0
.end method

.method public final getTypography()Lorf;
    .locals 2

    sget-object v0, Lak5;->B0:[Les7;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    iget-object v0, p0, Lak5;->c:Ltk;
...
.method public final onMeasure(II)V
    ...
    iget-object p2, p0, Lak5;->z0:Ljava/lang/Integer;
    ...
    :cond_0
    iget-object p2, p0, Lak5;->t0:Landroid/text/Layout;
...
.method public final onThemeChanged(Lw5b;)V
    ...
    iget-object v0, p0, Lak5;->d:Landroid/text/TextPaint;

    invoke-virtual {v0, p1}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p1, p0, Lak5;->o:Landroid/text/SpannableString;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    iget-object v1, p0, Lak5;->t0:Landroid/text/Layout;
    ...
    invoke-static {v2, v5, v1}, Lm65;->c(FFI)I
...
.method public final setText(Landroid/text/SpannableString;)V
    ...
    .line 1
    iput-object p1, p0, Lak5;->o:Landroid/text/SpannableString;
...
.method public final setText(Ljava/lang/CharSequence;)V
    ...
    invoke-static {p1, v0, v1}, Lxe8;->n(Ljava/lang/CharSequence;II)Landroid/text/Spannable;
    ...
    .line 4
    invoke-static {p1}, Lf9a;->b(Ljava/lang/CharSequence;)Luve;
    ...
    .line 6
    iput-boolean p1, p0, Lak5;->y0:Z

    .line 7
    iput-boolean p1, p0, Lak5;->w0:Z
