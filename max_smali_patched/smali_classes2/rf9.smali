...
.method public final onRouteAdded(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    iget-object p1, p0, Lrf9;->a:Lclg;

    invoke-virtual {p1, p2}, Lclg;->j(Ljava/lang/Object;)Z

    move-result p2

    if-eqz p2, :cond_0

    invoke-virtual {p1}, Lclg;->t()V
...
.method public final onRouteChanged(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    invoke-static {p2}, Lclg;->o(Ljava/lang/Object;)Lblg;

    move-result-object v0

    if-nez v0, :cond_1

    invoke-virtual {p1, p2}, Lclg;->k(Ljava/lang/Object;)I

    move-result p2

    if-ltz p2, :cond_1

    iget-object v0, p1, Lclg;->H0:Ljava/util/ArrayList;
    ...
    iget-object v1, p2, Lalg;->b:Ljava/lang/String;

    iget-object v2, p2, Lalg;->a:Ljava/lang/Object;

    iget-object v3, p1, Lfsc;->c:Ljava/lang/Object;
    ...
    :goto_0
    invoke-direct {v0, v1, v2}, Lz3d;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p1, p2, v0}, Lclg;->p(Lalg;Lz3d;)V

    invoke-virtual {v0}, Lz3d;->c()Lie9;

    move-result-object v0

    iput-object v0, p2, Lalg;->c:Lie9;
...
.method public final onRoutePresentationDisplayChanged(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    iget-object v1, p1, Lclg;->H0:Ljava/util/ArrayList;
    ...
    :goto_1
    iget-object v3, v0, Lalg;->c:Lie9;

    iget-object v3, v3, Lie9;->a:Landroid/os/Bundle;
    ...
    iget-object v2, v0, Lalg;->c:Lie9;

    if-eqz v2, :cond_5

    new-instance v3, Landroid/os/Bundle;

    iget-object v5, v2, Lie9;->a:Landroid/os/Bundle;

    invoke-direct {v3, v5}, Landroid/os/Bundle;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {v2}, Lie9;->b()Ljava/util/List;
    ...
    :goto_2
    invoke-virtual {v2}, Lie9;->a()V

    iget-object v6, v2, Lie9;->c:Ljava/util/List;
    ...
    iget-object v2, v2, Lie9;->c:Ljava/util/List;
    ...
    invoke-direct {p2, v3}, Lie9;-><init>(Landroid/os/Bundle;)V

    iput-object p2, v0, Lalg;->c:Lie9;
...
.method public final onRouteSelected(Landroid/media/MediaRouter;ILandroid/media/MediaRouter$RouteInfo;)V
    ...
    iget-object p2, p1, Lclg;->A0:Ljava/lang/Object;
    ...
    :cond_0
    invoke-static {p3}, Lclg;->o(Ljava/lang/Object;)Lblg;

    move-result-object p2

    if-eqz p2, :cond_1

    iget-object p1, p2, Lblg;->a:Llf9;
    ...
    :cond_1
    invoke-virtual {p1, p3}, Lclg;->k(Ljava/lang/Object;)I

    move-result p2

    if-ltz p2, :cond_2

    iget-object p3, p1, Lclg;->H0:Ljava/util/ArrayList;
    ...
    iget-object p1, p1, Lclg;->z0:Ldlg;

    iget-object p2, p2, Lalg;->b:Ljava/lang/String;

    check-cast p1, Lif9;

    iget-object p3, p1, Lif9;->m:Lgf9;

    const/16 v0, 0x106

    invoke-virtual {p3, v0}, Landroid/os/Handler;->removeMessages(I)V

    iget-object p3, p1, Lif9;->c:Lykg;

    invoke-virtual {p1, p3}, Lif9;->d(Lfsc;)Lkf9;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1, p2}, Lkf9;->a(Ljava/lang/String;)Llf9;
...
.method public final onRouteVolumeChanged(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    iget-object v1, v0, Lalg;->c:Lie9;

    iget-object v1, v1, Lie9;->a:Landroid/os/Bundle;
    ...
    iget-object v4, v1, Lie9;->a:Landroid/os/Bundle;

    invoke-direct {v3, v4}, Landroid/os/Bundle;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {v1}, Lie9;->b()Ljava/util/List;
    ...
    iget-object v6, v1, Lie9;->c:Ljava/util/List;
    ...
    iget-object v1, v1, Lie9;->c:Ljava/util/List;
