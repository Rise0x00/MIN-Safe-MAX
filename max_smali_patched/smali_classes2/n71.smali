...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ln71;->i:Ljava/util/List;

    return-void
.end method

.method public constructor <init>(Lru/ok/android/externcalls/analytics/CallAnalyticsSender;Ltuf;Lwge;Lcua;Lch8;Lcwc;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ln71;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;

    iput-object p2, p0, Ln71;->b:Ltuf;

    iput-object p3, p0, Ln71;->c:Lwge;

    iput-object p4, p0, Ln71;->d:Lcua;

    iput-object p5, p0, Ln71;->e:Lch8;

    iput-object p6, p0, Ln71;->f:Lcwc;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Ln71;->h:Ljava/util/ArrayList;
...
.method public final b(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    iget-object v0, p0, Ln71;->h:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Ln71;->h:Ljava/util/ArrayList;

    invoke-static {v1}, Lab3;->X(Ljava/lang/Iterable;)Ljava/util/List;

    move-result-object v1

    iget-object v2, p0, Ln71;->h:Ljava/util/ArrayList;
    ...
    iget-object v2, v1, Lqth;->c:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
    ...
    iget-object v3, v1, Lqth;->d:Ljava/lang/Long;
    ...
    invoke-interface {v3}, Ltuf;->localTimeMs()J
    ...
    iget-object v6, v1, Lqth;->a:Ljava/lang/String;

    iget-object v1, v1, Lqth;->b:Lru/ok/android/externcalls/analytics/events/EventItemValue;
    ...
    iget-object v2, p0, Ln71;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;
...
.method public final c(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    iget-object v1, p0, Ln71;->b:Ltuf;

    invoke-interface {v1}, Ltuf;->getServerTimeMs()Ljava/lang/Long;

    move-result-object v1

    invoke-direct {v0, p1, p2, p3, v1}, Lqth;-><init>(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;Ljava/lang/Long;)V

    iget-object v2, p0, Ln71;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;

    if-nez v2, :cond_0

    iget-object p1, p0, Ln71;->h:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_0
    iget-object p2, p0, Ln71;->h:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v0, p0, Ln71;->b:Ltuf;

    invoke-interface {v0}, Ltuf;->getServerTimeMs()Ljava/lang/Long;
    ...
    invoke-interface {v0}, Ltuf;->localTimeMs()J
    ...
    iget-object p2, p0, Ln71;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;
...
.method public final onTopologyUpdated(Ljzf;Ljzf;)V
    ...
    iget-object p1, p0, Ln71;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
    ...
    iget-object p2, p0, Ln71;->c:Lwge;

    invoke-virtual {p2, p1}, Lwge;->a(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    iget-object p2, p0, Ln71;->d:Lcua;

    iget-object p2, p2, Lcua;->b:Ljava/lang/Object;

    check-cast p2, Lq34;

    iget-object p2, p2, Lq34;->a:Ljava/lang/String;
    ...
    iget-object p2, p0, Ln71;->e:Lch8;

    iget-object v0, p2, Lch8;->b:Ljava/lang/Object;
    ...
    invoke-static {v0, p2}, Lbt9;->b(Landroid/net/ConnectivityManager;Landroid/telephony/TelephonyManager;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Ln71;->b(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    iput-object p1, p0, Ln71;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
