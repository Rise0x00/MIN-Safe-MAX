...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILuvf;)V
    .locals 0
    ...
    iput-object p2, p0, Ldp0;->b:Landroid/net/Uri;

    iput-object p3, p0, Ldp0;->c:Landroid/net/Uri;

    iput p4, p0, Ldp0;->d:I

    iput p5, p0, Ldp0;->e:I

    iput-object p6, p0, Ldp0;->f:Luvf;
...
.method public final a(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    iget-object v0, p0, Ldp0;->c:Landroid/net/Uri;
    ...
    :try_start_0
    iget-object v2, p0, Ldp0;->a:Landroid/content/Context;
    ...
    :cond_0
    invoke-static {v2}, Lvji;->b(Ljava/io/Closeable;)V

    invoke-static {p1}, Lvji;->b(Ljava/io/Closeable;)V

    iput-object v0, p0, Ldp0;->b:Landroid/net/Uri;
    ...
    :goto_1
    invoke-static {v1}, Lvji;->b(Ljava/io/Closeable;)V
...
.method public final b(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    invoke-direct {v4}, Lzp6;-><init>()V

    invoke-virtual {p1}, Landroid/net/Uri;->toString()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v4, p1}, Lzp6;->k(Ljava/lang/String;)V

    invoke-virtual {v4}, Lzp6;->c()Lxbd;

    move-result-object p1

    invoke-virtual {v1, p1}, Lbma;->b(Lxbd;)Lo0d;
    ...
    :try_start_2
    iget-object v5, p0, Ldp0;->a:Landroid/content/Context;
    ...
    sget-object v5, Lhma;->a:Ljava/util/logging/Logger;
    ...
    invoke-direct {v5, p2, v7, v6}, Lwx;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1

    :try_start_3
    invoke-interface {v4, v5}, Llv0;->H(Lwx;)J
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0

    invoke-static {v4}, Lvji;->b(Ljava/io/Closeable;)V

    invoke-static {v5}, Lvji;->b(Ljava/io/Closeable;)V

    invoke-static {v1}, Lvji;->b(Ljava/io/Closeable;)V

    invoke-virtual {v2}, Ln2f;->a()V
    ...
    :goto_2
    invoke-static {v3}, Lvji;->b(Ljava/io/Closeable;)V

    invoke-static {v5}, Lvji;->b(Ljava/io/Closeable;)V

    if-eqz p1, :cond_1

    iget-object p1, p1, Lldd;->Y:Lndd;
...
.method public final c()Ljava/lang/String;
    ...
    invoke-static {v1, v0}, Le8;->a(Landroid/content/Context;Ljava/lang/String;)I
    ...
    iget-object v0, p0, Ldp0;->b:Landroid/net/Uri;
    ...
    invoke-static {v1, v0, v2, v2}, Lu0j;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v2, v3, v0}, Lu0j;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
...
.method public final d()Lcp0;
    ...
    iget-object v3, v1, Ldp0;->a:Landroid/content/Context;

    iget-object v0, v1, Ldp0;->b:Landroid/net/Uri;
    ...
    invoke-direct {v0, v2}, Lcp0;-><init>(Ljava/lang/Exception;)V

    return-object v0

    :cond_0
    :try_start_0
    invoke-virtual {v1}, Ldp0;->e()V
    :try_end_0
    ...
    iget-object v4, v1, Ldp0;->b:Landroid/net/Uri;
    ...
    :cond_1
    iget v12, v1, Ldp0;->d:I

    iget v13, v1, Ldp0;->e:I
    ...
    invoke-direct {v3, v0}, Lw97;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {v3}, Lw97;->a()I
    ...
    :try_start_4
    invoke-static {v0}, Lvji;->b(Ljava/io/Closeable;)V
    :try_end_4
    ...
    iput v11, v4, Ldh5;->b:I

    iput v10, v4, Ldh5;->c:I
    ...
    :cond_b
    :goto_7
    invoke-direct {v3, v13, v4}, Lcp0;-><init>(Landroid/graphics/Bitmap;Ldh5;)V
    ...
    invoke-direct {v0, v13, v4}, Lcp0;-><init>(Landroid/graphics/Bitmap;Ldh5;)V
    ...
    invoke-direct {v2, v0}, Lcp0;-><init>(Ljava/lang/Exception;)V
...
.method public final e()V
    ...
    iget-object v3, p0, Ldp0;->c:Landroid/net/Uri;
    ...
    iget-object v0, p0, Ldp0;->a:Landroid/content/Context;
    ...
    :try_start_0
    iget-object v1, p0, Ldp0;->b:Landroid/net/Uri;
    ...
    invoke-virtual {p0}, Ldp0;->c()Ljava/lang/String;
    ...
    iput-object v1, p0, Ldp0;->b:Landroid/net/Uri;
    :try_end_1
    ...
    invoke-virtual {p0, v1, v3}, Ldp0;->a(Landroid/net/Uri;Landroid/net/Uri;)V
    :try_end_2
    ...
    iget-object v2, p0, Ldp0;->b:Landroid/net/Uri;
    ...
    invoke-static {v2, v0}, Lox1;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v3}, Ldp0;->b(Landroid/net/Uri;Landroid/net/Uri;)V
    :try_end_7
...
.method public final onPostExecute(Ljava/lang/Object;)V
    ...
    iget-object v0, p1, Lcp0;->b:Ljava/lang/Exception;

    iget-object v1, p0, Ldp0;->f:Luvf;

    if-nez v0, :cond_1

    iget-object p1, p1, Lcp0;->a:Landroid/graphics/Bitmap;
    ...
    iput-object v0, v1, Ly2g;->z0:Ljava/lang/String;

    const/4 v0, 0x1

    iput-boolean v0, v1, Ly2g;->w0:Z

    invoke-virtual {v1, p1}, Ly2g;->setImageBitmap(Landroid/graphics/Bitmap;)V
    ...
    iget-object p1, v1, Luvf;->a:Ljava/lang/Object;
