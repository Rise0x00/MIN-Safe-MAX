...
.field public volatile j:Lqp3;

.field public final k:Ljava/util/concurrent/CopyOnWriteArraySet;

.field public final l:Lbp3;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/ExecutorService;Lk5;Ltif;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcp3;->a:Landroid/content/Context;

    iput-object p2, p0, Lcp3;->b:Ljava/util/concurrent/ExecutorService;

    iput-object p3, p0, Lcp3;->c:Lk5;

    iput-object p4, p0, Lcp3;->d:Ltif;
    ...
    iput-object p1, p0, Lcp3;->e:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p3, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {p3, p2}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object p3, p0, Lcp3;->f:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p3, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {p3, p2}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object p3, p0, Lcp3;->g:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p3, Lzo3;

    const/4 p4, 0x0

    invoke-direct {p3, p0, p4}, Lzo3;-><init>(Lcp3;I)V

    new-instance p4, Ltif;

    invoke-direct {p4, p3}, Ltif;-><init>(Loi6;)V

    iput-object p4, p0, Lcp3;->h:Ltif;
    ...
    iput-object p4, p0, Lcp3;->i:Ltif;

    sget-object p3, Lqp3;->a:Lqp3;

    iput-object p3, p0, Lcp3;->j:Lqp3;

    new-instance p3, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {p3}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object p3, p0, Lcp3;->k:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance p3, Lbp3;

    const/4 p4, 0x0

    invoke-direct {p3, p4, p0}, Lbp3;-><init>(ILjava/lang/Object;)V

    iput-object p3, p0, Lcp3;->l:Lbp3;

    new-instance p3, Ljava/util/concurrent/atomic/AtomicReference;

    sget-object p4, Lap3;->g:Lap3;

    invoke-direct {p3, p4}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object p3, p0, Lcp3;->m:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object p3, p0, Lcp3;->n:Ljava/lang/String;

    invoke-virtual {p0, p2}, Lcp3;->n(Z)Z

    move-result p2

    invoke-virtual {p1, p2}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    invoke-virtual {p0}, Lcp3;->l()V

    return-void
.end method

.method public static j(Landroid/net/NetworkCapabilities;)Lqp3;
    .locals 1
    ...
    sget-object p0, Lqp3;->d:Lqp3;

    return-object p0

    :cond_3
    sget-object p0, Lqp3;->o:Lqp3;

    return-object p0

    :cond_4
    :goto_0
    sget-object p0, Lqp3;->a:Lqp3;
...
.method public final a()Z
    ...
    invoke-virtual {p0}, Lcp3;->k()Landroid/net/ConnectivityManager;
...
.method public final b()Lqp3;
    ...
    iget-object v0, p0, Lcp3;->j:Lqp3;

    sget-object v1, Lqp3;->a:Lqp3;
    ...
    invoke-static {v0}, Lcp3;->j(Landroid/net/NetworkCapabilities;)Lqp3;
    ...
    invoke-virtual {p0, v2, v0}, Lcp3;->m(Ljava/lang/String;Ljava/lang/Throwable;)V

    :goto_0
    iput-object v1, p0, Lcp3;->j:Lqp3;
...
.method public final c(Lvo3;)V
    ...
    iget-object v0, p0, Lcp3;->k:Ljava/util/concurrent/CopyOnWriteArraySet;
...
.method public final d()Z
    ...
    iget-object v0, p0, Lcp3;->m:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v1, p0, Lcp3;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-boolean v0, v0, Lap3;->f:Z

    return v0

    :cond_0
    invoke-virtual {p0}, Lcp3;->h()Landroid/net/Network;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcp3;->i(Landroid/net/Network;)Landroid/net/NetworkCapabilities;
...
.method public final f()Z
    ...
    iget-object v0, p0, Lcp3;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v1, p0, Lcp3;->n:Ljava/lang/String;

    const-string v2, "default network callback is not registered yet"

    invoke-static {v1, v2, v0}, Lcuh;->q(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object v1, p0, Lcp3;->d:Ltif;
    ...
    invoke-static {v4, v0}, Lpa9;->f(Ljava/lang/String;Z)Ljava/lang/String;
...
.method public final h()Landroid/net/Network;
    ...
    iget-object v0, p0, Lcp3;->n:Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Lcuh;->s(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
...
.method public final invalidate()V
    ...
    invoke-virtual {p0, v1}, Lcp3;->n(Z)Z
    ...
    invoke-virtual {p0, v2, v2}, Lcp3;->p(Landroid/net/Network;Landroid/net/NetworkCapabilities;)V
...
.method public final l()V
    ...
    iget-object v0, p0, Lcp3;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v3, v5, v0, v6, v4}, Lnxa;->c(La98;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :try_start_0
    iget-object v3, p0, Lcp3;->a:Landroid/content/Context;

    new-instance v5, Llo;

    const/4 v6, 0x5

    invoke-direct {v5, v6, p0}, Llo;-><init>(ILjava/lang/Object;)V
    ...
    invoke-static {v3, v5, v6, v4, v7}, Le8;->i(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;I)Landroid/content/Intent;

    iget-object v3, p0, Lcp3;->n:Ljava/lang/String;
    ...
    invoke-virtual {v5, v6, v3, v7, v4}, Lnxa;->c(La98;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :goto_2
    iget-object v4, p0, Lcp3;->n:Ljava/lang/String;
    ...
    iget-object v4, p0, Lcp3;->g:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v2, v4}, Lyua;->c(Ljava/lang/Throwable;)V
...
.method public final m(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p1, v0, p2}, Lk64;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final n(Z)Z
    ...
    iget-object p1, p0, Lcp3;->n:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, p1}, Lcp3;->m(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final o(Lap3;)V
    ...
    :cond_3
    :goto_0
    iget-object p1, p0, Lcp3;->b:Ljava/util/concurrent/ExecutorService;
...
.method public final p(Landroid/net/Network;Landroid/net/NetworkCapabilities;)V
    ...
    invoke-virtual {v1}, Lcp3;->h()Landroid/net/Network;
    ...
    :goto_0
    invoke-virtual {v1, v4}, Lcp3;->i(Landroid/net/Network;)Landroid/net/NetworkCapabilities;
    ...
    :try_start_0
    invoke-virtual {v1}, Lcp3;->k()Landroid/net/ConnectivityManager;
    ...
    iget-object v0, v1, Lcp3;->n:Ljava/lang/String;

    const-string v7, "Unable to get active network info"

    invoke-static {v0, v7}, Lcuh;->s(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v7, v1, Lcp3;->n:Ljava/lang/String;

    const-string v8, "Failed to get active network info"

    invoke-static {v7, v8, v0}, Lcuh;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_a
    iget-object v8, v1, Lcp3;->n:Ljava/lang/String;
    ...
    invoke-virtual {v15, v7}, Lnxa;->b(La98;)Z
    ...
    invoke-virtual {v15, v7, v8, v9, v5}, Lnxa;->c(La98;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_f
    sget-object v15, La98;->d:La98;

    invoke-virtual {v8, v15}, Lnxa;->b(La98;)Z
    ...
    invoke-virtual {v8, v15, v7, v0, v2}, Lnxa;->c(La98;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct/range {v8 .. v14}, Lap3;-><init>(ZZZZZZ)V
    ...
    :cond_10
    invoke-virtual {v1, v5}, Lcp3;->o(Lap3;)V
