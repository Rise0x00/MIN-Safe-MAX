...
# instance fields
.field public final b2:Lvpi;

.field public final c2:Landroid/graphics/drawable/GradientDrawable;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lc63;)V
    .locals 7
    ...
    invoke-direct {v1, p2, v2, v3}, Lvpi;-><init>(Ljava/lang/Object;Ljava/util/concurrent/ExecutorService;I)V

    iput-object v1, p0, Lixd;->b2:Lvpi;
    ...
    iput-object p2, p0, Lixd;->c2:Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-virtual {p0, v1, v4}, Landroidx/recyclerview/widget/RecyclerView;->j(Lk2e;I)V

    new-instance v1, Lc55;

    invoke-direct {v1, p1}, Lc55;-><init>(Landroid/content/Context;)V

    iput-object p2, v1, Lc55;->c:Ljava/lang/Object;
    ...
    invoke-direct {p1, p2, v0, v1}, Lcpa;-><init>(ILkotlin/coroutines/Continuation;I)V
...
.method public final setContacts(Ljava/util/List;)V
    ...
    iget-object v0, p0, Lixd;->b2:Lvpi;
