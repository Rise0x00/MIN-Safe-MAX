...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v5}, Lhz1;->B(Lhz1;)V
    ...
    iget-object v1, v5, Lhz1;->t1:Ljava/lang/CharSequence;

    invoke-virtual {v5, v1}, Lhz1;->b0(Ljava/lang/CharSequence;)V
    ...
    iget-object v7, v5, Lhz1;->p1:Lf12;

    const/4 v2, 0x1

    if-eqz v7, :cond_12

    iget-object v3, v7, Lf12;->a:Landroid/view/View;

    iget-object v6, v7, Lf12;->q:[F

    iget-object v8, v7, Lf12;->r:[F

    iget-object v9, v7, Lf12;->j:Landroid/view/ScaleGestureDetector;

    iget-object v12, v7, Lf12;->h:Landroid/graphics/Matrix;

    iget-object v13, v7, Lf12;->t:Landroid/graphics/Matrix;

    iget-boolean v10, v7, Lf12;->v:Z

    if-nez v10, :cond_0

    invoke-virtual {v7}, Lf12;->g()V

    :cond_0
    iget-boolean v10, v7, Lf12;->x:Z
    ...
    :cond_3
    iget-object v10, v7, Lf12;->n:Landroid/view/GestureDetector;
    ...
    iget-boolean v10, v7, Lf12;->k:Z

    if-nez v10, :cond_4

    iget-boolean v10, v7, Lf12;->l:Z
    ...
    :cond_8
    iput-boolean v4, v7, Lf12;->x:Z

    iget-boolean v9, v7, Lf12;->m:Z

    iput-boolean v4, v7, Lf12;->m:Z

    if-eqz v15, :cond_b

    iget-boolean v10, v7, Lf12;->A:Z
    ...
    invoke-direct/range {v6 .. v11}, Lvr1;-><init>(Lf12;FFFF)V

    invoke-static {v13}, Lr8g;->b(Landroid/graphics/Matrix;)F

    move-result v16

    invoke-static {v12}, Lr8g;->b(Landroid/graphics/Matrix;)F
    ...
    invoke-direct {v4, v7}, Lb12;-><init>(Lf12;)V
    ...
    invoke-direct {v4, v6, v7}, Lc12;-><init>(Lvr1;Lf12;)V

    invoke-virtual {v3, v4}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    :goto_5
    iget-object v4, v7, Lf12;->w:Lz02;
    ...
    iput-object v3, v7, Lf12;->u:Landroid/animation/ValueAnimator;
    ...
    :goto_9
    iget-object v4, v5, Lhz1;->o1:Landroid/view/GestureDetector;
    ...
    invoke-static {v5}, Lhz1;->F(Lhz1;)V
