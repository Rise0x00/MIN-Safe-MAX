...
.method public synthetic constructor <init>(Lone/me/sdk/messagewrite/MessageWriteWidget;I)V
    ...
    iput-object p1, p0, Lgh9;->b:Lone/me/sdk/messagewrite/MessageWriteWidget;
...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v9, v0, Lgh9;->b:Lone/me/sdk/messagewrite/MessageWriteWidget;
    ...
    invoke-virtual {v9}, Lone/me/sdk/messagewrite/MessageWriteWidget;->H0()Leh9;

    move-result-object v1

    invoke-static {v1, v6}, Leh9;->D(Leh9;I)V
    ...
    sget-object v10, Lone/me/sdk/messagewrite/MessageWriteWidget;->K0:[Les7;

    new-instance v10, Lgh9;

    invoke-direct {v10, v9, v7}, Lgh9;-><init>(Lone/me/sdk/messagewrite/MessageWriteWidget;I)V
    ...
    invoke-virtual {v10, v11}, Lgh9;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget v11, Lwoc;->writebar__miui_menu:I
    ...
    invoke-virtual {v10, v2}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Lp6d;)V

    new-instance v2, Lxz0;

    const/4 v3, 0x6

    invoke-direct {v2, v3}, Lxz0;-><init>(I)V

    invoke-virtual {v10, v2}, Landroidx/recyclerview/widget/RecyclerView;->j(Lv6d;)V
    ...
    iget-object v3, v9, Lone/me/sdk/messagewrite/MessageWriteWidget;->t0:Lru7;
    ...
    invoke-virtual {v3, v4, v5}, Lhud;->j(Lru/ok/tamtam/android/prefs/PmsKey;Z)Z
    ...
    invoke-direct {v4, v5, v9}, Lk5;-><init>(ILjava/lang/Object;)V

    invoke-direct {v2, v1, v3, v4}, Lih8;-><init>(Landroid/widget/EditText;ZLk5;)V

    iput-object v2, v9, Lone/me/sdk/messagewrite/MessageWriteWidget;->C0:Lih8;
    ...
    invoke-virtual {v9, v1}, Lone/me/sdk/messagewrite/MessageWriteWidget;->L0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v9}, Lone/me/sdk/messagewrite/MessageWriteWidget;->B0()Lxc9;

    move-result-object v2

    invoke-virtual {v2}, Lxc9;->getSelectionStart()I
    ...
    invoke-virtual {v3}, Lxc9;->getSelectionEnd()I
    ...
    invoke-virtual {v4}, Lxc9;->getEditableOriginal()Landroid/text/Editable;

    move-result-object v4

    invoke-virtual {v9}, Lone/me/sdk/messagewrite/MessageWriteWidget;->C0()Lgd8;
    ...
    sget v6, Lvpc;->markdown_link:I

    if-ne v1, v6, :cond_3

    new-instance v1, Ljd8;

    invoke-direct {v1, v4, v2, v3}, Ljd8;-><init>(Landroid/text/Editable;II)V
    ...
    invoke-direct {v6, v1, v4, v2, v3}, Lkd8;-><init>(ILandroid/text/Editable;II)V

    move-object v1, v6

    :goto_0
    iget-object v2, v5, Lgd8;->Z:Laf5;

    invoke-static {v2, v1}, Ljzg;->s(Laf5;Ljava/lang/Object;)V

    invoke-static {v5, v7}, Lgd8;->u(Lgd8;I)V
    ...
    sget-object v9, Lone/me/sdk/messagewrite/MessageWriteWidget;->K0:[Les7;
    ...
    invoke-direct {v9, v10}, Lxc9;-><init>(Landroid/content/Context;)V

    new-instance v10, Lwui;

    const/16 v11, 0x17

    iget-object v14, v0, Lgh9;->b:Lone/me/sdk/messagewrite/MessageWriteWidget;

    invoke-direct {v10, v11, v14}, Lwui;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v9, v10}, Lxc9;->setTextSelectionListener(Lsc9;)V
    ...
    invoke-direct {v11, v14, v12}, Lfh9;-><init>(Lone/me/sdk/messagewrite/MessageWriteWidget;I)V

    new-instance v13, Lao6;

    invoke-direct {v13, v7, v11}, Lao6;-><init>(ILoi6;)V
    ...
    invoke-direct {v10, v11, v12}, Lzn6;-><init>(Landroid/view/GestureDetector;I)V

    invoke-virtual {v9, v10}, Lxc9;->setLeftInnerIconTouchListener(Landroid/view/View$OnTouchListener;)V

    invoke-virtual {v9, v7}, Lxc9;->setRightInnerIconVisible(Z)V
    ...
    invoke-direct/range {v12 .. v19}, Lp81;-><init>(ILjava/lang/Object;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;II)V

    new-instance v13, Lao6;

    invoke-direct {v13, v7, v12}, Lao6;-><init>(ILoi6;)V
    ...
    invoke-direct {v10, v7, v11}, Lzn6;-><init>(Landroid/view/GestureDetector;I)V

    invoke-virtual {v9, v10}, Lxc9;->setRightInnerIconTouchListener(Landroid/view/View$OnTouchListener;)V
    ...
    invoke-direct/range {v12 .. v19}, Ljh9;-><init>(ILjava/lang/Object;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;II)V
    ...
    invoke-direct {v7, v12, v6, v5}, Leh1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v9, v7}, Lxc9;->setRightOuterIconTouchListener(Landroid/view/View$OnTouchListener;)V

    new-instance v5, Ljk1;

    invoke-direct {v5, v11, v14}, Ljk1;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v9, v5}, Lxc9;->setVideoMessageTouchListener(Landroid/view/View$OnTouchListener;)V
    ...
    invoke-direct {v6, v9, v7}, Ljc9;-><init>(Lxc9;I)V

    new-instance v7, Lgh9;

    invoke-direct {v7, v14, v11}, Lgh9;-><init>(Lone/me/sdk/messagewrite/MessageWriteWidget;I)V

    invoke-direct {v5, v6, v7}, La2e;-><init>(Ljc9;Lgh9;)V

    iget-object v6, v9, Lxc9;->d:Luc9;
    ...
    invoke-direct {v5, v14, v2}, Lgh9;-><init>(Lone/me/sdk/messagewrite/MessageWriteWidget;I)V

    invoke-virtual {v9, v5}, Lxc9;->setCustomSelectionActionModeCallback(Lqi6;)V
    ...
    invoke-direct {v3, v1}, Lng9;-><init>(Landroid/net/Uri;)V
