...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lej0;->i:Ljava/util/regex/Pattern;

    return-void
.end method

.method public constructor <init>(Li78;Lpo3;Ljxe;Lsp3;)V
    .locals 2
    ...
    iput-object v0, p0, Lej0;->g:Ldo3;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lej0;->h:Ljava/util/concurrent/ConcurrentHashMap;

    iput-object p1, p0, Lej0;->a:Li78;

    iput-object p4, p0, Lej0;->b:Lsp3;

    iput-object p3, p0, Lej0;->c:Ljxe;

    iput-object p2, p0, Lej0;->f:Lpo3;
...
.method public static n(Ljavax/net/SocketFactory;)Ljava/net/Socket;
    ...
    :goto_1
    invoke-static {v0}, Lej0;->p(Ljava/net/Socket;)V
...
.method public static o(IZ)J
    ...
    invoke-virtual {p1, v2}, Lnxa;->b(La98;)Z
    ...
    invoke-virtual {p1, v2, v4, p0, v3}, Lnxa;->c(La98;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final b()V
    ...
    iget-object v0, p0, Lej0;->h:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public connect()Ljava/net/Socket;
    ...
    invoke-direct {v0, v3}, Ldo3;-><init>(Z)V

    iput-object v0, v1, Lej0;->g:Ldo3;

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    invoke-interface {v1}, Ly73;->i()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v0, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-interface {v1}, Ly73;->d()I
    ...
    :try_start_0
    iget-object v5, v1, Lej0;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v6, v1, Lej0;->g:Ldo3;

    iput-object v0, v6, Ldo3;->g:Ljava/lang/String;

    iput v4, v6, Ldo3;->h:I

    invoke-virtual {v1, v5, v0, v4}, Lej0;->m(Ljavax/net/SocketFactory;Ljava/lang/String;I)Ljava/net/Socket;

    move-result-object v5

    iput-object v5, v1, Lej0;->d:Ljava/net/Socket;

    instance-of v6, v5, Ljavax/net/ssl/SSLSocket;

    if-nez v6, :cond_0

    iget-object v0, v1, Lej0;->g:Ldo3;
    ...
    :cond_0
    :try_start_1
    iget-object v6, v1, Lej0;->c:Ljxe;

    check-cast v5, Ljavax/net/ssl/SSLSocket;

    sget-object v7, Lej0;->i:Ljava/util/regex/Pattern;
    ...
    iget-object v7, v1, Lej0;->f:Lpo3;

    iget-object v7, v7, Lpo3;->a:Ljava/lang/String;
    ...
    invoke-virtual {v6, v5, v7}, Lkxe;->b(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;)V
    :try_end_1
    .catch Ljavax/net/ssl/SSLException; {:try_start_1 .. :try_end_1} :catch_0

    iget-object v5, v1, Lej0;->g:Ldo3;
    ...
    :cond_3
    :goto_1
    iget-object v5, v1, Lej0;->c:Ljxe;

    check-cast v5, Lkxe;

    iget-object v5, v5, Lkxe;->c:Llxe;

    iget-wide v7, v5, Llxe;->a:J

    iget v6, v5, Llxe;->c:I

    iget-wide v9, v5, Llxe;->b:J
    ...
    :cond_4
    iget v11, v5, Llxe;->c:I

    iget-wide v12, v5, Llxe;->d:J

    iget v6, v5, Llxe;->f:I

    if-le v6, v3, :cond_5

    iget-wide v14, v5, Llxe;->e:J
    ...
    invoke-direct/range {v6 .. v21}, Lmxe;-><init>(JJIJJIJJI)V

    iget-object v3, v1, Lej0;->g:Ldo3;

    iget-wide v4, v6, Lmxe;->j:J
    ...
    iput-wide v4, v3, Ldo3;->f:J

    invoke-static/range {v22 .. v22}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    invoke-virtual {v6}, Lmxe;->toString()Ljava/lang/String;
...
.method public m(Ljavax/net/SocketFactory;Ljava/lang/String;I)Ljava/net/Socket;
    ...
    :try_start_0
    invoke-interface {p0}, Ly73;->j()I

    move-result v0

    invoke-virtual {p0, p1, p2, p3, v0}, Lej0;->l(Ljava/net/Socket;Ljava/lang/String;II)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :goto_0
    invoke-static {p1}, Lej0;->p(Ljava/net/Socket;)V
