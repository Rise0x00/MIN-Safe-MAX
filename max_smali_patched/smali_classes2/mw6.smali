...
# direct methods
.method public static c(Ljava/nio/ByteBuffer;Lgxf;Lg52;)Ljava/util/ArrayList;
    .locals 20
    ...
    sget-object v11, Lfxf;->b:Lfxf;

    iget-short v11, v11, Lfxf;->a:S
    ...
    invoke-direct {v7}, Lis;-><init>()V

    invoke-virtual {v7, v0, v11, v6}, Llk5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-static {v14, v0}, Lis;->c(ILjava/nio/ByteBuffer;)V
    ...
    invoke-static {v4, v0}, Lis;->c(ILjava/nio/ByteBuffer;)V
    ...
    invoke-static {v6, v0}, Lis;->c(ILjava/nio/ByteBuffer;)V
    ...
    iput-object v13, v7, Lis;->b:Ljava/lang/Object;
    ...
    :cond_8
    sget-object v11, Lfxf;->d:Lfxf;

    iget-short v14, v11, Lfxf;->a:S
    ...
    iput-object v12, v8, Lfpe;->a:Ljava/util/List;

    iget-short v11, v11, Lfxf;->a:S

    invoke-virtual {v8, v0, v11, v7}, Llk5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    new-instance v13, Lb83;

    const/4 v14, 0x4

    invoke-direct {v13, v7, v14}, Lb83;-><init>(II)V
    ...
    invoke-direct {v12, v13, v8}, Li4;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v6, v0}, Lis;-><init>(Ljava/nio/ByteBuffer;)V
    ...
    :cond_d
    sget-object v11, Lfxf;->X:Lfxf;

    iget-short v14, v11, Lfxf;->a:S

    if-ne v8, v14, :cond_1e

    sget-object v6, Lgxf;->c:Lgxf;
    ...
    invoke-virtual {v6, v0, v14, v4}, Llk5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-virtual {v6, v0, v11, v12}, Llk5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    iput-object v12, v6, Lg83;->a:Ljava/util/List;
    ...
    iget-object v7, v6, Lg83;->a:Ljava/util/List;
    ...
    invoke-direct {v4, v8, v9, v15}, Lf83;-><init>(J[B)V
    ...
    iput-object v4, v6, Lg83;->b:Ljava/util/ArrayList;
    ...
    iget-object v9, v6, Lg83;->b:Ljava/util/ArrayList;

    new-instance v12, Le83;

    invoke-direct {v12, v8}, Le83;-><init>([B)V
    ...
    iget-object v4, v6, Lg83;->a:Ljava/util/List;

    invoke-interface {v4}, Ljava/util/List;->size()I

    move-result v4

    iget-object v7, v6, Lg83;->b:Ljava/util/ArrayList;
    ...
    sget-object v4, Lfxf;->Y:Lfxf;

    iget-short v4, v4, Lfxf;->a:S
    ...
    invoke-virtual {v7, v0, v4, v6}, Llk5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    iput-object v4, v7, Lk55;->a:Ljava/lang/Long;
    ...
    invoke-direct {v4, v0, v1}, Lkff;-><init>(Ljava/nio/ByteBuffer;Lgxf;)V
    ...
    invoke-direct {v4, v0}, Lo52;-><init>(Ljava/nio/ByteBuffer;)V
    ...
    :cond_25
    sget-object v4, Lfxf;->u0:Lfxf;

    iget-short v6, v4, Lfxf;->a:S
    ...
    iput-object v7, v6, Los7;->b:Ljava/util/ArrayList;

    iget-short v4, v4, Lfxf;->a:S

    const/4 v7, 0x1

    invoke-virtual {v6, v0, v4, v7}, Llk5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-virtual {v6, v0}, Los7;->d(Ljava/nio/ByteBuffer;)I
    ...
    iget-object v4, v2, Lg52;->b:Ljava/lang/Object;
    ...
    iget-object v6, v4, Ln84;->a:Lr8e;

    iget-object v6, v6, Lr8e;->b:Ljava/lang/Object;

    check-cast v6, Likg;

    invoke-direct {v13, v6}, Lhic;-><init>(Likg;)V

    iget-object v4, v4, Ln84;->f:Lq98;
...
.method public abstract b()Lgxf;
.end method

.method public final d(Ljava/nio/ByteBuffer;Lgxf;I)I
    .locals 3
