...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILu8a;)V
    .locals 0
    ...
    iput-object p2, p0, Lrv0;->b:Landroid/net/Uri;

    iput-object p3, p0, Lrv0;->c:Landroid/net/Uri;

    iput p4, p0, Lrv0;->d:I

    iput p5, p0, Lrv0;->e:I

    iput-object p6, p0, Lrv0;->f:Lu8a;
...
.method public final a(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    :try_start_0
    iget-object v2, p0, Lrv0;->a:Landroid/content/Context;
    ...
    :cond_0
    invoke-static {v2}, Ljkj;->b(Ljava/io/Closeable;)V

    invoke-static {p1}, Ljkj;->b(Ljava/io/Closeable;)V

    iput-object v0, p0, Lrv0;->b:Landroid/net/Uri;
    ...
    :goto_1
    invoke-static {v1}, Ljkj;->b(Ljava/io/Closeable;)V
...
.method public final b(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    invoke-direct {v2}, La4b;-><init>()V

    invoke-direct {v1, v2}, Lb4b;-><init>(La4b;)V

    iget-object v2, v1, Lb4b;->a:Lskg;
    ...
    invoke-direct {v4, v5}, Ltx4;-><init>(I)V

    invoke-virtual {p1}, Landroid/net/Uri;->toString()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v4, p1}, Ltx4;->h(Ljava/lang/String;)V

    invoke-virtual {v4}, Ltx4;->a()Lj80;

    move-result-object p1

    invoke-virtual {v1, p1}, Lb4b;->b(Lj80;)Liwd;
    ...
    :try_start_2
    iget-object v5, p0, Lrv0;->a:Landroid/content/Context;
    ...
    sget-object v5, Lh4b;->a:Ljava/util/logging/Logger;
    ...
    invoke-direct {v5, p2, v7, v6}, Lb20;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1

    :try_start_3
    invoke-interface {v4, v5}, Lw11;->X(Lb20;)J
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0

    invoke-static {v4}, Ljkj;->b(Ljava/io/Closeable;)V

    invoke-static {v5}, Ljkj;->b(Ljava/io/Closeable;)V

    invoke-static {v1}, Ljkj;->b(Ljava/io/Closeable;)V

    invoke-virtual {v2}, Lskg;->c()V
    ...
    :goto_2
    invoke-static {v3}, Ljkj;->b(Ljava/io/Closeable;)V
...
.method public final c()Ljava/lang/String;
    ...
    iget-object v1, p0, Lrv0;->a:Landroid/content/Context;

    invoke-static {v1, v0}, Lg84;->N(Landroid/content/Context;Ljava/lang/String;)I
    ...
    iget-object v0, p0, Lrv0;->b:Landroid/net/Uri;
    ...
    invoke-static {v1, v0, v2, v2}, Lf0k;->d(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v2, v3, v0}, Lf0k;->d(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
...
.method public final d()Lqv0;
    ...
    iget-object v3, v1, Lrv0;->a:Landroid/content/Context;

    iget-object v0, v1, Lrv0;->b:Landroid/net/Uri;
    ...
    invoke-direct {v0, v2}, Lqv0;-><init>(Ljava/lang/Exception;)V

    return-object v0

    :cond_0
    :try_start_0
    invoke-virtual {v1}, Lrv0;->e()V
    :try_end_0
    ...
    iget-object v4, v1, Lrv0;->b:Landroid/net/Uri;
    ...
    :cond_1
    iget v12, v1, Lrv0;->d:I

    iget v13, v1, Lrv0;->e:I
    ...
    invoke-direct {v3, v0}, Lsk7;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {v3}, Lsk7;->a()I
    ...
    :try_start_4
    invoke-static {v0}, Ljkj;->b(Ljava/io/Closeable;)V
    :try_end_4
    ...
    iput v11, v4, Ljr5;->b:I

    iput v10, v4, Ljr5;->c:I
    ...
    :cond_b
    :goto_7
    invoke-direct {v3, v13, v4}, Lqv0;-><init>(Landroid/graphics/Bitmap;Ljr5;)V
    ...
    invoke-direct {v0, v13, v4}, Lqv0;-><init>(Landroid/graphics/Bitmap;Ljr5;)V
    ...
    invoke-direct {v2, v0}, Lqv0;-><init>(Ljava/lang/Exception;)V
...
.method public final e()V
    ...
    iget-object v3, p0, Lrv0;->c:Landroid/net/Uri;
    ...
    :try_start_0
    iget-object v1, p0, Lrv0;->b:Landroid/net/Uri;
    ...
    invoke-virtual {p0}, Lrv0;->c()Ljava/lang/String;
    ...
    iput-object v1, p0, Lrv0;->b:Landroid/net/Uri;
    :try_end_1
    ...
    invoke-virtual {p0, v1, v3}, Lrv0;->a(Landroid/net/Uri;Landroid/net/Uri;)V
    :try_end_2
    ...
    iget-object v2, p0, Lrv0;->b:Landroid/net/Uri;
    ...
    invoke-virtual {p0, v0, v3}, Lrv0;->b(Landroid/net/Uri;Landroid/net/Uri;)V
    :try_end_7
...
.method public final onPostExecute(Ljava/lang/Object;)V
    ...
    iget-object v0, p1, Lqv0;->b:Ljava/lang/Exception;

    iget-object v1, p0, Lrv0;->f:Lu8a;

    if-nez v0, :cond_1

    iget-object p1, p1, Lqv0;->a:Landroid/graphics/Bitmap;
    ...
    :goto_0
    iget-object v1, v1, Lu8a;->b:Ljava/lang/Object;

    check-cast v1, Li6h;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object v0, v1, Li6h;->G0:Ljava/lang/String;

    const/4 v0, 0x1

    iput-boolean v0, v1, Li6h;->D0:Z

    invoke-virtual {v1, p1}, Li6h;->setImageBitmap(Landroid/graphics/Bitmap;)V
    ...
    iget-object p1, v1, Lu8a;->b:Ljava/lang/Object;
