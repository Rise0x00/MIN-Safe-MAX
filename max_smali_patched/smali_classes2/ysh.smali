...
.method public constructor <init>(Lvsh;)V
    ...
    iput-object v0, p0, Lysh;->d:Ljava/util/HashSet;

    iput-object p1, p0, Lysh;->a:Lvsh;

    invoke-interface {p1}, Lvsh;->b()I
    ...
    iput-object v1, p0, Lysh;->b:Landroid/util/Range;

    invoke-interface {p1}, Lvsh;->v()I
    ...
    iput-object p1, p0, Lysh;->c:Landroid/util/Range;
...
.method public static c(Lvsh;Landroid/util/Size;)Lvsh;
    .locals 4

    instance-of v0, p0, Lysh;
    ...
    invoke-interface {p0, v0, v1}, Lvsh;->a(II)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-interface {p0}, Lvsh;->w()Landroid/util/Range;

    move-result-object v0

    invoke-interface {p0}, Lvsh;->z()Landroid/util/Range;
    ...
    invoke-direct {v0, p0}, Lysh;-><init>(Lvsh;)V
    ...
    iget-object v0, v0, Lysh;->d:Ljava/util/HashSet;
...
.method public final s(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Lysh;->c:Landroid/util/Range;

    invoke-virtual {v1, v0}, Landroid/util/Range;->contains(Ljava/lang/Comparable;)Z

    move-result v0

    iget-object v2, p0, Lysh;->a:Lvsh;
    ...
    iget-object p1, p0, Lysh;->b:Landroid/util/Range;
...
.method public final u(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Lysh;->b:Landroid/util/Range;
    ...
    iget-object p1, p0, Lysh;->c:Landroid/util/Range;
...
.method public final w()Landroid/util/Range;
    ...
    iget-object v0, p0, Lysh;->b:Landroid/util/Range;
...
.method public final x(II)Z
    ...
    invoke-interface {v0, p1, p2}, Lvsh;->x(II)Z
    ...
    :cond_0
    iget-object v1, p0, Lysh;->d:Ljava/util/HashSet;
...
.method public final z()Landroid/util/Range;
    ...
    iget-object v0, p0, Lysh;->c:Landroid/util/Range;
