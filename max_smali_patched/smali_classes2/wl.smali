...
.method public synthetic constructor <init>(Lcom/my/tracker/applifecycle/o/d;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p4, p0, Lwl;->d:Ljava/io/Serializable;

    iput-object p5, p0, Lwl;->o:Ljava/io/Serializable;

    iput-object p6, p0, Lwl;->X:Ljava/io/Serializable;

    return-void
.end method

.method public synthetic constructor <init>(Ljava/lang/String;Lum;Lxl;Lru/ok/android/api/core/ApiInvocationException;Lu7d;Lu7d;)V
    .locals 0
...
.method public h(Lam;)Lam;
    ...
    iget-object v1, p0, Lwl;->c:Ljava/lang/Object;

    check-cast v1, Lxl;

    iget-object v2, p0, Lwl;->d:Ljava/io/Serializable;

    check-cast v2, Lru/ok/android/api/core/ApiInvocationException;

    iget-object v3, p0, Lwl;->o:Ljava/io/Serializable;

    check-cast v3, Lu7d;

    iget-object v4, p0, Lwl;->X:Ljava/io/Serializable;

    check-cast v4, Lu7d;

    iget-object v1, v1, Lxl;->c:Lwm;

    iget-object v5, p1, Lam;->c:Ljava/lang/String;

    iget-object v6, p0, Lwl;->a:Ljava/lang/String;
    ...
    iget-object v6, p1, Lam;->a:Ljava/lang/String;

    iget-object p1, p1, Lam;->b:Ljava/lang/String;

    const/4 v7, 0x0

    invoke-direct {v5, v6, p1, v7, v7}, Lam;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v6, Lum;->d:Lum;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    if-eq v0, v6, :cond_7

    sget-object v7, Lum;->c:Lum;
    ...
    :cond_2
    :try_start_1
    iget-object v5, p1, Lam;->b:Ljava/lang/String;
    ...
    :cond_4
    invoke-interface {v1, p1}, Lwm;->h(Lam;)Lam;
    ...
    :goto_2
    iget-object v5, v1, Lam;->c:Ljava/lang/String;
    ...
    :cond_6
    iput-object v1, v4, Lu7d;->a:Ljava/lang/Object;
...
.method public invoke(Lcom/my/tracker/core/EngineCore$InsertEventTools;)[B
    ...
    iget-object v0, p0, Lwl;->d:Ljava/io/Serializable;

    move-object v4, v0

    check-cast v4, Ljava/lang/String;

    iget-object v0, p0, Lwl;->o:Ljava/io/Serializable;

    move-object v5, v0

    check-cast v5, Ljava/lang/String;

    iget-object v0, p0, Lwl;->X:Ljava/io/Serializable;
