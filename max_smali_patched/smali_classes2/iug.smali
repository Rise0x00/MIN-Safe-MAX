...
.method public constructor <init>(Landroid/view/View;Lkotlin/coroutines/Continuation;Lone/me/chatscreen/videomsg/VideoMessageWidget;)V
    ...
    iput-object p3, p0, Liug;->X:Lone/me/chatscreen/videomsg/VideoMessageWidget;

    iput-object p1, p0, Liug;->Y:Landroid/view/View;
...
.method public final l(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v0, p0, Liug;->X:Lone/me/chatscreen/videomsg/VideoMessageWidget;

    iget-object v1, p0, Liug;->Y:Landroid/view/View;

    invoke-direct {p1, v1, p2, v0}, Liug;-><init>(Landroid/view/View;Lkotlin/coroutines/Continuation;Lone/me/chatscreen/videomsg/VideoMessageWidget;)V
...
.method public final n(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v4, v0, Liug;->X:Lone/me/chatscreen/videomsg/VideoMessageWidget;
    ...
    invoke-virtual {v9, v2, v4, v10, v6}, Lnxa;->c(La98;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_4
    :goto_0
    iget-object v4, v0, Liug;->Y:Landroid/view/View;
    ...
    invoke-direct {v9, v8, v10}, Ly22;-><init>(ILkotlin/coroutines/Continuation;)V

    invoke-virtual {v9}, Ly22;->o()V
    ...
    invoke-virtual {v9, v1}, Ly22;->resumeWith(Ljava/lang/Object;)V
    ...
    invoke-direct {v10, v5, v9}, Lvr0;-><init>(ILjava/lang/Object;)V
    ...
    invoke-virtual {v4}, Lone/me/chatscreen/videomsg/VideoMessageWidget;->z0()Lopg;
    ...
    :cond_a
    :goto_4
    iget-object v10, v0, Liug;->X:Lone/me/chatscreen/videomsg/VideoMessageWidget;

    iget-object v12, v0, Liug;->Y:Landroid/view/View;

    invoke-static {v10, v12}, Lone/me/chatscreen/videomsg/VideoMessageWidget;->y0(Lone/me/chatscreen/videomsg/VideoMessageWidget;Landroid/view/View;)I
    ...
    :goto_5
    iget-object v12, v0, Liug;->X:Lone/me/chatscreen/videomsg/VideoMessageWidget;

    iget-object v12, v12, Lone/me/chatscreen/videomsg/VideoMessageWidget;->X:Ljava/lang/String;
    ...
    invoke-virtual {v13, v2, v12, v8, v6}, Lnxa;->c(La98;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_c
    :goto_6
    if-eqz v10, :cond_14

    iget-object v2, v0, Liug;->Y:Landroid/view/View;

    iget v3, v9, Ls7d;->a:I

    iget-object v8, v0, Liug;->X:Lone/me/chatscreen/videomsg/VideoMessageWidget;

    new-instance v10, Lxr;

    invoke-direct {v10, v8, v9, v4, v5}, Lxr;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
    ...
    invoke-direct {v6, v7, v4}, Lt00;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v6, v7, v10}, Ltf;-><init>(ILjava/lang/Object;)V
    ...
    invoke-static {v6}, Lpqd;->g(Landroid/view/WindowInsets;)Landroid/view/DisplayCutout;
    ...
    invoke-static {v6}, Lpqd;->j(Landroid/view/DisplayCutout;)Ljava/util/List;
    ...
    invoke-static {v5, v6}, Lvi7;->a(II)J
    ...
    :cond_13
    invoke-static {v11, v11}, Lvi7;->a(II)J
    ...
    sget-object v6, Ltwe;->w:Ls45;

    invoke-direct {v5, v4, v6}, Ltwe;-><init>(Ljava/lang/Object;Lm40;)V

    new-instance v4, Luwe;

    invoke-direct {v4, v2}, Luwe;-><init>(F)V

    const/high16 v2, 0x42f00000    # 120.0f

    invoke-virtual {v4, v2}, Luwe;->b(F)V

    const v2, 0x3ee147ae    # 0.44f

    invoke-virtual {v4, v2}, Luwe;->a(F)V

    iput-object v4, v5, Ltwe;->m:Luwe;
    ...
    iget-object v2, v0, Liug;->X:Lone/me/chatscreen/videomsg/VideoMessageWidget;

    invoke-virtual {v2}, Lone/me/chatscreen/videomsg/VideoMessageWidget;->F0()Lbug;
    ...
    invoke-virtual {v4}, Lopg;->getSurfaceProvider()Lhyb;
    ...
    iget-object v2, v2, Lbug;->b:Llpg;

    check-cast v2, Lvsg;

    invoke-virtual {v2, v5, v4, v0}, Lvsg;->m(Landroid/util/Size;Lhyb;Lp14;)Ljava/lang/Object;
