...
.field private mSession2Token:Lzph;
...
.method public constructor <init>(Ljava/lang/Object;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0, v0}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lzph;)V
...
.method public constructor <init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;)V
    ...
    .line 2
    invoke-direct {p0, p1, p2, v0}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lzph;)V

    return-void
.end method

.method public constructor <init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lzph;)V
    .locals 1
    ...
    .line 7
    iput-object p3, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->mSession2Token:Lzph;
...
.method public static fromBundle(Landroid/os/Bundle;)Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    invoke-static {p0}, Lszb;->e(Landroid/os/Bundle;)Lzph;
    ...
    invoke-direct {v2, p0, v0, v1}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lzph;)V
...
.method public getSession2Token()Lzph;
    .locals 2
    ...
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->mSession2Token:Lzph;
...
.method public setSession2Token(Lzph;)V
    .locals 1
    ...
    :try_start_0
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->mSession2Token:Lzph;
...
.method public toBundle()Landroid/os/Bundle;
    ...
    :cond_0
    :goto_0
    iget-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->mSession2Token:Lzph;

    if-eqz v2, :cond_1

    invoke-static {v0, v2}, Lszb;->k(Landroid/os/Bundle;Lzph;)V
