...
# direct methods
.method public constructor <init>(Lhb4;Ly53;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Thread;-><init>()V

    iput-object p2, p0, Ljb4;->a:Ly53;

    const/16 p2, 0x1e

    iput p2, p0, Ljb4;->b:I

    iput-object p1, p0, Ljb4;->c:Lhb4;

    new-instance p1, Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;-><init>()V

    iput-object p1, p0, Ljb4;->d:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iput-object p1, p0, Ljb4;->o:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {p1}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object p1, p0, Ljb4;->Z:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {p1}, Ljava/util/concurrent/locks/ReentrantLock;->newCondition()Ljava/util/concurrent/locks/Condition;

    move-result-object p1

    iput-object p1, p0, Ljb4;->s0:Ljava/util/concurrent/locks/Condition;

    new-instance p1, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {p1}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object p1, p0, Ljb4;->t0:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public final run()V
    ...
    :cond_0
    :goto_0
    iget-boolean v0, p0, Ljb4;->u0:Z

    const/4 v1, 0x0

    if-nez v0, :cond_1b

    iget-object v0, p0, Ljb4;->t0:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v0}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_0
    iget-object v2, p0, Ljb4;->c:Lhb4;
    ...
    iget-object v2, v2, Lhb4;->a:Lorg/webrtc/DataChannel;
    ...
    iget-object v0, p0, Ljb4;->X:Ldk;

    if-nez v0, :cond_7

    iget-object v0, p0, Ljb4;->d:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    :cond_4
    :try_start_1
    iget-object v0, p0, Ljb4;->Z:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    :try_start_2
    iget-object v2, p0, Ljb4;->s0:Ljava/util/concurrent/locks/Condition;
    ...
    :cond_9
    iget-object v0, p0, Ljb4;->o:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    instance-of v0, v6, Loi;

    instance-of v8, v6, Lli;

    if-eqz v8, :cond_b

    check-cast v6, Lli;

    iget-object v6, v6, Lli;->b:[F
    ...
    :cond_17
    iget-object v2, p0, Ljb4;->a:Ly53;

    array-length v4, v8

    iget-object v2, v2, Ly53;->a:Ljava/lang/Object;
    ...
    invoke-virtual {v2, v7, v8}, Lhb4;->e(I[B)Z
    ...
    iget-object v2, v2, Ly53;->b:Ljava/lang/Object;

    check-cast v2, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v2}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iput-object v1, p0, Ljb4;->X:Ldk;
    :try_end_6
