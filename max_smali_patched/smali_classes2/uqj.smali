...
# direct methods
.method public static a(Landroid/net/Uri;Landroid/content/Context;Lc56;)Landroid/net/Uri;
    .locals 7
    ...
    iget-object v5, v5, Ly66;->b:Lwi5;

    invoke-static {p1, v4, v5}, Lvej;->d(Landroid/content/Context;Ljava/lang/String;Lwi5;)Ld84;

    move-result-object v4

    if-eqz v4, :cond_1

    iget-object v4, v4, Ld84;->b:Ljava/lang/String;

    invoke-static {v4}, Lis6;->M(Ljava/lang/CharSequence;)Z
    ...
    invoke-virtual {p2, v3}, Ly66;->p(Ljava/lang/String;)Ljava/io/File;
    ...
    :try_start_2
    invoke-static {v4, v3}, Ltla;->r(Ljava/io/InputStream;Ljava/io/OutputStream;)J
...
.method public static b(Landroid/content/Intent;)I
    ...
    invoke-static {v0, v3, v1}, Lmbg;->h0(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {v0, p0, v1}, Lmbg;->h0(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {v0, p0, v1}, Lebg;->i0(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z
...
.method public static c(Landroid/content/Intent;Landroid/content/Context;Lzp5;Lc56;)Ljava/util/ArrayList;
    .locals 3
    ...
    invoke-static {v1, p1, p2}, Lvej;->j(Landroid/net/Uri;Landroid/content/Context;Lzp5;)Z
    ...
    invoke-static {v1, p1, p3}, Luqj;->a(Landroid/net/Uri;Landroid/content/Context;Lc56;)Landroid/net/Uri;
...
.method public static d(Landroid/content/Intent;Landroid/content/Context;Lzp5;Lc56;)Ljava/util/ArrayList;
    .locals 3
    ...
    :cond_3
    invoke-static {p0, p1, p2}, Lvej;->j(Landroid/net/Uri;Landroid/content/Context;Lzp5;)Z
    ...
    invoke-static {p0, p1, p3}, Luqj;->a(Landroid/net/Uri;Landroid/content/Context;Lc56;)Landroid/net/Uri;
