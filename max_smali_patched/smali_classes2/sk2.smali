...
.field public final H0:Loza;

.field public I0:Lt40;

.field public J0:Lgye;

.field public K0:Ljava/lang/Long;

.field public L0:Latg;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lsk2;->F0:Landroid/widget/TextView;
    ...
    invoke-direct {v9, v3, v4}, Lmq3;-><init>(II)V
    ...
    invoke-static {v6, v8}, Lorf;->d(Lorf;Landroid/widget/TextView;)V
    ...
    iput-object v8, p0, Lsk2;->G0:Landroid/widget/TextView;
    ...
    invoke-direct {v7, v10, v9}, Lmq3;-><init>(II)V
    ...
    iput-object v6, p0, Lsk2;->H0:Loza;
    ...
    invoke-direct {p1, v9, v4}, Lmq3;-><init>(II)V
    ...
    invoke-virtual {v0, v2, v3, v9, v3}, Lwq3;->d(IIII)V

    const/4 v4, 0x3

    invoke-virtual {v0, v2, v4, v9, v4}, Lwq3;->d(IIII)V

    invoke-virtual {v0, v2, v5, v9, v5}, Lwq3;->d(IIII)V
    ...
    invoke-virtual {v0, v2, v3, v5, v4}, Lwq3;->d(IIII)V

    new-instance v4, Lola;

    const/4 v5, 0x5

    invoke-direct {v4, v0, v3, v2, v5}, Lola;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v4, p1}, Lola;->e(I)V
    ...
    invoke-virtual {p0, p1}, Lsk2;->onThemeChanged(Lw5b;)V

    return-void
.end method

.method private final setButtonState(Latg;)V
    .locals 3
    ...
    iget-object v0, p0, Lsk2;->H0:Loza;
    ...
    :cond_1
    invoke-virtual {v0, v1}, Loza;->setPlaying(Z)V
    ...
    invoke-virtual {v0, p1}, Loza;->setPlaying(Z)V

    return-void
.end method

.method private final setState(Lez5;)V
    .locals 2
    ...
    iput-object v0, p0, Lsk2;->I0:Lt40;
    ...
    iget-object p1, p0, Lsk2;->I0:Lt40;
...
.method private final setSubtitle(Ljava/lang/CharSequence;)V
    ...
    :goto_2
    iget-object v1, p0, Lsk2;->G0:Landroid/widget/TextView;
...
.method private final setTitle(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Lsk2;->F0:Landroid/widget/TextView;
...
.method public final onThemeChanged(Lw5b;)V
    ...
    iget-object v1, p0, Lsk2;->F0:Landroid/widget/TextView;
    ...
    iget-object v0, p0, Lsk2;->G0:Landroid/widget/TextView;
...
.method public final setupVideo(Li49;)V
    .locals 2

    iget-wide v0, p1, Li49;->b:J

    invoke-static {v0, v1}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, p0, Lsk2;->K0:Ljava/lang/Long;

    iget-object v0, p0, Lsk2;->H0:Loza;

    iget-object v1, p1, Li49;->o:Landroid/net/Uri;

    invoke-virtual {v0, v1}, Loza;->setCover(Landroid/net/Uri;)V

    iget-object v0, p1, Li49;->X:Ljava/lang/String;

    invoke-direct {p0, v0}, Lsk2;->setTitle(Ljava/lang/CharSequence;)V

    iget-object v0, p1, Li49;->Y:Ljava/lang/String;

    invoke-direct {p0, v0}, Lsk2;->setSubtitle(Ljava/lang/CharSequence;)V

    iget-object p1, p1, Li49;->Z:Lwje;

    invoke-interface {p1}, Lwje;->b()Ljava/util/List;
    ...
    invoke-virtual {p0, v0}, Lsk2;->v(Lbtg;)V

    :cond_0
    invoke-direct {p0, p1}, Lsk2;->setState(Lez5;)V

    return-void
.end method

.method public final v(Lbtg;)V
    .locals 5

    if-eqz p1, :cond_0

    iget-object v0, p1, Lbtg;->o:Latg;
    ...
    :goto_0
    iget-object v1, p0, Lsk2;->L0:Latg;
    ...
    iget-wide v1, p1, Lbtg;->b:J

    iget-object v3, p0, Lsk2;->K0:Ljava/lang/Long;
    ...
    :cond_3
    invoke-direct {p0, v0}, Lsk2;->setButtonState(Latg;)V
    ...
    invoke-direct {p0, v1}, Lsk2;->setButtonState(Latg;)V

    :cond_5
    :goto_2
    iput-object v0, p0, Lsk2;->L0:Latg;
