...
.field public z0:Ljava/io/FileInputStream;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Letd;->o:Landroid/content/res/Resources;

    invoke-virtual {p1}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Letd;->X:Ljava/lang/String;
...
.method public final R(Lik4;)J
    ...
    iget-object v2, v0, Lik4;->a:Landroid/net/Uri;

    iget-wide v3, v0, Lik4;->g:J

    iget-wide v5, v0, Lik4;->f:J

    iput-object v2, v1, Letd;->Y:Landroid/net/Uri;
    ...
    iget-object v10, v1, Letd;->o:Landroid/content/res/Resources;
    ...
    iget-object v13, v1, Letd;->X:Ljava/lang/String;
    ...
    iput-object v7, v1, Letd;->Z:Landroid/content/res/AssetFileDescriptor;
    ...
    iput-object v2, v1, Letd;->z0:Ljava/io/FileInputStream;
    ...
    :goto_6
    iput-wide v5, v1, Letd;->A0:J

    :cond_d
    iput-boolean v11, v1, Letd;->B0:Z
...
.method public final close()V
    ...
    iput-object v0, p0, Letd;->Y:Landroid/net/Uri;
    ...
    :try_start_0
    iget-object v3, p0, Letd;->z0:Ljava/io/FileInputStream;
    ...
    :cond_0
    :goto_0
    iput-object v0, p0, Letd;->z0:Ljava/io/FileInputStream;

    :try_start_1
    iget-object v3, p0, Letd;->Z:Landroid/content/res/AssetFileDescriptor;
    ...
    :cond_1
    :goto_1
    iput-object v0, p0, Letd;->Z:Landroid/content/res/AssetFileDescriptor;

    iget-boolean v0, p0, Letd;->B0:Z

    if-eqz v0, :cond_2

    iput-boolean v2, p0, Letd;->B0:Z
    ...
    :try_start_4
    iget-object v4, p0, Letd;->Z:Landroid/content/res/AssetFileDescriptor;
...
.method public final getUri()Landroid/net/Uri;
    ...
    iget-object v0, p0, Letd;->Y:Landroid/net/Uri;
...
.method public final read([BII)I
    ...
    :goto_0
    iget-object v0, p0, Letd;->z0:Ljava/io/FileInputStream;
