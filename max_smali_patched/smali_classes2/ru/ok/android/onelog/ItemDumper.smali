...
.method public static dump(Lru/ok/android/onelog/OneLogItem;Ljava/io/OutputStream;)V
    ...
    invoke-direct {v0, p1}, Lzab;-><init>(Ljava/io/OutputStream;)V
...
.method public static dump(Lru/ok/android/onelog/OneLogItem;Ljava/io/Writer;)V
    ...
    invoke-direct {v0, p1}, Lmsb;-><init>(Ljava/io/Writer;)V

    .line 7
    invoke-static {p0, v0}, Lru/ok/android/onelog/ItemDumper;->dump(Lru/ok/android/onelog/OneLogItem;Lnr7;)V

    .line 8
    invoke-virtual {v0}, Lmsb;->flush()V

    return-void
.end method

.method public static dump(Lru/ok/android/onelog/OneLogItem;Lnr7;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p1, p0}, Lru/ok/android/onelog/ItemSerializer;->serialize(Lnr7;Lru/ok/android/onelog/OneLogItem;)V
