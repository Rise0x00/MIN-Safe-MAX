...
.method private final writeValue(Lnr7;Lru/ok/android/externcalls/analytics/events/EventItemValue;)V
    .locals 2
    ...
    invoke-interface {p1, p2}, Lnr7;->h(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/analytics/internal/event/EventSerializer;->writeValue-iurDigI(Lnr7;Ljava/util/Collection;)V
    ...
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/analytics/internal/event/EventSerializer;->writeValue-4i0utlQ(Lnr7;Ljava/util/Map;)V

    :cond_5
    return-void
.end method

.method private final writeValue-4i0utlQ(Lnr7;Ljava/util/Map;)V
    .locals 2
...
.method private final writeValue-iurDigI(Lnr7;Ljava/util/Collection;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
# virtual methods
.method public final serialize(Lnr7;Lru/ok/android/externcalls/analytics/events/CallAnalyticsEvent;)V
    .locals 2
    ...
    invoke-direct {p0, p1, v0}, Lru/ok/android/externcalls/analytics/internal/event/EventSerializer;->writeValue(Lnr7;Lru/ok/android/externcalls/analytics/events/EventItemValue;)V
