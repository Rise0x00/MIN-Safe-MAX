...
.method private verifyOutputFormat(Ljava/io/File;)V
    ...
    :try_start_0
    invoke-static {p1}, Ltv5;->d(Ljava/io/File;)J
...
.method private write(ZLru/ok/android/externcalls/analytics/events/CallAnalyticsEvent;Ljava/io/OutputStream;)V
    ...
    invoke-direct {v0, p3}, Lzab;-><init>(Ljava/io/OutputStream;)V

    invoke-direct {p1, v0}, Lmsb;-><init>(Ljava/io/Writer;)V
    ...
    invoke-virtual {p3, p1, p2}, Lru/ok/android/externcalls/analytics/internal/event/EventSerializer;->serialize(Lnr7;Lru/ok/android/externcalls/analytics/events/CallAnalyticsEvent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {p1}, Lmsb;->close()V
...
.method public drop()V
    ...
    :goto_0
    invoke-static {v2}, Ltv5;->d(Ljava/io/File;)J
    ...
    :cond_0
    :try_start_2
    invoke-static {v2}, Ltv5;->b(Ljava/io/File;)V
...
.method public grab(Ljavax/inject/Provider;)V
    ...
    :goto_0
    invoke-static {v3}, Ltv5;->d(Ljava/io/File;)J
    ...
    invoke-static {p1, v3, v4}, Ltv5;->a(Ljava/io/File;Ljava/io/File;Z)V
...
.method public length()J
    ...
    invoke-static {v0}, Ltv5;->d(Ljava/io/File;)J
...
.method public writeToCache(Lru/ok/android/externcalls/analytics/events/CallAnalyticsEvent;)V
    ...
    invoke-static {v3}, Ltv5;->f(Ljava/io/File;)V
    ...
    :try_start_7
    invoke-static {v3}, Ltv5;->b(Ljava/io/File;)V
    :try_end_7
