...
.field private static final PEER_ID_RANGE:Lgc8;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/id/peer/PeerIdGenerator$Companion;-><init>(Lfi4;)V
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lgc8;-><init>(JJ)V

    sput-object v0, Lru/ok/android/externcalls/sdk/id/peer/PeerIdGenerator;->PEER_ID_RANGE:Lgc8;
...
.method public final generatePeerId()J
    ...
    sget-object v0, Lru/ok/android/externcalls/sdk/id/peer/PeerIdGenerator;->PEER_ID_RANGE:Lgc8;

    sget-object v1, Lowc;->a:Lnwc;

    :try_start_0
    iget-wide v1, v0, Lgc8;->a:J

    invoke-virtual {v0}, Lgc8;->isEmpty()Z

    move-result v3

    if-nez v3, :cond_2

    iget-wide v3, v0, Lgc8;->b:J
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Lowc;->f(JJ)J
