...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "sessionRoomId",
        "withSessionRoomId",
        "(Lf8e;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;",
        "",
        "name",
        "withName",
        ...
        "onSuccess",
        "withCallOnSuccess",
        "(Lqi6;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;",
        "",
        "onError",
        "withCallOnError",
...
.field private sessionRoomId:Lf8e;
...
.method public final build()Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;
    ...
    iget-object v4, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->sessionRoomId:Lf8e;
    ...
    iget-object v9, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->onSuccess:Lqi6;

    iget-object v10, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->onError:Lqi6;

    new-instance v0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;

    const/4 v11, 0x0

    invoke-direct/range {v0 .. v11}, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;-><init>(ZLjava/lang/Long;Ljava/lang/String;Lf8e;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/Long;Ljava/lang/String;Lqi6;Lqi6;Lfi4;)V
...
.method public final withCallOnError(Lqi6;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->onError:Lqi6;

    return-object p0
.end method

.method public final withCallOnSuccess(Lqi6;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->onSuccess:Lqi6;
...
.method public final withSessionRoomId(Lf8e;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->sessionRoomId:Lf8e;
