...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "listener",
        "<init>",
        "(Ljava/lang/String;Lcwc;Lm47;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$CompressorDecompressor;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V",
        "Lybg;",
        "connect",
        ...
        "session",
        "configureSession",
        "(Lv6e;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V",
        "openSession",
        "T",
        "action",
        "context",
        ...
        "handler",
        "handleAsync",
        "(Ljava/lang/String;Ljava/lang/Object;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;Lej6;)V",
        "Lakh;",
        "stream",
        "sendStreamData",
        "(Lakh;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V",
        "readStreamData",
        "(Lv6e;Lakh;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V",
        "message",
        "send",
        "(Ljava/lang/String;)V",
        "",
...
# instance fields
.field private final client:Lm47;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Companion;-><init>(Lfi4;)V
...
.method public constructor <init>(Ljava/lang/String;Lcwc;Lm47;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$CompressorDecompressor;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    .locals 0
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->log:Lcwc;

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->client:Lm47;
    ...
    invoke-direct {p0, p2, p3, p5, p1}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->handleAsync(Ljava/lang/String;Ljava/lang/Object;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;Lej6;)V

    return-void
.end method

.method public static synthetic a(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Lakh;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->configureSession$lambda$5(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Lakh;)V
...
.method public static final synthetic access$sendStreamData(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Lakh;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->sendStreamData(Lakh;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
...
.method public static synthetic c(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Ljava/lang/String;Lej6;Ljava/lang/Object;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->handleAsync$lambda$7(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Ljava/lang/String;Lej6;Ljava/lang/Object;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V

    return-void
.end method

.method private final configureSession(Lv6e;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    .locals 1
    ...
    invoke-direct {p2, v0, p0}, Lps3;-><init>(ILjava/lang/Object;)V

    check-cast p1, Lq7e;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object p2, p1, Lq7e;->j:Ljava/util/function/BiConsumer;

    new-instance p2, Lzjh;

    const/4 v0, 0x0

    invoke-direct {p2, p0, v0}, Lzjh;-><init>(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;I)V

    iput-object p2, p1, Lq7e;->i:Ljava/util/function/Consumer;
    ...
    iput-object p2, p1, Lq7e;->h:Ljava/util/function/Consumer;
...
.method private static final configureSession$lambda$3(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Ljava/lang/Long;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->log:Lcwc;
...
.method private static final configureSession$lambda$4(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Lakh;)V
    .locals 1

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->log:Lcwc;

    const-string p1, "WebTransportSocket"

    const-string v0, "Got new BIDI stream"

    invoke-interface {p0, p1, v0}, Lcwc;->log(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method private static final configureSession$lambda$5(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Lakh;)V
    .locals 1
...
.method private final connect(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->client:Lm47;

    invoke-direct {v1, v0, v2}, Lp83;-><init>(Ljava/net/URI;Lm47;)V

    invoke-virtual {v1, v0}, Lp83;->b(Ljava/net/URI;)Lq7e;

    move-result-object v0

    iput-object v0, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->session:Lv6e;

    invoke-direct {p0, v0, p1}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->configureSession(Lv6e;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V

    invoke-direct {p0, v0, p1}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->openSession(Lv6e;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    :try_end_0
...
.method public static synthetic d(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Lakh;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->configureSession$lambda$4(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Lakh;)V

    return-void
.end method

.method private final handleAsync(Ljava/lang/String;Ljava/lang/Object;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;Lej6;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct/range {v1 .. v7}, Lzt1;-><init>(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method private static final handleAsync$lambda$7(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Ljava/lang/String;Lej6;Ljava/lang/Object;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    .locals 5
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->log:Lcwc;
    ...
    :try_start_0
    invoke-interface {p2, p3, p4}, Lej6;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-interface {p0, v4, p1}, Lcwc;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_1
    iget-object p3, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->log:Lcwc;

    invoke-virtual {p1, v1}, Ljava/lang/String;->concat(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-interface {p3, v4, v1, p2}, Lcwc;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private final openSession(Lv6e;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    .locals 9
    ...
    sget-object v1, Lp7e;->b:Lp7e;

    new-instance v2, Loc8;

    const/16 v3, 0x1b

    invoke-direct {v2, v3}, Loc8;-><init>(I)V
    ...
    invoke-virtual {v0, v1, v2, v3}, Lq7e;->a(Lp7e;Ljava/util/function/Predicate;Ljava/util/function/Predicate;)Z

    iget-object v2, v0, Lq7e;->d:Lp83;

    iget-object v3, v2, Lp83;->b:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v3}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_0
    iget-object v3, v2, Lp83;->c:Ljava/util/concurrent/ConcurrentHashMap;

    iget-wide v4, v0, Lq7e;->c:J
    ...
    invoke-direct {v4, v5, v0}, Li4;-><init>(ILjava/lang/Object;)V
    ...
    :cond_0
    :goto_0
    iget-object v2, v2, Lp83;->b:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v2}, Ljava/util/concurrent/locks/ReentrantLock;->unlock()V

    invoke-interface {p2}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;->onOpen()V

    iget-object v2, v0, Lq7e;->e:Lp7e;

    sget-object v3, Lp7e;->a:Lp7e;
    ...
    iget-object v1, v0, Lq7e;->a:Lq47;

    check-cast v1, Lp47;

    iget-object v1, v1, Lp47;->f:Ljava/lang/Object;
    ...
    iget-object v2, v1, Lgic;->e:Lm9f;

    new-instance v3, Ls47;

    invoke-direct {v3, v1, v2}, Ls47;-><init>(Lgic;Lm9f;)V

    invoke-virtual {v3}, Ls47;->a()Ljava/io/OutputStream;
    ...
    invoke-static {v5, v6, v4}, Lvbi;->c(JLjava/nio/ByteBuffer;)I
    ...
    invoke-static {v4, v5, v2}, Lvbi;->c(JLjava/nio/ByteBuffer;)I
    ...
    :cond_2
    iget-object v1, v0, Lq7e;->k:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v1, v3}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    iget-object v0, v0, Lq7e;->l:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    invoke-direct {v0, v3, v1}, Lo7e;-><init>(Lt57;I)V
    ...
    invoke-direct {p0, v2, v0, p2, v1}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->handleAsync(Ljava/lang/String;Ljava/lang/Object;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;Lej6;)V

    invoke-direct {p0, p1, v0, p2}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->readStreamData(Lv6e;Lakh;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    ...
    :goto_3
    iget-object p2, v2, Lp83;->b:Ljava/util/concurrent/locks/ReentrantLock;
...
.method private final readStreamData(Lv6e;Lakh;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    .locals 7
    ...
    :try_start_0
    invoke-interface {p2}, Lakh;->b()Ljava/io/InputStream;
    ...
    :goto_0
    :try_start_1
    invoke-static {p2}, Lvbi;->d(Ljava/io/InputStream;)I
    ...
    iget-object p2, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->log:Lcwc;

    const-string p3, "stream closed, leave recv loop"

    invoke-interface {p2, v0, p3}, Lcwc;->log(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2
    ...
    invoke-interface {p3, v0, v1, p2}, Lcwc;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-interface {p3, v0, p1}, Lcwc;->log(Ljava/lang/String;Ljava/lang/String;)V

    throw p2
.end method

.method private final sendStreamData(Lakh;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :goto_1
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->log:Lcwc;
    ...
    :cond_0
    :try_start_4
    invoke-interface {p1}, Lakh;->a()Ljava/io/OutputStream;
    ...
    sget-object v7, Lp92;->a:Ljava/nio/charset/Charset;
    ...
    invoke-static {v7, v2}, Lvbi;->b(ILjava/nio/ByteBuffer;)I
    ...
    :try_start_6
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->log:Lcwc;
    ...
    invoke-interface {v1, v0, p2}, Lcwc;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final close(ILjava/lang/String;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->session:Lv6e;
    ...
    invoke-virtual {v0, v1, v2, p2}, Lq7e;->b(JLjava/lang/String;)V
