...
.method private handleHangup(Lvz0;Ljava/lang/Object;)V
    .locals 3
    ...
    iget-object v1, p1, Lvz0;->J:Lrw6;

    invoke-static {v0, v1, p2}, Lru/ok/android/externcalls/sdk/ConversationImpl;->s0(Lru/ok/android/externcalls/sdk/ConversationImpl;Lrw6;Ljava/lang/Object;)Lru/ok/android/externcalls/sdk/events/ConversationEventsListener$CallEndInfo;
    ...
    iget-object p1, p1, Lvz0;->g1:Lgr4;

    invoke-virtual {p1}, Lgr4;->t()Lru/ok/android/externcalls/sdk/events/end/ConversationEndReason;
...
.method private handleMuteParticipant(Li1a;)V
    .locals 2

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->shouldNotifyLegacyListener(Li1a;)Z
    ...
    iget-object v1, p1, Li1a;->a:Lh1a;

    invoke-interface {v0, v1}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener;->onMuteChanged(Lh1a;)V
    ...
    iget-object p1, p1, Li1a;->a:Lh1a;

    invoke-virtual {v0, p1}, Lru/ok/android/externcalls/sdk/media/mute/internal/listener/MediaMuteListenerManagerImpl;->onMuteChanged(Lh1a;)V

    return-void
.end method

.method private handleMuteStateInitialized(Li1a;)V
    .locals 1

    iget-boolean v0, p1, Li1a;->b:Z
    ...
    invoke-interface {v0, p1}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener;->onMuteStateInitialized(Lh1a;)V
    ...
    invoke-virtual {v0, p1}, Lru/ok/android/externcalls/sdk/media/mute/internal/listener/MediaMuteListenerManagerImpl;->onMuteStateInitialized(Lh1a;)V

    return-void
.end method

.method private handleRolesChanged(Lwh1;)V
    .locals 2
    ...
    invoke-static {v1}, Lru/ok/android/externcalls/sdk/ConversationImpl;->b0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lph1;

    move-result-object v1

    iget-boolean v1, v1, Lph1;->k:Z

    if-eqz v1, :cond_1

    iget-object v1, p1, Lwh1;->p:Lo71;
    ...
    invoke-virtual {v0}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->getCallParticipant()Lwh1;
    ...
    invoke-virtual {v0, p1, v1}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->setCallParticipant(Lwh1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    invoke-static {p1}, Lru/ok/android/externcalls/sdk/ConversationImpl;->b0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lph1;

    move-result-object p1

    iget-boolean p1, p1, Lph1;->k:Z
...
.method private shouldNotifyLegacyListener(Li1a;)Z
    .locals 3
    ...
    iget-object v0, p1, Lh1a;->a:Ljava/util/AbstractMap;

    iget-object p1, p1, Lh1a;->b:Ljava/util/Set;
...
# virtual methods
.method public onCallParticipantFingerprint(Lwh1;J)V
    .locals 3

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->this$0:Lru/ok/android/externcalls/sdk/ConversationImpl;

    invoke-static {v0}, Lru/ok/android/externcalls/sdk/ConversationImpl;->V(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lvz0;
...
.method public onCallParticipantNetworkStatusChanged(Ljava/util/List;)V
    ...
    invoke-virtual {v3, v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lsh1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;

    move-result-object v2

    if-eqz v2, :cond_0

    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->getCallParticipant()Lwh1;
    ...
    invoke-virtual {v2, v1, v3}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->setCallParticipant(Lwh1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    invoke-virtual {v1, v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipantRoomId(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lf8e;
    ...
    invoke-virtual {v3}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lf8e;
...
.method public onCustomData(Lsh1;Lorg/json/JSONObject;)V
    .locals 0
...
.method public onEvent(Lvz0;Lw61;Ljava/lang/Object;)V
    .locals 4

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->this$0:Lru/ok/android/externcalls/sdk/ConversationImpl;

    invoke-static {v0}, Lru/ok/android/externcalls/sdk/ConversationImpl;->h0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lcwc;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->onVideoStopped(Lnv9;)V

    return-void

    :pswitch_2
    instance-of p1, p3, Lmv9;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->onVideoStatesUpdatedChanged(Lmv9;)V

    return-void

    :pswitch_3
    instance-of p1, p3, Lkv9;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->onVideoStarted(Lkv9;)V
    ...
    :pswitch_6
    instance-of p1, p3, Li1a;

    if-eqz p1, :cond_5

    check-cast p3, Li1a;

    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleMuteStateInitialized(Li1a;)V
    ...
    sget-object p3, Ltz0;->X:Ltz0;

    iget-object p1, p1, Lvz0;->s:Ljava/util/EnumSet;
    ...
    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleMuteParticipant(Li1a;)V

    return-void

    :pswitch_d
    instance-of p1, p3, Lsh1;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lsh1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-direct {p0, p2}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleRolesChanged(Lwh1;)V

    goto :goto_1

    :pswitch_f
    instance-of p1, p3, Lwh1;

    if-eqz p1, :cond_5

    check-cast p3, Lwh1;

    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleRolesChanged(Lwh1;)V
    ...
    :pswitch_12
    invoke-virtual {p1, v1}, Lvz0;->F(Z)V
    ...
    :pswitch_13
    invoke-virtual {p1, v3}, Lvz0;->F(Z)V
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->onFeaturesPerRoleChanged(La81;)V

    return-void

    :pswitch_18
    instance-of p1, p3, Lz71;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->onFeatureSetChanged(Lz71;)V
    ...
    iget-object v0, p1, Lvz0;->g1:Lgr4;
    ...
    sget-object v0, Lrw6;->o:Lrw6;

    sget-object v1, Ljava/util/Collections;->EMPTY_SET:Ljava/util/Set;

    invoke-direct {p3, v0, v1, v2}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener$CallEndInfo;-><init>(Lrw6;Ljava/util/Set;Ljava/lang/String;)V
    ...
    iget-object p2, p1, Lvz0;->g1:Lgr4;
    ...
    invoke-virtual {p2, p3}, Lgr4;->B(Lru/ok/android/externcalls/sdk/events/end/ConversationEndReason;)V
    ...
    :pswitch_22
    invoke-direct {p0, p1, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleHangup(Lvz0;Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, v0, v1, p2}, Lvz0;->D(JLsr9;)V
...
.method public onStateChanged(Lsh1;Luh1;)V
    .locals 2
    ...
    invoke-static {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->fromInternal(Lsh1;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-interface {v1, v0, p2}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener;->onStateChanged(Lru/ok/android/externcalls/sdk/ConversationParticipant;Luh1;)V
    ...
    invoke-virtual {v0, p1, p2}, Lru/ok/android/externcalls/sdk/participant/state/internal/ParticipantStatesManagerImpl;->onStateChanged(Lsh1;Luh1;)V
