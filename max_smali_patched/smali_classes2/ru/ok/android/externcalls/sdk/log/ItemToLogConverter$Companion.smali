...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "create",
        "(Landroid/content/Context;ZZLcwc;)Lru/ok/android/externcalls/sdk/log/ItemToLogConverter;",
        "",
        "LOG_TAG",
        "Ljava/lang/String;",
        "calls-sdk_release"
...
# virtual methods
.method public final create(Landroid/content/Context;ZZLcwc;)Lru/ok/android/externcalls/sdk/log/ItemToLogConverter;
    .locals 1
    ...
    :try_start_0
    sget-object p2, Lkna;->a:Lyl;

    if-eqz p2, :cond_0

    new-instance p2, Lru/ok/android/externcalls/sdk/log/OneLogItemLogger;

    invoke-direct {p2, p4}, Lru/ok/android/externcalls/sdk/log/OneLogItemLogger;-><init>(Lcwc;)V
    ...
    invoke-interface {p4, p3, v0, p2}, Lcwc;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    new-instance p2, Lru/ok/android/externcalls/sdk/log/ProductStatItemLogger;

    const/4 p3, 0x1

    invoke-direct {p2, p1, p3, p4}, Lru/ok/android/externcalls/sdk/log/ProductStatItemLogger;-><init>(Landroid/content/Context;ZLcwc;)V
