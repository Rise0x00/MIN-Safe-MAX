...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "parse",
        "(Lgr7;)Lru/ok/android/externcalls/sdk/api/CallInfo;",
        "",
        "conversationId",
        "startConversationDelegateResultParse",
        "(Lgr7;Ljava/lang/String;)Lru/ok/android/externcalls/sdk/api/CallInfo;",
...
.method public synthetic constructor <init>(Lfi4;)V
    .locals 0
...
.method public static final synthetic access$parse(Lru/ok/android/externcalls/sdk/api/CallInfo$Companion;Lgr7;)Lru/ok/android/externcalls/sdk/api/CallInfo;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/api/CallInfo$Companion;->parse(Lgr7;)Lru/ok/android/externcalls/sdk/api/CallInfo;
...
.method private final parse(Lgr7;)Lru/ok/android/externcalls/sdk/api/CallInfo;
    .locals 15
    ...
    invoke-interface/range {p1 .. p1}, Lgr7;->p()V
    ...
    :goto_0
    invoke-interface/range {p1 .. p1}, Lgr7;->hasNext()Z

    move-result v0

    if-eqz v0, :cond_b

    invoke-interface/range {p1 .. p1}, Lgr7;->name()Ljava/lang/String;
    ...
    :cond_0
    invoke-interface/range {p1 .. p1}, Lgr7;->B()Ljava/lang/String;
    ...
    :cond_1
    invoke-static/range {p1 .. p1}, Lru/ok/android/externcalls/sdk/api/TurnStunParser;->parseStun(Lgr7;)Ljava/util/List;
    ...
    :cond_3
    invoke-static/range {p1 .. p1}, Lru/ok/android/externcalls/sdk/api/TurnStunParser;->parseTurn(Lgr7;)Ljava/util/List;
    ...
    :cond_4
    invoke-interface/range {p1 .. p1}, Lgr7;->W()Z
    ...
    :cond_5
    invoke-interface/range {p1 .. p1}, Lgr7;->x()I
    ...
    :goto_1
    invoke-interface/range {p1 .. p1}, Lgr7;->v()V
    ...
    :cond_b
    invoke-interface/range {p1 .. p1}, Lgr7;->n()V
...
.method private final startConversationDelegateResultParse(Lgr7;Ljava/lang/String;)Lru/ok/android/externcalls/sdk/api/CallInfo;
    .locals 15
...
.method public final createFromStartConversationDelegateResult$calls_sdk_release(Lru/ok/android/externcalls/sdk/api/delegate/StartConversationDelegate$Result$Success;)Lru/ok/android/externcalls/sdk/api/CallInfo;
    ...
    invoke-direct {p0, v0, p1}, Lru/ok/android/externcalls/sdk/api/CallInfo$Companion;->startConversationDelegateResultParse(Lgr7;Ljava/lang/String;)Lru/ok/android/externcalls/sdk/api/CallInfo;
...
.method public final getPARSER()Lar7;
    .locals 1
    ...
    invoke-static {}, Lru/ok/android/externcalls/sdk/api/CallInfo;->access$getPARSER$cp()Lar7;
