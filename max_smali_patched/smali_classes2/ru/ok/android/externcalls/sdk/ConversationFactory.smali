...
# static fields
.field private static final DEFAULT_APP_VERSION:Ljava/lang/String; = "sdk-sdk-125.1.0.71.1"

.field private static final LOG_TAG:Ljava/lang/String; = "ConversationFactory"

.field public static final SDK_VERSION:Ljava/lang/String; = "sdk-125.1.0.71.1"
...
.field private animojiDataSupplier:Lqi;
...
.field private groupCallMediaAdaptationConfig:Lxk8;
...
.field private log:Lcwc;

.field private logConfiguration:Ldwc;
...
.field private p2pCallMediaAdaptationConfig:Lxk8;
...
.field private final tracerLiteFacade:Ln0g;
...
.method public constructor <init>(Ltla;Landroid/content/Context;Ljava/lang/String;)V
    .locals 1

    const/4 v0, 0x0

    .line 1
    invoke-direct {p0, p1, p2, p3, v0}, Lru/ok/android/externcalls/sdk/ConversationFactory;-><init>(Ltla;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public constructor <init>(Ltla;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    .locals 7
    ...
    invoke-direct {v6, v1, v0}, Lg52;-><init>(ILjava/lang/Object;)V
    ...
    .line 3
    invoke-direct/range {v1 .. v6}, Lru/ok/android/externcalls/sdk/ConversationFactory;-><init>(Ltla;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lru/ok/android/externcalls/sdk/log/ExtLogger$TimeProvider;)V

    return-void
.end method

.method public constructor <init>(Ltla;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lru/ok/android/externcalls/sdk/log/ExtLogger$TimeProvider;)V
    .locals 6
    ...
    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->log:Lcwc;

    .line 9
    sget-object v2, Lru/ok/android/externcalls/sdk/CallUtil;->LOG_CONFIGURATION:Ldwc;

    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->logConfiguration:Ldwc;
    ...
    .line 21
    sget-object v2, Lcid;->V:Lvh4;

    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->rotationProvider:Lcid;

    .line 22
    const-string v2, "sdk-sdk-125.1.0.71.1"
    ...
    .line 33
    invoke-direct {v3}, Lph1;-><init>()V

    .line 34
    iput-object v3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lph1;

    .line 35
    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->locale:Ljava/util/Locale;

    .line 36
    sget-object v3, Lth6;->c:Lth6;

    iput-object v3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->animojiDataSupplier:Lqi;
    ...
    .line 39
    sget-object v3, Lru/ok/android/externcalls/sdk/chat/ChatStateListener;->EMPTY:Lru/ok/android/externcalls/sdk/chat/ChatStateListener;

    iput-object v3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->chatStateListener:Lru/ok/android/externcalls/sdk/chat/ChatStateListener;
    ...
    .line 42
    sget-object v1, Llg0;->e:Llg0;

    iput-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->badNetworkIndicatorConfig:Llg0;
    ...
    .line 45
    new-instance v4, Lru/ok/android/externcalls/sdk/connection/MediaConnectionSettings;

    invoke-direct {v4}, Lru/ok/android/externcalls/sdk/connection/MediaConnectionSettings;-><init>()V

    iput-object v4, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->mediaConnectionSettings:Lru/ok/android/externcalls/sdk/connection/MediaConnectionSettings;

    .line 46
    new-instance v4, Lru/ok/android/externcalls/sdk/rate/rtt/RttRateHintConfig;

    invoke-direct {v4}, Lru/ok/android/externcalls/sdk/rate/rtt/RttRateHintConfig;-><init>()V

    iput-object v4, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->rttRateHintConfig:Lru/ok/android/externcalls/sdk/rate/rtt/RttRateHintConfig;
    ...
    .line 51
    new-instance p4, Luuf;

    .line 52
    invoke-direct {p4}, Ljava/lang/Object;-><init>()V

    .line 53
    invoke-direct {p3, v2, p4}, Lru/ok/android/externcalls/sdk/api/ExecutionTimeInterceptor;-><init>(Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Ltuf;)V
    ...
    .line 55
    iget-object p4, p1, Ly53;->Z:Ljava/lang/Object;

    .line 56
    invoke-static {p4, p3}, Lab3;->O(Ljava/util/Collection;Ljava/lang/Object;)Ljava/util/ArrayList;

    move-result-object p3

    iput-object p3, p1, Ly53;->Z:Ljava/lang/Object;

    .line 57
    invoke-virtual {p1}, Ly53;->b()Ltla;

    move-result-object p1

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Ltla;
    ...
    .line 61
    iput-object p3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->disposable:Lai3;
    ...
    .line 64
    iput-object p3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->timeProvider:Ltuf;
    ...
    invoke-direct {v2, p0, v4}, Lm34;-><init>(Lru/ok/android/externcalls/sdk/ConversationFactory;I)V

    invoke-direct {p4, v2}, Lru/ok/android/externcalls/sdk/factory/internal/RTCLogWrapper;-><init>(Loi6;)V

    .line 66
    invoke-static {p2, p4}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->get(Landroid/content/Context;Lcwc;)Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;
    ...
    invoke-static {p2, v4, v0, p4}, Lru/ok/android/externcalls/sdk/log/ItemToLogConverter;->create(Landroid/content/Context;ZZLcwc;)Lru/ok/android/externcalls/sdk/log/ItemToLogConverter;
    ...
    invoke-direct {v0, p3, p4}, Lru/ok/android/externcalls/sdk/log/stat/ProductStatisticsManagerImpl;-><init>(Ltuf;Lru/ok/android/externcalls/sdk/log/ItemToLogConverter;)V
    ...
    iput-object p3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->bitrates:Loh1;

    .line 73
    new-instance p3, Lru/ok/android/externcalls/sdk/api/OkApiService;

    invoke-virtual {p1}, Ltla;->f()Ltkd;

    move-result-object p4

    invoke-direct {p3, p4}, Lru/ok/android/externcalls/sdk/api/OkApiService;-><init>(Ltkd;)V
    ...
    invoke-direct {p3, p2}, Ln0g;-><init>(Landroid/content/Context;)V

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->tracerLiteFacade:Ln0g;
    ...
    new-instance p4, Lm34;

    const/4 p5, 0x1

    invoke-direct {p4, p0, p5}, Lm34;-><init>(Lru/ok/android/externcalls/sdk/ConversationFactory;I)V

    invoke-virtual {p2, v1, p3, p1, p4}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsInitializer;->init(Lru/ok/android/externcalls/analytics/CallAnalyticsSender;Lru/ok/android/externcalls/sdk/analytics/ConversationAnalyticsConfigurationImpl;Ltla;Loi6;)V

    return-void
.end method

.method public static synthetic a(Lru/ok/android/externcalls/sdk/ConversationFactory;)Lcwc;
    .locals 0

    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$new$0()Lcwc;
...
.method public static synthetic b(Lgr7;)Ljava/lang/Object;
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$hangup$21(Lgr7;)Ljava/lang/Object;
...
.method private getBaseBuilder()Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Ltla;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setApi(Ltla;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    move-result-object v0

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->timeProvider:Ltuf;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setTimeProvider(Ltuf;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->log:Lcwc;

    instance-of v2, v1, Lu0g;
    ...
    iget-object v3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->tracerLiteFacade:Ln0g;

    invoke-direct {v2, v3, v1}, Lu0g;-><init>(Ln0g;Lcwc;)V

    move-object v1, v2

    :goto_0
    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setLog(Lcwc;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    move-result-object v0

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->logConfiguration:Ldwc;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setLogConfiguration(Ldwc;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->bitrates:Loh1;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setBitrates(Loh1;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->rotationProvider:Lcid;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setRotationProvider(Lcid;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    move-result-object v0

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->animojiDataSupplier:Lqi;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setAnimojiDataSupplier(Lqi;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->p2pCallMediaAdaptationConfig:Lxk8;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setP2PCallMediaAdaptationConfig(Lxk8;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->groupCallMediaAdaptationConfig:Lxk8;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setGroupCallMediaAdaptationConfig(Lxk8;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lph1;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setExperiments(Lph1;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->screenCapturePermissionProvider:Lfqd;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setScreenCapturePermissionProvider(Lfqd;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
...
.method public static declared-synchronized init(Lru/ok/android/externcalls/sdk/ConversationFactoryInitParams;)V
    ...
    .line 14
    invoke-virtual {v0}, Lru/ok/android/externcalls/sdk/ConversationFactoryInitParams$PeerConnection;->getLogger()Lcwc;
    ...
    .line 28
    invoke-direct/range {v4 .. v16}, Ligb;-><init>(ZZLjava/lang/String;Ljava/lang/String;Ljava/lang/Integer;ZZZZZZLjava/lang/String;)V
    ...
    .line 30
    invoke-direct {v0, v4, v5, v3}, Ltz8;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    .line 32
    invoke-static {v2, v0, v3}, Lhgb;->C(Landroid/content/Context;Ltz8;Lorg/webrtc/NativeLibraryLoader;)V
...
.method public static synthetic l(Lru/ok/android/externcalls/sdk/ConversationFactory;)Lcwc;
    .locals 0

    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$new$1()Lcwc;
...
.method private static synthetic lambda$answer$5(Lym;)Lym;
    .locals 0
...
.method private static synthetic lambda$answer$6(Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;Lru/ok/android/externcalls/sdk/Conversation;)V
    ...
    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams;->getOnPrepared()Lqi6;

    move-result-object p0

    invoke-interface {p0, p1}, Lqi6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static synthetic lambda$answer$7(Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams;->getOnError()Lqi6;
...
.method private static synthetic lambda$call$2(Lym;)Lym;
    .locals 0
...
.method private static synthetic lambda$createConfRoom$18(Lym;)Lym;
    .locals 0
...
.method private static synthetic lambda$hangup$21(Lgr7;)Ljava/lang/Object;
    .locals 0
...
.method private static synthetic lambda$joinAnonByLink$13(Lym;)Lym;
    .locals 0
...
.method private static synthetic lambda$joinAnonByLink$14(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;)Lbn;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct {v0, v1, p0}, Lbn;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method private static synthetic lambda$joinByLink$10(Lym;)Lym;
    .locals 0
...
.method private synthetic lambda$new$0()Lcwc;
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->log:Lcwc;

    return-object v0
.end method

.method private synthetic lambda$new$1()Lcwc;
    .locals 1
...
.method public static synthetic o(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;)Lbn;
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$joinAnonByLink$14(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;)Lbn;
...
# virtual methods
.method public answer(Lqi6;)Lru/ok/android/externcalls/sdk/Conversation;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams;->getCameraCapturerFactory()Lsha;

    move-result-object v3

    invoke-virtual {v1, v3}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setCameraCapturerFactory(Lsha;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    move-result-object v1

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams;->getFrameInterceptor()La42;

    invoke-virtual {v1, v2}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setFrameInterceptor(La42;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;->getTokenProvider()Lpxf;

    move-result-object v3

    if-eqz v3, :cond_0

    iget-object v3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Ltla;

    invoke-virtual {v3}, Ltla;->g()Ly53;

    move-result-object v3

    iget-object v4, v3, Ly53;->a:Ljava/lang/Object;

    check-cast v4, Lbm3;

    new-instance v5, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;

    invoke-direct {v5, v4}, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;-><init>(Lbm3;)V

    iput-object v5, v3, Ly53;->a:Ljava/lang/Object;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;->getTokenProvider()Lpxf;

    move-result-object v4

    iput-object v4, v3, Ly53;->b:Ljava/lang/Object;

    invoke-virtual {v3}, Ly53;->b()Ltla;

    move-result-object v3

    invoke-virtual {v1, v3}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setApi(Ltla;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    :cond_0
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;->getTokenInfoProvider()Lcn;
    ...
    iget-object v4, v3, Ly53;->Y:Ljava/lang/Object;

    check-cast v4, Lym;

    invoke-static {v4}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$answer$5(Lym;)Lym;

    move-result-object v4

    iput-object v4, v3, Ly53;->Y:Ljava/lang/Object;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;->getTokenInfoProvider()Lcn;

    move-result-object v4

    iput-object v4, v3, Ly53;->X:Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->log:Lcwc;

    const-string v4, "Try to decode provided conversation params"

    invoke-interface {v3, v0, v4}, Lcwc;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p1, v3}, Ll34;-><init>(Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;I)V

    new-instance v3, Ll34;

    const/4 v4, 0x1

    invoke-direct {v3, p1, v4}, Ll34;-><init>(Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;I)V

    invoke-virtual {v1, v2, v0, v3}, Lru/ok/android/externcalls/sdk/ConversationImpl;->prepare(Lru/ok/android/externcalls/sdk/api/ConversationParams;Ljr3;Ljr3;)V

    return-object v1
.end method

.method public call(Lqi6;)Lru/ok/android/externcalls/sdk/Conversation;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setFrameInterceptor(La42;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-virtual {v0, v2}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setCameraCapturerFactory(Lsha;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/StartCallParams;->getTokenProvider()Lpxf;

    move-result-object v2

    if-eqz v2, :cond_0

    iget-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Ltla;

    invoke-virtual {v2}, Ltla;->g()Ly53;

    move-result-object v2

    iget-object v3, v2, Ly53;->a:Ljava/lang/Object;

    check-cast v3, Lbm3;

    new-instance v4, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;

    invoke-direct {v4, v3}, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;-><init>(Lbm3;)V

    iput-object v4, v2, Ly53;->a:Ljava/lang/Object;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/StartCallParams;->getTokenProvider()Lpxf;

    move-result-object v3

    iput-object v3, v2, Ly53;->b:Ljava/lang/Object;

    invoke-virtual {v2}, Ly53;->b()Ltla;

    move-result-object v2

    invoke-virtual {v0, v2}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setApi(Ltla;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    :cond_0
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/StartCallParams;->getTokenInfoProvider()Lcn;
    ...
    iget-object v3, v2, Ly53;->Y:Ljava/lang/Object;

    check-cast v3, Lym;

    invoke-static {v3}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$call$2(Lym;)Lym;

    move-result-object v3

    iput-object v3, v2, Ly53;->Y:Ljava/lang/Object;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/StartCallParams;->getTokenInfoProvider()Lcn;

    move-result-object v3

    iput-object v3, v2, Ly53;->X:Ljava/lang/Object;
    ...
    invoke-direct {v2, p1, v3}, Lh34;-><init>(Lru/ok/android/externcalls/sdk/factory/StartCallParams;I)V

    new-instance v3, Lh34;

    const/4 v4, 0x1

    invoke-direct {v3, p1, v4}, Lh34;-><init>(Lru/ok/android/externcalls/sdk/factory/StartCallParams;I)V

    invoke-virtual {v0, v1, v2, v3}, Lru/ok/android/externcalls/sdk/ConversationImpl;->prepare(Lru/ok/android/externcalls/sdk/api/ConversationParams;Ljr3;Ljr3;)V
...
.method public clearApiAuthSession()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Ltla;

    invoke-virtual {v0}, Ltla;->e()Lula;
...
.method public createConfRoom(Lqi6;)Lru/ok/android/externcalls/sdk/Conversation;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setCameraCapturerFactory(Lsha;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/CreateConfParams;->getTokenProvider()Lpxf;
    ...
    iput-object v2, v1, Ly53;->b:Ljava/lang/Object;

    iget-object v2, v1, Ly53;->a:Ljava/lang/Object;

    check-cast v2, Lbm3;

    new-instance v3, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;

    invoke-direct {v3, v2}, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;-><init>(Lbm3;)V

    iput-object v3, v1, Ly53;->a:Ljava/lang/Object;

    invoke-virtual {v1}, Ly53;->b()Ltla;
    ...
    :cond_0
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/CreateConfParams;->getTokenInfoProvider()Lcn;
    ...
    iget-object v2, v1, Ly53;->Y:Ljava/lang/Object;

    check-cast v2, Lym;

    invoke-static {v2}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$createConfRoom$18(Lym;)Lym;

    move-result-object v2

    iput-object v2, v1, Ly53;->Y:Ljava/lang/Object;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/CreateConfParams;->getTokenInfoProvider()Lcn;

    move-result-object v2

    iput-object v2, v1, Ly53;->X:Ljava/lang/Object;
    ...
    invoke-direct {v6, p1, v0}, Ln34;-><init>(Lru/ok/android/externcalls/sdk/factory/CreateConfParams;I)V

    new-instance v7, Ln34;

    const/4 v0, 0x1

    invoke-direct {v7, p1, v0}, Ln34;-><init>(Lru/ok/android/externcalls/sdk/factory/CreateConfParams;I)V

    const/4 v3, 0x0

    const/4 v4, 0x1

    invoke-virtual/range {v2 .. v7}, Lru/ok/android/externcalls/sdk/ConversationImpl;->prepare(Lru/ok/android/externcalls/sdk/api/ConversationParams;ZZLjr3;Ljr3;)V
...
.method public getAnimojiDataSupplier()Lqi;
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->animojiDataSupplier:Lqi;
...
.method public hangup(Lrw6;Ljava/lang/String;)V
    .locals 1

    const/4 v0, 0x0

    .line 25
    invoke-virtual {p0, p1, p2, v0}, Lru/ok/android/externcalls/sdk/ConversationFactory;->hangup(Lrw6;Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public hangup(Lrw6;Ljava/lang/String;Ljava/lang/String;)V
    .locals 4
    ...
    invoke-direct {v2, v3, p2}, Lvaf;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p2, v2, p1}, Lvaf;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p1, p2, p3}, Lvaf;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object p3, Ldr7;->a:Lay6;

    invoke-direct {p1, v0, p2, v1, p3}, Ltl0;-><init>(Landroid/net/Uri;Lum;Lom;Lar7;)V

    .line 15
    iget-object p2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Ltla;

    .line 16
    invoke-virtual {p2}, Ltla;->f()Ltkd;
    ...
    invoke-direct {p3, v0}, Lbc2;-><init>(I)V
    ...
    invoke-direct {v0, p1, p3}, Lgm;-><init>(Lpm;Lar7;)V

    .line 18
    invoke-virtual {p2, v0}, Ltkd;->a(Lfm;)Lbre;

    move-result-object p1

    .line 19
    iget-object p2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->log:Lcwc;

    .line 20
    invoke-static {p1, p2}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiCallForBackgroundWork(Ljqe;Lcwc;)Ljqe;
    ...
    invoke-direct {p2, p3}, Lbc2;-><init>(I)V
    ...
    invoke-direct {v0, p2, v1, p3}, Lnt1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    .line 23
    invoke-virtual {p1, v0}, Ljqe;->k(Lcre;)V

    .line 24
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->disposable:Lai3;
...
.method public join(Lqi6;)Lru/ok/android/externcalls/sdk/Conversation;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, p1, v3}, Lk34;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinCallParams;I)V

    new-instance v3, Lk34;

    const/4 v4, 0x1

    invoke-direct {v3, p1, v4}, Lk34;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinCallParams;I)V
...
.method public joinAnonByLink(Lqi6;)Lru/ok/android/externcalls/sdk/Conversation;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v1}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$joinAnonByLink$13(Lym;)Lym;
    ...
    invoke-direct {v2, v1}, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;-><init>(Lbm3;)V

    iput-object v2, v0, Ly53;->a:Ljava/lang/Object;
    ...
    iput-object v1, v0, Ly53;->b:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setApi(Ltla;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-direct {v1, p1, v2}, Li34;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;I)V

    new-instance v2, Li34;

    const/4 v3, 0x0

    invoke-direct {v2, p1, v3}, Li34;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;I)V

    invoke-virtual {v0, v1, v2}, Lru/ok/android/externcalls/sdk/ConversationImpl;->prepareJoinByLink(Ljr3;Ljr3;)V

    return-object v0
.end method

.method public joinByLink(Lqi6;)Lru/ok/android/externcalls/sdk/Conversation;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams;->getTokenProvider()Lpxf;
    ...
    :cond_0
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams;->getTokenInfoProvider()Lcn;
    ...
    invoke-static {v2}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$joinByLink$10(Lym;)Lym;
    ...
    invoke-direct {v1, p1, v2}, Lj34;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams;I)V

    new-instance v2, Lj34;

    const/4 v3, 0x1

    invoke-direct {v2, p1, v3}, Lj34;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams;I)V
...
.method public reset()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->disposable:Lai3;
...
.method public setAddParticipantsByExternalIdEnabled(Z)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lph1;

    iput-boolean p1, v0, Lph1;->n:Z
...
.method public setAnimojiDataSupplier(Lqi;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->animojiDataSupplier:Lqi;
...
.method public setAudioAdaptationParams(Lmh1;)V
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lph1;

    iput-object p1, v0, Lph1;->t:Lmh1;
...
.method public setAudioJitterBufferMaxPackets(Ljava/lang/Integer;)V
    ...
    iput-object p1, v0, Lph1;->F:Ljava/lang/Integer;
...
.method public setAudioRedundancyParams(Lnh1;)V
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lph1;

    iput-object p1, v0, Lph1;->u:Lnh1;
...
.method public setBackendRenderVmoji(ZLjava/lang/String;)V
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lph1;

    iput-boolean v3, p1, Lph1;->m:Z

    iget-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->log:Lcwc;

    const-string p2, "Vmoji backend render enabled for all"

    invoke-interface {p1, v2, p2}, Lcwc;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public setBitrates(Loh1;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->bitrates:Loh1;
...
.method public setCallAnalyticsUploadParams(Ljava/lang/Double;Ljava/lang/Double;)V
    ...
    iput-object p1, v0, Lph1;->q:Ljava/lang/Double;

    iput-object p2, v0, Lph1;->r:Ljava/lang/Double;
...
.method public setDynamicScreenShareSizeUpdateEnabled(Z)V
    ...
    iput-boolean p1, v0, Lph1;->l:Z

    return-void
.end method

.method public setEmulatedNegotiationErrorType(Lh5a;)V
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lph1;

    iput-object p1, v0, Lph1;->z:Lh5a;
...
.method public setEnqueuedCommandMergeEnabled(Z)V
    ...
    iput-boolean p1, v0, Lph1;->j:Z

    return-void
.end method

.method public setExceptionConsumer(Lawc;)V
    .locals 0
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
...
.method public setGroupCallMediaAdaptationConfig(Lxk8;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->groupCallMediaAdaptationConfig:Lxk8;
...
.method public setIceTransportType(Lorg/webrtc/PeerConnection$IceTransportsType;)V
    ...
    iput-object p1, v0, Lph1;->v:Lorg/webrtc/PeerConnection$IceTransportsType;
...
.method public setLogConfiguration(Ldwc;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->logConfiguration:Ldwc;

    return-void
.end method

.method public setLogger(Lcwc;)V
    .locals 2

    if-nez p1, :cond_0

    iget-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Ltla;

    invoke-virtual {p1}, Ltla;->e()Lula;

    move-result-object p1

    sget-object v0, Lrm;->a:Lqm;

    invoke-interface {p1, v0}, Lula;->a(Lrm;)V

    sget-object p1, Lbwc;->a:Lbwc;
    ...
    invoke-direct {v1, p1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;-><init>(Lcwc;)V

    invoke-interface {v0, v1}, Lula;->a(Lrm;)V

    :goto_0
    new-instance v0, Lu0g;

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->tracerLiteFacade:Ln0g;

    invoke-direct {v0, v1, p1}, Lu0g;-><init>(Ln0g;Lcwc;)V

    iput-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->log:Lcwc;

    invoke-static {v0}, Lru/ok/android/externcalls/sdk/log/GlobalRTCLogger;->setLog(Lcwc;)V
...
.method public setP2PCallMediaAdaptationConfig(Lxk8;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->p2pCallMediaAdaptationConfig:Lxk8;
...
.method public setRotationProvider(Lcid;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->rotationProvider:Lcid;
...
.method public setScreenCapturePermissionProvider(Lfqd;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->screenCapturePermissionProvider:Lfqd;
...
.method public setStartCallByExternalIdEnabled(Z)V
    ...
    iput-boolean p1, v0, Lph1;->k:Z

    return-void
.end method

.method public setTimeouts(Lqh1;)V
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lph1;

    iput-object p1, v0, Lph1;->f:Lqh1;
...
.method public setVpnPreference(Lorg/webrtc/PeerConnection$VpnPreference;)V
    ...
    iput-object p1, v0, Lph1;->w:Lorg/webrtc/PeerConnection$VpnPreference;
