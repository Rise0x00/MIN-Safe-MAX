...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "download",
        "(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Ljqe;",
        "Lcwc;",
        "Companion",
        "calls-sdk_release"
    }
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl$Companion;-><init>(Lfi4;)V
...
.method public constructor <init>(Lcwc;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Lcwc;

    return-void
.end method

.method public static synthetic a(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Lnqe;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->download$lambda$3(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Lrqe;)V

    return-void
.end method

.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;)Lcwc;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Lcwc;

    return-object p0
.end method

.method private static final download$lambda$3(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Lrqe;)V
    .locals 8
    ...
    invoke-virtual {v0, p2}, Lnqe;->onError(Ljava/lang/Throwable;)V
    :try_end_1
    ...
    :cond_0
    :try_start_2
    invoke-static {p1}, Lt0j;->b(Ljava/io/File;)V
    ...
    invoke-virtual {p2}, Lru/ok/android/externcalls/sdk/net/FileValidationConfig;->getHashAlgorithm()Ldx6;

    move-result-object p0

    iget-object p0, p0, Ldx6;->a:Ljava/lang/String;
    ...
    invoke-virtual {p0, p2}, Lnqe;->a(Ljava/lang/Object;)V
    :try_end_6
    ...
    :goto_4
    iget-object p0, v2, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Lcwc;
    ...
    invoke-static {v1, v3, p3, p1, v0}, Lox1;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-interface {p0, p3, p1}, Lcwc;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4, p0}, Lt0j;->a(Ljava/io/File;Lqi6;)V

    check-cast p4, Lnqe;

    invoke-virtual {p4, p2}, Lnqe;->onError(Ljava/lang/Throwable;)V
...
.method private final downloadInner(Ljava/lang/String;Ljava/io/File;Ljava/security/MessageDigest;)V
    ...
    invoke-direct {v2, v0, p3}, Lahg;-><init>(ILjava/lang/Object;)V
    ...
    invoke-static {v5, p2}, Ltv5;->g(Ljava/io/InputStream;[Ljava/io/OutputStream;)V
    :try_end_3
...
# virtual methods
.method public download(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Ljqe;
    .locals 1
    ...
    invoke-direct {v0, p1, p2, p3, p0}, Lvl;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
