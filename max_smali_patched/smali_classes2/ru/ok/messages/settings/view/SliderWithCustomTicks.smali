...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p0, v2}, Ltse;->setValue(F)V
    ...
    sget v6, Ldvc;->Slider_tickColor:I
    ...
    sget v7, Ldvc;->Slider_tickColor:I

    goto :goto_0

    :cond_1
    sget v7, Ldvc;->Slider_tickColorInactive:I
    ...
    :cond_2
    sget v6, Ldvc;->Slider_tickColorActive:I
    ...
    sget-object v0, Lfvc;->SliderWithCustomTicks:[I

    invoke-virtual {p1, p2, v0, v1, v1}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Lfvc;->SliderWithCustomTicks_tickRadius:I
    ...
    sget p2, Lfvc;->SliderWithCustomTicks_normalValue:I
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-super/range {p0 .. p1}, Lzk0;->onDraw(Landroid/graphics/Canvas;)V
    ...
    :cond_0
    invoke-virtual {v0}, Ltse;->getStepSize()F
    ...
    invoke-virtual {v0}, Ltse;->getTrackWidth()I

    move-result v6

    invoke-virtual {v0}, Ltse;->getTrackHeight()I
    ...
    invoke-virtual {v0}, Ltse;->getTrackSidePadding()I
    ...
    :cond_4
    invoke-virtual {v0}, Ltse;->getValue()F
    ...
    invoke-virtual {v0}, Ltse;->getThumbRadius()I
...
.method public final onSizeChanged(IIII)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Lzk0;->onSizeChanged(IIII)V
...
.method public setStepSize(F)V
    ...
    invoke-super {p0, p1}, Ltse;->setStepSize(F)V
...
.method public setValueFrom(F)V
    ...
    invoke-super {p0, p1}, Ltse;->setValueFrom(F)V
...
.method public setValueTo(F)V
    ...
    invoke-super {p0, p1}, Ltse;->setValueTo(F)V
