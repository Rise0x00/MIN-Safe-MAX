...
.method public final O(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    sget p3, Lqqc;->frg_tam_crop_image:I
...
.method public final b0(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0}, Lone/me/image/crop/view/ImageCropView;->getCropState()Lf74;
...
.method public final e0(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    sget v0, Ltpc;->frg_tam_crop_image__iv_crop:I
    ...
    sget v0, Ltpc;->frg_tam_crop_image__rotate:I
    ...
    sget v0, Ltpc;->frg_tam_crop_image__flip:I
    ...
    sget v0, Ltpc;->frg_tam_crop_image__btn_clear:I
    ...
    sget v0, Ltpc;->frg_tam_crop_image__btn_done:I
    ...
    sget v0, Ltpc;->frg_tam_crop_image__btn_close:I
    ...
    invoke-static {v10, v0, p1}, Lcuh;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object p2, p2, Lone/me/image/crop/view/ImageCropView;->a:Lco6;

    invoke-virtual {p2}, Ly2g;->getMaxBitmapSize()I
    ...
    invoke-direct {v9, p2}, Luvf;-><init>(Ljava/lang/Object;)V

    new-instance v3, Ldp0;

    move v8, v7

    invoke-direct/range {v3 .. v9}, Ldp0;-><init>(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILuvf;)V
    ...
    iput-object p1, p2, Llj7;->G0:Lf74;
    :try_end_0
    ...
    invoke-static {v10, p2, p1}, Lcuh;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {p1, p2, v2}, Luyh;->j(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    invoke-direct {p2, p0, v2}, Ldi6;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V

    invoke-static {p1, p2}, Lsxi;->b(Landroid/view/View;Lu6;)V

    iget-object p1, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->w1:Landroid/widget/ImageButton;

    new-instance p2, Ldi6;

    invoke-direct {p2, p0, v1}, Ldi6;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V
    ...
    invoke-direct {p2, p0, v0}, Ldi6;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V
    ...
    invoke-static {v2, p2}, Lfk7;->d(II)Landroid/graphics/drawable/RippleDrawable;
