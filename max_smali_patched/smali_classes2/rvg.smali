...
.method public final createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    :cond_0
    sget-object v4, Leye;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-direct/range {v6 .. v11}, Lobf;-><init>(FIIZLeye;)V
    ...
    iput-object v3, v1, Ltui;->b:Ljava/lang/String;
    ...
    invoke-static {v1, v4, v5}, Ltxi;->u(Landroid/os/Parcel;II)V
    ...
    :pswitch_6
    invoke-static {v1, v4}, Ltxi;->k(Landroid/os/Parcel;I)B
    ...
    invoke-static {v7}, Lkhi;->f(B)Ljava/lang/Boolean;

    move-result-object v2

    iput-object v2, v1, Lcom/google/android/gms/maps/GoogleMapOptions;->a:Ljava/lang/Boolean;

    invoke-static {v8}, Lkhi;->f(B)Ljava/lang/Boolean;
    ...
    invoke-static/range {v22 .. v22}, Lkhi;->f(B)Ljava/lang/Boolean;
    ...
    iput-object v3, v1, Loti;->a:Ljava/lang/String;

    iput-object v4, v1, Loti;->b:Ljava/lang/String;

    iput-object v5, v1, Loti;->c:Ljava/lang/String;

    iput-object v6, v1, Loti;->d:Ljava/lang/String;

    iput-object v7, v1, Loti;->o:Ljava/lang/String;

    iput-object v8, v1, Loti;->X:Ljava/lang/String;

    iput-object v9, v1, Loti;->Y:Ljava/lang/String;
    ...
    invoke-static {v1, v7}, Ltxi;->s(Landroid/os/Parcel;I)V

    goto :goto_4

    :cond_c
    invoke-static {v1, v7}, Ltxi;->l(Landroid/os/Parcel;I)D
    ...
    iput-wide v3, v1, Llsi;->a:D

    iput-wide v5, v1, Llsi;->b:D
    ...
    invoke-direct/range {v7 .. v12}, Lgu7;-><init>(JIZLd6i;)V
    ...
    :cond_14
    invoke-static {v1, v7}, Ltxi;->e(Landroid/os/Parcel;I)Ljava/lang/String;
    ...
    :cond_17
    invoke-static {v1, v7}, Ltxi;->p(Landroid/os/Parcel;I)I
    ...
    iput-object v3, v1, Lgri;->b:Ljava/lang/String;

    iput-object v4, v1, Lgri;->c:Ljava/lang/String;

    iput-object v5, v1, Lgri;->d:Ljava/lang/String;
    ...
    :cond_1e
    invoke-static {v1, v7}, Ltxi;->m(Landroid/os/Parcel;I)F
    ...
    invoke-static {v1, v7, v6}, Ltxi;->d(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Landroid/os/Parcelable;
    ...
    invoke-direct/range {v5 .. v10}, Ltvh;-><init>(ILandroid/os/IBinder;Lgp3;ZZ)V
    ...
    invoke-static {v1, v7, v4}, Ltxi;->d(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Landroid/os/Parcelable;
    ...
    invoke-static {v1, v7, v3}, Ltxi;->d(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v5, v3, v6, v4}, Lsvh;-><init>(ILandroid/accounts/Account;ILcom/google/android/gms/auth/api/signin/GoogleSignInAccount;)V
    ...
    invoke-direct/range {v8 .. v19}, Lrr9;-><init>(IIIJJLjava/lang/String;Ljava/lang/String;II)V
    ...
    :cond_2f
    sget-object v4, Ltvh;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    :cond_30
    sget-object v3, Lgp3;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-static {v1, v6, v3}, Ltxi;->d(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v5, v3, v4}, Lnvh;-><init>(ILgp3;Ltvh;)V
    ...
    :cond_33
    sget-object v3, Lsvh;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-direct {v1, v4, v3}, Llvh;-><init>(ILsvh;)V
    ...
    invoke-direct {v1, v5, v4}, Lgvh;-><init>(Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    :pswitch_36
    sget-object v3, Lus6;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-static {v1, v4, v3}, Ltxi;->h(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Ljava/util/ArrayList;
    ...
    :cond_3b
    invoke-static {v1, v5}, Ltxi;->j(Landroid/os/Parcel;I)Z
    ...
    invoke-direct {v1, v3, v4}, Lgu9;-><init>(IZ)V
    ...
    :cond_40
    invoke-static {v1, v7}, Ltxi;->j(Landroid/os/Parcel;I)Z
    ...
    invoke-static {v1, v7, v3}, Ltxi;->h(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Ljava/util/ArrayList;
    ...
    invoke-direct {v1, v3, v6, v4, v5}, Lim;-><init>(Ljava/util/ArrayList;ZLjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v3, v4}, Ltxi;->h(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Ljava/util/ArrayList;
    ...
    invoke-direct {v1, v4, v5, v3}, Lduh;-><init>(IILandroid/content/Intent;)V
    ...
    invoke-direct {v1, v3}, Lfu9;-><init>(Landroid/app/PendingIntent;)V
    ...
    :cond_4a
    sget-object v3, Lrr9;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-static {v1, v5, v3}, Ltxi;->h(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Ljava/util/ArrayList;
    ...
    invoke-direct {v1, v4, v3}, Lnpf;-><init>(ILjava/util/List;)V
    ...
    invoke-direct {v1, v3, v4}, Leu9;-><init>(ZI)V
    ...
    invoke-direct {v1, v4, v5, v3}, Lus6;-><init>(IILandroid/os/Bundle;)V
    ...
    :goto_1e
    invoke-direct/range {v6 .. v13}, Lkfh;-><init>(ILjava/lang/String;Ljava/lang/String;ZZZZ)V
    ...
    invoke-direct {v2, v1}, Lq2h;-><init>(Landroid/os/Parcel;)V
    ...
    invoke-direct {v2, v1}, Ltvg;-><init>(Lkhc;)V
...
.method public final newArray(I)[Ljava/lang/Object;
    ...
    new-array p1, p1, [Lobf;

    return-object p1

    :pswitch_0
    new-array p1, p1, [Ltui;
    ...
    :pswitch_13
    new-array p1, p1, [Lduh;

    return-object p1

    :pswitch_14
    new-array p1, p1, [Lfu9;

    return-object p1

    :pswitch_15
    new-array p1, p1, [Lnpf;

    return-object p1

    :pswitch_16
    new-array p1, p1, [Leu9;
    ...
    :pswitch_19
    new-array p1, p1, [Lq2h;

    return-object p1

    :pswitch_1a
    new-array p1, p1, [Lr2h;

    return-object p1

    :pswitch_1b
    new-array p1, p1, [Ltvg;

    return-object p1

    :pswitch_1c
    new-array p1, p1, [Lsvg;
