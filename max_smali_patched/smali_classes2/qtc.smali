...
.method public final a(Landroid/util/Size;ILandroid/graphics/Rect;)Landroid/graphics/Matrix;
    ...
    iget-object v2, p0, Lqtc;->d:Landroid/graphics/Matrix;

    invoke-direct {v1, v2}, Landroid/graphics/Matrix;-><init>(Landroid/graphics/Matrix;)V

    invoke-virtual {p0, p1, p2}, Lqtc;->c(Landroid/util/Size;I)Landroid/graphics/Matrix;
...
.method public final b()Landroid/util/Size;
    ...
    iget-object v1, p0, Lqtc;->b:Landroid/graphics/Rect;

    invoke-virtual {v1}, Landroid/graphics/Rect;->height()I

    move-result v1

    iget-object v2, p0, Lqtc;->b:Landroid/graphics/Rect;
...
.method public final c(Landroid/util/Size;I)Landroid/graphics/Matrix;
    ...
    invoke-virtual {p0}, Lqtc;->b()Landroid/util/Size;

    move-result-object v0

    const/4 v1, 0x1

    invoke-static {p1, v1, v0}, Lj6h;->d(Landroid/util/Size;ZLandroid/util/Size;)Z
    ...
    invoke-static {v6, v5}, Lw8g;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_0
    sget-object v6, Lutc;->d:Lutc;

    if-eq v3, v6, :cond_5

    sget-object v6, Lutc;->c:Lutc;

    if-eq v3, v6, :cond_5

    sget-object v6, Lutc;->o:Lutc;
    ...
    iget-object v0, p0, Lqtc;->b:Landroid/graphics/Rect;
    ...
    invoke-static {p1, p2, v0, v1}, Lj6h;->a(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;

    move-result-object p1

    iget-boolean p2, p0, Lqtc;->f:Z

    if-eqz p2, :cond_8

    iget-boolean p2, p0, Lqtc;->g:Z

    if-eqz p2, :cond_8

    iget p2, p0, Lqtc;->c:I

    invoke-static {p2}, Lj6h;->c(I)Z
    ...
    iget-object p2, p0, Lqtc;->b:Landroid/graphics/Rect;
...
.method public final d()Landroid/graphics/Matrix;
    ...
    iget-object v1, p0, Lqtc;->a:Landroid/util/Size;
    ...
    iget-object v2, p0, Lqtc;->a:Landroid/util/Size;
    ...
    invoke-static {v0, v0, v1, v2}, Lj6h;->a(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
...
.method public final e(Landroid/util/Size;I)Landroid/graphics/RectF;
    ...
    iget-object v0, p0, Lqtc;->a:Landroid/util/Size;
...
.method public final f()Z
    ...
    :goto_1
    iget-object v3, p0, Lqtc;->b:Landroid/graphics/Rect;

    if-eqz v3, :cond_2

    iget-object v3, p0, Lqtc;->a:Landroid/util/Size;
