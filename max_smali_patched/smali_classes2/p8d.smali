...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object v7, v5, Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;->v0:Ld0d;

    sget-object v8, Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;->D0:[Les7;

    aget-object v2, v8, v2

    invoke-interface {v7, v5, v2}, Ld0d;->E(Ljava/lang/Object;Les7;)Ljava/lang/Object;
    ...
    invoke-static {v6, v7, p1}, Lm65;->o(FFI)I

    move-result p1

    invoke-direct {v8, v2, p1, v3}, Lone/me/login/neuroavatars/NeuroAvatarPickerBottomSheet;-><init>(Ljava/lang/String;ILfi4;)V

    invoke-virtual {v8, v5}, Lone/me/sdk/arch/Widget;->setTargetController(Lc24;)V
    ...
    :cond_2
    invoke-virtual {v8, v5}, Lone/me/sdk/bottomsheet/BottomSheetWidget;->M0(Lone/me/sdk/arch/Widget;)V
    ...
    invoke-static {v0, v7, v4, v1}, Lnx1;->u(ZLbjd;ZLjava/lang/String;)V
    ...
    invoke-virtual {v5}, Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;->y0()Lm8d;
    ...
    :cond_4
    invoke-virtual {v5}, Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;->z0()Lk8a;
    ...
    sget v6, Lwsc;->oneme_login_neuro_avatars_bottomsheet_title:I

    invoke-static {v6, v3, v3, v2}, Lnx1;->e(ILandroid/os/Bundle;Ldqd;I)Ltn3;

    move-result-object v2

    check-cast p1, Le28;

    invoke-virtual {p1, v0}, Le28;->listIterator(I)Ljava/util/ListIterator;
    ...
    invoke-virtual {v6}, Lc28;->hasNext()Z

    move-result v7

    if-eqz v7, :cond_5

    invoke-virtual {v6}, Lc28;->next()Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lun3;

    filled-new-array {v6}, [Lun3;

    move-result-object v6

    invoke-virtual {v2, v6}, Ltn3;->a([Lun3;)V
    ...
    invoke-virtual {v5, v4}, Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;->A0(Z)V
