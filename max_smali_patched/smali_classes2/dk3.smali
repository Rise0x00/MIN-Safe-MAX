...
# direct methods
.method public constructor <init>(JJZLcig;Z[JZLjava/util/ArrayList;Ljava/util/ArrayList;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lzm;-><init>(J)V

    iput-wide p3, p0, Ldk3;->d:J

    iput-boolean p5, p0, Ldk3;->o:Z

    iput-object p6, p0, Ldk3;->X:Lcig;

    iput-boolean p7, p0, Ldk3;->Y:Z

    iput-object p8, p0, Ldk3;->Z:[J
...
.method public static u([B)Ldk3;
    ...
    invoke-direct {v4, v1}, Let;-><init>(I)V
    ...
    invoke-virtual {v4, v9}, Let;->add(Ljava/lang/Object;)Z
    ...
    invoke-direct {v6, v1}, Let;-><init>(I)V
    ...
    invoke-virtual {v6, v10}, Let;->add(Ljava/lang/Object;)Z
    ...
    invoke-direct {v7, v1}, Let;-><init>(I)V
    ...
    invoke-static {v13}, Ln66;->valueOf(Ljava/lang/String;)Ln66;

    move-result-object v13

    invoke-virtual {v7, v13}, Let;->add(Ljava/lang/Object;)Z
    ...
    invoke-static {v5}, Lrb9;->a([Lru/ok/tamtam/nano/Protos$MessageElement;)Ljava/util/ArrayList;

    move-result-object v5

    invoke-static {v5}, Lug8;->t(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    iget-object v5, v3, Lru/ok/tamtam/nano/a;->j:Lt96;
    ...
    iget-object v2, v5, Lt96;->b:Ljava/io/Serializable;
    ...
    :cond_5
    sget-object v5, Ln66;->B0:Ln66;

    invoke-virtual {v1, v5, v2}, Ljava/util/EnumMap;->put(Ljava/lang/Enum;Ljava/lang/Object;)Ljava/lang/Object;

    :goto_7
    iget-object v2, v3, Lru/ok/tamtam/nano/a;->k:Lt96;

    invoke-static {v2}, Ligi;->o(Lt96;)Ljava/util/ArrayList;

    move-result-object v25

    iget-object v2, v3, Lru/ok/tamtam/nano/a;->l:Lt96;

    invoke-static {v2}, Ligi;->n(Lt96;)Ljava/util/EnumSet;
    ...
    invoke-direct/range {v13 .. v26}, Lef2;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;ZLjava/util/List;JLjava/util/Map;Ljava/util/List;Ljava/util/Set;)V
    ...
    iput-object v9, v7, Laig;->a:Ljava/lang/Boolean;
    ...
    iput-object v9, v7, Laig;->b:Ljava/lang/Long;
    ...
    iput-object v9, v7, Laig;->c:Ljava/lang/String;
    ...
    iput-object v9, v7, Laig;->d:Ljava/lang/String;
    ...
    iput-object v9, v7, Laig;->e:Ljava/lang/String;
    ...
    iput-object v9, v7, Laig;->f:Ljava/lang/String;
    ...
    iput-object v9, v7, Laig;->g:Ljava/lang/String;
    ...
    iput-object v9, v7, Laig;->h:Ljava/lang/Boolean;
    ...
    iput-object v9, v7, Laig;->i:Ljava/lang/Integer;
    ...
    iput-object v9, v7, Laig;->j:Ljava/lang/Integer;
    ...
    iput-object v9, v7, Laig;->k:Ljava/lang/Integer;
    ...
    iput-object v9, v7, Laig;->l:Ljava/lang/Boolean;
    ...
    iput-object v9, v7, Laig;->m:Ljava/lang/Boolean;
    ...
    iput-object v9, v7, Laig;->n:Ljava/lang/Boolean;
    ...
    invoke-static {v9}, Lijf;->d(Ljava/lang/String;)I
    ...
    :pswitch_0
    sget-object v10, Lbig;->d:Lbig;

    goto :goto_a

    :pswitch_1
    sget-object v10, Lbig;->c:Lbig;

    :cond_1b
    :goto_a
    :pswitch_2
    iput-object v10, v7, Laig;->q:Lbig;
    ...
    invoke-static {v9}, Lijf;->c(Ljava/lang/String;)I
    ...
    invoke-static {v9}, Lijf;->e(Ljava/lang/String;)I
    ...
    iput-object v9, v7, Laig;->t:Ljava/lang/Boolean;
    ...
    iput-object v8, v7, Laig;->x:Ljava/lang/Boolean;

    :cond_20
    new-instance v8, Lcig;

    invoke-direct {v8, v7}, Lcig;-><init>(Laig;)V
    ...
    invoke-direct/range {v1 .. v12}, Ldk3;-><init>(JJZLcig;Z[JZLjava/util/ArrayList;Ljava/util/ArrayList;)V
...
.method public final c()I
    ...
    iget-object v1, v1, Lwof;->b:Lhpf;

    sget-object v4, Lhpf;->d:Lhpf;
    ...
    invoke-static {v4, v2, v0}, Lok7;->q(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    iget-wide v4, p0, Ldk3;->d:J

    invoke-virtual {v0, v4, v5}, Lad2;->D(J)Lt92;
...
.method public final e(Lmmf;)V
    ...
    invoke-virtual {v0, v2, v1}, Ly3;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v2}, Lkif;-><init>(Z)V
    ...
    iget-object p1, p1, Lcig;->u:Ljava/lang/Boolean;
    ...
    invoke-virtual {p1, v0, v1}, Ly3;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, p1}, Let;-><init>(Ljava/util/Collection;)V

    iget-object p1, p0, Lzm;->c:Lan;

    iget-object p1, p1, Lan;->w:Lru7;
    ...
    invoke-interface {p1, v0, v1}, Ly96;->D(Ljava/util/List;Ljava/util/Set;)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    :cond_2
    iget-boolean v3, p0, Ldk3;->o:Z

    iget-boolean v4, p1, Ldk3;->o:Z
    ...
    :cond_3
    iget-boolean v3, p0, Ldk3;->Y:Z

    iget-boolean v4, p1, Ldk3;->Y:Z
    ...
    :cond_7
    iget-object p1, p0, Ldk3;->X:Lcig;

    if-eqz p1, :cond_8

    invoke-virtual {p1, v2}, Lcig;->equals(Ljava/lang/Object;)Z
...
.method public final f()[B
    ...
    iget-object v2, p0, Ldk3;->X:Lcig;

    if-nez v2, :cond_0

    new-instance v2, Lbt;

    invoke-direct {v2, v1}, Llpe;-><init>(I)V
    ...
    invoke-direct {v3, v1}, Llpe;-><init>(I)V

    iget-object v4, v2, Lcig;->a:Ljava/lang/Boolean;
    ...
    invoke-virtual {v3, v5, v4}, Llpe;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_1
    iget-object v4, v2, Lcig;->b:Ljava/lang/Long;
    ...
    :cond_2
    iget-object v4, v2, Lcig;->c:Ljava/lang/String;
    ...
    :cond_3
    iget-object v4, v2, Lcig;->d:Ljava/lang/String;
    ...
    :cond_4
    iget-object v4, v2, Lcig;->e:Ljava/lang/String;
    ...
    :cond_5
    iget-object v4, v2, Lcig;->f:Ljava/lang/String;
    ...
    :cond_6
    iget-object v4, v2, Lcig;->g:Ljava/lang/String;
    ...
    :cond_7
    iget-object v4, v2, Lcig;->h:Ljava/lang/Boolean;
    ...
    :cond_8
    iget-object v4, v2, Lcig;->i:Ljava/lang/Integer;
    ...
    :cond_9
    iget-object v4, v2, Lcig;->j:Ljava/lang/Integer;
    ...
    :cond_a
    iget-object v4, v2, Lcig;->k:Ljava/lang/Integer;
    ...
    :cond_b
    iget-object v4, v2, Lcig;->l:Ljava/lang/Boolean;
    ...
    :cond_c
    iget-object v4, v2, Lcig;->m:Ljava/lang/Boolean;
    ...
    :cond_d
    iget-object v4, v2, Lcig;->n:Ljava/lang/Boolean;
    ...
    invoke-static {v4}, Lijf;->k(I)Ljava/lang/String;
    ...
    :cond_10
    iget-object v4, v2, Lcig;->q:Lbig;

    if-eqz v4, :cond_11

    const-string v5, "inactiveTTL"

    iget-object v4, v4, Lbig;->a:Ljava/lang/String;
    ...
    invoke-static {v4}, Lijf;->j(I)Ljava/lang/String;
    ...
    invoke-static {v4}, Lijf;->l(I)Ljava/lang/String;
    ...
    :cond_13
    iget-object v4, v2, Lcig;->t:Ljava/lang/Boolean;
    ...
    :cond_14
    iget-object v2, v2, Lcig;->u:Ljava/lang/Boolean;
    ...
    invoke-virtual {v3, v4, v2}, Llpe;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v8, v7, Lef2;->a:Ljava/lang/String;

    iget-object v9, v7, Lef2;->d:Ljava/util/Set;

    iget-object v10, v7, Lef2;->o:Ljava/util/Set;

    iget-object v11, v7, Lef2;->X:Ljava/util/Set;

    iput-object v8, v6, Lru/ok/tamtam/nano/a;->a:Ljava/lang/String;

    iget-object v8, v7, Lef2;->b:Ljava/lang/String;
    ...
    iget-object v8, v7, Lef2;->c:Ljava/lang/String;
    ...
    iget-object v8, v7, Lef2;->Z:Ljava/util/List;

    invoke-static {v8}, Lug8;->s(Ljava/util/List;)Ljava/util/ArrayList;

    move-result-object v8

    invoke-static {v8}, Lrb9;->c(Ljava/util/List;)Lru/ok/tamtam/nano/Protos$MessageElements;

    move-result-object v8

    iput-object v8, v6, Lru/ok/tamtam/nano/a;->h:Lru/ok/tamtam/nano/Protos$MessageElements;

    iget-wide v8, v7, Lef2;->s0:J

    iput-wide v8, v6, Lru/ok/tamtam/nano/a;->i:J

    iget-object v8, v7, Lef2;->t0:Ljava/util/Map;

    invoke-static {v8}, Ligi;->k(Ljava/util/Map;)Lt96;

    move-result-object v8

    iput-object v8, v6, Lru/ok/tamtam/nano/a;->j:Lt96;

    iget-object v8, v7, Lef2;->u0:Ljava/util/List;

    invoke-static {v8}, Ligi;->m(Ljava/util/List;)Lt96;

    move-result-object v8

    iput-object v8, v6, Lru/ok/tamtam/nano/a;->k:Lt96;

    iget-object v7, v7, Lef2;->v0:Ljava/util/Set;

    invoke-static {v7}, Ligi;->l(Ljava/util/Set;)Lt96;

    move-result-object v7

    iput-object v7, v6, Lru/ok/tamtam/nano/a;->l:Lt96;
...
.method public final h()Lkh;
    ...
    iget-object v6, v1, Lzm;->c:Lan;

    invoke-virtual {v6}, Lan;->c()Lad2;

    move-result-object v6

    invoke-virtual {v6, v2, v3}, Lad2;->D(J)Lt92;
    ...
    invoke-static {v8, v0, v9}, Lcuh;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_1
    iget-object v2, v6, Lt92;->b:Lvd2;

    new-instance v3, Lav2;

    invoke-direct {v3, v7}, Lav2;-><init>(I)V

    invoke-virtual {v2}, Lvd2;->a()Lmd2;

    move-result-object v6

    iget-object v6, v6, Lmd2;->b:Ljava/util/List;

    invoke-static {v6}, Lug8;->m(Ljava/util/List;)Ljava/util/ArrayList;

    move-result-object v6

    iput-object v6, v3, Lav2;->c:Ljava/lang/Object;

    invoke-virtual {v2}, Lvd2;->a()Lmd2;

    move-result-object v6

    iget-wide v10, v6, Lmd2;->a:J

    iput-wide v10, v3, Lav2;->b:J

    invoke-virtual {v2}, Lvd2;->a()Lmd2;

    move-result-object v6

    iget-wide v10, v6, Lmd2;->e:J

    invoke-static {v10, v11}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v6

    iput-object v6, v3, Lav2;->d:Ljava/lang/Object;

    new-instance v6, Lbv2;

    invoke-direct {v6, v3}, Lbv2;-><init>(Lav2;)V

    new-instance v3, Lbt;

    invoke-direct {v3, v7}, Llpe;-><init>(I)V

    iget-wide v10, v2, Lvd2;->a:J

    invoke-static {v10, v11}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v2

    invoke-virtual {v3, v2, v6}, Llpe;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v13, v1, Lzm;->c:Lan;

    invoke-virtual {v13}, Lan;->c()Lad2;

    move-result-object v13

    invoke-virtual {v13, v11, v12}, Lad2;->D(J)Lt92;

    move-result-object v11

    if-eqz v11, :cond_5

    iget-object v12, v11, Lt92;->b:Lvd2;

    invoke-virtual {v11}, Lt92;->E()Z
    ...
    :cond_4
    new-instance v11, Lav2;

    invoke-direct {v11, v7}, Lav2;-><init>(I)V

    invoke-virtual {v12}, Lvd2;->a()Lmd2;

    move-result-object v13

    iget-object v13, v13, Lmd2;->b:Ljava/util/List;

    invoke-static {v13}, Lug8;->m(Ljava/util/List;)Ljava/util/ArrayList;

    move-result-object v13

    iput-object v13, v11, Lav2;->c:Ljava/lang/Object;

    invoke-virtual {v12}, Lvd2;->a()Lmd2;

    move-result-object v13

    iget-wide v13, v13, Lmd2;->a:J

    iput-wide v13, v11, Lav2;->b:J

    new-instance v13, Lbv2;

    invoke-direct {v13, v11}, Lbv2;-><init>(Lav2;)V

    iget-wide v11, v12, Lvd2;->a:J

    invoke-static {v11, v12}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v11

    invoke-virtual {v3, v11, v13}, Llpe;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget v2, v14, Llpe;->c:I

    if-gtz v2, :cond_8

    :cond_7
    iget-object v2, v1, Ldk3;->X:Lcig;
    ...
    iget-object v15, v1, Ldk3;->X:Lcig;
    ...
    invoke-direct/range {v11 .. v16}, Ltl3;-><init>(Ljava/lang/String;Ltr6;Lbt;Lcig;Lmf2;)V
    ...
    invoke-direct {v6, v7}, Let;-><init>(I)V
    ...
    invoke-virtual {v6, v7}, Let;->add(Ljava/lang/Object;)Z
    :try_end_0
    ...
    iget-object v7, v2, Lef2;->a:Ljava/lang/String;
    ...
    new-instance v15, Lmf2;

    invoke-direct {v15, v3, v6}, Lmf2;-><init>(Ljava/util/List;Ljava/util/Set;)V
    ...
    invoke-direct/range {v10 .. v15}, Ltl3;-><init>(Ljava/lang/String;Ltr6;Lbt;Lcig;Lmf2;)V
    ...
    invoke-direct/range {v11 .. v16}, Lbe2;-><init>(Ljava/lang/String;JLtl3;Z)V
...
.method public final j(Lxlf;)V
    ...
    invoke-virtual {v1, v3, v4, v2}, Lad2;->W(JZ)V
    ...
    invoke-virtual {v0, v1}, Lztd;->B(Ljava/lang/String;)V
