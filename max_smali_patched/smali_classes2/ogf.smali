...
.method public constructor <init>(Lqgf;)V
    ...
    invoke-direct {p0}, Ltgf;-><init>()V

    iput-object p1, p0, Logf;->c:Lqgf;
...
# virtual methods
.method public final b(Landroid/graphics/Matrix;Ljgf;ILandroid/graphics/Canvas;)V
    .locals 22
    ...
    iget v10, v4, Lqgf;->d:F

    iget v4, v4, Lqgf;->e:F

    invoke-direct {v7, v8, v9, v10, v4}, Landroid/graphics/RectF;-><init>(FFFF)V

    iget-object v8, v0, Ljgf;->b:Landroid/graphics/Paint;
    ...
    :goto_0
    iget-object v12, v0, Ljgf;->g:Landroid/graphics/Path;

    const/4 v13, 0x3

    const/4 v14, 0x2

    sget-object v19, Ljgf;->k:[I

    if-eqz v9, :cond_1

    aput v11, v19, v11

    iget v11, v0, Ljgf;->f:I

    aput v11, v19, v10

    iget v11, v0, Ljgf;->e:I

    aput v11, v19, v14

    iget v11, v0, Ljgf;->d:I
    ...
    iget-object v0, v0, Ljgf;->h:Landroid/graphics/Paint;
