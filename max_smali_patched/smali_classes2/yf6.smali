...
.field public final u0:Lxsd;


# direct methods
.method public constructor <init>(Lorg/webrtc/EglBase$Context;Landroid/content/Context;Lxsd;Lcwc;)V
    .locals 0

    invoke-direct {p0}, Landroid/media/projection/MediaProjection$Callback;-><init>()V

    iput-object p1, p0, Lyf6;->a:Lorg/webrtc/EglBase$Context;

    iput-object p2, p0, Lyf6;->b:Landroid/content/Context;

    iput-object p4, p0, Lyf6;->c:Lcwc;

    iput-object p3, p0, Lyf6;->u0:Lxsd;
    ...
    iput-object p1, p0, Lyf6;->d:Lu14;

    new-instance p1, Lbvf;

    invoke-direct {p1}, Lbvf;-><init>()V

    iput-object p1, p0, Lyf6;->Z:Lbvf;
...
.method public final b(Lorg/webrtc/Size;I)V
    ...
    iget-boolean v2, p0, Lyf6;->s0:Z

    if-eqz v2, :cond_1

    iget-boolean v2, p0, Lyf6;->t0:Z

    if-nez v2, :cond_1

    :try_start_0
    iget-object v2, p0, Lyf6;->X:Lorg/webrtc/ScreenCapturerAndroid;
    ...
    :goto_0
    iget-object p2, p0, Lyf6;->c:Lcwc;

    invoke-interface {p2, v1, v0, p1}, Lcwc;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p1, p2}, Lu14;->c(Ljava/lang/Runnable;)V

    goto :goto_2

    :goto_1
    iget-object v3, p0, Lyf6;->c:Lcwc;

    invoke-interface {v3, v1, v0, v2}, Lcwc;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    const/16 v0, 0xa

    if-le p2, v0, :cond_0

    iget-object p1, p0, Lyf6;->c:Lcwc;

    const-string v0, "Error: "

    const-string v3, "times of restart screen capture did fail"

    invoke-static {p2, v0, v3}, Lox1;->f(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p2

    invoke-interface {p1, v1, p2, v2}, Lcwc;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final onCapturerStopped()V
    ...
    iget-object v0, p0, Lyf6;->u0:Lxsd;
...
.method public final onFrameCaptured(Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v0, p0, Lyf6;->Z:Lbvf;

    invoke-virtual {v0}, Lbvf;->a()V

    iget-object v0, p0, Lyf6;->Y:Lorg/webrtc/VideoSink;
...
.method public final onStop()V
    ...
    invoke-direct {v0, p0, v1}, Lxf6;-><init>(Lyf6;I)V

    iget-object v1, p0, Lyf6;->d:Lu14;

    invoke-virtual {v1, v0}, Lu14;->c(Ljava/lang/Runnable;)V
