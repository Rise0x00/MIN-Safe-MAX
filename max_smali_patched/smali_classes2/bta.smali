...
.field public final D0:Ln0a;

.field public final E0:Ljava/lang/Object;

.field public final F0:Ljava/lang/Object;

.field public y0:Lzsa;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, Ll53;-><init>(Landroid/content/Context;)V

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lbta;->z0:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lbta;->A0:Landroid/graphics/Rect;
    ...
    invoke-static {v0, v1, v2}, La9b;->a(Landroid/view/View;Landroid/text/TextPaint;Lorf;)V
    ...
    iput-object v0, p0, Lbta;->B0:Landroid/widget/EditText;

    new-instance v5, Ljava/util/LinkedHashMap;

    invoke-direct {v5}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v5, p0, Lbta;->C0:Ljava/util/LinkedHashMap;

    new-instance v5, Ln0a;

    invoke-direct {v5}, Ln0a;-><init>()V

    iput-object v5, p0, Lbta;->D0:Ln0a;
    ...
    iput-object v5, p0, Lbta;->E0:Ljava/lang/Object;

    new-instance v5, Lwaa;

    const/16 v7, 0x19

    invoke-direct {v5, p1, v7, p0}, Lwaa;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-static {v6, v5}, Llci;->i(ILoi6;)Lru7;

    move-result-object p1

    iput-object p1, p0, Lbta;->F0:Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Ll53;->setChipSpacing(I)V

    invoke-virtual {p0, v1}, Ll53;->setSingleLine(Z)V

    invoke-virtual {p0, v3}, Ll53;->setSingleSelection(Z)V
    ...
    invoke-direct {p1, p0}, Lata;-><init>(Lbta;)V
...
.method private final getCancelChipDrawable()Lone/me/sdk/richvector/EnhancedVectorDrawable;
    ...
    iget-object v0, p0, Lbta;->F0:Ljava/lang/Object;
...
.method private final getMaterialThemeWrapper()Landroid/view/ContextThemeWrapper;
    ...
    iget-object v0, p0, Lbta;->E0:Ljava/lang/Object;
...
.method public final a(JJLjava/lang/CharSequence;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lbta;->C0:Ljava/util/LinkedHashMap;
    ...
    invoke-direct {p0}, Lbta;->getMaterialThemeWrapper()Landroid/view/ContextThemeWrapper;
    ...
    invoke-static {v3, v0, v2}, La9b;->a(Landroid/view/View;Landroid/text/TextPaint;Lorf;)V
    ...
    invoke-virtual/range {v2 .. v10}, Lbta;->b(Lcom/google/android/material/chip/Chip;ZJJLjava/lang/CharSequence;Ljava/lang/String;)V
    ...
    invoke-direct/range {v2 .. v10}, Lysa;-><init>(Lbta;Lcom/google/android/material/chip/Chip;JJLjava/lang/CharSequence;Ljava/lang/String;)V
    ...
    iget-object p1, p0, Lbta;->y0:Lzsa;
...
.method public final b(Lcom/google/android/material/chip/Chip;ZJJLjava/lang/CharSequence;Ljava/lang/String;)V
    ...
    invoke-direct {p0}, Lbta;->getCancelChipDrawable()Lone/me/sdk/richvector/EnhancedVectorDrawable;
    ...
    invoke-direct {p2, p0, p3, p4, p1}, Lyd6;-><init>(Lbta;JLcom/google/android/material/chip/Chip;)V

    new-instance p3, Leh1;

    const/4 p4, 0x3

    invoke-direct {p3, p1, p4, p2}, Leh1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    :cond_0
    iget-object p2, p0, Lbta;->D0:Ln0a;

    invoke-virtual {p2, p5, p6}, Ln0a;->d(J)Ljava/lang/Object;

    move-result-object p3

    if-nez p3, :cond_1

    new-instance p3, Lmoa;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p4

    invoke-direct {p3, p4}, Lmoa;-><init>(Landroid/content/Context;)V

    invoke-virtual {p2, p5, p6, p3}, Ln0a;->h(JLjava/lang/Object;)V
    ...
    invoke-static {p7, p2}, Lqii;->a(Ljava/lang/CharSequence;Ljava/lang/Long;)Lqc0;

    move-result-object p2

    invoke-virtual {p3, p2, p8}, Lmoa;->b(Lqc0;Ljava/lang/String;)V
    ...
    :goto_0
    invoke-direct {p0, p1}, Lbta;->setChipStyle(Lcom/google/android/material/chip/Chip;)V
...
.method public final d()V
    ...
    invoke-virtual {p0}, Lbta;->getEditText()Landroid/widget/EditText;

    move-result-object v0

    iget-object v1, p0, Lbta;->z0:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Landroid/view/View;->getHitRect(Landroid/graphics/Rect;)V

    iget-object v0, p0, Lbta;->A0:Landroid/graphics/Rect;
...
.method public final getCallback()Lzsa;
    .locals 1

    iget-object v0, p0, Lbta;->y0:Lzsa;
...
.method public final getEditText()Landroid/widget/EditText;
    ...
    iget-object v0, p0, Lbta;->B0:Landroid/widget/EditText;
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v0, p0, Lbta;->D0:Ln0a;

    invoke-virtual {v0}, Ln0a;->a()V

    iget-object v0, p0, Lbta;->C0:Ljava/util/LinkedHashMap;
...
.method public final onThemeChanged(Lw5b;)V
    ...
    iget-object v1, p0, Lbta;->B0:Landroid/widget/EditText;
    ...
    iget-object p1, p0, Lbta;->C0:Ljava/util/LinkedHashMap;
    ...
    invoke-direct {p0, v0}, Lbta;->setChipStyle(Lcom/google/android/material/chip/Chip;)V

    goto :goto_0

    :cond_0
    iget-object p1, p0, Lbta;->F0:Ljava/lang/Object;
    ...
    invoke-static {p1, v0, v1}, Lpzi;->c(Lxjg;Ljava/lang/String;I)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, p0, Lbta;->A0:Landroid/graphics/Rect;
    ...
    iget-object v0, p0, Lbta;->z0:Landroid/graphics/Rect;
...
.method public final setCallback(Lzsa;)V
    .locals 0

    iput-object p1, p0, Lbta;->y0:Lzsa;
