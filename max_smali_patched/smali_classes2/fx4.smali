...
# direct methods
.method public constructor <init>(ZLq07;Ljava/util/concurrent/ExecutorService;Ly07;IZZZ)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-boolean p1, p0, Lfx4;->a:Z

    iput-object p2, p0, Lfx4;->b:Lq07;

    iput-object p3, p0, Lfx4;->c:Ljava/util/concurrent/ExecutorService;

    iput-object p4, p0, Lfx4;->d:Ly07;
...
# virtual methods
.method public final bridge synthetic a(Landroid/content/Context;Lr41;Lsj3;ZLva2;)Lauh;
    .locals 7
    ...
    invoke-virtual/range {v0 .. v6}, Lfx4;->c(Landroid/content/Context;Lr41;Lsj3;ZLjava/util/concurrent/Executor;Lzth;)Lhx4;
...
.method public final b()Landroidx/media3/effect/DefaultVideoFrameProcessor$Factory$Builder;
    ...
    iget-object v1, p0, Lfx4;->c:Ljava/util/concurrent/ExecutorService;
    ...
    iget-object v1, p0, Lfx4;->b:Lq07;

    iput-object v1, v0, Landroidx/media3/effect/DefaultVideoFrameProcessor$Factory$Builder;->b:Lq07;

    iget-object v1, p0, Lfx4;->d:Ly07;
...
.method public final c(Landroid/content/Context;Lr41;Lsj3;ZLjava/util/concurrent/Executor;Lzth;)Lhx4;
    .locals 12

    iget-object v0, p0, Lfx4;->c:Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct {v2, v3, v4}, Lv85;-><init>(ILjava/io/Serializable;)V
    ...
    invoke-direct {v5, v8, v3}, Lax4;-><init>(Lzth;I)V

    invoke-direct {v6, v11, v4, v5}, Lo42;-><init>(Ljava/util/concurrent/ExecutorService;ZLvth;)V

    iget-object v4, p0, Lfx4;->b:Lq07;
    ...
    invoke-direct {v4, v0, v2}, Lh09;-><init>(IB)V
    ...
    invoke-direct/range {v0 .. v10}, Lex4;-><init>(Lfx4;Landroid/content/Context;Lr41;Lsj3;ZLo42;Ljava/util/concurrent/Executor;Lzth;Lq07;Z)V
