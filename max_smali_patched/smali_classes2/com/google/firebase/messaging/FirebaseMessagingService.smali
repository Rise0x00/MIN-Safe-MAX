...
.method public final b(Landroid/content/Intent;)V
    ...
    invoke-static {v0}, Lzga;->q(Landroid/os/Bundle;)Z
    ...
    invoke-direct {v4, v0}, Lzga;-><init>(Landroid/os/Bundle;)V
    ...
    iput-object v5, v8, Lz3d;->a:Ljava/lang/Object;

    iput-object p0, v8, Lz3d;->b:Ljava/lang/Object;

    iput-object v4, v8, Lz3d;->c:Ljava/lang/Object;

    :try_start_0
    invoke-virtual {v8}, Lz3d;->z()Z
    ...
    invoke-static {p1}, Llfj;->f(Landroid/content/Intent;)Z
    ...
    invoke-static {v4, v5}, Llfj;->d(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-direct {v4, v0}, Lp5e;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {p0, v4}, Lcom/google/firebase/messaging/FirebaseMessagingService;->d(Lp5e;)V
    ...
    :cond_10
    :goto_4
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->X:Luge;
    ...
    invoke-direct {v0, v4}, Luge;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->X:Luge;

    :cond_11
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->X:Luge;

    iget-object v4, v0, Luge;->c:Li4c;

    invoke-virtual {v4}, Li4c;->u()I
    ...
    :cond_14
    iget-object p1, v0, Luge;->b:Landroid/content/Context;
    ...
    invoke-direct {v0, v1, v6, v4, v7}, Lnyj;-><init>(IILandroid/os/Bundle;I)V
