...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 4
    invoke-direct {p0, p1}, Lj5i;-><init>(I)V
...
.method public static K(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldp;IIZ)V
    .locals 7
    ...
    invoke-virtual {p1, p2}, Ldp;->g(Landroid/view/View;)Z

    move-result v3

    :cond_4
    invoke-virtual {p1, v3}, Ldp;->f(Z)Z
    ...
    iget-object p0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:Ln5b;

    iget-object p0, p0, Ln5b;->c:Ljava/lang/Object;

    check-cast p0, Lhpf;

    invoke-virtual {p0, p1}, Lhpf;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public B(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldp;Landroid/view/View;II[II)V
    .locals 6
    ...
    invoke-virtual {p2}, Ldp;->getTotalScrollRange()I

    move-result p4

    neg-int p4, p4

    invoke-virtual {p2}, Ldp;->getDownNestedPreScrollRange()I
    ...
    :cond_0
    invoke-virtual {p2}, Ldp;->getUpNestedPreScrollRange()I
    ...
    :goto_2
    iget-boolean p1, v2, Ldp;->F0:Z

    if-eqz p1, :cond_2

    invoke-virtual {v2, p3}, Ldp;->g(Landroid/view/View;)Z

    move-result p1

    invoke-virtual {v2, p1}, Ldp;->f(Z)Z

    :cond_2
    return-void
.end method

.method public C(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldp;Landroid/view/View;IIIII[I)V
    .locals 6

    if-gez p7, :cond_0

    invoke-virtual {p2}, Ldp;->getDownNestedScrollRange()I
    ...
    invoke-static {v1}, Lj4i;->c(Landroid/view/View;)Landroid/view/View$AccessibilityDelegate;
    ...
    invoke-direct {p1, p0, v2, v1}, Lyo;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Ldp;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    invoke-static {v1, p1}, Lj4i;->m(Landroid/view/View;Lb5;)V
...
.method public D(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldp;Landroid/view/View;Landroid/view/View;II)Z
    .locals 0
...
.method public E(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldp;Landroid/view/View;I)V
    .locals 1
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->J(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldp;)V

    iget-boolean p1, p2, Ldp;->F0:Z

    if-eqz p1, :cond_1

    invoke-virtual {p2, p3}, Ldp;->g(Landroid/view/View;)Z

    move-result p1

    invoke-virtual {p2, p1}, Ldp;->f(Z)Z
...
.method public final F(Lzo;Z)V
    .locals 1

    iget-object v0, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lzo;
    ...
    :cond_1
    :goto_0
    iput-object p1, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lzo;

    return-void
.end method

.method public final G(Landroid/os/Parcelable;Ldp;)Lzo;
    .locals 7
    ...
    invoke-virtual {p2}, Ldp;->getTopInset()I
...
.method public final H(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)I
    ...
    invoke-static/range {p3 .. p5}, Lsr6;->r(III)I

    move-result v2

    if-eq v4, v2, :cond_d

    iget-boolean v6, v3, Ldp;->o:Z
    ...
    iget-object v11, v10, Lbp;->c:Landroid/view/animation/Interpolator;
    ...
    invoke-virtual {v3}, Ldp;->getTopInset()I
    ...
    :goto_2
    invoke-virtual {v0, v8}, Lj5i;->v(I)Z
    ...
    iget-object v11, v10, Lbp;->b:Li9c;

    if-eqz v11, :cond_7

    iget v10, v10, Lbp;->a:I
    ...
    invoke-virtual {v0}, Lj5i;->t()I

    move-result v12

    int-to-float v12, v12

    iget-object v13, v11, Li9c;->b:Ljava/lang/Object;

    check-cast v13, Landroid/graphics/Rect;

    iget-object v11, v11, Li9c;->a:Ljava/lang/Object;
    ...
    invoke-static {v15, v12, v8}, Lsr6;->q(FFF)F
    ...
    iget-object v6, v1, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:Ln5b;

    iget-object v6, v6, Ln5b;->c:Ljava/lang/Object;

    check-cast v6, Lhpf;

    invoke-virtual {v6, v3}, Lhpf;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v10, v1, v9, v3}, Lnb4;->d(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-virtual {v3, v6}, Ldp;->d(I)V
    ...
    :goto_7
    invoke-static {v1, v3, v2, v8, v5}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->K(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldp;IIZ)V
    ...
    invoke-direct {v2, v0, v3, v1}, Lyo;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Ldp;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    invoke-static {v1, v2}, Lj4i;->m(Landroid/view/View;Lb5;)V
...
.method public final J(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldp;)V
    .locals 12
    ...
    invoke-static {v8, v0, v3}, Lsr6;->r(III)I

    move-result v0

    invoke-virtual {p0, p1, p2, v0}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->y(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldp;I)V
...
.method public final h(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    invoke-super {p0, p1, p2, p3}, Lj5i;->h(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z

    invoke-virtual {p2}, Ldp;->getPendingAction()I
    ...
    iget-object v3, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lzo;

    iget-boolean v3, v3, Lzo;->Y:Z
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->y(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldp;I)V
    ...
    invoke-virtual {p0, p1, p2, v1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->y(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldp;I)V
    ...
    iput-object p3, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lzo;
    ...
    invoke-static {p3, v0, v1}, Lsr6;->r(III)I

    move-result p3

    invoke-virtual {p0, p3}, Lj5i;->v(I)Z

    invoke-virtual {p0}, Lj5i;->t()I

    move-result p3

    invoke-static {p1, p2, p3, v1, v2}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->K(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldp;IIZ)V

    invoke-virtual {p0}, Lj5i;->t()I

    move-result p3

    invoke-virtual {p2, p3}, Ldp;->d(I)V
    ...
    invoke-direct {p3, p0, p2, p1}, Lyo;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Ldp;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    invoke-static {p1, p3}, Lj4i;->m(Landroid/view/View;Lb5;)V
...
.method public bridge synthetic k(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;II[II)V
    ...
    invoke-virtual/range {p0 .. p7}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->B(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldp;Landroid/view/View;II[II)V
...
.method public bridge synthetic l(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;IIIII[I)V
    ...
    invoke-virtual/range {p0 .. p9}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->C(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldp;Landroid/view/View;IIIII[I)V
...
.method public final n(Landroid/view/View;Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, p2, p1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->F(Lzo;Z)V

    iget-object p1, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lzo;
...
.method public final o(Landroid/view/View;)Landroid/os/Parcelable;
    ...
    invoke-virtual {p0, v0, p1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->G(Landroid/os/Parcelable;Ldp;)Lzo;
...
.method public bridge synthetic q(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;Landroid/view/View;II)Z
    ...
    invoke-virtual/range {p0 .. p6}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->D(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldp;Landroid/view/View;Landroid/view/View;II)Z
...
.method public bridge synthetic r(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->E(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldp;Landroid/view/View;I)V
...
.method public final s(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v1}, Ldp;->getDownNestedScrollRange()I

    move-result v3

    neg-int v3, v3

    invoke-virtual {v1}, Ldp;->getTopInset()I
    ...
    invoke-virtual {v3}, Ldp;->getTotalScrollRange()I

    move-result v4

    neg-int v4, v4

    iget-object v5, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->c:Ldyh;

    if-eqz v5, :cond_5

    invoke-virtual {v2, v5}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iput-object v7, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->c:Ldyh;
    ...
    invoke-direct/range {v0 .. v5}, Ldyh;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Z)V
    ...
    iput-object v1, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->c:Ldyh;
    ...
    invoke-virtual {v0, v1, v3}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->J(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldp;)V

    iget-boolean v2, v3, Ldp;->F0:Z
    ...
    invoke-virtual {v3, v1}, Ldp;->g(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v3, v1}, Ldp;->f(Z)Z
...
.method public final y(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldp;I)V
    .locals 5
    ...
    sget-object v3, Lni;->e:Landroid/view/animation/DecelerateInterpolator;
    ...
    invoke-direct {v3, p0, p1, p2, v4}, Lxo;-><init>(Ljava/lang/Object;Landroid/view/View;Landroid/view/View;I)V
