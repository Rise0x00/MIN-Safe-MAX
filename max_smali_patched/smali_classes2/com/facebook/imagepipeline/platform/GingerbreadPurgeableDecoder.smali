...
.method public static g(Lug3;I[B)Landroid/os/MemoryFile;
    .locals 8
    ...
    invoke-direct {v1, v4}, Lepc;-><init>(Leo9;)V
    :try_end_0
    ...
    invoke-direct {v4, v1, p1}, Lgd8;-><init>(Ljava/io/InputStream;I)V
    :try_end_1
    ...
    invoke-static {v1}, Lwg3;->b(Ljava/io/InputStream;)V

    invoke-static {v4}, Lwg3;->b(Ljava/io/InputStream;)V

    invoke-static {v3}, Lwg3;->a(Ljava/io/Closeable;)V
    ...
    invoke-static {p2}, Lwg3;->a(Ljava/io/Closeable;)V
...
.method public final c(Lug3;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, p1, v0, v1, p2}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->h(Lug3;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public final d(Lug3;ILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, v0, p3}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->h(Lug3;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public final h(Lug3;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 1

    const/4 v0, 0x0

    :try_start_0
    invoke-static {p1, p2, p3}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->g(Lug3;I[B)Landroid/os/MemoryFile;
    ...
    invoke-static {p2, p3}, Lsr6;->o(Ljava/lang/Object;Ljava/lang/String;)V
    :try_end_1
    ...
    :goto_0
    :try_start_3
    invoke-static {p2}, Lmyj;->c(Ljava/lang/Throwable;)V
...
.method public final i(Landroid/os/MemoryFile;)Ljava/io/FileDescriptor;
    ...
    :try_start_3
    invoke-static {p1}, Lmyj;->c(Ljava/lang/Throwable;)V
