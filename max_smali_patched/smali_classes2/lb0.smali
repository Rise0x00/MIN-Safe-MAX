...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Llb0;->m:J

    return-void
.end method

.method public constructor <init>(Lye0;Landroid/content/Context;)V
    .locals 10
    ...
    invoke-static {v0, p1, p2}, Llb0;->b(ILye0;Landroid/content/Context;)Landroid/media/AudioRecord;
...
.method public static b(ILye0;Landroid/content/Context;)Landroid/media/AudioRecord;
    .locals 5
...
.method public final a()V
    ...
    iget-object v0, p0, Llb0;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final c(Z)V
    ...
    iget-object v0, p0, Llb0;->i:Ls2f;

    iget-object v1, p0, Llb0;->h:Lhfe;

    if-eqz v0, :cond_0

    if-eqz v1, :cond_0

    iget-object v2, p0, Llb0;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v2, v1, p1, v3}, Lok;-><init>(Ljava/lang/Object;ZI)V
...
.method public final d()V
    ...
    invoke-static {v0}, Lym;->c(Landroid/media/AudioRecord;)Landroid/media/AudioRecordingConfiguration;

    move-result-object v0

    if-eqz v0, :cond_3

    invoke-static {v0}, Lym;->f(Landroid/media/AudioRecordingConfiguration;)Z
...
.method public final read(Ljava/nio/ByteBuffer;)Lbf0;
    .locals 13
    ...
    invoke-static {v11, v9}, Lvfa;->h(Ljava/lang/String;Z)V
    ...
    invoke-static {v9, v6}, Lvfa;->h(Ljava/lang/String;Z)V

    iget-wide v11, p1, Landroid/media/AudioTimestamp;->framePosition:J

    sub-long/2addr v7, v11

    invoke-static {v5, v7, v8}, Loij;->a(IJ)J
    ...
    invoke-static {p1, v1}, Lw8g;->l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, v5, v6}, Loij;->d(IJ)J
    ...
    invoke-direct {p1, v0, v1, v2}, Lbf0;-><init>(IJ)V
