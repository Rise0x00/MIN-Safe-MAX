...
.method static constructor <clinit>()V
    ...
    sput-object v3, Lplg;->C0:[Les7;

    new-instance v0, Landroid/text/TextPaint;

    invoke-direct {v0}, Landroid/text/TextPaint;-><init>()V

    sput-object v0, Lplg;->D0:Landroid/text/TextPaint;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v2, p0, Lplg;->t0:Ljava/lang/Object;
    ...
    iput v2, p0, Lplg;->u0:I

    new-instance v2, Lolg;

    const/4 v3, 0x1

    invoke-direct {v2, p0, v3}, Lolg;-><init>(Lplg;I)V

    iput-object v2, p0, Lplg;->v0:Lolg;
    ...
    iput-object v2, p0, Lplg;->w0:Lolg;
    ...
    iput-object v2, p0, Lplg;->x0:Lolg;

    new-instance v3, Le5f;

    const/16 v4, 0x16

    invoke-direct {v3, v4}, Le5f;-><init>(I)V

    invoke-static {v1, v3}, Llci;->i(ILoi6;)Lru7;

    move-result-object v1

    iput-object v1, p0, Lplg;->A0:Ljava/lang/Object;

    new-instance v1, Lolg;

    const/4 v3, 0x0

    invoke-direct {v1, p0, v3}, Lolg;-><init>(Lplg;I)V

    iput-object v1, p0, Lplg;->B0:Lolg;
    ...
    sget-object v3, Lplg;->D0:Landroid/text/TextPaint;

    invoke-virtual {v3, v1}, Landroid/graphics/Paint;->setAntiAlias(Z)V

    sget-object v1, Lsw2;->d:Lorf;

    sget-object v4, Lx45;->b:Lx45;

    invoke-virtual {v1, v4}, Lorf;->e(Lx45;)J

    move-result-wide v4

    invoke-static {v4, v5, p1}, Lbu4;->b(JLandroid/content/Context;)F

    move-result v4

    invoke-virtual {v3, v4}, Landroid/graphics/Paint;->setTextSize(F)V

    iget-wide v4, v1, Lorf;->e:J
    ...
    iget-object p1, v1, Lorf;->f:Ljava/lang/String;
    ...
    sget-object p1, Lplg;->C0:[Les7;

    const/4 v1, 0x2

    aget-object p1, p1, v1

    iget-object p1, v2, Ladi;->b:Ljava/lang/Object;
    ...
    invoke-direct {p0}, Lplg;->getDrawableColor()I

    move-result v0

    invoke-virtual {p1, v0}, Landroid/graphics/drawable/Drawable;->setTint(I)V

    iput-object p1, p0, Lplg;->y0:Landroid/graphics/drawable/Drawable;

    :cond_0
    return-void
.end method

.method public static final synthetic a(Lplg;)I
    .locals 0
...
.method public static final synthetic b(Lplg;)Landroid/text/BoringLayout$Metrics;
    .locals 0

    invoke-direct {p0}, Lplg;->getMetrics()Landroid/text/BoringLayout$Metrics;
...
.method private final getBackgroundColor()I
    ...
    sget-object v1, Lplg;->C0:[Les7;

    const/4 v2, 0x1

    aget-object v1, v1, v2

    iget-object v1, p0, Lplg;->w0:Lolg;
...
.method private final getMetrics()Landroid/text/BoringLayout$Metrics;
    ...
    iget-object v0, p0, Lplg;->A0:Ljava/lang/Object;
...
.method private final getText()Ljava/lang/CharSequence;
    ...
    sget-object v0, Lplg;->C0:[Les7;

    const/4 v1, 0x3

    aget-object v0, v0, v1

    iget-object v0, p0, Lplg;->B0:Lolg;
...
.method private final setText(Ljava/lang/CharSequence;)V
    ...
    iget-object v1, p0, Lplg;->B0:Lolg;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lplg;->z0:Landroid/text/Layout;
    ...
    sget-object v3, Lplg;->C0:[Les7;

    const/4 v4, 0x0

    aget-object v3, v3, v4

    iget-object v3, p0, Lplg;->v0:Lolg;
    ...
    iget-object v3, p0, Lplg;->t0:Ljava/lang/Object;
    ...
    invoke-direct {p0}, Lplg;->getBackgroundColor()I
    ...
    iget-object p1, p0, Lplg;->y0:Landroid/graphics/drawable/Drawable;
...
.method public final onMeasure(II)V
    ...
    iget-object p1, p0, Lplg;->z0:Landroid/text/Layout;
    ...
    :goto_0
    iget-object v1, p0, Lplg;->y0:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p2, p0, Lplg;->v0:Lolg;
...
.method public final setBackgroundEnabled(Z)V
    ...
    iget-object v1, p0, Lplg;->v0:Lolg;
...
.method public final setContent(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0, p1}, Lplg;->setText(Ljava/lang/CharSequence;)V
...
.method public final setDrawableEnabled(Z)V
    ...
    iget-object v1, p0, Lplg;->x0:Lolg;
