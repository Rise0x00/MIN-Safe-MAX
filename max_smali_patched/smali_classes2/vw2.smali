...
# direct methods
.method public constructor <init>(JJJILjava/lang/String;ZLjava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;Lq10;Ljava/lang/Long;ZJ)V
    .locals 0

    invoke-direct/range {p0 .. p2}, Lzm;-><init>(J)V

    iput-wide p3, p0, Lvw2;->d:J

    iput-wide p5, p0, Lvw2;->o:J

    iput p7, p0, Lvw2;->X:I

    iput-object p8, p0, Lvw2;->Y:Ljava/lang/String;

    iput-boolean p9, p0, Lvw2;->Z:Z

    iput-object p10, p0, Lvw2;->s0:Ljava/lang/String;

    iput-object p11, p0, Lvw2;->t0:Ljava/util/Map;

    iput-object p12, p0, Lvw2;->u0:Ljava/lang/String;

    iput-object p13, p0, Lvw2;->v0:Ljava/lang/String;

    iput-object p14, p0, Lvw2;->w0:Lq10;

    iput-object p15, p0, Lvw2;->x0:Ljava/lang/Long;

    move/from16 p1, p16

    iput-boolean p1, p0, Lvw2;->y0:Z

    move-wide/from16 p1, p17

    iput-wide p1, p0, Lvw2;->z0:J
...
.method public final e(Lmmf;)V
    ...
    iget-object v0, p1, Lww2;->c:Lu92;

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lvw2;->t()V
...
.method public final f()[B
    ...
    iget-wide v1, p0, Lvw2;->o:J

    iput-wide v1, v0, Lru/ok/tamtam/nano/Tasks$ChatUpdate;->chatServerId:J

    const/4 v1, 0x1

    iget-object v2, p0, Lvw2;->u0:Ljava/lang/String;
    ...
    :goto_0
    iget-object v2, p0, Lvw2;->v0:Ljava/lang/String;
    ...
    :goto_1
    iget-object v2, p0, Lvw2;->w0:Lq10;
    ...
    :cond_2
    iget-object v2, p0, Lvw2;->x0:Ljava/lang/Long;
    ...
    :goto_2
    iget-boolean v2, p0, Lvw2;->y0:Z

    iput-boolean v2, v0, Lru/ok/tamtam/nano/Tasks$ChatUpdate;->notifyPin:Z

    iget-object v2, p0, Lvw2;->s0:Ljava/lang/String;
...
.method public final h()Lkh;
    ...
    iget-object v1, v0, Lvw2;->x0:Ljava/lang/Long;
    ...
    :goto_1
    iget-boolean v14, v0, Lvw2;->y0:Z

    iget-wide v3, v0, Lvw2;->z0:J

    move-wide v15, v3

    iget-wide v3, v0, Lvw2;->o:J

    iget-object v6, v0, Lvw2;->Y:Ljava/lang/String;

    iget-boolean v7, v0, Lvw2;->Z:Z

    iget-object v8, v0, Lvw2;->s0:Ljava/lang/String;

    iget-object v9, v0, Lvw2;->t0:Ljava/util/Map;

    iget-object v10, v0, Lvw2;->u0:Ljava/lang/String;

    iget-object v11, v0, Lvw2;->v0:Ljava/lang/String;

    iget-object v12, v0, Lvw2;->w0:Lq10;

    invoke-direct/range {v2 .. v16}, Lbe2;-><init>(JILjava/lang/String;ZLjava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;Lq10;Ljava/lang/Long;ZJ)V
...
.method public final j(Lxlf;)V
    ...
    iget-object v0, p0, Lvw2;->u0:Ljava/lang/String;

    if-nez v0, :cond_0

    iget-object v0, p0, Lvw2;->v0:Ljava/lang/String;

    if-nez v0, :cond_0

    iget-object v0, p0, Lvw2;->x0:Ljava/lang/Long;

    if-nez v0, :cond_0

    iget-object v0, p0, Lvw2;->s0:Ljava/lang/String;

    if-eqz v0, :cond_1

    :cond_0
    invoke-virtual {p0}, Lvw2;->d()V
