...
.method public static a(Lrl7;)V
    .locals 15

    invoke-static {p0}, Landroidx/camera/core/ImageProcessingUtil;->h(Lrl7;)Z
    ...
    invoke-static {v1, p0}, Lw8g;->e(Ljava/lang/String;Ljava/lang/String;)V

    return-void

    :cond_0
    invoke-interface {p0}, Lrl7;->getWidth()I

    move-result v10

    invoke-interface {p0}, Lrl7;->getHeight()I

    move-result v11

    invoke-interface {p0}, Lrl7;->v()[Lql7;
    ...
    invoke-interface {p0}, Lql7;->getBuffer()Ljava/nio/ByteBuffer;
...
.method public static b(Lx29;[B)Lrl7;
    .locals 2

    invoke-virtual {p0}, Lx29;->f()I
    ...
    invoke-virtual {p0}, Lx29;->getSurface()Landroid/view/Surface;
    ...
    invoke-static {v0, p0}, Lw8g;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static c(Lrl7;)Landroid/graphics/Bitmap;
    .locals 14

    invoke-interface {p0}, Lrl7;->getFormat()I
    ...
    invoke-interface {v1}, Lql7;->getBuffer()Ljava/nio/ByteBuffer;
...
.method public static d(Lrl7;Ltl7;Ljava/nio/ByteBuffer;IZ)Lij7;
    .locals 22

    invoke-static/range {p0 .. p0}, Landroidx/camera/core/ImageProcessingUtil;->h(Lrl7;)Z
    ...
    :cond_1
    invoke-interface/range {p1 .. p1}, Ltl7;->getSurface()Landroid/view/Surface;

    move-result-object v13

    invoke-interface/range {p0 .. p0}, Lrl7;->getWidth()I

    move-result v15

    invoke-interface/range {p0 .. p0}, Lrl7;->getHeight()I

    move-result v16

    invoke-interface/range {p0 .. p0}, Lrl7;->v()[Lql7;
    ...
    invoke-interface {v7}, Lql7;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    :cond_6
    invoke-interface/range {p1 .. p1}, Ltl7;->d()Lrl7;
    ...
    invoke-direct {v1, v0}, Lij7;-><init>(Lrl7;)V
    ...
    invoke-direct {v2, v0, v4, v3}, Lnl7;-><init>(Lrl7;Lrl7;I)V

    invoke-virtual {v1, v2}, Lyn6;->d(Lxn6;)V
...
.method public static i(Lrl7;Ltl7;Landroid/media/ImageWriter;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;I)Lij7;
    .locals 25
    ...
    invoke-interface {v10}, Lql7;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v11}, Lql7;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v12}, Lql7;->getBuffer()Ljava/nio/ByteBuffer;
...
.method public static j(Lrl7;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;I)Lij7;
    .locals 25
    ...
    invoke-interface {v4}, Lql7;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v5}, Lql7;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v6}, Lql7;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-static {v0, v1}, Lw8g;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct/range {v6 .. v12}, Lpl7;-><init>(Lrl7;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;II)V

    invoke-direct {v0, v6}, Lij7;-><init>(Lrl7;)V
...
.method public static k([BLandroid/view/Surface;)V
    ...
    invoke-static {p0, p1}, Lw8g;->e(Ljava/lang/String;Ljava/lang/String;)V
