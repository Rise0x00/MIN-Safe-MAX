...
.method public final D(IILandroid/content/Intent;)V
    ...
    invoke-direct {p1, p2, p3}, Luu0;-><init>(Lvu0;I)V

    invoke-virtual {p0, p1}, Landroidx/biometric/BiometricFragment;->r0(Luu0;)V

    return-void

    :cond_0
    sget p1, Llnd;->generic_error_user_canceled:I
...
.method public final G(Landroid/os/Bundle;)V
    ...
    iget-object p1, v4, Landroidx/biometric/BiometricViewModel;->o:Lyha;
    ...
    iput-object p1, v4, Landroidx/biometric/BiometricViewModel;->o:Lyha;
    ...
    invoke-direct {v0, p0, v1}, Lku0;-><init>(Landroidx/biometric/BiometricFragment;I)V

    invoke-virtual {p1, p0, v0}, Lvj8;->e(Lad8;Lc3b;)V

    iget-object p1, p0, Landroidx/biometric/BiometricFragment;->p1:Landroidx/biometric/BiometricViewModel;

    iget-object v0, p1, Landroidx/biometric/BiometricViewModel;->p:Lyha;
    ...
    iput-object v0, p1, Landroidx/biometric/BiometricViewModel;->p:Lyha;

    :cond_4
    iget-object p1, p1, Landroidx/biometric/BiometricViewModel;->p:Lyha;
    ...
    iget-object v0, p1, Landroidx/biometric/BiometricViewModel;->q:Lyha;
    ...
    iput-object v0, p1, Landroidx/biometric/BiometricViewModel;->q:Lyha;

    :cond_5
    iget-object p1, p1, Landroidx/biometric/BiometricViewModel;->q:Lyha;
    ...
    iget-object v0, p1, Landroidx/biometric/BiometricViewModel;->r:Lyha;
    ...
    iput-object v0, p1, Landroidx/biometric/BiometricViewModel;->r:Lyha;

    :cond_6
    iget-object p1, p1, Landroidx/biometric/BiometricViewModel;->r:Lyha;
    ...
    iget-object v0, p1, Landroidx/biometric/BiometricViewModel;->s:Lyha;
    ...
    iput-object v0, p1, Landroidx/biometric/BiometricViewModel;->s:Lyha;

    :cond_7
    iget-object p1, p1, Landroidx/biometric/BiometricViewModel;->s:Lyha;
...
.method public final V()V
    ...
    invoke-direct {v0, v1, v2}, Lqu0;-><init>(Landroidx/biometric/BiometricViewModel;I)V
...
.method public final j0(I)V
    ...
    invoke-static {p1, v0}, Llzj;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    iget-object v0, p1, Landroidx/biometric/BiometricViewModel;->f:Li9c;
    ...
    iput-object v0, p1, Landroidx/biometric/BiometricViewModel;->f:Li9c;

    :cond_2
    iget-object p1, p1, Landroidx/biometric/BiometricViewModel;->f:Li9c;

    iget-object v0, p1, Li9c;->a:Ljava/lang/Object;
    ...
    :try_start_0
    invoke-static {v0}, Lvb2;->a(Landroid/os/CancellationSignal;)V
    :try_end_0
    ...
    :goto_0
    iput-object v1, p1, Li9c;->a:Ljava/lang/Object;
    ...
    :goto_1
    iput-object v1, p1, Li9c;->b:Ljava/lang/Object;
...
.method public final k0()V
    ...
    invoke-direct {v3, v0}, Lwj0;-><init>(Landroidx/fragment/app/c;)V

    invoke-virtual {v3, p0}, Lwj0;->h(Landroidx/fragment/app/a;)V
    ...
    :cond_1
    sget v4, Ldfd;->delay_showing_prompt_models:I
    ...
    invoke-direct {v1, v0, v2}, Lqu0;-><init>(Landroidx/biometric/BiometricViewModel;I)V
...
.method public final l0()V
    ...
    invoke-direct {v1, v0}, Lwj0;-><init>(Landroidx/fragment/app/c;)V

    invoke-virtual {v1, v2}, Lwj0;->h(Landroidx/fragment/app/a;)V

    invoke-virtual {v1, v4}, Lwj0;->d(Z)I
...
.method public final n0()Z
    ...
    iget-object v5, v5, Landroidx/biometric/BiometricViewModel;->d:Lvu0;
    ...
    :cond_0
    sget v0, Ldfd;->crypto_fingerprint_fallback_vendors:I
    ...
    :cond_3
    :goto_1
    sget v0, Ldfd;->crypto_fingerprint_fallback_prefixes:I
    ...
    invoke-static {v0}, Ljyb;->a(Landroid/content/pm/PackageManager;)Z
...
.method public final o0()V
    ...
    :cond_0
    invoke-static {v0}, Lk98;->a(Landroid/content/Context;)Landroid/app/KeyguardManager;

    move-result-object v0

    if-nez v0, :cond_1

    sget v0, Llnd;->generic_error_no_keyguard:I
    ...
    iget-object v2, v1, Landroidx/biometric/BiometricViewModel;->c:Lal8;
    ...
    :goto_1
    invoke-static {v0, v2, v1}, Llu0;->a(Landroid/app/KeyguardManager;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Landroid/content/Intent;

    move-result-object v0

    if-nez v0, :cond_4

    sget v0, Llnd;->generic_error_no_device_credential:I
...
.method public final q0(ILjava/lang/CharSequence;)V
    ...
    invoke-direct {v1, p0, p1, p2}, Lju0;-><init>(Landroidx/biometric/BiometricFragment;ILjava/lang/CharSequence;)V
...
.method public final r0(Luu0;)V
    ...
    invoke-direct {v1, p0, p1, v3, v2}, Lpu6;-><init>(Ljava/lang/Object;Ljava/lang/Object;ZI)V
...
.method public final t0()V
    ...
    invoke-direct {v5, v0, v6}, Ltu0;-><init>(Landroid/content/Context;Z)V
    ...
    invoke-static {v0, v6}, Llzj;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_4
    sget v8, Ldfd;->hide_fingerprint_instantly_prefixes:I
    ...
    invoke-direct {v6, p0, v8}, Lju0;-><init>(Landroidx/biometric/BiometricFragment;I)V
    ...
    iget-object v6, v6, Landroidx/biometric/BiometricViewModel;->d:Lvu0;
    ...
    :cond_8
    iget-object v7, v6, Lvu0;->b:Ljavax/crypto/Cipher;

    if-eqz v7, :cond_9

    new-instance v3, Lz3d;

    invoke-direct {v3, v7}, Lz3d;-><init>(Ljavax/crypto/Cipher;)V

    goto :goto_4

    :cond_9
    iget-object v7, v6, Lvu0;->a:Ljava/security/Signature;

    if-eqz v7, :cond_a

    new-instance v3, Lz3d;

    invoke-direct {v3, v7}, Lz3d;-><init>(Ljava/security/Signature;)V

    goto :goto_4

    :cond_a
    iget-object v7, v6, Lvu0;->c:Ljavax/crypto/Mac;

    if-eqz v7, :cond_b

    new-instance v3, Lz3d;

    invoke-direct {v3, v7}, Lz3d;-><init>(Ljavax/crypto/Mac;)V
    ...
    iget-object v4, v6, Lvu0;->d:Landroid/security/identity/IdentityCredential;
    ...
    iget-object v6, v4, Landroidx/biometric/BiometricViewModel;->f:Li9c;
    ...
    iput-object v6, v4, Landroidx/biometric/BiometricViewModel;->f:Li9c;

    :cond_d
    iget-object v4, v4, Landroidx/biometric/BiometricViewModel;->f:Li9c;
    ...
    invoke-direct {v6, v7}, Laz0;-><init>(I)V
    ...
    iget-object v7, v6, Landroidx/biometric/BiometricViewModel;->e:Lqn8;
    ...
    invoke-direct {v8, v6}, Lyu0;-><init>(Landroidx/biometric/BiometricViewModel;)V

    invoke-direct {v7, v8}, Lqn8;-><init>(Lyu0;)V

    iput-object v7, v6, Landroidx/biometric/BiometricViewModel;->e:Lqn8;

    :cond_f
    iget-object v6, v6, Landroidx/biometric/BiometricViewModel;->e:Lqn8;

    iget-object v7, v6, Lqn8;->c:Ljava/lang/Object;
    ...
    invoke-direct {v7, v8, v6}, Lxq0;-><init>(ILjava/lang/Object;)V

    iput-object v7, v6, Lqn8;->c:Ljava/lang/Object;

    :cond_10
    iget-object v6, v6, Lqn8;->c:Ljava/lang/Object;

    check-cast v6, Lxq0;

    :try_start_0
    invoke-virtual {v5, v3, v4, v6}, Ltu0;->a(Lz3d;Laz0;Lxq0;)V
    :try_end_0
    .catch Ljava/lang/NullPointerException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v0, v2}, Llzj;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {v0}, Lmu0;->d(Landroid/content/Context;)Landroid/hardware/biometrics/BiometricPrompt$Builder;

    move-result-object v0

    iget-object v5, p0, Landroidx/biometric/BiometricFragment;->p1:Landroidx/biometric/BiometricViewModel;

    iget-object v6, v5, Landroidx/biometric/BiometricViewModel;->c:Lal8;

    if-eqz v6, :cond_12

    iget-object v6, v6, Lal8;->b:Ljava/lang/Object;
    ...
    iget-object v5, v5, Landroidx/biometric/BiometricViewModel;->c:Lal8;

    if-eqz v5, :cond_13

    iget-object v5, v5, Lal8;->c:Ljava/lang/Object;
    ...
    invoke-static {v0, v6}, Lmu0;->g(Landroid/hardware/biometrics/BiometricPrompt$Builder;Ljava/lang/CharSequence;)V

    :cond_14
    if-eqz v5, :cond_15

    invoke-static {v0, v5}, Lmu0;->e(Landroid/hardware/biometrics/BiometricPrompt$Builder;Ljava/lang/CharSequence;)V
    ...
    iget-object v3, v5, Lal8;->d:Ljava/lang/Object;
    ...
    invoke-direct {v5, v6}, La87;-><init>(I)V

    iget-object v6, p0, Landroidx/biometric/BiometricFragment;->p1:Landroidx/biometric/BiometricViewModel;

    iget-object v8, v6, Landroidx/biometric/BiometricViewModel;->g:Lzu0;

    if-nez v8, :cond_19

    new-instance v8, Lzu0;

    invoke-direct {v8, v6}, Lzu0;-><init>(Landroidx/biometric/BiometricViewModel;)V

    iput-object v8, v6, Landroidx/biometric/BiometricViewModel;->g:Lzu0;

    :cond_19
    iget-object v6, v6, Landroidx/biometric/BiometricViewModel;->g:Lzu0;

    invoke-static {v0, v3, v5, v6}, Lmu0;->f(Landroid/hardware/biometrics/BiometricPrompt$Builder;Ljava/lang/CharSequence;Ljava/util/concurrent/Executor;Landroid/content/DialogInterface$OnClickListener;)V
    ...
    invoke-static {v0, v2}, Lnu0;->a(Landroid/hardware/biometrics/BiometricPrompt$Builder;Z)V
    ...
    invoke-static {v0, v6}, Lou0;->a(Landroid/hardware/biometrics/BiometricPrompt$Builder;I)V
    ...
    invoke-static {v6}, Lwij;->a(I)Z

    move-result v3

    invoke-static {v0, v3}, Lnu0;->b(Landroid/hardware/biometrics/BiometricPrompt$Builder;Z)V

    :cond_1d
    :goto_8
    invoke-static {v0}, Lmu0;->c(Landroid/hardware/biometrics/BiometricPrompt$Builder;)Landroid/hardware/biometrics/BiometricPrompt;
    ...
    iget-object v4, v4, Landroidx/biometric/BiometricViewModel;->d:Lvu0;

    invoke-static {v4}, Lqrj;->c(Lvu0;)Landroid/hardware/biometrics/BiometricPrompt$CryptoObject;

    move-result-object v4

    iget-object v5, p0, Landroidx/biometric/BiometricFragment;->p1:Landroidx/biometric/BiometricViewModel;

    iget-object v6, v5, Landroidx/biometric/BiometricViewModel;->f:Li9c;
    ...
    iput-object v6, v5, Landroidx/biometric/BiometricViewModel;->f:Li9c;

    :cond_1e
    iget-object v5, v5, Landroidx/biometric/BiometricViewModel;->f:Li9c;
    ...
    invoke-static {}, Lvb2;->b()Landroid/os/CancellationSignal;

    move-result-object v6

    iput-object v6, v5, Li9c;->a:Ljava/lang/Object;

    :cond_1f
    iget-object v5, v5, Li9c;->a:Ljava/lang/Object;
    ...
    invoke-direct {v6, v8}, Lpu0;-><init>(I)V

    iget-object v8, p0, Landroidx/biometric/BiometricFragment;->p1:Landroidx/biometric/BiometricViewModel;

    iget-object v9, v8, Landroidx/biometric/BiometricViewModel;->e:Lqn8;

    if-nez v9, :cond_20

    new-instance v9, Lqn8;

    new-instance v10, Lyu0;

    invoke-direct {v10, v8}, Lyu0;-><init>(Landroidx/biometric/BiometricViewModel;)V

    invoke-direct {v9, v10}, Lqn8;-><init>(Lyu0;)V

    iput-object v9, v8, Landroidx/biometric/BiometricViewModel;->e:Lqn8;

    :cond_20
    iget-object v8, v8, Landroidx/biometric/BiometricViewModel;->e:Lqn8;

    iget-object v9, v8, Lqn8;->b:Ljava/lang/Object;

    check-cast v9, Landroid/hardware/biometrics/BiometricPrompt$AuthenticationCallback;

    if-nez v9, :cond_21

    iget-object v9, v8, Lqn8;->d:Ljava/lang/Object;

    check-cast v9, Lyu0;

    invoke-static {v9}, Lvd0;->a(Lxd0;)Landroid/hardware/biometrics/BiometricPrompt$AuthenticationCallback;

    move-result-object v9

    iput-object v9, v8, Lqn8;->b:Ljava/lang/Object;

    :cond_21
    iget-object v8, v8, Lqn8;->b:Ljava/lang/Object;
    ...
    :try_start_1
    invoke-static {v0, v5, v6, v8}, Lmu0;->b(Landroid/hardware/biometrics/BiometricPrompt;Landroid/os/CancellationSignal;Ljava/util/concurrent/Executor;Landroid/hardware/biometrics/BiometricPrompt$AuthenticationCallback;)V
    ...
    :cond_22
    invoke-static {v0, v4, v5, v6, v8}, Lmu0;->a(Landroid/hardware/biometrics/BiometricPrompt;Landroid/hardware/biometrics/BiometricPrompt$CryptoObject;Landroid/os/CancellationSignal;Ljava/util/concurrent/Executor;Landroid/hardware/biometrics/BiometricPrompt$AuthenticationCallback;)V
    :try_end_1
    .catch Ljava/lang/NullPointerException; {:try_start_1 .. :try_end_1} :catch_1
    ...
    sget v0, Llnd;->default_error_msg:I
