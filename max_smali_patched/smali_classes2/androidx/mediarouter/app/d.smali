...
.field public final E1:Lsg;

.field public F0:Landroid/widget/ImageButton;

.field public G0:Landroidx/mediarouter/app/MediaRouteExpandCollapseButton;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {p1, v0}, Lsf9;->a(Landroid/content/Context;Z)Landroid/view/ContextThemeWrapper;

    move-result-object p1

    sget v1, Ljfd;->mediaRouteTheme:I

    invoke-static {p1, v1}, Lsf9;->g(Landroid/content/Context;I)I

    move-result v1

    if-nez v1, :cond_0

    invoke-static {p1}, Lsf9;->e(Landroid/content/Context;)I

    move-result v1

    :cond_0
    invoke-direct {p0, p1, v1}, Lre;-><init>(Landroid/view/ContextThemeWrapper;I)V
    ...
    iput-object v1, p0, Landroidx/mediarouter/app/d;->E1:Lsg;

    invoke-virtual {p0}, Landroid/app/Dialog;->getContext()Landroid/content/Context;

    move-result-object v1

    iput-object v1, p0, Landroidx/mediarouter/app/d;->A0:Landroid/content/Context;

    new-instance v2, Lge9;

    invoke-direct {v2, p0}, Lge9;-><init>(Landroidx/mediarouter/app/d;)V

    iput-object v2, p0, Landroidx/mediarouter/app/d;->j1:Lge9;

    invoke-static {v1}, Lmf9;->d(Landroid/content/Context;)Lmf9;

    move-result-object v2

    iput-object v2, p0, Landroidx/mediarouter/app/d;->Y:Lmf9;

    sget-object v2, Lmf9;->d:Lif9;
    ...
    invoke-direct {v0, p0, v2}, Lud9;-><init>(Landroid/view/KeyEvent$Callback;I)V

    iput-object v0, p0, Landroidx/mediarouter/app/d;->Z:Lud9;
    ...
    invoke-virtual {v0}, Lif9;->e()Llf9;

    move-result-object v0

    iput-object v0, p0, Landroidx/mediarouter/app/d;->z0:Llf9;
    ...
    sget v2, Lfgd;->mr_controller_volume_group_list_padding_top:I
    ...
    sget v0, Llld;->mr_linear_out_slow_in:I
    ...
    sget v0, Llld;->mr_fast_out_slow_in:I
...
.method public final h(Landroid/view/View;I)V
    ...
    invoke-direct {v1, p1, v0, p2, v2}, Lde9;-><init>(Landroid/view/View;III)V
...
.method public final j(Z)V
    ...
    :cond_0
    sget v5, Lphd;->volume_item_container:I
    ...
    iput-boolean v4, v2, Lmxb;->j:Z

    iput-boolean v4, v2, Lmxb;->k:Z

    iget-object v2, v2, Lmxb;->l:Loh5;

    if-eqz v2, :cond_2

    iget-object v3, v2, Loh5;->c:Ljava/lang/Object;
...
.method public final m(II)I
    ...
    :cond_0
    iget p1, p0, Landroidx/mediarouter/app/d;->C0:I
...
.method public final o()Z
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/d;->z0:Llf9;
...
.method public final onAttachedToWindow()V
    ...
    iget-object v1, p0, Landroidx/mediarouter/app/d;->Z:Lud9;

    const/4 v2, 0x2

    iget-object v3, p0, Landroidx/mediarouter/app/d;->Y:Lmf9;

    invoke-virtual {v3, v0, v1, v2}, Lmf9;->a(Lef9;Lud9;I)V
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    sget p1, Lpld;->mr_controller_material_dialog_b:I

    invoke-virtual {p0, p1}, Liq;->setContentView(I)V

    const p1, 0x102001b

    invoke-virtual {p0, p1}, Liq;->findViewById(I)Landroid/view/View;
    ...
    invoke-direct {p1, p0}, Lee9;-><init>(Landroidx/mediarouter/app/d;)V

    sget v1, Lphd;->mr_expandable_area:I

    invoke-virtual {p0, v1}, Liq;->findViewById(I)Landroid/view/View;
    ...
    invoke-direct {v2, p0, v3}, Lae9;-><init>(Landroidx/mediarouter/app/d;I)V

    invoke-virtual {v1, v2}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    sget v1, Lphd;->mr_dialog_area:I
    ...
    sget v1, Lofd;->colorPrimary:I

    iget-object v2, p0, Landroidx/mediarouter/app/d;->A0:Landroid/content/Context;

    invoke-static {v2, v1}, Lsf9;->f(Landroid/content/Context;I)I

    move-result v1

    const v3, 0x1010031

    invoke-static {v2, v3}, Lsf9;->f(Landroid/content/Context;I)I

    move-result v3

    invoke-static {v1, v3}, Lkk3;->d(II)D
    ...
    invoke-virtual {p0, v3}, Liq;->findViewById(I)Landroid/view/View;

    move-result-object v3

    check-cast v3, Landroid/widget/Button;

    iput-object v3, p0, Landroidx/mediarouter/app/d;->D0:Landroid/widget/Button;

    sget v4, Lsod;->mr_controller_disconnect:I

    invoke-virtual {v3, v4}, Landroid/widget/TextView;->setText(I)V

    iget-object v3, p0, Landroidx/mediarouter/app/d;->D0:Landroid/widget/Button;
    ...
    iput-object v3, p0, Landroidx/mediarouter/app/d;->E0:Landroid/widget/Button;

    sget v4, Lsod;->mr_controller_stop_casting:I

    invoke-virtual {v3, v4}, Landroid/widget/TextView;->setText(I)V

    iget-object v3, p0, Landroidx/mediarouter/app/d;->E0:Landroid/widget/Button;

    invoke-virtual {v3, v1}, Landroid/widget/TextView;->setTextColor(I)V

    iget-object v1, p0, Landroidx/mediarouter/app/d;->E0:Landroid/widget/Button;

    invoke-virtual {v1, p1}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    sget v1, Lphd;->mr_name:I
    ...
    sget v1, Lphd;->mr_custom_control:I
    ...
    sget v1, Lphd;->mr_default_control:I
    ...
    iput-object v1, p0, Landroidx/mediarouter/app/d;->J0:Landroid/widget/FrameLayout;

    new-instance v1, Lae9;

    const/4 v3, 0x1

    invoke-direct {v1, p0, v3}, Lae9;-><init>(Landroidx/mediarouter/app/d;I)V

    sget v3, Lphd;->mr_art:I
    ...
    iput-object v3, p0, Landroidx/mediarouter/app/d;->K0:Landroid/widget/ImageView;

    invoke-virtual {v3, v1}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    sget v3, Lphd;->mr_control_title_container:I
    ...
    sget v1, Lphd;->mr_media_main_control:I
    ...
    sget v1, Lphd;->mr_control_divider:I
    ...
    sget v1, Lphd;->mr_playback_control:I
    ...
    sget v1, Lphd;->mr_control_title:I
    ...
    sget v1, Lphd;->mr_control_subtitle:I
    ...
    iput-object v1, p0, Landroidx/mediarouter/app/d;->M0:Landroid/widget/TextView;

    sget v1, Lphd;->mr_control_playback_ctrl:I
    ...
    iput-object v1, p0, Landroidx/mediarouter/app/d;->F0:Landroid/widget/ImageButton;

    invoke-virtual {v1, p1}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    sget p1, Lphd;->mr_volume_control:I
    ...
    sget p1, Lphd;->mr_volume_slider:I
    ...
    invoke-direct {p1, p0}, Lhe9;-><init>(Landroidx/mediarouter/app/d;)V

    iput-object p1, p0, Landroidx/mediarouter/app/d;->b1:Lhe9;
    ...
    sget p1, Lphd;->mr_volume_group_list:I
    ...
    sget v4, Lofd;->colorPrimary:I

    invoke-static {v2, v4}, Lsf9;->f(Landroid/content/Context;I)I

    move-result v4

    sget v5, Lofd;->colorPrimaryDark:I

    invoke-static {v2, v5}, Lsf9;->f(Landroid/content/Context;I)I

    move-result v5

    if-eqz v3, :cond_1

    invoke-static {v2}, Lsf9;->b(Landroid/content/Context;)I
    ...
    sget p1, Lphd;->mr_group_expand_collapse:I
    ...
    iput-object p1, p0, Landroidx/mediarouter/app/d;->G0:Landroidx/mediarouter/app/MediaRouteExpandCollapseButton;

    new-instance v0, Lae9;

    const/4 v1, 0x2

    invoke-direct {v0, p0, v1}, Lae9;-><init>(Landroidx/mediarouter/app/d;I)V

    iput-object v0, p1, Landroidx/mediarouter/app/MediaRouteExpandCollapseButton;->C0:Landroid/view/View$OnClickListener;
    ...
    sget v0, Lild;->mr_controller_volume_group_list_animation_duration_ms:I
    ...
    sget v0, Lild;->mr_controller_volume_group_list_fade_in_duration_ms:I
    ...
    sget v0, Lild;->mr_controller_volume_group_list_fade_out_duration_ms:I
    ...
    iput-boolean p1, p0, Landroidx/mediarouter/app/d;->B0:Z
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/d;->Y:Lmf9;

    iget-object v1, p0, Landroidx/mediarouter/app/d;->Z:Lud9;

    invoke-virtual {v0, v1}, Lmf9;->f(Lud9;)V
...
.method public final onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    :cond_0
    invoke-super {p0, p1, p2}, Lre;->onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    :goto_1
    iget-object p2, p0, Landroidx/mediarouter/app/d;->z0:Llf9;

    invoke-virtual {p2, p1}, Llf9;->k(I)V
...
.method public final onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    :cond_0
    invoke-super {p0, p1, p2}, Lre;->onKeyUp(ILandroid/view/KeyEvent;)Z
...
.method public final r()V
    ...
    iget-object v1, p0, Landroidx/mediarouter/app/d;->j1:Lge9;
...
.method public final s(Z)V
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/d;->c1:Llf9;
    ...
    iget-object v2, p0, Landroidx/mediarouter/app/d;->z0:Llf9;

    invoke-virtual {v2}, Llf9;->g()Z

    move-result v3

    if-eqz v3, :cond_24

    invoke-virtual {v2}, Llf9;->d()Z
    ...
    iget-object v4, v2, Llf9;->d:Ljava/lang/String;

    invoke-virtual {v3, v4}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v3, p0, Landroidx/mediarouter/app/d;->D0:Landroid/widget/Button;

    iget-boolean v4, v2, Llf9;->i:Z
    ...
    :cond_4
    iget-object v3, p0, Landroidx/mediarouter/app/d;->K0:Landroid/widget/ImageView;
    ...
    invoke-virtual {v2}, Llf9;->e()Z

    move-result v3

    if-eqz v3, :cond_a

    sget-object v3, Lmf9;->d:Lif9;
    ...
    iget-object v3, p0, Landroidx/mediarouter/app/d;->G0:Landroidx/mediarouter/app/MediaRouteExpandCollapseButton;
    ...
    iget-object v2, p0, Landroidx/mediarouter/app/d;->L0:Landroid/widget/TextView;

    sget v3, Lsod;->mr_controller_casting_screen:I
    ...
    sget v3, Lsod;->mr_controller_no_info_available:I
    ...
    iget-object v3, p0, Landroidx/mediarouter/app/d;->M0:Landroid/widget/TextView;
    ...
    sget v3, Lsod;->mr_controller_no_media_selected:I
    ...
    :goto_c
    iget-object v4, p0, Landroidx/mediarouter/app/d;->L0:Landroid/widget/TextView;
    ...
    iget-object v2, p0, Landroidx/mediarouter/app/d;->M0:Landroid/widget/TextView;
    ...
    :goto_10
    iget-object v3, p0, Landroidx/mediarouter/app/d;->F0:Landroid/widget/ImageButton;
    ...
    sget v2, Ljfd;->mediaRoutePauseDrawable:I

    sget v4, Lsod;->mr_controller_pause:I
    ...
    sget v2, Ljfd;->mediaRouteStopDrawable:I

    sget v4, Lsod;->mr_controller_stop:I
    ...
    sget v2, Ljfd;->mediaRoutePlayDrawable:I

    sget v4, Lsod;->mr_controller_play:I
    ...
    :goto_14
    iget-object v6, p0, Landroidx/mediarouter/app/d;->F0:Landroid/widget/ImageButton;
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/d;->F0:Landroid/widget/ImageButton;

    invoke-static {v3, v2}, Lsf9;->g(Landroid/content/Context;I)I
    ...
    :cond_24
    :goto_16
    invoke-virtual {p0}, Liq;->dismiss()V
...
.method public final t()V
    ...
    :goto_1
    iget-object v2, p0, Landroidx/mediarouter/app/d;->m1:Lfe9;
    ...
    :cond_2
    iget-object v3, v2, Lfe9;->a:Landroid/graphics/Bitmap;
    ...
    :cond_3
    iget-object v2, v2, Lfe9;->b:Landroid/net/Uri;
    ...
    :cond_7
    iget-object v0, p0, Landroidx/mediarouter/app/d;->m1:Lfe9;
    ...
    invoke-direct {v0, p0}, Lfe9;-><init>(Landroidx/mediarouter/app/d;)V

    iput-object v0, p0, Landroidx/mediarouter/app/d;->m1:Lfe9;
...
.method public final u()V
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/d;->A0:Landroid/content/Context;

    invoke-static {v0}, Ls7j;->a(Landroid/content/Context;)I
    ...
    iput v1, p0, Landroidx/mediarouter/app/d;->C0:I

    invoke-virtual {v0}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v0

    sget v1, Lfgd;->mr_controller_volume_group_list_item_icon_size:I
    ...
    sget v1, Lfgd;->mr_controller_volume_group_list_item_height:I
    ...
    sget v1, Lfgd;->mr_controller_volume_group_list_max_height:I
...
.method public final v(Z)V
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/d;->J0:Landroid/widget/FrameLayout;
    ...
    invoke-direct {v1, p0, p1}, Lce9;-><init>(Landroidx/mediarouter/app/d;Z)V
