...
# direct methods
.method public constructor <init>(Lsha;Lorg/webrtc/CameraVideoCapturer;Lkh;Ljava/util/ArrayList;Ljava/util/ArrayList;ZLcwc;)V
    .locals 4
    ...
    iput-object v0, p0, Lrz1;->a:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lrz1;->b:Ljava/util/ArrayList;

    new-instance v2, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v2}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v2, p0, Lrz1;->f:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Lrz1;->g:Ljava/lang/Object;

    const/4 v2, 0x0

    iput-object v2, p0, Lrz1;->h:Ljava/lang/String;

    iput-object p7, p0, Lrz1;->e:Lcwc;
    ...
    invoke-direct {v3, p1}, Lu12;-><init>(Lcwc;)V

    invoke-direct {v2, p2, v3, p1}, Lveb;-><init>(Lorg/webrtc/CameraVideoCapturer;Lu12;Lcwc;)V

    invoke-direct {p7, v2}, Lhf;-><init>(Ljava/lang/Object;)V

    iput-object p7, p0, Lrz1;->c:Lhf;

    iput-object p3, p0, Lrz1;->d:Lkh;

    invoke-virtual {v0, p4}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    invoke-virtual {v1, p5}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iput-boolean p6, p0, Lrz1;->i:Z
...
.method public final a()V
    ...
    iget-object v0, p0, Lrz1;->g:Ljava/lang/Object;
    ...
    iget-object v2, p0, Lrz1;->a:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v2, p0, Lrz1;->b:Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v3}, Lhp6;-><init>(I)V
    ...
    invoke-static {v6, v7, v8, v2, v9}, Lmb3;->h(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    invoke-interface {v5, v6, v2}, Lcwc;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v7, v4, v3, v8}, Lok7;->g(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v7, p0, Lrz1;->e:Lcwc;

    new-instance v8, Ljava/lang/IllegalArgumentException;

    invoke-direct {v8, v4}, Ljava/lang/IllegalArgumentException;-><init>(Ljava/lang/String;)V

    invoke-interface {v7, v6, v4, v8}, Lcwc;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_b
    iget-object v4, p0, Lrz1;->e:Lcwc;

    const-string v7, "changeFormat, "

    const-string v8, "@"

    invoke-static {v7, v2, v5, v0, v8}, Lox1;->k(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-interface {v4, v6, v7}, Lcwc;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lrz1;->f:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iget-object v8, v7, Lx68;->r:Lrz1;

    if-eq p0, v8, :cond_d

    iget-object v8, v7, Lx68;->n:Lcwc;
    ...
    invoke-interface {v8, v10, v11, v9}, Lcwc;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_d
    iget-object v7, v7, Lx68;->y:Lxvg;

    iget-object v8, v7, Lxq3;->c:Ljava/lang/Object;
    ...
    invoke-static {v10, v2, v0, v5}, Lok7;->g(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v10

    invoke-interface {v8, v9, v10}, Lcwc;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v8, v7, Lxvg;->k:Lorg/webrtc/Size;
    ...
    invoke-virtual {v7}, Lxvg;->u()V

    goto :goto_6

    :cond_e
    iget-boolean v4, p0, Lrz1;->k:Z
    ...
    invoke-interface {v4, v6, v5}, Lcwc;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v4, p0, Lrz1;->c:Lhf;

    iget-object v4, v4, Lhf;->a:Ljava/lang/Object;

    check-cast v4, Lveb;

    invoke-virtual {v4, v2, v0, v3}, Lveb;->changeCaptureFormat(III)V
    ...
    invoke-virtual {v0, v3, v4, v5}, Lveb;->startCapture(III)V

    iput-boolean v1, p0, Lrz1;->k:Z
    :try_end_1
...
.method public final b()V
    ...
    invoke-virtual {v0}, Lveb;->stopCapture()V

    const/4 v0, 0x0

    iput-boolean v0, p0, Lrz1;->k:Z
    :try_end_0
