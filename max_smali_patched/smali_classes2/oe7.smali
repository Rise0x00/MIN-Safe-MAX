...
.field public u0:Lzv7;


# direct methods
.method public constructor <init>(Lru7;Lru7;Lru7;Lru7;Ltif;Lru7;Lru7;Lru7;Lru7;)V
    .locals 1
    ...
    iput-object v0, p0, Loe7;->u0:Lzv7;

    iput-object p1, p0, Loe7;->a:Lru7;

    iput-object p2, p0, Loe7;->b:Lru7;

    iput-object p3, p0, Loe7;->c:Lru7;

    iput-object p4, p0, Loe7;->d:Lru7;

    iput-object p5, p0, Loe7;->o:Ltif;

    iput-object p6, p0, Loe7;->X:Lru7;

    iput-object p7, p0, Loe7;->Y:Lru7;

    iput-object p8, p0, Loe7;->Z:Lru7;

    iput-object p9, p0, Loe7;->s0:Lru7;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Loe7;->t0:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final C(J)V
    ...
    iget-object v0, p0, Loe7;->u0:Lzv7;

    if-eqz v0, :cond_0

    iget-object v1, v0, Lzv7;->o:Lkotlinx/coroutines/internal/ContextScope;

    new-instance v2, Lyv7;

    const/4 v3, 0x0

    invoke-direct {v2, v0, p1, p2, v3}, Lyv7;-><init>(Lzv7;JLkotlin/coroutines/Continuation;)V
...
.method public final declared-synchronized H(JJ)V
    ...
    invoke-static {p3, p4}, Lcuh;->f(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p3, p0, Loe7;->t0:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final I(J)Ljava/lang/String;
    ...
    invoke-static {p1, p2, v2, v0}, Lox1;->r(JLjava/lang/String;Ljava/lang/String;)V

    return-object v1

    :cond_0
    iget-object v2, p0, Loe7;->Y:Lru7;
    ...
    invoke-virtual {v2, p1, p2}, Lad2;->D(J)Lt92;

    move-result-object p1

    if-nez p1, :cond_1

    iget-object p1, p0, Loe7;->c:Lru7;
    ...
    :cond_2
    sget p2, Lguc;->tt_typing_video_message:I
    ...
    :cond_4
    sget p2, Lguc;->tt_typing_sticker:I
    ...
    :cond_5
    sget p2, Lguc;->tt_typing_audio:I
    ...
    :cond_6
    sget p2, Lguc;->tt_typing_video:I
    ...
    :cond_7
    sget p2, Lguc;->tt_typing_photo:I
    ...
    iget-object v7, p0, Loe7;->s0:Lru7;

    iget-object v8, p0, Loe7;->Z:Lru7;
    ...
    invoke-virtual {v0, v3, v4, p2}, Lqs3;->i(JZ)Lmr3;

    move-result-object p2

    if-eqz p2, :cond_b

    invoke-virtual {p2}, Lmr3;->z()Z
    ...
    invoke-virtual {v2, v3, v4, p2}, Lqs3;->i(JZ)Lmr3;
    ...
    invoke-virtual {v2, v3, v4, v9}, Lqs3;->i(JZ)Lmr3;
    ...
    sget v1, Larc;->tt_chat_subtitle_count:I

    invoke-interface {v0}, Ljava/util/List;->size()I

    move-result v0

    invoke-static {v1, v0, p2}, Lhsf;->p(IILandroid/content/Context;)Ljava/lang/String;
...
.method public final f()V
    ...
    iget-object v0, p0, Loe7;->t0:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final x(J)Ljava/util/List;
    ...
    invoke-static {p1, p2, v2, v3}, Lox1;->r(JLjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p1, p2}, Ln63;-><init>(I)V
