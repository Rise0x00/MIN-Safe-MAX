...
.method public constructor <init>(Lia8;Lia8;Lia8;Lia8;)V
    ...
    const-string p4, "26.16.0(6698)"

    invoke-direct {v6, p4}, Lhtg;-><init>(Ljava/lang/CharSequence;)V

    sget p4, Ltnd;->oneme_settings_app_version:I

    new-instance v8, Ldtg;

    invoke-direct {v8, p4}, Ldtg;-><init>(I)V
    ...
    invoke-direct {v3, p2}, Lhtg;-><init>(Ljava/lang/CharSequence;)V

    sget p2, Ltnd;->oneme_settings_user_id:I
    ...
    iget-object p2, p2, Lj15;->h:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {p4, p2}, Lmae;-><init>(Ljava/lang/Throwable;)V
    ...
    new-instance p3, Lui2;

    const/16 p4, 0x61

    const/16 v0, 0x7a

    invoke-direct {p3, p4, v0}, Lsi2;-><init>(CC)V

    new-instance p4, Lui2;

    const/16 v0, 0x41

    const/16 v1, 0x5a

    invoke-direct {p4, v0, v1}, Lsi2;-><init>(CC)V
    ...
    invoke-static {p3, p4}, Lij3;->x1(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/ArrayList;
    ...
    invoke-static {v0, p3}, Loj3;->X0(Ljava/util/Collection;Ljava/lang/Iterable;)V

    invoke-static {v0, p4}, Loj3;->X0(Ljava/util/Collection;Ljava/lang/Iterable;)V
    ...
    invoke-static {v1, p3}, Lij3;->f1(ILjava/util/Collection;)Ljava/lang/Object;
...
.method public final d(Lmm4;)V
    ...
    :goto_0
    invoke-static {v1, p1}, Lvf3;->a(Landroid/content/Context;Ljava/lang/String;)V
