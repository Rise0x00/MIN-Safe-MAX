...
.field public K0:Lp42;


# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/graphics/drawable/ShapeDrawable;Let7;)V
    .locals 5
    ...
    iput-object p2, p0, Lv4f;->E0:Landroid/graphics/drawable/ShapeDrawable;
    ...
    iput p2, p0, Lv4f;->J0:I

    new-instance p2, Lg8a;

    const/4 v1, 0x0

    invoke-direct {p2, p0, p1, v1}, Lg8a;-><init>(Lv4f;Landroid/content/Context;Lkotlin/coroutines/Continuation;)V
    ...
    invoke-direct {p1, p0, p2, p3}, Lpde;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final F(I)V
    ...
    iget-object p1, p0, Lv4f;->F0:Landroid/graphics/drawable/LayerDrawable;

    if-nez p1, :cond_0

    invoke-virtual {p0}, Lv4f;->H()Landroid/graphics/drawable/LayerDrawable;

    move-result-object p1

    iput-object p1, p0, Lv4f;->F0:Landroid/graphics/drawable/LayerDrawable;
    ...
    iget-object v0, p0, Lv4f;->F0:Landroid/graphics/drawable/LayerDrawable;
...
.method public final G(Z)V
    ...
    iget-object v4, p0, Lv4f;->E0:Landroid/graphics/drawable/ShapeDrawable;
    ...
    :goto_0
    iget-object v3, p0, Lv4f;->K0:Lp42;

    if-eqz v3, :cond_1

    iget-object v3, v3, Lp42;->d:Ljava/lang/Integer;
...
.method public final H()Landroid/graphics/drawable/LayerDrawable;
    ...
    invoke-static {v3, v1}, Lw1f;->e(Landroid/graphics/drawable/Drawable;I)V
...
.method public final z(Li28;)V
    ...
    iput-object p1, p0, Lv4f;->K0:Lp42;

    iget-object v0, p1, Lp42;->b:Lj4f;

    iget-object v1, v0, Lj4f;->c:Ljava/lang/String;

    iget-object p1, p1, Lp42;->d:Ljava/lang/Integer;
    ...
    :cond_2
    :goto_1
    iget-boolean p1, v0, Lj4f;->Y:Z

    invoke-virtual {p0, p1}, Lv4f;->G(Z)V

    iget p1, v0, Lj4f;->X:I

    invoke-virtual {p0, p1}, Lv4f;->F(I)V
