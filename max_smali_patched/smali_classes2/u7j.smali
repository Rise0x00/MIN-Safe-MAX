...
.method public static b(Landroid/media/MediaRoute2Info;)Lie9;
    .locals 10
    ...
    invoke-static {p0}, Lxf;->m(Landroid/media/MediaRoute2Info;)Ljava/lang/String;

    move-result-object v2

    invoke-static {p0}, Lmd9;->n(Landroid/media/MediaRoute2Info;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, v2, v3}, Lz3d;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, v1, Lz3d;->a:Ljava/lang/Object;

    check-cast v2, Landroid/os/Bundle;

    invoke-static {p0}, Lmd9;->b(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lmd9;->x(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lmd9;->C(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lmd9;->D(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lxf;->i(Landroid/media/MediaRoute2Info;)Landroid/os/Bundle;
    ...
    invoke-static {p0}, Lmd9;->y(Landroid/media/MediaRoute2Info;)Ljava/lang/CharSequence;
    ...
    :cond_2
    invoke-static {p0}, Lmd9;->l(Landroid/media/MediaRoute2Info;)Landroid/net/Uri;
    ...
    invoke-virtual {v1, p0}, Lz3d;->b(Ljava/util/List;)V

    :cond_6
    invoke-virtual {v1}, Lz3d;->c()Lie9;
