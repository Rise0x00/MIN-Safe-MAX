...
.method public constructor <init>(Lru7;Lru7;)V
    ...
    iput-object p1, p0, Lff0;->a:Lru7;

    iput-object p2, p0, Lff0;->b:Lru7;

    return-void
.end method

.method public static final a(Lff0;[BLijg;)Lthf;
    .locals 2
    ...
    invoke-direct {p0, p1, v0, v1}, Lthf;-><init>(Ljava/lang/String;II)V

    iget p1, p2, Lijg;->d:I

    invoke-virtual {p0, p1}, Lthf;->setAlpha(I)V

    new-instance p1, Landroid/graphics/PorterDuffXfermode;

    iget-boolean v0, p2, Lijg;->e:Z
    ...
    sget-object p2, Lmq0;->a:Lmq0;

    invoke-static {p2}, Lnq0;->a(Lmq0;)Ljava/lang/Object;

    move-result-object p2

    if-eqz p2, :cond_2

    invoke-static {p1, p2}, Llq0;->a(ILjava/lang/Object;)Landroid/graphics/ColorFilter;
    ...
    :cond_2
    :goto_1
    invoke-virtual {p0, v1}, Lthf;->setColorFilter(Landroid/graphics/ColorFilter;)V
...
.method public static b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v9, v10}, Lbgi;->b(II)V
    ...
    invoke-direct/range {v11 .. v18}, Lhjg;-><init>(FFFFF[F[I)V
...
.method public final c(Landroid/content/Context;Lpf0;)Ljava/util/LinkedHashMap;
    ...
    sget-object v9, Lp92;->a:Ljava/nio/charset/Charset;
    ...
    iget-object v15, v10, Ldf0;->a:Ljava/lang/String;
    ...
    invoke-direct {v13, v2}, Lpf0;-><init>(Ljava/lang/String;)V

    sget-object v2, Ly53;->s0:Lvh4;

    move-object/from16 v14, p1

    invoke-virtual {v2, v14}, Lvh4;->h(Landroid/content/Context;)Ly53;

    move-result-object v2

    iget-object v2, v2, Ly53;->c:Ljava/lang/Object;

    check-cast v2, Ly5b;

    iget-object v2, v2, Ly5b;->b:Ljava/util/Map;
    ...
    :goto_3
    invoke-static {v2, v12}, Lp9i;->b(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-boolean v2, v10, Ldf0;->b:Z

    invoke-virtual {v15, v2}, Lewa;->a(Z)Lw5b;
    ...
    iget-object v2, v2, Lpc3;->a:Loc3;
    :try_end_1
    .catch Lorg/json/JSONException; {:try_start_1 .. :try_end_1} :catch_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0

    iget v10, v2, Loc3;->g:I

    iget v12, v2, Loc3;->i:I

    if-eqz v0, :cond_5

    :try_start_2
    invoke-virtual {v0, v13}, Lpf0;->equals(Ljava/lang/Object;)Z
    ...
    invoke-static {v9, v6}, Lvai;->a(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/Boolean;

    move-result-object v6

    if-eqz v15, :cond_b

    new-instance v20, Lijg;
    ...
    invoke-direct/range {v20 .. v26}, Lijg;-><init>(Ljava/lang/String;IIIZI)V
    ...
    invoke-direct {v12, v7, v0}, Lgjg;-><init>([IF)V
    ...
    iget v12, v2, Loc3;->e:I

    iget v15, v2, Loc3;->f:I
    ...
    invoke-static {v4, v0}, Lff0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v5, v0}, Lff0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v6, v0}, Lp9i;->b(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    new-instance v20, Ljjg;

    invoke-direct/range {v20 .. v25}, Ljjg;-><init>(Lijg;Lgjg;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Integer;)V
...
.method public final d(Landroid/content/Context;Lijg;Logf;)Ljava/lang/Object;
    .locals 3

    iget-object v0, p0, Lff0;->a:Lru7;
    ...
    invoke-direct {v1, p0, p1, p2, v2}, Lef0;-><init>(Lff0;Landroid/content/Context;Lijg;Lkotlin/coroutines/Continuation;)V
