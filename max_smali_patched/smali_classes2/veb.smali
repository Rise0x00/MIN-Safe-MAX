...
# direct methods
.method public constructor <init>(Lorg/webrtc/CameraVideoCapturer;Lu12;Lcwc;)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Lveb;->a:Ljava/lang/Object;

    .line 3
    iput-object p2, p0, Lveb;->b:Ljava/lang/Object;

    .line 4
    iput-object p3, p0, Lveb;->d:Ljava/lang/Object;
...
.method public constructor <init>(Ly47;)V
    ...
    iput-object p1, p0, Lveb;->b:Ljava/lang/Object;

    .line 7
    sget-object p1, Lv40;->s0:Lv40;

    iput-object p1, p0, Lveb;->d:Ljava/lang/Object;

    .line 8
    sget-object p1, Lz34;->a:Le9a;

    iput-object p1, p0, Lveb;->o:Ljava/lang/Object;
...
# virtual methods
.method public a(Lfm;Lam;)Ljava/lang/Object;
    .locals 9

    const-string v0, "Geo-Position"

    iget-object v1, p0, Lveb;->d:Ljava/lang/Object;

    check-cast v1, Lv40;

    :try_start_0
    iget-object v2, p0, Lveb;->X:Ljava/lang/Object;

    check-cast v2, Lrm;

    invoke-interface {v2, p0, p1, p2}, Lrm;->debugApiRequest(Lzl;Lpm;Lam;)V

    invoke-virtual {p0, p1, p2}, Lveb;->b(Lfm;Lam;)Ld5e;

    move-result-object p2

    iget-object v2, p0, Lveb;->a:Ljava/lang/Object;

    check-cast v2, Ly47;

    invoke-interface {v2, p2}, Ly47;->f(Ld5e;)Ls57;
    ...
    iget-object v4, v2, Ls57;->c:Ljava/lang/Object;
    ...
    :try_start_2
    iget-object v3, v2, Ls57;->d:Ljava/io/Closeable;

    check-cast v3, Lbh6;

    new-instance v5, Ljava/io/BufferedInputStream;

    iget-object v3, v3, Lbh6;->b:Ljava/lang/Object;
    ...
    invoke-static {v5}, Lhr7;->c(Ljava/io/BufferedInputStream;)Lhr7;
    ...
    invoke-virtual {v4, v5}, Lgt;->a(Ljava/lang/String;)Z

    move-result v5

    if-eqz v5, :cond_0

    iget-object v5, p0, Lveb;->o:Ljava/lang/Object;

    check-cast v5, Le9a;

    invoke-static {v4}, Lz34;->a(Lgt;)V
    ...
    :try_start_4
    iget-object v6, p0, Lveb;->X:Ljava/lang/Object;

    check-cast v6, Lrm;

    invoke-interface {v6, p0, p1, v3}, Lrm;->debugApiResponseOk(Lzl;Lpm;Lgr7;)Lgr7;

    move-result-object v3

    invoke-interface {p1}, Lfm;->getOkParser()Lar7;

    move-result-object v6

    invoke-interface {v6, v3}, Lar7;->parse(Lgr7;)Ljava/lang/Object;
    ...
    iget-object p2, p2, Lgt;->b:Ljava/lang/Object;
    ...
    iget-object v8, v7, Ll57;->a:Ljava/lang/String;
    ...
    iget-object v5, v7, Ll57;->b:Ljava/lang/String;
    ...
    :cond_4
    :try_start_6
    invoke-virtual {v2}, Ls57;->close()V
    :try_end_6
    ...
    :cond_9
    :try_start_9
    iget-object p2, p0, Lveb;->X:Ljava/lang/Object;

    check-cast p2, Lrm;

    invoke-interface {p2, p0, p1, v3}, Lrm;->debugApiResponseFail(Lzl;Lpm;Lgr7;)Lgr7;

    move-result-object p2

    invoke-interface {p1}, Lfm;->getFailParser()Lar7;

    move-result-object v0

    invoke-interface {v0, p2}, Lar7;->parse(Lgr7;)Ljava/lang/Object;
    ...
    :try_start_c
    invoke-static {v2, p2}, Ltti;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    :goto_9
    iget-object v0, p0, Lveb;->X:Ljava/lang/Object;

    check-cast v0, Lrm;

    invoke-interface {v0, p0, p1, p2}, Lrm;->debugIoException(Lzl;Lpm;Ljava/io/IOException;)V
    ...
    invoke-interface {v0, p0, p1, p2}, Lrm;->debugApiException(Lzl;Lpm;Lru/ok/android/api/core/ApiException;)V
...
.method public addMediaRecorderToCamera(Landroid/media/MediaRecorder;Lorg/webrtc/CameraVideoCapturer$MediaRecorderHandler;)V
    ...
    invoke-interface {p1, p2, v0}, Lcwc;->log(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public b(Lfm;Lam;)Ld5e;
    .locals 13
    ...
    invoke-virtual {v1, p1}, Lyl;->b(Lpm;)Landroid/net/Uri;
    ...
    invoke-direct {v7, v8, v9}, Ll57;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v4, v6}, Lfbf;->u(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    iput-object p0, v3, Lk6a;->b:Ljava/lang/Object;

    iput-object p1, v3, Lk6a;->c:Ljava/lang/Object;

    iput-object p2, v3, Lk6a;->d:Ljava/lang/Object;
    ...
    sget-object v8, Lx47;->$EnumSwitchMapping$0:[I
    ...
    invoke-static {v7, v4, v6}, Lfbf;->u(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v1, v2, p1, p2, v9}, Lyl;->g(Ljava/io/OutputStream;Lpm;Lam;I)V
    ...
    invoke-static {v7, p2, v6, v1}, Lxaf;->G(Ljava/lang/CharSequence;CII)I
    ...
    :goto_3
    invoke-static {v7, p2}, Lok7;->o(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p2}, Ldn;->b(Landroid/net/Uri;)Ljava/lang/String;
    ...
    :goto_6
    iget-object p2, p0, Lveb;->c:Ljava/lang/Object;
    ...
    invoke-direct {v2, v3, p2}, Ll57;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p1, p0, Lveb;->o:Ljava/lang/Object;
    ...
    invoke-direct {p1, p2, v1}, Ll57;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v10, p2, p1}, Lgt;-><init>(ILjava/lang/Object;)V

    const/4 v12, 0x7

    invoke-direct/range {v7 .. v12}, Ld5e;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public changeCaptureFormat(III)V
    ...
    iget-object v0, p0, Lveb;->a:Ljava/lang/Object;
...
.method public initialize(Lorg/webrtc/SurfaceTextureHelper;Landroid/content/Context;Lorg/webrtc/CapturerObserver;)V
    ...
    iput-object v2, p0, Lveb;->o:Ljava/lang/Object;
    :try_end_0
    ...
    :goto_0
    invoke-interface {v1, v3, v0, v2}, Lcwc;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v1, p0, p3}, Lch8;-><init>(Lveb;Lorg/webrtc/CapturerObserver;)V
...
.method public isScreencast()Z
    ...
    iget-object v0, p0, Lveb;->d:Ljava/lang/Object;
