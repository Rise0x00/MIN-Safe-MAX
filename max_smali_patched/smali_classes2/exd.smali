...
.method public constructor <init>(JLjava/lang/String;Ljava/lang/String;Ljava/lang/CharSequence;ZZI)V
    ...
    iput-object p3, p0, Lexd;->b:Ljava/lang/CharSequence;

    iput-object p4, p0, Lexd;->c:Ljava/lang/String;

    iput-object p5, p0, Lexd;->d:Ljava/lang/CharSequence;

    iput-boolean p6, p0, Lexd;->o:Z

    iput-boolean p7, p0, Lexd;->X:Z

    iput-boolean v1, p0, Lexd;->Y:Z

    iput-wide p1, p0, Lexd;->Z:J
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    :cond_2
    iget-object v1, p0, Lexd;->b:Ljava/lang/CharSequence;

    iget-object v2, p1, Lexd;->b:Ljava/lang/CharSequence;
    ...
    :cond_4
    iget-object v1, p0, Lexd;->d:Ljava/lang/CharSequence;
    ...
    :cond_5
    iget-boolean v1, p0, Lexd;->o:Z

    iget-boolean v2, p1, Lexd;->o:Z
    ...
    :cond_6
    iget-boolean v1, p0, Lexd;->X:Z

    iget-boolean v2, p1, Lexd;->X:Z
    ...
    :cond_7
    iget-boolean v1, p0, Lexd;->Y:Z

    iget-boolean p1, p1, Lexd;->Y:Z
...
.method public final hashCode()I
    ...
    iget-object v2, p0, Lexd;->b:Ljava/lang/CharSequence;
    ...
    iget-object v3, p0, Lexd;->c:Ljava/lang/String;
    ...
    iget-object v3, p0, Lexd;->d:Ljava/lang/CharSequence;

    invoke-static {v0, v1, v3}, Ls54;->c(IILjava/lang/CharSequence;)I

    move-result v0

    iget-boolean v3, p0, Lexd;->o:Z

    invoke-static {v0, v1, v3}, Lwph;->b(IIZ)I

    move-result v0

    iget-boolean v3, p0, Lexd;->X:Z

    invoke-static {v0, v1, v3}, Lwph;->b(IIZ)I

    move-result v0

    iget-boolean v3, p0, Lexd;->Y:Z
...
.method public final l(Lki8;)Z
    ...
    invoke-virtual {p0, p1}, Lexd;->equals(Ljava/lang/Object;)Z
...
.method public final m(Lki8;)Ljava/lang/Object;
    ...
    iget-object v1, p1, Lexd;->c:Ljava/lang/String;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iget-object v3, p1, Lexd;->b:Ljava/lang/CharSequence;

    iget-object v4, p0, Lexd;->b:Ljava/lang/CharSequence;
    ...
    invoke-direct {v4, v3}, Lbxd;-><init>(Ljava/lang/CharSequence;)V

    invoke-virtual {v2, v4}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    :cond_0
    iget-boolean v3, p1, Lexd;->X:Z

    iget-boolean v4, p0, Lexd;->X:Z

    if-eq v4, v3, :cond_1

    new-instance v4, Ldxd;

    invoke-direct {v4, v3}, Ldxd;-><init>(Z)V
    ...
    invoke-direct {v3, v1}, Laxd;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v1, v0}, Lzwd;-><init>(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v0, p1}, Lcxd;-><init>(Z)V
