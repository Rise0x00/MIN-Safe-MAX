...
.method static constructor <clinit>()V
    ...
    sput-object v1, Los7;->c:Ljava/util/Map;
    ...
    sput-object v0, Los7;->d:Ljava/util/List;
...
.method public final a()[B
    ...
    iget-object v0, p0, Los7;->b:Ljava/util/ArrayList;
    ...
    sget-object v6, Lfxf;->u0:Lfxf;

    iget-short v6, v6, Lfxf;->a:S
    ...
    iget-object v2, v1, Lns7;->a:Lhxf;

    iget-short v2, v2, Lhxf;->a:S

    invoke-virtual {v5, v2}, Ljava/nio/ByteBuffer;->putShort(S)Ljava/nio/ByteBuffer;

    iget-object v2, v1, Lns7;->a:Lhxf;

    sget-object v3, Los7;->c:Ljava/util/Map;
    ...
    invoke-virtual {v1}, Lns7;->a()Ljava/security/PublicKey;
    ...
    invoke-static {v5, v2}, Los7;->f(Ljava/nio/ByteBuffer;[B)V
    ...
    invoke-static {v5, v1}, Los7;->f(Ljava/nio/ByteBuffer;[B)V

    goto :goto_1

    :cond_2
    sget-object v4, Lhxf;->o:Lhxf;
    ...
    invoke-static {v2}, La5;->s(Ljava/security/PublicKey;)Ljava/security/interfaces/XECPublicKey;

    move-result-object v2

    invoke-static {v2}, La5;->r(Ljava/security/interfaces/XECPublicKey;)Ljava/math/BigInteger;
    ...
    invoke-static {v2}, Los7;->e([B)V

    iget-object v1, v1, Lns7;->a:Lhxf;
...
.method public final d(Ljava/nio/ByteBuffer;)I
    ...
    invoke-direct {v6, v2, v7}, Lb83;-><init>(II)V
    ...
    sget-object v3, Los7;->d:Ljava/util/List;
    ...
    invoke-static {v4}, Los7;->c(Ljava/lang/String;)Ljava/security/spec/ECParameterSpec;
    ...
    invoke-direct {v4, v2, v3}, Lms7;-><init>(Lhxf;Ljava/security/interfaces/ECPublicKey;)V
    ...
    :cond_1
    sget-object v3, Lhxf;->o:Lhxf;

    if-eq v2, v3, :cond_2

    sget-object v3, Lhxf;->X:Lhxf;
    ...
    invoke-static {v5}, Lwbb;->c(Ljava/lang/String;)Ljava/security/spec/NamedParameterSpec;

    move-result-object v5

    invoke-static {}, La5;->w()V

    invoke-static {v5, v4}, La5;->t(Ljava/security/spec/AlgorithmParameterSpec;Ljava/math/BigInteger;)Ljava/security/spec/XECPublicKeySpec;
    ...
    invoke-direct {v4, v2, v3}, Lns7;-><init>(Lhxf;Ljava/security/PublicKey;)V
