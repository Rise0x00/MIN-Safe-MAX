...
.method public constructor <init>(Lgxf;)V
    ...
    .line 2
    iput-object p1, p0, Lkff;->a:Lgxf;

    const/16 p1, 0x304

    .line 3
    iput-short p1, p0, Lkff;->b:S

    return-void
.end method

.method public constructor <init>(Ljava/nio/ByteBuffer;Lgxf;)V
    .locals 3
    ...
    .line 5
    iput-object p2, p0, Lkff;->a:Lgxf;

    .line 6
    sget-object v0, Lfxf;->Z:Lfxf;

    .line 7
    iget-short v0, v0, Lfxf;->a:S

    const/4 v1, 0x2

    invoke-virtual {p0, p1, v0, v1}, Llk5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    .line 12
    iget-short v2, p0, Lkff;->b:S

    if-nez v2, :cond_1

    .line 13
    :cond_0
    iput-short v1, p0, Lkff;->b:S
