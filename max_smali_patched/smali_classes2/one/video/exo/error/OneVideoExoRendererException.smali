...
.method public constructor <init>(Landroidx/media3/exoplayer/ExoPlaybackException;)V
    ...
    iget-object v0, p1, Landroidx/media3/exoplayer/ExoPlaybackException;->w0:Lub6;
    ...
    invoke-static {v0}, Laji;->b(Lub6;)Lx30;
    ...
    iget-object v1, v0, Lub6;->a:Ljava/lang/String;
    ...
    invoke-direct {v3, v1, v2, v0}, Llqf;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_2
    iput-object v0, p0, Lone/video/exo/error/OneVideoExoRendererException;->b:Lfr8;

    sget-object v0, Lwb6;->a:Lyib;
    ...
    invoke-virtual {v0, p1}, Lyib;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object p1, Lvb6;->X:Lvb6;

    :cond_8
    iput-object p1, p0, Lone/video/exo/error/OneVideoExoRendererException;->c:Lvb6;
    ...
    iget-object p1, v4, Landroidx/media3/exoplayer/mediacodec/MediaCodecRenderer$DecoderInitializationException;->c:Lwo8;

    invoke-static {p1}, Lone/video/exo/error/OneVideoExoRendererException;->a(Lwo8;)V
    ...
    iget-object p1, v4, Landroidx/media3/exoplayer/mediacodec/MediaCodecDecoderException;->a:Lwo8;
...
.method public static a(Lwo8;)V
    ...
    :cond_0
    iget-boolean v0, p0, Lwo8;->h:Z

    const/4 v1, 0x0

    invoke-static {v0, v1}, Ljava/lang/Boolean;->compare(ZZ)I

    iget-boolean v0, p0, Lwo8;->e:Z

    invoke-static {v0, v1}, Ljava/lang/Boolean;->compare(ZZ)I

    invoke-virtual {p0}, Lwo8;->f()Z
    ...
    :goto_0
    iget-boolean v0, p0, Lwo8;->g:Z

    invoke-static {v0, v1}, Ljava/lang/Boolean;->compare(ZZ)I

    iget-boolean v0, p0, Lwo8;->i:Z

    invoke-static {v0, v1}, Ljava/lang/Boolean;->compare(ZZ)I

    iget-boolean v0, p0, Lwo8;->j:Z

    invoke-static {v0, v1}, Ljava/lang/Boolean;->compare(ZZ)I

    iget-boolean p0, p0, Lwo8;->f:Z
