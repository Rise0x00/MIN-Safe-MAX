...
.method public constructor <init>(Lru7;Lru7;Landroid/content/Context;)V
    ...
    iput-object p3, p0, Lhec;->a:Landroid/content/Context;

    iput-object p1, p0, Lhec;->b:Lru7;

    iput-object p2, p0, Lhec;->c:Lru7;
...
.method public final a(Ljava/lang/CharSequence;[Lvf7;)Ljava/lang/CharSequence;
    ...
    iget-object v7, v1, Lhec;->c:Lru7;

    const/4 v8, 0x1

    iget-object v9, v1, Lhec;->a:Landroid/content/Context;
    ...
    invoke-static {v0, v7}, Lud9;->mergeFrom(Lud9;[B)Lud9;
    ...
    invoke-direct {v12, v9, v7}, Lzgg;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iget v0, v0, Lqf7;->a:I

    invoke-virtual {v10, v0}, Lce5;->get(I)Ljava/lang/Object;
    ...
    invoke-direct/range {v11 .. v17}, Lone/me/sdk/uikit/common/span/FitFontImageSpan;-><init>(Landroid/graphics/drawable/Drawable;Lkx5;ZZILfi4;)V
    ...
    new-instance v11, Lpve;

    iget v0, v0, Lwf7;->a:I

    invoke-direct {v11, v0}, Lpve;-><init>(I)V
    ...
    invoke-static {v0, v8}, Lud9;->mergeFrom(Lud9;[B)Lud9;
    ...
    invoke-static {v8}, Lnp0;->a([B)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v7, v9}, Lvh4;->h(Landroid/content/Context;)Ly53;
    ...
    invoke-direct {v11, v7, v8}, Lhtf;-><init>(Lw5b;Lqi6;)V
    ...
    invoke-static {v0}, Lnp0;->a([B)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v11, v7}, Le95;-><init>(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {v7, v6, v0}, Lcuh;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final b(Ljava/lang/CharSequence;)Ljava/util/ArrayList;
    ...
    :cond_7
    instance-of v12, v9, Le95;

    iget-object v13, v1, Lhec;->c:Lru7;

    if-eqz v12, :cond_12

    check-cast v9, Le95;

    iget-object v12, v9, Le95;->X:Landroid/graphics/drawable/Drawable;
    ...
    :cond_8
    instance-of v14, v12, Lvwe;

    if-eqz v14, :cond_9

    check-cast v12, Lvwe;

    iget-object v12, v12, Lvwe;->a:Lwwe;

    iget-object v14, v12, Lwwe;->c:Lr75;

    iget-object v12, v12, Lwwe;->a:Lt85;

    invoke-virtual {v14, v12}, Lr75;->x(Lt85;)Landroid/graphics/Bitmap;
    ...
    :cond_a
    iget-object v9, v9, Le95;->X:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v9, v9, Lvwe;->b:Landroid/graphics/Rect;
    ...
    iget-object v13, v9, Lnp0;->a:Loje;
    ...
    invoke-static {v15}, Lvp0;->d(Landroid/graphics/Bitmap;)I
    ...
    invoke-static {v15, v13}, Lnp0;->c(Landroid/graphics/Bitmap;[B)[B
    ...
    invoke-static {v3, v9}, Lpsb;->a(II)V
    ...
    invoke-virtual/range {v14 .. v20}, Lpsb;->b(Landroid/graphics/Bitmap;IIIILandroid/graphics/Matrix;)Lci4;
    ...
    invoke-static {v0, v13}, Lnp0;->c(Landroid/graphics/Bitmap;[B)[B
    ...
    iget-object v3, v0, Lvk;->b:Luk;

    invoke-virtual {v3}, Luk;->e()Landroid/graphics/drawable/Drawable;

    move-result-object v3

    instance-of v5, v3, Lzgg;
    ...
    iget-object v3, v3, Lzgg;->Z:Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lone/me/sdk/uikit/common/span/FitFontImageSpan;->getScaleType()Lkx5;
    ...
    :cond_17
    iget-object v0, v0, Lvk;->b:Luk;

    invoke-virtual {v0}, Luk;->e()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    invoke-virtual {v1, v0}, Lhec;->c(Landroid/graphics/drawable/Drawable;)Lci4;
    ...
    invoke-static {v5, v0}, Lnp0;->c(Landroid/graphics/Bitmap;[B)[B
    ...
    invoke-virtual {v9}, Lone/me/sdk/uikit/common/span/FitFontImageSpan;->getScaleType()Lkx5;
...
.method public final c(Landroid/graphics/drawable/Drawable;)Lci4;
    .locals 8

    :try_start_0
    iget-object v0, p0, Lhec;->b:Lru7;
    ...
    invoke-virtual {v0, v1, v2, v7}, Lpsb;->c(IILandroid/graphics/Bitmap$Config;)Lq93;
