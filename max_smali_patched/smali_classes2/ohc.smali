...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget-object v4, Lodh;->s:Lktg;

    invoke-static {v4, v2}, Lktg;->d(Lktg;Landroid/widget/TextView;)V

    iput-object v2, p0, Lohc;->c:Landroid/widget/TextView;

    new-instance v5, Landroid/widget/TextView;

    invoke-direct {v5, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3, v5}, Lz66;->k(Landroid/view/View;)Lgqb;
    ...
    invoke-static {v4, v5}, Lktg;->d(Lktg;Landroid/widget/TextView;)V

    iput-object v5, p0, Lohc;->d:Landroid/widget/TextView;
    ...
    invoke-static {v7, v8}, Lf90;->r0(IF)I
    ...
    iput-object v7, v6, Lsth;->a:Landroid/widget/ImageView;
    ...
    iput-object v7, v6, Lsth;->c:Landroid/widget/ProgressBar;

    new-instance v7, Landroid/widget/TextView;

    invoke-direct {v7, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3, v7}, Lz66;->k(Landroid/view/View;)Lgqb;
    ...
    sget-object p1, Lodh;->o:Lktg;

    invoke-static {p1, v7}, Lktg;->d(Lktg;Landroid/widget/TextView;)V
    ...
    iput-object v7, v6, Lsth;->b:Landroid/widget/TextView;
    ...
    invoke-direct {p1, p0, v0}, Lxe9;-><init>(Landroid/view/KeyEvent$Callback;I)V
...
.method public final a(Lju2;)V
    ...
    iget-boolean v0, p1, Lju2;->b:Z

    iget-object p1, p1, Lju2;->a:Llq6;
    ...
    iget-object v3, p1, Llq6;->a:Landroid/graphics/Bitmap;
    ...
    :goto_0
    iput-object v3, p0, Lohc;->A0:Llq6;

    if-eqz v3, :cond_2

    iget-object v1, v3, Llq6;->a:Landroid/graphics/Bitmap;

    :cond_2
    iget-object v3, p0, Lohc;->z0:Lsth;

    iget-object v4, v3, Lsth;->a:Landroid/widget/ImageView;
    ...
    iget-object v2, v3, Lsth;->c:Landroid/widget/ProgressBar;
...
.method public final getListener()Lnhc;
    .locals 1

    iget-object v0, p0, Lohc;->C0:Lnhc;
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p1, p0, Lohc;->z0:Lsth;
    ...
    invoke-static {p1, p4, p2, p3, p5}, Lnm4;->S(Landroid/view/View;IIII)V

    :cond_0
    iget-object p1, p0, Lohc;->c:Landroid/widget/TextView;

    const/4 p2, 0x0

    const/16 p5, 0xc

    invoke-static {p1, p4, p3, p2, p5}, Lnm4;->S(Landroid/view/View;IIII)V
    ...
    iget-object v1, p0, Lohc;->d:Landroid/widget/TextView;
    ...
    invoke-static {v1, v0, p3, p2, p5}, Lnm4;->S(Landroid/view/View;IIII)V
    ...
    iget-object p3, p0, Lohc;->o:Ljic;

    invoke-static {p3, p4, p1, p2, p5}, Lnm4;->S(Landroid/view/View;IIII)V
...
.method public final onMeasure(II)V
    ...
    iget-object v3, p0, Lohc;->c:Landroid/widget/TextView;
    ...
    iget-object v4, p0, Lohc;->d:Landroid/widget/TextView;
    ...
    iget-object v0, p0, Lohc;->A0:Llq6;
    ...
    iget-object v0, p0, Lohc;->z0:Lsth;
...
.method public final setListener(Lnhc;)V
    .locals 0

    iput-object p1, p0, Lohc;->C0:Lnhc;
