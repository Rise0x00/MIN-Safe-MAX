...
.method public c(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;Lv5d;)Lj1j;
    .locals 7
    ...
    iget-object v0, p3, Lv5d;->a:Ljava/lang/Object;
    ...
    invoke-direct {v3}, Ls9d;-><init>()V

    new-instance v5, Lsof;

    iget-object v0, v3, Ls9d;->b:Ljava/lang/Object;

    check-cast v0, Lv5d;

    invoke-direct {v5, v0}, Lsof;-><init>(Lv5d;)V

    new-instance v6, Lao;

    invoke-direct {v6, p1, p3, v3, v5}, Lao;-><init>(Ljava/util/concurrent/Executor;Lv5d;Ls9d;Lsof;)V
    ...
    invoke-direct/range {v0 .. v5}, Lao8;-><init>(Lf3;Lv5d;Ls9d;Ljava/util/concurrent/Callable;Lsof;)V

    invoke-virtual {p1, v0, v6}, Lph6;->u(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V

    iget-object p1, v5, Lsof;->a:Lj1j;
...
.method public f()V
    ...
    invoke-virtual {v2, v1}, Lww1;->h(Ldog;)V
...
.method public k(Landroid/graphics/Bitmap;Lkg6;Leq3;)V
    .locals 0
...
.method public abstract u(Lvg7;)Ljava/util/List;
.end method

.method public v(Lkg6;Z)V
    .locals 0

    return-void
.end method

.method public w(Lcz9;)V
    .locals 0
...
.method public abstract x(Lum4;)V
.end method
