...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lrya;Lwh4;Lgua;Lqxb;)V
    .locals 0
    ...
    iput-object p2, p0, Lgca;->b:Lrya;

    iput-object p3, p0, Lgca;->c:Lwh4;

    iput-object p4, p0, Lgca;->d:Lgua;

    iput-object p5, p0, Lgca;->e:Lqxb;
...
.method public final a()Lfca;
    ...
    iget-object v0, p0, Lgca;->c:Lwh4;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v0, p0, Lgca;->a:Landroid/content/Context;

    sget v1, Lguc;->tt_notif_category_active_calls:I
    ...
    invoke-direct/range {v2 .. v13}, Lfca;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZZ)V

    return-object v2
.end method

.method public final b()Lfca;
    .locals 14
    ...
    sget v1, Lguc;->tt_notif_category_incoming_calls:I

    invoke-virtual {v0, v1}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v4

    iget-object v0, p0, Lgca;->e:Lqxb;
...
.method public final c()Lfca;
    ...
    iget-object v1, v0, Lsxb;->c:Leig;

    const-string v2, "app.notification.chats.ringtone"

    invoke-virtual {v1, v2}, Leig;->q(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lgca;->i(Z)Landroid/net/Uri;

    move-result-object v8

    iget-object v1, p0, Lgca;->c:Lwh4;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v1, p0, Lgca;->a:Landroid/content/Context;

    sget v3, Lguc;->tt_notif_category_chats:I
    ...
    invoke-direct/range {v3 .. v14}, Lfca;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZZ)V

    return-object v3
.end method

.method public final d()Lfca;
    .locals 15
    ...
    invoke-virtual {p0, v2}, Lgca;->i(Z)Landroid/net/Uri;
    ...
    sget v3, Lguc;->tt_notif_category_dialogs:I
...
.method public final e()Lfca;
    .locals 14

    iget-object v0, p0, Lgca;->b:Lrya;
    ...
    sget v1, Lguc;->tt_notif_category_inapp:I
...
.method public final f(Lfca;)V
    ...
    iget-boolean v0, p1, Lfca;->c:Z

    const/4 v2, 0x4

    if-eqz v0, :cond_1

    iget-boolean v0, p1, Lfca;->f:Z
    ...
    iget-object v5, p1, Lfca;->b:Ljava/lang/String;

    invoke-direct {v3, v1, v5, v0}, Landroid/app/NotificationChannel;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;I)V

    iget-object v0, p1, Lfca;->e:Landroid/net/Uri;

    if-eqz v0, :cond_5

    iget-object v5, p0, Lgca;->c:Lwh4;
    ...
    iget-object v0, p0, Lgca;->d:Lgua;

    invoke-virtual {v0, v1}, Lgua;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method public final g()V
    ...
    iget-object v1, v0, Lgca;->d:Lgua;

    iget-object v2, v1, Lgua;->e:Ltif;
    ...
    invoke-virtual {v3, v4}, Let;->add(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v3, v2}, Let;->contains(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v1, v4, v2}, Lgua;->a(ILjava/lang/String;)V
    ...
    invoke-virtual {v1, v3, v2}, Lgua;->a(ILjava/lang/String;)V

    :cond_3
    invoke-virtual {v0}, Lgca;->j()Landroid/app/NotificationManager;
    ...
    invoke-virtual {v0}, Lgca;->c()Lfca;

    move-result-object v3

    invoke-virtual {v0, v3}, Lgca;->f(Lfca;)V
    ...
    iget-object v4, v0, Lgca;->a:Landroid/content/Context;

    if-nez v3, :cond_7

    iget-object v3, v0, Lgca;->e:Lqxb;

    check-cast v3, Lsxb;

    iget-object v5, v3, Lsxb;->c:Leig;

    const-string v6, "app.notification.ringtone"

    invoke-virtual {v5, v6}, Leig;->q(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v6}, Lgca;->i(Z)Landroid/net/Uri;

    move-result-object v12

    sget v5, Lguc;->tt_notif_category_misc:I
    ...
    invoke-virtual {v3, v5, v6}, Luu7;->getBoolean(Ljava/lang/String;Z)Z
    ...
    invoke-direct/range {v7 .. v18}, Lfca;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZZ)V

    invoke-virtual {v0, v7}, Lgca;->f(Lfca;)V
    ...
    sget v3, Lguc;->tt_notif_category_file_loading:I
    ...
    invoke-direct/range {v5 .. v16}, Lfca;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZZ)V

    invoke-virtual {v0, v5}, Lgca;->f(Lfca;)V
    ...
    sget v3, Lguc;->tt_notif_category_media:I
    ...
    sget v3, Lguc;->tt_notif_category_live_location:I
...
.method public final i(Z)Landroid/net/Uri;
    ...
    iget-object p1, v0, Lsxb;->c:Leig;

    const-string v0, "app.notification.ringtone"

    invoke-virtual {p1, v0}, Leig;->q(Ljava/lang/String;)Ljava/lang/String;
...
.method public final j()Landroid/app/NotificationManager;
    ...
    iget-object v0, p0, Lgca;->f:Landroid/app/NotificationManager;
    ...
    iput-object v0, p0, Lgca;->f:Landroid/app/NotificationManager;
...
.method public final k()Z
    ...
    invoke-virtual {p0, v0}, Lgca;->h(Ljava/lang/String;)Landroid/app/NotificationChannel;

    move-result-object v1

    invoke-virtual {p0}, Lgca;->a()Lfca;
    ...
    invoke-virtual {p0, v2}, Lgca;->f(Lfca;)V
