...
# direct methods
.method public static final a(Lgzb;)J
    .locals 2
    ...
    invoke-static {v0, v1, p0}, Ls5b;->O(JLhd5;)J
...
.method public static final b(Lgzb;)Z
    .locals 0
...
.method public static c(Ltw9;)Lroa;
    .locals 15
    ...
    new-instance v10, Lax9;

    const/16 v12, 0x14

    invoke-direct {v10, v12}, Lax9;-><init>(I)V

    invoke-static {p0, v10}, Ltf3;->w0(Ltw9;Lwea;)Ljava/util/ArrayList;

    move-result-object v10

    if-eqz v10, :cond_d

    invoke-static {v10}, Lij3;->g1(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    :cond_14
    new-instance p0, Lroa;

    if-eqz v11, :cond_15

    invoke-direct {p0, v11, v10}, Lroa;-><init>(Ljava/lang/String;Ljava/util/List;)V
