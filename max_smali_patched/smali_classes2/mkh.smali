...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lmkh;->a:Lwui;

    new-instance v1, Llkh;

    invoke-direct {v1, p1}, Llkh;-><init>(Landroid/content/Context;)V
...
.method public final a(Ll3f;I)V
    ...
    :cond_0
    iget-object v0, p1, Ll3f;->X:Ljava/lang/String;

    const/4 v1, 0x0

    iget-object v2, p0, Lmkh;->a:Lwui;

    const/4 v3, 0x1

    iget-object v4, p0, Lmkh;->b:Llkh;
    ...
    invoke-direct {v5, v6, p0}, Luff;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v4, v5}, Llkh;->setOnFirstFrameListener(Lkkh;)V

    invoke-virtual {v4, v1}, Landroid/view/View;->setVisibility(I)V

    iput-boolean v3, p0, Lmkh;->c:Z
    ...
    :cond_2
    iget-object v5, v4, Llkh;->a:Ljava/lang/String;
    ...
    :cond_3
    iput-boolean v3, v4, Llkh;->b:Z

    iput-object v0, v4, Llkh;->a:Ljava/lang/String;
    ...
    invoke-virtual {v4, p2}, Llkh;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    goto :goto_0

    :goto_1
    iput-boolean v1, p0, Lmkh;->c:Z

    if-eqz p2, :cond_4

    iget-boolean p2, p0, Lmkh;->d:Z
