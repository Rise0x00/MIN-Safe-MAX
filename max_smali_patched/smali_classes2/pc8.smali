...
# direct methods
.method public constructor <init>(Ljava/time/Clock;Ll6d;Lxjd;Lp8a;Lg6d;Lcgc;)V
    .locals 2
    ...
    iput-wide v0, p0, Lpc8;->i:J

    iput-object p1, p0, Lpc8;->a:Ljava/time/Clock;

    iput-object p2, p0, Lpc8;->b:Ll6d;

    iput-object p3, p0, Lpc8;->c:Lxjd;

    iput-object p4, p0, Lpc8;->d:Lp8a;

    iput-object p5, p0, Lpc8;->e:Lg6d;

    iput-object p6, p0, Lpc8;->f:Lcgc;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>()V

    iput-object p1, p0, Lpc8;->h:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Lpc8;->g:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final declared-synchronized a()V
    ...
    :try_start_0
    iget-object v0, p0, Lpc8;->g:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Lpc8;->d:Lp8a;

    invoke-virtual {v1, v0}, Lp8a;->b(Ljava/util/List;)V

    iget-object v0, p0, Lpc8;->h:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-object v0, p0, Lpc8;->j:Ljava/time/Instant;

    iput-object v0, p0, Lpc8;->k:Ljava/time/Instant;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lpc8;->l:Z
    :try_end_0
...
.method public final b()V
    ...
    :cond_0
    iget-object v0, p0, Lpc8;->c:Lxjd;

    invoke-virtual {v0}, Lxjd;->b()I

    move-result v0

    iget-object v1, p0, Lpc8;->c:Lxjd;
    ...
    iget-object v1, p0, Lpc8;->a:Ljava/time/Clock;
    ...
    iget-object v1, p0, Lpc8;->g:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {v4, p0, v5, v0}, Lok4;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object v5, p0, Lpc8;->h:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-direct {v5, p0, v6}, Lnc8;-><init>(Lpc8;I)V

    invoke-interface {v4, v5}, Ljava/util/stream/Stream;->forEach(Ljava/util/function/Consumer;)V

    iget-object v4, p0, Lpc8;->e:Lg6d;

    invoke-virtual {v4}, Lg6d;->run()V

    iget-object v4, p0, Lpc8;->d:Lp8a;
    ...
    invoke-direct {v6, v7}, Lc83;-><init>(I)V
    ...
    iget-wide v9, v4, Lp8a;->b:J

    sub-long/2addr v9, v7

    iput-wide v9, v4, Lp8a;->b:J

    iget-object v9, v4, Lp8a;->d:Lq2e;

    invoke-virtual {v9}, Lq2e;->k()V
    ...
    invoke-virtual {v4}, Lp8a;->a()V

    iget-object v7, v4, Lp8a;->a:Lq98;

    iget-wide v8, v4, Lp8a;->b:J
    ...
    invoke-direct {v6, v7}, Les5;-><init>(I)V
    ...
    iget-object v6, v4, Lp8a;->f:Ljava/time/Instant;
    ...
    iput-object v5, v4, Lp8a;->f:Ljava/time/Instant;

    iget-wide v5, v4, Lp8a;->c:J
    ...
    iput-wide v7, v4, Lp8a;->c:J

    :cond_2
    iget-object v5, v4, Lp8a;->a:Lq98;

    iget-wide v6, v4, Lp8a;->c:J
    ...
    iput-wide v5, v4, Lp8a;->e:J

    :cond_3
    iget-object v4, v4, Lp8a;->a:Lq98;

    invoke-interface {v4}, Lq98;->getQLog()Lcgc;
    ...
    invoke-direct {v4, p0, v5}, Lnc8;-><init>(Lpc8;I)V
    ...
    invoke-direct {v4, p0, v5}, Lmc8;-><init>(Lpc8;I)V
    ...
    invoke-direct {v4, v5}, Les5;-><init>(I)V
