...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput v0, p0, Ld1j;->alpha:F

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Ld1j;->customParams:Ljava/util/HashMap;

    const-string v0, "precision mediump float;\nuniform mat4 mvpMatrix;\nuniform mat4 texMatrix;\nattribute vec4 aVertexCoord;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nvoid main() {\n    gl_Position = mvpMatrix * aVertexCoord;\n   vTextureCoord = (texMatrix * aTextureCoord).xy;\n}\n"

    const v1, 0x8b31

    invoke-static {v1, v0}, Le3k;->c(ILjava/lang/String;)I
    ...
    invoke-static {v1, p1}, Le3k;->c(ILjava/lang/String;)I
    ...
    iput v1, p0, Ld1j;->programId:I

    const-string v2, "glCreateProgram"

    invoke-static {v2}, Le3k;->b(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Le3k;->b(Ljava/lang/String;)V
    ...
    iput v0, p0, Ld1j;->aVertexCoordLoc:I

    invoke-static {v0, p1}, Le3k;->a(ILjava/lang/String;)V
    ...
    iput v2, p0, Ld1j;->aTextureCoordLoc:I

    invoke-static {v2, p1}, Le3k;->a(ILjava/lang/String;)V
    ...
    iput v3, p0, Ld1j;->mvpMatrixLoc:I

    invoke-static {v3, p1}, Le3k;->a(ILjava/lang/String;)V
    ...
    iput v3, p0, Ld1j;->texMatrixLoc:I
    ...
    iput v3, p0, Ld1j;->textureLocation:I
    ...
    iput v1, p0, Ld1j;->alphaLocation:I

    invoke-static {v3, p1}, Le3k;->a(ILjava/lang/String;)V

    new-instance p1, Lo0j;

    invoke-direct {p1, v0, v2}, Lo0j;-><init>(II)V

    iput-object p1, p0, Ld1j;->frame:Lo0j;
...
.method public getTextureCoordLoc()I
    ...
    iget v0, p0, Ld1j;->aTextureCoordLoc:I
...
.method public getVertexCoordLoc()I
    ...
    iget v0, p0, Ld1j;->aVertexCoordLoc:I
...
.method public registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Ld1j;->firstFreeTexture:I
    ...
    invoke-static {p1}, Le3k;->b(Ljava/lang/String;)V

    iget p1, p0, Ld1j;->firstFreeTexture:I

    add-int/lit8 p2, p1, 0x1

    iput p2, p0, Ld1j;->firstFreeTexture:I
...
.method public release()V
    ...
    iget-object v0, p0, Ld1j;->frame:Lo0j;

    iget-object v0, v0, Lo0j;->a:Lx0j;

    invoke-interface {v0}, Lx0j;->a()V

    iget v0, p0, Ld1j;->programId:I
...
.method public render()V
    ...
    invoke-virtual {p0}, Ld1j;->use()V

    iget-object v0, p0, Ld1j;->frame:Lo0j;

    iget-object v0, v0, Lo0j;->a:Lx0j;

    invoke-interface {v0}, Lx0j;->b()V

    invoke-virtual {p0}, Ld1j;->unUse()V
...
.method public setCustomParameter(Ljava/lang/String;F)V
    ...
    .line 2
    iget-object v0, p0, Ld1j;->customParams:Ljava/util/HashMap;
...
.method public setMVPMat([F)V
    ...
    iput-object p1, p0, Ld1j;->mvpMat:[F
...
.method public setTexMat([F)V
    ...
    iput-object p1, p0, Ld1j;->texMat:[F
...
.method public use()V
    ...
    iput v0, p0, Ld1j;->firstFreeTexture:I

    iget-object v1, p0, Ld1j;->mvpMat:[F
    ...
    iput-object v1, p0, Ld1j;->mvpMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_0
    iget-object v1, p0, Ld1j;->texMat:[F

    if-nez v1, :cond_1

    new-array v1, v2, [F

    iput-object v1, p0, Ld1j;->texMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_1
    iget v1, p0, Ld1j;->programId:I

    invoke-static {v1}, Landroid/opengl/GLES20;->glUseProgram(I)V

    const-string v1, "glUseProgram"

    invoke-static {v1}, Le3k;->b(Ljava/lang/String;)V

    iget v1, p0, Ld1j;->mvpMatrixLoc:I

    iget-object v2, p0, Ld1j;->mvpMat:[F
    ...
    iget v2, p0, Ld1j;->texMatrixLoc:I

    iget-object v4, p0, Ld1j;->texMat:[F

    invoke-static {v2, v3, v0, v4, v0}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    invoke-static {v1}, Le3k;->b(Ljava/lang/String;)V

    iget v0, p0, Ld1j;->textureLocation:I

    invoke-virtual {p0}, Ld1j;->getTarget()I

    move-result v1

    iget v2, p0, Ld1j;->textureId:I

    const-string v3, "textureId"

    invoke-virtual {p0, v1, v2, v3}, Ld1j;->registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Ld1j;->alphaLocation:I

    iget v1, p0, Ld1j;->alpha:F
    ...
    iget-object v3, p0, Ld1j;->customParams:Ljava/util/HashMap;
