...
# direct methods
.method public constructor <init>(Landroid/util/Size;Ly45;)V
    .locals 5

    invoke-direct {p0}, Lbx4;-><init>()V

    iput-object p1, p0, Lwsg;->o:Landroid/util/Size;
    ...
    iput-object v0, p0, Lwsg;->p:Ljava/lang/String;

    const/16 v1, 0x10

    new-array v1, v1, [F

    iput-object v1, p0, Lwsg;->t:[F
    ...
    invoke-virtual {p0, p2}, Lbx4;->n(Ly45;)Lja0;
...
.method public final q()V
    ...
    iget-object v0, p0, Lwsg;->p:Ljava/lang/String;

    const-string v1, "release"

    invoke-static {v0, v1}, Lcuh;->s(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lwsg;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v0, p0, Lwsg;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    iget-object v2, p0, Lwsg;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    :cond_1
    iput-object v0, p0, Lwsg;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    iget-object v2, p0, Lwsg;->q:Ln2f;

    if-eqz v2, :cond_2

    iget-object v3, v2, Ln2f;->d:Ljava/io/Serializable;

    check-cast v3, Ljava/lang/String;

    invoke-static {v3, v1}, Lcuh;->s(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, v2, Ln2f;->e:Ljava/lang/Object;
    ...
    iget-object v1, v2, Ln2f;->f:Ljava/lang/Object;
    ...
    :cond_2
    iput-object v0, p0, Lwsg;->q:Ln2f;

    iput-object v0, p0, Lwsg;->w:Ln7f;

    invoke-super {p0}, Lbx4;->q()V
...
.method public final w(Landroid/graphics/SurfaceTexture;Landroid/view/Surface;[FZ)V
    ...
    invoke-virtual {v1, v0}, Lbx4;->l(Landroid/view/Surface;)Lab0;

    move-result-object v2

    sget-object v3, Lsk6;->j:Lab0;

    invoke-virtual {v2, v3}, Lab0;->equals(Ljava/lang/Object;)Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-virtual {v1, v0}, Lbx4;->h(Landroid/view/Surface;)Lab0;
    ...
    :cond_1
    iget-object v3, v1, Lbx4;->c:Ljava/lang/Object;

    check-cast v3, Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 v8, 0x1

    invoke-static {v3, v8}, Lsk6;->d(Ljava/util/concurrent/atomic/AtomicBoolean;Z)V
    ...
    iget v11, v2, Lab0;->b:I

    iget v12, v2, Lab0;->c:I

    iget-object v9, v2, Lab0;->a:Landroid/opengl/EGLSurface;

    invoke-virtual/range {p1 .. p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v13

    iget-object v2, v1, Lwsg;->q:Ln2f;

    if-nez v2, :cond_2

    new-instance v2, Ln2f;

    iget-object v5, v1, Lwsg;->o:Landroid/util/Size;

    invoke-direct {v2, v5}, Ln2f;-><init>(Landroid/util/Size;)V

    iput-object v2, v1, Lwsg;->q:Ln2f;

    :cond_2
    move-object v10, v2

    iget-object v2, v10, Ln2f;->f:Ljava/lang/Object;

    move-object/from16 v17, v2

    check-cast v17, Lone/me/sdk/gl/effects/objects/FrameBuffer;

    iget-object v2, v1, Lwsg;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    iput-object v2, v1, Lwsg;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    :cond_3
    iget-object v5, v1, Lwsg;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v5, v1, Lwsg;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    :cond_4
    iget-wide v6, v1, Lwsg;->u:J

    cmp-long v6, v13, v6

    iget-object v7, v1, Lwsg;->t:[F
    ...
    iget v6, v10, Ln2f;->a:I

    move/from16 v16, v8

    iget v8, v10, Ln2f;->b:I
    ...
    iget-object v3, v10, Ln2f;->e:Ljava/lang/Object;
    ...
    iget-object v4, v10, Ln2f;->c:Ljava/lang/Object;
    ...
    iget-object v4, v1, Lbx4;->k:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v2}, Lbx4;->o(Landroid/opengl/EGLSurface;)V

    iput-object v0, v1, Lbx4;->k:Ljava/lang/Object;
    ...
    invoke-virtual {v4, v11}, Ln7f;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    :cond_8
    iput-object v8, v1, Lwsg;->w:Ln7f;
    ...
    :cond_9
    :goto_2
    iget-object v4, v1, Lbx4;->f:Ljava/lang/Object;
    ...
    invoke-static {v7, v4, v5}, Lm9i;->b(IJ)Ljava/lang/String;
    ...
    iget-object v4, v1, Lwsg;->p:Ljava/lang/String;

    invoke-static {v4, v2, v8}, Lcuh;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-virtual {v1, v0, v3}, Lbx4;->s(Landroid/view/Surface;Z)V
