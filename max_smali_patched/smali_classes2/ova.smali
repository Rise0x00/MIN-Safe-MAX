...
.method public final b(Lb4h;)V
    ...
    iget-object v2, v0, Lgwa;->b:Ljava/lang/CharSequence;
    ...
    iget-object v3, v0, Lova;->e:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v3}, Lnva;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V
    ...
    :cond_5
    :goto_1
    iget-boolean v3, v0, Lova;->g:Z

    if-eqz v3, :cond_7

    iget-object v3, v0, Lova;->f:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v1}, Lmva;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V

    :cond_7
    :goto_2
    iget-boolean v1, v0, Lgwa;->d:Z

    if-eqz v1, :cond_8

    iget-object v1, v0, Lgwa;->c:Ljava/lang/CharSequence;
    ...
    invoke-static {v2, v1}, Lnva;->c(Landroid/app/Notification$BigPictureStyle;Z)V

    invoke-static {v2, v5}, Lnva;->b(Landroid/app/Notification$BigPictureStyle;Ljava/lang/CharSequence;)V
