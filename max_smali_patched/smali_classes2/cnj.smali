...
.method public static b(Lcom/google/android/gms/maps/model/LatLng;)Ls7a;
    .locals 3

    :try_start_0
    new-instance v0, Ls7a;

    sget-object v1, Lcnj;->a:Lx6j;
    ...
    invoke-direct {v0, v1}, Ls7a;-><init>(Llh7;)V
    :try_end_0
...
.method public static c(Lcom/google/android/gms/maps/model/LatLng;F)Ls7a;
    .locals 3
    ...
    invoke-direct {v0, p1}, Ls7a;-><init>(Llh7;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static d([B)Lyna;
    .locals 13

    new-instance v0, Lvzb;

    invoke-direct {v0, p0}, Lvzb;-><init>([B)V
    ...
    invoke-virtual {v0, p0}, Lvzb;->J(I)V
    ...
    invoke-static {v4, p0}, Lq98;->Y(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, p0, v4}, Lx82;->r(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p0, v2, v3}, Lvzb;->h(I[BI)V

    new-instance p0, Lyna;

    invoke-direct {p0, v5, v1, v2, v6}, Lyna;-><init>(Ljava/util/UUID;I[B[Ljava/util/UUID;)V
...
.method public static e(Ljava/util/UUID;[B)[B
    ...
    invoke-static {p1}, Lcnj;->d([B)Lyna;
    ...
    :cond_0
    iget-object v1, p1, Lyna;->c:Ljava/lang/Object;
    ...
    :cond_1
    iget-object p0, p1, Lyna;->d:Ljava/lang/Object;
