...
.method public constructor <init>(I)V
    ...
    :try_start_0
    invoke-static {p1}, Ljv;->c(I)Landroid/os/SharedMemory;

    move-result-object p1

    iput-object p1, p0, Lkv;->a:Landroid/os/SharedMemory;

    invoke-static {p1}, Ljv;->e(Landroid/os/SharedMemory;)Ljava/nio/ByteBuffer;

    move-result-object p1

    iput-object p1, p0, Lkv;->b:Ljava/nio/ByteBuffer;
    :try_end_0
...
.method public final G(Lco9;I)V
    ...
    :try_start_1
    invoke-virtual {p0, p1, p2}, Lkv;->d(Lco9;I)V
...
.method public final declared-synchronized J(I)B
    ...
    :try_start_0
    invoke-virtual {p0}, Lkv;->isClosed()Z
    ...
    invoke-virtual {p0}, Lkv;->getSize()I
    ...
    iget-object v0, p0, Lkv;->b:Ljava/nio/ByteBuffer;
...
.method public final declared-synchronized close()V
    ...
    iget-object v0, p0, Lkv;->a:Landroid/os/SharedMemory;

    if-eqz v0, :cond_0

    invoke-static {v0}, Ljv;->h(Landroid/os/SharedMemory;)V
    ...
    invoke-static {v0}, Ljv;->i(Ljava/nio/ByteBuffer;)V

    :cond_1
    const/4 v0, 0x0

    iput-object v0, p0, Lkv;->b:Ljava/nio/ByteBuffer;

    iput-object v0, p0, Lkv;->a:Landroid/os/SharedMemory;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final d(Lco9;I)V
    ...
    invoke-virtual {p1}, Lkv;->isClosed()Z
    ...
    iget-object v0, p1, Lkv;->b:Ljava/nio/ByteBuffer;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-virtual {p1}, Lkv;->getSize()I
    ...
    iget-object v1, p0, Lkv;->b:Ljava/nio/ByteBuffer;

    invoke-virtual {v1, v0, v2, p2}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;

    iget-object p1, p1, Lkv;->b:Ljava/nio/ByteBuffer;
...
.method public final declared-synchronized g0(III[B)I
    ...
    iget-object p1, p0, Lkv;->b:Ljava/nio/ByteBuffer;
...
.method public final getSize()I
    ...
    invoke-static {v0}, Ljv;->a(Landroid/os/SharedMemory;)I
