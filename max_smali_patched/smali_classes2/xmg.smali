...
.field public final u:Lmhc;

.field public final v:Z

.field public final w:Lcua;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lvf5;Landroid/net/Uri;Ljava/lang/String;FFLmhc;ZLcua;)V
    .locals 1
    ...
    iput-boolean v0, p0, Lxmg;->j:Z

    iput-boolean v0, p0, Lxmg;->k:Z

    iput-boolean v0, p0, Lxmg;->l:Z

    iput-boolean v0, p0, Lxmg;->m:Z

    iput-boolean v0, p0, Lxmg;->n:Z

    iput-object p1, p0, Lxmg;->o:Landroid/content/Context;

    iput-object p2, p0, Lxmg;->p:Lvf5;

    iput-object p3, p0, Lxmg;->q:Landroid/net/Uri;

    iput-object p4, p0, Lxmg;->r:Ljava/lang/String;

    iput p5, p0, Lxmg;->s:F

    iput p6, p0, Lxmg;->t:F

    iput-object p7, p0, Lxmg;->u:Lmhc;

    iput-boolean p8, p0, Lxmg;->v:Z

    iput-object p9, p0, Lxmg;->w:Lcua;

    return-void
.end method

.method public static a(Landroid/content/Context;Lvf5;Landroid/net/Uri;Ljava/lang/String;FFLmhc;ZLcua;)Z
    .locals 13
    ...
    invoke-direct/range {v1 .. v10}, Lxmg;-><init>(Landroid/content/Context;Lvf5;Landroid/net/Uri;Ljava/lang/String;FFLmhc;ZLcua;)V
    ...
    invoke-static {p1, p2, p0}, Lcuh;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {p1, v0, p0}, Lcuh;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object p0, v1, Lxmg;->h:Ld39;

    if-eqz p0, :cond_0

    iget-object p0, p0, Ld39;->a:Ljava/lang/Object;
    ...
    :cond_1
    iget-object p0, v1, Lxmg;->b:Landroid/media/MediaExtractor;
    ...
    :cond_3
    iget-object p0, v1, Lxmg;->i:Lkjf;

    if-eqz p0, :cond_4

    iget-object p1, p0, Lkjf;->d:Ljava/lang/Object;

    check-cast p1, Landroid/view/Surface;

    if-eqz p1, :cond_4

    invoke-virtual {p0}, Lkjf;->m()V

    :cond_4
    iget-object p0, v1, Lxmg;->g:Labb;

    if-eqz p0, :cond_23

    iget-object p1, p0, Labb;->b:Landroid/view/Surface;
    ...
    iget-object v0, v1, Lxmg;->b:Landroid/media/MediaExtractor;
    ...
    iget-boolean v6, v1, Lxmg;->n:Z

    if-eqz v6, :cond_8

    iget-boolean v6, v1, Lxmg;->m:Z
    ...
    iget-object v0, v1, Lxmg;->f:Lae;

    iget-object v2, v1, Lxmg;->b:Landroid/media/MediaExtractor;
    ...
    iget-wide v5, v1, Lxmg;->x:J

    cmp-long v0, v3, v5

    if-lez v0, :cond_e

    iget-object v0, v1, Lxmg;->a:Ljava/nio/ByteBuffer;
    ...
    iget-object v3, v1, Lxmg;->b:Landroid/media/MediaExtractor;

    iget-object v4, v1, Lxmg;->a:Ljava/nio/ByteBuffer;
    ...
    iget-object v3, v1, Lxmg;->c:Lq1a;

    iget-object v4, v1, Lxmg;->a:Ljava/nio/ByteBuffer;

    iget-object v5, v3, Lq1a;->f:Ljava/lang/Object;

    check-cast v5, Landroid/media/MediaMuxer;

    invoke-virtual {v3}, Lq1a;->b()Z

    move-result v6

    if-eqz v6, :cond_c

    iget-boolean v6, v3, Lq1a;->c:Z

    if-nez v6, :cond_b

    invoke-virtual {v5}, Landroid/media/MediaMuxer;->start()V

    iput-boolean v2, v3, Lq1a;->c:Z

    :cond_b
    invoke-virtual {v3}, Lq1a;->a()V
    ...
    :cond_c
    iget-object v5, v3, Lq1a;->g:Ljava/lang/Object;
    ...
    invoke-direct {v6, v3, v4, v0}, Lp1a;-><init>(ILjava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    iget-object v0, v1, Lxmg;->h:Ld39;

    invoke-virtual {v0}, Ld39;->h()V
    :try_end_1
    ...
    iget-object p2, p0, Lkjf;->d:Ljava/lang/Object;
    ...
    iget-object p2, p0, Labb;->b:Landroid/view/Surface;
    ...
    invoke-static {p1, p0}, Lcuh;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1c
    invoke-static {p1, v3, p0}, Lcuh;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {p1, p0, v0}, Lcuh;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object p0, v1, Lxmg;->p:Lvf5;
    ...
    invoke-virtual {p0, p1}, Lyua;->c(Ljava/lang/Throwable;)V
    :try_end_3
    ...
    :cond_26
    iget-object p1, v1, Lxmg;->b:Landroid/media/MediaExtractor;
    ...
    :cond_27
    iget-object p1, v1, Lxmg;->c:Lq1a;

    if-eqz p1, :cond_28

    iget-object p1, p1, Lq1a;->f:Ljava/lang/Object;
    ...
    :cond_28
    iget-object p1, v1, Lxmg;->i:Lkjf;

    if-eqz p1, :cond_29

    iget-object p2, p1, Lkjf;->d:Ljava/lang/Object;

    check-cast p2, Landroid/view/Surface;

    if-eqz p2, :cond_29

    invoke-virtual {p1}, Lkjf;->m()V

    :cond_29
    iget-object p1, v1, Lxmg;->g:Labb;

    if-eqz p1, :cond_2a

    iget-object p2, p1, Labb;->b:Landroid/view/Surface;

    if-eqz p2, :cond_2a

    invoke-virtual {p1}, Labb;->a()V
...
.method public final b()Z
    ...
    iput-object v2, v0, Lxmg;->a:Ljava/nio/ByteBuffer;

    new-instance v2, Landroid/media/MediaExtractor;

    invoke-direct {v2}, Landroid/media/MediaExtractor;-><init>()V

    iput-object v2, v0, Lxmg;->b:Landroid/media/MediaExtractor;

    iget-object v3, v0, Lxmg;->o:Landroid/content/Context;

    iget-object v4, v0, Lxmg;->q:Landroid/net/Uri;
    ...
    iget-object v3, v0, Lxmg;->r:Ljava/lang/String;
    ...
    iput-boolean v4, v2, Lq1a;->d:Z

    iput-boolean v4, v2, Lq1a;->e:Z

    new-instance v7, Ljava/util/ArrayList;

    invoke-direct {v7}, Ljava/util/ArrayList;-><init>()V

    iput-object v7, v2, Lq1a;->g:Ljava/lang/Object;

    new-instance v7, Landroid/media/MediaMuxer;

    invoke-direct {v7, v3, v4}, Landroid/media/MediaMuxer;-><init>(Ljava/lang/String;I)V

    iput-object v7, v2, Lq1a;->f:Ljava/lang/Object;

    iput-object v2, v0, Lxmg;->c:Lq1a;

    iget-object v2, v0, Lxmg;->b:Landroid/media/MediaExtractor;
    ...
    iget-object v8, v0, Lxmg;->b:Landroid/media/MediaExtractor;
    ...
    const-string v10, "xmg"

    invoke-static {v10, v9}, Lcuh;->f(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v8}, Landroid/media/MediaFormat;->toString()Ljava/lang/String;

    move-result-object v11

    invoke-static {v10, v11}, Lcuh;->f(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v10, v0, Lxmg;->b:Landroid/media/MediaExtractor;
    ...
    iget v11, v0, Lxmg;->s:F

    mul-float/2addr v11, v10

    float-to-long v11, v11

    iput-wide v11, v0, Lxmg;->x:J

    iget v11, v0, Lxmg;->t:F

    mul-float/2addr v10, v11

    float-to-long v10, v10

    iput-wide v10, v0, Lxmg;->y:J

    iget-object v10, v0, Lxmg;->u:Lmhc;

    iget v11, v10, Lmhc;->b:I

    iget v12, v10, Lmhc;->c:I
    ...
    iget v10, v10, Lmhc;->d:I

    invoke-direct {v14}, Ljava/lang/Object;-><init>()V

    iput-object v0, v14, Ld39;->b:Ljava/lang/Object;
    ...
    iput-object v10, v14, Ld39;->a:Ljava/lang/Object;
    ...
    iput-object v11, v14, Ld39;->c:Ljava/lang/Object;

    invoke-virtual {v10}, Landroid/media/MediaCodec;->start()V

    iput-object v14, v0, Lxmg;->h:Ld39;

    new-instance v10, Lkjf;

    iget-object v11, v14, Ld39;->c:Ljava/lang/Object;
    ...
    iput-object v12, v10, Lkjf;->a:Ljava/lang/Object;

    sget-object v12, Landroid/opengl/EGL14;->EGL_NO_CONTEXT:Landroid/opengl/EGLContext;

    iput-object v12, v10, Lkjf;->b:Ljava/lang/Object;

    sget-object v12, Landroid/opengl/EGL14;->EGL_NO_SURFACE:Landroid/opengl/EGLSurface;

    iput-object v12, v10, Lkjf;->c:Ljava/lang/Object;

    invoke-virtual {v11}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object v11, v10, Lkjf;->d:Ljava/lang/Object;

    invoke-static {v4}, Landroid/opengl/EGL14;->eglGetDisplay(I)Landroid/opengl/EGLDisplay;

    move-result-object v11

    iput-object v11, v10, Lkjf;->a:Ljava/lang/Object;
    ...
    iget-object v12, v10, Lkjf;->a:Ljava/lang/Object;
    ...
    iput-object v11, v10, Lkjf;->b:Ljava/lang/Object;

    const-string v11, "eglCreateContext"

    invoke-static {v11}, Lkjf;->c(Ljava/lang/String;)V

    iget-object v11, v10, Lkjf;->b:Ljava/lang/Object;
    ...
    iget-object v14, v10, Lkjf;->d:Ljava/lang/Object;
    ...
    iput-object v11, v10, Lkjf;->c:Ljava/lang/Object;

    const-string v11, "eglCreateWindowSurface"

    invoke-static {v11}, Lkjf;->c(Ljava/lang/String;)V

    iget-object v11, v10, Lkjf;->c:Ljava/lang/Object;

    check-cast v11, Landroid/opengl/EGLSurface;

    if-eqz v11, :cond_3

    iput-object v10, v0, Lxmg;->i:Lkjf;

    iget-object v12, v10, Lkjf;->a:Ljava/lang/Object;

    check-cast v12, Landroid/opengl/EGLDisplay;

    iget-object v10, v10, Lkjf;->b:Ljava/lang/Object;
    ...
    invoke-direct {v10}, Labb;-><init>()V

    iput-object v10, v0, Lxmg;->g:Labb;

    new-instance v10, Lae;

    iget-object v11, v0, Lxmg;->g:Labb;

    invoke-direct {v10, v9, v8, v11, v0}, Lae;-><init>(Ljava/lang/String;Landroid/media/MediaFormat;Labb;Lxmg;)V

    iput-object v10, v0, Lxmg;->f:Lae;

    iget-object v8, v0, Lxmg;->c:Lq1a;

    iput-boolean v7, v8, Lq1a;->d:Z
    ...
    :cond_6
    iput-object v5, v10, Lkjf;->a:Ljava/lang/Object;
    ...
    iget-boolean v9, v0, Lxmg;->v:Z

    if-eqz v9, :cond_9

    iget-object v8, v0, Lxmg;->c:Lq1a;

    iput-boolean v4, v8, Lq1a;->e:Z

    goto :goto_3

    :cond_9
    iget-object v9, v0, Lxmg;->c:Lq1a;

    iput-boolean v7, v9, Lq1a;->e:Z

    iget-object v10, v9, Lq1a;->f:Ljava/lang/Object;
