...
# direct methods
.method public constructor <init>(Lsm8;)V
    .locals 1

    sget-object v0, Lfd4;->e:Lfd4;

    invoke-direct {p0, v0}, Lb28;-><init>(Llyi;)V

    iput-object p1, p0, Lh1e;->o:Lsm8;
...
.method public final r(Lm7d;I)V
    ...
    iget-object v0, p1, Lg1e;->F0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    iget-object v1, p2, Ld1e;->Z:Landroid/net/Uri;

    iput-object p2, p1, Lg1e;->H0:Ld1e;

    iget-object v2, p1, Lg1e;->I0:Landroid/net/Uri;

    iget-object v3, p2, Ld1e;->d:Landroid/net/Uri;
    ...
    iget-object v2, p1, Lg1e;->J0:Landroid/net/Uri;
    ...
    :cond_0
    iput-object v3, p1, Lg1e;->I0:Landroid/net/Uri;

    iput-object v1, p1, Lg1e;->J0:Landroid/net/Uri;

    invoke-static {v3}, Lbb7;->d(Landroid/net/Uri;)Lbb7;

    move-result-object v2

    iput-boolean v4, v2, Lbb7;->h:Z
    ...
    invoke-direct {v3, v5, v1}, Lgbb;-><init>(Landroid/content/Context;Landroid/net/Uri;)V

    iput-object v3, v2, Lbb7;->k:Luwb;
    ...
    :cond_2
    iget-object p2, p2, Ld1e;->a:Lk68;

    iget-object p2, p2, Lk68;->v0:Lj68;
    ...
    :goto_0
    iget-object p1, p1, Lg1e;->G0:Landroidx/appcompat/widget/AppCompatImageView;
...
.method public final t(Landroid/view/ViewGroup;I)Lm7d;
    ...
    invoke-direct/range {v3 .. v8}, Ltg1;-><init>(Ljava/lang/Object;Ljava/lang/Object;Landroid/graphics/drawable/Drawable;Lkotlin/coroutines/Continuation;I)V
    ...
    iget-object v1, p0, Lh1e;->o:Lsm8;

    move-object v3, p2

    invoke-direct/range {v0 .. v5}, Lg1e;-><init>(Lsm8;Lone/me/sdk/uikit/common/views/OneMeDraweeView;Landroidx/appcompat/widget/AppCompatImageView;Landroidx/appcompat/widget/AppCompatImageView;Landroid/widget/FrameLayout;)V
