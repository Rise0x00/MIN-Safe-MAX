...
.method public synthetic constructor <init>(Landroidx/viewpager2/widget/ViewPager2;ILone/me/devmenu/DevMenuScreen;)V
    ...
    iput-object p1, p0, Ld80;->c:Ljava/lang/Object;
...
.method public final run()V
    ...
    iget-object v2, v0, Lpfe;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v0, v0, Lpfe;->a:Lk82;

    iget-object v0, v0, Lk82;->a:Lkc8;

    iput v1, v0, Ln82;->v:I

    iget-object v2, v0, Ln82;->h:Lbj7;

    invoke-virtual {v2, v1}, Lemh;->B(I)Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-virtual {v2}, Lbj7;->K()V

    :cond_1
    iget-object v2, v0, Ln82;->e:Lfk7;

    invoke-virtual {v2}, Lemh;->l()I
    ...
    iget-object v4, v2, Lfk7;->v:Landroid/util/Rational;
    ...
    invoke-static {v3, v4}, Lx2k;->b(ILandroid/util/Rational;)Landroid/util/Rational;

    move-result-object v3

    iput-object v3, v2, Lfk7;->v:Landroid/util/Rational;

    :cond_2
    iget-object v0, v0, Ln82;->i:Lzqh;

    invoke-virtual {v0, v1}, Lemh;->B(I)Z
    ...
    iget v8, v0, Lj1e;->n0:I

    iput v3, v0, Lj1e;->n0:I

    if-eq v8, v3, :cond_9

    invoke-static {v3}, Lndh;->n(I)Ljava/lang/String;
    ...
    invoke-static {v7, v8}, Lw8g;->c(Ljava/lang/String;Ljava/lang/String;)V

    if-ne v3, v1, :cond_8

    iget-object v1, v0, Lj1e;->D:Landroid/view/Surface;

    if-nez v1, :cond_7

    iget-object v1, v0, Lj1e;->i0:Lh1e;

    if-eqz v1, :cond_6

    iget-boolean v3, v1, Lh1e;->d:Z
    ...
    :cond_4
    iput-boolean v6, v1, Lh1e;->d:Z

    iget-object v3, v1, Lh1e;->f:Ljava/util/concurrent/ScheduledFuture;

    if-eqz v3, :cond_5

    invoke-interface {v3, v5}, Ljava/util/concurrent/Future;->cancel(Z)Z

    iput-object v2, v1, Lh1e;->f:Ljava/util/concurrent/ScheduledFuture;

    :cond_5
    :goto_0
    iput-object v2, v0, Lj1e;->i0:Lh1e;

    :cond_6
    invoke-virtual {v0, v5}, Lj1e;->v(Z)V

    goto :goto_1

    :cond_7
    iput-boolean v6, v0, Lj1e;->c0:Z

    iget-object v1, v0, Lj1e;->s:Lah0;

    if-eqz v1, :cond_a

    iget-boolean v3, v1, Lah0;->C0:Z

    if-nez v3, :cond_a

    const/4 v3, 0x4

    invoke-virtual {v0, v1, v3, v2}, Lj1e;->s(Lah0;ILjava/lang/Exception;)V
    ...
    invoke-virtual {v0, v1}, Lcu9;->l(I)V
    ...
    iget-object v2, v0, Lx59;->j:Lzu;

    invoke-static {v1}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v1

    invoke-virtual {v2, v1}, Lzu;->remove(Ljava/lang/Object;)Z

    iget-object v1, v0, Lx59;->l:Ln8f;

    if-eqz v1, :cond_b

    iget-object v1, v1, Ln8f;->a:Lm8f;

    invoke-interface {v1}, Lm8f;->f()I
    ...
    iget-object v1, v0, Lx59;->k:Landroid/os/Handler;

    new-instance v2, Ls59;

    invoke-direct {v2, v0, v6}, Ls59;-><init>(Lx59;I)V
    ...
    invoke-virtual {v0, v1}, Lkm5;->O0(I)V
    ...
    iget-object v2, v0, Lml5;->l:Lpl5;

    iget-boolean v0, v0, Lml5;->j:Z

    if-eqz v0, :cond_c

    iget-object v0, v2, Lpl5;->a:Ljava/lang/String;
    ...
    :pswitch_8
    iget-object v0, v2, Lpl5;->l:Ljava/util/ArrayDeque;
    ...
    invoke-static {v6}, Lone/me/devmenu/DevMenuScreen;->d1(Landroid/view/View;)V
    ...
    iget-object v2, v0, Lln4;->a:Lorg/webrtc/VpxDecoderWrapper;
    ...
    invoke-direct {v1, v0, v4}, Ljl4;-><init>(Lru/ok/tamtam/messages/scheduled/DateTimePicker;I)V
    ...
    iget-object v4, v2, Lzjg;->p:Ljava/lang/Object;

    monitor-enter v4

    :try_start_0
    invoke-virtual {v2}, Lzjg;->l()Z

    move-result v5

    if-eqz v5, :cond_11

    iget-object v5, v2, Lzjg;->q:Ljava/util/ArrayList;

    if-eqz v5, :cond_11

    const-string v5, "Close DeferrableSurfaces for CameraDevice error."

    invoke-virtual {v2, v5}, Lzjg;->k(Ljava/lang/String;)V

    iget-object v2, v2, Lzjg;->q:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v1}, Lb72;->a(I)V
    ...
    sget v2, Lone/me/calls/impl/service/CallServiceImpl;->F0:I
    ...
    invoke-virtual {v0, v1, v2}, Lbu1;->A(ILjava/lang/String;)V
    ...
    invoke-static {v2, v3, v4}, Lsb6;->s(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v0, v0, Ljt5;->W0:Lqa;

    new-instance v2, Lkp1;

    invoke-direct {v2, v1, v3}, Lkp1;-><init>(II)V
    ...
    invoke-virtual {v0, v3}, Lqa;->B(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v0, v1}, Lqa;->G(Ljava/lang/Object;)V
    ...
    iget-object v0, v0, Le80;->b:Lf80;

    iget-object v3, v0, Lf80;->c:Lct5;
    ...
    invoke-static {v3, v1, v2, v0}, Ln;->j(Ljava/lang/String;IILjava/lang/String;)V

    goto :goto_b

    :cond_17
    invoke-virtual {v0, v6}, Lf80;->b(I)V

    if-eqz v3, :cond_1f

    iget-object v0, v3, Lct5;->a:Lit5;

    invoke-virtual {v0}, Lit5;->W()Z

    move-result v1

    invoke-virtual {v0, v6, v6, v1}, Lit5;->h0(IIZ)V
    ...
    iget-object v2, v3, Lct5;->a:Lit5;

    invoke-virtual {v2}, Lit5;->W()Z
    ...
    :goto_a
    invoke-virtual {v2, v1, v4, v3}, Lit5;->h0(IIZ)V

    :cond_1a
    invoke-virtual {v0}, Lf80;->a()V
    ...
    invoke-virtual {v0, v1}, Lf80;->b(I)V
    ...
    :cond_1d
    invoke-virtual {v1, v5, v6, v2}, Lit5;->h0(IIZ)V

    :cond_1e
    invoke-virtual {v0, v4}, Lf80;->b(I)V
