...
# direct methods
.method public constructor <init>(Lorg/webrtc/EglBase$Context;Lcwc;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lvha;->a:Lorg/webrtc/EglBase$Context;

    iput-object p2, p0, Lvha;->b:Lcwc;

    new-instance p1, Luth;

    const/4 p2, 0x0

    invoke-direct {p1, p0, p2}, Luth;-><init>(Lvha;I)V

    new-instance p2, Ltif;

    invoke-direct {p2, p1}, Ltif;-><init>(Loi6;)V

    iput-object p2, p0, Lvha;->c:Ltif;
    ...
    iput-object p2, p0, Lvha;->d:Ltif;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lvha;->e:Z
...
# virtual methods
.method public final a(Lorg/webrtc/VideoCodecInfo;)Ltz8;
    .locals 5
    ...
    :cond_1
    iget-boolean v1, p0, Lvha;->e:Z

    if-nez v1, :cond_2

    iget-object v1, p0, Lvha;->d:Ltif;
    ...
    iget-object v2, p0, Lvha;->b:Lcwc;

    invoke-direct {v0, v1, p1, v2}, Ltz8;-><init>(Lorg/webrtc/VideoDecoder;Lorg/webrtc/VideoCodecInfo;Lcwc;)V

    return-object v0

    :cond_2
    :try_start_0
    iget-object v1, p0, Lvha;->c:Ltif;
    ...
    invoke-static {v3, v1, v2, v4}, Lo3h;->p(Ljava/lang/String;Ljava/lang/String;Lcwc;Ljava/lang/String;)V

    move-object v1, v0

    :goto_0
    iget-object v2, p0, Lvha;->d:Ltif;
...
.method public final createDecoder(Lorg/webrtc/VideoCodecInfo;)Lorg/webrtc/VideoDecoder;
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Lvha;->a(Lorg/webrtc/VideoCodecInfo;)Ltz8;
...
.method public final getSupportedCodecs()[Lorg/webrtc/VideoCodecInfo;
    ...
    :try_start_0
    invoke-virtual {p0}, Lvha;->b()[Lorg/webrtc/VideoCodecInfo;
