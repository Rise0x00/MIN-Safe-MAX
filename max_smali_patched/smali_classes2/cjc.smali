...
# instance fields
.field public final A0:Lfza;

.field public final B0:Lfza;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v4, v0, Lcjc;->a:Landroid/animation/FloatEvaluator;
    ...
    iput-object v4, v0, Lcjc;->t0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
    ...
    invoke-virtual {v7, v5}, Lvh4;->i(Landroid/view/View;)Lw5b;

    move-result-object v10

    invoke-interface {v10}, Lw5b;->getIcon()Le77;
    ...
    iput-object v5, v0, Lcjc;->u0:Landroidx/appcompat/widget/AppCompatImageView;

    new-instance v10, Lfza;

    invoke-direct {v10, v1}, Lfza;-><init>(Landroid/content/Context;)V
    ...
    sget-object v2, Lcza;->b:Lcza;

    invoke-virtual {v10, v2}, Lfza;->setMode(Lcza;)V
    ...
    invoke-virtual {v10, v11, v9, v13}, Lfza;->a(FILjava/lang/String;)V

    new-instance v9, Lwic;

    const/4 v13, 0x0

    invoke-direct {v9, v0, v13}, Lwic;-><init>(Lcjc;I)V

    invoke-static {v10, v9}, Llxi;->d(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v10, v0, Lcjc;->v0:Lfza;
    ...
    invoke-virtual {v7, v9}, Lvh4;->i(Landroid/view/View;)Lw5b;
    ...
    iput-object v9, v0, Lcjc;->w0:Landroid/widget/Chronometer;
    ...
    invoke-virtual {v7, v13}, Lvh4;->i(Landroid/view/View;)Lw5b;

    move-result-object v6

    invoke-interface {v6}, Lw5b;->b()Lcf0;

    move-result-object v6

    iget v6, v6, Lcf0;->g:I

    invoke-static {v3, v6}, Lw1f;->e(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-virtual {v7, v3}, Lvh4;->i(Landroid/view/View;)Lw5b;
    ...
    invoke-static {v6, v7}, Lw1f;->e(Landroid/graphics/drawable/Drawable;I)V
    ...
    iput-object v13, v0, Lcjc;->x0:Landroid/widget/LinearLayout;

    new-instance v3, Lfza;

    invoke-direct {v3, v1}, Lfza;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v3, v2}, Lfza;->setMode(Lcza;)V

    new-instance v6, Lwic;

    const/4 v7, 0x1

    invoke-direct {v6, v0, v7}, Lwic;-><init>(Lcjc;I)V

    invoke-static {v3, v6}, Llxi;->d(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v3, v0, Lcjc;->y0:Lfza;

    new-instance v6, Luz1;

    invoke-direct {v6, v1}, Luz1;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v7, v0, v8}, Lwic;-><init>(Lcjc;I)V

    invoke-static {v6, v7}, Llxi;->d(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v6, v0, Lcjc;->z0:Luz1;

    new-instance v7, Lfza;

    invoke-direct {v7, v1}, Lfza;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v7, v2}, Lfza;->setMode(Lcza;)V
    ...
    invoke-virtual {v7, v11, v8, v9}, Lfza;->a(FILjava/lang/String;)V

    new-instance v8, Lwic;

    const/4 v9, 0x3

    invoke-direct {v8, v0, v9}, Lwic;-><init>(Lcjc;I)V

    invoke-static {v7, v8}, Llxi;->d(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v7, v0, Lcjc;->A0:Lfza;

    new-instance v8, Lfza;

    invoke-direct {v8, v1}, Lfza;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v8, v2}, Lfza;->setMode(Lcza;)V

    new-instance v2, Lwic;

    const/4 v9, 0x4

    invoke-direct {v2, v0, v9}, Lwic;-><init>(Lcjc;I)V

    invoke-static {v8, v2}, Llxi;->d(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v8, v0, Lcjc;->B0:Lfza;
    ...
    invoke-direct {v3, v2, v1, v7}, Lni7;-><init>(ILds0;I)V

    const/4 v8, 0x0

    invoke-static {v6, v3, v8}, Lu0i;->b(Landroid/view/View;Lni7;Lqi6;)V

    iput-object v6, v0, Lcjc;->C0:Landroid/widget/FrameLayout;

    new-instance v1, Lxic;

    const/4 v3, 0x0

    invoke-direct {v1, v0, v3}, Lxic;-><init>(Lcjc;I)V

    invoke-static {v2, v1}, Llci;->i(ILoi6;)Lru7;

    move-result-object v1

    iput-object v1, v0, Lcjc;->D0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Lcjc;->E0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Lcjc;->F0:Ljava/lang/Object;
...
.method public static final synthetic a(Lcjc;)Z
    .locals 0

    invoke-direct {p0}, Lcjc;->getCanRecordingVideo()Z
...
.method public static final b(Lcjc;Lwy1;)V
    .locals 6
    ...
    invoke-direct {p0}, Lcjc;->getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    invoke-direct {p0}, Lcjc;->getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    invoke-direct {p0}, Lcjc;->getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    :goto_1
    iget-object v1, p0, Lcjc;->y0:Lfza;

    iget-object v1, v1, Lfza;->c:Lv2b;

    invoke-virtual {v1, v0}, Landroidx/appcompat/widget/AppCompatImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    invoke-static {v5}, Luti;->d(Ljava/lang/String;)Landroid/graphics/Path;

    move-result-object v0

    iput-object v0, v1, Lv2b;->o:Landroid/graphics/Path;
    ...
    invoke-virtual {p0}, Lcjc;->getCameraApi()Lxy1;
    ...
    invoke-interface {p0, p1}, Lxy1;->setFlash(Ljava/lang/String;)V

    return-void
.end method

.method public static final c(Lcjc;FFFFF)V
    .locals 2

    iget-object v0, p0, Lcjc;->u0:Landroidx/appcompat/widget/AppCompatImageView;

    iget-object v1, p0, Lcjc;->a:Landroid/animation/FloatEvaluator;
    ...
    iget-object p0, p0, Lcjc;->C0:Landroid/widget/FrameLayout;
...
.method private final getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lcjc;->D0:Ljava/lang/Object;
...
.method private final getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lcjc;->F0:Ljava/lang/Object;
...
.method private final getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lcjc;->E0:Ljava/lang/Object;
...
.method public final getCameraApi()Lxy1;
    .locals 1

    iget-object v0, p0, Lcjc;->t0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
