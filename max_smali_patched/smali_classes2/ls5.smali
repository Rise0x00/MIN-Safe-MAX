...
.field public final synthetic b:La4h;


# direct methods
.method public constructor <init>(La4h;Llw;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lls5;->b:La4h;

    iput-object p2, p0, Lls5;->a:Llw;
...
.method public final L0(Landroidx/media3/common/PlaybackException;)V
    ...
    :cond_0
    sget-object v0, Landroidx/media3/transformer/ExportException;->b:Lu4e;
    ...
    invoke-virtual {v0, v1}, Lu4e;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v1, p1}, Llw;->d(Landroidx/media3/transformer/ExportException;)V
...
.method public final e0(Lg4h;)V
    ...
    iget-object v0, p0, Lls5;->a:Llw;

    const/4 v1, 0x1

    :try_start_0
    invoke-virtual {p1, v1}, Lg4h;->a(I)Z

    move-result v2

    const/4 v3, 0x2

    invoke-virtual {p1, v3}, Lg4h;->a(I)Z
    ...
    invoke-static {v4, v6, v5}, Lx82;->r(ILjava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    :cond_3
    iget-object p1, p0, Lls5;->b:La4h;

    if-lez v2, :cond_4

    :try_start_1
    invoke-interface {v0, v2}, Llw;->b(I)V

    iget-object p1, p1, La4h;->o:Ljava/lang/Object;

    check-cast p1, Ljt5;

    invoke-virtual {p1}, Ldp0;->play()V
    ...
    iget-object v3, p1, La4h;->b:Ljava/lang/Object;
    ...
    invoke-static {v3, p1}, Lpzj;->b(Landroid/content/Context;Ln99;)Ljava/lang/String;
...
.method public final m0(Lqxg;I)V
    ...
    iget-object p2, p0, Lls5;->a:Llw;

    iget-object v0, p0, Lls5;->b:La4h;
    ...
    invoke-virtual {p1, v2, v1}, Lqxg;->n(ILoxg;)V

    iget-boolean p1, v1, Loxg;->k:Z

    if-nez p1, :cond_3

    iget-wide v1, v1, Loxg;->m:J
    ...
    invoke-interface {p2, v1, v2}, Llw;->e(J)V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
