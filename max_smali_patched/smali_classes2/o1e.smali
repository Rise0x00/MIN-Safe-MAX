...
# direct methods
.method public constructor <init>(Le92;I)V
    .locals 21
    ...
    iput-object v2, v0, Lo1e;->d:Ljava/util/HashMap;

    new-instance v2, Ljava/util/HashMap;

    invoke-direct {v2}, Ljava/util/HashMap;-><init>()V

    iput-object v2, v0, Lo1e;->e:Ljava/util/HashMap;
    ...
    invoke-interface {v1}, Le92;->t()Lql5;

    move-result-object v5

    if-ne v4, v2, :cond_1

    invoke-interface {v1}, Le92;->k()Z

    move-result v2

    if-nez v2, :cond_b

    sget-object v5, Lql5;->r:Lr0k;
    ...
    invoke-direct {v7, v8}, Lnn3;-><init>(Z)V

    invoke-direct {v6, v7}, Ljava/util/TreeMap;-><init>(Ljava/util/Comparator;)V

    sget-object v7, Lzg0;->e:Lzg0;

    new-instance v7, Ljava/util/ArrayList;

    sget-object v9, Lzg0;->m:Ljava/util/List;
    ...
    invoke-static {v10, v12}, Lw8g;->c(Ljava/lang/String;Ljava/lang/String;)V

    invoke-interface {v11}, Lrl5;->d()Ljava/util/List;
    ...
    :cond_3
    invoke-interface {v11}, Lrl5;->a()I

    move-result v15

    invoke-interface {v11}, Lrl5;->b()I

    move-result v16

    invoke-interface {v11}, Lrl5;->c()Ljava/util/List;
    ...
    invoke-direct/range {v14 .. v20}, Lbi0;-><init>(IILjava/util/List;Ljava/util/List;Lpf0;Lrf0;)V
    ...
    invoke-static {v10, v3}, Lw8g;->l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_5
    iget-object v3, v13, Lbi0;->f:Lrf0;
    ...
    invoke-static {v10, v3}, Lw8g;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v3, Lzg0;->f:Lzg0;

    sget-object v4, Lzg0;->e:Lzg0;

    filled-new-array {v2, v3, v4}, [Lzg0;
    ...
    invoke-direct {v5, v1, v2}, Lg4f;-><init>(Le92;Ljava/util/List;)V
    ...
    invoke-direct {v3, v1, v5, v2}, Loh5;-><init>(Le92;Lql5;Lh98;)V

    new-instance v4, Lh7c;

    invoke-direct {v4, v3, v2}, Lh7c;-><init>(Lql5;Lh98;)V

    invoke-interface {v1}, Le92;->b()Ljava/util/Set;
    ...
    iput-object v6, v3, Lz3d;->c:Ljava/lang/Object;

    iput-object v4, v3, Lz3d;->a:Ljava/lang/Object;

    iput-object v5, v3, Lz3d;->b:Ljava/lang/Object;
    ...
    invoke-direct {v5, v1, v4, v2}, Lxcd;-><init>(Le92;Lql5;Lh98;)V

    :cond_b
    :goto_5
    iput-object v5, v0, Lo1e;->b:Lql5;
    ...
    iget-object v5, v0, Lo1e;->b:Lql5;

    invoke-direct {v4, v5, v3}, Lqn8;-><init>(Lql5;Lie5;)V

    new-instance v5, Lcc2;

    iget v6, v0, Lo1e;->c:I

    invoke-direct {v5, v4, v6}, Lcc2;-><init>(Lqn8;I)V

    new-instance v4, Ljava/util/ArrayList;

    iget-object v6, v5, Lcc2;->a:Ljava/util/LinkedHashMap;
    ...
    iget-object v4, v0, Lo1e;->d:Ljava/util/HashMap;
...
# virtual methods
.method public final a(Landroid/util/Size;Lie5;)Lbi0;
    .locals 4

    invoke-virtual {p0, p2}, Lo1e;->d(Lie5;)Lcc2;
    ...
    :cond_0
    iget-object v1, p2, Lcc2;->b:Ljava/util/TreeMap;
    ...
    sget-object p1, Lzg0;->k:Lzg0;

    if-eq v1, p1, :cond_5

    invoke-virtual {p2, v1}, Lcc2;->a(Lzg0;)Lbi0;
...
.method public final b(Lzg0;Lie5;)Lbi0;
    .locals 0
    ...
    :cond_0
    invoke-virtual {p2, p1}, Lcc2;->a(Lzg0;)Lbi0;
...
.method public final c(Lie5;)Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, p1}, Lo1e;->d(Lie5;)Lcc2;
    ...
    iget-object p1, p1, Lcc2;->a:Ljava/util/LinkedHashMap;
...
.method public final d(Lie5;)Lcc2;
    .locals 9
    ...
    iget-object v1, p0, Lo1e;->d:Ljava/util/HashMap;
    ...
    :cond_0
    iget-object v0, p0, Lo1e;->e:Ljava/util/HashMap;
    ...
    iget-object v2, p0, Lo1e;->b:Lql5;

    invoke-direct {v1, v2, p1}, Lqn8;-><init>(Lql5;Lie5;)V

    new-instance v3, Lcc2;

    iget v2, p0, Lo1e;->c:I

    invoke-direct {v3, v1, v2}, Lcc2;-><init>(Lqn8;I)V
