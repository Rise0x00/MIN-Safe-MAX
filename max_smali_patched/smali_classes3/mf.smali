...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmf;->b:Landroid/location/Address;
    ...
    invoke-direct {v0, v1, v2}, Laz8;-><init>(II)V

    invoke-static {v0}, Ljava/util/Collections;->synchronizedMap(Ljava/util/Map;)Ljava/util/Map;

    move-result-object v0

    sput-object v0, Lmf;->c:Ljava/util/Map;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lakg;)V
    .locals 2
...
.method public static d(Landroid/location/Address;Ljava/lang/String;Landroid/location/Address;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lmf;->g(Ljava/lang/String;)Z
...
.method public static g(Ljava/lang/String;)Z
    ...
    invoke-static {p0, v0}, Lis6;->b(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
...
.method public final a(DDDD)F
    ...
    invoke-static/range {p1 .. p8}, Lhxj;->a(DDDD)D
...
.method public final b(DDDDLz84;)Ljava/lang/Object;
    .locals 0

    invoke-virtual {p0, p1, p2, p3, p4}, Lmf;->f(DD)Landroid/location/Address;
    ...
    :cond_0
    invoke-virtual {p0, p5, p6, p7, p8}, Lmf;->f(DD)Landroid/location/Address;
    ...
    invoke-static {p4}, Lmf;->g(Ljava/lang/String;)Z
    ...
    invoke-static {p5}, Lmf;->g(Ljava/lang/String;)Z
    ...
    invoke-static {p4, p6, p5}, Lx82;->m(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p4, p3}, Lmf;->d(Landroid/location/Address;Ljava/lang/String;Landroid/location/Address;)Ljava/lang/String;

    move-result-object p2

    invoke-static {p1, p2, p3}, Lmf;->e(Landroid/location/Address;Ljava/lang/String;Landroid/location/Address;)Ljava/lang/String;

    move-result-object p1

    invoke-static {p1}, Lytg;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p4, p3}, Lmf;->e(Landroid/location/Address;Ljava/lang/String;Landroid/location/Address;)Ljava/lang/String;
    ...
    invoke-static {p3}, Lmf;->g(Ljava/lang/String;)Z

    move-result p4

    if-nez p4, :cond_7

    invoke-static {p3}, Lytg;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_8
    invoke-static {p2}, Lmf;->g(Ljava/lang/String;)Z
    ...
    invoke-static {p2, p3, p1}, Lx82;->m(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final f(DD)Landroid/location/Address;
    ...
    sget-object v0, Lmf;->c:Ljava/util/Map;
    ...
    sget-object v4, Lmf;->b:Landroid/location/Address;
