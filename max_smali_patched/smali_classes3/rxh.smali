...
.method public constructor <init>(Lvxh;Z)V
    ...
    iput-object p1, p0, Lrxh;->b:Lvxh;

    iput-boolean p2, p0, Lrxh;->a:Z
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object p1, p0, Lrxh;->b:Lvxh;

    iget-object p1, p1, Lvxh;->a:Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lrxh;->b:Lvxh;

    iget-boolean v1, v0, Lvxh;->B0:Z

    if-nez v1, :cond_9

    iget-object v0, v0, Lvxh;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v1, v0, Lvxh;->A0:Lhyh;

    if-eqz v1, :cond_8

    iget-object v2, v0, Lvxh;->Y:Ljava/util/LinkedHashMap;
    ...
    :cond_2
    iget-object v8, v0, Lvxh;->z0:[F

    iget-object v9, v0, Lvxh;->Z:[F

    invoke-virtual {v7, v8, v9, v6}, Lygg;->J([F[FZ)V

    :try_start_0
    iget-object v7, v0, Lvxh;->z0:[F

    iget-boolean v8, p0, Lrxh;->a:Z

    invoke-virtual {v1, p1, v5, v7, v8}, Lhyh;->x(Landroid/graphics/SurfaceTexture;Landroid/view/Surface;[FZ)V
    :try_end_0
    ...
    invoke-static {v6, v7, v5}, Lnm4;->m0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    goto :goto_0

    :cond_3
    iget-object v5, v0, Lvxh;->a:Ljava/lang/String;
    ...
    iget-boolean v0, p1, Lvxh;->D0:Z

    if-nez v0, :cond_7

    iput-boolean v6, p1, Lvxh;->D0:Z
    ...
    :cond_6
    :goto_1
    iget-object p1, p1, Lvxh;->X:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iget-object v1, v0, Lwxh;->b:Landroid/os/Handler;

    iget-object v0, v0, Lwxh;->a:Lgyh;
