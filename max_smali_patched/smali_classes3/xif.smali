...
.method public final run()V
    ...
    iget-object v1, v0, Lbjf;->d:Lorg/webrtc/PeerConnectionFactory;

    const/4 v2, 0x0

    if-eqz v1, :cond_3

    iget-object v4, v0, Lbjf;->j:Loy4;

    if-eqz v4, :cond_2

    iget-object v5, v0, Lbjf;->k:Lq1c;

    invoke-virtual {v4, v5}, Loy4;->b(Lj09;)V

    :cond_2
    invoke-virtual {v1}, Lorg/webrtc/PeerConnectionFactory;->dispose()V

    iget-object v4, v0, Lbjf;->b:Lnrd;
    ...
    iput-object v2, v0, Lbjf;->d:Lorg/webrtc/PeerConnectionFactory;

    :cond_3
    iget-object v1, v0, Lbjf;->m:Lv98;
    ...
    :cond_4
    iget-object v1, v0, Lbjf;->h:Lxd5;

    if-eqz v1, :cond_5

    iget-object v1, v1, Lxd5;->Y:Ljava/lang/Object;

    invoke-interface {v1}, Ls45;->dispose()V

    iput-object v2, v0, Lbjf;->h:Lxd5;

    :cond_5
    iget-object v1, v0, Lbjf;->g:Lorg/webrtc/audio/JavaAudioDeviceModule;

    if-eqz v1, :cond_6

    invoke-interface {v1}, Lorg/webrtc/audio/AudioDeviceModule;->release()V

    iput-object v2, v0, Lbjf;->g:Lorg/webrtc/audio/JavaAudioDeviceModule;

    :cond_6
    iget-object v1, v0, Lbjf;->n:Lhti;
