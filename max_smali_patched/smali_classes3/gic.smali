...
# direct methods
.method public constructor <init>(ILcic;Lt9f;Liz5;Lq98;)V
    .locals 3
    ...
    iget-object p3, p3, Lt9f;->f:Llo3;

    invoke-interface {p3}, Llo3;->a()J
    ...
    invoke-interface {p3}, Llo3;->c()J

    move-result-wide v1

    :goto_2
    invoke-direct {p2, p0, v1, v2, p5}, Lo9f;-><init>(Lgic;JLq98;)V
    ...
    invoke-direct {p1, p0, p4, p2}, Ly9f;-><init>(Lgic;Liz5;Lq98;)V
...
.method public final a(Ll9f;)J
    ...
    :cond_2
    :goto_0
    iget-object v0, p0, Lgic;->e:Lm9f;

    invoke-virtual {v0, p1}, Lm9f;->y(Ll9f;)J
...
.method public final b()V
    ...
    :cond_1
    iget-object v0, p0, Lgic;->c:Lt9f;

    iget v1, p0, Lgic;->a:I

    invoke-virtual {v0, v1}, Lt9f;->j(I)V
    :try_end_0
...
.method public final f(I)V
    ...
    :try_start_0
    iget-object v1, v0, Lt9f;->t:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v1}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    iget-wide v1, v0, Lt9f;->p:J

    int-to-long v3, p1

    add-long/2addr v1, v3

    iput-wide v1, v0, Lt9f;->p:J

    iget-wide v1, v0, Lt9f;->p:J

    iget-wide v3, v0, Lt9f;->q:J

    sub-long/2addr v1, v3

    iget-wide v3, v0, Lt9f;->r:J

    cmp-long p1, v1, v3

    if-lez p1, :cond_0

    iget-object p1, v0, Lt9f;->b:Lcic;

    new-instance v1, Lgb4;

    iget-wide v2, v0, Lt9f;->p:J

    const/4 v4, 0x1

    invoke-direct {v1, v4}, Lgb4;-><init>(I)V

    iput-wide v2, v1, Lgb4;->b:J
    ...
    :cond_0
    :goto_0
    iget-object p1, v0, Lt9f;->t:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    :goto_1
    iget-object v0, v0, Lt9f;->t:Ljava/util/concurrent/locks/ReentrantLock;
