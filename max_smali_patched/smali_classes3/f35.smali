...
.method public final a(Ljava/lang/Long;Ljava/lang/Long;J)V
    ...
    invoke-virtual {p2, v5, v6}, Lwl2;->N(J)Lej2;
    ...
    invoke-virtual {p1, v5, v6}, Lwl2;->T(J)Lej2;
    ...
    iget-object p2, p2, Lwm2;->e0:Lqcb;

    if-nez p2, :cond_3

    const-string p1, "draft is null, ignore"

    invoke-static {v1, p1, v4}, Lnm4;->L(Ljava/lang/String;Ljava/lang/String;Ljava/util/concurrent/CancellationException;)V

    return-void

    :cond_3
    invoke-virtual {p2}, Lqcb;->d()Ljava/lang/Long;
    ...
    iget-wide p3, p1, Lej2;->a:J

    invoke-virtual {p2, p3, p4}, Lwl2;->D(J)V
