...
.method public constructor <init>(Lt25;)V
    ...
    iput-object p1, p0, Le4h;->a:Lt25;

    new-instance p1, Ljava/util/concurrent/atomic/LongAdder;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/LongAdder;-><init>()V

    iput-object p1, p0, Le4h;->b:Ljava/util/concurrent/atomic/LongAdder;

    new-instance p1, Ljava/util/concurrent/atomic/LongAdder;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/LongAdder;-><init>()V

    iput-object p1, p0, Le4h;->c:Ljava/util/concurrent/atomic/LongAdder;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicLong;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicLong;-><init>()V

    iput-object p1, p0, Le4h;->d:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iput-object p1, p0, Le4h;->e:Ljava/util/concurrent/atomic/LongAccumulator;

    new-instance p1, Ljava/util/concurrent/atomic/LongAdder;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/LongAdder;-><init>()V

    iput-object p1, p0, Le4h;->f:Ljava/util/concurrent/atomic/LongAdder;

    new-instance p1, Ljava/util/concurrent/atomic/LongAdder;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/LongAdder;-><init>()V

    iput-object p1, p0, Le4h;->g:Ljava/util/concurrent/atomic/LongAdder;
...
.method public final a(I)Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Le4h;->b:Ljava/util/concurrent/atomic/LongAdder;

    invoke-virtual {v2, v0, v1}, Ljava/util/concurrent/atomic/LongAdder;->add(J)V

    iget-object v2, p0, Le4h;->d:Ljava/util/concurrent/atomic/AtomicLong;

    invoke-virtual {v2, v0, v1}, Ljava/util/concurrent/atomic/AtomicLong;->addAndGet(J)J

    iget-object v0, p0, Le4h;->f:Ljava/util/concurrent/atomic/LongAdder;
...
.method public final b(Ljava/nio/ByteBuffer;)V
    ...
    iget-object v2, p0, Le4h;->c:Ljava/util/concurrent/atomic/LongAdder;
    ...
    iget-object v5, p0, Le4h;->e:Ljava/util/concurrent/atomic/LongAccumulator;
    ...
    iget-object v0, p0, Le4h;->g:Ljava/util/concurrent/atomic/LongAdder;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/LongAdder;->increment()V

    iget-object v0, p0, Le4h;->a:Lt25;

    invoke-virtual {v0, p1}, Lt25;->b(Ljava/nio/ByteBuffer;)V
