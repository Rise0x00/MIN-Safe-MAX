...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lpbd;->a:Landroid/graphics/Paint;
    ...
    invoke-direct {v0, p0, v6}, Lobd;-><init>(Lpbd;I)V

    invoke-virtual {p1, v0}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iput-object p1, p0, Lpbd;->c:Landroid/animation/ValueAnimator;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lpbd;->d:Landroid/graphics/RectF;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lpbd;->z0:Landroid/graphics/RectF;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lpbd;->A0:Landroid/graphics/RectF;

    const-wide v3, 0xff29e056L

    long-to-int p1, v3

    iput p1, p0, Lpbd;->D0:I
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v0, p0, Lpbd;->c:Landroid/animation/ValueAnimator;

    invoke-virtual {v0}, Landroid/animation/ValueAnimator;->cancel()V

    iget-object v0, p0, Lpbd;->B0:Landroid/animation/ValueAnimator;
    ...
    :cond_0
    iget-object v0, p0, Lpbd;->C0:Landroid/animation/ValueAnimator;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v0, p0, Lpbd;->F0:Z

    iget-object v1, p0, Lpbd;->d:Landroid/graphics/RectF;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lpbd;->o:Landroid/graphics/RectF;
    ...
    iget-object v3, p0, Lpbd;->z0:Landroid/graphics/RectF;
    ...
    iget-object v7, p0, Lpbd;->a:Landroid/graphics/Paint;
...
.method public final setOnQrAnimationCompleteListener(Lxs6;)V
    .locals 0
    ...
    iput-object p1, p0, Lpbd;->G0:Lxs6;
