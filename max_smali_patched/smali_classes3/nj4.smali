...
.field public final z0:Ljava/util/concurrent/locks/Condition;


# direct methods
.method public constructor <init>(Llj4;Lyxb;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Thread;-><init>()V

    iput-object p2, p0, Lnj4;->a:Lyxb;

    const/16 p2, 0x1e

    iput p2, p0, Lnj4;->b:I

    iput-object p1, p0, Lnj4;->c:Llj4;

    new-instance p1, Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;-><init>()V

    iput-object p1, p0, Lnj4;->d:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iput-object p1, p0, Lnj4;->o:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {p1}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object p1, p0, Lnj4;->Z:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {p1}, Ljava/util/concurrent/locks/ReentrantLock;->newCondition()Ljava/util/concurrent/locks/Condition;

    move-result-object p1

    iput-object p1, p0, Lnj4;->z0:Ljava/util/concurrent/locks/Condition;

    new-instance p1, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {p1}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object p1, p0, Lnj4;->A0:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public final run()V
    ...
    :cond_0
    :goto_0
    iget-boolean v0, p0, Lnj4;->B0:Z

    const/4 v1, 0x0

    if-nez v0, :cond_1b

    iget-object v0, p0, Lnj4;->A0:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v0}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_0
    iget-object v2, p0, Lnj4;->c:Llj4;
    ...
    iget-object v2, v2, Llj4;->a:Lorg/webrtc/DataChannel;
    ...
    iget-object v0, p0, Lnj4;->X:Lll;

    if-nez v0, :cond_7

    iget-object v0, p0, Lnj4;->d:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    :cond_4
    :try_start_1
    iget-object v0, p0, Lnj4;->Z:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    :try_start_2
    iget-object v2, p0, Lnj4;->z0:Ljava/util/concurrent/locks/Condition;
    ...
    :cond_9
    iget-object v0, p0, Lnj4;->o:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {v2, v7, v8}, Llj4;->e(I[B)Z
    ...
    iget-object v2, v2, Lyxb;->b:Ljava/lang/Object;

    check-cast v2, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v2}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iput-object v1, p0, Lnj4;->X:Lll;
    :try_end_6
