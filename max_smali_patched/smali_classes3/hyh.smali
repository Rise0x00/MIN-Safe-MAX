...
# direct methods
.method public constructor <init>(Landroid/util/Size;Lie5;)V
    .locals 5

    invoke-direct {p0}, Ly55;-><init>()V

    iput-object p1, p0, Lhyh;->o:Landroid/util/Size;
    ...
    iput-object v0, p0, Lhyh;->p:Ljava/lang/String;

    const/16 v1, 0x10

    new-array v1, v1, [F

    iput-object v1, p0, Lhyh;->t:[F
    ...
    invoke-virtual {p0, p2}, Ly55;->o(Lie5;)Lxf0;
...
.method public final r()V
    ...
    iget-object v0, p0, Lhyh;->p:Ljava/lang/String;

    const-string v1, "release"

    invoke-static {v0, v1}, Lnm4;->p0(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lhyh;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v0, p0, Lhyh;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    iget-object v2, p0, Lhyh;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    :cond_1
    iput-object v0, p0, Lhyh;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    iget-object v2, p0, Lhyh;->q:Lh2g;

    if-eqz v2, :cond_2

    iget-object v3, v2, Lh2g;->d:Ljava/lang/String;

    invoke-static {v3, v1}, Lnm4;->p0(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, v2, Lh2g;->e:Lone/me/sdk/gl/effects/VideoMessageStencilHolder;

    invoke-virtual {v1}, Lone/me/sdk/gl/effects/VideoMessageStencilHolder;->release()V

    iget-object v1, v2, Lh2g;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;

    invoke-virtual {v1}, Lone/me/sdk/gl/effects/objects/FrameBuffer;->release()V

    :cond_2
    iput-object v0, p0, Lhyh;->q:Lh2g;

    iput-object v0, p0, Lhyh;->w:Lpbh;

    invoke-super {p0}, Ly55;->r()V
...
.method public final x(Landroid/graphics/SurfaceTexture;Landroid/view/Surface;[FZ)V
    ...
    invoke-virtual {v1, v0}, Ly55;->m(Landroid/view/Surface;)Lqg0;

    move-result-object v2

    sget-object v3, Lxu6;->j:Lqg0;

    invoke-virtual {v2, v3}, Lqg0;->equals(Ljava/lang/Object;)Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-virtual {v1, v0}, Ly55;->i(Landroid/view/Surface;)Lqg0;
    ...
    :cond_0
    iget-object v3, v1, Ly55;->d:Ljava/lang/Object;
    ...
    :cond_1
    iget-object v3, v1, Ly55;->c:Ljava/lang/Object;

    check-cast v3, Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 v8, 0x1

    invoke-static {v3, v8}, Lxu6;->d(Ljava/util/concurrent/atomic/AtomicBoolean;Z)V

    iget-object v3, v1, Ly55;->e:Ljava/lang/Object;
    ...
    iget v11, v2, Lqg0;->b:I

    iget v12, v2, Lqg0;->c:I

    iget-object v9, v2, Lqg0;->a:Landroid/opengl/EGLSurface;

    invoke-virtual/range {p1 .. p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v13

    iget-object v2, v1, Lhyh;->q:Lh2g;
    ...
    invoke-direct {v2, v5}, Lh2g;-><init>(Landroid/util/Size;)V

    iput-object v2, v1, Lhyh;->q:Lh2g;

    :cond_2
    move-object v10, v2

    iget-object v2, v1, Lhyh;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    iput-object v2, v1, Lhyh;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    :cond_3
    iget-object v5, v1, Lhyh;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v5, v1, Lhyh;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    :cond_4
    iget-wide v6, v1, Lhyh;->u:J
    ...
    :cond_6
    :goto_0
    iget-object v6, v10, Lh2g;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;

    invoke-virtual {v6}, Lone/me/sdk/gl/effects/objects/FrameBuffer;->bind()V

    iget v6, v10, Lh2g;->b:I

    iget v7, v10, Lh2g;->c:I
    ...
    iget-object v9, v10, Lh2g;->e:Lone/me/sdk/gl/effects/VideoMessageStencilHolder;

    iget-object v4, v10, Lh2g;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;

    invoke-virtual {v4}, Lone/me/sdk/gl/effects/objects/FrameBuffer;->getTextureId()I

    move-result v4

    iget-object v5, v10, Lh2g;->a:Landroid/util/Size;
    ...
    iget-object v5, v1, Ly55;->k:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v3}, Ly55;->p(Landroid/opengl/EGLSurface;)V

    iput-object v0, v1, Ly55;->k:Ljava/lang/Object;

    :cond_7
    invoke-static {v4, v4, v13, v12}, Landroid/opengl/GLES20;->glViewport(IIII)V

    iget-object v5, v2, Lh2g;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;
    ...
    iget-object v5, v1, Lhyh;->w:Lpbh;

    const/16 v8, 0x10

    if-eqz v5, :cond_9

    iget-object v2, v2, Lh2g;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;
    ...
    iget-object v2, v1, Lhyh;->w:Lpbh;

    if-eqz v2, :cond_8

    invoke-virtual {v2, v11}, Lpbh;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_9
    :goto_2
    iget-object v2, v1, Ly55;->f:Ljava/lang/Object;
    ...
    iget-object v11, v1, Lhyh;->p:Ljava/lang/String;

    invoke-static {}, Landroid/opengl/EGL14;->eglGetError()I

    move-result v2

    invoke-static {v8}, Lhk0;->s(I)V
    ...
    invoke-static {v8, v2, v3}, Ll0k;->d(IJ)Ljava/lang/String;
    ...
    :cond_b
    invoke-virtual {v1, v0, v4}, Ly55;->t(Landroid/view/Surface;Z)V
