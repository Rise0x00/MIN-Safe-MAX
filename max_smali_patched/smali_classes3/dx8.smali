...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget v2, Lagd;->markdown_dot_size:I
    ...
    sget v3, Lagd;->markdown_button_size:I
    ...
    iput-object v5, p0, Ldx8;->a:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-static {v8, v7}, Ltla;->P(ILandroid/graphics/drawable/Drawable;)V

    invoke-virtual {v6, v7}, Landroid/view/View;->setBackground(Landroid/graphics/drawable/Drawable;)V

    iput-object v6, p0, Ldx8;->b:Landroid/view/View;
    ...
    invoke-static {v3, v2}, Lmbg;->e0(ILjava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    sget-object v2, Luqd;->MarkdownItemView:[I
    ...
    sget v0, Luqd;->MarkdownItemView_miv_title:I
    ...
    invoke-virtual {p0, v0}, Ldx8;->setTitle(I)V

    :cond_1
    sget v0, Luqd;->MarkdownItemView_miv_highlight_title:I

    invoke-virtual {p1, v0, v1}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v0

    invoke-virtual {p0, v0, v1}, Ldx8;->a(ZZ)V

    invoke-virtual {p1}, Landroid/content/res/TypedArray;->recycle()V

    invoke-virtual {p0}, Ldx8;->c()V
...
.method public final a(ZZ)V
    ...
    invoke-direct {p1, v0, v1}, Loh;-><init>(Ljava/lang/Float;Ljava/lang/Float;)V

    iget-boolean v2, p0, Ldx8;->c:Z
    ...
    invoke-direct {p1, v1, v0}, Loh;-><init>(Ljava/lang/Float;Ljava/lang/Float;)V
    ...
    iget-object v1, p1, Loh;->b:Ljava/lang/Float;
    ...
    invoke-static {p0}, Lcgj;->b(Landroid/widget/LinearLayout;)Lti;

    move-result-object p2

    invoke-virtual {p2}, Lti;->a()Z
    ...
    iget-object v0, p0, Ldx8;->d:Landroid/animation/ObjectAnimator;
    ...
    iput-object v0, p0, Ldx8;->d:Landroid/animation/ObjectAnimator;

    :cond_4
    iget-object v0, p1, Loh;->a:Ljava/lang/Float;
    ...
    iget-object p2, p2, Lti;->a:Lzp4;

    const-wide/16 v1, 0xc8

    invoke-virtual {v0, v1, v2}, Landroid/animation/ObjectAnimator;->setDuration(J)Landroid/animation/ObjectAnimator;

    iget-boolean v1, p0, Ldx8;->c:Z

    if-eqz v1, :cond_5

    invoke-virtual {p2}, Lzp4;->T()Landroid/view/animation/Interpolator;
    ...
    :cond_5
    invoke-virtual {p2}, Lzp4;->W()Landroid/view/animation/Interpolator;
    ...
    invoke-direct {p2, p0, v1, p1}, Lmh;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final c()V
    ...
    iget-object v1, p0, Ldx8;->a:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public final setTitle(I)V
    ...
    iget-object v0, p0, Ldx8;->a:Landroidx/appcompat/widget/AppCompatTextView;
