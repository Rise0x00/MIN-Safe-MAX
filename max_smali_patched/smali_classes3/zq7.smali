...
.method public synthetic constructor <init>(Ljava/lang/String;I)V
    ...
    iput-object p1, p0, Lzq7;->b:Ljava/lang/String;
...
.method public synthetic constructor <init>(Ljava/lang/String;Lb9a;)V
    .locals 0
...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v8, v1, Lzq7;->b:Ljava/lang/String;
    ...
    invoke-static {v0, v8}, Landroidx/work/impl/model/WorkersQueueDao_Impl;->g(Lsie;Ljava/lang/String;)Lyeh;
    ...
    :try_start_0
    invoke-interface {v2, v7, v8}, Lyie;->I(ILjava/lang/String;)V
    ...
    :goto_0
    invoke-static {v5}, Lq0k;->b(Ljava/lang/Integer;)Lzkh;
    ...
    invoke-interface {v6, v0}, Lsie;->B0(Ljava/lang/String;)Lyie;

    move-result-object v6

    :try_start_3
    invoke-interface {v6, v7, v8}, Lyie;->I(ILjava/lang/String;)V
    ...
    invoke-interface {v6, v8}, Lyie;->isNull(I)Z
    ...
    :cond_2
    invoke-interface {v6, v8}, Lyie;->f0(I)Ljava/lang/String;
    ...
    invoke-static {v2}, Lnm4;->e0(Ljava/lang/String;)Ljava/util/EnumSet;
    ...
    :goto_4
    invoke-interface {v6, v11}, Lyie;->isNull(I)Z
    ...
    :cond_4
    invoke-interface {v6, v11}, Lyie;->getBlob(I)[B
    ...
    invoke-static {v3, v2}, Lav9;->mergeFrom(Lav9;[B)Lav9;
    ...
    :goto_7
    invoke-interface {v6, v12}, Lyie;->isNull(I)Z
    ...
    :cond_6
    invoke-interface {v6, v12}, Lyie;->getBlob(I)[B

    move-result-object v2

    :goto_8
    invoke-static {v2}, Lnm4;->F([B)Ljava/util/Map;
    ...
    :cond_7
    invoke-interface {v6, v13}, Lyie;->getBlob(I)[B

    move-result-object v2

    :goto_9
    invoke-static {v2}, Lnm4;->G([B)Ljava/util/List;
    ...
    invoke-direct {v3, v8}, Lhk6;-><init>(I)V

    invoke-static {v3, v2}, Lav9;->mergeFrom(Lav9;[B)Lav9;

    invoke-static {v3}, Lmtd;->u(Lhk6;)Ljava/util/EnumSet;
    ...
    :cond_a
    invoke-interface {v6, v4}, Lyie;->getBlob(I)[B

    move-result-object v2

    :goto_d
    invoke-static {v2}, Lnm4;->f([B)Ljava/util/ArrayList;
    ...
    :cond_c
    invoke-interface {v6, v7}, Lyie;->getLong(I)J
    ...
    :goto_f
    new-instance v19, Lnce;

    move/from16 v22, v0

    invoke-direct/range {v19 .. v34}, Lnce;-><init>(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/util/Set;ZLjava/util/List;Ljava/util/Map;Ljava/util/List;Ljava/util/Set;JLjava/util/List;Ljava/lang/Long;Ljava/lang/Long;)V
    :try_end_3
    ...
    :try_start_4
    invoke-interface {v2, v0, v8}, Lyie;->I(ILjava/lang/String;)V
    ...
    new-instance v10, Lt1g;

    invoke-direct {v10}, Lt1g;-><init>()V

    invoke-static {v10, v9}, Lav9;->mergeFrom(Lav9;[B)Lav9;
    ...
    :goto_13
    new-instance v18, Lc9a;

    invoke-direct/range {v18 .. v26}, Lc9a;-><init>(Ljava/lang/String;Ljava/lang/String;JLt1g;JZ)V
    ...
    :try_start_7
    invoke-interface {v4, v0, v8}, Lyie;->I(ILjava/lang/String;)V
    ...
    invoke-interface {v4, v9}, Lyie;->isNull(I)Z
    ...
    invoke-static {v5}, Lk3k;->b(I)Lmr7;
    ...
    invoke-interface {v4, v15}, Lyie;->getLong(I)J
    ...
    invoke-direct/range {v17 .. v35}, Lnr7;-><init>(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;BBJLjava/lang/Long;Ljava/lang/String;Lmr7;JJJI)V
    :try_end_7
