...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbo1;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    return-void
.end method

.method public constructor <init>(Lnrd;Landroid/opengl/EGLContext;[ILh2j;Ljava/lang/String;)V
    .locals 13

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lbo1;->a:Lnrd;

    move-object/from16 v0, p4

    iput-object v0, p0, Lbo1;->b:Lh2j;
    ...
    iput-object v0, p0, Lbo1;->c:Landroid/os/HandlerThread;

    sget-object v1, Landroid/opengl/EGL14;->EGL_NO_SURFACE:Landroid/opengl/EGLSurface;

    iput-object v1, p0, Lbo1;->g:Landroid/opengl/EGLSurface;

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, Lbo1;->h:Ljava/lang/Object;
    ...
    :goto_1
    iput-object v2, p0, Lbo1;->j:Ljava/lang/String;
    ...
    invoke-direct/range {v5 .. v12}, Lh2j;-><init>(ILjava/lang/Object;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;II)V

    invoke-direct {v3, v0, p1, v4, v5}, Lj2j;-><init>(Landroid/os/Looper;Lnrd;Ljava/lang/String;Lh2j;)V

    iput-object v3, p0, Lbo1;->k:Lj2j;
    ...
    invoke-interface {p1, v2, p2}, Lnrd;->log(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
...
.method public final b(Landroid/opengl/EGLSurface;)V
    ...
    iget-object v0, p0, Lbo1;->d:Landroid/opengl/EGLContext;

    if-eqz v0, :cond_3

    iget-object v1, p0, Lbo1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v3, p0, Lbo1;->d:Landroid/opengl/EGLContext;
    ...
    iget-object v2, p0, Lbo1;->g:Landroid/opengl/EGLSurface;
    ...
    iput-object p1, p0, Lbo1;->g:Landroid/opengl/EGLSurface;
...
.method public final c(Lzs6;)Z
    .locals 3

    :try_start_0
    iget-object v0, p0, Lbo1;->k:Lj2j;

    new-instance v1, Lao1;

    const/4 v2, 0x1

    invoke-direct {v1, p1, p0, v2}, Lao1;-><init>(Lzs6;Lbo1;I)V
    ...
    iget-object v0, p0, Lbo1;->j:Ljava/lang/String;

    const-string v1, "OpenGL tread died, is it fine?"

    iget-object v2, p0, Lbo1;->a:Lnrd;
...
.method public final d(Landroid/opengl/EGLSurface;)V
    ...
    iget-object v0, p0, Lbo1;->e:Landroid/opengl/EGLDisplay;

    if-eqz v0, :cond_0

    invoke-static {v0, p1}, Landroid/opengl/EGL14;->eglDestroySurface(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;)Z

    sget-object p1, Lbo1;->l:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Lbo1;->a:Lnrd;

    iget-object v1, p0, Lbo1;->j:Ljava/lang/String;
