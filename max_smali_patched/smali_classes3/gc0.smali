...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v3, p0, Lgc0;->B0:Landroid/graphics/Paint;

    new-instance v6, Landroid/graphics/Paint;

    invoke-direct {v6, v3}, Landroid/graphics/Paint;-><init>(Landroid/graphics/Paint;)V

    iput-object v6, p0, Lgc0;->C0:Landroid/graphics/Paint;
    ...
    iput-object v3, p0, Lgc0;->D0:Landroid/graphics/Paint;
    ...
    iput-object v3, p0, Lgc0;->E0:Landroid/graphics/Paint;

    new-instance v3, Landroid/graphics/Path;

    invoke-direct {v3}, Landroid/graphics/Path;-><init>()V

    iput-object v3, p0, Lgc0;->F0:Landroid/graphics/Path;
    ...
    invoke-direct {v1, v2, p0}, Lu40;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p1, v1}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iput-object p1, p0, Lgc0;->G0:Landroid/animation/ValueAnimator;
    ...
    invoke-virtual {p0, p1}, Lgc0;->onThemeChanged(Ldqb;)V
...
.method public final a()V
    ...
    iget-object v0, p0, Lgc0;->z0:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, Lgc0;->F0:Landroid/graphics/Path;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lgc0;->F0:Landroid/graphics/Path;
    ...
    iget-object v6, p0, Lgc0;->B0:Landroid/graphics/Paint;

    if-nez v2, :cond_3

    iget-boolean v2, p0, Lgc0;->J0:Z
    ...
    invoke-static {v5, v8, v4, v7}, Ls54;->b(FFII)I
    ...
    iget-object v9, p0, Lgc0;->C0:Landroid/graphics/Paint;
    ...
    iget-object v2, p0, Lgc0;->E0:Landroid/graphics/Paint;

    invoke-virtual {p1, v8, v0, v1, v2}, Landroid/graphics/Canvas;->drawCircle(FFFLandroid/graphics/Paint;)V

    iget-object v1, p0, Lgc0;->D0:Landroid/graphics/Paint;
...
.method public final onSizeChanged(IIII)V
    ...
    invoke-virtual {p0}, Lgc0;->getPeaksCount()I
    ...
    iget-object p1, p0, Lgc0;->K0:Lec0;
    ...
    sget-object p2, Lone/me/sdk/messagewrite/recordcontrols/RecordControlsWidget;->p1:[Lb88;
    ...
    iget-object p1, v1, Ldc0;->n:Ljava/lang/Integer;
    ...
    iget-object p1, v1, Ldc0;->l:Ljava/lang/Float;

    invoke-static {p1, v3}, Lsr6;->e(Ljava/lang/Float;F)Z

    move-result p1

    if-eqz p1, :cond_1

    iget-object p1, v1, Ldc0;->m:Ljava/lang/Float;

    invoke-static {p1, v4}, Lsr6;->e(Ljava/lang/Float;F)Z
    ...
    :cond_1
    :goto_0
    iget-object p1, v1, Ldc0;->g:Lkotlinx/coroutines/internal/ContextScope;
...
.method public final onThemeChanged(Ldqb;)V
    ...
    :goto_0
    iget-object v1, p0, Lgc0;->B0:Landroid/graphics/Paint;

    invoke-virtual {v1, v0}, Landroid/graphics/Paint;->setColor(I)V

    invoke-interface {p1}, Ldqb;->getIcon()Lzpb;

    iget-object v0, p0, Lgc0;->D0:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Lgc0;->E0:Landroid/graphics/Paint;

    invoke-virtual {v0, p1}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p1, p0, Lgc0;->C0:Landroid/graphics/Paint;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_3
    invoke-virtual {p0, p1}, Lgc0;->b(Landroid/view/MotionEvent;)F

    move-result v0

    iput v0, p0, Lgc0;->o:F

    iget-object v0, p0, Lgc0;->K0:Lec0;
    ...
    invoke-virtual {v1}, Lgc0;->getDuration()J
    ...
    invoke-static {v3, v4}, Lgyj;->c(J)Ljava/lang/String;
    ...
    iget-object v0, v0, Lcai;->D0:Landroid/widget/TextView;
    ...
    invoke-interface {v0, v3, v4}, Lxi8;->seekTo(J)V
...
.method public final setLinesColor(I)V
    ...
    iget-object v0, p0, Lgc0;->B0:Landroid/graphics/Paint;
...
.method public final setListener(Lec0;)V
    .locals 0

    iput-object p1, p0, Lgc0;->K0:Lec0;
...
.method public final setShiftOffset(J)V
    ...
    iget-object v0, p0, Lgc0;->G0:Landroid/animation/ValueAnimator;
