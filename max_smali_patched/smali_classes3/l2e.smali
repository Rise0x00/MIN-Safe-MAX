...
# direct methods
.method public constructor <init>(Ljava/time/Clock;Llc5;)V
    .locals 1
    ...
    iput-object v0, p0, Ll2e;->c:Ljava/util/concurrent/ConcurrentLinkedDeque;

    new-instance v0, Ljava/util/concurrent/ConcurrentLinkedDeque;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentLinkedDeque;-><init>()V

    iput-object v0, p0, Ll2e;->d:Ljava/util/concurrent/ConcurrentLinkedDeque;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Ll2e;->e:Ljava/lang/Object;

    iput-object p1, p0, Ll2e;->a:Ljava/time/Clock;

    iput-object p2, p0, Ll2e;->b:Llc5;
...
.method public final a(Leic;Ljava/util/function/Consumer;)V
    ...
    iget-object v1, p0, Ll2e;->c:Ljava/util/concurrent/ConcurrentLinkedDeque;
    ...
    invoke-direct {v0, p1, p2}, Lux5;-><init>(Leic;Ljava/util/function/Consumer;)V
...
.method public final b(Z)V
    ...
    iput-boolean v0, p0, Ll2e;->g:Z

    iget-object v0, p0, Ll2e;->c:Ljava/util/concurrent/ConcurrentLinkedDeque;

    invoke-virtual {v0}, Ljava/util/concurrent/ConcurrentLinkedDeque;->clear()V

    iget-object v0, p0, Ll2e;->d:Ljava/util/concurrent/ConcurrentLinkedDeque;

    invoke-virtual {v0}, Ljava/util/concurrent/ConcurrentLinkedDeque;->clear()V

    if-eqz p1, :cond_0

    iget-object p1, p0, Ll2e;->e:Ljava/lang/Object;
    ...
    :try_start_0
    iput-object v0, p0, Ll2e;->f:Ljava/time/Instant;
