...
# direct methods
.method public constructor <init>(JJJJJLjava/lang/String;Ljava/lang/String;Lkw9;Ljava/util/List;Ljava/util/List;Z)V
    .locals 0

    invoke-direct/range {p0 .. p2}, Llo;-><init>(J)V

    iput-wide p3, p0, Ljea;->d:J

    iput-wide p5, p0, Ljea;->e:J

    iput-wide p7, p0, Ljea;->f:J

    iput-wide p9, p0, Ljea;->g:J

    iput-object p13, p0, Ljea;->h:Lkw9;

    iput-object p14, p0, Ljea;->i:Ljava/util/List;

    iput-object p15, p0, Ljea;->j:Ljava/util/List;

    move/from16 p1, p16

    iput-boolean p1, p0, Ljea;->k:Z
    ...
    :cond_0
    iput-object p11, p0, Ljea;->l:Ljava/lang/String;
    ...
    :cond_1
    iput-object p12, p0, Ljea;->m:Ljava/lang/String;
...
.method public final b(Lxng;)V
    ...
    iget-object v0, v7, Lcs9;->A0:Lkw9;
    ...
    invoke-direct/range {v4 .. v9}, Ljs;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    iget-object p1, v5, Las9;->a:Lsj4;
    ...
    invoke-virtual {p1, v4}, Lpk4;->a(Lxs6;)Ljava/lang/Object;

    iget-object p1, v8, Llo;->c:Lmo;
    ...
    :goto_3
    invoke-virtual {p1}, Lmo;->c()Lwl2;

    move-result-object p1

    iget-wide v4, v8, Ljea;->d:J

    invoke-virtual {p1, v4, v5}, Lwl2;->Q(J)Lej2;

    move-result-object p1

    iget-object v0, v7, Lcs9;->Y0:Lgy4;
    ...
    invoke-virtual {p1, v4, v5}, Lwl2;->L(J)V
    ...
    iget-wide v3, v7, Lfo0;->a:J

    const/4 v5, 0x0

    iget-wide v1, v8, Ljea;->d:J
...
.method public final e(Leng;)V
    ...
    iget-wide v3, p0, Ljea;->e:J

    invoke-virtual {v1, v3, v4}, Las9;->n(J)Lcs9;
    ...
    invoke-virtual {p1, v1}, Lm60;->b(Lcs9;)V
    ...
    iget-wide v4, p0, Ljea;->d:J

    iget-wide v6, p0, Llo;->a:J

    move-object v8, p1

    invoke-direct/range {v3 .. v8}, Ljf5;-><init>(JJLeng;)V
...
.method public final f()I
    ...
    :goto_1
    invoke-virtual {v5}, Lmo;->c()Lwl2;

    move-result-object v5

    iget-wide v6, v0, Ljea;->d:J
    ...
    :goto_2
    invoke-virtual {v8}, Lmo;->g()Loqg;

    move-result-object v8

    sget-object v9, Le6c;->z0:Le6c;

    iget-wide v10, v0, Llo;->a:J

    invoke-virtual {v8, v10, v11, v9}, Loqg;->h(JLe6c;)Ljava/util/List;
    ...
    iget-object v9, v9, Laqg;->f:Ld6c;

    check-cast v9, Ljea;

    iget-wide v14, v9, Ljea;->d:J

    cmp-long v14, v14, v6

    if-nez v14, :cond_3

    iget-wide v14, v9, Ljea;->e:J
    ...
    invoke-static {v13, v1}, Lnm4;->y(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v3, v1, Lcs9;->E0:Lps0;
    ...
    iget-boolean v14, v0, Ljea;->k:Z

    if-eqz v14, :cond_10

    sget-object v15, Ly50;->c:Ly50;

    invoke-virtual {v1, v15}, Lcs9;->v(Ly50;)Z
    ...
    iget-object v15, v3, Lps0;->a:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v10, v11}, Loqg;->j(J)Laqg;
    ...
    iget-wide v3, v0, Ljea;->f:J

    invoke-virtual {v1, v3, v4, v2}, Lw5b;->z(JLjava/util/List;)J
    ...
    :goto_7
    invoke-virtual {v2}, Lmo;->g()Loqg;

    move-result-object v1

    invoke-virtual {v1, v10, v11}, Loqg;->c(J)V

    invoke-static {v13, v9}, Lnm4;->y(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final g()V
    ...
    invoke-virtual {v2, v0, v3}, Las9;->s(Lcs9;Lhs9;)V
    ...
    iget-object v9, p0, Ljea;->i:Ljava/util/List;

    iget-boolean v10, p0, Ljea;->k:Z

    iget-wide v2, p0, Ljea;->e:J

    iget-wide v4, p0, Ljea;->d:J

    iget-object v6, p0, Ljea;->m:Ljava/lang/String;

    iget-object v7, p0, Ljea;->j:Ljava/util/List;

    iget-object v8, p0, Ljea;->h:Lkw9;

    invoke-virtual/range {v1 .. v10}, Llf5;->a(JJLjava/lang/String;Ljava/util/List;Lkw9;Ljava/util/List;Z)V
...
.method public final j()[B
    ...
    iput-object v1, v2, Lf60;->a:Ljava/util/List;

    invoke-virtual {v2}, Lf60;->c()Lps0;
    ...
    :cond_0
    iget-object v1, p0, Ljea;->j:Ljava/util/List;
...
.method public final l()Lp2;
    ...
    invoke-static {v3, v4}, Lsw8;->d(Lps0;Lm16;)Ly30;
    ...
    :goto_3
    iget-object v3, v2, Lcs9;->U0:Ljava/util/List;

    if-eqz v3, :cond_6

    invoke-static {v3}, Lsw8;->r(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    iget-object v9, p0, Ljea;->l:Ljava/lang/String;

    iget-object v12, v2, Lcs9;->X0:Lhy4;

    iget-wide v7, p0, Ljea;->g:J

    invoke-direct/range {v4 .. v12}, Lk36;-><init>(JJLjava/lang/String;Ly30;Ljava/util/ArrayList;Lhy4;)V
