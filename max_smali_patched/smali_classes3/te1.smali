...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lte1;->i:Ljava/util/List;

    return-void
.end method

.method public constructor <init>(Lru/ok/android/externcalls/analytics/CallAnalyticsSender;Lvwg;Lzga;Lxq0;Ldu5;Lnrd;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lte1;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;

    iput-object p2, p0, Lte1;->b:Lvwg;

    iput-object p3, p0, Lte1;->c:Lzga;

    iput-object p4, p0, Lte1;->d:Lxq0;

    iput-object p5, p0, Lte1;->e:Ldu5;

    iput-object p6, p0, Lte1;->f:Lnrd;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lte1;->h:Ljava/util/ArrayList;
...
.method public final b(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    iget-object v0, p0, Lte1;->h:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lte1;->h:Ljava/util/ArrayList;

    invoke-static {v1}, Lij3;->I1(Ljava/lang/Iterable;)Ljava/util/List;

    move-result-object v1

    iget-object v2, p0, Lte1;->h:Ljava/util/ArrayList;
    ...
    iget-object v2, v1, Lf2j;->c:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
    ...
    iget-object v3, v1, Lf2j;->d:Ljava/lang/Long;
    ...
    iget-object v6, v1, Lf2j;->a:Ljava/lang/String;

    iget-object v1, v1, Lf2j;->b:Lru/ok/android/externcalls/analytics/events/EventItemValue;
    ...
    iget-object v2, p0, Lte1;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;
...
.method public final c(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    iget-object v1, p0, Lte1;->b:Lvwg;

    check-cast v1, Lxwg;

    invoke-virtual {v1}, Lxwg;->a()Ljava/lang/Long;

    move-result-object v1

    invoke-direct {v0, p1, p2, p3, v1}, Lf2j;-><init>(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;Ljava/lang/Long;)V

    iget-object v2, p0, Lte1;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;

    if-nez v2, :cond_0

    iget-object p1, p0, Lte1;->h:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_0
    iget-object p2, p0, Lte1;->h:Ljava/util/ArrayList;
    ...
    iget-object p2, p0, Lte1;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;
...
.method public final onTopologyUpdated(Lc1h;Lc1h;)V
    ...
    iget-object p1, p0, Lte1;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;

    iget-object p2, p0, Lte1;->e:Ldu5;

    iget-object v0, p0, Lte1;->d:Lxq0;

    iget-object v1, p0, Lte1;->c:Lzga;

    if-eqz p1, :cond_0

    invoke-virtual {v1, p1}, Lzga;->i(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    invoke-virtual {v0, p1}, Lxq0;->h(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    invoke-virtual {p2, p1}, Ldu5;->s(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    invoke-virtual {p0, p1}, Lte1;->b(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    :goto_0
    iput-object p1, p0, Lte1;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
