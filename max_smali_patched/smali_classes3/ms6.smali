...
.method public synthetic constructor <init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V
    ...
    iput-object p1, p0, Lms6;->b:Lru/ok/messages/media/crop/FrgTamCropImage;
...
.method public accept(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lms6;->b:Lru/ok/messages/media/crop/FrgTamCropImage;

    invoke-virtual {p1}, Lru/ok/messages/views/fragments/base/FrgBase;->l0()Lo7;
    ...
    invoke-static {v1, v0, v2}, Lzyj;->b(ILandroid/content/Context;Ljava/lang/String;)V
...
.method public run()V
    ...
    iget-object v0, p0, Lms6;->b:Lru/ok/messages/media/crop/FrgTamCropImage;

    invoke-virtual {v0}, Lru/ok/messages/views/fragments/base/FrgBase;->l0()Lo7;
    ...
    iget-object v3, v3, Lone/me/image/crop/view/ImageCropView;->a:Lgy6;

    invoke-virtual {v3}, Llw7;->getInitialMatrix()Landroid/graphics/Matrix;

    move-result-object v4

    iget-object v3, v3, Li6h;->A0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v3}, Lone/me/image/crop/view/ImageCropView;->getCropState()Lxe4;
    ...
    :goto_1
    iget-object v1, v1, Lone/me/image/crop/view/ImageCropView;->a:Lgy6;

    invoke-virtual {v1}, Li6h;->getViewBitmap()Landroid/graphics/Bitmap;

    move-result-object v2

    invoke-virtual {v1}, Li6h;->getImageOutputPath()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v1}, Llw7;->getCropState()Lxe4;
    ...
    iget-object v5, v1, Lxe4;->c:[F

    iget-object v1, v1, Lxe4;->a:Landroid/graphics/RectF;
    ...
    invoke-static {v4}, Lr8g;->b(Landroid/graphics/Matrix;)F
    ...
    iget-object v2, p0, Lms6;->b:Lru/ok/messages/media/crop/FrgTamCropImage;

    invoke-direct {v0, v2, v1}, Lms6;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V

    new-instance v1, Lzo3;

    const/4 v3, 0x1

    invoke-direct {v1, v3, v0}, Lzo3;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v3, v2, v4}, Lms6;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V

    new-instance v4, Lms6;

    const/4 v5, 0x7

    invoke-direct {v4, v2, v5}, Lms6;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V

    new-instance v2, Ll12;

    const/4 v5, 0x0

    invoke-direct {v2, v4, v5, v3}, Ll12;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    :try_start_2
    new-instance v3, Lep3;

    invoke-direct {v3, v2, v1}, Lep3;-><init>(Lfp3;Lqne;)V
    ...
    iget-object v0, v0, Lone/me/image/crop/view/ImageCropView;->a:Lgy6;

    const/4 v1, 0x0

    iput v1, v0, Llw7;->L0:F

    invoke-virtual {v0}, Llw7;->a()V
    ...
    iget-object v2, v1, Llw7;->I0:Landroid/graphics/RectF;
    ...
    iget-object v4, v1, Li6h;->A0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v1, v4}, Li6h;->setImageMatrix(Landroid/graphics/Matrix;)V
    ...
    iget-object v2, v1, Llw7;->J0:Landroid/graphics/Matrix;
    ...
    iget-object v3, v1, Llw7;->K0:Landroid/graphics/RectF;

    iget-object v1, v1, Llw7;->I0:Landroid/graphics/RectF;
    ...
    iget-object v2, v2, Lone/me/image/crop/view/ImageCropView;->a:Lgy6;

    iget-object v3, v2, Llw7;->I0:Landroid/graphics/RectF;
    ...
    iget-object v6, v2, Li6h;->A0:Landroid/graphics/Matrix;

    const/high16 v7, 0x42b40000    # 90.0f

    invoke-virtual {v6, v7, v5, v3}, Landroid/graphics/Matrix;->postRotate(FFF)Z

    invoke-virtual {v2, v6}, Li6h;->setImageMatrix(Landroid/graphics/Matrix;)V

    iget-object v2, v0, Lru/ok/messages/media/crop/FrgTamCropImage;->y1:Lone/me/image/crop/view/ImageCropView;

    iget-object v2, v2, Lone/me/image/crop/view/ImageCropView;->b:Lqxb;

    iget v3, v2, Lqxb;->z0:F

    div-float v3, v4, v3

    iput v3, v2, Lqxb;->z0:F

    iget-object v5, v2, Lqxb;->a:Landroid/graphics/RectF;

    invoke-virtual {v2, v5, v3}, Lqxb;->a(Landroid/graphics/RectF;F)V

    invoke-virtual {v2}, Lqxb;->b()V

    iget-object v3, v2, Lqxb;->S0:Lrxb;
    ...
    invoke-virtual {v3, v5}, Llw7;->setCropRect(Landroid/graphics/RectF;)V
    ...
    iget-object v3, v2, Llw7;->J0:Landroid/graphics/Matrix;
    ...
    iget-object v4, v2, Llw7;->K0:Landroid/graphics/RectF;

    iget-object v2, v2, Llw7;->I0:Landroid/graphics/RectF;
    ...
    iget-object v1, v3, Lone/me/image/crop/view/ImageCropView;->a:Lgy6;

    iget-object v3, v1, Llw7;->I0:Landroid/graphics/RectF;
    ...
    iget-object v5, v1, Li6h;->A0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v1, v5}, Li6h;->setImageMatrix(Landroid/graphics/Matrix;)V
