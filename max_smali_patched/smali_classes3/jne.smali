...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ljne;->D0:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Ljava/lang/Long;Ldng;Lia8;)V
    .locals 2

    invoke-direct {p0}, Lw4i;-><init>()V

    iput-object p1, p0, Ljne;->b:Ljava/lang/Long;

    iput-object p2, p0, Ljne;->c:Ldng;
    ...
    iput-object v0, p0, Ljne;->d:Lb1g;

    new-instance v1, Lbwd;

    invoke-direct {v1, v0}, Lbwd;-><init>(Lvia;)V

    iput-object v1, p0, Ljne;->o:Lbwd;

    iput-object p3, p0, Ljne;->X:Lia8;

    invoke-static {p1}, Lc1g;->a(Ljava/lang/Object;)Lb1g;

    move-result-object p3

    iput-object p3, p0, Ljne;->Y:Lb1g;

    new-instance v0, Lbwd;

    invoke-direct {v0, p3}, Lbwd;-><init>(Lvia;)V

    iput-object v0, p0, Ljne;->Z:Lbwd;
    ...
    iput-object p3, p0, Ljne;->z0:Lbja;

    sget-object p3, Lpj5;->a:Lpj5;

    iput-object p3, p0, Ljne;->A0:Ljava/lang/Object;

    new-instance p3, Lfde;

    const/4 v0, 0x4

    invoke-direct {p3, v0, p0}, Lfde;-><init>(ILjava/lang/Object;)V

    new-instance v0, Lakg;

    invoke-direct {v0, p3}, Lakg;-><init>(Lxs6;)V

    iput-object v0, p0, Ljne;->B0:Lakg;
    ...
    invoke-direct {v0, p0, p1, v1}, Lctb;-><init>(Ljava/lang/Object;Lkotlin/coroutines/Continuation;I)V

    const/4 v1, 0x2

    invoke-static {p3, p2, p1, v0, v1}, Ly6j;->L(Loc4;Lfc4;Lrc4;Lnt6;I)Lhyf;

    new-instance p2, Lzo5;

    invoke-direct {p2, p1}, Lzo5;-><init>(Ljava/lang/String;)V

    iput-object p2, p0, Ljne;->C0:Lzo5;

    return-void
.end method

.method public static final u(Ljne;)Ljava/util/ArrayList;
    .locals 23

    move-object/from16 v0, p0

    iget-object v1, v0, Ljne;->B0:Lakg;
    ...
    invoke-direct/range {v10 .. v17}, Lol4;-><init>(JIIILjava/lang/String;Litg;)V
    ...
    invoke-direct/range {v14 .. v21}, Lol4;-><init>(JIIILjava/lang/String;Litg;)V
    ...
    :cond_8
    iput-object v3, v0, Ljne;->A0:Ljava/lang/Object;

    return-object v3
.end method

.method public static v(Ljne;Ljava/util/List;Lol4;II)Lfne;
    .locals 16
    ...
    iget v10, v0, Lol4;->d:I

    if-ne v9, v10, :cond_0

    iget v9, v7, Lol4;->c:I

    iget v10, v0, Lol4;->c:I
    ...
    invoke-static {v10, v1, v2, v3}, Ljne;->w(Ljava/util/List;IILjava/util/Calendar;)Lfne;
    ...
    invoke-static {v1, v5, v0}, Lnm4;->o(III)I

    move-result v1

    invoke-static {v5}, Lagj;->a(I)Ljava/util/ArrayList;

    move-result-object v4

    add-int/lit8 v6, v0, 0x1

    invoke-static {v4, v6}, Lij3;->D1(Ljava/lang/Iterable;I)Ljava/util/List;
    ...
    :goto_6
    invoke-static {v2, v5, v0}, Lnm4;->o(III)I

    move-result v1

    invoke-static {v5}, Lagj;->b(I)Ljava/util/ArrayList;

    move-result-object v2

    add-int/lit8 v0, v0, 0x1

    invoke-static {v2, v0}, Lij3;->D1(Ljava/lang/Iterable;I)Ljava/util/List;
    ...
    invoke-direct/range {v9 .. v15}, Lfne;-><init>(Ljava/util/List;Ljava/util/List;Ljava/util/List;III)V
    ...
    invoke-static {v11}, Ljj3;->L0(Ljava/util/List;)I
...
.method public static w(Ljava/util/List;IILjava/util/Calendar;)Lfne;
    .locals 11
    ...
    invoke-static {p1, v3, v1}, Lnm4;->o(III)I
    ...
    invoke-static {v0}, Lagj;->a(I)Ljava/util/ArrayList;
    ...
    invoke-static {p2, v3, v1}, Lnm4;->o(III)I
    ...
    :cond_5
    invoke-static {p3}, Lagj;->b(I)Ljava/util/ArrayList;
    ...
    invoke-direct/range {v4 .. v10}, Lfne;-><init>(Ljava/util/List;Ljava/util/List;Ljava/util/List;III)V
...
.method public final x()V
    ...
    :cond_0
    iget-object v1, p0, Ljne;->A0:Ljava/lang/Object;

    iget-object v2, v0, Lcl4;->a:Lol4;

    iget-object v3, v0, Lcl4;->b:Lqwg;
    ...
    invoke-static {p0, v1, v2, v3, v0}, Ljne;->v(Ljne;Ljava/util/List;Lol4;II)Lfne;

    move-result-object v0

    invoke-virtual {p0, v0}, Ljne;->y(Lfne;)V

    return-void
.end method

.method public final y(Lfne;)V
    .locals 5
    ...
    iget-object v2, p1, Lfne;->a:Ljava/util/List;
    ...
    iget-object v3, p1, Lfne;->b:Ljava/util/List;
    ...
    iget-object v4, p1, Lfne;->c:Ljava/util/List;
    ...
    invoke-direct {v0, v2, v3, p1}, Lcl4;-><init>(Lol4;Lqwg;Lqwg;)V

    iget-object p1, p0, Ljne;->Y:Lb1g;
