...
# direct methods
.method public constructor <init>(Ljava/time/Clock;Lx1e;Lmhe;Ljqa;Ls1e;Ltbe;)V
    .locals 2
    ...
    iput-wide v0, p0, Ljt8;->i:J

    iput-object p1, p0, Ljt8;->a:Ljava/time/Clock;

    iput-object p2, p0, Ljt8;->b:Lx1e;

    iput-object p3, p0, Ljt8;->c:Lmhe;

    iput-object p4, p0, Ljt8;->d:Ljqa;

    iput-object p5, p0, Ljt8;->e:Ls1e;

    iput-object p6, p0, Ljt8;->f:Ltbe;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>()V

    iput-object p1, p0, Ljt8;->h:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Ljt8;->g:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final declared-synchronized a()V
    ...
    :try_start_0
    iget-object v0, p0, Ljt8;->g:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Ljt8;->d:Ljqa;

    invoke-virtual {v1, v0}, Ljqa;->b(Ljava/util/List;)V

    iget-object v0, p0, Ljt8;->h:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-object v0, p0, Ljt8;->j:Ljava/time/Instant;

    iput-object v0, p0, Ljt8;->k:Ljava/time/Instant;

    const/4 v0, 0x1

    iput-boolean v0, p0, Ljt8;->l:Z
    :try_end_0
...
.method public final b()V
    ...
    :cond_0
    iget-object v0, p0, Ljt8;->c:Lmhe;

    invoke-virtual {v0}, Lmhe;->b()I

    move-result v0

    iget-object v1, p0, Ljt8;->c:Lmhe;
    ...
    iget-object v1, p0, Ljt8;->a:Ljava/time/Clock;
    ...
    iget-object v1, p0, Ljt8;->g:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {v4, p0, v5, v0}, Lns4;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object v5, p0, Ljt8;->h:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-direct {v5, p0, v6}, Lht8;-><init>(Ljt8;I)V

    invoke-interface {v4, v5}, Ljava/util/stream/Stream;->forEach(Ljava/util/function/Consumer;)V

    iget-object v4, p0, Ljt8;->e:Ls1e;

    invoke-virtual {v4}, Ls1e;->run()V

    iget-object v4, p0, Ljt8;->d:Ljqa;
    ...
    iget-wide v9, v4, Ljqa;->b:J

    sub-long/2addr v9, v7

    iput-wide v9, v4, Ljqa;->b:J

    iget-object v9, v4, Ljqa;->d:Lv1f;

    invoke-virtual {v9}, Lv1f;->k()V
    ...
    invoke-virtual {v4}, Ljqa;->a()V

    iget-object v7, v4, Ljqa;->a:Lxp8;

    iget-wide v8, v4, Ljqa;->b:J
    ...
    invoke-direct {v6, v7}, Lmh8;-><init>(I)V
    ...
    iget-object v5, v5, Lqyb;->a:Ljava/time/Instant;

    iget-object v6, v4, Ljqa;->f:Ljava/time/Instant;
    ...
    iput-object v5, v4, Ljqa;->f:Ljava/time/Instant;

    iget-wide v5, v4, Ljqa;->c:J
    ...
    iput-wide v7, v4, Ljqa;->c:J

    :cond_2
    iget-wide v5, v4, Ljqa;->c:J

    iput-wide v5, v4, Ljqa;->e:J
    ...
    invoke-direct {v4, p0, v5}, Lht8;-><init>(Ljt8;I)V
    ...
    invoke-direct {v4, p0, v5}, Lgt8;-><init>(Ljt8;I)V
    ...
    invoke-direct {v4, v5}, Lmh8;-><init>(I)V
