...
.method public constructor <init>(Lqph;)V
    ...
    iput-object p1, p0, Lndd;->d:Lq7h;

    return-void
.end method

.method public constructor <init>(Lqph;Lq7h;)V
    .locals 0
...
.method public static c(IJLjava/nio/ByteBuffer;)V
    ...
    invoke-static {p0, p3}, Ln1k;->c(ILjava/nio/ByteBuffer;)I
    ...
    invoke-static {p1, p2, p3}, Ln1k;->d(JLjava/nio/ByteBuffer;)I
...
.method public static d(ILjava/nio/ByteBuffer;[B)V
    ...
    invoke-static {p0, p1}, Ln1k;->c(ILjava/nio/ByteBuffer;)I
...
.method public final a()[B
    ...
    sget-object v2, Lqph;->b:Lqph;

    iget-object v3, p0, Lndd;->a:Lqph;

    invoke-virtual {v3, v2}, Lqph;->equals(Ljava/lang/Object;)Z

    move-result v2

    if-nez v2, :cond_1

    invoke-virtual {v3}, Lqph;->b()Z
    ...
    iget-object v4, p0, Lndd;->d:Lq7h;

    if-ne v3, v2, :cond_2

    iget-object v5, v4, Lq7h;->a:[B

    invoke-static {v0, v1, v5}, Lndd;->d(ILjava/nio/ByteBuffer;[B)V

    :cond_2
    iget-wide v5, v4, Lq7h;->b:J

    const/4 v7, 0x1

    invoke-static {v7, v5, v6, v1}, Lndd;->c(IJLjava/nio/ByteBuffer;)V

    if-ne v3, v2, :cond_3

    iget-object v5, v4, Lq7h;->q:[B

    if-eqz v5, :cond_3

    invoke-static {v2, v1, v5}, Lndd;->d(ILjava/nio/ByteBuffer;[B)V
    ...
    iget-wide v5, v4, Lq7h;->c:J

    const/4 v7, 0x4

    invoke-static {v7, v5, v6, v1}, Lndd;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lq7h;->d:J

    const/4 v8, 0x5

    invoke-static {v8, v5, v6, v1}, Lndd;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lq7h;->e:J

    const/4 v8, 0x6

    invoke-static {v8, v5, v6, v1}, Lndd;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lq7h;->f:J

    const/4 v8, 0x7

    invoke-static {v8, v5, v6, v1}, Lndd;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lq7h;->g:J

    const/16 v8, 0x8

    invoke-static {v8, v5, v6, v1}, Lndd;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lq7h;->h:J
    ...
    iget-boolean v5, v4, Lq7h;->j:Z

    if-eqz v5, :cond_4

    const/16 v5, 0xc

    invoke-static {v5, v1}, Ln1k;->c(ILjava/nio/ByteBuffer;)I
    ...
    invoke-static {v0, v5, v6, v1}, Lndd;->c(IJLjava/nio/ByteBuffer;)V

    iget-object v0, v4, Lq7h;->n:[B

    const/16 v5, 0xf

    invoke-static {v5, v1, v0}, Lndd;->d(ILjava/nio/ByteBuffer;[B)V

    if-ne v3, v2, :cond_5

    iget-object v0, v4, Lq7h;->o:[B

    if-eqz v0, :cond_5

    const/16 v3, 0x10

    invoke-static {v3, v1, v0}, Lndd;->d(ILjava/nio/ByteBuffer;[B)V

    :cond_5
    iget-object v0, v4, Lq7h;->r:Lb8f;
    ...
    invoke-direct {v0, v5, v6}, Lyt;-><init>(Ljava/nio/ByteBuffer;I)V
    ...
    invoke-static {v0, v3, v4, v1}, Lndd;->c(IJLjava/nio/ByteBuffer;)V
...
.method public final e(Ljava/nio/ByteBuffer;Ljava/util/HashSet;Lxp8;)V
    .locals 11
    ...
    invoke-static {p1}, Ln1k;->f(Ljava/nio/ByteBuffer;)I
    ...
    invoke-interface {p3, v0, v1}, Lxp8;->o([BLjava/lang/String;)V

    iput-object v0, v6, Lq7h;->a:[B
    ...
    invoke-interface {p3, v2}, Lxp8;->e(Ljava/lang/String;)V

    iput-wide v0, v6, Lq7h;->b:J
    ...
    invoke-interface {p3, v1}, Lxp8;->e(Ljava/lang/String;)V

    iput-object v0, v6, Lq7h;->q:[B
    ...
    invoke-interface {p3, v0}, Lxp8;->e(Ljava/lang/String;)V

    iput-boolean v5, v6, Lq7h;->j:Z
    ...
    invoke-direct {p3, v0, v1}, Lqn8;-><init>(IZ)V
    ...
    iput-object v0, p3, Lqn8;->b:Ljava/lang/Object;
    ...
    iput-object v0, p3, Lqn8;->c:Ljava/lang/Object;
    ...
    iget-object v0, p3, Lqn8;->b:Ljava/lang/Object;

    check-cast v0, Ljava/net/InetAddress;

    if-nez v0, :cond_14

    iget-object v0, p3, Lqn8;->c:Ljava/lang/Object;
    ...
    iput-object v0, p3, Lqn8;->d:Ljava/lang/Object;
    ...
    invoke-direct {v2, v1}, Lqph;-><init>(I)V
    ...
    invoke-direct {v2, p3}, Lqph;-><init>(I)V

    const/16 p3, 0xc

    invoke-direct {v1, v2, p3, v0}, Lb8f;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    iput-object v1, v6, Lq7h;->r:Lb8f;
