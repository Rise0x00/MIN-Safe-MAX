...
# instance fields
.field public final A0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;

.field public final B0:Landroidx/appcompat/widget/AppCompatImageView;

.field public final C0:Lnhb;

.field public final D0:Landroid/widget/Chronometer;

.field public final E0:Landroid/widget/LinearLayout;

.field public final F0:Lnhb;

.field public final G0:Lx72;

.field public final H0:Lnhb;

.field public final I0:Lnhb;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v4, v0, Lged;->a:Landroid/animation/FloatEvaluator;
    ...
    iput-object v4, v0, Lged;->A0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
    ...
    invoke-virtual {v10, v7}, Lz66;->d(Landroid/content/Context;)Lzc3;
    ...
    iput-object v5, v0, Lged;->B0:Landroidx/appcompat/widget/AppCompatImageView;

    new-instance v7, Lnhb;

    invoke-direct {v7, v1}, Lnhb;-><init>(Landroid/content/Context;)V
    ...
    sget-object v2, Lkhb;->b:Lkhb;

    invoke-virtual {v7, v2}, Lnhb;->setMode(Lkhb;)V
    ...
    invoke-virtual {v7, v11, v9, v13}, Lnhb;->a(FILjava/lang/String;)V

    new-instance v9, Lced;

    const/4 v13, 0x0

    invoke-direct {v9, v0, v13}, Lced;-><init>(Lged;I)V

    invoke-static {v7, v9}, Ls5b;->H(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v7, v0, Lged;->C0:Lnhb;
    ...
    invoke-virtual {v10, v13}, Lz66;->d(Landroid/content/Context;)Lzc3;
    ...
    iput-object v9, v0, Lged;->D0:Landroid/widget/Chronometer;
    ...
    invoke-virtual {v10, v6}, Lz66;->d(Landroid/content/Context;)Lzc3;
    ...
    invoke-static {v6, v3}, Ltla;->P(ILandroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v10, v8}, Lz66;->d(Landroid/content/Context;)Lzc3;
    ...
    invoke-interface {v8}, Ldqb;->m()Ltpb;
    ...
    iput-object v13, v0, Lged;->E0:Landroid/widget/LinearLayout;

    new-instance v3, Lnhb;

    invoke-direct {v3, v1}, Lnhb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v3, v2}, Lnhb;->setMode(Lkhb;)V

    new-instance v6, Lced;

    const/4 v8, 0x1

    invoke-direct {v6, v0, v8}, Lced;-><init>(Lged;I)V

    invoke-static {v3, v6}, Ls5b;->H(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v3, v0, Lged;->F0:Lnhb;

    new-instance v6, Lx72;

    invoke-direct {v6, v1}, Lx72;-><init>(Landroid/content/Context;)V
    ...
    new-instance v8, Lced;

    const/4 v9, 0x2

    invoke-direct {v8, v0, v9}, Lced;-><init>(Lged;I)V

    invoke-static {v6, v8}, Ls5b;->H(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v6, v0, Lged;->G0:Lx72;

    new-instance v8, Lnhb;

    invoke-direct {v8, v1}, Lnhb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v8, v2}, Lnhb;->setMode(Lkhb;)V
    ...
    invoke-virtual {v8, v11, v9, v10}, Lnhb;->a(FILjava/lang/String;)V

    new-instance v9, Lced;

    const/4 v10, 0x3

    invoke-direct {v9, v0, v10}, Lced;-><init>(Lged;I)V

    invoke-static {v8, v9}, Ls5b;->H(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v8, v0, Lged;->H0:Lnhb;

    new-instance v9, Lnhb;

    invoke-direct {v9, v1}, Lnhb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v9, v2}, Lnhb;->setMode(Lkhb;)V

    new-instance v2, Lced;

    const/4 v10, 0x4

    invoke-direct {v2, v0, v10}, Lced;-><init>(Lged;I)V

    invoke-static {v9, v2}, Ls5b;->H(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v9, v0, Lged;->I0:Lnhb;
    ...
    invoke-direct {v3, v2, v1, v7}, Ldv7;-><init>(ILxy0;I)V

    const/4 v8, 0x0

    invoke-static {v6, v3, v8}, Lg84;->H(Landroid/view/View;Ldv7;Lzs6;)V

    iput-object v6, v0, Lged;->J0:Landroid/widget/FrameLayout;

    new-instance v1, Lded;

    const/4 v3, 0x0

    invoke-direct {v1, v0, v3}, Lded;-><init>(Lged;I)V

    invoke-static {v2, v1}, Ltf3;->M(ILxs6;)Lia8;

    move-result-object v1

    iput-object v1, v0, Lged;->K0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Lged;->L0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Lged;->M0:Ljava/lang/Object;
...
.method public static final synthetic a(Lged;)Z
    .locals 0

    invoke-direct {p0}, Lged;->getCanRecordingVideo()Z
...
.method public static final b(Lged;Lz62;)V
    .locals 6
    ...
    invoke-direct {p0}, Lged;->getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    invoke-direct {p0}, Lged;->getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    invoke-direct {p0}, Lged;->getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    :goto_1
    iget-object v1, p0, Lged;->F0:Lnhb;

    sget v2, Lged;->N0:F

    invoke-virtual {v1, v0, v5, v2}, Lnhb;->b(Landroid/graphics/drawable/Drawable;Ljava/lang/String;F)V

    invoke-virtual {p0}, Lged;->getCameraApi()La72;
    ...
    invoke-interface {p0, p1}, La72;->setFlash(Ljava/lang/String;)V

    return-void
.end method

.method public static final c(Lged;FFFFF)V
    .locals 2

    iget-object v0, p0, Lged;->B0:Landroidx/appcompat/widget/AppCompatImageView;

    iget-object v1, p0, Lged;->a:Landroid/animation/FloatEvaluator;
    ...
    iget-object p0, p0, Lged;->J0:Landroid/widget/FrameLayout;
...
.method private final getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lged;->K0:Ljava/lang/Object;
...
.method private final getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lged;->M0:Ljava/lang/Object;
...
.method private final getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lged;->L0:Ljava/lang/Object;
...
.method public final getCameraApi()La72;
    .locals 1

    iget-object v0, p0, Lged;->A0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
