...
.method public constructor <init>()V
    ...
    iput-wide v0, p0, Lldd;->b:J

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lldd;->c:Ljava/util/ArrayList;
...
# virtual methods
.method public abstract a(Lhdd;Lvk;)I
.end method

.method public final b(Lkdd;)V
    .locals 1

    iget-object v0, p0, Lldd;->c:Ljava/util/ArrayList;
...
.method public abstract i(Lzd;)[B
.end method
...
.method public final j(I)Ljava/nio/ByteBuffer;
    ...
    iget-object v1, p0, Lldd;->c:Ljava/util/ArrayList;
    ...
    invoke-direct {v2, v0, v3}, Lyt;-><init>(Ljava/nio/ByteBuffer;I)V
    ...
    invoke-direct {v1, v2}, Lryb;-><init>(I)V

    iget-object p1, p0, Lldd;->c:Ljava/util/ArrayList;

    invoke-virtual {p1, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v1, v0}, Lryb;->g(Ljava/nio/ByteBuffer;)V
...
.method public abstract l()Lvl5;
.end method

.method public m()Ljava/lang/Long;
    .locals 4

    iget-wide v0, p0, Lldd;->b:J
...
.method public abstract s(Ljava/nio/ByteBuffer;Lzd;JLxp8;I)V
.end method

.method public final t(Ljava/nio/ByteBuffer;BILzd;JLxp8;)V
    .locals 22
    ...
    invoke-interface {v4, v9}, Lzd;->a([B)[B
    ...
    :goto_1
    invoke-virtual {v0, v2}, Lldd;->v(B)V
    ...
    iget-short v7, v7, Lhkf;->g:S

    move-object v8, v4

    check-cast v8, Lce;

    iget-object v12, v8, Lce;->a:Lxp8;
    ...
    iget-object v7, v8, Lce;->f:[B

    if-nez v7, :cond_5

    invoke-virtual {v8, v10}, Lce;->d(Z)V
    ...
    iput-boolean v7, v8, Lce;->o:Z

    :cond_6
    check-cast v4, Lce;

    iget-boolean v7, v4, Lce;->o:Z

    if-eqz v7, :cond_7

    iget-object v7, v4, Lce;->h:[B

    goto :goto_5

    :cond_7
    iget-object v7, v4, Lce;->g:[B
    ...
    :cond_8
    invoke-interface {v4, v9, v6, v1}, Lzd;->b([B[B[B)[B
    ...
    iput-object v3, v0, Lldd;->c:Ljava/util/ArrayList;
    ...
    iget-object v7, v0, Lldd;->c:Ljava/util/ArrayList;

    new-instance v8, Le9g;

    invoke-direct {v8}, Ljava/lang/Object;-><init>()V

    invoke-virtual {v8, v1, v5}, Le9g;->i(Ljava/nio/ByteBuffer;Lxp8;)V
    ...
    invoke-virtual {v8, v1}, Lo57;->i(Ljava/nio/ByteBuffer;)V
    ...
    invoke-direct {v8}, Lhw3;-><init>()V

    invoke-virtual {v8, v1}, Lhw3;->m(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1}, La2c;->i(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1}, Lt1c;->i(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {v1}, Lkdd;->f(Ljava/nio/ByteBuffer;)I
    ...
    invoke-virtual {v8, v1}, Lcqa;->i(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1}, Ljag;->i(Ljava/nio/ByteBuffer;)V
    ...
    invoke-direct {v8, v9}, Lcz8;-><init>(I)V

    invoke-virtual {v8, v1}, Lcz8;->l(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {v1}, Ln1k;->i(Ljava/nio/ByteBuffer;)J

    move-result-wide v9

    iput-wide v9, v8, Lkj4;->b:J
    ...
    invoke-virtual {v8, v1}, Ldz8;->i(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1}, Lcz8;->m(Ljava/nio/ByteBuffer;)V
    ...
    new-instance v8, Lsqa;

    invoke-direct {v8}, Ljava/lang/Object;-><init>()V

    invoke-virtual {v8, v1, v5}, Lsqa;->i(Ljava/nio/ByteBuffer;Lxp8;)V
    ...
    invoke-virtual {v8, v1, v5}, Lxf4;->i(Ljava/nio/ByteBuffer;Lxp8;)V
    ...
    invoke-virtual {v8, v1}, Lcz8;->i(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1}, Lz8e;->i(Ljava/nio/ByteBuffer;)V
    ...
    iput-object v9, v8, Ll7;->X:Ljava/lang/String;

    invoke-virtual {v8, v1, v5}, Ll7;->l(Ljava/nio/ByteBuffer;Lxp8;)V
    ...
    invoke-virtual {v8, v1}, Lryb;->i(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1}, Ltk4;->i(Ljava/nio/ByteBuffer;)V
    ...
    :cond_b
    invoke-virtual {v0, v2}, Lldd;->d(B)V
    ...
    invoke-interface {v5, v1}, Lxp8;->b(Ljava/lang/String;)V
...
.method public final u(Ljava/nio/ByteBuffer;ILjava/nio/ByteBuffer;Lzd;)V
    .locals 17
    ...
    iget-wide v8, v0, Lldd;->b:J

    move-object v6, v2

    check-cast v6, Lce;

    iget-boolean v10, v6, Lce;->o:Z

    if-eqz v10, :cond_0

    iget-object v10, v6, Lce;->h:[B

    goto :goto_0

    :cond_0
    iget-object v10, v6, Lce;->g:[B
    ...
    :cond_2
    invoke-interface {v6, v4, v5, v8}, Lzd;->c([B[B[B)[B

    move-result-object v4

    invoke-virtual {v1, v4}, Ljava/nio/ByteBuffer;->put([B)Ljava/nio/ByteBuffer;

    iget-wide v5, v0, Lldd;->b:J

    invoke-static {v5, v6}, Lldd;->f(J)[B
    ...
    invoke-interface {v2, v9}, Lzd;->a([B)[B
