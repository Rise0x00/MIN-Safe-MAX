...
# static fields
.field public static final j:[Ld2i;
...
.method static constructor <clinit>()V
    ...
    sget-object v1, Ld2i;->b:Ld2i;

    filled-new-array {v0, v1}, [Ld2i;

    move-result-object v0

    sput-object v0, Lpu4;->j:[Ld2i;
...
.method public constructor <init>(Lxy9;Lnrd;Lj2c;Lsxj;)V
    ...
    iput-object p1, p0, Lpu4;->f:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lpu4;->g:Ljava/util/HashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Lpu4;->h:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Lpu4;->i:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final a(Lsp1;Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v0, p0, Lpu4;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {v0, p2}, Lf1i;->a(Lorg/webrtc/VideoFrame;)V
...
.method public final d()V
    ...
    invoke-direct {v2, v0, v1, v3}, Ll2j;-><init>(Lw2c;Luz3;I)V
...
.method public final e(Lsp1;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v3}, Lal8;-><init>(I)V

    iput-object v1, v2, Lal8;->c:Ljava/lang/Object;

    iput-object p1, v2, Lal8;->b:Ljava/lang/Object;

    invoke-virtual {v2}, Lal8;->j()Lxz1;

    move-result-object v1

    const/4 v2, 0x0

    invoke-virtual {p0, p2, v1, v2}, Lpu4;->n(Ljava/lang/String;Lxz1;Ljava/util/List;)V
...
.method public final f()V
    ...
    :try_start_0
    iget-object v2, p0, Lpu4;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v1, v4, Lf1i;->a:Lorg/webrtc/VideoSink;
...
.method public final n(Ljava/lang/String;Lxz1;Ljava/util/List;)V
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Lnu4;-><init>(Lpu4;Ljava/lang/String;Lxz1;Ljava/util/List;)V
    ...
    invoke-direct {p2, p1, v1, p3}, Ll2j;-><init>(Lw2c;Luz3;I)V
...
.method public final p(Ljava/lang/String;Lxz1;Ljava/util/List;)V
    .locals 6
    ...
    :try_start_0
    iget-object v3, p0, Lpu4;->g:Ljava/util/HashMap;
    ...
    :cond_0
    iget-object v1, p0, Lpu4;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-interface {v1, v4, v0}, Lnrd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v4, v1, Lf1i;->a:Lorg/webrtc/VideoSink;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_4
    iget-object p3, p0, Lpu4;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Lpu4;->h:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentHashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v1, p0, Lpu4;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p3, p0, Lpu4;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p1, p0, Lpu4;->f:Ljava/util/concurrent/ConcurrentHashMap;
