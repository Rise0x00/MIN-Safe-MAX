...
.method public constructor <init>(Lone/me/messages/list/ui/MessagesListWidget;)V
    ...
    iput-object p1, p0, Lq4a;->g:Lone/me/messages/list/ui/MessagesListWidget;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lq4a;->a:Landroid/graphics/Rect;
    ...
    iput-boolean p1, p0, Lq4a;->d:Z

    new-instance p1, Ljava/util/LinkedHashSet;

    invoke-direct {p1}, Ljava/util/LinkedHashSet;-><init>()V

    iput-object p1, p0, Lq4a;->e:Ljava/util/LinkedHashSet;

    new-instance p1, Ljava/util/LinkedHashSet;

    invoke-direct {p1}, Ljava/util/LinkedHashSet;-><init>()V

    iput-object p1, p0, Lq4a;->f:Ljava/util/LinkedHashSet;
...
.method public final a(Landroidx/recyclerview/widget/RecyclerView;I)V
    ...
    :goto_0
    iput-boolean v0, p0, Lq4a;->d:Z

    if-nez p2, :cond_1

    const/4 p2, -0x1

    invoke-virtual {p0, p1, p2, p2}, Lq4a;->b(Landroidx/recyclerview/widget/RecyclerView;II)V

    invoke-virtual {p0}, Lq4a;->c()V
...
.method public final b(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    iget-object v4, p0, Lq4a;->a:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p1, p2}, Lq4a;->d(II)V
...
.method public final c()V
    ...
    iget-object v0, p0, Lq4a;->e:Ljava/util/LinkedHashSet;

    iget-object v1, p0, Lq4a;->f:Ljava/util/LinkedHashSet;

    invoke-static {v0, v1}, Lb9f;->e0(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    :cond_0
    iget-object v1, p0, Lq4a;->e:Ljava/util/LinkedHashSet;

    iput-object v1, p0, Lq4a;->f:Ljava/util/LinkedHashSet;

    new-instance v1, Ljava/util/LinkedHashSet;

    invoke-direct {v1}, Ljava/util/LinkedHashSet;-><init>()V

    iput-object v1, p0, Lq4a;->e:Ljava/util/LinkedHashSet;

    sget-object v1, Lone/me/messages/list/ui/MessagesListWidget;->B1:[Lb88;

    iget-object v1, p0, Lq4a;->g:Lone/me/messages/list/ui/MessagesListWidget;

    invoke-virtual {v1}, Lone/me/messages/list/ui/MessagesListWidget;->q1()Lh4a;

    move-result-object v1

    invoke-virtual {v1, v0}, Lh4a;->b0(Ljava/util/Set;)V
...
.method public final d(II)V
    ...
    invoke-direct {v1, p1, p2, v2}, Lrv7;-><init>(III)V
    ...
    iget-object v2, p0, Lq4a;->g:Lone/me/messages/list/ui/MessagesListWidget;

    iget-object v2, v2, Lone/me/messages/list/ui/MessagesListWidget;->V0:La2a;
