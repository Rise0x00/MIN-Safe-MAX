...
# direct methods
.method public constructor <init>(Lvz7;Lzs6;)V
    .locals 2
    ...
    iput-object p1, p0, Lwz7;->Y:Lvz7;

    iput-object p2, p0, Lwz7;->Z:Lzs6;
...
# virtual methods
.method public final a(Lb3e;)Z
    .locals 1

    iget-object v0, p0, Lwz7;->Z:Lzs6;
...
.method public final b(Landroidx/recyclerview/widget/RecyclerView;Lb3e;)V
    ...
    iget-object p1, p0, Lwz7;->Y:Lvz7;

    invoke-interface {p1, p2}, Lvz7;->T(Lb3e;)V

    check-cast p2, Ld08;

    invoke-interface {p2}, Ld08;->i()V
...
.method public final m(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Lb3e;FFIZ)V
    ...
    invoke-virtual {p3}, Lb3e;->n()I

    move-result v0

    iget-object v1, p3, Lb3e;->a:Landroid/view/View;
    ...
    invoke-virtual {p2, v0}, Landroidx/recyclerview/widget/RecyclerView;->M(I)Lb3e;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {p0, v0}, Lwz7;->a(Lb3e;)Z
...
.method public final n(Lb3e;Lb3e;)Z
    ...
    invoke-virtual {p2}, Lb3e;->m()I

    move-result p2

    iget-object v0, p0, Lwz7;->Y:Lvz7;

    invoke-interface {v0, p1, p2}, Lvz7;->C0(II)V
...
.method public final o(Lb3e;I)V
    .locals 0
    ...
    iget-object p2, p0, Lwz7;->Y:Lvz7;

    invoke-interface {p2}, Lvz7;->l()V

    check-cast p1, Ld08;

    invoke-interface {p1}, Ld08;->k()V
