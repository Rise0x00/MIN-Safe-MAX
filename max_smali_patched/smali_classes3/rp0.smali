...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lrp0;->c:Ljava/lang/Object;
...
.method private final getAgslDelegate()Lhe;
    ...
    iget-object v0, p0, Lrp0;->c:Ljava/lang/Object;
...
# virtual methods
.method public abstract a(Lge;FF)V
.end method
...
.method public final b()V
    ...
    :cond_1
    iget-object v0, p0, Lrp0;->d:La17;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, La17;->a()V
...
.method public final c()V
    ...
    iput-boolean v0, p0, Lrp0;->o:Z

    iget-boolean v1, p0, Lrp0;->a:Z

    if-eqz v1, :cond_6

    invoke-direct {p0}, Lrp0;->getAgslDelegate()Lhe;

    move-result-object v1

    iget-object v2, v1, Lhe;->a:Lh98;

    iget-object v3, v1, Lhe;->b:Landroid/graphics/RuntimeShader;
    ...
    invoke-virtual {v3}, Lrp0;->getSpec()Lweh;
    ...
    sget-object v4, Lhe;->g:Ljava/util/LinkedHashMap;
    ...
    invoke-static {v3}, Lfe;->c(Ljava/lang/Object;)Landroid/graphics/RuntimeShader;
    ...
    :goto_0
    iput-object v3, v1, Lhe;->b:Landroid/graphics/RuntimeShader;

    if-nez v3, :cond_8

    sget-object v3, Lggf;->a:Ljava/lang/Object;

    iget-object v2, v2, Lh98;->b:Ljava/lang/Object;

    check-cast v2, Lrp0;

    invoke-virtual {v2}, Lrp0;->getSpec()Lweh;
    ...
    invoke-virtual {v2}, Ld77;->t()Ljava/util/List;
    ...
    :goto_2
    iget-object v4, v4, Lxeh;->a:Ljava/lang/String;
    ...
    invoke-static {v9, v6, v7, v4, v8}, Lo52;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v0, Lggf;->a:Ljava/lang/Object;
    ...
    invoke-direct {v4, v5}, Lp4e;-><init>(I)V
    ...
    invoke-virtual {v2, v6, v4}, Lu3e;->c(Ljava/lang/String;Lzs6;)Ljava/lang/String;
    ...
    invoke-direct {v2, v5}, Lp4e;-><init>(I)V
    ...
    invoke-virtual {v0, v4, v2}, Lu3e;->c(Ljava/lang/String;Lzs6;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lfe;->d(Ljava/lang/String;)Landroid/graphics/RuntimeShader;

    move-result-object v0

    iput-object v0, v1, Lhe;->b:Landroid/graphics/RuntimeShader;

    return-void

    :cond_6
    iget-object v1, p0, Lrp0;->d:La17;
    ...
    iget-object v3, p0, Lrp0;->b:Lh98;

    invoke-direct {v1, v2, v3}, La17;-><init>(Landroid/content/Context;Lh98;)V

    iput-object v1, p0, Lrp0;->d:La17;
    ...
    invoke-virtual {v1, v0}, La17;->setStarted(Z)V
...
.method public final d()V
    ...
    iget-object v1, v0, Lhe;->c:Ljava/lang/Object;
    ...
    iget-object v1, v0, Lhe;->b:Landroid/graphics/RuntimeShader;
    ...
    :cond_0
    iput-object v2, v0, Lhe;->b:Landroid/graphics/RuntimeShader;

    sget-object v2, Lhe;->g:Ljava/util/LinkedHashMap;

    iget-object v0, v0, Lhe;->a:Lh98;

    iget-object v0, v0, Lh98;->b:Ljava/lang/Object;

    check-cast v0, Lrp0;

    invoke-virtual {v0}, Lrp0;->getSpec()Lweh;
...
.method public abstract getSpec()Lweh;
.end method
...
.method public final onDrawForeground(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v1, Lhe;->b:Landroid/graphics/RuntimeShader;
    ...
    :cond_2
    iget-object v4, v0, Lhe;->e:[F

    iget-object v5, v0, Lhe;->c:Ljava/lang/Object;
    ...
    invoke-static {v1, v4}, Lfe;->C(Landroid/graphics/RuntimeShader;[F)V

    iget-object v0, v0, Lhe;->f:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, v2, v3}, Lrp0;->a(Lge;FF)V
