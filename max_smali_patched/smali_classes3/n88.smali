...
.method static constructor <clinit>()V
    ...
    invoke-static {v7, v1}, Lsb6;->j(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    sput-object v1, Ln88;->c:Ljava/util/Map;
    ...
    sput-object v0, Ln88;->d:Ljava/util/List;
...
.method public final a()[B
    ...
    iget-object v0, p0, Ln88;->b:Ljava/util/ArrayList;
    ...
    sget-object v6, Lkzg;->B0:Lkzg;

    iget-short v6, v6, Lkzg;->a:S
    ...
    iget-object v2, v1, Lm88;->a:Lmzg;

    iget-short v2, v2, Lmzg;->a:S

    invoke-virtual {v5, v2}, Ljava/nio/ByteBuffer;->putShort(S)Ljava/nio/ByteBuffer;

    iget-object v2, v1, Lm88;->a:Lmzg;

    sget-object v3, Ln88;->c:Ljava/util/Map;
    ...
    invoke-virtual {v1}, Lm88;->a()Ljava/security/PublicKey;
    ...
    invoke-static {v5, v2}, Ln88;->f(Ljava/nio/ByteBuffer;[B)V
    ...
    invoke-static {v5, v1}, Ln88;->f(Ljava/nio/ByteBuffer;[B)V

    goto :goto_1

    :cond_2
    sget-object v4, Lmzg;->o:Lmzg;
    ...
    invoke-static {v2}, Lfe;->p(Ljava/security/PublicKey;)Ljava/security/interfaces/XECPublicKey;

    move-result-object v2

    invoke-static {v2}, Lfe;->o(Ljava/security/interfaces/XECPublicKey;)Ljava/math/BigInteger;
    ...
    invoke-static {v2}, Ln88;->e([B)V

    iget-object v1, v1, Lm88;->a:Lmzg;
...
.method public final d(Ljava/nio/ByteBuffer;)I
    ...
    invoke-static {}, Lmzg;->values()[Lmzg;
    ...
    invoke-direct {v6, v2, v7}, Lcf3;-><init>(II)V
    ...
    sget-object v3, Ln88;->d:Ljava/util/List;
    ...
    invoke-static {v4}, Ln88;->c(Ljava/lang/String;)Ljava/security/spec/ECParameterSpec;
    ...
    invoke-direct {v4, v2, v3}, Ll88;-><init>(Lmzg;Ljava/security/interfaces/ECPublicKey;)V
    ...
    :cond_1
    sget-object v3, Lmzg;->o:Lmzg;

    if-eq v2, v3, :cond_2

    sget-object v3, Lmzg;->X:Lmzg;
    ...
    invoke-static {v5}, Lmrb;->c(Ljava/lang/String;)Ljava/security/spec/NamedParameterSpec;

    move-result-object v5

    invoke-static {}, Lfe;->t()V

    invoke-static {v5, v4}, Lfe;->q(Ljava/security/spec/AlgorithmParameterSpec;Ljava/math/BigInteger;)Ljava/security/spec/XECPublicKeySpec;
    ...
    invoke-direct {v4, v2, v3}, Lm88;-><init>(Lmzg;Ljava/security/PublicKey;)V
