...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v1, p1, v2, p0}, Ldm;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    iput-object v1, p0, Lpe5;->a:Ldm;
    ...
    invoke-static {p1}, Lvfa;->q(Ljava/lang/String;)Landroid/graphics/Path;

    move-result-object p1

    iput-object p1, p0, Lpe5;->b:Landroid/graphics/Path;
    ...
    iput-object v1, p0, Lpe5;->c:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lpe5;->d:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Lpe5;->o:Landroid/graphics/Matrix;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0, p1}, Landroid/graphics/Path;-><init>(Landroid/graphics/Path;)V

    iput-object v0, p0, Lpe5;->z0:Landroid/graphics/Path;
...
.method public final getStrokeWidthPx()F
    ...
    sget-object v0, Lpe5;->A0:[Lb88;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    iget-object v0, p0, Lpe5;->a:Ldm;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lpe5;->b:Landroid/graphics/Path;

    iget-object v2, p0, Lpe5;->d:Landroid/graphics/RectF;
    ...
    iget-object v8, p0, Lpe5;->o:Landroid/graphics/Matrix;
    ...
    iget-object v11, p0, Lpe5;->c:Landroid/graphics/Paint;
    ...
    :cond_0
    iget-object v0, p0, Lpe5;->z0:Landroid/graphics/Path;
