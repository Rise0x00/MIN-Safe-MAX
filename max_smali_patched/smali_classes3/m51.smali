...
.method public synthetic constructor <init>(Li61;Z)V
    .locals 0
...
.method public final run()V
    ...
    iget-object v0, p0, Lm51;->b:Li61;

    sget-object v1, Lc1h;->b:Lc1h;

    const/4 v2, 0x0

    invoke-virtual {v0, v1, v2}, Li61;->f(Lc1h;Z)V
    ...
    iget-object v4, v0, Li61;->o0:Loy1;

    invoke-virtual {v4, v2, v3}, Loy1;->r(Lxp1;Z)V
    ...
    iget-object v1, v0, Li61;->u0:Lhia;

    iget-boolean v2, v0, Li61;->u:Z

    if-nez v2, :cond_6

    iget-object v2, v0, Li61;->g0:Lwif;

    invoke-virtual {v2}, Lwif;->c()I
    ...
    iget-boolean v1, v1, Lhia;->f:Z

    const-string v3, ") != camera video enabled state ("

    const-string v5, "). Let us update media settings"

    invoke-static {v3, v5, v2, v1, v4}, Lo52;->q(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;ZZ)Ljava/lang/String;
    ...
    :cond_5
    invoke-virtual {v0, v4}, Li61;->o(Z)V
    ...
    invoke-interface {v2, v1, v3, v0}, Lnrd;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v1, v0, Li61;->l:Landroid/os/Handler;

    new-instance v2, Lm51;

    const/4 v3, 0x3

    invoke-direct {v2, v0, v3}, Lm51;-><init>(Li61;I)V
    ...
    iget-object v0, v0, Li61;->l0:Ljava/util/concurrent/CopyOnWriteArraySet;
