...
# direct methods
.method public synthetic constructor <init>(Lfv5;Lxs6;)V
    .locals 1
    ...
    iput-object p1, p0, Lhb4;->b:Ljava/lang/Object;

    check-cast p2, Lu98;

    iput-object p2, p0, Lhb4;->c:Ljava/lang/Object;
...
.method public final call()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lhb4;->b:Ljava/lang/Object;

    check-cast v0, Lorg/webrtc/audio/WebRtcAudioRecord;

    iget-object v1, p0, Lhb4;->c:Ljava/lang/Object;
    ...
    iget-object v0, v0, Lhie;->a:Lcn;

    invoke-interface {v0, v1}, Lcn;->a(Lpn;)Ljava/lang/Object;
    ...
    invoke-static {v1}, Ltgj;->a(Lzn;)Ljava/lang/String;
    ...
    invoke-interface {v1}, Lpn;->getOkParser()Lo68;
    ...
    :cond_4
    iget-object v3, v2, Lg4f;->o:Ljava/lang/Object;
    ...
    iput-object v3, v2, Lg4f;->b:Ljava/lang/Object;
    ...
    :goto_2
    iget-object v3, v2, Lg4f;->b:Ljava/lang/Object;
    ...
    :cond_c
    :try_start_4
    invoke-virtual {v2, v0}, Lg4f;->T(Landroid/content/Context;)Z

    move-result v2

    if-eqz v2, :cond_d

    invoke-static {v0, v1}, Lw8i;->c(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
    ...
    iget-object v3, v0, Lfy5;->a:Ljava/lang/String;

    iget-object v0, v0, Lfy5;->b:Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;

    invoke-virtual {v0}, Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;->isVideo()Z

    move-result v4

    iget-object v5, v1, Lgy5;->A0:Lww7;

    invoke-virtual {v5, v0}, Lww7;->a(Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Ljava/lang/String;

    move-result-object v0

    invoke-direct {v2, v3, v0, v4}, Ll28;-><init>(Ljava/lang/String;Ljava/lang/String;Z)V

    iget-object v0, v1, Lgy5;->z0:Lp28;
    ...
    invoke-direct {v1, v0, v2, v4, v3}, Lkn9;-><init>(Ljava/lang/Object;Ljava/lang/Object;Lkotlin/coroutines/Continuation;I)V
    ...
    invoke-direct {v0, v1}, Lm28;-><init>(Ljava/lang/Throwable;)V
    ...
    iget-object v2, v0, Lfv5;->e:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    iget-object v1, v0, Ldk4;->b:Lrq4;

    invoke-virtual {v1}, Lrq4;->b()Ltq4;

    move-result-object v1

    iget-object v8, v0, Ldk4;->c:Landroid/graphics/BitmapFactory$Options;
    ...
    invoke-direct/range {v2 .. v7}, Ljk4;-><init>(Landroid/net/Uri;JJ)V

    invoke-virtual {v1, v2}, Ltq4;->G(Ljk4;)J
    ...
    invoke-virtual {v1, v2, v4, v3}, Ltq4;->read([BII)I
    ...
    invoke-static {v2, v3, v0, v8}, Lnkj;->a([BIILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;

    move-result-object v0
    :try_end_8
    .catchall {:try_start_8 .. :try_end_8} :catchall_3

    invoke-virtual {v1}, Ltq4;->close()V
    ...
    iget-object v3, v0, Ldk4;->c:Landroid/graphics/BitmapFactory$Options;

    iget v0, v0, Ldk4;->d:I

    invoke-static {v1, v2, v0, v3}, Lnkj;->a([BIILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
