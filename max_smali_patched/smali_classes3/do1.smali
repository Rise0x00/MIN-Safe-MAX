...
# direct methods
.method public constructor <init>(Lnrd;Lorg/webrtc/EglBase$Context;[ILjava/lang/String;)V
    .locals 11

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ldo1;->a:Lnrd;

    iput-object p2, p0, Ldo1;->b:Lorg/webrtc/EglBase$Context;

    const-string v1, "CallOpenGL_renderer_"

    move-object v8, p4

    invoke-static {v1, p4}, Lx82;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v7}, Lh2j;-><init>(ILjava/lang/Object;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;II)V
    ...
    invoke-direct/range {v1 .. v6}, Lbo1;-><init>(Lnrd;Landroid/opengl/EGLContext;[ILh2j;Ljava/lang/String;)V

    iput-object v1, p0, Ldo1;->e:Lbo1;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Ldo1;->f:Landroid/graphics/Matrix;

    new-instance v0, Lorg/webrtc/VideoFrameDrawer;

    invoke-direct {v0}, Lorg/webrtc/VideoFrameDrawer;-><init>()V

    iput-object v0, p0, Ldo1;->g:Lorg/webrtc/VideoFrameDrawer;

    new-instance v0, Lorg/webrtc/GlRectDrawer;

    invoke-direct {v0}, Lorg/webrtc/GlRectDrawer;-><init>()V

    iput-object v0, p0, Ldo1;->h:Lorg/webrtc/GlRectDrawer;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Ldo1;->i:Ljava/util/ArrayList;

    new-instance v2, Lsg;

    const/4 v0, 0x6

    invoke-direct {v2, v0, p0}, Lsg;-><init>(ILjava/lang/Object;)V
    ...
    iget-object v3, v1, Lbo1;->j:Ljava/lang/String;

    const-string v4, "OpenGL tread died, is it fine?"

    iget-object v1, v1, Lbo1;->a:Lnrd;

    invoke-interface {v1, v3, v4, v0}, Lnrd;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :goto_0
    iput-object v2, p0, Ldo1;->c:Lsg;
...
.method public final a()V
    ...
    iget-object v0, p0, Ldo1;->e:Lbo1;

    iget-object v1, v0, Lbo1;->a:Lnrd;

    iget-object v2, v0, Lbo1;->j:Ljava/lang/String;
    ...
    iget-object v2, v0, Lbo1;->h:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    iget-boolean v3, v0, Lbo1;->i:Z
    ...
    :try_start_1
    iput-boolean v3, v0, Lbo1;->i:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    monitor-exit v2

    iget-object v2, v0, Lbo1;->k:Lj2j;

    new-instance v3, Lpf;

    const/16 v4, 0x11

    invoke-direct {v3, v0, v4, v1}, Lpf;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v2, v3}, Landroid/os/Handler;->postAtFrontOfQueue(Ljava/lang/Runnable;)Z

    iget-object v2, v0, Lbo1;->a:Lnrd;

    iget-object v0, v0, Lbo1;->j:Ljava/lang/String;

    const-string v3, "Release action submitted"

    invoke-interface {v2, v0, v3}, Lnrd;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final b(Lbo1;Luz1;Lorg/webrtc/VideoFrame;Lvr1;)V
    .locals 16
    ...
    iget-object v4, v2, Lco1;->a:Landroid/opengl/EGLSurface;
    ...
    invoke-virtual {v1, v4}, Lbo1;->b(Landroid/opengl/EGLSurface;)V

    const-string v7, "makeCurrent()"

    invoke-static {v7}, Lbo1;->a(Ljava/lang/String;)V
    ...
    iget-object v11, v0, Ldo1;->f:Landroid/graphics/Matrix;
    ...
    iget-object v3, v2, Luz1;->k:Lorg/webrtc/RendererCommon$GlDrawer;

    if-nez v3, :cond_3

    iget-object v3, v0, Ldo1;->h:Lorg/webrtc/GlRectDrawer;

    :cond_3
    move-object v10, v3

    iget-object v3, v1, Lbo1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v8, v0, Ldo1;->g:Lorg/webrtc/VideoFrameDrawer;
    ...
    invoke-static {v3}, Lbo1;->a(Ljava/lang/String;)V

    invoke-static {}, Ljava/lang/System;->nanoTime()J

    move-result-wide v7

    iget-object v1, v1, Lbo1;->e:Landroid/opengl/EGLDisplay;
    ...
    invoke-static {v1}, Lbo1;->a(Ljava/lang/String;)V

    invoke-static {}, Ljava/lang/System;->nanoTime()J

    move-result-wide v3

    iget-object v2, v2, Luz1;->l:Lvz1;

    sub-long v5, v3, v5

    sub-long/2addr v3, v7

    iget-wide v7, v2, Lvz1;->h:J

    add-long/2addr v7, v5

    iput-wide v7, v2, Lvz1;->h:J

    iget-wide v5, v2, Lvz1;->i:J

    add-long/2addr v5, v3

    iput-wide v5, v2, Lvz1;->i:J
