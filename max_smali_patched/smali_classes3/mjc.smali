...
.method public constructor <init>(ILandroid/content/Context;Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;)V
    ...
    iput-object p3, p0, Lmjc;->l:Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;
    ...
    sget-object v3, Lapg;->Y:Lakg;

    invoke-static {p2}, Lg84;->E0(Landroid/content/Context;)Lapg;
    ...
    iput-object v3, p0, Lmjc;->c:Landroid/graphics/Paint;
    ...
    iput-object v3, p0, Lmjc;->d:Landroid/graphics/Paint;

    new-instance v3, Landroid/graphics/Paint;

    invoke-direct {v3}, Landroid/graphics/Paint;-><init>()V

    iput-object v3, p0, Lmjc;->e:Landroid/graphics/Paint;

    iget p2, p2, Lapg;->k:I

    const v6, 0x3f19999a    # 0.6f

    invoke-static {p2, v6}, Lf90;->r0(IF)I
    ...
    iput-object p2, p0, Lmjc;->g:Landroid/graphics/RectF;
    ...
    iput-object p3, p0, Lmjc;->i:Landroid/graphics/RectF;
    ...
    iput-object p2, p0, Lmjc;->j:Landroid/graphics/RectF;
    ...
    iput-object p2, p0, Lmjc;->k:Landroid/graphics/RectF;
...
.method public final a()F
    ...
    iget-object v0, p0, Lmjc;->i:Landroid/graphics/RectF;

    invoke-virtual {v0}, Landroid/graphics/RectF;->centerX()F

    move-result v0

    iget-object v1, p0, Lmjc;->l:Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;
...
.method public final b(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {p0, p1}, Lmjc;->c(F)V

    return-void

    :cond_1
    invoke-virtual {p0}, Lmjc;->a()F
...
.method public final c(F)V
    ...
    iget-object v0, p0, Lmjc;->l:Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;

    invoke-virtual {v0, p1}, Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;->b(F)F

    move-result p1

    iget-object v0, p0, Lmjc;->g:Landroid/graphics/RectF;
    ...
    iget-object v2, p0, Lmjc;->j:Landroid/graphics/RectF;

    invoke-virtual {v2, p1, v1}, Landroid/graphics/RectF;->offsetTo(FF)V

    iget-object p1, p0, Lmjc;->k:Landroid/graphics/RectF;
