...
.field public final C0:Landroid/graphics/PathMeasure;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Le5h;->N0:Ljava/lang/Object;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Le5h;->a:Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;
    ...
    iput-object v1, p0, Le5h;->b:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, Le5h;->c:Landroid/widget/ImageView;
    ...
    iput-object p1, p0, Le5h;->d:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Le5h;->o:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Le5h;->z0:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Le5h;->A0:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Le5h;->B0:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/PathMeasure;

    invoke-direct {p1}, Landroid/graphics/PathMeasure;-><init>()V

    iput-object p1, p0, Le5h;->C0:Landroid/graphics/PathMeasure;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Le5h;->D0:Landroid/graphics/RectF;

    new-instance p1, Ly4h;

    const/4 v3, 0x0

    invoke-direct {p1, v3, p0}, Ly4h;-><init>(ILe5h;)V
    ...
    iput-object p1, p0, Le5h;->E0:Ljava/lang/Object;

    new-instance p1, Ly4h;

    const/4 v4, 0x1

    invoke-direct {p1, v4, p0}, Ly4h;-><init>(ILe5h;)V

    invoke-static {v3, p1}, Ltf3;->M(ILxs6;)Lia8;

    move-result-object p1

    iput-object p1, p0, Le5h;->F0:Ljava/lang/Object;
    ...
    iput-object p1, p0, Le5h;->G0:Ljava/lang/Object;
    ...
    iput-object p1, p0, Le5h;->H0:Ljava/lang/Object;
...
.method public static a(Le5h;Landroid/animation/ValueAnimator;)V
    .locals 0
    ...
    invoke-direct {p0, p1}, Le5h;->setDrawableColor(I)V
...
.method private final getBackgroundColorAnimator()Landroid/animation/ValueAnimator;
    ...
    iget-object v0, p0, Le5h;->F0:Ljava/lang/Object;
...
.method private final getDrawableColorAnimator()Landroid/animation/ValueAnimator;
    ...
    iget-object v0, p0, Le5h;->G0:Ljava/lang/Object;
...
.method private final getLoadingAnimator()Landroid/animation/ValueAnimator;
    ...
    iget-object v0, p0, Le5h;->E0:Ljava/lang/Object;
...
.method private final getLoadingToSuccessAnimatorSet()Landroid/animation/AnimatorSet;
    ...
    iget-object v0, p0, Le5h;->H0:Ljava/lang/Object;
...
.method private final setDrawableColor(I)V
    ...
    iget-object v1, p0, Le5h;->a:Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;

    invoke-static {v1, v0, p1}, Lg84;->x0(Lbph;Ljava/lang/String;I)V
...
.method public final b(IZ)V
    ...
    :cond_0
    iget v0, p0, Le5h;->I0:I

    iput p1, p0, Le5h;->I0:I
    ...
    invoke-virtual {p0, v1}, Le5h;->onThemeChanged(Ldqb;)V
    ...
    invoke-direct {p2, p1, p0}, Lpq0;-><init>(ILe5h;)V

    invoke-static {p0, p2}, Ljde;->u(Landroid/view/View;Lxs6;)V
    ...
    :cond_2
    iget-object p2, p0, Le5h;->a:Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;
    ...
    invoke-direct {p0}, Le5h;->getBackgroundColorAnimator()Landroid/animation/ValueAnimator;
    ...
    invoke-direct {p0}, Le5h;->getLoadingToSuccessAnimatorSet()Landroid/animation/AnimatorSet;
    ...
    invoke-virtual {v2, p2}, Lz66;->d(Landroid/content/Context;)Lzc3;
    ...
    iget-boolean v0, p0, Le5h;->L0:Z

    invoke-static {p2, v0}, Lyn8;->f(Lps0;Z)Lspb;

    move-result-object p2

    iget-object p2, p2, Lspb;->c:Lqpb;

    iget p2, p2, Lqpb;->a:I

    invoke-direct {p0, p2}, Le5h;->setDrawableColor(I)V
    ...
    iget-boolean p2, p0, Le5h;->M0:Z

    if-nez p2, :cond_8

    invoke-direct {p0}, Le5h;->getDrawableColorAnimator()Landroid/animation/ValueAnimator;
    ...
    invoke-direct {p0}, Le5h;->getLoadingAnimator()Landroid/animation/ValueAnimator;
...
.method public final onAttachedToWindow()V
    ...
    invoke-direct {v1, v0, p0}, Lpq0;-><init>(ILe5h;)V

    invoke-static {p0, v1}, Ljde;->u(Landroid/view/View;Lxs6;)V
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Le5h;->d:Landroid/graphics/Paint;

    iget-object v3, p0, Le5h;->D0:Landroid/graphics/RectF;
    ...
    :cond_0
    iget-object v0, p0, Le5h;->C0:Landroid/graphics/PathMeasure;

    invoke-virtual {v0}, Landroid/graphics/PathMeasure;->getLength()F

    move-result v1

    iget v2, p0, Le5h;->J0:F
    ...
    invoke-static {v5, v4, v2, v4}, Lrtc;->l(FFFF)F
    ...
    iget-object v4, p0, Le5h;->B0:Landroid/graphics/Path;

    invoke-virtual {v4}, Landroid/graphics/Path;->reset()V

    cmpl-float v5, v2, v8

    iget-object v6, p0, Le5h;->z0:Landroid/graphics/Paint;
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p2, p0, Le5h;->b:Landroid/widget/ImageView;
    ...
    iget-object p2, p0, Le5h;->c:Landroid/widget/ImageView;
...
.method public final onMeasure(II)V
    ...
    iget-object v4, p0, Le5h;->b:Landroid/widget/ImageView;
    ...
    iget-object v2, p0, Le5h;->c:Landroid/widget/ImageView;
...
.method public final onSizeChanged(IIII)V
    ...
    iget-object p3, p0, Le5h;->D0:Landroid/graphics/RectF;

    const/4 p4, 0x0

    invoke-virtual {p3, p4, p4, p1, p2}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Le5h;->A0:Landroid/graphics/Path;
    ...
    iget-object p4, p0, Le5h;->o:Landroid/graphics/Paint;
    ...
    iget-object p2, p0, Le5h;->C0:Landroid/graphics/PathMeasure;
...
.method public final onThemeChanged(Ldqb;)V
    ...
    iget-boolean v1, p0, Le5h;->L0:Z

    invoke-static {p1, v1}, Lyn8;->f(Lps0;Z)Lspb;

    move-result-object p1

    iget-object v1, p1, Lspb;->d:Lnpb;
    ...
    iget-object v5, p0, Le5h;->o:Landroid/graphics/Paint;

    invoke-virtual {v5, v4}, Landroid/graphics/Paint;->setColor(I)V

    iget-boolean v4, p0, Le5h;->M0:Z
    ...
    :goto_0
    iget-object v4, p0, Le5h;->z0:Landroid/graphics/Paint;

    invoke-virtual {v4, v1}, Landroid/graphics/Paint;->setColor(I)V

    iget-boolean v1, p0, Le5h;->M0:Z
    ...
    :goto_3
    invoke-direct {p0, v2}, Le5h;->setDrawableColor(I)V
