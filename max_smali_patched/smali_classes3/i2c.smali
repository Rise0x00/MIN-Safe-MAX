...
.method public final accept(Ljava/lang/Object;)V
    ...
    iput-object v6, v2, Lw2c;->N:Lorg/webrtc/RtpSender;

    iput-object v6, v2, Lw2c;->P:Lorg/webrtc/RtpSender;
    ...
    iget-object v0, v2, Lw2c;->w:Lnrd;

    const-string v10, "audioShareTransceiver found"

    invoke-interface {v0, v9, v10}, Lnrd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v11, v2, Lw2c;->w:Lnrd;
    ...
    invoke-interface {v11, v9, v0}, Lnrd;->log(Ljava/lang/String;Ljava/lang/String;)V

    :goto_1
    iget-object v0, v2, Lw2c;->t:Lwif;
    ...
    iput-object v7, v2, Lw2c;->N:Lorg/webrtc/RtpSender;

    iget-object v11, v2, Lw2c;->o:Lr04;

    const-string v12, "audio-share"

    invoke-virtual {v11, v7, v12}, Lr04;->b(Lorg/webrtc/RtpSender;Ljava/lang/String;)V

    invoke-virtual {v7, v0, v10}, Lorg/webrtc/RtpSender;->setTrack(Lorg/webrtc/MediaStreamTrack;Z)Z

    iget-object v7, v2, Lw2c;->w:Lnrd;
    ...
    invoke-interface {v7, v9, v0}, Lnrd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v0, v9, v7}, Lnrd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v11 .. v17}, Lr04;->c(Lorg/webrtc/RtpSender;Ljava/lang/String;IILjava/lang/Double;Z)V

    iput-object v12, v2, Lw2c;->P:Lorg/webrtc/RtpSender;

    invoke-virtual {v12, v0, v10}, Lorg/webrtc/RtpSender;->setTrack(Lorg/webrtc/MediaStreamTrack;Z)Z

    iget-object v5, v2, Lw2c;->P:Lorg/webrtc/RtpSender;

    iget-boolean v7, v2, Lw2c;->d0:Z
    ...
    invoke-direct {v7, v2, v10, v8}, Laz0;-><init>(Ljava/lang/Object;ZI)V
    ...
    invoke-interface {v5, v9, v0}, Lnrd;->log(Ljava/lang/String;Ljava/lang/String;)V

    :try_start_2
    iget-object v0, v2, Lw2c;->P:Lorg/webrtc/RtpSender;

    const/4 v5, 0x1

    invoke-virtual {v2, v3, v10, v5, v0}, Lw2c;->n(Lorg/webrtc/PeerConnection;ZZLorg/webrtc/RtpSender;)V
    :try_end_2
    ...
    :cond_9
    :goto_8
    invoke-virtual {v2, v3}, Lw2c;->w(Lorg/webrtc/PeerConnection;)V

    sget-object v0, Loma;->b:Loma;

    iget-object v4, v2, Lw2c;->y:Lpp1;

    iget-object v4, v4, Lpp1;->q:Loma;
    ...
    invoke-direct {v3, v0, v5, v6, v4}, Lpma;-><init>(Loma;Ljava/lang/String;Lorg/webrtc/SessionDescription;Lorg/webrtc/SessionDescription;)V

    invoke-virtual {v2, v3}, Lw2c;->h(Lpma;)V
    ...
    invoke-direct {v0, v2, v4}, Lt2c;-><init>(Lw2c;I)V
    ...
    invoke-virtual {v0, v2, v3}, Lw2c;->u(Lorg/webrtc/PeerConnection;Z)V

    invoke-virtual {v0, v2, v3}, Lw2c;->m(Lorg/webrtc/PeerConnection;Z)V
