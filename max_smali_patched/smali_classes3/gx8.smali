...
.field public final e:Lxha;


# direct methods
.method public constructor <init>(Landroid/widget/EditText;Lw0g;ZLxy9;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lgx8;->a:Landroid/widget/EditText;

    iput-object p2, p0, Lgx8;->b:Lw0g;

    iput-boolean p3, p0, Lgx8;->c:Z

    iput-object p4, p0, Lgx8;->d:Lxy9;

    new-instance p1, Lxha;

    invoke-direct {p1}, Lxha;-><init>()V

    iput-object p1, p0, Lgx8;->e:Lxha;
...
.method public final a(ILandroid/text/Editable;II)V
    ...
    invoke-static {p2, p3, p4, v1, p1}, Ltf3;->Y(Landroid/text/Editable;IIZLhx8;)V

    return-void

    :cond_0
    sget v0, Lcld;->markdown_italic:I

    if-ne p1, v0, :cond_1

    new-instance p1, Luz7;

    invoke-direct {p1}, Luz7;-><init>()V
    ...
    :cond_1
    sget v0, Lcld;->markdown_underline:I
    ...
    invoke-direct {p1, v2}, Ltag;-><init>(I)V

    invoke-static {p2, p3, p4, v2, p1}, Ltf3;->Y(Landroid/text/Editable;IIZLhx8;)V

    return-void

    :cond_2
    sget v0, Lcld;->markdown_mono:I
    ...
    :cond_3
    sget v0, Lcld;->markdown_strikethrough:I

    if-ne p1, v0, :cond_4

    new-instance p1, Ltag;

    invoke-direct {p1, v1}, Ltag;-><init>(I)V
    ...
    :cond_4
    sget v0, Lcld;->markdown_heading:I
    ...
    :cond_5
    sget v0, Lcld;->markdown_quote:I

    sget-object v3, Lyeh;->a:Lyeh;

    iget-object v4, p0, Lgx8;->a:Landroid/widget/EditText;
    ...
    sget v0, Lfld;->text_change_is_programmatic_tag:I
    ...
    invoke-virtual {p0}, Lgx8;->b()Lted;

    move-result-object p4

    new-instance v0, Lued;

    invoke-direct {v0, p4}, Lued;-><init>(Lted;)V

    const/16 p4, 0x11

    invoke-static {p2, v0, p1, p3, p4}, Lddh;->A(Landroid/text/Spannable;Lhx8;III)V
    ...
    invoke-static {p2, v3, v5, v6}, Ltf3;->Z(Landroid/text/Spannable;Lhx8;II)V
    :try_end_0
    ...
    :cond_f
    :goto_5
    sget p1, Lfld;->text_change_is_programmatic_tag:I

    invoke-virtual {v4, p1, v8}, Landroid/view/View;->setTag(ILjava/lang/Object;)V

    invoke-static {p2}, Lpej;->a(Landroid/text/Editable;)V

    return-void

    :goto_6
    sget p2, Lfld;->text_change_is_programmatic_tag:I
    ...
    :cond_10
    sget v0, Lcld;->markdown_regular:I
    ...
    invoke-static {p2, v6, v7, v9}, Ltf3;->Z(Landroid/text/Spannable;Lhx8;II)V
    ...
    :goto_a
    invoke-static {p2, p3, p4}, Ltf3;->Q(Landroid/text/Spannable;II)V
...
.method public final b()Lted;
    ...
    iget-object v1, v0, Lgx8;->a:Landroid/widget/EditText;
    ...
    invoke-static {v3, v4}, Lddh;->m(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct/range {v2 .. v19}, Lted;-><init>(Landroid/content/Context;Lw0g;Lspb;Lktg;Landroid/graphics/drawable/Drawable;IIIIIIIIIIFZ)V
    ...
    invoke-direct {v1, v4, v3}, Lfdd;-><init>(ILjava/lang/Object;)V

    iput-object v1, v2, Lted;->f:Lfdd;
...
.method public final c()Z
    ...
    iget-object v0, p0, Lgx8;->a:Landroid/widget/EditText;
...
.method public final d(Landroid/text/Editable;II)V
    ...
    iget-object p1, v5, Lqg8;->c:Ljava/lang/String;

    iget-object v0, v2, Lxy9;->a:Ljava/lang/Object;

    check-cast v0, Lone/me/sdk/messagewrite/MessageWriteWidget;

    sget-object v1, Lone/me/sdk/messagewrite/MessageWriteWidget;->X0:[Lb88;

    iget-object v0, v0, Lone/me/sdk/messagewrite/MessageWriteWidget;->d:Lia8;
    ...
    invoke-direct {v1, p2, p3, p1}, Lrb;-><init>(IILjava/lang/String;)V
    ...
    :cond_2
    iget-object p1, v2, Lxy9;->a:Ljava/lang/Object;
    ...
    iget-object p1, p1, Lone/me/sdk/messagewrite/MessageWriteWidget;->d:Lia8;
    ...
    iget-object p1, p1, Lix8;->c:Lzo5;

    new-instance v0, Lrb;

    invoke-direct {v0, p2, p3, v1}, Lrb;-><init>(IILjava/lang/String;)V
...
.method public final onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {p0, p2, v0, v1, v2}, Lgx8;->a(ILandroid/text/Editable;II)V
    ...
    :cond_1
    sget v5, Lcld;->markdown_italic:I
    ...
    :cond_2
    sget v5, Lcld;->markdown_underline:I
    ...
    :cond_4
    sget v5, Lcld;->markdown_strikethrough:I
    ...
    :cond_5
    sget v5, Lcld;->markdown_link:I

    if-ne v4, v5, :cond_6

    invoke-virtual {p0, v0, v1, v2}, Lgx8;->d(Landroid/text/Editable;II)V

    return v6

    :cond_6
    sget v5, Lcld;->markdown_heading:I
    ...
    :cond_8
    sget v5, Lcld;->markdown_regular:I
...
.method public final onCreateActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    iget-object p1, p0, Lgx8;->e:Lxha;

    invoke-virtual {p1}, Lxha;->c()V

    const v0, 0x1020020

    invoke-virtual {p1, v0}, Lxha;->a(I)V

    const v0, 0x1020021

    invoke-virtual {p1, v0}, Lxha;->a(I)V

    invoke-virtual {p0}, Lgx8;->c()Z
    ...
    invoke-virtual {p1, v3}, Lxha;->a(I)V
...
.method public final onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    :cond_4
    sget-object v1, Lcx8;->X:Lcx8;

    iget v2, v1, Lcx8;->a:I

    iget-object v3, p0, Lgx8;->a:Landroid/widget/EditText;
    ...
    invoke-virtual {p1, v2}, Lxha;->a(I)V
    ...
    invoke-direct {p1, v1, p2}, Ldv;-><init>(ILjava/lang/Object;)V
