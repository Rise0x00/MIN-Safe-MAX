...
.method public final a(Lhbd;)I
    ...
    iget-object p1, p1, Lhbd;->a:Landroid/text/Layout;
...
.method public final j(F)Ljbd;
    ...
    invoke-static {v1, p1, v2, p1}, Lrtc;->l(FFFF)F
    ...
    invoke-static {v2, v1}, Ljbd;->k(IF)I

    move-result v1

    iget v2, p0, Ljbd;->b:I

    invoke-static {v2, p1}, Ljbd;->k(IF)I

    move-result v2

    iget v3, p0, Ljbd;->c:I

    invoke-static {v3, p1}, Ljbd;->k(IF)I

    move-result v3

    iget v4, p0, Ljbd;->d:I

    invoke-static {v4, p1}, Ljbd;->k(IF)I

    move-result v4

    iget v5, p0, Ljbd;->e:I

    invoke-static {v5, p1}, Ljbd;->k(IF)I

    move-result v5

    iget v6, p0, Ljbd;->f:I

    invoke-static {v6, p1}, Ljbd;->k(IF)I

    move-result v6

    iget v7, p0, Ljbd;->g:I

    invoke-static {v7, p1}, Ljbd;->k(IF)I

    move-result v7

    iget v8, p0, Ljbd;->h:I

    invoke-static {v8, p1}, Ljbd;->k(IF)I

    move-result v8

    iget v9, p0, Ljbd;->i:I

    invoke-static {v9, p1}, Ljbd;->k(IF)I

    move-result v9

    invoke-direct/range {v0 .. v9}, Ljbd;-><init>(IIIIIIIII)V
