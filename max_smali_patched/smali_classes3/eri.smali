...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Leri;->a:Lhfe;

    new-instance v1, Ldri;

    invoke-direct {v1, p1}, Ldri;-><init>(Landroid/content/Context;)V
...
# virtual methods
.method public final a(Lc3g;I)V
    .locals 7

    iget-object v0, p0, Leri;->o:Ld4g;
    ...
    :cond_0
    iget-object v0, p1, Lc3g;->X:Ljava/lang/String;

    const/4 v1, 0x1

    const/4 v2, 0x0

    iget-object v3, p0, Leri;->a:Lhfe;

    iget-object v4, p0, Leri;->b:Ldri;
    ...
    invoke-direct {v5, v1, p0}, Lwpi;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v4, v5}, Ldri;->setOnFirstFrameListener(Lcri;)V

    invoke-virtual {v4, v2}, Landroid/view/View;->setVisibility(I)V

    iput-boolean v1, p0, Leri;->c:Z
    ...
    :cond_2
    iget-object v5, v4, Ldri;->a:Ljava/lang/String;
    ...
    :cond_3
    iput-boolean v1, v4, Ldri;->b:Z

    iput-object v0, v4, Ldri;->a:Ljava/lang/String;
    ...
    invoke-virtual {v4, p2}, Ldri;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    goto :goto_0

    :goto_1
    iput-boolean v2, p0, Leri;->c:Z

    if-eqz p2, :cond_4

    iget-boolean p2, p0, Leri;->d:Z
    ...
    iget-object p2, v3, Lhfe;->b:Ljava/lang/Object;
    ...
    invoke-virtual {p2, p1, v0}, Lone/me/sdk/uikit/common/views/OneMeDraweeView;->j(Lzl7;Lzl7;)V
...
.method public final b(Lot8;)V
    ...
    iget-object v0, p1, Lot8;->a:Ljava/util/Set;
    ...
    iput-object v0, p1, Lot8;->a:Ljava/util/Set;

    :cond_0
    iget-object p1, p1, Lot8;->a:Ljava/util/Set;

    if-eqz p1, :cond_1

    iget-object v0, p0, Leri;->b:Ldri;
