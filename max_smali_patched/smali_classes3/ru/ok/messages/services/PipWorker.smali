...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/WorkerParameters;)V
    ...
    iput-object p2, p0, Lru/ok/messages/services/PipWorker;->A0:Lakg;
...
.method public final g(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p1}, Lnfc;-><init>(Lru/ok/messages/services/PipWorker;Lz84;)V

    :goto_0
    iget-object p1, v0, Lnfc;->d:Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lsab;->e()Lj15;

    move-result-object p1

    invoke-virtual {p1, v3}, Lj15;->d(Ljava/lang/String;)V

    :cond_5
    :goto_1
    :try_start_2
    iget-boolean p1, p0, Ldj8;->c:Z

    if-nez p1, :cond_6

    iget-object p1, p0, Lru/ok/messages/services/PipWorker;->A0:Lakg;
    ...
    invoke-virtual {v0}, Lsab;->e()Lj15;

    move-result-object v0

    invoke-virtual {v0, v3}, Lj15;->e(Ljava/lang/String;)V
...
.method public final i(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object p1, p1, Lzec;->a:Lkfc;

    iget-object v0, p1, Lkfc;->b:Lfhb;

    invoke-virtual {v0}, Lfhb;->c()V

    iget-object v0, p1, Lkfc;->b:Lfhb;

    iget-object v1, p1, Lkfc;->c:Ldq4;
    ...
    iput-object v3, v1, Lyva;->e:[I

    iget-object v3, p1, Lkfc;->d:Lakg;
    ...
    iput-object v3, v1, Lyva;->f:Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    iput-object v4, v1, Lyva;->e:[I

    iget-object v4, p1, Lkfc;->e:Ldtb;
    ...
    iget-object v4, v4, Ldtb;->b:Ljava/lang/Object;

    check-cast v4, Landroid/content/Context;

    const/high16 v7, 0x8000000

    invoke-static {v7}, Ls5b;->o(I)I

    move-result v8

    invoke-static {v5, v8}, Ls5b;->X(Landroid/content/Intent;I)I
    ...
    invoke-static {v5, v6}, Ls5b;->X(Landroid/content/Intent;I)I
    ...
    invoke-virtual {v0, v5, v3}, Lrva;->f(IZ)V

    const/16 v3, 0x8

    invoke-virtual {v0, v3, v2}, Lrva;->f(IZ)V

    iget-object p1, p1, Lkfc;->a:Landroid/content/Context;
    ...
    invoke-virtual {v0, p1}, Lrva;->d(Ljava/lang/CharSequence;)V
    ...
    invoke-static {p1, v2}, Ls5b;->X(Landroid/content/Intent;I)I
    ...
    invoke-direct {v3, v2, v4, p1}, Ljva;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V

    iget-object p1, v0, Lrva;->b:Ljava/util/ArrayList;

    invoke-virtual {p1, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v0, v1}, Lrva;->i(Lgwa;)V
    ...
    invoke-direct {v0, v9, p1, v1}, Lsl6;-><init>(ILandroid/app/Notification;I)V
