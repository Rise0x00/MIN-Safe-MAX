...
.method public final I(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    sget p2, Lald;->frg_local_gif__drawee:I
    ...
    invoke-virtual {p2}, Lsa5;->getHierarchy()Lpa5;

    move-result-object p2

    check-cast p2, Lsx6;

    new-instance p3, Ll60;
    ...
    invoke-direct {p3, v0, v1}, Ll60;-><init>(Landroid/content/Context;I)V

    const/4 v0, 0x3

    invoke-virtual {p2, v0, p3}, Lsx6;->i(ILandroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {p3, v0, p0}, Lmh6;-><init>(ILjava/lang/Object;)V
...
.method public final j(Lnm8;Landroid/net/Uri;ILandroid/net/Uri;)V
    ...
    invoke-virtual {p3, p2}, Lpfc;->b(Landroid/net/Uri;)V
    ...
    iget-object p2, p1, Lnm8;->d:Ljava/lang/String;
    ...
    invoke-virtual {p2, p1}, Lsa5;->setController(Lma5;)V
