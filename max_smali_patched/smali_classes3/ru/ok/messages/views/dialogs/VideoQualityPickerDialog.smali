...
.method public final k0()Landroid/app/Dialog;
    ...
    invoke-static {v2}, Lg84;->E0(Landroid/content/Context;)Lapg;
    ...
    iget-object v7, v7, Lvcd;->a:Lpcd;

    iget-boolean v9, v7, Lpcd;->f:Z

    iget-object v10, v7, Lpcd;->a:Lkcd;

    iget-object v10, v10, Lkcd;->a:Ljava/lang/String;
    ...
    iget-wide v13, v7, Lpcd;->e:J

    const/4 v7, 0x0

    invoke-static {v13, v14, v8, v7}, Lytg;->v(JZLandroid/content/Context;)Ljava/lang/String;

    move-result-object v7

    if-eqz v9, :cond_3

    invoke-static {v12, v7}, Lx82;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v1, v2, v3}, Lwx8;-><init>(Landroid/content/Context;I)V
    ...
    invoke-virtual {v1, v2}, Lwx8;->a(Ljava/lang/String;)Lwx8;
    ...
    invoke-direct {v3, p0, v0}, Lo0i;-><init>(Lru/ok/messages/views/dialogs/VideoQualityPickerDialog;Ljava/util/ArrayList;)V

    iget-object v0, v1, Lqe;->a:Lme;

    iput-object v2, v0, Lme;->n:[Ljava/lang/CharSequence;

    iput-object v3, v0, Lme;->p:Landroid/content/DialogInterface$OnClickListener;

    iput v5, v0, Lme;->s:I

    iput-boolean v8, v0, Lme;->r:Z
    ...
    invoke-direct {v2, p0, v3}, Lpv3;-><init>(Landroidx/fragment/app/DialogFragment;I)V

    iget-object v3, v1, Lqe;->a:Lme;

    iput-object v0, v3, Lme;->k:Ljava/lang/CharSequence;

    iput-object v2, v3, Lme;->l:Landroid/content/DialogInterface$OnClickListener;

    invoke-virtual {v1}, Lwx8;->create()Lre;
...
.method public final m0(Lr0i;)V
    ...
    invoke-virtual {v0, v1, p1}, Landroidx/fragment/app/c;->a0(Ljava/lang/String;Landroid/os/Bundle;)V
