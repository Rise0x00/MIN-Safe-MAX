...
.method private final uploadFileWithContent(Lcn;Ljava/io/File;)Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader$UploadResult;
    ...
    invoke-static {p2}, Lx66;->d(Ljava/io/File;)Z
    ...
    invoke-virtual {v5, p1, v6, v7}, Lru/ok/android/externcalls/analytics/internal/upload/UploadHelper;->executeApiMethod$calls_sdk_analytics_release(Lcn;Lru/ok/android/externcalls/analytics/internal/event/EventChannel;Lrz0;)V
...
.method public drop()V
    ...
    :cond_0
    invoke-static {v4}, Lx66;->b(Ljava/io/File;)V
...
.method public final ensureStorageIsOfCorrectType(Z)Ljava/io/File;
    ...
    :try_start_0
    invoke-static {v0}, Lx66;->b(Ljava/io/File;)V
    :try_end_0
...
.method public final uploadFile(Ljava/io/File;)Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader$UploadResult;
    ...
    :cond_1
    invoke-virtual {v2}, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;->getOkApi()Ls3b;

    move-result-object v0

    invoke-virtual {v0}, Ls3b;->b()Lcn;
