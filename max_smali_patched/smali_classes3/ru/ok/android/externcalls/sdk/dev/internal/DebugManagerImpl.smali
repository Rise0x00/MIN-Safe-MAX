...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "signalingProvider",
        "<init>",
        "(Li61;Lnrd;La3c;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;)V",
        "",
        "error",
        "Lyeh;",
        "reportError",
        ...
        "(Lr1g;ILjava/util/concurrent/TimeUnit;)V",
        "removeStatListener",
        "(Lr1g;)V",
...
.field private final peerVideoSettingsAdapter:La3c;

.field private final underlyingCall:Li61;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl$Companion;-><init>(Ljq4;)V
...
.method public constructor <init>(Li61;Lnrd;La3c;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->underlyingCall:Li61;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->log:Lnrd;

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->peerVideoSettingsAdapter:La3c;

    new-instance p1, Lru/ok/android/externcalls/sdk/dev/internal/MediaDumpManagerImpl;

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->getUnderlyingCall()Li61;

    move-result-object p2

    invoke-direct {p1, p2, p4}, Lru/ok/android/externcalls/sdk/dev/internal/MediaDumpManagerImpl;-><init>(Li61;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;)V
...
.method public enableFullAudioDump(Ljava/lang/String;)V
    ...
    iget-object v1, v0, Li61;->f0:Lbjf;
    ...
    :cond_0
    iget-object v2, v0, Li61;->c:Ljava/util/concurrent/ExecutorService;
...
.method public getCurrentVideoSettingsOverride()Lru/ok/android/externcalls/sdk/dev/DebugManager$VideoSettingsOverride;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->peerVideoSettingsAdapter:La3c;

    iget-boolean v2, v1, La3c;->a:Z
...
.method public getUnderlyingCall()Li61;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->underlyingCall:Li61;

    return-object v0
.end method

.method public registerStatListener(Lr1g;ILjava/util/concurrent/TimeUnit;)V
    .locals 3
    ...
    iget-object v0, v0, Li61;->M0:Lr0g;

    int-to-long v1, p2

    iget-object p2, v0, Lr0g;->i:Ljava/util/HashMap;

    new-instance v0, Lq2j;

    invoke-direct {v0, v1, v2, p3}, Lq2j;-><init>(JLjava/util/concurrent/TimeUnit;)V
...
.method public removeStatListener(Lr1g;)V
    .locals 1
...
.method public reportError(Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->log:Lnrd;
...
.method public setVideoSettingsOverride(Lru/ok/android/externcalls/sdk/dev/DebugManager$VideoSettingsOverride;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->peerVideoSettingsAdapter:La3c;
    ...
    iput-boolean p1, v0, La3c;->a:Z

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->getUnderlyingCall()Li61;

    move-result-object p1

    invoke-virtual {p1}, Li61;->x()V

    return-void
.end method

.method public updateCameraToggles(Lzs6;)V
    .locals 3
    ...
    iget-object v0, v0, Li61;->h0:Lv62;

    iget-object v0, v0, Lv62;->Z:Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v2, v0, Lfd4;->b:Ljava/lang/Object;

    check-cast v2, Lka2;

    invoke-interface {p1, v2}, Lzs6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lka2;

    iput-object p1, v0, Lfd4;->b:Ljava/lang/Object;
