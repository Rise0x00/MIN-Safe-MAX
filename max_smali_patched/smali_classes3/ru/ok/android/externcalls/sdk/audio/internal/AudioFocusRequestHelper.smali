...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "onFocusGained",
        "<init>",
        "(Landroid/media/AudioManager;Lru/ok/android/externcalls/sdk/audio/CallsAudioManager$OnMuteListener;Landroid/os/Handler;Landroid/os/Handler;Lxs6;Lru/ok/android/externcalls/sdk/audio/Logger;Lxs6;Lxs6;)V",
        "T",
        "context",
        "",
        "requestResult",
...
.field private final isDestroyed:Lxs6;
...
.field private final onFocusGained:Lxs6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lxs6;"
        }
...
.field private final onFocusLost:Lxs6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lxs6;"
        }
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper$Companion;-><init>(Ljq4;)V
...
.method public constructor <init>(Landroid/media/AudioManager;Lru/ok/android/externcalls/sdk/audio/CallsAudioManager$OnMuteListener;Landroid/os/Handler;Landroid/os/Handler;Lxs6;Lru/ok/android/externcalls/sdk/audio/Logger;Lxs6;Lxs6;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    iput-object p5, p0, Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;->isDestroyed:Lxs6;
    ...
    .line 8
    iput-object p7, p0, Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;->onFocusLost:Lxs6;

    .line 9
    iput-object p8, p0, Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;->onFocusGained:Lxs6;

    return-void
.end method

.method public synthetic constructor <init>(Landroid/media/AudioManager;Lru/ok/android/externcalls/sdk/audio/CallsAudioManager$OnMuteListener;Landroid/os/Handler;Landroid/os/Handler;Lxs6;Lru/ok/android/externcalls/sdk/audio/Logger;Lxs6;Lxs6;ILjq4;)V
    .locals 11
    ...
    .line 12
    :goto_2
    invoke-direct/range {v2 .. v10}, Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;-><init>(Landroid/media/AudioManager;Lru/ok/android/externcalls/sdk/audio/CallsAudioManager$OnMuteListener;Landroid/os/Handler;Landroid/os/Handler;Lxs6;Lru/ok/android/externcalls/sdk/audio/Logger;Lxs6;Lxs6;)V
...
.method private final handleAudioFocusRequestResult(Ljava/lang/Object;I)Ljava/lang/Object;
    ...
    invoke-direct {p2, p0, v4}, Lm80;-><init>(Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;I)V
...
.method private final handleFocusUpdate(ZZ)V
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;->onFocusGained:Lxs6;
    ...
    :cond_1
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;->onFocusLost:Lxs6;
...
.method private final mute()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;->isDestroyed:Lxs6;
    ...
    invoke-direct {v1, p0, v2}, Lm80;-><init>(Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;I)V
