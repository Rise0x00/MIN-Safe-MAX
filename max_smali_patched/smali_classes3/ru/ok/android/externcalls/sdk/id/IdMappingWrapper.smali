...
.method private constructor <init>(Landroid/content/Context;Lnrd;)V
    .locals 1
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lnrd;
...
.method private declared-synchronized ensureMappingNotOutdated(Lsp1;)V
    .locals 1
...
.method public static get(Landroid/content/Context;Lnrd;)Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;
    .locals 2
    ...
    invoke-direct {v1, p0, p1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;-><init>(Landroid/content/Context;Lnrd;)V
...
.method private getFile(Z)Ljava/io/File;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lnrd;
...
.method private declared-synchronized read()V
    ...
    :catch_0
    :try_start_4
    iget-object v3, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lnrd;
    ...
    invoke-interface {v3, v4, v1}, Lnrd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lnrd;

    const-string v1, "IdMappingWrapper"

    const-string v3, "empty mapping"

    invoke-interface {v0, v1, v3}, Lnrd;->log(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_4
...
.method private declared-synchronized write()V
    ...
    invoke-virtual {v3}, Lsp1;->b()Ljava/lang/String;
...
# virtual methods
.method public declared-synchronized addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lsp1;)V
    .locals 2
...
.method public declared-synchronized getByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Lsp1;
    .locals 1
...
.method public declared-synchronized getByInternal(Lsp1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    .locals 1
    ...
    :cond_0
    :try_start_1
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->ensureMappingNotOutdated(Lsp1;)V
...
.method public scheduleReadCacheFromDisk()V
    ...
    invoke-direct {v1, p0, v2}, Loi7;-><init>(Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;I)V
