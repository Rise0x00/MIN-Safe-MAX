...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Lsp1;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;",
        ...
        "(Ljava/util/Collection;Lxs6;Lzs6;)V",
        "getRoomParticipants",
        "(Lv7f;Lzs6;Lzs6;)V",
...
.method public static synthetic a(Lzs6;)V
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds$lambda$9(Lzs6;)V
...
.method public static final synthetic access$getRoomParticipantIds(Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Lu7f;)Ljava/util/Collection;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->getRoomParticipantIds(Lu7f;)Ljava/util/Collection;
...
.method public static final synthetic access$mapInternalIdsToSessionRoomParticipants(Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Lv7f;Ljava/util/Collection;)Ljava/util/Collection;
    .locals 0

    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->mapInternalIdsToSessionRoomParticipants(Lv7f;Ljava/util/Collection;)Ljava/util/Collection;
...
.method public static synthetic b(Lzs6;Lzs6;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lsp1;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveInternalIdByExternal$lambda$0(Lzs6;Lzs6;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lsp1;)V

    return-void
.end method

.method public static synthetic c(Lzs6;Lru/ok/android/externcalls/sdk/id/ParticipantId;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveInternalIdByExternal$lambda$1(Lzs6;Lru/ok/android/externcalls/sdk/id/ParticipantId;)V
...
.method public static synthetic d(Lxs6;)V
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds$lambda$8(Lxs6;)V
...
.method private final getAllRoomParticipantIds()Ljava/util/Collection;
    ...
    iget-object v2, v2, Lp7f;->e:Ljava/util/List;
    ...
    :cond_0
    invoke-static {v1}, Lkj3;->T0(Ljava/lang/Iterable;)Ljava/util/ArrayList;
...
.method private final getMainCallParticipantIds(Lzs6;Lzs6;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v1, Lt7f;->a:Lt7f;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipants(Lv7f;)Ljava/util/Collection;
    ...
    invoke-static {v2, v0}, Lkj3;->S0(Ljava/lang/Iterable;I)I
    ...
    invoke-direct {v0, v1, p2}, Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants;-><init>(Lv7f;Ljava/util/Collection;)V
...
.method private final getRoomParticipantIds(Lu7f;)Ljava/util/Collection;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p1, p1, Lp7f;->e:Ljava/util/List;
...
.method private final mapConversationParticipantToSessionRoomParticipant(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;
    ...
    invoke-virtual {v2, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipantRoomId(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lv7f;

    move-result-object v2

    invoke-direct {v0, v1, v2, p1}, Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lv7f;Lru/ok/android/externcalls/sdk/ConversationParticipant;)V

    return-object v0
.end method

.method private final mapInternalIdToSessionRoomParticipant(Lsp1;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;
    .locals 2
    ...
    invoke-direct {v1, p1, v0, v0}, Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lv7f;Lru/ok/android/externcalls/sdk/ConversationParticipant;)V
...
.method private final mapInternalIdsToSessionRoomParticipants(Lv7f;Ljava/util/Collection;)Ljava/util/Collection;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, v1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->mapInternalIdToSessionRoomParticipant(Lsp1;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;
    ...
    invoke-virtual {p2, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipants(Lv7f;)Ljava/util/Collection;
...
.method private static final resolveInternalIdByExternal$lambda$0(Lzs6;Lzs6;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lsp1;)V
    .locals 1

    if-eqz p3, :cond_0

    invoke-interface {p0, p3}, Lzs6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static final resolveInternalIdByExternal$lambda$1(Lzs6;Lru/ok/android/externcalls/sdk/id/ParticipantId;)V
    .locals 3
...
.method private final resolveParticipantIds(Ljava/util/Collection;Lxs6;Lzs6;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v2, p2}, Lsn0;-><init>(ILxs6;)V

    new-instance p2, Lw7f;

    const/4 v2, 0x0

    invoke-direct {p2, v2, p3}, Lw7f;-><init>(ILzs6;)V
...
.method private static final resolveParticipantIds$lambda$8(Lxs6;)V
    .locals 0
...
.method private static final resolveParticipantIds$lambda$9(Lzs6;)V
    .locals 2
...
# virtual methods
.method public getAllInRoomParticipants(Lzs6;Lzs6;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, v0, p0, p1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl$getAllInRoomParticipants$1;-><init>(Ljava/util/Set;Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Lzs6;)V

    invoke-direct {p0, v1, v2, p2}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds(Ljava/util/Collection;Lxs6;Lzs6;)V
...
.method public final getInternalIdsByExternal(Ljava/util/Collection;)Ljava/util/Map;
    ...
    invoke-virtual {v2, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Lsp1;
...
.method public getParticipantRoomId(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lzs6;Lzs6;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p3, p2}, Lzs6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipantRoomId(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lv7f;
...
.method public getRoomParticipants(Lv7f;Lzs6;Lzs6;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p2, p3}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->getMainCallParticipantIds(Lzs6;Lzs6;)V
    ...
    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->getRoomParticipantIds(Lu7f;)Ljava/util/Collection;
    ...
    invoke-direct {v1, p2, p1, p0, v0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl$getRoomParticipants$1;-><init>(Lzs6;Lv7f;Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Ljava/util/Collection;)V

    invoke-direct {p0, v0, v1, p3}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds(Ljava/util/Collection;Lxs6;Lzs6;)V

    :cond_1
    return-void
.end method

.method public final resolveInternalIdByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lzs6;Lzs6;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p2, p3, p1, v2}, Lou4;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/io/Serializable;I)V

    new-instance p2, Lv0e;

    const/16 v2, 0x13

    invoke-direct {p2, p3, v2, p1}, Lv0e;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-interface {v0, p1, v1, p2}, Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;->withInternalId(Lru/ok/android/externcalls/sdk/id/ParticipantId;Luz3;Ljava/lang/Runnable;)V
