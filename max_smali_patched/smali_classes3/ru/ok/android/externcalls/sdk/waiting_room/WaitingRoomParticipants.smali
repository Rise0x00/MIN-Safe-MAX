...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "log",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Listener;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Lnrd;)V",
        "Li61;",
        "call",
        "Lyeh;",
        "setCall",
        ...
        "(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Loqf;",
        "Lg02;",
        "fromId",
        "Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$WaitingParticipantsPage;",
        ...
        "internalId",
        "fromInternalLong",
        "(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lsp1;)Lg02;",
        "",
        "Lf02;",
        "waitingParticipants",
        "Lkotlin/Function1;",
...
# instance fields
.field private volatile call:Li61;

.field private final compositeDisposable:Lrq3;
...
.field private final loadEventSubject:Ltad;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Companion;-><init>(Ljq4;)V
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Listener;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Lnrd;)V
    .locals 2
    ...
    iput-object p4, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->log:Lnrd;

    new-instance p1, Ltad;

    invoke-direct {p1}, Ltad;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadEventSubject:Ltad;

    new-instance p2, Lrq3;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->compositeDisposable:Lrq3;
    ...
    invoke-direct {p4, p1, v0, v1}, Lr0b;-><init>(Ltad;Lqne;I)V

    invoke-static {}, Laoe;->b()Lqne;

    move-result-object p1

    invoke-virtual {p4, p1}, Lg0b;->h(Lqne;)Lb2b;
    ...
    invoke-direct {v0, p1, p4, v1}, Lh1b;-><init>(Lg0b;Ljava/lang/Object;I)V
    ...
    invoke-direct {p1, p3}, Leu6;-><init>(Ljava/lang/Object;)V

    new-instance p3, Lc2b;

    const/4 p4, 0x0

    invoke-direct {p3, v0, p1, p4}, Lc2b;-><init>(Lg0b;Ljava/lang/Object;I)V

    invoke-static {}, Lag;->a()Lqne;

    move-result-object p1

    invoke-virtual {p3, p1}, Lg0b;->h(Lqne;)Lb2b;
    ...
    invoke-virtual {p1, p3}, Lg0b;->i(Ltz3;)Lv98;
...
.method public static synthetic a(Li61;Lg02;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Luqf;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$6(Li61;Lg02;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lwqf;)V
...
.method public static synthetic b(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Luqf;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle$lambda$1(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lwqf;)V

    return-void
.end method

.method public static synthetic c(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lwqf;Lx02;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lwqf;Lx02;)V

    return-void
.end method

.method public static synthetic d(Lwqf;)V
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$6$lambda$5(Lwqf;)V

    return-void
.end method

.method public static synthetic e(Lwqf;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle$lambda$1$lambda$0(Lwqf;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V

    return-void
.end method

.method private final fromInternalLong(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lsp1;)Lg02;
    .locals 3
    ...
    invoke-direct {v0, p2, v1, v2}, Lg02;-><init>(Lsp1;J)V
...
.method private final getInternalIdsToResolve(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v1, v1, Lf02;->a:Lg02;

    iget-object v1, v1, Lg02;->b:Lsp1;
    ...
    invoke-virtual {v2, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lsp1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private final getResolvedWaitingParticipantIds(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v2, v1, Lf02;->a:Lg02;

    iget-object v2, v2, Lg02;->b:Lsp1;
    ...
    invoke-virtual {v3, v2}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lsp1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private final loadWaitingParticipantIds()Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipantsUpdate;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->call:Li61;
    ...
    :try_start_0
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Loqf;
    ...
    invoke-direct {p0, v3, v6}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->fromInternalLong(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lsp1;)Lg02;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->log:Lnrd;
    ...
    :goto_0
    :try_start_1
    invoke-direct {p0, v0, v6}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle(Li61;Lg02;)Loqf;
    ...
    invoke-static {v2, v3, v0, v4}, Lndh;->i(Lnrd;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private final loadWaitingParticipantIdsPageSingle(Li61;Lg02;)Loqf;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p2, p0, v1}, Lxah;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p1, Li2b;

    const/4 p2, 0x1

    invoke-direct {p1, p2, v0}, Li2b;-><init>(ILjava/lang/Object;)V

    return-object p1
.end method

.method private static final loadWaitingParticipantIdsPageSingle$lambda$6(Li61;Lg02;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lwqf;)V
    .locals 7
    ...
    invoke-direct {v0, p2, v1, p3}, Lq2c;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance p2, Lo0h;

    const/16 v1, 0xf

    invoke-direct {p2, v1, p3}, Lo0h;-><init>(ILjava/lang/Object;)V

    iget-object p3, p0, Li61;->k:Lrnf;
    ...
    iget-object v5, p1, Lg02;->b:Lsp1;

    invoke-virtual {v5}, Lsp1;->b()Ljava/lang/String;
    ...
    invoke-virtual {v1, v2, p1}, Lrx6;->b(ILjava/lang/String;)V
    :try_end_0
    ...
    invoke-direct {p1, p0, v0, p2, v2}, Lq51;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p0, Lb61;

    const/4 v0, 0x0

    invoke-direct {p0, v0, p2}, Lb61;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p3, v1, v4, p1, p0}, Lrnf;->d(Lvnf;ZLonf;Lonf;)V
...
.method private static final loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lwqf;Lx02;)V
    .locals 8

    iget-object v2, p2, Lx02;->a:Ljava/util/ArrayList;
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4$$inlined$resolveInternalIds$1;-><init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ljava/util/List;Lwqf;Lx02;Lwqf;)V
    ...
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4$$inlined$resolveInternalIds$2;-><init>(Lwqf;)V
    ...
    invoke-virtual {p0, p1}, Luqf;->b(Ljava/lang/Object;)V

    return-void
.end method

.method private static final loadWaitingParticipantIdsPageSingle$lambda$6$lambda$5(Lwqf;)V
    .locals 2
    ...
    invoke-virtual {p0, v0}, Luqf;->c(Ljava/lang/Throwable;)Z
...
.method private final putIdMappingsToCache(Ljava/util/List;)V
    ...
    iget-object v0, v0, Lf02;->a:Lg02;

    iget-object v0, v0, Lg02;->b:Lsp1;

    invoke-virtual {v2, v1, v0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lsp1;)V
...
.method private final resolveInternalIdSingle(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Loqf;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static final resolveInternalIdSingle$lambda$1(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lwqf;)V
    .locals 4
    ...
    invoke-direct {v1, v2, p2}, Lrz3;-><init>(ILjava/lang/Object;)V

    new-instance v2, Lerf;

    const/16 v3, 0x1d

    invoke-direct {v2, p2, v3, p1}, Lerf;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-interface {p0, v0, v1, v2}, Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;->withInternalId(Lru/ok/android/externcalls/sdk/id/ParticipantId;Luz3;Ljava/lang/Runnable;)V

    return-void
.end method

.method private static final resolveInternalIdSingle$lambda$1$lambda$0(Lwqf;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V
    .locals 3
    ...
    invoke-virtual {p0, v0}, Luqf;->a(Ljava/lang/Throwable;)V

    return-void
.end method

.method private final resolveInternalIds(Ljava/util/List;Lzs6;Lzs6;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$1;-><init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ljava/util/List;Lzs6;Lzs6;)V

    new-instance p1, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$2;

    invoke-direct {p1, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$2;-><init>(Lzs6;)V
...
.method private final scheduleLoad()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadEventSubject:Ltad;
...
.method public final release()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->compositeDisposable:Lrq3;
...
.method public final setCall(Li61;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->call:Li61;
