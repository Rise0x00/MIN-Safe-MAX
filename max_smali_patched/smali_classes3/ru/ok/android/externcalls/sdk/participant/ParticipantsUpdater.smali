...
.method public onActiveParticipantUpdated(Lr61;)V
    ...
    iget-object v1, p1, Lr61;->c:Lv7f;

    iget-object v2, p1, Lr61;->d:Lp7f;

    invoke-virtual {v0, v1, v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->setActiveSessionRoom(Lv7f;Lp7f;)V
    ...
    invoke-static {p1}, Lddh;->c(Ljava/lang/Object;)Ljava/util/Collection;
...
.method public onCallParticipantsAdded(Leq1;)V
    .locals 8
    ...
    :cond_0
    invoke-virtual {v4, v5}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lsp1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;

    move-result-object v4

    iget-object v5, v3, Lxp1;->q:Lue1;

    invoke-static {v5}, Lru/ok/android/externcalls/sdk/id/CallExternalIdConverter;->convert(Lue1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    invoke-virtual {v6, v5, v3}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lsp1;)V
    ...
    invoke-static {v3, v2}, Lru/ok/android/externcalls/sdk/ConversationParticipantExtensionsKt;->createConversationParticipantFromInternal(Lsp1;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-static {v2, v5, v3}, Lru/ok/android/externcalls/sdk/ConversationParticipantExtensionsKt;->setCallParticipantExt(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lxp1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V

    iget-object v3, p0, Lru/ok/android/externcalls/sdk/participant/ParticipantsUpdater;->store:Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;

    iget-object v5, p1, Leq1;->a:Lv7f;

    invoke-virtual {v3, v2, v5}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->add(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lv7f;)V
    ...
    invoke-static {v3, v5, v4}, Lru/ok/android/externcalls/sdk/ConversationParticipantExtensionsKt;->setCallParticipantExt(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lxp1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
...
.method public onCallParticipantsChanged(Lfq1;)V
    .locals 4
    ...
    :cond_1
    invoke-virtual {v2, v3}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lsp1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-static {v2, v1, v3}, Lru/ok/android/externcalls/sdk/ConversationParticipantExtensionsKt;->setCallParticipantExt(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lxp1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    :cond_3
    iget-object v2, v1, Lxp1;->q:Lue1;

    invoke-static {v2}, Lru/ok/android/externcalls/sdk/id/CallExternalIdConverter;->convert(Lue1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method public onCallParticipantsDeAnonimized(Lgq1;)V
    .locals 7
    ...
    :cond_1
    invoke-virtual {v3, v4}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lsp1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;

    move-result-object v3

    iget-object v4, v2, Lxp1;->q:Lue1;

    if-eqz v3, :cond_0

    if-eqz v4, :cond_0

    iget-object v5, v4, Lue1;->a:Ljava/lang/String;
    ...
    invoke-static {v4}, Lru/ok/android/externcalls/sdk/id/CallExternalIdConverter;->convert(Lue1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    invoke-virtual {v6}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->getInternalId()Lsp1;
...
.method public onCallParticipantsRemoved(Lhq1;)V
    .locals 6
    ...
    invoke-virtual {v4, v3}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lsp1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-static {v4, v2, v5}, Lru/ok/android/externcalls/sdk/ConversationParticipantExtensionsKt;->setCallParticipantExt(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lxp1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
...
.method public onCurrentParticipantActiveRoomChanged(Lrv1;)V
    ...
    iget-object v1, p1, Lrv1;->a:Lv7f;

    iget-object p1, p1, Lrv1;->b:Lp7f;

    invoke-virtual {v0, v1, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->setActiveSessionRoom(Lv7f;Lp7f;)V
...
.method public onCurrentParticipantInvitedToRoom(Lsv1;)V
    .locals 2

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/participant/ParticipantsUpdater;->store:Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;

    iget-object v1, p1, Lsv1;->b:Lv7f;

    iget-object p1, p1, Lsv1;->c:Lp7f;

    invoke-virtual {v0, v1, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->setProposedSessionRoom(Lv7f;Lp7f;)V

    return-void
.end method

.method public onRoomRemoved(Ltv1;)V
    .locals 3

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/participant/ParticipantsUpdater;->store:Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;

    invoke-virtual {v0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getProposedRoomId()Lv7f;

    move-result-object v0

    iget-object p1, p1, Ltv1;->a:Lv7f;
    ...
    invoke-virtual {v0, v2, v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->setProposedSessionRoom(Lv7f;Lp7f;)V
    ...
    invoke-virtual {p1, v2, v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->setActiveSessionRoom(Lv7f;Lp7f;)V

    :cond_1
    return-void
.end method

.method public onRoomUpdated(Luv1;)V
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/participant/ParticipantsUpdater;->store:Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;

    iget-object p1, p1, Luv1;->b:Lp7f;

    invoke-virtual {v0, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->maybeUpdateRoom(Lp7f;)V
