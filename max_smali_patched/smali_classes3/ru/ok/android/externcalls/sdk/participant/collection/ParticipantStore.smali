...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "sessionRoomId",
        "add",
        "(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lv7f;)V",
        "Lsp1;",
        ...
        "getByInternal",
        "(Lsp1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;",
        "removeByExternal",
        ...
        "(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lv7f;",
        "Lp7f;",
        "room",
...
.field private proposedRoom:Lp7f;

.field private proposedRoomId:Lv7f;
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    sget-object p2, Lt7f;->a:Lt7f;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoomId:Lv7f;
...
.method private final getSessionRoomParticipantsMap(Lv7f;)Ljava/util/LinkedHashMap;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private final onActiveRoomChanged(Lv7f;Lv7f;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, p2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->add(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lv7f;)V
...
.method private final setActiveRoomId(Lv7f;)V
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoomId:Lv7f;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoomId:Lv7f;

    invoke-direct {p0, v0, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->onActiveRoomChanged(Lv7f;Lv7f;)V
...
# virtual methods
.method public final add(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lv7f;)V
    .locals 2
    ...
    .line 4
    invoke-direct {p0, p2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getSessionRoomParticipantsMap(Lv7f;)Ljava/util/LinkedHashMap;
...
.method public final addToActiveSessionRoom(Lru/ok/android/externcalls/sdk/ConversationParticipant;)V
    ...
    invoke-virtual {p0, p1, v0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->add(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lv7f;)V
...
.method public final containsByInternal(Lsp1;)Z
    .locals 0

    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lsp1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
...
.method public final getActiveRoom()Lp7f;
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoom:Lp7f;

    return-object v0
.end method

.method public final getActiveRoomId()Lv7f;
    .locals 1
...
.method public getByInternal(Lsp1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->localIdMappings:Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;

    invoke-virtual {v0, p1}, Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;->getLocalId(Lsp1;)Lru/ok/android/externcalls/sdk/id/local/LocalParticipantId;
...
.method public final getParticipantRoomId(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lv7f;
    .locals 1
...
.method public getParticipants()Ljava/util/Collection;
    ...
    invoke-virtual {p0, v0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipants(Lv7f;)Ljava/util/Collection;
...
.method public final getParticipants(Lv7f;)Ljava/util/Collection;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getSessionRoomParticipantsMap(Lv7f;)Ljava/util/LinkedHashMap;
...
.method public final getProposedRoom()Lp7f;
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->proposedRoom:Lp7f;

    return-object v0
.end method

.method public final getProposedRoomId()Lv7f;
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->proposedRoomId:Lv7f;
...
.method public final maybeUpdateRoom(Lp7f;)V
    .locals 2

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoomId:Lv7f;

    iget-object v1, p1, Lp7f;->a:Lu7f;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoom:Lp7f;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->proposedRoom:Lp7f;
...
.method public final removeByInternal(Ljava/util/Collection;)V
    ...
    .line 4
    invoke-virtual {p0, v0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->removeByInternal(Lsp1;)V
...
.method public final removeByInternal(Lsp1;)V
    .locals 1
...
.method public final setActiveSessionRoom(Lv7f;Lp7f;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->setActiveRoomId(Lv7f;)V

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoom:Lp7f;

    return-void
.end method

.method public final setProposedSessionRoom(Lv7f;Lp7f;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->proposedRoomId:Lv7f;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->proposedRoom:Lp7f;
...
.method public toArray()[Ljava/lang/Object;
    ...
    .line 1
    invoke-static {p0}, Lsr6;->d0(Ljava/util/Collection;)[Ljava/lang/Object;
...
.method public toArray([Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    .line 2
    invoke-static {p0, p1}, Lsr6;->e0(Ljava/util/Collection;[Ljava/lang/Object;)[Ljava/lang/Object;
