...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "externalIds",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Lzs6;Lzs6;Ljava/util/Collection;)V",
...
.field private final onError:Lzs6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lzs6;"
        }
...
.field private final onSuccess:Lzs6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lzs6;"
        }
...
# direct methods
.method public constructor <init>(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Lzs6;Lzs6;Ljava/util/Collection;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$ListenerAddParticipantsResponse;->onSuccess:Lzs6;

    .line 3
    iput-object p3, p0, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$ListenerAddParticipantsResponse;->onError:Lzs6;
...
.method public synthetic constructor <init>(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Lzs6;Lzs6;Ljava/util/Collection;ILjq4;)V
    .locals 1
    ...
    .line 5
    sget-object p4, Lpj5;->a:Lpj5;

    .line 6
    :cond_2
    invoke-direct {p0, p1, p2, p3, p4}, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$ListenerAddParticipantsResponse;-><init>(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Lzs6;Lzs6;Ljava/util/Collection;)V
...
.method public onResponse(Lorg/json/JSONObject;)V
    ...
    :cond_0
    invoke-static {v9}, Lerj;->x(Lorg/json/JSONObject;)Lsp1;
    ...
    invoke-static {v11}, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;->access$getCall$p(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;)Li61;

    move-result-object v11

    invoke-virtual {v11, v10, v9}, Li61;->z(Lsp1;Lorg/json/JSONObject;)I
    ...
    :cond_3
    iget-object v2, v1, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$ListenerAddParticipantsResponse;->onSuccess:Lzs6;
    ...
    invoke-static {v0, v8}, Lerj;->F(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-static {v0, v10}, Lerj;->F(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-static {v0, v11}, Lerj;->C(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-static {v0, v12}, Lerj;->C(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget-object v14, v13, Lue1;->a:Ljava/lang/String;

    new-instance v15, Lru/ok/android/externcalls/sdk/id/ParticipantId;

    iget-object v6, v13, Lue1;->a:Ljava/lang/String;

    iget v7, v13, Lue1;->b:I
    ...
    invoke-virtual {v0, v11}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lsp1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    :cond_11
    invoke-static {v7, v9}, Lij3;->x1(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v7, v10}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lsp1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    :cond_13
    invoke-static {v9, v6}, Lij3;->x1(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v7, v9}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lsp1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    invoke-virtual {v3, v7}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lsp1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    :goto_c
    iget-object v2, v1, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$ListenerAddParticipantsResponse;->onError:Lzs6;
