...
.field private badNetworkIndicatorConfig:Lol0;

.field private bitrates:Ljp1;
...
.field private groupCallMediaAdaptationConfig:Lo09;
...
.method public constructor <init>()V
    ...
    sget-object v1, Lqfe;->b0:Ldbe;

    iput-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->rotationProvider:Lqfe;

    const-string v1, "sdk-0.1.14"
    ...
    invoke-static {}, Lru/ok/android/externcalls/sdk/CallUtil;->createBitrates()Ljp1;

    move-result-object v0

    iput-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->bitrates:Ljp1;
    ...
    sget-object v0, Lol0;->e:Lol0;

    iput-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->badNetworkIndicatorConfig:Lol0;
...
.method public getBaseBuilder(Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->bitrates:Ljp1;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setBitrates(Ljp1;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->rotationProvider:Lqfe;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setRotationProvider(Lqfe;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->p2pCallMediaAdaptationConfig:Lo09;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setP2PCallMediaAdaptationConfig(Lo09;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->groupCallMediaAdaptationConfig:Lo09;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setGroupCallMediaAdaptationConfig(Lo09;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->badNetworkIndicatorConfig:Lol0;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setBadNetworkIndicatorConfig(Lol0;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    move-result-object p1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->screenCapturePermissionProvider:Looe;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setScreenCapturePermissionProvider(Looe;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
...
.method public setBadNetworkIndicatorConfig(Lol0;)V
    .locals 0

    if-nez p1, :cond_0

    sget-object p1, Lol0;->e:Lol0;

    :cond_0
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->badNetworkIndicatorConfig:Lol0;

    return-void
.end method

.method public setBitrates(Ljp1;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->bitrates:Ljp1;
...
.method public setGroupCallMediaAdaptationConfig(Lo09;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->groupCallMediaAdaptationConfig:Lo09;
...
.method public setJoinConversationDelegate(Lp28;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->joinConversationDelegate:Lp28;
...
.method public setP2PCallMediaAdaptationConfig(Lo09;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->p2pCallMediaAdaptationConfig:Lo09;
...
.method public setRotationProvider(Lqfe;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->rotationProvider:Lqfe;
...
.method public setScreenCapturePermissionProvider(Looe;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->screenCapturePermissionProvider:Looe;
