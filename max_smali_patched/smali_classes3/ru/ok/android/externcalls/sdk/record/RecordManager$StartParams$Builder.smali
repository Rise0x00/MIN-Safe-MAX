...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "sessionRoomId",
        "withSessionRoomId",
        "(Lv7f;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;",
        "",
        "name",
        "withName",
        ...
        "onSuccess",
        "withCallOnSuccess",
        "(Lzs6;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;",
        "",
        "onError",
        "withCallOnError",
...
.field private sessionRoomId:Lv7f;
...
.method public final build()Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;
    ...
    iget-object v4, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->sessionRoomId:Lv7f;
    ...
    iget-object v9, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->onSuccess:Lzs6;

    iget-object v10, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->onError:Lzs6;

    new-instance v0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;

    const/4 v11, 0x0

    invoke-direct/range {v0 .. v11}, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;-><init>(ZLjava/lang/Long;Ljava/lang/String;Lv7f;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/Long;Ljava/lang/String;Lzs6;Lzs6;Ljq4;)V
...
.method public final withCallOnError(Lzs6;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->onError:Lzs6;

    return-object p0
.end method

.method public final withCallOnSuccess(Lzs6;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->onSuccess:Lzs6;
...
.method public final withSessionRoomId(Lv7f;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->sessionRoomId:Lv7f;
