...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "toRecordDescription",
        "(Lpr1;)Lru/ok/android/externcalls/sdk/record/RecordDescription;",
        ...
        "current",
        "setMyRecordHistory",
        "(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lv7f;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V",
        "reportStarted",
        "()V",
        "whoStoppedRecordId",
        "reportStopped",
        ...
        "onError",
        "startRecord",
        "(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lxs6;Lzs6;)V",
        "Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;",
        "stopRecord",
        "(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lxs6;Lzs6;)V",
...
# instance fields
.field private activeRoomId:Lv7f;

.field private final commandParamsCreator:Llyd;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl$Companion;-><init>(Ljq4;)V
...
.method public constructor <init>(Lnrd;Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;Lru/ok/android/externcalls/sdk/events/RecordEventListener;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->logger:Lnrd;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->commandParamsCreator:Llyd;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lv7f;

    return-void
.end method

.method public static synthetic a(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lzs6;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->stopRecord$lambda$3(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lzs6;Lorg/json/JSONObject;)V

    return-void
.end method

.method private final applyRecordStarted(Lrr1;)V
    .locals 2

    iget-object v0, p1, Lrr1;->b:Lpr1;

    iget-object p1, p1, Lrr1;->a:Lv7f;

    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->toRecordDescription(Lpr1;)Lru/ok/android/externcalls/sdk/record/RecordDescription;
    ...
    invoke-direct {p0, v1, p1, v0}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->setMyRecordHistory(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lv7f;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lv7f;
...
.method public static synthetic b(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lrr1;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->onRecordStarted$lambda$4(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lrr1;)V

    return-void
.end method

.method public static synthetic c(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lxs6;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->stopRecord$lambda$2(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lxs6;Lorg/json/JSONObject;)V

    return-void
.end method

.method public static synthetic d(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lzs6;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->startRecord$lambda$1(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lzs6;Lorg/json/JSONObject;)V
...
.method public static synthetic f(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lxs6;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->startRecord$lambda$0(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lxs6;Lorg/json/JSONObject;)V

    return-void
.end method

.method private final notifyListenersWhenActiveRoomChanged(Lv7f;Lv7f;)V
    .locals 1
...
.method private static final onRecordStarted$lambda$4(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lrr1;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->applyRecordStarted(Lrr1;)V
...
.method private static final onRecordStarted$lambda$5(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;)V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->logger:Lnrd;
...
.method private final setMyRecordHistory(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lv7f;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V
    .locals 3
...
.method private static final startRecord$lambda$0(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lxs6;Lorg/json/JSONObject;)V
    .locals 0

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;->getOnSuccess()Lzs6;
...
.method private static final startRecord$lambda$1(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lzs6;Lorg/json/JSONObject;)V
    .locals 2
    ...
    :cond_0
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;->getOnError()Lzs6;
    ...
    invoke-interface {p2, p0}, Lzs6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    :cond_2
    return-void
.end method

.method private static final stopRecord$lambda$2(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lxs6;Lorg/json/JSONObject;)V
    .locals 1

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;->getOnSuccess()Lzs6;
    ...
    invoke-interface {p0, p2}, Lzs6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static final stopRecord$lambda$3(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lzs6;Lorg/json/JSONObject;)V
    .locals 2
    ...
    :cond_0
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;->getOnError()Lzs6;
...
.method private final toRecordDescription(Lpr1;)Lru/ok/android/externcalls/sdk/record/RecordDescription;
    .locals 9

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->participantStore:Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;

    iget-object v1, p1, Lpr1;->c:Lsp1;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lsp1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lsp1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    iget-object v2, p1, Lpr1;->b:Lw0e;

    iget-wide v3, p1, Lpr1;->d:J

    iget-wide v5, p1, Lpr1;->a:J

    iget-object v7, p1, Lpr1;->e:Ljava/lang/String;

    iget-object v8, p1, Lpr1;->f:Ljava/lang/String;

    invoke-direct/range {v0 .. v8}, Lru/ok/android/externcalls/sdk/record/RecordDescription;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lw0e;JJLjava/lang/String;Ljava/lang/String;)V
...
.method public final getRecordAdmin()Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lv7f;
...
.method public onCurrentParticipantActiveRoomChanged(Lrv1;)V
    .locals 1

    iget-object p1, p1, Lrv1;->a:Lv7f;
    ...
    invoke-direct {p0, v0, p1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->notifyListenersWhenActiveRoomChanged(Lv7f;Lv7f;)V

    return-void
.end method

.method public bridge synthetic onCurrentParticipantInvitedToRoom(Lsv1;)V
    .locals 0

    return-void
.end method

.method public onRecordError(Lqr1;)V
    .locals 0
...
.method public onRecordStarted(Lrr1;)V
    .locals 4

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->participantStore:Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;

    iget-object v1, p1, Lrr1;->b:Lpr1;

    iget-object v1, v1, Lpr1;->c:Lsp1;
    ...
    invoke-direct {v2, p0, v3, p1}, Lv0e;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance p1, Llc8;

    const/16 v3, 0x1b

    invoke-direct {p1, v3, p0}, Llc8;-><init>(ILjava/lang/Object;)V
...
.method public onRecordStopped(Lsr1;)V
    .locals 3

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->sessionRoomToRecordInfo:Ljava/util/HashMap;

    iget-object v1, p1, Lsr1;->a:Lv7f;
    ...
    :goto_0
    invoke-direct {p0, v0, v1, v2}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->setMyRecordHistory(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lv7f;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V
...
.method public bridge synthetic onRoomRemoved(Ltv1;)V
    .locals 0

    return-void
.end method

.method public bridge synthetic onRoomUpdated(Luv1;)V
    .locals 0
...
.method public startRecord(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lxs6;Lzs6;)V
    .locals 21
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v3, v2}, Lru/ok/android/externcalls/sdk/signaling/SignalingProviderKt;->get(Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;Lzs6;)Lrnf;
    ...
    :cond_0
    iget-object v4, v1, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->commandParamsCreator:Llyd;
    ...
    invoke-virtual {v0}, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;->getSessionRoomId()Lv7f;

    move-result-object v7

    if-nez v7, :cond_1

    iget-object v7, v1, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lv7f;
    ...
    invoke-static {v5, v4}, Lerj;->b(Lorg/json/JSONObject;Ljava/lang/String;)Lrx6;

    move-result-object v4

    instance-of v5, v7, Lu7f;
    ...
    invoke-virtual {v4, v6, v5}, Lrx6;->b(ILjava/lang/String;)V
    :try_end_0
    ...
    :cond_3
    :goto_0
    new-instance v5, Lu0e;

    const/4 v6, 0x1

    move-object/from16 v7, p2

    invoke-direct {v5, v0, v7, v6}, Lu0e;-><init>(Ljava/lang/Object;Lxs6;I)V

    new-instance v6, Lq51;

    const/4 v7, 0x5

    invoke-direct {v6, v1, v0, v2, v7}, Lq51;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    const/4 v0, 0x0

    invoke-virtual {v3, v4, v0, v5, v6}, Lrnf;->d(Lvnf;ZLonf;Lonf;)V
...
.method public stopRecord(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lxs6;Lzs6;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, p3}, Lru/ok/android/externcalls/sdk/signaling/SignalingProviderKt;->get(Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;Lzs6;)Lrnf;
    ...
    :cond_0
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->commandParamsCreator:Llyd;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;->getSessionRoomId()Lv7f;

    move-result-object v2

    if-nez v2, :cond_1

    iget-object v2, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lv7f;
    ...
    invoke-static {v1, v4}, Lerj;->b(Lorg/json/JSONObject;Ljava/lang/String;)Lrx6;

    move-result-object v1

    iget-object v5, v1, Lrx6;->a:Lorg/json/JSONObject;

    const-string v6, "command"

    invoke-virtual {v5, v6, v4}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    instance-of v4, v2, Lu7f;
    ...
    invoke-virtual {v1, v2, v4}, Lrx6;->b(ILjava/lang/String;)V
    ...
    invoke-direct {v2, p1, p2, v3}, Lu0e;-><init>(Ljava/lang/Object;Lxs6;I)V

    new-instance p2, Lq51;

    const/4 v3, 0x4

    invoke-direct {p2, p0, p1, p3, v3}, Lq51;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    const/4 p1, 0x0

    invoke-virtual {v0, v1, p1, v2, p2}, Lrnf;->d(Lvnf;ZLonf;Lonf;)V
