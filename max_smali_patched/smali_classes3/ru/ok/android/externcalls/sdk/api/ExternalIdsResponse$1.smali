...
.method private parseIds(Ljava/util/Map;Lz68;Z)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2}, Lz68;->q()V

    :goto_0
    invoke-interface {p2}, Lz68;->hasNext()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-interface {p2}, Lz68;->name()Ljava/lang/String;

    move-result-object v0

    invoke-interface {p2}, Lz68;->S()Ljava/lang/String;
...
# virtual methods
.method public bridge synthetic parse(Lz68;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    .line 1
    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/api/ExternalIdsResponse$1;->parse(Lz68;)Lru/ok/android/externcalls/sdk/api/ExternalIdsResponse;
...
.method public parse(Lz68;)Lru/ok/android/externcalls/sdk/api/ExternalIdsResponse;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    .line 7
    invoke-direct {p0, v0, p1, v1}, Lru/ok/android/externcalls/sdk/api/ExternalIdsResponse$1;->parseIds(Ljava/util/Map;Lz68;Z)V
