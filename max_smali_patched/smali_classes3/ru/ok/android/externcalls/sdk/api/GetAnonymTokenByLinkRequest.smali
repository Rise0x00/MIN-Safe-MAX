...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lru/ok/android/externcalls/sdk/api/GetAnonymTokenByLinkRequest;->PARSER:Lo68;
...
.method public static synthetic b(Lz68;)Lru/ok/android/externcalls/sdk/api/GetAnonymTokenByLinkRequest$Response;
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/api/GetAnonymTokenByLinkRequest;->lambda$static$0(Lz68;)Lru/ok/android/externcalls/sdk/api/GetAnonymTokenByLinkRequest$Response;
...
.method private static synthetic lambda$static$0(Lz68;)Lru/ok/android/externcalls/sdk/api/GetAnonymTokenByLinkRequest$Response;
    .locals 4
    ...
    :goto_0
    invoke-interface {p0}, Lz68;->hasNext()Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-interface {p0}, Lz68;->name()Ljava/lang/String;
    ...
    :cond_0
    invoke-interface {p0}, Lz68;->S()Ljava/lang/String;
...
# virtual methods
.method public bridge synthetic getConfigExtractor()Lln;
    .locals 1
...
.method public bridge synthetic getFailParser()Lo68;
    .locals 1
...
.method public getOkParser()Lo68;
    ...
    sget-object v0, Lru/ok/android/externcalls/sdk/api/GetAnonymTokenByLinkRequest;->PARSER:Lo68;
...
.method public bridge synthetic getScope()Lgo;
    .locals 1

    sget-object v0, Lgo;->d:Lgo;

    return-object v0
.end method

.method public bridge synthetic getScopeAfter()Lho;
    .locals 1
...
.method public populateParams(Lyn;)V
    .locals 2
    ...
    invoke-virtual {p1, v0, v1}, Lyn;->b(Ljava/lang/String;Ljava/lang/String;)V
