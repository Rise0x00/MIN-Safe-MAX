...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "timeProvider",
        "<init>",
        "(Lhie;Lru/ok/android/externcalls/sdk/api/OkApiService;Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Lnrd;Lvwg;)V",
        "",
        "cid",
        "",
        "peerId",
        ...
        "joinToConversation",
        "(Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Loqf;",
        "anonToken",
        "",
        "isFastRetryEnabled",
        "Lru/ok/android/externcalls/sdk/api/ConversationParams;",
        "getConversationParams",
        "(Ljava/lang/String;ZLjava/lang/String;)Loqf;",
        "initialJoinLink",
        "joinConversationByLink",
        "(Ljava/lang/String;Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Loqf;",
        "servers",
        "createLink",
        ...
        "startConversation",
        "(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Loqf;",
        "createJoinLink",
        ...
        "Lhz6;",
        "requestUploadUrl",
        "(Ljava/lang/String;Lblh;Ljava/lang/String;)Loqf;",
        "",
        "keys",
        "",
        "getSettingsBlocking",
        ...
        "(Lorg/json/JSONObject;)Loqf;",
        "cId",
        "Lu57;",
        "reason",
        "Lru/ok/android/externcalls/sdk/api/request/HangupConversation$Response;",
        "hangupConversation",
        "(Ljava/lang/String;Lu57;Ljava/lang/String;)Loqf;",
        "",
        "Lsp1;",
...
.field private rtcLog:Lnrd;

.field private final rxApiClient:Lhie;

.field private timeProvider:Lvwg;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal$Companion;-><init>(Ljq4;)V
...
.method public constructor <init>(Lhie;Lru/ok/android/externcalls/sdk/api/OkApiService;Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Lnrd;Lvwg;)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rxApiClient:Lhie;
    ...
    .line 5
    iput-object p4, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rtcLog:Lnrd;

    .line 6
    iput-object p5, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->timeProvider:Lvwg;

    return-void
.end method

.method public constructor <init>(Lhie;Lru/ok/android/externcalls/sdk/api/OkApiService;Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Lnrd;Lvwg;ILjq4;)V
    .locals 6
...
.method public static synthetic getConversationParams$default(Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;Ljava/lang/String;ZLjava/lang/String;ILjava/lang/Object;)Loqf;
    .locals 1
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->getConversationParams(Ljava/lang/String;ZLjava/lang/String;)Loqf;
...
# virtual methods
.method public final createJoinLink(Ljava/lang/String;)Loqf;
    .locals 2
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rxApiClient:Lhie;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rtcLog:Lnrd;

    invoke-static {p1, v0}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiCallForFastWorkRequired(Loqf;Lnrd;)Loqf;
...
.method public final getConversationParams(Ljava/lang/String;ZLjava/lang/String;)Loqf;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p2, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rtcLog:Lnrd;

    invoke-static {p1, p2}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiCallForFastWorkRequired(Loqf;Lnrd;)Loqf;
...
.method public final getExternalIdsByOkIds(Ljava/util/Collection;)Loqf;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, v0, v0}, Lij3;->N1(Ljava/lang/Iterable;II)Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rxApiClient:Lhie;

    invoke-static {v0}, Lru/ok/android/externcalls/sdk/api/request/BatchRequestKt;->toBatchRequest(Ljava/util/List;)Lpn;

    move-result-object v1

    invoke-virtual {p1, v1}, Lhie;->a(Lpn;)Lzz8;

    move-result-object p1

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->timeProvider:Lvwg;
    ...
    invoke-direct {v4, v3, v5, v1}, Lmof;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance v5, Lvqf;

    const/4 v6, 0x1

    invoke-direct {v5, p1, v4, v6}, Lvqf;-><init>(Loqf;Ltz3;I)V

    new-instance p1, Lal8;

    invoke-direct {p1, v3, v2, v1}, Lal8;-><init>(Ln3e;Lzs6;Lvwg;)V

    new-instance v1, Lzz8;

    const/4 v2, 0x1

    invoke-direct {v1, v5, p1, v2}, Lzz8;-><init>(Loqf;Ljava/lang/Object;I)V
...
.method public final getOkIdByExternalId(Ljava/lang/String;)Loqf;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p1, v4, v2, v3}, Lru/ok/android/externcalls/sdk/api/request/GetOkIdByExternalId$Request;-><init>(Ljava/lang/String;ZILjq4;)V
...
.method public final getOkIdsByExternalIds(Ljava/util/Collection;)Loqf;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final getSettings(Ljava/util/Set;)Loqf;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final getSettingsBlocking(Ljava/util/Set;)Ljava/util/Map;
    ...
    iget-object p1, v0, Lhie;->a:Lcn;

    invoke-interface {p1, v1}, Lcn;->a(Lpn;)Ljava/lang/Object;
...
.method public final hangupConversation(Ljava/lang/String;Lu57;Ljava/lang/String;)Loqf;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p1, p2, p3}, Lru/ok/android/externcalls/sdk/api/request/HangupConversation$Request;-><init>(Ljava/lang/String;Lu57;Ljava/lang/String;)V
...
.method public final joinConversationByLink(Ljava/lang/String;Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Loqf;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, p2}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiCallForJoining(Loqf;Lnrd;)Loqf;
...
.method public final joinToConversation(Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Loqf;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/api/request/JoinConversation$Request;-><init>(Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;Lnt6;)V

    iget-object p1, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rxApiClient:Lhie;

    invoke-virtual {p1, v0}, Lhie;->a(Lpn;)Lzz8;
...
.method public final removeJoinLink(Ljava/lang/String;)Loqf;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final requestUploadUrl(Ljava/lang/String;Lblh;Ljava/lang/String;)Loqf;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p1, p2, p3}, Lgz6;-><init>(Ljava/lang/String;Lblh;Ljava/lang/String;)V
...
.method public final sendSupportedCodecsStatistics(Lorg/json/JSONObject;)Loqf;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, v0}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiCallForBackgroundWork(Loqf;Lnrd;)Loqf;
...
.method public final startConversation(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Loqf;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v7}, Lru/ok/android/externcalls/sdk/api/request/StartConversation$Request;-><init>(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;Lrt6;)V
    ...
    invoke-static {p1, p2}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiCallForOutgoing(Loqf;Lnrd;)Loqf;
