...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "parse",
        "(Lz68;)Lru/ok/android/externcalls/sdk/api/CallInfo;",
        "",
        "conversationId",
        "startConversationDelegateResultParse",
        "(Lz68;Ljava/lang/String;)Lru/ok/android/externcalls/sdk/api/CallInfo;",
...
.method public synthetic constructor <init>(Ljq4;)V
    .locals 0
...
.method public static final synthetic access$parse(Lru/ok/android/externcalls/sdk/api/CallInfo$Companion;Lz68;)Lru/ok/android/externcalls/sdk/api/CallInfo;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/api/CallInfo$Companion;->parse(Lz68;)Lru/ok/android/externcalls/sdk/api/CallInfo;
...
.method private final parse(Lz68;)Lru/ok/android/externcalls/sdk/api/CallInfo;
    .locals 19
    ...
    :cond_1
    invoke-static/range {p1 .. p1}, Lru/ok/android/externcalls/sdk/api/TurnStunParser;->parseStun(Lz68;)Ljava/util/List;
    ...
    :cond_3
    invoke-static/range {p1 .. p1}, Lru/ok/android/externcalls/sdk/api/TurnStunParser;->parseTurn(Lz68;)Ljava/util/List;
    ...
    :cond_4
    invoke-interface/range {p1 .. p1}, Lz68;->p0()Z
    ...
    invoke-direct/range {v3 .. v18}, Lru/ok/android/externcalls/sdk/api/CallInfo;-><init>(Ljava/lang/String;Ljava/util/List;Ljava/lang/String;Ljava/util/List;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLjava/util/List;Ljava/util/List;ZIILjq4;)V
...
.method private final startConversationDelegateResultParse(Lz68;Ljava/lang/String;)Lru/ok/android/externcalls/sdk/api/CallInfo;
    .locals 19
...
.method public final createFromStartConversationDelegateResult$calls_sdk_release(Lru/ok/android/externcalls/sdk/api/delegate/StartConversationDelegate$Result$Success;)Lru/ok/android/externcalls/sdk/api/CallInfo;
    ...
    invoke-direct {p0, v0, p1}, Lru/ok/android/externcalls/sdk/api/CallInfo$Companion;->startConversationDelegateResultParse(Lz68;Ljava/lang/String;)Lru/ok/android/externcalls/sdk/api/CallInfo;
...
.method public final getPARSER()Lo68;
    .locals 1
    ...
    invoke-static {}, Lru/ok/android/externcalls/sdk/api/CallInfo;->access$getPARSER$cp()Lo68;
