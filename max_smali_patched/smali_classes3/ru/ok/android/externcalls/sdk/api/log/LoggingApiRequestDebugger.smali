...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Ljava/lang/String;)Lgzb;",
        "Lzn;",
        "request",
        "getParams",
        "(Lzn;)Ljava/lang/String;",
        "jsonString",
        "eraseSecrets",
        ...
        "exception",
        "debugIoException",
        "(Lin;Lzn;Ljava/io/IOException;)V",
        "Lnrd;",
        "Lko;",
...
.field private final sessionStore:Lko;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger$Companion;-><init>(Ljq4;)V
...
.method public constructor <init>(Lnrd;Lko;)V
    .locals 4

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Lnrd;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->sessionStore:Lko;
...
.method private final eraseSecrets(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Lnrd;
...
.method private final extractHostAndScheme(Ljava/lang/String;)Lgzb;
    .locals 2
...
.method private final getParams(Lzn;)Ljava/lang/String;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->getRawParams(Lzn;)Ljava/lang/String;
...
.method private final getRawParams(Lzn;)Ljava/lang/String;
    .locals 3
    ...
    invoke-direct {v1, v0}, Lcgc;-><init>(Ljava/io/Writer;)V

    :try_start_0
    invoke-virtual {v1}, Lcgc;->q()V

    invoke-interface {p1, v1}, Lzn;->writeParams(Ll78;)V

    invoke-virtual {v1}, Lcgc;->n()V

    invoke-virtual {v1}, Lcgc;->flush()V
    :try_end_0
    ...
    :catch_0
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Lnrd;

    const-string v1, "CallsApiDebug"

    const-string v2, "failed to log request params"

    invoke-interface {p1, v1, v2}, Lnrd;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method private final transformUriForLog(Landroid/net/Uri;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->sessionStore:Lko;
    ...
    iget-object v0, v0, Ljo;->c:Ljava/lang/String;
    ...
    :cond_1
    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->extractHostAndScheme(Ljava/lang/String;)Lgzb;
...
.method public debugApiRequest(Lin;Lzn;Lkn;)V
    ...
    instance-of p1, p2, Lco;

    if-eqz p1, :cond_0

    invoke-direct {p0, p2}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->getParams(Lzn;)Ljava/lang/String;

    move-result-object p1

    const-string p3, "start with params "

    invoke-static {p3, p1}, Lx82;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    iget-object p3, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Lnrd;
    ...
    invoke-static {v0, p2, v1, p1}, Lo52;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public debugApiResponseFail(Lin;Lzn;Lz68;)Lz68;
    ...
    invoke-interface {p3}, Lz68;->j0()Ljava/lang/String;
    ...
    invoke-static {v1, p2, v2, p3}, Lo52;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p2

    const-string p3, "CallsApiDebug"

    invoke-interface {v0, p3, p2}, Lnrd;->log(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {p1}, La78;->l(Ljava/lang/String;)La78;
...
.method public debugIoException(Lin;Lzn;Ljava/io/IOException;)V
    ...
    invoke-static {v0, p2, v1}, Lsb6;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p2

    const-string v0, "CallsApiDebug"

    invoke-interface {p1, v0, p2, p3}, Lnrd;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
