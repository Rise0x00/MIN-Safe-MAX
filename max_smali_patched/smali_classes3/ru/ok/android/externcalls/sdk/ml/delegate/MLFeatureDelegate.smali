...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "downloadModel",
        "(Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Loqf;",
        "stage",
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate$Companion;-><init>(Ljq4;)V
...
.method public constructor <init>(Lfu8;Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfigProvider;Lru/ok/android/externcalls/sdk/net/DownloadService;Lru/ok/android/externcalls/sdk/stat/mldownload/MLDownloadStat;Lru/ok/android/externcalls/sdk/ml/model/MLFeatureType;Ljava/lang/String;Lnrd;Landroid/content/Context;Lru/ok/android/externcalls/sdk/ml/model/ModelSpec;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->mlFeaturesInfoDataSource:Lfu8;
    ...
    iput-object p7, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->logger:Lnrd;
...
.method public static final synthetic access$downloadModel(Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Loqf;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->downloadModel(Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Loqf;
...
.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;)Lnrd;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->logger:Lnrd;
...
.method private final clearDir()V
    ...
    invoke-static {v3, v4}, Le0k;->a(Ljava/io/File;Lzs6;)V
...
.method private final downloadModel(Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Loqf;
    .locals 5
    ...
    sget-object v4, Lh67;->b:Lh67;

    invoke-direct {v3, p1, v4}, Lru/ok/android/externcalls/sdk/net/FileValidationConfig;-><init>(Ljava/lang/String;Lh67;)V

    invoke-interface {v1, v2, v0, v3}, Lru/ok/android/externcalls/sdk/net/DownloadService;->download(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Loqf;
    ...
    invoke-interface {p1}, Lgu6;->d()Lxd6;
    ...
    invoke-direct {v0, v2, p1}, Lge6;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v0, p1, v1, v2}, Lte6;-><init>(Lxd6;Ljava/lang/Object;I)V

    new-instance p1, Lxe6;

    invoke-direct {p1, v0}, Lxe6;-><init>(Lb1;)V
...
.method private final fetchConfig()Lez8;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {v0}, Lru/ok/android/externcalls/sdk/config/ConfigProvider;->getConfig()Lez8;
...
.method private final log(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->logger:Lnrd;
...
.method private final removeCurrentModel()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->mlFeaturesInfoDataSource:Lfu8;
...
.method private final saveNewModelInfo(Lru/ok/android/externcalls/sdk/ml/stage/UnzipStage;)Lru/ok/android/externcalls/sdk/ml/stage/SaveNewModelInfoStage;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->mlFeaturesInfoDataSource:Lfu8;
    ...
    invoke-virtual {v1, v2, v0}, Ldq;->V(Ljava/lang/String;Ljava/io/Serializable;)V
...
.method private final unzipModel(Lru/ok/android/externcalls/sdk/ml/stage/DownloadStage;)Lru/ok/android/externcalls/sdk/ml/stage/UnzipStage;
    ...
    invoke-static {v0, v1}, Lx66;->i(Ljava/io/File;Ljava/io/File;)Ljava/util/ArrayList;
    ...
    invoke-static {p1, v1}, Le0k;->a(Ljava/io/File;Lzs6;)V
...
# virtual methods
.method public final checkModel()Loqf;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->fetchConfig()Lez8;
    ...
    invoke-direct {v2, v0, v1, v3}, Ltz8;-><init>(Lez8;Ljava/lang/Object;I)V

    invoke-static {}, Laoe;->b()Lqne;

    move-result-object v0

    invoke-virtual {v2, v0}, Lez8;->d(Lqne;)Ltz8;
    ...
    invoke-direct {v2, v0, v1}, Lnz8;-><init>(Lez8;Lot6;)V
...
.method public isModelValid(Ljava/io/File;)Z
    ...
    invoke-static {v1}, La76;->L(Ljava/io/File;)Ljava/lang/String;
