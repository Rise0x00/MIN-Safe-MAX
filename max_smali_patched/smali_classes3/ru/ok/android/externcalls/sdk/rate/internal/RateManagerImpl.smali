...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "statMonitor",
        "<init>",
        "(Lnrd;Lru/ok/android/externcalls/sdk/rate/RateManagerConfigProvider;Lxs6;Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitor;)V",
...
.field private final currentTopology:Lxs6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lxs6;"
        }
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/rate/internal/RateManagerImpl$Companion;-><init>(Ljq4;)V
...
.method public constructor <init>(Lnrd;Lru/ok/android/externcalls/sdk/rate/RateManagerConfigProvider;Lxs6;Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitor;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/rate/internal/RateManagerImpl;->log:Lnrd;

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/rate/internal/RateManagerImpl;->currentTopology:Lxs6;
    ...
    invoke-interface {p2}, Lru/ok/android/externcalls/sdk/config/ConfigProvider;->getConfig()Lez8;
    ...
    invoke-virtual {p1, p2}, Lez8;->d(Lqne;)Ltz8;
    ...
    new-instance p4, Ljnc;

    const/16 v0, 0x9

    invoke-direct {p4, v0, p0}, Ljnc;-><init>(ILjava/lang/Object;)V

    new-instance v0, Lfz8;

    invoke-direct {v0, p2, p3, p4}, Lfz8;-><init>(Ltz3;Ltz3;Lx7;)V

    invoke-virtual {p1, v0}, Lez8;->e(Luz8;)V

    iput-object v0, p0, Lru/ok/android/externcalls/sdk/rate/internal/RateManagerImpl;->initDisposable:Ls45;
...
.method private static final _init_$lambda$0(Lru/ok/android/externcalls/sdk/rate/internal/RateManagerImpl;)V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/rate/internal/RateManagerImpl;->log:Lnrd;
...
.method public static final synthetic access$getCurrentTopology$p(Lru/ok/android/externcalls/sdk/rate/internal/RateManagerImpl;)Lxs6;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/rate/internal/RateManagerImpl;->currentTopology:Lxs6;
...
.method public static final synthetic access$getLog$p(Lru/ok/android/externcalls/sdk/rate/internal/RateManagerImpl;)Lnrd;
    .locals 0
...
.method private final addRateHint(Lru/ok/android/externcalls/sdk/rate/RateHint;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/rate/internal/RateManagerImpl;->log:Lnrd;
...
.method private final observeStats()Ls45;
    .locals 5
    ...
    invoke-interface {v0}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitor;->observeStat()Lg0b;
...
.method private final onConfigReceived(Lru/ok/android/externcalls/sdk/rate/RateManagerConfig;)V
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/rate/internal/RateManagerImpl;->log:Lnrd;
    ...
    invoke-direct {v0, v1, v2, v3}, Lru/ok/android/externcalls/sdk/rate/internal/RttRateHintTrigger;-><init>(Lnrd;Lru/ok/android/externcalls/sdk/rate/rtt/RttRateHintConfig;Lru/ok/android/externcalls/sdk/rate/internal/RateHintCollection;)V
    ...
    invoke-direct {v0, v1, v2, v3}, Lru/ok/android/externcalls/sdk/rate/internal/LossHintTrigger;-><init>(Lnrd;Lru/ok/android/externcalls/sdk/rate/loss/LossHintConfig;Lru/ok/android/externcalls/sdk/rate/internal/RateHintCollection;)V
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lru/ok/android/externcalls/sdk/rate/internal/CandidateTypeHintTrigger;-><init>(Lnrd;Lru/ok/android/externcalls/sdk/rate/connection/CandidateTypeHintConfig;Lru/ok/android/externcalls/sdk/rate/internal/RateHintCollection;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, p1, v2, v3}, Lru/ok/android/externcalls/sdk/rate/internal/CandidateTypeHintTrigger;-><init>(Lnrd;Lru/ok/android/externcalls/sdk/rate/connection/CandidateTypeHintConfig;Lru/ok/android/externcalls/sdk/rate/internal/RateHintCollection;Ljava/lang/String;)V
    ...
    :cond_3
    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/rate/internal/RateManagerImpl;->observeStats()Ls45;

    move-result-object p1

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/rate/internal/RateManagerImpl;->observeDisposable:Ls45;
...
.method public final release()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/rate/internal/RateManagerImpl;->initDisposable:Ls45;

    invoke-interface {v0}, Ls45;->dispose()V

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/rate/internal/RateManagerImpl;->observeDisposable:Ls45;
