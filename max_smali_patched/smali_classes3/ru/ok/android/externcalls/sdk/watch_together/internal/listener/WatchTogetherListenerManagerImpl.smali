...
.method private final getPosition(Ljava/lang/Long;)Lpca;
    .locals 4
    ...
    invoke-direct {v0, v1, v2}, Lnca;-><init>(J)V

    return-object v0

    :cond_1
    :goto_0
    sget-object p1, Loca;->a:Loca;
...
.method private final sendActualState(Lru/ok/android/externcalls/sdk/watch_together/listener/WatchTogetherListener;)V
    ...
    invoke-direct {v1, p0, v2, p1}, Le9i;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method private final updateState(Lvca;)V
    .locals 12
    ...
    iget-object p1, p1, Lvca;->a:Ljava/util/ArrayList;
    ...
    iget-object v3, v1, Luca;->a:Lxz1;

    iget-object v3, v3, Lxz1;->b:Lsp1;
    ...
    iget-object v11, v3, Lxz1;->c:Lmca;
    ...
    sget-object v5, Lsca;->$EnumSwitchMapping$1:[I
    ...
    iget-object v9, v8, Ljca;->d:Lrca;

    if-ne v9, v3, :cond_6

    iget-object v8, v8, Ljca;->a:Lmca;

    invoke-virtual {v8, v11}, Lmca;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, v1, Luca;->d:Ljava/lang/Long;

    invoke-direct {p0, v2}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->getPosition(Ljava/lang/Long;)Lpca;
    ...
    invoke-static {v7}, Lzca;->a(F)V

    iget-boolean v8, v1, Luca;->e:Z

    const/4 v10, 0x0

    invoke-direct/range {v3 .. v10}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lpca;ZFZLjca;Ljq4;)V
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lv7f;

    move-result-object v2

    invoke-direct {v1, v4, v2, v9}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lv7f;Ljca;)V
...
.method public final onVideoStarted(Ltca;)V
    .locals 12
    ...
    iget-object v11, v7, Ljca;->a:Lmca;
    ...
    invoke-direct/range {v1 .. v8}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lpca;ZFZLjca;Ljq4;)V
    ...
    iget-object p1, p1, Ltca;->b:Lv7f;

    invoke-direct {v1, v0, p1, v7}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lv7f;Ljca;)V
...
.method public final onVideoStatesUpdatedChanged(Lvca;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->updateState(Lvca;)V
...
.method public final onVideoStopped(Lwca;)V
    .locals 4
    ...
    iget-object v2, p1, Lwca;->b:Lv7f;

    iget-object v3, p1, Lwca;->c:Lmca;

    iget-object p1, p1, Lwca;->d:Lrca;

    invoke-direct {v1, v0, v2, v3, p1}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStoppedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lv7f;Lmca;Lrca;)V
