...
.field private final noise:Ldsi;
...
.method public constructor <init>(SLandroid/os/Handler;Ljava/lang/Runnable;)V
    ...
    iput-object v0, p0, Lru/ok/android/externcalls/sdk/AudioLevelListener;->noise:Ldsi;
...
.method public onSample(IIILgyb;)V
    ...
    invoke-virtual {p4, p2}, Lgyb;->a(I)S
    ...
    :goto_1
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/AudioLevelListener;->noise:Ldsi;
    ...
    iget-object p3, p0, Lru/ok/android/externcalls/sdk/AudioLevelListener;->noise:Ldsi;
