...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "listener",
        "notifyNewListener",
        "(Lbf1;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V",
        "addFeatureListener",
        ...
        "(Lbf1;)Z",
        "getFeatureRoles",
        "(Lbf1;)Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;",
        "Lef1;",
        "onFeatureSetChanged",
        "(Lef1;)V",
...
.method private final getFeaturesRolesMap(Lff1;)Ljava/util/Map;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {}, Lbf1;->values()[Lbf1;
    ...
    iget-object v5, p1, Lff1;->a:Ljava/lang/Object;
...
.method private final notifyListenersWithNewEnabledFeatures(Ljava/util/Set;Ljava/util/Set;)V
    ...
    invoke-static {p1, p2}, Lb9f;->e0(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    invoke-interface {v3, v1, v4}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureEnabledChanged(Lbf1;Z)V

    goto :goto_0

    :cond_1
    invoke-static {p2, p1}, Lb9f;->e0(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    invoke-interface {v1, p2, v2}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureEnabledChanged(Lbf1;Z)V
...
.method private final notifyListenersWithNewFeaturesRoles(Ljava/util/Map;Ljava/util/Map;)V
    ...
    invoke-static {v0, v1}, Lb9f;->f0(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;
    ...
    invoke-interface {v3, v1, v5}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureRolesChanged(Lbf1;Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;)V
...
.method private final notifyNewListener(Lbf1;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V
    .locals 1

    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->isFeatureEnabled(Lbf1;)Z

    move-result v0

    invoke-interface {p2, p1, v0}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureEnabledChanged(Lbf1;Z)V

    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->getFeatureRoles(Lbf1;)Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;

    move-result-object v0

    invoke-interface {p2, p1, v0}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureRolesChanged(Lbf1;Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;)V
...
# virtual methods
.method public addFeatureListener(Lbf1;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V
    .locals 2
    ...
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->notifyNewListener(Lbf1;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V

    return-void
.end method

.method public getFeatureRoles(Lbf1;)Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;
    .locals 2
...
.method public isFeatureEnabled(Lbf1;)Z
    .locals 1
...
.method public final onFeatureSetChanged(Lef1;)V
    .locals 1

    iget-object p1, p1, Lef1;->a:Ljava/util/LinkedHashSet;
...
.method public final onFeaturesPerRoleChanged(Lff1;)V
    .locals 1

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->getFeaturesRolesMap(Lff1;)Ljava/util/Map;
...
.method public removeFeatureListener(Lbf1;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V
    .locals 1
