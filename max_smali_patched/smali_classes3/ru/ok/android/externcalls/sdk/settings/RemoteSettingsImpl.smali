...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "log",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;Lnrd;)V",
        "Lyeh;",
        "drainEmitters",
        "()V",
        "requestReadSettings",
...
.field private final requestSettingsDisposable:Ls45;

.field private final wantedSettings:Lft0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lft0;"
        }
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl$Companion;-><init>(Ljq4;)V
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;Lnrd;)V
    .locals 6
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->log:Lnrd;
    ...
    invoke-direct {v1, p1}, Lft0;-><init>(Ljava/io/Serializable;)V

    iput-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->wantedSettings:Lft0;
    ...
    invoke-direct/range {v0 .. v5}, Lf2b;-><init>(Lg0b;JLjava/util/concurrent/TimeUnit;Lqne;)V
    ...
    invoke-virtual {v0, p1}, Lg0b;->a(Lbrc;)Lh1b;
    ...
    invoke-direct {v0, p1, p2, v1}, Lh1b;-><init>(Lg0b;Ljava/lang/Object;I)V

    invoke-static {}, Lag;->a()Lqne;

    move-result-object p1

    invoke-virtual {v0, p1}, Lg0b;->h(Lqne;)Lb2b;
    ...
    invoke-direct {v2, p2, v0, v1}, Lv98;-><init>(Ltz3;Ltz3;Lx7;)V

    invoke-virtual {p1, v2}, Lg0b;->j(Lb3b;)V

    iput-object v2, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->requestSettingsDisposable:Ls45;
...
.method public static final synthetic access$getLog$p(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;)Lnrd;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->log:Lnrd;
...
.method public static synthetic b(Ljava/lang/String;Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;Luqf;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->get$lambda$1(Ljava/lang/String;Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;Lwqf;)V
...
.method private static final get$lambda$1(Ljava/lang/String;Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;Lwqf;)V
    .locals 2

    new-instance v0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl$KeyListener;

    invoke-direct {v0, p0, p2}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl$KeyListener;-><init>(Ljava/lang/String;Lwqf;)V
    ...
    invoke-static {p2, v0}, Lw45;->g(Ljava/util/concurrent/atomic/AtomicReference;Lrb2;)V
...
.method private final requestReadSettings()V
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->wantedSettings:Lft0;

    invoke-virtual {v1, v0}, Lft0;->e(Ljava/lang/Object;)V
...
.method public get(Ljava/lang/String;)Loqf;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->log:Lnrd;
    ...
    invoke-direct {v0, p1, v1, p0}, Lh6a;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public release()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->requestSettingsDisposable:Ls45;
