...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "<init>",
        "(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitor;Lnrd;Lxs6;Lru/ok/android/externcalls/sdk/stat/ConversationStats;Lru/ok/android/externcalls/sdk/p2prelay/P2PRelaySwitchConfigProvider;)V",
...
.field private final getConfigDisposable:Ls45;

.field private isActive:Z

.field private final logger:Lnrd;

.field private final onSwitchTrigger:Lxs6;
...
.field private statObserveDisposable:Ls45;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/p2prelay/P2pRelaySwitchTrigger$Companion;-><init>(Ljq4;)V
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitor;Lnrd;Lxs6;Lru/ok/android/externcalls/sdk/stat/ConversationStats;Lru/ok/android/externcalls/sdk/p2prelay/P2PRelaySwitchConfigProvider;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/p2prelay/P2pRelaySwitchTrigger;->logger:Lnrd;

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/p2prelay/P2pRelaySwitchTrigger;->onSwitchTrigger:Lxs6;
    ...
    invoke-interface {p5}, Lru/ok/android/externcalls/sdk/config/ConfigProvider;->getConfig()Lez8;
    ...
    new-instance p4, Lbm8;

    const/16 p5, 0x18

    invoke-direct {p4, p5, p0}, Lbm8;-><init>(ILjava/lang/Object;)V

    new-instance p5, Lfz8;

    invoke-direct {p5, p2, p3, p4}, Lfz8;-><init>(Ltz3;Ltz3;Lx7;)V

    invoke-virtual {p1, p5}, Lez8;->e(Luz8;)V

    iput-object p5, p0, Lru/ok/android/externcalls/sdk/p2prelay/P2pRelaySwitchTrigger;->getConfigDisposable:Ls45;
...
.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/p2prelay/P2pRelaySwitchTrigger;)Lnrd;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/p2prelay/P2pRelaySwitchTrigger;->logger:Lnrd;
...
.method private final handleStats(Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;Lru/ok/android/externcalls/sdk/p2prelay/P2PRelaySwitchConfig;)V
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/p2prelay/P2pRelaySwitchTrigger;->logger:Lnrd;
    ...
    invoke-static {p1, v0, v1, v4, v5}, Lx82;->p(IJLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/p2prelay/P2pRelaySwitchTrigger;->onSwitchTrigger:Lxs6;
...
.method private final maybeStartObserveStat(Lru/ok/android/externcalls/sdk/p2prelay/P2PRelaySwitchConfig;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/p2prelay/P2pRelaySwitchTrigger;->logger:Lnrd;
    ...
    :cond_0
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/p2prelay/P2pRelaySwitchTrigger;->statObserveDisposable:Ls45;
    ...
    invoke-direct {v3, v1, p1, v2}, Lv98;-><init>(Ltz3;Ltz3;Lx7;)V

    invoke-virtual {v0, v3}, Lg0b;->j(Lb3b;)V

    iput-object v3, p0, Lru/ok/android/externcalls/sdk/p2prelay/P2pRelaySwitchTrigger;->statObserveDisposable:Ls45;
...
.method public final release()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/p2prelay/P2pRelaySwitchTrigger;->getConfigDisposable:Ls45;
