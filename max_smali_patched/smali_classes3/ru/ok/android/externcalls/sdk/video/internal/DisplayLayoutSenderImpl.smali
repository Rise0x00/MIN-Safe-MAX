...
.field private final sender:Lzs6;
...
.field private final store:Lzs6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lzs6;"
        }
...
# direct methods
.method public constructor <init>(Lzs6;Lzs6;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->store:Lzs6;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->sender:Lzs6;
...
.method public sendDisplayLayouts(Ljava/util/Collection;)V
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->sender:Lzs6;
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getType()Ld2i;
    ...
    iget-object v4, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->store:Lzs6;

    invoke-interface {v4, v3}, Lzs6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v3, v4, Lal8;->b:Ljava/lang/Object;

    iput-object v2, v4, Lal8;->c:Ljava/lang/Object;

    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/layout/ConversationDisplayLayoutItem;->getVideoTrackParticipantKey()Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    move-result-object v2

    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getMovieId()Lmca;

    move-result-object v2

    iput-object v2, v4, Lal8;->d:Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/layout/ConversationDisplayLayoutItem;->getLayout()Lssh;

    move-result-object v1

    invoke-direct {v3, v2, v1}, Lbd1;-><init>(Lxz1;Lssh;)V
