...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "store",
        "<init>",
        "(Lxs6;Li61;Lru/ok/android/externcalls/sdk/renderer/ConversationRenderers;Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;)V",
        "Lxz1;",
        "key",
        "",
...
.field private final state:Lxs6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lxs6;"
        }
...
# direct methods
.method public constructor <init>(Lxs6;Li61;Lru/ok/android/externcalls/sdk/renderer/ConversationRenderers;Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->state:Lxs6;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->call:Li61;
...
.method private final setRenderers(Lxz1;Ljava/util/List;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private final setRenderersForMe(Lxz1;Ljava/util/List;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->setRenderers(Lxz1;Ljava/util/List;)V

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->call:Li61;
    ...
    invoke-virtual {v1, p1, p2}, Loy1;->P(Lxz1;Ljava/util/List;)V

    iget-object v0, v0, Li61;->y0:Lvj;

    invoke-virtual {v0, p1, p2}, Lvj;->b(Lxz1;Ljava/util/List;)V

    return-void

    :cond_2
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->call:Li61;
    ...
    invoke-direct {v1, v2}, Lal8;-><init>(I)V

    iput-object v0, v1, Lal8;->b:Ljava/lang/Object;

    sget-object v0, Ld2i;->c:Ld2i;

    iput-object v0, v1, Lal8;->c:Ljava/lang/Object;

    invoke-virtual {v1}, Lal8;->j()Lxz1;

    move-result-object v0

    iget-object p1, p1, Li61;->y0:Lvj;

    invoke-virtual {p1, v0, p2}, Lvj;->b(Lxz1;Ljava/util/List;)V
    ...
    :cond_7
    iget-object p1, p1, Li61;->g0:Lwif;

    iput-object p2, p1, Lwif;->p:Lorg/webrtc/VideoSink;

    iget-object p1, p1, Lwif;->o:Ldn8;

    if-eqz p1, :cond_8

    invoke-virtual {p1, p2}, Ldn8;->j(Lorg/webrtc/VideoSink;)V
...
.method private final setRenderersForOthers(Lxz1;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
# virtual methods
.method public getCallRenderer()Ldo1;
    .locals 2

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->state:Lxs6;
...
.method public getEglBaseContext()Lorg/webrtc/EglBase$Context;
    ...
    iget-object v0, v0, Li61;->r:Lorg/webrtc/EglBase;
...
.method public setRenderers(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Ljava/util/List;)V
    ...
    .line 4
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getType()Ld2i;

    move-result-object v2

    .line 5
    iput-object v2, v1, Lal8;->c:Ljava/lang/Object;
    ...
    .line 8
    iput-object v2, v1, Lal8;->b:Ljava/lang/Object;

    .line 9
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getMovieId()Lmca;
    ...
    .line 14
    invoke-direct {p0, v1, p2}, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->setRenderersForMe(Lxz1;Ljava/util/List;)V

    return-void

    .line 15
    :cond_1
    invoke-direct {p0, v1, p2}, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->setRenderersForOthers(Lxz1;Ljava/util/List;)V
