...
# instance fields
.field private final conversation:Lxs6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lxs6;"
        }
...
.field private final factory:Lzs6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lzs6;"
        }
...
.field private final onOwnCameraRendererSet:Lxs6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lxs6;"
        }
...
# direct methods
.method public constructor <init>(Lxs6;Lzs6;Lxs6;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/ParticipantVideoViewManagerImpl;->conversation:Lxs6;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/video/internal/ParticipantVideoViewManagerImpl;->factory:Lzs6;

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/video/internal/ParticipantVideoViewManagerImpl;->onOwnCameraRendererSet:Lxs6;
...
.method public createVideoViewInstance(Landroid/content/Context;)Landroid/view/View;
    ...
    .line 2
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/video/internal/ParticipantVideoViewManagerImpl;->factory:Lzs6;
...
.method public getOwnVideoTrack()Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/video/internal/ParticipantVideoViewManagerImpl;->conversation:Lxs6;
...
.method public setParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Landroid/view/View;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    .line 10
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/video/internal/ParticipantVideoViewManagerImpl;->onOwnCameraRendererSet:Lxs6;
    ...
    invoke-interface {p1}, Lru/ok/android/externcalls/sdk/video/VideoRenderManager;->getCallRenderer()Ldo1;
    ...
    invoke-interface {p2, p1, v0, p3}, Lru/ok/android/externcalls/sdk/ui/RendererView;->init(Ldo1;Lorg/webrtc/RendererCommon$RendererEvents;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)Z
