...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "download",
        "(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Loqf;",
        "Lnrd;",
        "Companion",
        "calls-sdk_release"
    }
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl$Companion;-><init>(Ljq4;)V
...
.method public constructor <init>(Lnrd;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Lnrd;

    return-void
.end method

.method public static synthetic a(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Luqf;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->download$lambda$3(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Lwqf;)V

    return-void
.end method

.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;)Lnrd;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Lnrd;

    return-object p0
.end method

.method private static final download$lambda$3(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Lwqf;)V
    .locals 8
    ...
    invoke-static {p1, v1, v1}, Lnzj;->a(Ljava/io/File;Ljava/io/File;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-direct {v0, v1}, Ljava/io/IOException;-><init>(Ljava/lang/String;)V

    invoke-virtual {p2, v0}, Luqf;->a(Ljava/lang/Throwable;)V
    :try_end_1
    ...
    :cond_0
    :try_start_2
    invoke-static {p1}, Le0k;->b(Ljava/io/File;)V
    ...
    invoke-virtual {p2}, Lru/ok/android/externcalls/sdk/net/FileValidationConfig;->getHashAlgorithm()Lh67;

    move-result-object p0

    iget-object p0, p0, Lh67;->a:Ljava/lang/String;
    ...
    invoke-virtual {p2, p3}, Luqf;->b(Ljava/lang/Object;)V
    ...
    :goto_3
    iget-object p0, v2, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Lnrd;
    ...
    invoke-static {v1, v3, p3, p1, v0}, Lo52;->z(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v4, p0}, Le0k;->a(Ljava/io/File;Lzs6;)V

    check-cast p4, Luqf;

    invoke-virtual {p4}, Luqf;->f()Z

    move-result p0

    if-nez p0, :cond_5

    invoke-virtual {p4, p2}, Luqf;->a(Ljava/lang/Throwable;)V
...
.method private final downloadInner(Ljava/lang/String;Ljava/io/File;Ljava/security/MessageDigest;)V
    ...
    invoke-direct {v2, v0, p3}, Lylh;-><init>(ILjava/lang/Object;)V
    ...
    invoke-static {v5, p2}, Lx66;->h(Ljava/io/InputStream;[Ljava/io/OutputStream;)V
    :try_end_3
...
# virtual methods
.method public download(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Loqf;
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Len;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
