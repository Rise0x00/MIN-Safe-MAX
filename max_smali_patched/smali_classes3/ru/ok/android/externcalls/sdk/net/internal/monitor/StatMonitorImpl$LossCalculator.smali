...
# instance fields
.field private final lossCalc:Lft8;
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl$LossCalculator;->lossCalc:Lft8;
...
.method private final calculateLoss(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/lang/Float;
    ...
    :cond_0
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl$LossCalculator;->lossCalc:Lft8;
    ...
    invoke-virtual {v0, v1, v2, p1, p2}, Lft8;->a(JJ)D
    ...
    invoke-static {p1, p2, v0}, Lnm4;->n(FFF)F
...
.method private final synthetic findSender(Ljava/util/List;)Lrxf;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    iget-object v1, v1, Lrxf;->n:Ljava/lang/Boolean;
...
.method public final synthetic getLoss(Ljava/util/List;)Ljava/lang/Float;
    ...
    iget-object p1, v0, Lrxf;->i:Ljava/math/BigInteger;

    iget-object v0, v0, Lrxf;->h:Ljava/math/BigInteger;
