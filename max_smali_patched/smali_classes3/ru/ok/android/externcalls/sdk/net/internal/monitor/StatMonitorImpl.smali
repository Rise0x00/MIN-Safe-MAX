...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "mapToMonitoringStat",
        "(Lprd;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;",
        "Lg0b;",
        "observeStat",
        "()Lg0b;",
        "rtcStat",
...
.field private final statSubject:Lft0;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl$Companion;-><init>(Ljq4;)V
...
.method public constructor <init>(Lnrd;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Lnrd;

    new-instance p1, Lft0;

    const/4 v0, 0x0

    invoke-direct {p1, v0}, Lft0;-><init>(Ljava/io/Serializable;)V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->statSubject:Lft0;
...
.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Lnrd;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Lnrd;

    return-object p0
.end method

.method private final mapToMonitoringStat(Lprd;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;
    .locals 8
    ...
    invoke-direct/range {v1 .. v7}, Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;-><init>(Ljava/lang/Integer;Ljava/lang/Float;Ljava/lang/Float;Ljava/lang/String;ILjq4;)V

    return-object v1

    :cond_0
    iget-object v1, v0, Lyb2;->h:Ljava/lang/Double;
    ...
    :goto_0
    iget-object p1, p1, Lprd;->b:Ljava/util/List;

    invoke-static {p1, v0}, Lhwj;->d(Ljava/util/List;Lyb2;)Ljava/util/ArrayList;
    ...
    invoke-static {v5}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Lnrd;
    ...
    :cond_6
    iget-object v4, v5, Lrxf;->i:Ljava/math/BigInteger;

    iget-object v5, v5, Lrxf;->h:Ljava/math/BigInteger;
    ...
    invoke-static {p1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Lnrd;
    ...
    :cond_b
    iget-object p1, v5, Lrxf;->i:Ljava/math/BigInteger;

    iget-object v2, v5, Lrxf;->h:Ljava/math/BigInteger;
    ...
    :goto_6
    iget-object p1, v0, Lyb2;->b:Ljava/lang/String;
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Lnrd;
...
# virtual methods
.method public observeStat()Lg0b;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->statSubject:Lft0;
    ...
    invoke-direct {v1, v0, v2}, Lw0b;-><init>(Lg0b;I)V

    return-object v1
.end method

.method public onRtcStats(Lprd;)V
    .locals 1

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->mapToMonitoringStat(Lprd;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;
