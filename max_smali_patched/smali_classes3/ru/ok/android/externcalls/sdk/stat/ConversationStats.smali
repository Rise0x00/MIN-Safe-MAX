...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "<init>",
        "(Lxs6;Lru/ok/android/externcalls/sdk/Conversation$CallType;Lvwg;Lnrd;ZZ)V",
...
# direct methods
.method public constructor <init>(Lxs6;Lru/ok/android/externcalls/sdk/Conversation$CallType;Lvwg;Lnrd;ZZ)V
    .locals 1
    ...
    invoke-direct {v0, p3, p1}, Lru/ok/android/externcalls/sdk/stat/connect/ConversationConnectedToSignalingStat;-><init>(Lvwg;Lxs6;)V
    ...
    invoke-direct {v0, p3, p1}, Lru/ok/android/externcalls/sdk/stat/warmup/ConversationPreparedStat;-><init>(Lvwg;Lxs6;)V
    ...
    invoke-direct {v0, p2, p3, p1}, Lru/ok/android/externcalls/sdk/stat/start/ConversationStartedStat;-><init>(Lru/ok/android/externcalls/sdk/Conversation$CallType;Lvwg;Lxs6;)V
    ...
    invoke-direct {v0, p1, p3, p4, p6}, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;-><init>(Lxs6;Lvwg;Lnrd;Z)V
    ...
    invoke-direct {p4, p1}, Lru/ok/android/externcalls/sdk/stat/finish/CallFinishStat;-><init>(Lxs6;)V
    ...
    invoke-direct {p4, p2, p5, p1}, Lru/ok/android/externcalls/sdk/stat/init/CallInitStat;-><init>(Lru/ok/android/externcalls/sdk/Conversation$CallType;ZLxs6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/candidate/IceCandidatePairChangedStat;-><init>(Lxs6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/icerestart/IceRestartStat;-><init>(Lxs6;)V
    ...
    invoke-direct {p2, p1, p3}, Lru/ok/android/externcalls/sdk/stat/topology/ServerTopologyRequestedStat;-><init>(Lxs6;Lvwg;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/connection/PeerConnectionChangedStat;-><init>(Lxs6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/negotiation/NegotiationErrorStat;-><init>(Lxs6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/mldownload/MLDownloadStat;-><init>(Lxs6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/p2prelay/P2PRelayRequestedStat;-><init>(Lxs6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/accept/AcceptCallStat;-><init>(Lxs6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/audio/AudioErrorStat;-><init>(Lxs6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/candidate/IceCandidateGatheringFailedStat;-><init>(Lxs6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/candidate/IceCandidateAddFailedStat;-><init>(Lxs6;)V
