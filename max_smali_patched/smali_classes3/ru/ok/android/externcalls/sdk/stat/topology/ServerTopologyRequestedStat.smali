...
# direct methods
.method public constructor <init>(Lxs6;Lvwg;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/stat/topology/ServerTopologyRequestedStat;->getEventualStatSender:Lxs6;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/stat/topology/ServerTopologyRequestedStat;->timeProvider:Lvwg;
...
# virtual methods
.method public final onServerTopologyRequested(Lf1h;)V
    .locals 4

    instance-of v0, p1, Le1h;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/stat/topology/ServerTopologyRequestedStat;->timeProvider:Lvwg;
    ...
    :goto_1
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/stat/topology/ServerTopologyRequestedStat;->getEventualStatSender:Lxs6;
    ...
    iget-object p1, p1, Lf1h;->a:Ld1h;

    iget-object p1, p1, Ld1h;->a:Ljava/lang/String;
    ...
    invoke-virtual {v2, p1, v0, v1}, Lte1;->c(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
