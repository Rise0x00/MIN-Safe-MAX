...
.method private final processFeedbackForResolvedInternalIds(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;->getParticipantId()Lsp1;
    ...
    invoke-virtual {v2, v3}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lsp1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    invoke-direct/range {v4 .. v11}, Lru/ok/android/externcalls/sdk/feedback/ParticipantFeedback;-><init>(Ljava/lang/String;JLru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/feedback/ParticipantFeedbackSource;ILjq4;)V
...
.method private final scheduleRemoving()V
    ...
    invoke-direct {v5, p0, v0, v1, v6}, Lbb0;-><init>(Ljava/lang/Object;JI)V
...
.method private final unrollReceivedFeedback(Lhf1;)Ljava/util/List;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p1, p1, Lhf1;->b:Ljava/util/ArrayList;
    ...
    iget-object v2, v1, Lgf1;->b:Ljava/lang/Object;
    ...
    iget-object v5, v1, Lgf1;->a:Ljava/lang/String;
    ...
    invoke-direct {v6, v4, v5}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;-><init>(Lsp1;Ljava/lang/String;)V
...
.method public onFeedback(Lhf1;)V
    .locals 5

    iget-object v0, p1, Lhf1;->a:Lv7f;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lv7f;
    ...
    :cond_0
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;->unrollReceivedFeedback(Lhf1;)Ljava/util/List;
    ...
    invoke-virtual {v4}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;->getParticipantId()Lsp1;
    ...
    invoke-direct {v3, p0, p1, v0, v4}, Lmg5;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p1, Lb45;

    const/16 v4, 0x15

    invoke-direct {p1, p0, v4, v0}, Lb45;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
