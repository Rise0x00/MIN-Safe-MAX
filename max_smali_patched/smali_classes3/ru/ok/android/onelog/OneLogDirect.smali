...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "errorCallback",
        "send-B_83SRM",
        "(Lru/ok/android/onelog/OneLogItem;Ljava/lang/String;Lnt6;)V",
        "send",
        "Lcn;",
        "getApiClient",
        "()Lcn;",
...
.method public static synthetic a(Lru/ok/android/onelog/OneLogItem;Ljava/lang/Exception;)Lyeh;
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/onelog/OneLogDirect;->send_PCEVtD0$lambda$0(Lru/ok/android/onelog/OneLogItem;Ljava/lang/Exception;)Lyeh;
...
.method public static synthetic c(Ljava/lang/String;Lru/ok/android/onelog/OneLogItem;Lcn;Lnt6;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/onelog/OneLogDirect;->send_B_83SRM$lambda$1(Ljava/lang/String;Lru/ok/android/onelog/OneLogItem;Lcn;Lnt6;)V
...
.method private final send-B_83SRM(Lru/ok/android/onelog/OneLogItem;Ljava/lang/String;Lnt6;)V
    .locals 7
    ...
    sget-object v0, Lq5b;->c:Ljava/util/concurrent/Executor;
    ...
    sput-object v0, Lq5b;->c:Ljava/util/concurrent/Executor;
    :try_end_0
    ...
    :cond_2
    :goto_2
    sget-object v6, Lq5b;->c:Ljava/util/concurrent/Executor;
...
.method private static final send_B_83SRM$lambda$1(Ljava/lang/String;Lru/ok/android/onelog/OneLogItem;Lcn;Lnt6;)V
    .locals 3
    ...
    invoke-interface {p2, v2}, Lcn;->a(Lpn;)Ljava/lang/Object;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :goto_1
    invoke-interface {p3, p1, p0}, Lnt6;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    return-void
.end method

.method private static final send_PCEVtD0$lambda$0(Lru/ok/android/onelog/OneLogItem;Ljava/lang/Exception;)Lyeh;
    .locals 0
...
.method public final flush()V
    ...
    sget-object v1, Lq5b;->c:Ljava/util/concurrent/Executor;
    ...
    sput-object v1, Lq5b;->c:Ljava/util/concurrent/Executor;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final send-PCEVtD0(Lru/ok/android/onelog/OneLogItem;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lru/ok/android/onelog/OneLogDirect;->send-B_83SRM(Lru/ok/android/onelog/OneLogItem;Ljava/lang/String;Lnt6;)V
