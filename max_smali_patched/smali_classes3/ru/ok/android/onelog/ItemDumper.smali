...
.method public static dump(Lru/ok/android/onelog/OneLogItem;Ljava/io/OutputStream;)V
    ...
    invoke-direct {v0, p1}, Lixb;-><init>(Ljava/io/OutputStream;)V
...
.method public static dump(Lru/ok/android/onelog/OneLogItem;Ljava/io/Writer;)V
    ...
    invoke-direct {v0, p1}, Lcgc;-><init>(Ljava/io/Writer;)V

    .line 7
    invoke-static {p0, v0}, Lru/ok/android/onelog/ItemDumper;->dump(Lru/ok/android/onelog/OneLogItem;Ll78;)V

    .line 8
    invoke-virtual {v0}, Lcgc;->flush()V

    return-void
.end method

.method public static dump(Lru/ok/android/onelog/OneLogItem;Ll78;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p1, p0}, Lru/ok/android/onelog/ItemSerializer;->serialize(Ll78;Lru/ok/android/onelog/OneLogItem;)V
