...
.method public final g()Lcj8;
    ...
    iget-object v2, v1, Landroidx/work/WorkerParameters;->b:Ljj4;

    const-string v3, "param_dump_path"

    invoke-virtual {v2, v3}, Ljj4;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v3}, Ljj4;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v7, v8}, Lpd7;-><init>(Ljava/io/DataInputStream;)V
    :try_end_1
    ...
    :try_start_3
    invoke-static {v7, v8}, Lsr6;->u(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_3
    ...
    :try_start_5
    invoke-virtual {v7}, Lpd7;->close()V
    :try_end_5
    ...
    :try_start_7
    invoke-static {v8, v1}, Lddh;->i(Ljava/io/Closeable;Ljava/lang/Throwable;)V
