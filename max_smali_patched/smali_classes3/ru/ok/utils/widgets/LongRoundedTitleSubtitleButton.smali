...
.field public final z0:Landroid/text/style/TextAppearanceSpan;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v1, Llqd;->UiUtils_TextAppearance_LongRoundedTitleSubtitleButton_Title:I

    invoke-direct {v0, p1, v1}, Landroid/text/style/TextAppearanceSpan;-><init>(Landroid/content/Context;I)V

    iput-object v0, p0, Lru/ok/utils/widgets/LongRoundedTitleSubtitleButton;->z0:Landroid/text/style/TextAppearanceSpan;

    new-instance v0, Landroid/text/style/TextAppearanceSpan;

    sget v1, Llqd;->UiUtils_TextAppearance_LongRoundedTitleSubtitleButton_Subtitle:I

    invoke-direct {v0, p1, v1}, Landroid/text/style/TextAppearanceSpan;-><init>(Landroid/content/Context;I)V

    iput-object v0, p0, Lru/ok/utils/widgets/LongRoundedTitleSubtitleButton;->A0:Landroid/text/style/TextAppearanceSpan;

    sget-object v0, Lwqd;->LongRoundedTitleSubtitleButton:[I

    invoke-virtual {p1, p2, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Lwqd;->LongRoundedTitleSubtitleButton_lrts_title:I

    invoke-virtual {p1, p2}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object p2

    sget v0, Lwqd;->LongRoundedTitleSubtitleButton_lrts_subtitle:I
    ...
    :goto_0
    invoke-virtual {p0, p1}, Lru/ok/utils/widgets/LongRoundedTitleSubtitleButton;->d(Lapg;)V
...
.method public final b(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
    ...
    iget-object v4, p0, Lru/ok/utils/widgets/LongRoundedTitleSubtitleButton;->z0:Landroid/text/style/TextAppearanceSpan;
    ...
    iget-object v0, p0, Lru/ok/utils/widgets/LongRoundedTitleSubtitleButton;->A0:Landroid/text/style/TextAppearanceSpan;
...
.method public final d(Lapg;)V
    ...
    invoke-static {v1, v3}, Lf90;->r0(IF)I
    ...
    invoke-static {v0, v1, v1, v4}, Lf90;->m0(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;[F)Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-static {v3, v1, v1, v4}, Lf90;->m0(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;[F)Landroid/graphics/drawable/GradientDrawable;

    move-result-object v3

    invoke-static {v0, v1, v3}, Lf90;->o0(Landroid/graphics/drawable/GradientDrawable;Landroid/graphics/drawable/GradientDrawable;Landroid/graphics/drawable/GradientDrawable;)Landroid/graphics/drawable/StateListDrawable;
