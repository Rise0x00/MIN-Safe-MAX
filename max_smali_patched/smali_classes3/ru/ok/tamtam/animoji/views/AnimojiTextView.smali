...
# instance fields
.field public final B0:Lim;

.field public C0:Lgzb;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p1, p0, p2, p3}, Lim;-><init>(Lru/ok/tamtam/animoji/views/AnimojiTextView;Lgm;Ll;)V

    iput-object p1, p0, Lru/ok/tamtam/animoji/views/AnimojiTextView;->B0:Lim;

    .line 3
    iget-object p1, p0, Lru/ok/tamtam/animoji/views/AnimojiTextView;->C0:Lgzb;
    ...
    .line 8
    iput-object p1, p0, Lru/ok/tamtam/animoji/views/AnimojiTextView;->C0:Lgzb;
...
.method public final getAnimojiEnabled()Z
    ...
    iget-object v0, p0, Lru/ok/tamtam/animoji/views/AnimojiTextView;->B0:Lim;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v2, v3}, Lrj;->b(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    iget-object v0, v0, Lim;->o:Ljava/lang/Object;
    ...
    invoke-static {v2, p1}, Lrj;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public setText(Ljava/lang/CharSequence;Landroid/widget/TextView$BufferType;)V
    ...
    iput-object v0, p0, Lru/ok/tamtam/animoji/views/AnimojiTextView;->C0:Lgzb;

    return-void

    :cond_0
    iget-object v1, v0, Lim;->c:Ljava/lang/Object;

    check-cast v1, Lru/ok/tamtam/animoji/views/AnimojiTextView;

    iget-object v2, v0, Lim;->d:Ljava/lang/Object;
    ...
    invoke-virtual {v4, p1}, Lkh5;->f(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    :cond_8
    invoke-virtual {v3, v4}, Lil;->a(Ljava/lang/CharSequence;)Ljava/util/List;
    ...
    :cond_9
    invoke-interface {v1}, Llh5;->a()Z

    move-result p1

    if-eqz p1, :cond_a

    invoke-interface {v1, v5}, Llh5;->setEmojiCompatEnabled(Z)V
    ...
    iget-object p1, v0, Lim;->X:Ljava/lang/Object;
    ...
    invoke-direct {p1, v1}, Lkl;-><init>(Lru/ok/tamtam/animoji/views/AnimojiTextView;)V

    iput-object p1, v0, Lim;->X:Ljava/lang/Object;
    ...
    invoke-static {p1, v3, v0}, Lkgj;->a(Landroid/text/Spannable;Ljava/util/ArrayList;Lil;)V

    invoke-static {v4}, Lkgj;->d(Ljava/lang/CharSequence;)V
