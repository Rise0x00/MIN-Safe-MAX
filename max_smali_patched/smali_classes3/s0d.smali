...
.method public synthetic constructor <init>(Lone/me/profileedit/ProfileEditScreen;I)V
    ...
    iput-object p1, p0, Ls0d;->b:Lone/me/profileedit/ProfileEditScreen;
...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v6, v0, Ls0d;->b:Lone/me/profileedit/ProfileEditScreen;
    ...
    invoke-virtual {v2, v7}, Lt6b;->setAddBadgeVisibility(Z)V

    new-instance v3, Lt0d;

    invoke-direct {v3, v6, v8}, Lt0d;-><init>(Lone/me/profileedit/ProfileEditScreen;I)V
    ...
    sget-object v9, Lone/me/profileedit/ProfileEditScreen;->G0:[Lb88;
    ...
    invoke-direct {v10, v3, v2}, Lbj3;-><init>(II)V
    ...
    invoke-direct {v4, v7}, Lirb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v4, v7}, Lirb;->setForm(Lxqb;)V

    new-instance v7, Lnqb;

    new-instance v10, Ls0d;

    const/4 v11, 0x3

    invoke-direct {v10, v6, v11}, Ls0d;-><init>(Lone/me/profileedit/ProfileEditScreen;I)V

    invoke-direct {v7, v10}, Lnqb;-><init>(Lzs6;)V

    invoke-virtual {v4, v7}, Lirb;->setLeftActions(Lsqb;)V

    sget-object v7, Lpqb;->a:Lpqb;

    invoke-virtual {v4, v7}, Lirb;->setRightActions(Luqb;)V
    ...
    invoke-direct {v4, v6, v7}, Ls0d;-><init>(Lone/me/profileedit/ProfileEditScreen;I)V
    ...
    invoke-direct {v9, v3, v2}, Lbj3;-><init>(II)V
    ...
    invoke-virtual {v4, v6}, Ls0d;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v9, v10}, Ldp;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v9, v8}, Ldp;->setLiftOnScroll(Z)V

    invoke-virtual {v9, v4}, Landroid/view/View;->setStateListAnimator(Landroid/animation/StateListAnimator;)V

    sget-object v10, Lone/me/profileedit/ProfileEditScreen;->G0:[Lb88;

    new-instance v10, Ls0d;

    invoke-direct {v10, v6, v8}, Ls0d;-><init>(Lone/me/profileedit/ProfileEditScreen;I)V
    ...
    invoke-direct {v8, v11}, Lej3;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v11}, Lbp;-><init>()V

    const/16 v12, 0x13

    iput v12, v11, Lbp;->a:I

    invoke-virtual {v8, v11}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    invoke-virtual {v8, v7}, Lej3;->setTitleEnabled(Z)V

    invoke-virtual {v10, v8}, Ls0d;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v9, v3, v3}, Lqb4;-><init>(II)V
    ...
    invoke-virtual {v9, v10}, Lqb4;->b(Lnb4;)V
    ...
    iget-object v9, v6, Lone/me/profileedit/ProfileEditScreen;->Y:Lcn0;

    invoke-virtual {v8, v9}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Le2e;)V

    invoke-virtual {v8, v4}, Landroidx/recyclerview/widget/RecyclerView;->setItemAnimator(Lj2e;)V
    ...
    sget-object v10, Lvv7;->a:Lxha;

    new-instance v10, Lxha;

    invoke-direct {v10, v4}, Lxha;-><init>(I)V
    ...
    invoke-virtual {v10, v12}, Lxha;->h(I)V
    ...
    invoke-direct {v14, v6, v4, v10}, Lh6a;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance v12, Lawe;

    sget-object v4, Lzc3;->A0:Lz66;

    invoke-static {v8, v4}, Ln;->e(Landroidx/recyclerview/widget/RecyclerView;Lz66;)Ldqb;
    ...
    invoke-virtual {v8, v12, v3}, Landroidx/recyclerview/widget/RecyclerView;->j(Lk2e;I)V

    new-instance v9, Lyw8;

    invoke-direct {v9, v7}, Lyw8;-><init>(I)V

    invoke-virtual {v8, v9, v3}, Landroidx/recyclerview/widget/RecyclerView;->j(Lk2e;I)V
    ...
    invoke-direct {v9, v3, v2}, Lqb4;-><init>(II)V

    const/16 v10, 0x50

    iput v10, v9, Lqb4;->c:I
    ...
    invoke-virtual {v4, v9}, Lz66;->d(Landroid/content/Context;)Lzc3;
    ...
    invoke-static {v6, v4}, Lone/me/profileedit/ProfileEditScreen;->e1(Lone/me/profileedit/ProfileEditScreen;Ldqb;)V
    ...
    invoke-direct {v4, v6, v9, v8}, Lb02;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    invoke-virtual {v4, v9}, Li8b;->setMode(Lf8b;)V

    sget-object v9, Ld8b;->d:Ld8b;
    ...
    invoke-direct {v2, v6, v7}, Lt0d;-><init>(Lone/me/profileedit/ProfileEditScreen;I)V
